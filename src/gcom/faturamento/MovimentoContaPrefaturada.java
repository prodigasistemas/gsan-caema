...
public class MovimentoContaPrefaturada implements Serializable {
	...
	/*
	 * RM 5635 - Registrar a quantidade de vezes que a conta foi impressa
	 * através da ISC Amelia Pessoa
	 */
	/** persistent field */
...
//	private ContratoDemandaComercialIndustrial contratoDemandaComercialIndustrial ;
	...
	/** full constructor */
	public MovimentoContaPrefaturada(Integer id,
			Integer anoMesReferenciaPreFaturamento, Integer leituraHidrometro,
			Date dataHoraLeitura, Short indicadorSituacaoLeitura,
			Integer leituraFaturamento, Integer consumoMedido,
			Integer consumoCobrado, Date dataHoraGeracaoMovimento,
			Short indicadorAtualizacaoFaturamento, Date utlimaAlteracao,
			Short indicadorEmissaoConta, Integer consumoRateioAgua,
			Integer consumoRateioEsgoto, Imovel imovel,
			MedicaoTipo medicaoTipo,
			gcom.faturamento.FaturamentoGrupo faturamentoGrupo, Rota rota,
			LeituraAnormalidade leituraAnormalidadeFaturamento,
			ConsumoTipo consumoTipo, ConsumoAnormalidade consumoAnormalidade,
			Conta conta, Set movimentoContaPrefaturadaCategorias,
			Set movimentoContaImpostoDeduzidos, Integer qntVezesImpressa) {
		this.id = id;
	...
	/** minimal constructor */
	public MovimentoContaPrefaturada(Integer id,
			Integer anoMesReferenciaPreFaturamento, Date dataHoraLeitura,
			Short indicadorSituacaoLeitura, Date dataHoraGeracaoMovimento,
			Short indicadorAtualizacaoFaturamento, Date utlimaAlteracao,
			Short indicadorEmissaoConta, Imovel imovel,
			MedicaoTipo medicaoTipo,
			gcom.faturamento.FaturamentoGrupo faturamentoGrupo, Rota rota,
			LeituraAnormalidade leituraAnormalidadeFaturamento,
			ConsumoTipo consumoTipo, ConsumoAnormalidade consumoAnormalidade,
			Conta conta, Set movimentoContaPrefaturadaCategorias,
			Set movimentoContaImpostoDeduzidos) {
		this.id = id;
		this.anoMesReferenciaPreFaturamento = anoMesReferenciaPreFaturamento;
		this.dataHoraLeitura = dataHoraLeitura;
		this.indicadorSituacaoLeitura = indicadorSituacaoLeitura;
	...
	public void setAnoMesReferenciaPreFaturamento(
			Integer anoMesReferenciaPreFaturamento) {
		this.anoMesReferenciaPreFaturamento = anoMesReferenciaPreFaturamento;
	}
	...
	public void setIndicadorAtualizacaoFaturamento(
			Short indicadorAtualizacaoFaturamento) {
		this.indicadorAtualizacaoFaturamento = indicadorAtualizacaoFaturamento;
	}
	...
	public void setFaturamentoGrupo(
	...
	public void setMovimentoContaPrefaturadaCategorias(
			Set movimentoContaPrefaturadaCategorias) {
		this.movimentoContaPrefaturadaCategorias = movimentoContaPrefaturadaCategorias;
	}
	...
	public void setMovimentoContaImpostoDeduzidos(
			Set movimentoContaImpostoDeduzidos) {
		this.movimentoContaImpostoDeduzidos = movimentoContaImpostoDeduzidos;
	}
	...
	public String getAnoMesReferenciaFormatado() {
		return Util.formatarAnoMesParaMesAno(String.valueOf(this
				.getAnoMesReferenciaPreFaturamento()));
	}

	public Short getIndicadorRisco() {
		return indicadorRisco;
	}

	public void setIndicadorRisco(Short indicadorRisco) {
...
//	}
//
//	public void setContratoDemandaComercialIndustrial(
//			ContratoDemandaComercialIndustrial contratoDemandaComercialIndustrial) {

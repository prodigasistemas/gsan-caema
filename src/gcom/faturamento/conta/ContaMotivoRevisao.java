...
public class ContaMotivoRevisao extends ObjetoTransacao {
    ...
    public static final Integer REVISAO_RECLAMACAO_CONSUMO = new Integer("92");
    public static final Integer REVISAO_RECORRENCIA = new Integer("96");
    public static final Integer REVISAO_FATURAMENTO_INDEVIDO = new Integer("103");
    ...
    public static final Integer SOLICITACAO_DE_DEVOLUCAO = new Integer("107");

...
private static UC0146ManterConta instancia;
	...
	*/
	...
	public void retificarConjuntoConta(Collection<Conta> colecaoContas, 
		...
		ContaMotivoRetificacao contaMotivoRetificacao, Short indicadorCategoriaEconomiaConta, SistemaParametro sistemaParametro, Usuario usuarioLogado, boolean substituirClienteConta) throws ControladorException {
			...
			while (colecaoContasIterator.hasNext()) {
				...
				if (podeRetificarConta){
					...
					this.getControladorFaturamento().retificarConta(
							...
							false,null,null,false, null,null,null,null,null,substituirClienteConta,null,false);
				}
			}
		}
	}

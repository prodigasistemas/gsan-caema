...
public class Conta extends ObjetoTransacao {
	...
	private Integer quantidadeImpressaoConvencional;
	
	private Integer quantidadeImpressaoSimultanea;
	
	private Short indicadorContaAlterada;
	
	private Integer quantidadeAlteracaoVinculo;
	
	private String descricaoObservacaoRetificacao;
	...
	public Conta(
		...
		this.indicadorContaAlterada = ConstantesSistema.NAO;
		this.quantidadeAlteracaoVinculo = new Integer("0");
	}
...
//	}
	...
	public Integer getQuantidadeImpressaoConvencional() {
		return quantidadeImpressaoConvencional;
	}

	public void setQuantidadeImpressaoConvencional(
			Integer quantidadeImpressaoConvencional) {
		this.quantidadeImpressaoConvencional = quantidadeImpressaoConvencional;
	}

	public Integer getQuantidadeImpressaoSimultanea() {
		return quantidadeImpressaoSimultanea;
	}

	public void setQuantidadeImpressaoSimultanea(
			Integer quantidadeImpressaoSimultanea) {
		this.quantidadeImpressaoSimultanea = quantidadeImpressaoSimultanea;
	}

	public Short getIndicadorContaAlterada() {
		return indicadorContaAlterada;
	}

	public void setIndicadorContaAlterada(Short indicadorContaAlterada) {
		this.indicadorContaAlterada = indicadorContaAlterada;
	}
	...
	public String getDescricaoObservacaoRetificacao() {
		return descricaoObservacaoRetificacao;
	}

	public void setDescricaoObservacaoRetificacao(String descricaoObservacaoRetificacao) {
		this.descricaoObservacaoRetificacao = descricaoObservacaoRetificacao;
	}
	...
	public Conta clone(){
		...
		for (Field field : declaredFields) {
			...
			if (!Modifier.isStatic(modifiers)) {
				...
				try {
					Field fieldClone = this.getClass().getDeclaredField(
							field.getName());
					fieldClone.setAccessible(true);
					fieldClone.set(clone, field.get(this));
				} catch (Exception e) {
					e.printStackTrace();
				}
			}

...
public class ContaMotivoRetificacao extends TabelaAuxiliar {
    ...
    private Short indicadorConcederCredito;
    ...
    public final static Integer RETIFICACAO_IMOVEL_CONTRATO_DEMANDA = 99;
	...
	public Short getIndicadorConcederCredito() {
		return indicadorConcederCredito;
	}

	public void setIndicadorConcederCredito(Short indicadorConcederCredito) {
		this.indicadorConcederCredito = indicadorConcederCredito;
	}

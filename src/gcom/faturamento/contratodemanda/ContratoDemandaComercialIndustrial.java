...
public class ContratoDemandaComercialIndustrial extends ObjetoTransacao implements Serializable {
    ...
    /** persistent field */
    private Integer numeroVolumeInformadoFixadoEsgoto;
    
    /** persistent field */
    private Integer numeroVolumeAgua;
    
    /** persistent field */
    private BigDecimal percentualColetaEsgoto;
    
    /** persistent field */
    private BigDecimal percentualValorTarifaAgua;

    /** persistent field */
    private ConsumoTarifa consumoTarifa;
    
    /** persistent field */
    private ContratoDemandaMotivoEncerramento motivoEncerramento;

    /** full constructor */
    public ContratoDemandaComercialIndustrial(Integer id, Date dataContratoInicio, Date dataContratoEncerrado, Date dataContratoFim, String numeroContrato, Date ultimaAlteracao) {
        this.id = id;
    ...
    /** default constructor */
    public ContratoDemandaComercialIndustrial() {
    }
	...
	public Integer getNumeroVolumeInformadoFixadoEsgoto() {
		return numeroVolumeInformadoFixadoEsgoto;
	}

	public void setNumeroVolumeInformadoFixadoEsgoto(Integer numeroVolumeInformadoFixadoEsgoto) {
		this.numeroVolumeInformadoFixadoEsgoto = numeroVolumeInformadoFixadoEsgoto;
	}
	...
	public BigDecimal getPercentualValorTarifaAgua() {
		return percentualValorTarifaAgua;
	}

	public void setPercentualValorTarifaAgua(BigDecimal percentualValorTarifaAgua) {
		this.percentualValorTarifaAgua = percentualValorTarifaAgua;
	}
	...
	public ContratoDemandaMotivoEncerramento getMotivoEncerramento() {
		return motivoEncerramento;
	}

	public void setMotivoEncerramento(ContratoDemandaMotivoEncerramento motivoEncerramento) {
		this.motivoEncerramento = motivoEncerramento;
	}
	
	public Integer getNumeroVolumeAgua() {
		return numeroVolumeAgua;
	}

	public void setNumeroVolumeAgua(Integer numeroVolumeAgua) {
		this.numeroVolumeAgua = numeroVolumeAgua;
	}

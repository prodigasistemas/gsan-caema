...
public class FiltroMovimentoContaPrefaturada extends Filtro {
    ...
    public final static String LEITURA_ANORMALIDADE_FATURAMENTO = "leituraAnormalidadeFaturamento.id";
    public final static String CONSUMO_ANORMALIDADE = "consumoAnormalidade.id";

	public final static String IMOVEL_ROTA_ALTERN_EMPRESA = "imovel.rotaAlternativa.empresa";

...
public class UC0745GerarArquivoTextoFaturamento {
    ...
    protected ControladorBatchLocal getControladorBatch() {
        ...
        // pega a insta¢ncia do ServiceLocator.
     ...
     * 
     * [FS0005] - Verificar exista™ncia do arquivo texto por rota
     * 
    ...
    public boolean verificarExistenciaArquivoTextoRota(Integer idRota, Integer anoMesReferencia) throws ControladorException {
        ...
        try {
             ...
             * informados e com situaaßa£o da transmissao de leitura igual a
             * dispona≠vel: Remover o registro encontrado.
             */
     ...
     * [UC0745] - Gerar Arquivo Texto para Faturamento
     * 
     * [FS0002] - Verificar Situaaßa£o Especial de Faturamento
     * 
     * @author Raphael Rossiter
     * @date 17/04/2008
     * 
    ...
    public Object[] pesquisarImovelGerarArquivoTextoFaturamento(Rota rota, int numeroIndice, int quantidadeRegistros,
        ...
        /*
         * Caso a rota na£o esteja com o indicador de rota alternativa ativo; a
         * pesquisa dos ima≥veis sera° feita a partir de sua quadra.
         */
        if (!rota.getIndicadorRotaAlternativa()
                 .equals(ConstantesSistema.SIM)) {

            try {
                imoveis = repositorioFaturamento.pesquisarImovelGerarArquivoTextoFaturamento(idRota, numeroIndice, quantidadeRegistros, sistemaParametro, idImovelCondominio,null);
         ...
         */
            ...
            try {
                ...
                imoveis = repositorioFaturamento.pesquisarImovelGerarArquivoTextoFaturamentoPorRotaAlternativa(idRota, numeroIndice, quantidadeRegistros, sistemaParametro, idImovelCondominio,null);
        ...
        if (imoveis != null && !imoveis.isEmpty()) {
            ...
            while (iteratorImoveis.hasNext()) {
                ...
                if (sistemaParametro.getCodigoEmpresaFebraban()
                    ...
                    // SE NaÉO FOR CAERN, ENTaÉO aâ COMPESA OU CAER
                    if (imovel.getImovelContaEnvio() != null
                            && (imovel.getImovelContaEnvio()
                                      .getId()
                ...
                // caso seja para emtir ou seja medido de a°gua ou poaßo
    ...
    public Object[] gerarArquivoTexto(Imovel imovel, Conta conta, Integer anoMesReferencia, Rota rota,
        ...
        Object[] registroTipo9e10 = gerarArquivoTextoRegistroDadosTarifa09(imovel, sistemaParametro, anoMesReferencia, faturamentoGrupo);
    ...
    public Object[] gerarArquivoTextoRegistroTipo04(Conta conta) throws ControladorException {
        ...
        if (conta != null) {
            ...
            // [SB0002] - Obter dados dos serviaßos e parcelamento - PARTE II
            // -----------------------------------------------------------------------------------------
                ...
                while (iterator.hasNext()) {
                    ...
                    if (debitoCobradoAnterior == null) {
                        ...
                        if (debitoCobradoAnterior.getAnoMesReferenciaDebito() != null) {
                            ...
                            // ACUMULA O VALOR DA PRESTAaáaÉO PARA OS DaâBITOS DE
                            // MESMO TIPO
                            valorPrestacaoAcumulado = debitoCobradoAnterior.getValorPrestacao();

                            // ACUMULA A QUANTIDADE DE ANO/MaäS DISTINTOS PARA O
                            // MESMO TIPO DE DaâBITO
                            qtdAnoMesDistintos++;

                            // CONCATENANDO OS ANO/MaäS DOS DEBITOS DE MESMO TIPO
                            anoMesAcumulado = Util.formatarAnoMesParaMesAno(debitoCobradoAnterior.getAnoMesReferenciaDebito());

                        } else {
                            quantidadeLinhas = quantidadeLinhas + 1;

                            // GERANDO - [SB0002] - Obter dados dos serviaßos e
                        ...
                        if (debitoCobradoAnterior.getAnoMesReferenciaDebito() != null) {
                            ...
                            // INICIALIZANDO O VALOR DA PRESTAaáaÉO PARA OS
                            // DaâBITOS DE MESMO TIPO
                            valorPrestacaoAcumulado = debitoCobradoAnterior.getValorPrestacao();
    ...
    public StringBuilder gerarArquivoTextoRegistroTipo01(Imovel imovel, Conta conta, Integer anoMesReferencia, Rota rota,
        ...
        if (conta != null) {
            ...
            // MONTANDO INSCRIaáaÉO DO IMOVEL A PARTIR DA CONTA
            // -----------------------------------------------------------------
        ...
        // NOME DO IMaìVEL OU NOME DO CLIENTE USUaÅRIO
        ...
        if (conta != null) {
            ...
            // MaäS/ANO DE REFERaäNCIA DA CONTA E DIGITO VERIFICADOR
        ...
        // CLIENTE RESPONSaÅVEL - CaìDIGO, NOME E ENDEREaáO
        ...
        // MATRaçCULA DO IMaìVEL CONDOMaçNIO
        ...
        // CONSUMO MaâDIO DO IMaìVEL

        // [UC1113 - Obter Volume Ma©dio aÅgua ou Esgoto]
        ...
        if (imovel.getLigacaoEsgoto() != null && imovel.getLigacaoEsgoto()
            ...
            arquivoTextoRegistroTipo01.append(Util.adicionarZerosEsquedaNumero(6, "0.00"));
        }
        ...
        // CONSUMO_TARIFA - Caso o imovel possua situacao especial faturamento (indicador cobrar consumo minimo ativo - Consumo tarifa = tarifa social)
        if ( imovel.getFaturamentoSituacaoTipo() != null && imovel.getFaturamentoSituacaoTipo().getIndicadorCobrarConsumoMinimo() != null &&
        	imovel.getFaturamentoSituacaoTipo().getIndicadorCobrarConsumoMinimo().equals(ConstantesSistema.SIM) ) {
        	
        	arquivoTextoRegistroTipo01.append(Util.adicionarZerosEsquedaNumero(2, ConsumoTarifa.CONSUMO_SOCIAL.toString()));
        ...
        // Obta©m a quantidade de economias por categoria
        ...
        while (colecaoCategoriaIterator.hasNext()) {
            ...
            // pr na∫mero de economias do ima≥vel
            ...
            // Obta©m a maior quantidade de economias e a vezes ma©dia de estouro
        ...
        if (cobrancaDocumento != null && !cobrancaDocumento.equals("")) {
            ...
            // 57. Ca≥digo de Barras do Documento do Cobranaßa
        ...
        if (dataLeituraAnteriorFaturamento == null || dataLeituraAnteriorFaturamento.equals("")) {
            // Obter data Prevista do cronograma do ma™s anterior
            try {
        ...
        // verificar se o ima≥vel a© Sazonal
        ...
        // Verificar se a© para faturar pela situaaßa£o especial de faturamento
        if (imovel.getFaturamentoSituacaoTipo() != null && !imovel.getFaturamentoSituacaoTipo()
            ...
            if ((faturamentoSituacaoHistorico != null
                ...
                // INDICADOR_PARALIZAaáaÉO_ESGOTO
                if (imovel.getFaturamentoSituacaoTipo()
                          .getIndicadorParalisacaoFaturamento() != null
                        && imovel.getFaturamentoSituacaoTipo()
                                 .getIndicadorParalisacaoFaturamento()
        ...
        // DATA DA EMISSaÉO DO DOCUMENTO DE COBRANCA
		...
		//N. 78 - RM 5981 - Indicador para desconsiderar Estouro de Consumo e Alto Consumo
		arquivoTextoRegistroTipo01.append(indicadorDesconsiderarEstouroAltoConsumo);
		
		//N. 79 - RM 6602 - Caso o ima≥vel aceite rateio negativo, desconsiderar quantidade ma°xima parametrizada no sistema
		arquivoTextoRegistroTipo01.append(imovel.getIndicadorRateioNegativo().toString());
    ...
    private StringBuilder gerarDadosSituacaoEspecialFaturamento(Imovel imovel, FaturamentoGrupo faturamentoGrupo)
		...
		// CONSUMO aÅGUA MEDIDO DO HISTORICO DE FATURAMENTO
		...
		// CONSUMO AGUA NAO MEDIDO DO HISTORICO DE FATURAMENTO
		...
		// VOLUME ESGOTO MEDIDO DO HISTORICO DE FATURAMENTO
		...
		// VOLUME ESGOTO NAO MEDIDO DO HISTORICO DE FATURAMENTO
		...
		// CONSUMO aÅGUA NAO MEDIDO DO HISTORICO DE FATURAMENTO
		arquivoTextoRegistroTipo01.append(Util.completaString("", 6));
                ...
                while (iterator.hasNext()) {
                    ...
                    if (creditoRealizadoAnterior == null) {
                        ...
                        if (creditoRealizadoAnterior.getAnoMesReferenciaCredito() != null) {
                            ...
                            // ACUMULA O VALOR DOS CRaâDITOS DE MESMO TIPO
                            valorCreditoAcumulado = creditoRealizadoAnterior.getValorCredito();

                            // ACUMULA A QUANTIDADE DE ANO/MaäS DISTINTOS PARA O
                            // MESMO TIPO DE CRaâDITO
                            qtdAnoMesDistintos++;

                            // CONCATENANDO OS ANO/MaäS DOS CRaâDITOS DE MESMO
                            // TIPO
                        ...
                        if (creditoRealizadoAnterior.getAnoMesReferenciaCredito() != null) {
                            ...
                            // INICIALIZANDO A QUANTIDADE DE ANO/MaäS DISTINTOS
                            // PARA O MESMO TIPO DE CRaâDITO
                            qtdAnoMesDistintos = 1;
    ...
    public Object[] gerarArquivoTextoRegistroTipo07(Imovel imovel, SistemaParametro sistemaParametro,
        ...
        //			
        // /*
        // * Data referente ao a∫ltimo dia do ano/ma™s de refera™ncia da
        // arrecadaaßa£o (PARM_AMREFERENCIAARRECADACAO
        // * da tabela SISTEMA_PARAMETROS) menos 1 ma™s.
        // */
        ...
        // mes, ano);
        //
        // //[UC0067] Obter Da©bito do Ima≥vel ou Cliente
        ...
        //					
        // //VALOR ACRaâSCIMOS IMPONTUALIDADE
        // arquivoTextoRegistroTipo07.append(Util.adicionarZerosEsquedaNumero(
        // 14,
    ...
    public Object[] gerarArquivoTextoRegistroTipo08(Imovel imovel, Integer anoMesReferencia,
        ...
        if (colecaoDadosMedicaoHistorico != null && !colecaoDadosMedicaoHistorico.isEmpty()) { 
            ...
            while (iterator.hasNext()) {
                ...
                // NaöMERO DE DaçGITOS DE LEITURA
                ...
                // Verifica se existe mediaßa£o historico para o ma™s ano atual.
                ...
                // DESCRIaáaÇO LOCAL INSTALAaáaÇO DO HIDROMETRO
                ...
                if (imovel.getFaturamentoSituacaoTipo() != null) {
                    ...
                    if ((faturamentoSituacaoHistorico != null
                        ...
                        if (imovel.getFaturamentoSituacaoTipo()
                            ...
                            // (tipoLigaaßa£o=aÅGUA(lgti_id=1)_e_FTST_ICVALIDOAGUA=1)
                            // ou
                            // (tipoligaaßa£o=POaáO(lgti_id=2)_e_FTST_ICVALIDOESGOTO=1)
                            if ((medicaoTipo.getId()
                ...
                arquivoTextoRegistroTipo08.append(Util.completaString(hidrometro.getTombamento(), 11));
    ...
    public Integer inserirArquivoTextoRoteiroEmpresa(Integer anoMesFaturamento, FaturamentoGrupo faturamentoGrupo,
        ...
        if (!apenasNaoEnviados) {
            ...
            // MENOR E MAIOR NaöMERO DA QUADRA PARA ROTA
    ...
    public Object[] gerarArquivoTextoRegistroDadosTarifa09(Imovel imovel, SistemaParametro sistemaParametro,
        ...
        try {
            ...
            if (tarifaTipoCalculo != null && tarifaTipoCalculo.getId()
                ...
                // caso na£o tenha a data de leitura anterior, pegar a data
                ...
                while (ite.hasNext()) {
                    ...
                    // caso exista e a data de leitura anterior na£o seja igual a
                    // data de vigencia
                    // na£o procura mais tarifa para esse ima≥vel
                    if (colecaoDadosTarifaProporcional != null && !colecaoDadosTarifaProporcional.isEmpty()) {
                        ...
                        // Caso na£o tenha encontrado nenhuma tarifa proporcional
                        ...
                        // coloca a coleaßa£o de vigencia proporcial caso exista
                        // sa≥ a© colocado nesse momento, para ficar ordenado pela
                        // data
                        // de vigencia
                        if (colecaoDadosTarifaProporcional != null && !colecaoDadosTarifaProporcional.isEmpty()) {
     ...
     * [UC0745] - Gerar Arquivo Texto para Faturamento
     * 
     * Formata a parte de padrao da qualidade da agua e a qualidade da agua
     * 
     * @author Savio Luiz
     * @date 13/07/2009
     * 
    ...
    public StringBuilder gerarArquivoTextoQualidadeAgua(Integer idLocalidade, Integer idSetor, Integer anoMesReferencia)
        ...
        // Pesquisa Dados Qualidade aÅgua Padra£o
        ...
        // Pesquisa Dados Qulaidade aÅgua
    ...
    public StringBuilder gerarArquivoTextoRegistroTipo11(SistemaParametro sistemaParametro, Imovel imovel)
        ...
        // Inscriaßa£o Estadual da Empresa
        ...
        // PERCENTUAL TOLERaÇNCIA PARA RATEIO
        ...
        // ICCREMENTO MaÅXIMO DE CONSUMO POR ECONOMIA
        arquivoTextoRegistroTipo11.append(Util.adicionarZerosEsquedaNumero(6, ""
        ...
        // INDICADOR DE ROTA DE MARCAaáaÉO
        ...
        arquivoTextoRegistroTipo11.append(Util.adicionarZerosEsquedaNumero(1, ""
                + sistemaParametro.getIndicadorPercentualColetaEsgoto()));
        
        // INDICADOR PARA DESCONSIDERAR O RATEIO DE ESGOTO
        arquivoTextoRegistroTipo11.append(Util.adicionarZerosEsquedaNumero(1, ""
                + sistemaParametro.getIndicadorDesconsiderarRateioEsgoto()));
            ...
            while (itConsumoAnormalidadeAcao.hasNext()) {
                ...
                for (ConsumoAnormalidadeAtividadeAcaoMensal consumo : colecaoAcaoMensal){  
	                ...
	                if (consumo.getLeituraAnormalidadeConsumo() != null
	                        && consumo.getLeituraAnormalidadeConsumo()
	                                                  .getId() != null) {
	                    arquivoTextoRegistroTipo12.append(Util.adicionarZerosEsquedaNumero(2, ""
	                            + consumo.getLeituraAnormalidadeConsumo()
	                                                     .getId()));
	                ...
	                arquivoTextoRegistroTipo12.append("00");	                
	                ...
	                arquivoTextoRegistroTipo12.append("0000");
	                ...
	                if (consumo.getDescricaoContaMensagem() != null
	                        && !consumo.getDescricaoContaMensagem()
	                                                   .equals("")) {
	                    arquivoTextoRegistroTipo12.append(Util.completaString(consumo.getDescricaoContaMensagem(), 120));
	                } else {
	                ...
	                arquivoTextoRegistroTipo12.append(Util.completaString(consumo.getCodigoOrdemMes().toString(), 2));
    ...
    public Object[] gerarArquivoTextoRegistroTipo14() throws ControladorException {
        ...
        //filtroLeituraAnormalidade.adicionarParametro(new ParametroSimplesDiferenteDe(FiltroLeituraAnormalidade.ID, LeituraAnormalidade.HIDROMETRO_PARADO_SEM_CONSUMO));
        ...
        if (colecaoLeituraAnormalidade != null && !colecaoLeituraAnormalidade.isEmpty()) {
            ...
            while (itLeituraAnormalidade.hasNext()) {
                ...
                // descriaßa£o da leitura Anormalidade
               ...
               //Indicador de exibir mensagem para os hidra¥metros cadastrados na calaßada e 
                ...
                //Indicador de exibir mensagem para os hidra¥metros substitua≠dos e 
                //que o leiturista informe uma anormalidade  
                ...
                // Indicador de na£o impressa£o da conta

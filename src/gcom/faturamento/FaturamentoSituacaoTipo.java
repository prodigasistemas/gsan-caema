...
public class FaturamentoSituacaoTipo extends ObjetoTransacao implements Serializable {
   ...
   // private Short indicadorFaturamentoParalisacaoEsgoto;
	...
	Amelia Pessoa */
    /** persistent field */
	private Short icDescEstouroAltoConsumo;
	
	/** persistent field */
	private Short indicadorCobrarConsumoMinimo;
    ...
    public final static Integer FATURAR_MAIOR_ENTRE_MEDIA_E_CONSUMO = new Integer(6);
    
    public final static Integer FATURAR_MAIOR_ENTRE_MEDIA_E_CONSUMO_FIXO = new Integer(15);
    
    public final static Integer INDICADOR_PARALIZACAO_LEITURA_SUSPENSA = new Integer("1");

    /** full constructor */
    public FaturamentoSituacaoTipo(String descricao, Short indicadorParalisacaoFaturamento, Short indicadorParalisacaoLeitura, Short indicadorUso, 
    		Date ultimaAlteracao, Short indicadorFaturamentoParalisacaoEsgoto, LeituraAnormalidadeLeitura leituraAnormalidadeLeituraComLeitura, 
    		LeituraAnormalidadeLeitura leituraAnormalidadeLeituraSemLeitura, LeituraAnormalidadeConsumo leituraAnormalidadeConsumoComLeitura, 
    		LeituraAnormalidadeConsumo leituraAnormalidadeConsumoSemLeitura, Short icDescEstouroAltoConsumo) {
        ...
        this.icDescEstouroAltoConsumo = icDescEstouroAltoConsumo;
    }
	...
	public Short getIcDescEstouroAltoConsumo() {
		return icDescEstouroAltoConsumo;
	}

	public void setIcDescEstouroAltoConsumo(Short icDescEstouroAltoConsumo) {
		this.icDescEstouroAltoConsumo = icDescEstouroAltoConsumo;
	}

	public Short getIndicadorCobrarConsumoMinimo() {
		return indicadorCobrarConsumoMinimo;
	}

	public void setIndicadorCobrarConsumoMinimo(Short indicadorCobrarConsumoMinimo) {
		this.indicadorCobrarConsumoMinimo = indicadorCobrarConsumoMinimo;
	}

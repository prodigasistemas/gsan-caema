 ...
 * @date 06/12/2012
 */
public class GuiaDevolucaoHelper implements Serializable {
	...
	private Integer idFuncionarioAnalista;
	private Integer idFuncionarioAutorizador;
	...
	public Integer getIdFuncionarioAnalista() {
		return idFuncionarioAnalista;
	}
	public void setIdFuncionarioAnalista(Integer idFuncionarioAnalista) {
		this.idFuncionarioAnalista = idFuncionarioAnalista;
	}
	public Integer getIdFuncionarioAutorizador() {
		return idFuncionarioAutorizador;
	}
	public void setIdFuncionarioAutorizador(Integer idFuncionarioAutorizador) {

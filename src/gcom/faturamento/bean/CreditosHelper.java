 ...
 * @date 16/03/2011, 07/12/2012
 */
public class CreditosHelper implements Serializable {
	
	private static final long serialVersionUID = 1L;
	
	private CreditoTipo tipoCredito;
	private CreditoOrigem origemCredito;
	...
	public CreditoOrigem getOrigemCredito() {
		return origemCredito;
	}
	public void setOrigemCredito(CreditoOrigem origemCredito) {
	...
	public CreditoTipo getTipoCredito() {
		return tipoCredito;
	}
	public void setTipoCredito(CreditoTipo tipoCredito) {

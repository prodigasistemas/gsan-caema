...
public class EmitirContaHelper implements Serializable {
	...
	private String descricaoTipoConsumoAgua;
	private String descricaoTipoConsumoEsgoto;
	
	private Integer tipoMedicao;
	private Integer tipoLigacao;
	
	private String somaValorAguaEsgotoBoleto;
	private String valorImpostoPisBoleto;
	private String valorImpostoConfinsBoleto;
	...
	public void setDadosConsumoMes1(String dadosConsumoMes1) {
		...
		this.dadosConsumoMes1 = dadosConsumoMes1.replaceAll("[-]", "");
	}
	...
	public void setDadosConsumoMes2(String dadosConsumoMes2) {
		this.dadosConsumoMes2 = dadosConsumoMes2.replaceAll("[-]", "");;
	}
	...
	public void setDadosConsumoMes3(String dadosConsumoMes3) {
		this.dadosConsumoMes3 = dadosConsumoMes3.replaceAll("[-]", "");;
	}
	...
	public void setDadosConsumoMes4(String dadosConsumoMes4) {
		this.dadosConsumoMes4 = dadosConsumoMes4.replaceAll("[-]", "");;
	}
	...
	public void setDadosConsumoMes5(String dadosConsumoMes5) {
		this.dadosConsumoMes5 = dadosConsumoMes5.replaceAll("[-]", "");;
	}
	...
	public void setDadosConsumoMes6(String dadosConsumoMes6) {
		this.dadosConsumoMes6 = dadosConsumoMes6.replaceAll("[-]", "");;
	}
...
//	}
	...
	public String getDescricaoTipoConsumoAgua() {
		return descricaoTipoConsumoAgua;
	}

	public void setDescricaoTipoConsumoAgua(String descricaoTipoConsumoAgua) {
		this.descricaoTipoConsumoAgua = descricaoTipoConsumoAgua;
	}

	public String getDescricaoTipoConsumoEsgoto() {
		return descricaoTipoConsumoEsgoto;
	}

	public void setDescricaoTipoConsumoEsgoto(String descricaoTipoConsumoEsgoto) {
		this.descricaoTipoConsumoEsgoto = descricaoTipoConsumoEsgoto;
	}
	...
	public String getSomaValorAguaEsgotoBoleto() {
		return somaValorAguaEsgotoBoleto;
	}

	public void setSomaValorAguaEsgotoBoleto(String somaValorAguaEsgotoBoleto) {
		this.somaValorAguaEsgotoBoleto = somaValorAguaEsgotoBoleto;
	}

	public String getValorImpostoPisBoleto() {
		return valorImpostoPisBoleto;
	}

	public void setValorImpostoPisBoleto(String valorImpostoPisBoleto) {
		this.valorImpostoPisBoleto = valorImpostoPisBoleto;
	}

	public String getValorImpostoConfinsBoleto() {
		return valorImpostoConfinsBoleto;
	}

	public void setValorImpostoConfinsBoleto(String valorImpostoConfinsBoleto) {
		this.valorImpostoConfinsBoleto = valorImpostoConfinsBoleto;
	}

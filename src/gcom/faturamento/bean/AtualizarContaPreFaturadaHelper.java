...
public class AtualizarContaPreFaturadaHelper {
    ...
    private static final int REGISTRO_TIPO_1_QNT_VEZES_IMPRESSA = 2;
...
//    private String idContratoDemanda;
   ...
   private AtualizarContaPreFaturadaHelper parserRegistroTipo1( String linha ){
       ...
       /* RM 5635 - Registrar a quantidade de vezes que a conta foi impressa através da ISC
		Amelia Pessoa */
       try {
    	   retorno.setQntVezesImpressa(linha.substring(index, index+REGISTRO_TIPO_1_QNT_VEZES_IMPRESSA));
	       index+=REGISTRO_TIPO_1_QNT_VEZES_IMPRESSA;
       } catch (StringIndexOutOfBoundsException ex){
    	   if (retorno.getIndicacaoEmissaoConta().intValue()==1){
    		   retorno.setQntVezesImpressa("1");
    	   }else{
    		   retorno.setQntVezesImpressa("0");
    	   }    	   
       }
       return retorno;       
   }
   ...
   private AtualizarContaPreFaturadaHelper parserRegistroTipo1Pipe(String linha){ 
       ...
       //34 - Indicador Risco
       retorno.indicadorRisco = dados.get(33);
       
//       retorno.idContratoDemanda = dados.get(34);
...
//	public String getIdContratoDemanda() {
//		return idContratoDemanda;
//	}
//
//	public void setIdContratoDemanda(String idContratoDemanda) {
//		this.idContratoDemanda = idContratoDemanda;
//	}

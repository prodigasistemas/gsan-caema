 ...
 * @since 12/11/2013
 */
public class ExecucaoOSRemocao extends ObjetoTransacao {
    ...
    public ExecucaoOSRemocao(ExecucaoOSPK comp_id, Integer numeroLeitura, Short indicadorTipoHidrometro, 
    		Short indicadorCavalete, Date ultimaAlteracao, HidrometroLocalInstalacao hidrometroLocalInstalacao, 
    ...
    public ExecucaoOSRemocao(Integer idArquivoTexto, String linha){
    	...
    	this.setIndicadorCavalete(new Short(colunas[4]));
        
        this.setUltimaAlteracao(new Date());
    }

    public ExecucaoOSRemocao() {

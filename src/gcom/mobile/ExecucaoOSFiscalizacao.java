...
public class ExecucaoOSFiscalizacao extends ObjetoTransacao {
    ...
    /** full constructor */
    public ExecucaoOSFiscalizacao(ExecucaoOSPK comp_id, Integer codigoDocumentoEntregue, Date ultimaAlteracao) {
    ...
    public ExecucaoOSFiscalizacao( Integer idArquivoTexto, String linha ) {
        ...
        Integer idDocumentoEntregue = Integer.parseInt( colunas[2] );
        ...
        this.setComp_id( pk );
        this.setCodigoDocumentoEntregue( idDocumentoEntregue );        
    }

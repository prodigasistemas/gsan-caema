...
public class ExecucaoOSFoto extends ObjetoTransacao{
	...
	private ExecucaoFotoOSPK comp_id;
	...
	public ExecucaoOSFoto( Integer idArquivo, Integer numeroOS, Integer tipoFoto, byte[] fotoOrdemServico ){
		ExecucaoFotoOSPK pk = new ExecucaoFotoOSPK();
	...
	public ExecucaoFotoOSPK getComp_id() {
		return comp_id;
	}

	public void setComp_id(ExecucaoFotoOSPK comp_id) {

...
public interface IControladorFinanceiro {
   ...
   /**
	 ...
	 * @date 30/01/2012
	 */
	public File gerarArquivoEFDPisConfins(Integer idFuncionalidadeIniciada, int tipoArquivo[], Integer anoMesReferencia, boolean quebraPorMunicipio, Short indicadorTipoGeracao) throws ControladorException;
	 ...
	 * @throws ControladorException
	 */
	public void gerarContasAReceberContabilAnaliticoTabelaAuxiliar(int idFuncionalidadeIniciada) throws ControladorException;
	 ...
	 * @throws ControladorException
	 */
	public void gerarContasAReceberContabilAnalitico(int idFuncionalidadeIniciada) throws ControladorException;
	 ...
	 * @throws ControladorException
	 */
	public void gerarContasAReceberContabilSintetico(int idFuncionalidadeIniciada) throws ControladorException;

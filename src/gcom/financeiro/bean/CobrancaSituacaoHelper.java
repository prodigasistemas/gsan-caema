...
public class CobrancaSituacaoHelper extends ValidatorActionForm {
	...
	private float valorPerdasFiscais;
	...
	public float getValorPerdasFiscais() {
		return valorPerdasFiscais;
	}

	public void setValorPerdasFiscais(float valorPerdasFiscais) {
		this.valorPerdasFiscais = valorPerdasFiscais;
	}

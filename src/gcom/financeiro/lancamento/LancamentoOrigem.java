...
public class LancamentoOrigem implements Serializable {
    ...
    public final static Integer PERDAS_FISCAIS = new Integer("3");
    
    public final static Integer PERDAS_SOCIETARIAS = new Integer("4");
    
    public final static Integer VOLUME_CONSUMIDO_NAO_FATURADO = new Integer("7");

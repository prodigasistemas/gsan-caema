...
public class AssinaturaDSA {
	...
	public static void main(String[] arg0){
		...
		AssinaturaDSA verificador = new AssinaturaDSA("/home/ipad/Downloads/DSA_PROGIS_Publica.xml");
		...
		String usur_nmlogin = "04244986421";
		String sign = "bN97BOS_pXuWYpwbR8azLPdYnm2LwWNCt5o0pb9knGgfyU6ncquh8Q".replace("-","/").replace("_","+")+"==";

...
import gcom.arrecadacao.ArrecadadorCritica;
...
import gcom.atendimentopublico.UnResKitCasServico;
...
import gcom.atendimentopublico.ordemservico.OSAtividadeOutrosServicosAcompanhamentoServico;
...
import gcom.atendimentopublico.ordemservico.OrdemServicoContas;
...
import gcom.cadastro.DocumentoImpedidoSorteio;
...
import gcom.cadastro.ImovelPremioSorteio;
...
import gcom.cadastro.imovel.ImovelAtualizacaoCadastralRemovido;
...
import gcom.cadastro.imovel.ImovelSubcategoriaHistorico;
...
import gcom.financeiro.ResumoFaturamentoPpp;
...
import gcom.integracao.CarroPipaAbastecimento;
...
import gcom.micromedicao.hidrometro.HidrometroModeloSensor;
...
import gcom.mobile.ArquivoTextoOSCobrancaItem;
...
import gcom.mobile.ParametrosArquivoTextoOSServicoTipo;
...
import gcom.seguranca.AcessoReceitaFederal;
...
import gcom.seguranca.acesso.usuario.PermissaoEspecialOperacao;
...
import gcom.seguranca.acesso.usuario.UsuarioBDHistorico;
...
public class HibernateUtil {
	...
	private static SessionFactory sessionFactoryIntegracaoAtualizacaoCadastral;
	...
	private static Configuration configurationAtualizacaoCadastral;
		
	private static HashMap<Long, Long> tempoSession = new HashMap<Long, Long>();
	...
	public static void inicializarSessionFactoryIFS() {
		...
		try{
			...
			System.out.println("Sem conexao com a base IFS");
		}
	...
	public static void inicializarSessionFactory() {
		...
		try {
			...
			configurationGerencial.addClass(UnResumoArrecadacao.class).
				...
				addClass(UnResKitCasServico.class);
			...
			// **********************************************/
				    ...
				    .addClass(SubstituicaoHidrometroAcompanhamentoServico.class)
				    .addClass(CobrancaIndevidaMotivo.class)
				    .addClass(RegistroAtendimentoDevolucaoValores.class)
				    .addClass(CoordenadasCompGis.class)
					...
					.addClass(ComandoOsSetor.class)
					.addClass(PesquisaSatisfacaoLoja.class)
					.addClass(EtapaOrdemServico.class)
					.addClass(OsAcompanhamentoMotivoNaoAceite.class)
					.addClass(UsuarioUnidadeAcompEquipe.class)
					.addClass(ProgramacaoDiasEspeciais.class)
					.addClass(SmsTipo.class)
				    .addClass(MensagemSms.class)
				    .addClass(ParametrosSms.class)
				    .addClass(ServicoRepavimentadora.class)
				    .addClass(OrdemRepavimentadoraServico.class)
				    .addClass(UnidadeRepavimentadoraMunicipio.class)
				    .addClass(UnidadeRepavimentadoraMunicipioBairros.class)
				    .addClass(MotivoDeNaoExecucaoDoServico.class)
				    .addClass(MotivoNaoExecucaoUnidadeRepavimentadora.class)
				    .addClass(OSAtividadeOutrosServicosAcompanhamentoServico.class)
			        .addClass(ComandoOSConexaoEsgoto.class)
				    .addClass(MotivoNaoEmissaoCartaEsgoto.class)
				    .addClass(OrdemServicoNaoEmissaoCartaEsgoto.class)
				    .addClass(EquipeNatureza.class)
				    .addClass(OrdemServicoContas.class)
				    .addClass(UsuarioEmpresaAcompEquipe.class)
				    .addClass(UsuarioNaturezaAcompEquipe.class)
				    .addClass(ServicoTipoPerfilEquipe.class)
				    .addClass(NormaDocumentoTipo.class)
				    .addClass(NormaProcedimentos.class)
				    .addClass(NormaArquivos.class)
				    .addClass(ResolucaoImagem.class)
					.addClass(LocalidadeSistemaAbastecimento.class)
				    
					// *************************************//
					// CLASSES DO PACOTE gcom.cadastro //
					// *************************************//
					.addClass(VersaoMobile.class)
					.addClass(ImovelPremioSorteio.class)
					...
					.addClass(EsferaPoder.class).addClass(
							...
							.addClass(MotivoRejeicaoClienteVirtual.class)
							.addClass(ClienteContaAnterior.class)
							.addClass(ImovelFotoAtualizacaoCadastral.class)
							.addClass(ImovelOcorrenciaAtualizacaoCadastral.class)
					.addClass(ClienteUnificado.class)
					...
					.addClass(ImovelContaEnvio.class).addClass(
							...
							.addClass(AtributoAtualizacaoCadastral.class)
							.addClass(RetornoAtualizacaoCadastral.class)
							.addClass(MensagemAtualizacaoCadastral.class)
							.addClass(Cadastrador.class)
							.addClass(HidrometroInstalacaoHistoricoAtualizacaoCadastral.class)
							.addClass(AreaAtualizacaoCadastral.class)
							.addClass(ImovelFoto.class)
							.addClass(CapaLoteAtualizacaoCadastral.class)
							.addClass(CapaLoteLogradouroAtualizacaoCadastral.class)
							.addClass(ImovelSubcategoriaHistorico.class)
							.addClass(OcorrenciaResetorizacao.class)
							.addClass(ImovelInscricaoResetorizada.class)
							.addClass(AtualizacaoCadastralArquivoTexto.class)
							.addClass(ImovelAtualizacaoCadastralRemovido.class)
					...
					.addClass(LogradouroAdmin.class)
					.addClass(LogradouroGsanAdmin.class)
					.addClass(BairroAdmin.class)
					.addClass(BairroGsanAdmin.class)
					.addClass(SistemaAndroid.class)
					.addClass(VersaoSistemasAndroid.class)
					.addClass(ImovelAptoSorteioMensal.class)
					.addClass(Sorteios.class)
					.addClass(CepAtlzCad.class)
					.addClass(LogradouroAtlzCad.class)
					.addClass(LogradouroCepAtlzCad.class)
					.addClass(LogradouroBairroAtlzCad.class)
					.addClass(RoteiroQuadraAtlzCad.class). 
					addClass(ImovelEnderecoArquivoTexto.class)
					// *************************************//
					...
					.addClass(CobrancaGrupo.class).addClass(
							...
							.addClass(ComandoImovelCobrancaSituacao.class)
							.addClass(MotivoNaoGeracaoCobrancaResultado.class)
							.addClass(ImovelContaNaoGeracaoCobrancaResultado.class)
							.addClass(HistoricoPagamentoCobrancaResultado.class)
						
							.addClass(RdLimitacaoGeografica.class)
							.addClass(RdLimitacaoGeograficaLocalidade.class)
							.addClass(PagamentoNaoGeracaoCobrancaResultado.class)
							.addClass(ComandoEmpresaCobrancaContaFaixa.class)
							.addClass(EmpresaCobrancaContaProporcionalidade.class)
							.addClass(ComandoAtividadeImoveis.class)
							.addClass(ComandoEmpresaCobrancaContaAcaoCobranca.class)
							.addClass(ParcelamentoJudicial.class)
							.addClass(ParcelamentoJudicialItem.class)
							.addClass(ParcelamentoJudicialImovel.class)
							.addClass(ParcelaEntradaDesconto.class)
							.addClass(DescontoValorDebitoPeriodo.class)
							.addClass(ComandoEmpresaCobrancaContaCobrancaSituacao.class)
							// *************************************//
...
//							.addClass(CobrancaBoletimSucesso.class)
					...
					.addClass(ImpostoTipoAliquota.class).addClass(
							...
							.addClass(DebitosGsanJudiciais.class)
							.addClass(ImovelGsanJudiciais.class)
							.addClass(ComandoOsAnormalidade.class)
							.addClass(ComandoOsAnormalidadeGrupo.class)
					...
					.addClass(ConsumoTarifa.class).addClass(
							...
							ConsumoTarifaFaixa.class).addClass(
							ConsumoTarifaPpp.class).addClass(
							ConsumoTarifaVigenPpp.class).addClass(
							ConsumoTarifaCategPpp.class).addClass(
							ConsumoTarifaFaixaPpp.class)
					...
					.addClass(HidrometroCapacidade.class).addClass(
							...
							.addClass(HidrometroModeloSensor.class)
					...
					.addClass(ConsumoHistorico.class).addClass(
							...
							.addClass(ConsumoAnormalidadeAtividadeAcao.class )
							.addClass(ConsumoAnormalidadeAtividadeAcaoMensal.class )
					...
					.addClass(LancamentoContabil.class).addClass(
							...
							ValorConsumidoNaoFaturadoParametro.class).addClass(
							ResumoFaturamentoPpp.class)
					...
					.addClass(ArrecadadorCritica.class)
					.addClass(ArrecadadorMovimentoCriticas.class)
					// *************************************//
					...
					.addClass(ZonaPressao.class).addClass(ProducaoAgua.class).addClass(
							SubSistemaEsgoto.class).addClass(SubSistemaEsgotoArquivoTexto.class).addClass(
									SubSistemaEsgotoArquivoTextoErro.class)
					.addClass(SubsistemaAbastecimento.class)
					.addClass(SubsistemaSistemaAbastecimento.class)
					.addClass(SetorSubsistemaAbastecimento.class)					
					.addClass(AreaOperacional.class)
					.addClass(DistritoSetorAbastecimento.class)
					.addClass(AreaDistritoOperacional.class)
					.addClass(ZonaAreaOperacional.class)
					// ************************************//
					...
					.addClass(UsuarioAfastamentoMotivo.class)
					.addClass(UsuarioAfastamento.class)
					.addClass(UsuarioBDHistorico.class)
					.addClass(SolicitacaoAcessoMotivoNaoAutorizacao.class)
					.addClass(SolicitacaoAcessoPermissao.class)
					.addClass(PermissaoEspecialOperacao.class)
					.addClass(MotivoNaoAutorizacao.class)
					
					
					.addClass(ConsultarReceitaFederal.class)
					.addClass(AcessoReceitaFederal.class)
					.addClass(PremioSorteio.class)
					.addClass(ImovelAptoSorteio.class)
					.addClass(DocumentoImpedidoSorteio.class)
					.addClass(ImovelCadastroSorteio.class)
					.addClass(RdRestricaoUsuario.class)
					.addClass(CobrancaAcaoAtividadeComandoLocalidade.class)
					.addClass(CobrancaAcaoAtividadeComandoSetorComercial.class)
					// ************************************//
					...
					// ***************************************************//
					.addClass(ContratoDemandaComercialIndustrial.class)
					.addClass(ContratoDemandaImovelComercialIndustrial.class)
					...
					.addClass(ExecucaoOSSupressao.class)
					.addClass(ParametrosArquivoTextoOSCobranca.class)
					.addClass(ParametrosArquivoTextoOSServicoTipo.class)
					.addClass(ArquivoTextoOSCobrancaItem.class)
					.addClass(ExecucaoOSFoto.class)
					.addClass(ExecucaoOSSubstituicao.class)
					.addClass(ExecucaoOSRemocao.class)
					.addClass(ExecucaoOSCaixaProtecao.class)
			
				   // *************************************//
				   // CLASSES DO PACOTE gcom.integracao //
				   // *************************************//
				   .addClass(CarroPipaRetornoTipo.class)
				   .addClass(CarroPipaRetornoOcorrencia.class)
				   .addClass(CarroPipaAbastecimento.class);
...
//				try {
//					if (getDialect().toUpperCase().contains("ORACLE")){
////						HibernateUtil.inicializarSessionFactoryAtualizacaoCadastral();
//					}
//				} catch (Exception e) {
//					e.printStackTrace();
//				}			
//			}
	...
	public static void inicializarSessionFactoryAtualizacaoCadastral() {
		configurationAtualizacaoCadastral = new Configuration();
		
		configurationAtualizacaoCadastral.setProperty("hibernate.connection.datasource", "java:/PostgresDSAtualizaoCadastral");
		configurationAtualizacaoCadastral.setProperty("hibernate.connection.release_mode", "after_transaction");
		configurationAtualizacaoCadastral.setProperty("hibernate.dialect","org.hibernate.dialect.PostgreSQLDialect");

		
		configurationAtualizacaoCadastral.addClass(AtcClienteImovelRetorno.class)
										 .addClass(AtcClienteRetorno.class)
										 .addClass(AtcClienteTelefoneRetorno.class)
										 .addClass(AtcHidrometroInstalacaoRetorno.class)
										 .addClass(AtcImovelRetorno.class)
										 .addClass(AtcSubcategoriaImovelRetorno.class)
										 .addClass(AtcClienteImovel.class)
										 .addClass(AtcCliente.class)
										 .addClass(AtcClienteTelefone.class)
										 .addClass(AtcHidrometroInstalacao.class)
										 .addClass(AtcImovel.class)
										 .addClass(AtcSubcategoriaImovel.class)
										 .addClass(AcaAtualizadores.class)
										 .addClass(AtcLogradouro.class)
										 .addClass(AtcBairro.class)
										 .addClass(AtcMunicipio.class);
		try{
			sessionFactoryIntegracaoAtualizacaoCadastral = configurationAtualizacaoCadastral.buildSessionFactory();
		} catch (Exception e) {
			System.out.println("Sem conexao com a base atualizacao_cadastra_admin");
		}
	}
	...
	public static Session getSession() {
		...
		try {
			...
			//--TRECHO DE CÓDIGO COMENTADO EM 01/06/2012. ESTAVA OCORRENDO UM ERRO NA APLICAÇÃO POR CAUSA DO HASHCODE MUITO GRANDE.
			//--A LINHA ABAIXO NÃO SERVIA PARA NADA.
			//tempoSession.put(((long)retorno.hashCode()), System.currentTimeMillis());
			//--------------------------------------------------------------------------------------------------------------------
		} catch (HibernateException ex) {
			ex.printStackTrace();
	...
	public static StatelessSession getStatelessSessionIntegracaoAtualizacaoCadastral() {
		StatelessSession retorno = null;

		
			try {
				retorno = sessionFactoryIntegracaoAtualizacaoCadastral == null ? null : sessionFactoryIntegracaoAtualizacaoCadastral.openStatelessSession();
			} catch (HibernateException ex) {
				ex.printStackTrace();
				throw new SistemaException("Hibernate - Erro ao criar a Session Integracao Atualizacao Cadastral");
			}
	 ...
	 * @return O valor de session
	 */
	public static Session getSessionIntegracaoAtualizacaoCadastral() {
		Session retorno = null;

		
			try {
				retorno = sessionFactoryIntegracaoAtualizacaoCadastral == null ? null : sessionFactoryIntegracaoAtualizacaoCadastral.openSession();
			} catch (HibernateException ex) {
				ex.printStackTrace();
				throw new SistemaException(
						"Hibernate - Erro ao criar a Session Integracao IFS");
	...
	private static void verificaBaseDadosTipo() {
		...
		configurationGerencial.setProperty("hibernate.dialect","org.hibernate.dialect.Oracle9Dialect");
		
		configuration.setProperty("hibernate.connection.datasource","java:/OracleDS");
	 ...
	 * Método retorna a string de conexão ao banco de dados.
	...
	public static String getStringConexao(){
		try {
			return getSession().connection().getMetaData().getURL();

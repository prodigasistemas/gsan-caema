...
public class ConstantesJNDI {
	...
	public static String BATCH_GERAR_RESUMO_ACOES_ORDEM_DE_SERVICO_MDB = "";
	...
	public static String BATCH_GERAR_ORDEM_SERVICO_CONEXAO_ESGOTO_MDB = "";
	
	public static String BATCH_ENCERRAR_ORDEM_SERVICO_CONEXAO_ESGOTO_CONCLUSAO_SERVICO_MDB = "";
	...
	public static String BATCH_GERAR_DEBITOS_ATUALIZADOS_JURIDICO_MDB = "";
	
	public static String BATCH_INFORMAR_SITUACAO_COBRANCA_JURIDICO_MDB = "";
	
	public static String BATCH_ATUALIZAR_PERIODO_FINAL_REFERENCIA_IMOVEL_COBRANCA_JUDICIAL_MDB = "";
	
	public static String BATCH_ENVIAR_EMAIL_USUARIOS_SUPERIORES_MDB = "";	

	public static String BATCH_GERAR_OS_ANORMALIDADE_CONSUMO_MDB = "";
	
	public static String BATCH_ATUALIZAR_DADOS_DO_IMOVEL_PELO_RECADASTRAMENTRO_MDB = "";
	
	public static String BATCH_GERAR_BASE_DE_CLIENTE_PARA_SORTEIO_MDB = "";
	...
	public static String BATCH_GERAR_RESUMO_KIT_CAS_SERVICO_MDB = "";
	...
	public static String BATCH_RECEPCAO_DADOS_ADMIN = "";
	
	public static String BATCH_INSERIR_DADOS_ADMIN = "";
	
	public static String BATCH_ATUALIZAR_TABELA_BASICA_RECEPCAO_DADOS_ADMIN = "";
	
	public static String BATCH_ATUALIZAR_LOGRADOURO_IMOVEL_ATUALIZACAO_CADASTRAL = "";
	
	public static String BATCH_DETALHAR_ARRECADAMENTO_LIQUIDO_ENCERRAMENTO_MES = "";
	
	public static String BATCH_GERAR_RESUMO_SIM_MDB = "";
	
	public static String BATCH_GERAR_MOTIVOS_NAO_GERACAO_CONTAS_IMOVEIS_COB_EMPRESA = "";
	
	public static String BATCH_REGISTRAR_AUTOMATICAMENTE_MOV_ARRECADADORES = "";
	
	public static String BATCH_ENCERRAR_AUTOMATICAMENTE_COMANDOS_COB_RESULTADO = "";
	
	public static String BATCH_GERAR_RESUMO_PENDENCIA_BD = "";
	
	public static String BATCH_GERAR_ARQUIVOS_EFD_PIS_CONFINS = "";

	public static String BATCH_GERAR_ARQUIVO_TEXTO_PARCELAMENTOS_NEGOCIADOS_EMPRESAS_COBRANCA = "";
	
	public static String BATCH_ATUALIZAR_SITUACAO_LIGACAO_AGUA_IMOVEL_FISCALIZADO = "";
	
	public static String BATCH_GERAR_ARQUIVO_TEXTO_CODIGO_BARRAS_DOCUMENTO_COBRANCA = "";
	
	public static String BATCH_CONCEDER_CREDITO_CONJUNTO_CONTAS_MDB = "";
	
	public static String BATCH_PROCESSAR_ARQUIVO_RESETORIZACAO_IMOVEIS_MDB = "";
	
	public static String BATCH_VALIDAR_RESETORIZACAO_IMOVEIS_MDB = "";
	
	public static String BATCH_GERAR_BASE_CLIENTE_SORTEIO_MENSAL_MDB = "";
	
	public static String BATCH_RETIRAR_SITUACAO_ESPECIAL_FATURAMENTO_MDB = "";
	...
	public static String BATCH_GERAR_INTEGRACAO_CONTABILIDADE = "";
	
	public static String BATCH_GERAR_RESUMO_CONSUMO_AGUA_BD = "";
	
	public static String BATCH_UNIFICAR_ID_CLIENTES_MESMO_DOCUMENTO = "";
	
	public static String BATCH_GERAR_RELATORIO_CLIENTES_MESMO_CPF_CNPJ = "";
	
	public static String BATCH_ATUALIZAR_INDICADOR_FATURAMENTO_LIGACOES_CORTADAS = "";
	
	public static String BATCH_ATUALIZAR_MES_ANO_CONTABIL_DEBITOS_A_COBRAR = "";
	
	public static String BATCH_SUSPENDER_FATURAMENTO_AGUA_IMOVEIS_LIGADOS_EM_ANALISE = "";
	
	public static String BATCH_SUSPENDER_FATURAMENTO_ESGOTO_IMOVEIS_TARIFA_SOCIAL = "";
	
	public static String BATCH_GERAR_GUIA_ATRASO_PARCELAMENTO_JUDICIAL = "";
	
	public static String BATCH_ATUALIZAR_CONTAS_VALORES_ESGOTO_PPP = "";
	
	public static String BATCH_GERAR_RESUMO_FATURAMENTO_ANALITICO_SINTETICO_PPP = "";
	
	public static String BATCH_ATUALIZAR_SUBSISTEMA_ESGOTO_IMOVEL = "";
	
	public static String BATCH_GERAR_OS_FACTIVEL_FATURAVEL = "";
	
	public static String BATCH_ENCERRAR_OS_NAO_EXECUCAO = "";
	
	public static String BATCH_VALIDAR_DADOS_DO_ENDERECO_ENVIADOS_PELO_GEO = "";

	public static String BATCH_GERAR_DEBITO_A_COBRAR_CARRO_PIPA = "";
	...
	public static void inicializarPropriedades() {
		...
		try {
			...
			QUEUE_CONTROLADOR_COBRANCA_MDB = propriedades
					.getProperty("QueueControladorCobranca");
			...
			BATCH_GERAR_RESUMO_ACOES_ORDEM_DE_SERVICO_MDB = propriedades
					.getProperty("QueueBatchGerarResumoAcoesOrdemDeServicoMDB");			
			...
			BATCH_GERAR_DEBITOS_ATUALIZADOS_JURIDICO_MDB = propriedades
					.getProperty("QueueBatchGerarDebitosAtualizadosParaJuridicoMDB");
			
			BATCH_INFORMAR_SITUACAO_COBRANCA_JURIDICO_MDB = propriedades
					.getProperty("QueueBatchInformarSituacaoCobrancaJuridicoMDB");
			
			BATCH_ATUALIZAR_PERIODO_FINAL_REFERENCIA_IMOVEL_COBRANCA_JUDICIAL_MDB = propriedades
					.getProperty("QueueBatchAtualizarPeriodoFinalReferenciaImovelCobrancaSituacaoMDB");
			...
			BATCH_ENVIAR_EMAIL_USUARIOS_SUPERIORES_MDB = propriedades
					.getProperty("QueueBatchEnviarEmailUsuariosSuperioresMDB");
			
			BATCH_GERAR_OS_ANORMALIDADE_CONSUMO_MDB = propriedades
					.getProperty("QueueBatchGerarOsAnormalidadeConsumoMDB");
			
			BATCH_ATUALIZAR_DADOS_DO_IMOVEL_PELO_RECADASTRAMENTRO_MDB = propriedades
					.getProperty("QueueBatchAtualizarDadosDoImovelPeloRecadastramentoMDB");
			
			BATCH_GERAR_BASE_DE_CLIENTE_PARA_SORTEIO_MDB = propriedades
					.getProperty("QueueBatchGerarBaseDeClienteParaSorteioMDB");
			...
			BATCH_EXECUTAR_CARGA_ARRECADACAO_GERENCIAL_POR_ANO = propriedades
					.getProperty("QueueBatchExecutarCargaArrecadacaoGerencialAnoMDB");
			...
			BATCH_GERAR_RESUMO_KIT_CAS_SERVICO_MDB = propriedades
					.getProperty("QueueBatchGerarResumoKitCASServicoMDB");
		
			BATCH_RECEPCAO_DADOS_ADMIN = propriedades
					.getProperty("QueueBatchRecepcaoDadosAdminMDB");
			
			BATCH_INSERIR_DADOS_ADMIN = propriedades
					.getProperty("QueueBatchInserirDadosAdminMDB");
			
			BATCH_ATUALIZAR_TABELA_BASICA_RECEPCAO_DADOS_ADMIN = propriedades.getProperty("QueueBatchAtualizarTabelasBasicasRecepcaoDadosAdminMDB");
			
			BATCH_ATUALIZAR_LOGRADOURO_IMOVEL_ATUALIZACAO_CADASTRAL = propriedades.getProperty("QueueBatchAtualizarLogradouroImovelAtualizacaoCadastralMDB");
			
			BATCH_DETALHAR_ARRECADAMENTO_LIQUIDO_ENCERRAMENTO_MES = propriedades
					.getProperty("QueueBatchDetalharArrecadacaoLiquidaEncerramentoMesMDB");
		
			BATCH_GERAR_RESUMO_SIM_MDB = 
					propriedades.getProperty("QueueBatchGerarResumoSIMMDB");

			BATCH_GERAR_MOTIVOS_NAO_GERACAO_CONTAS_IMOVEIS_COB_EMPRESA = 
					propriedades.getProperty("QueueBatchGerarMotivosNaoGeracaoContasImoveisCobrancaEmpresaMDB");
			
			BATCH_REGISTRAR_AUTOMATICAMENTE_MOV_ARRECADADORES = propriedades
					.getProperty("QueueBatchRegistrarAutomaticamenteMovimentosArrecadadoresMDB");
			
			BATCH_ENCERRAR_AUTOMATICAMENTE_COMANDOS_COB_RESULTADO = propriedades
					.getProperty("QueueBatchEncerrarAutomaticamenteComandosCobResultadoMDB");
			
			BATCH_GERAR_RESUMO_PENDENCIA_BD = propriedades
					.getProperty("QueueBatchGerarResumoPendenciaBDMDB");
			
			BATCH_GERAR_ARQUIVOS_EFD_PIS_CONFINS = propriedades
					.getProperty("QueueBatchGerarArquivoEfdPisCofinsMDB");

			BATCH_GERAR_ARQUIVO_TEXTO_PARCELAMENTOS_NEGOCIADOS_EMPRESAS_COBRANCA = propriedades
					.getProperty("QueueBatchGerarArquivoTextoParcelamentosNegociadosEmpresasCobrancaMDB");
			
			BATCH_ATUALIZAR_SITUACAO_LIGACAO_AGUA_IMOVEL_FISCALIZADO = propriedades
					.getProperty("QueueBatchAtualizarSituacaoLigacaoAguaImovelFiscalizadoMDB");
			
			BATCH_GERAR_ARQUIVO_TEXTO_CODIGO_BARRAS_DOCUMENTO_COBRANCA = propriedades
					.getProperty("QueueBatchGerarArquivoTextoCodigoBarrasDocumentoCobrancaMDB");
			
			BATCH_CONCEDER_CREDITO_CONJUNTO_CONTAS_MDB = propriedades
					.getProperty("QueueBatchConcederCreditoConjuntoContasMDB");
			
			BATCH_PROCESSAR_ARQUIVO_RESETORIZACAO_IMOVEIS_MDB = propriedades
					.getProperty("QueueBatchProcessarArquivoResetorizacaoImoveisMDB");
			
			BATCH_VALIDAR_RESETORIZACAO_IMOVEIS_MDB = propriedades
					.getProperty("QueueBatchValidarResetorizacaoImoveisMDB");
			
			BATCH_GERAR_BASE_CLIENTE_SORTEIO_MENSAL_MDB = propriedades
					.getProperty("QueueBatchGerarBaseClienteSorteioMensalMDB");
			
			BATCH_RETIRAR_SITUACAO_ESPECIAL_FATURAMENTO_MDB = propriedades
					.getProperty("QueueBatchRetirarSituacaoEspecialFaturamentoMDB");
			...
			BATCH_UNIFICAR_ID_CLIENTES_MESMO_DOCUMENTO = propriedades
					.getProperty("QueueBatchUnificarIDClientesComMesmoDocumentoMDB");

			BATCH_GERAR_RELATORIO_CLIENTES_MESMO_CPF_CNPJ = propriedades
					.getProperty("QueueBatchGerarRelatorioClientesMesmoCpfCnpjMDB");
			
			BATCH_GERAR_INTEGRACAO_CONTABILIDADE = propriedades
					.getProperty("QueueBatchGerarIntegracaoContabilidadeMDB");
			BATCH_GERAR_RESUMO_CONSUMO_AGUA_BD = propriedades
					.getProperty("QueueBatchGerarResumoConsumoAguaBDMDB");
			
			BATCH_ATUALIZAR_INDICADOR_FATURAMENTO_LIGACOES_CORTADAS = propriedades
					.getProperty("QueueBatchAtualizarIndicadorFaturamentoLigacoesCortadasMDB");
			
			BATCH_ATUALIZAR_MES_ANO_CONTABIL_DEBITOS_A_COBRAR = propriedades
					.getProperty("QueueBatchAtualizarMesAnoContabilDebitosACobrarMDB");
			
			BATCH_SUSPENDER_FATURAMENTO_AGUA_IMOVEIS_LIGADOS_EM_ANALISE = propriedades
					.getProperty("QueueBatchSuspenderFaturamentoAguaImoveisLigadosEmAnaliseMDB");
			
			BATCH_SUSPENDER_FATURAMENTO_ESGOTO_IMOVEIS_TARIFA_SOCIAL = propriedades
					.getProperty("QueueBatchSuspenderFaturamentoEsgotoImoveisTarifaSocialMDB");
			
			BATCH_GERAR_GUIA_ATRASO_PARCELAMENTO_JUDICIAL = propriedades
					.getProperty("QueueBatchGerarGuiaAtrasoParcelamentoJudicialMDB");
			
			BATCH_ATUALIZAR_CONTAS_VALORES_ESGOTO_PPP = propriedades
					.getProperty("QueueBatchAtualizarContasValoresEsgotoPPPMDB");
			
			BATCH_GERAR_RESUMO_FATURAMENTO_ANALITICO_SINTETICO_PPP = propriedades
					.getProperty("QueueBatchGerarResumoFaturamentoAnaliticoSinteticoPPPMDB");
			
			BATCH_ATUALIZAR_SUBSISTEMA_ESGOTO_IMOVEL = propriedades
					.getProperty("QueueBatchAtualizarSubsistemaEsgotoImovelMDB");
			
			BATCH_GERAR_ORDEM_SERVICO_CONEXAO_ESGOTO_MDB = propriedades
					.getProperty("QueueBatchGerarOrdemServicoConexaoEsgotoMDB");
			
			BATCH_GERAR_OS_FACTIVEL_FATURAVEL = propriedades
					.getProperty("QueueBatchGerarOrdensServicoFactivelFaturavelMDB");
			
			BATCH_ENCERRAR_OS_NAO_EXECUCAO = propriedades
					.getProperty("QueueBatchEncerrarOrdemServicoNaoExecucaoMDB");
			
			BATCH_ENCERRAR_ORDEM_SERVICO_CONEXAO_ESGOTO_CONCLUSAO_SERVICO_MDB = propriedades
					.getProperty("QueueBatchEncerrarOrdemServicoConexaoEsgotoConclusaoServicoMDB");
			
			BATCH_VALIDAR_DADOS_DO_ENDERECO_ENVIADOS_PELO_GEO = propriedades
					.getProperty("QueueBatchValidarDadosDoEnderecoEnviadosPeloGEOMDB");
			
			BATCH_GERAR_DEBITO_A_COBRAR_CARRO_PIPA = propriedades
					.getProperty("QueueBatchGerarDebitoACobrarCarroPipaMDB");

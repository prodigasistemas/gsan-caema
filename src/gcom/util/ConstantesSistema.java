...
//  Indicador de Tipo de Pagamento parcelado
    ...
    String EXTENSAO_PNG = "PNG";
    String CONTENT_TYPE_GIF = "image/gif";
    String EXTENSAO_GIF = "GIF";
    String EXTENSAO_JPEG = "JPEG";
	...
	String CODIGO_SITUACAO_CADASTRO_PENDENTE = "1";
	String CODIGO_SITUACAO_CADASTRO_ATUALIZADO = "2";
	String CODIGO_SITUACAO_CADASTRO_REJEITADO = "3";
	String CODIGO_SITUACAO_EM_ANALISE = "4";
	String CODIGO_SITUACAO_REMOVIDO_DE_EM_ANALISE = "5";
	Short INDICADOR_LIBERADO = new Short("1");
	Short INDICADOR_SUSPENSO = new Short("2");
	...
	String DEVOLUCAO_PAGAMENTO_EM_DUPLICIDADE = "1";
	String DEVOLUCAO_PAGAMENTO_VALOR_A_MAIOR = "2";
	String DEVOLUCAO_PAGAMENTO_INDEVIDO = "3"; 
	
	Integer ESTADO_ARQUIVO_RECEBIDO = 3;

	Integer DEVOLUCAO_PAGAMENTO_NAO_CONFORME =	new Integer("3");
	Integer DEVOLUCAO_PAGAMENTO_EM_DUPLICIDADE_INT =new Integer("1");
	
	Integer IDENTIFICADOR_TIPO_OS_COBRANCA = new Integer("1");
	Integer IDENTIFICADOR_TIPO_OS_MICROMEDICAO = new Integer("2");
	
	//[UC0000] Relatório Opção Totalização por Comando e Opção de Totalização por Mês de Apuração
	String TOTALIZACAO_POR_COMANDO = "1";
	String TOTALIZACAO_POR_MES_DE_APURACAO = "2";

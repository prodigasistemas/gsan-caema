...
public interface IControladorCobranca {
	...
	public void gerarCreditoARealizarParcelamento(Imovel imovel,
			...
			boolean isContaEntradaParcelamento, Integer anoMesGuiaEntrada, Integer maiorAnoMesConta,
			BigDecimal valorDescontoSobreDebitoTotal) throws ControladorException;
	...
	public Integer gerarDadosParcelamento(Date dataParcelamento,
			...
			Integer anoMesReferenciaContabil,BigDecimal descontoSobreDebitoTotal) throws ControladorException;
	...
	public void inserirComandoAcaoCobrancaEventual(String idCobrancaAcao,
			...
			String numeroQuadraFinal, String[] idsLocalidade, String[] idsSetorComercial, String idLocalidade)
			throws ControladorException;
	...
	public void verficarExistenciaComandoEventual(String[] idsCobrancaAcao,
			...
			String idUnidadeNegocio,String codigoClienteSuperior,String numeroQuadraInicial,String numeroQuadraFinal, String idLocalidade, String[] idsLocalidade, String[] idsSetorComercial) throws ControladorException;
	...
	public Collection inserirComandoAcaoCobrancaCriterioEventual(
			...
			String numeroQuadraInicial,String numeroQuadraFinal,
	 ...
	 * @param nomeArquivo 
	 * @param imoveisSitLigacaoNaoAlteradaDeb 
	...
	public Collection concluirComandoAcaoCobranca(String periodoInicialConta,
			...
			String periodoInicialFiscalizacao, String periodoFinalFiscalizacao, String[] situacaoFiscalizacao,
			String numeroQuadraInicial,String numeroQuadraFinal, String quantidadeDiasVencimento,
			String imoveisSitLigacaoNaoAlteradaDeb, String nomeArquivo, 
			Collection<Integer> colecaoIdsImovel, String[] idsLocalidade, String[] idsSetorComercial, String idLocalidade) throws ControladorException;
	...
	public Collection executarComandoAcaoCobranca(String periodoInicialConta,
			...
			String nomeArquivo, 
			Collection<Integer> colecaoIdsImovel, String[] idsLocalidade, String[] idsSetorComercial, String idLocalidade)
			throws ControladorException;
	...
	public void executarComandoManterAcaoCobranca(String periodoInicialConta,
			...
			String imoveisSitLigacaoNaoAlteradaDeb, String nomeArquivo, 
			Collection<Integer> colecaoIdsImovel,
			String[] idsLocalidade, String[] idsSetorComercial, String idLocalidade) throws ControladorException;
	...
	public CobrancaAcaoAtividadeComando atualizarComandoAcaoCobrancaEventual(
			...
			Collection<Integer> colecaoIdsImovel, 
			String[] idsLocalidade,
			String[] idsSetorComercial, String idLocalidade) throws ControladorException;
	...
	public List gerarRelacaoDebitos(String idImovelCondominio,
			...
			String qtdImoveis, String qtdMaiores,String indicadorCodigoBarra, String ordenacao,
	 ...
	 * modificado por Fernanda Almeida [RM5405]
	 * 
	 * @param imovel
...
/** 
	...
	**/
	 ...
	 * @date 10/11/2011
	 */	
	public Collection<AcoesPenalidadeGrupoHelper> pesquisarAcoesPenalidadesPorGrupoMes(Integer idGrupo, Integer anoMes) throws ControladorException;
	/**
	 ...
	 * @date 15/12/2011
	 * */
	public void retirarImoveisContasEmpresaCobranca(Integer idFuncionalidade,
			Usuario u, Integer idComando) throws ControladorException;
	 ...
	 * @date 24/10/2011
	 * */	
	//public void gerarBoletimCobrancaResultado() throws ControladorException;	
	/**
	 ...
	 * Pesquisa os dados dos comandos	 * 	 * @author: Raimundo Martins	 
	 * @date: 19/04/2012	 
	 * */	
	 ...
	 * @created 04/06/2012
	 */
	public void encerrarAutomaticamenteComandosCobResultado(
			Integer idFuncionalidadeIniciada) throws ControladorException;
	 ...
	 * [UC0870] - Gerar Movimento de Contas em Cobranca por Empresa
	 *  
	 * Retorna a quantidade de vezes que o imovel informado foi associado a comandos de cobranca
	 * 
	 * @author Rômulo Aurélio
	 * @date 30/07/2012
	 * */	
	...
	public List<RelatorioRetornoOrdemServicoFiscalizacaoBean> obterDadosRelatorioRetornoOSFiscalizacao(
			...
			Map<String, Object> parametros, Integer mesAno, String[] situacoes) throws ControladorException;
	...
	/**
	 * [UC1384] Reabrir Comando de Atividade de Ação de Cobrança
	 * [IT0002] [IT0002] Apresenta Comandos de Ação de Cobrança Eventuais
	 * 
	 * @author Hugo Azevedo
	 ...
	 * 
	 * @author Hugo Azevedo
	 * @param debitosImoveisInformados 
	 * @date 20/03/2013
	 */
	 ...
	 * 
	 * @author Hugo Azevedo
	 * @param registroImovelHelper 
	 * @date 21/03/2013
	 */
	public void validarEfetuarParcelamentoJudicialDebitos(String[] idsContasSelecionadas, RegistroImovelHelper registroImovelHelper) throws ControladorException;
	...
	public void validarEfetuarParcelamentoJudicialNegociacao(String valorDebito,
			...
			String idClienteresponsavel, String advogado, String numeroOAB, byte[] conteudoArquivo,
	 ...
	 * @throws ControladorException
	 */
	public void inserirColecaoEmpresaCobrancaContaSemTransacao(Collection<? extends Object> colecaoObjetos) throws ControladorException ;
	 ...
	 * @throws ControladorException
	 */
	public void inserirColecaoEmpresaCobrancaContaProporcionalidadeSemTransacao(Collection<? extends Object> colecaoObjetos) throws ControladorException;
	...
	public Integer incluirParcelamentoJudicial(
			...
			Short indicadorEntradaParcelamento, Integer numeroDiasEntreParcelas,
	 ...
	 */
	public void verificarMotivosNaoGeracaoComando(Collection<Object[]> colecaoComandos) 
			throws ControladorException;
	 ...
	 * @return ParcelamentoDebitoEfetuadoHelper
	 */
	public ParcelamentoDebitoEfetuadoHelper consultarParcelamentoEfetuado(String matricula) throws ControladorException;

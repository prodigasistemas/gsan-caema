...
public class CobrancaSituacao extends ObjetoTransacao {
    ...
    public final static Integer PARCELAMENTO_BLOQUEADO_PELA_DCB	 = new Integer(7);
    public final static Integer EMPRESA_DE_COBRANCA_COMPESA	 = new Integer(20);
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		CobrancaSituacao other = (CobrancaSituacao) obj;
		if (id == null) {
			if (other.id != null)
				return false;

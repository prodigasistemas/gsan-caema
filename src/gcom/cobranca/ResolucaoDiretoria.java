...
public class ResolucaoDiretoria extends ObjetoTransacao {
    ...
    private Short indicadorValidoAcaoCobranca;
    
    private BigDecimal valorDebitoMinimo;
    private BigDecimal valorDebitoMaximo;
	...
	public Short getIndicadorValidoAcaoCobranca() {
		return indicadorValidoAcaoCobranca;
	}

	public void setIndicadorValidoAcaoCobranca(Short indicadorValidoAcaoCobranca) {
		this.indicadorValidoAcaoCobranca = indicadorValidoAcaoCobranca;
	}

	public BigDecimal getValorDebitoMinimo() {
		return valorDebitoMinimo;
	}

	public void setValorDebitoMinimo(BigDecimal valorDebitoMinimo) {
		this.valorDebitoMinimo = valorDebitoMinimo;
	}

	public BigDecimal getValorDebitoMaximo() {
		return valorDebitoMaximo;
	}

	public void setValorDebitoMaximo(BigDecimal valorDebitoMaximo) {

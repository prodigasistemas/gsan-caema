...
public class FiltroContratoParcelamentoItem extends Filtro implements Serializable {
	...
	public final static String CONTA_GERAL_CONTA_HIST_DEBITO_CREDITO_SITUACAO_ATUAL  = "contaGeral.contaHistorico.debitoCreditoSituacaoAtual";
	
	public final static String CONTA_GERAL_CONTA_MOTIVO_REVISAO  = "contaGeral.conta.contaMotivoRevisao";
	
	public final static String CONTA_GERAL_CONTA_HIST_MOTIVO_REVISAO  = "contaGeral.contaHistorico.contaMotivoRevisao";
	...
	public final static String DEBITO_A_COBRAR_HISTORICO_DEBITO_IMOVEL = "debitoACobrarGeral.debitoACobrarHistorico.imovel";
	
	public final static String DEBITO_A_COBRAR_GERAL_DEBITO_TIPO = "debitoACobrarGeral.debitoACobrar.debitoTipo";
	
	public final static String DEBITO_A_COBRAR_HISTORICO_DEBITO_TIPO = "debitoACobrarGeral.debitoACobrarHistorico.debitoTipo";

...
public class ParcelamentoQuantidadeReparcelamentoHelper implements Serializable {
    ...
    private ArrayList<ParcelaEntradaDesconto> collectionParcelaEntradaDesconto;   
	...
	public ArrayList<ParcelaEntradaDesconto> getCollectionParcelaEntradaDesconto() {
		return collectionParcelaEntradaDesconto;
	}

	public void setCollectionParcelaEntradaDesconto(
			ArrayList<ParcelaEntradaDesconto> collectionParcelaEntradaDesconto) {
		this.collectionParcelaEntradaDesconto = collectionParcelaEntradaDesconto;
	}

...
/** 
 *  [UC0220] Inserir Perfil do Parcelamento
 *  
 * @author Anderson Cabral
 * @since 31/07/2013
 *  
 *  */
public class ParcelaEntradaDesconto extends ObjetoTransacao {
	
	private static final long serialVersionUID = 1L;

    private Integer id;   
    private ParcelamentoQuantidadeReparcelamento parcelamentoQuantidadeReparcelamento;
	...
	public ParcelaEntradaDesconto(
			...
			BigDecimal percentualEntrada, BigDecimal percentualDesconto,
			Integer quantidadeParcelas, BigDecimal valorMinimoParcela,
			Integer quantidadeMeses, Date ultimaAlteracao) {
		super();
		this.id = id;
	...
	public ParcelamentoQuantidadeReparcelamento getParcelamentoQuantidadeReparcelamento() {
		return parcelamentoQuantidadeReparcelamento;
	}

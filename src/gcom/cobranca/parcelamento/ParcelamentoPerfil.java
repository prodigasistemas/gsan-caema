...
public class ParcelamentoPerfil extends ObjetoTransacao {
    ...
    private Short indicadorDescontoVistaValorDebito;
    
    private Short indicadorDescontoParcelaValorEntrada;
    
    private BigDecimal valorFixoParcelaMinima;
    
    private Integer qtdFaturasAnterioresPagVista;
    
    private Integer qtdFaturasAnterioresPagParcelado;
    
    private Short indicadorDescontoVistaDebParcelado;
	...
	public Short getIndicadorDescontoVistaValorDebito() {
		return indicadorDescontoVistaValorDebito;
	}

	public void setIndicadorDescontoVistaValorDebito(
			Short indicadorDescontoVistaValorDebito) {
		this.indicadorDescontoVistaValorDebito = indicadorDescontoVistaValorDebito;
	}

	public Short getIndicadorDescontoParcelaValorEntrada() {
		return indicadorDescontoParcelaValorEntrada;
	}

	public void setIndicadorDescontoParcelaValorEntrada(
			Short indicadorDescontoParcelaValorEntrada) {
		this.indicadorDescontoParcelaValorEntrada = indicadorDescontoParcelaValorEntrada;
	}

	public BigDecimal getValorFixoParcelaMinima() {
		return valorFixoParcelaMinima;
	}

	public void setValorFixoParcelaMinima(BigDecimal valorFixoParcelaMinima) {
		this.valorFixoParcelaMinima = valorFixoParcelaMinima;
	}

	public Integer getQtdFaturasAnterioresPagVista() {
		return qtdFaturasAnterioresPagVista;
	}

	public void setQtdFaturasAnterioresPagVista(Integer qtdFaturasAnterioresPagVista) {
		this.qtdFaturasAnterioresPagVista = qtdFaturasAnterioresPagVista;
	}

	public Integer getQtdFaturasAnterioresPagParcelado() {
		return qtdFaturasAnterioresPagParcelado;
	}

	public void setQtdFaturasAnterioresPagParcelado(Integer qtdFaturasAnterioresPagParcelado) {
		this.qtdFaturasAnterioresPagParcelado = qtdFaturasAnterioresPagParcelado;
	}

	public Short getIndicadorDescontoVistaDebParcelado() {
		return indicadorDescontoVistaDebParcelado;
	}

	public void setIndicadorDescontoVistaDebParcelado(Short indicadorDescontoVistaDebParcelado) {

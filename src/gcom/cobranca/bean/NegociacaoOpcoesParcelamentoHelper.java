...
public class NegociacaoOpcoesParcelamentoHelper implements Serializable {
	...
	private BigDecimal valorDescontoPagParceladoPercentualEntrada;
	
	private BigDecimal valorTotalAcrescimosPagamentoAVista;
	...
	public BigDecimal getValorDescontoPagParceladoPercentualEntrada() {
		return valorDescontoPagParceladoPercentualEntrada;
	}

	public void setValorDescontoPagParceladoPercentualEntrada(
			BigDecimal valorDescontoPagParceladoPercentualEntrada) {
		this.valorDescontoPagParceladoPercentualEntrada = valorDescontoPagParceladoPercentualEntrada;
	}
	
	public BigDecimal getValorTotalAcrescimosPagamentoAVista() {
		return valorTotalAcrescimosPagamentoAVista;
	}

	public void setValorTotalAcrescimosPagamentoAVista(
			BigDecimal valorTotalAcrescimosPagamentoAVista) {
		this.valorTotalAcrescimosPagamentoAVista = valorTotalAcrescimosPagamentoAVista;
	}

...
public class FiltroResolucaoDiretoria extends Filtro {
    ...
    public final static String ID_RD_PARCELAS_EM_ATRASO = "rdParcelasEmAtraso.id";
    public final static String INDICADOR_PARCELAMENTO_EM_ANDAMENTO = "indicadorParcelamentoEmAndamento";
    public final static String ID_RD_PARCELAMENTO_EM_ANDAMENTO = "rdParcelamentoEmAndamento.id";

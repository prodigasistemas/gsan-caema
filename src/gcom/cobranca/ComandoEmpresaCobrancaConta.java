...
public class ComandoEmpresaCobrancaConta extends ObjetoTransacao {
	...
	private Integer indicadorInclusaoNaoGeracao = 2;
	
	private Usuario usuario;
	
	private Integer qtdImoveisComando;
	

	public Integer getIndicadorInclusaoNaoGeracao() {
		return indicadorInclusaoNaoGeracao;
	}

	public void setIndicadorInclusaoNaoGeracao(Integer indicadorInclusaoNaoGeracao) {
		this.indicadorInclusaoNaoGeracao = indicadorInclusaoNaoGeracao;
	}
	...
	public Integer getQtdImoveisComando() {
		return qtdImoveisComando;
	}

	public void setQtdImoveisComando(Integer qtdImoveisComando) {
		this.qtdImoveisComando = qtdImoveisComando;
	}

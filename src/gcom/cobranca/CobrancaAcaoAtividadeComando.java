...
public class CobrancaAcaoAtividadeComando extends ObjetoTransacao {
	...
	private Integer ligacaoAlteradaDebito;

	private FaturamentoAtividadeCronograma faturamentoAtividadeCronograma;
	
	private String nomeArquivoRelacaoImoveis;
	
	private Set cobrancaAcaoAtividadeComandoSetorComercial;
	
	private Set cobrancaAcaoAtividadeComandoLocalidade;
	...
	public Integer getLigacaoAlteradaDebito() {
		return ligacaoAlteradaDebito;
	}

	public void setLigacaoAlteradaDebito(Integer ligacaoAlteradaDebito) {
	...
	public Set getCobrancaAcaoAtividadeComandoSetorComercial() {
		return cobrancaAcaoAtividadeComandoSetorComercial;
	}

	public void setCobrancaAcaoAtividadeComandoSetorComercial(
			Set cobrancaAcaoAtividadeComandoSetorComercial) {
		this.cobrancaAcaoAtividadeComandoSetorComercial = cobrancaAcaoAtividadeComandoSetorComercial;
	}

	public Set getCobrancaAcaoAtividadeComandoLocalidade() {
		return cobrancaAcaoAtividadeComandoLocalidade;
	}

	public void setCobrancaAcaoAtividadeComandoLocalidade(
			Set cobrancaAcaoAtividadeComandoLocalidade) {
		this.cobrancaAcaoAtividadeComandoLocalidade = cobrancaAcaoAtividadeComandoLocalidade;
	}

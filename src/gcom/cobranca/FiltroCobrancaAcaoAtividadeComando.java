...
public class FiltroCobrancaAcaoAtividadeComando extends Filtro implements Serializable {
    ...
    public final static String LIGACAO_ALTERADA_DEBITO = "ligacaoAlteradaDebito";
    ...
    public final static String IDS_LOCALIDADE =  "cobrancaAcaoAtividadeComandoLocalidade.localidade.id";
    public final static String IDS_SETORCOMERCIAL =  "cobrancaAcaoAtividadeComandoSetorComercial.setorComercial.id";

		...
		if (idOrdemServico != null && !idOrdemServico.trim().equals("")) {
			...
			if (ordemServico != null) {
				...
				if (temPermissaoMotivoNaoCobranca) {
					...
					if (efetuarRestabelecimentoLigacaoAguaActionForm.getPercentualCobranca() == null
							|| !efetuarRestabelecimentoLigacaoAguaActionForm.getPercentualCobranca().trim().equals("100")) {
						efetuarRestabelecimentoLigacaoAguaActionForm.setPercentualCobranca("100");
					}
					if (efetuarRestabelecimentoLigacaoAguaActionForm.getQuantidadeParcelas() == null
							|| efetuarRestabelecimentoLigacaoAguaActionForm.getQuantidadeParcelas().trim().equals("")) {
						efetuarRestabelecimentoLigacaoAguaActionForm.setQuantidadeParcelas("1");
					}
					if (efetuarRestabelecimentoLigacaoAguaActionForm.getValorParcelas() == null
							|| efetuarRestabelecimentoLigacaoAguaActionForm.getValorParcelas().trim().equals("")) {

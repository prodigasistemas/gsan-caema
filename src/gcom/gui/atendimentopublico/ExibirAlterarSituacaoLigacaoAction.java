...
public class ExibirAlterarSituacaoLigacaoAction extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping,
		...
		HttpSession sessao = httpServletRequest.getSession(false);
			...
			String idOrdemServico = (String) httpServletRequest.getAttribute("veioEncerrarOS");
			
			form.setIdOrdemServico(idOrdemServico);
			form.setIndicadorVeioEncerrarOS(String.valueOf(ConstantesSistema.SIM));
			form.setIndicadorTipoLigacao(String.valueOf(ConstantesSistema.NAO));

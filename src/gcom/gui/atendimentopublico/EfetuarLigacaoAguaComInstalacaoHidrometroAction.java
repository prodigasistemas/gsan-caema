...
public class EfetuarLigacaoAguaComInstalacaoHidrometroAction extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping,
		...
		if (idImovel == null && sessao.getAttribute("imovel") != null) {
		...
		if (ordemServicoId != null && !ordemServicoId.equals("")) {
			...
			if (efetuarLigacaoAguaComInstalacaoHidrometroActionForm
					.getVeioEncerrarOS().equalsIgnoreCase("FALSE") || (sessao.getAttribute("movimentarOS") != null && sessao.getAttribute("movimentarOS").equals("TRUE"))) {
	...
	public HidrometroInstalacaoHistorico setDadosHidrometroInstalacaoHistorico(
			...
			EfetuarLigacaoAguaComInstalacaoHidrometroActionForm efetuarLigacaoAguaComInstalacaoHidrometroActionForm,
			Usuario usuarioLogado,String idImovel) {
		...
		String numeroTombamento = efetuarLigacaoAguaComInstalacaoHidrometroActionForm
				.getNumeroTombamento();
		...
		//Indicador Telemedido
		hidrometroInstalacaoHistorico.setIndicadorMedicaoTelemedido(
				Short.parseShort(efetuarLigacaoAguaComInstalacaoHidrometroActionForm.getIndicadorMedicaoTelemedido()));

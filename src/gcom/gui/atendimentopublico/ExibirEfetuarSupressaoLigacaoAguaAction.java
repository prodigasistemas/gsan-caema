	...
	public ActionForward execute(ActionMapping actionMapping,
		...
		if (idOrdemServico != null && !idOrdemServico.trim().equals("")) {
			...
			if (ordemServico != null) {
				...
				if ((calculaValores != null && !calculaValores.equals("S")) || (calculaValores == null)){
					...
					if (ligacaoAgua.getSupressaoMotivo() != null) {
						...
						efetuarSupressaoLigacaoAguaActionForm.setMotivoSupressao(null);
					}
					...
					if (httpServletRequest.getParameter("combo") == null) {
						if (ligacaoAgua.getSupressaoTipo() != null) {
							...
							efetuarSupressaoLigacaoAguaActionForm.setTipoSupressao(null);
						}
					}
				...
				if (temPermissaoMotivoNaoCobranca) {
					...
					if (efetuarSupressaoLigacaoAguaActionForm.getPercentualCobranca() == null
							|| !efetuarSupressaoLigacaoAguaActionForm.getPercentualCobranca().trim().equals("100")) {
						efetuarSupressaoLigacaoAguaActionForm.setPercentualCobranca("100");
					}
					if (efetuarSupressaoLigacaoAguaActionForm.getQuantidadeParcelas() == null
							|| efetuarSupressaoLigacaoAguaActionForm.getQuantidadeParcelas().trim().equals("")) {
						efetuarSupressaoLigacaoAguaActionForm.setQuantidadeParcelas("1");
					}
					if (efetuarSupressaoLigacaoAguaActionForm.getValorParcelas() == null
							|| efetuarSupressaoLigacaoAguaActionForm.getValorParcelas().trim().equals("")) {
	...
	private void pesquisarSelectObrigatorio(
		...
		if ((efetuarSupressaoLigacaoAguaActionForm.getIndicadorTipoSupressao() != null) && 
				((httpServletRequest.getParameter("desfazer") == null) || 
						(httpServletRequest.getParameter("desfazer") != null && !httpServletRequest.getParameter("desfazer").equals("ok")))){
		...
		if((efetuarSupressaoLigacaoAguaActionForm.getIndicadorPermanenciaHidrometro() == null || 
				efetuarSupressaoLigacaoAguaActionForm.getIndicadorPermanenciaHidrometro().equals("")) || 
			(httpServletRequest.getParameter("desfazer") != null && httpServletRequest.getParameter("desfazer").equals("ok"))){
			//Indicador Permanência do Hidrômetro
			efetuarSupressaoLigacaoAguaActionForm.setIndicadorPermanenciaHidrometro(ConstantesSistema.NAO.toString());
		} 
	}

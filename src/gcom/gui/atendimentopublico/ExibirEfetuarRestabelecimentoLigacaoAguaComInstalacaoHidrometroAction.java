...
public class ExibirEfetuarRestabelecimentoLigacaoAguaComInstalacaoHidrometroAction extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping,ActionForm actionForm, 
		...
		if(efetuarRestabelecimentoLigacaoAguaComInstalacaoHidrometroActionForm.getIndicadorMedicaoTelemedido() == null)
			efetuarRestabelecimentoLigacaoAguaComInstalacaoHidrometroActionForm
						.setIndicadorMedicaoTelemedido(String.valueOf(ConstantesSistema.NAO));

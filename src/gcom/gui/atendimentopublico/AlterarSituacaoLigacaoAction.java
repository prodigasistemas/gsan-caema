...
public class AlterarSituacaoLigacaoAction extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping,
		...
		if ( form.getIndicadorVeioEncerrarOS() != null && form.getIndicadorVeioEncerrarOS().equals(String.valueOf(form.getIndicadorVeioEncerrarOS()))){
			veioEncerrarOS = true;
		}
		...
		if ( form.getIndicadorVeioEncerrarOS() != null && form.getIndicadorVeioEncerrarOS().equals(String.valueOf(ConstantesSistema.SIM)) ) {
			...
			integracaoComercialHelper.setIndicadorTipoLigacao(indicadorTipoLigacao);
			integracaoComercialHelper.setIdSituacaoLigacaoAguaNova(idSituacaoLigacaoAguaNova);
			integracaoComercialHelper.setIdSituacaoLigacaoEsgotoNova(idSituacaoLigacaoEsgotoNova);
			...
			idImovel = fachada.alterarSituacaoLigacao( imovel,  indicadorTipoLigacao,  idSituacaoLigacaoAguaNova, 

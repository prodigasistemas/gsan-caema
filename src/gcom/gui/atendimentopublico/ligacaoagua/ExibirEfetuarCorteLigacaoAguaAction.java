...
public class ExibirEfetuarCorteLigacaoAguaAction extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping,
		...
		if(httpServletRequest.getParameter("limparOS") != null && httpServletRequest.getParameter("limparOS").equals("OK")){
			...
			form.setMotivoCorte("");
			form.setTipoCorte("");
			form.setNumLeituraCorte("");
			form.setNumSeloCorte("");
			sessao.removeAttribute("bloquearMotivoCorte");
		}
		...
		if (idOrdemServico != null && !idOrdemServico.trim().equals("")) {
			...
			if (ordemServico != null) {
				...
				if(calculaValores != null && calculaValores.equals("S"))
					calcularValorPrestacao(form, ordemServico,
	...
	private void calcularValorPrestacao(
			EfetuarCorteLigacaoAguaActionForm form, OrdemServico ordemServico,
	...
	private void pesquisarDadosCorteLigacao(HttpSession sessao, EfetuarCorteLigacaoAguaActionForm form, OrdemServico ordemServico) {
		...
		if(ordemServico.getRegistroAtendimento() != null){
			if(ordemServico.getRegistroAtendimento().getSolicitacaoTipoEspecificacao() != null){
				if(ordemServico.getRegistroAtendimento().getSolicitacaoTipoEspecificacao().getMotivoCorte() != null && 
						(form.getMotivoCorte() == null || form.getMotivoCorte().equals(""+ConstantesSistema.NUMERO_NAO_INFORMADO))){
					form.setMotivoCorte(""+ordemServico.getRegistroAtendimento().getSolicitacaoTipoEspecificacao().getMotivoCorte().getId());
					sessao.setAttribute("bloquearMotivoCorte", true);
				}
			}
		}else{
		...
		if(ordemServico.getImovel().getLigacaoAgua().getCorteTipo() != null &&
				(form.getTipoCorte() == null || form.getTipoCorte().equals(""+ConstantesSistema.NUMERO_NAO_INFORMADO))) {

...
public class ExibirEfetuarReligacaoAguaComInstalacaoHidrometroAction extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping,ActionForm actionForm, 
		...
		if(efetuarReligacaoAguaComInstalacaoHidrometroActionForm.getIndicadorMedicaoTelemedido() == null){
			efetuarReligacaoAguaComInstalacaoHidrometroActionForm.setIndicadorMedicaoTelemedido(String.valueOf(ConstantesSistema.NAO));
		}

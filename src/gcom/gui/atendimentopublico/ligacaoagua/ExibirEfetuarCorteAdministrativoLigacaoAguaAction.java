				...
				if (temPermissaoMotivoNaoCobranca) {
					httpServletRequest.setAttribute("permissaoMotivoNaoCobranca", temPermissaoMotivoNaoCobranca);
					 ...
					 if (corteAdministrativoLigacaoAguaActionForm.getPercentualCobranca() == null
                             || !corteAdministrativoLigacaoAguaActionForm.getPercentualCobranca().trim().equals("100")) {
		             ...
		             if (corteAdministrativoLigacaoAguaActionForm.getQuantidadeParcelas() == null
		                             || corteAdministrativoLigacaoAguaActionForm.getQuantidadeParcelas().trim().equals("")) {
		            	 corteAdministrativoLigacaoAguaActionForm.setQuantidadeParcelas("1");
		             }
		             if (corteAdministrativoLigacaoAguaActionForm.getValorParcelas() == null
		                             || corteAdministrativoLigacaoAguaActionForm.getValorParcelas().trim().equals("")) {

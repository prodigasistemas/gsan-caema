...
public class AtualizarLigacaoAguaAction extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping,
		...
		if(ordemServico != null){
			...
			Collection hidrometro = fachada.pesquisar(filtroHidrometro, HidrometroInstalacaoHistorico.class.getName());
			
			if(!Util.isVazioOrNulo(hidrometro)){
				hidrometroInstalacaoHistorico = (HidrometroInstalacaoHistorico) Util.retonarObjetoDeColecao(hidrometro);
			}

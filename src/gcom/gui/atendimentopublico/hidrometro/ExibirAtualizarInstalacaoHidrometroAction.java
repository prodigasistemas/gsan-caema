				...
				if (Util.validarStringNumerica(form.getMedicaoTipo())) {
					...
					if (MedicaoTipo.LIGACAO_AGUA.equals(medicaoTipo)) {
						...
						if(hidrometroInstalacaoHistorico.getHidrometro().getIndicadorMacromedidor().intValue() == 1){
							form.setNumeroTombamento(hidrometroInstalacaoHistorico.getHidrometro().getTombamento());
						}
					...
					form.setIndicadorMacromedidor(hidrometroInstalacaoHistorico.getHidrometro().getIndicadorMacromedidor().toString());
					...
					form.setIndicadorMedicaoTelemedido(hidrometroInstalacaoHistorico.getIndicadorMedicaoTelemedido().toString());
			...
			if (ordemServico != null) {
				...
				if (Util.validarStringNumerica(form.getMedicaoTipo())) {
					...
					if (MedicaoTipo.LIGACAO_AGUA.equals(medicaoTipo)) {
						...
						//Caso HIDR_ICMACRO = 1 (Macromedidor)
						if(hidrometroInstalacaoHistorico.getHidrometro().getIndicadorMacromedidor().intValue() == 1){
							form.setNumeroTombamento(hidrometroInstalacaoHistorico.getHidrometro().getTombamento());
					...
					if(hidrometroInstalacaoHistorico.getHidrometro().getIndicadorMacromedidor().intValue() == 2){
						...
						form.setIndicadorTipoHidrometro("1");
					}
					...
					if (imovel != null && imovel.getPocoTipo() != null){
						
					form
						 	.setTipoPoco(imovel.getPocoTipo().getId().toString());
					}

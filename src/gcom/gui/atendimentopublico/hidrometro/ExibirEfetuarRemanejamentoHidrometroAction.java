...
//						.getRegistroAtendimento().getImovel());
				...
				if (ordemServico.getRegistroAtendimento() == null || ordemServico.getRegistroAtendimento()
					...
					if(hidrometroInstalacaoHistorico.getHidrometro().getIndicadorMacromedidor().intValue() == 1){
						efetuarRemanejamentoHidrometroActionForm.setNumeroTombamento(hidrometroInstalacaoHistorico.getHidrometro().getTombamento());
					}
				...
				if(hidrometroInstalacaoHistorico.getHidrometro().getIndicadorMacromedidor().intValue() == 2){
					efetuarRemanejamentoHidrometroActionForm.setHidrometro(hidrometroInstalacaoHistorico
							.getHidrometro().getNumero());
				}
				
				efetuarRemanejamentoHidrometroActionForm.setIndicadorMacromedidor(hidrometroInstalacaoHistorico.getHidrometro().getIndicadorMacromedidor().toString());
				...
				if (temPermissaoMotivoNaoCobranca) {
					httpServletRequest.setAttribute("permissaoMotivoNaoCobranca", temPermissaoMotivoNaoCobranca);
					 ...
					 if (efetuarRemanejamentoHidrometroActionForm.getPercentualCobranca() == null
                             || !efetuarRemanejamentoHidrometroActionForm.getPercentualCobranca().trim().equals("100")) {
						 efetuarRemanejamentoHidrometroActionForm.setPercentualCobranca("100");
		             }
		             if (efetuarRemanejamentoHidrometroActionForm.getQuantidadeParcelas() == null
		                             || efetuarRemanejamentoHidrometroActionForm.getQuantidadeParcelas().trim().equals("")) {
		            	 efetuarRemanejamentoHidrometroActionForm.setQuantidadeParcelas("1");
		             }
		             if (efetuarRemanejamentoHidrometroActionForm.getValorParcelas() == null
		                             || efetuarRemanejamentoHidrometroActionForm.getValorParcelas().trim().equals("")) {

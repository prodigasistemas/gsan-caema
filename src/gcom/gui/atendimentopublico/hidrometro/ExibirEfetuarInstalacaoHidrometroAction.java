...
/*		String objetoConsulta = httpServletRequest.getParameter("objetoConsulta");		
		 ...
		 */
        if(efetuarInstalacaoHidrometroActionForm.getIndicadorMedicaoTelemedido() == null){
        	efetuarInstalacaoHidrometroActionForm.setIndicadorMedicaoTelemedido(ConstantesSistema.NAO.toString());
        }
		...
		if(efetuarInstalacaoHidrometroActionForm.getIndicadorTipoHidrometro() == null || 
				efetuarInstalacaoHidrometroActionForm.getIndicadorTipoHidrometro().equals("")){
			
			efetuarInstalacaoHidrometroActionForm.setIndicadorTipoHidrometro("1");
		}
		...
		if (idOrdemServico != null && !idOrdemServico.trim().equals("")) {			
			ordemServico = fachada.recuperaOSPorId(Integer.parseInt(idOrdemServico));
			...
			if (ordemServico != null) {
				...
				this.calcularValores(httpServletRequest, ordemServico, 
				efetuarInstalacaoHidrometroActionForm);
				...
				if (temPermissaoMotivoNaoCobranca) {
					...
					if(efetuarInstalacaoHidrometroActionForm.getQuantidadeParcelas() == null ||
							efetuarInstalacaoHidrometroActionForm.getQuantidadeParcelas().equals("")){
...
//			ordemServico.getRegistroAtendimento().getImovel().getId(), new Short("3"));
	...
	private void calcularValorPrestacao(OrdemServico ordemServico,
			EfetuarInstalacaoHidrometroActionForm form, BigDecimal valorDebito,

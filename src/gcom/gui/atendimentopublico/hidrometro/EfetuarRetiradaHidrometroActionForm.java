...
public class EfetuarRetiradaHidrometroActionForm extends ActionForm{
    ...
    private String bloquearLocalArmazenamento;
	...
	public String getBloquearLocalArmazenamento() {
		return bloquearLocalArmazenamento;
	}

	public void setBloquearLocalArmazenamento(String bloquearLocalArmazenamento) {
		this.bloquearLocalArmazenamento = bloquearLocalArmazenamento;
	}	

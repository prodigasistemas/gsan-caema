 ...
 * RM8974
 * UC0364
 * [SB0011] Gerar Ordem de Servico Instalacao Caixa Protecao
 */

public class GerarOrdemServicoInstalacaoCaixaProtecaoHidrometroAction extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping,
		...
		montarPaginaSucesso(httpServletRequest, "Ordem de Serviço de Instalação de Caixa de Proteção de Hidrômetro de código "+idOrdemServicoGerada+" gerada com sucesso","Voltar","");

...
//	Dados da Geração do Débito
    ...
    private String indicadorMacromedidorAtual;
    private String numeroTombamentoAtual;
    ...
    private String hidrometroProtegido;
    
    private String indicadorMedicaoTelemedido;
    
    /** [SB0009] - Informar instalacao de caixa de protecao do hidrometro ***/
    private String indicadorInstCaixaProtecao;
	...
	public String getHidrometroProtegido() {
		return hidrometroProtegido;
	}

	public void setHidrometroProtegido(String hidrometroProtegido) {
		this.hidrometroProtegido = hidrometroProtegido;
	}
	...
	public HidrometroInstalacaoHistorico setFormValues(HidrometroInstalacaoHistorico hidrometroInstalacaoHistorico) {
		...
		if(getIndicadorInstCaixaProtecao().equals(ConstantesSistema.NAO.toString())){
        ...
        if(getIndicadorMedicaoTelemedido() != null)
        	hidrometroInstalacaoHistorico.setIndicadorMedicaoTelemedido(new Short(getIndicadorMedicaoTelemedido()));
	...
	public String getIndicadorMacromedidorAtual() {
		return indicadorMacromedidorAtual;
	}

	public void setIndicadorMacromedidorAtual(String indicadorMacromedidorAtual) {
		this.indicadorMacromedidorAtual = indicadorMacromedidorAtual;
	}

	public String getNumeroTombamentoAtual() {
		return numeroTombamentoAtual;
	}

	public void setNumeroTombamentoAtual(String numeroTombamentoAtual) {
		this.numeroTombamentoAtual = numeroTombamentoAtual;
	}

	public String getIndicadorInstCaixaProtecao() {
		return indicadorInstCaixaProtecao;
	}

	public void setIndicadorInstCaixaProtecao(String indicadorInstCaixaProtecao) {
		this.indicadorInstCaixaProtecao = indicadorInstCaixaProtecao;
	}

	public String getIndicadorMedicaoTelemedido() {
		return indicadorMedicaoTelemedido;
	}

	public void setIndicadorMedicaoTelemedido(String indicadorMedicaoTelemedido) {
		this.indicadorMedicaoTelemedido = indicadorMedicaoTelemedido;
	}
}

...
public class ExibirEfetuarLigacaoEsgotoSemRAAction extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping,
		...
		if (matriculaImovel != null && !matriculaImovel.trim().equals("")) {
			...
			Integer idImovel = Integer.parseInt(matriculaImovel);
			Integer clienteDesconhecido = Fachada.getInstancia().pesquisarClienteDesconhecidoAssociadoImovel(idImovel);
			
			if(clienteDesconhecido != null){
				throw new ActionServletException("atencao.nao.permitido.ligacao.agua" ,null, ligacaoEsgotoSemRAActionForm.getMatriculaImovel());
			}
			...
			if (mensagemImovel == null) {
				...
				if (ligacaoEsgotoSituacao != null) {
					...
					if ((!ligacaoEsgotoSituacao.getId().equals(LigacaoEsgotoSituacao.POTENCIAL)) 
							...
							&& (!ligacaoEsgotoSituacao.getId().equals(LigacaoEsgotoSituacao.FACTIVEL_FATURAVEL))) {
			...
			this.exibirDadosDaLigacaoEsgoto(ligacaoEsgotoSemRAActionForm, matriculaImovel);
	...
	private void exibirDadosDaLigacaoEsgoto(EfetuarLigacaoEsgotoSemRAActionForm form, String idImovel){
		
		Imovel imovel = this.getFachada().pesquisarImovel(Integer.parseInt(idImovel));
		
		if(imovel != null && imovel.getLigacaoEsgoto() != null){
			
			//Data Ligacao
			if(imovel.getLigacaoEsgoto().getDataLigacao() != null){
				form.setDataLigacao(Util.formatarData(imovel.getLigacaoEsgoto().getDataLigacao()));
			}

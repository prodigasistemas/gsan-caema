...
public class EfetuarSupressaoLigacaoAguaAction extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping,
		...
		String indicadorPermanenciaHidrometro = efetuarSupressaoLigacaoAguaActionForm
				.getIndicadorPermanenciaHidrometro();
		...
		ligacaoAgua.setIndicadorPermanenciaHidrometro(Short.parseShort(indicadorPermanenciaHidrometro));

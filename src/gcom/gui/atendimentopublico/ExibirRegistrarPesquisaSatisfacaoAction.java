 ...
 *
 */
public class ExibirRegistrarPesquisaSatisfacaoAction extends GcomAction {
    ...
    public ActionForward execute(ActionMapping actionMapping,
        ...
        ActionForward retorno = actionMapping.findForward("pesquisaSatisfacaoRegistrar");
        
        RegistrarPesquisaSatisfacaoActionForm form = (RegistrarPesquisaSatisfacaoActionForm) actionForm;
        
        if(httpServletRequest.getParameter("tipoConsulta") == null){
        	form.setAvaliacaoAtendente("1");
        	form.setAgilidadeAtendimento("1");
        	form.setTempoEspera("1");
        	form.setConfortoAmbiente("1");
        	form.setLocalizacaoAmbiente("1");
        	form.setSeguranca("1");
        	form.setEstacionamento("1");
        }
	 ...
	 * @date 27/02/2012
	 */
	private void pesquisarImovel(RegistrarPesquisaSatisfacaoActionForm form,
	 ...
	 * @date 27/02/2012
	 */
	private void pesquisarUnidadeOrganizacional(RegistrarPesquisaSatisfacaoActionForm form, 
			HttpServletRequest httpServletRequest){

...
public class ExibirEfetuarLigacaoAguaAction extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping,
		...
		this.consultaSelectObrigatorio(sessao, httpServletRequest);
...
//		 Permissao Especial Efetuar Ligacao de Agua sem RA
		...
		if (idImovel != null && !idImovel.trim().equals("")) {
			...
			if(clienteDesconhecido != null){
				throw new ActionServletException("atencao.nao.permitido.ligacao.agua" , null , ligacaoAguaActionForm.getIdImovel());
			}
		...
		if (idOrdemServico != null && !idOrdemServico.trim().equals("")) {
			...
			if (ordemServico != null) {
				...
				if (servicoTipo != null && servicoTipo.getDebitoTipo() != null) {
					...
					if(ligacaoAguaActionForm.getQuantidadeParcelas() == null || 
							ligacaoAguaActionForm.getQuantidadeParcelas().equals(""))
						ligacaoAguaActionForm.setQuantidadeParcelas(qtdeParcelas.toString());
					
					if (calculaValores != null && calculaValores.equals("S"))
						calcularValorPrestacao(ligacaoAguaActionForm,
								ordemServico, sistemaParametro);
					else {
				...
				if (clienteDesconhecido != null) {
					throw new ActionServletException("atencao.nao.permitido.ligacao.agua",	null, ligacaoAguaActionForm.getMatriculaImovel());
				}
	 ...
	 * @date 22/08/2006
	 */
	private void consultaSelectObrigatorio(HttpSession sessao, HttpServletRequest httpServletRequest) {

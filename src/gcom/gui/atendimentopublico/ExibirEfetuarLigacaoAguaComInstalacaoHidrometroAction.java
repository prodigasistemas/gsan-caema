...
public class ExibirEfetuarLigacaoAguaComInstalacaoHidrometroAction extends
	...
	public ActionForward execute(ActionMapping actionMapping,
		...
		if(efetuarLigacaoAguaComInstalacaoHidrometroActionForm.getIndicadorTipoHidrometro() == null || 
				efetuarLigacaoAguaComInstalacaoHidrometroActionForm.getIndicadorTipoHidrometro().equals("")){
			
			efetuarLigacaoAguaComInstalacaoHidrometroActionForm.setIndicadorTipoHidrometro("1");
		}
		
		if(efetuarLigacaoAguaComInstalacaoHidrometroActionForm.getIndicadorMedicaoTelemedido() == null || 
				efetuarLigacaoAguaComInstalacaoHidrometroActionForm.getIndicadorMedicaoTelemedido().equals("")){
			efetuarLigacaoAguaComInstalacaoHidrometroActionForm.setIndicadorMedicaoTelemedido("2");
		}
		...
		if (idOrdemServico != null && !idOrdemServico.trim().equals("")) {
			...
			if (ordemServico != null) {
				...
				// Verifica se o Cliente é desconhecido
				...
				if (clienteDesconhecido != null) {
					throw new ActionServletException("atencao.nao.permitido.ligacao.agua",	null, efetuarLigacaoAguaComInstalacaoHidrometroActionForm.getMatriculaImovel());
				}
			...
			if (temPermissaoMotivoNaoCobranca) {
					httpServletRequest.setAttribute(
					 ...
					 if (efetuarLigacaoAguaComInstalacaoHidrometroActionForm.getPercentualCobranca() == null
                             || !efetuarLigacaoAguaComInstalacaoHidrometroActionForm.getPercentualCobranca().trim().equals("100")) {
						 efetuarLigacaoAguaComInstalacaoHidrometroActionForm.setPercentualCobranca("100");
		             }
		             if (efetuarLigacaoAguaComInstalacaoHidrometroActionForm.getQuantidadeParcelas() == null
		                             || efetuarLigacaoAguaComInstalacaoHidrometroActionForm.getQuantidadeParcelas().trim().equals("")) {
		            	 efetuarLigacaoAguaComInstalacaoHidrometroActionForm.setQuantidadeParcelas("1");
		             }
		             if (efetuarLigacaoAguaComInstalacaoHidrometroActionForm.getValorParcelas() == null
		                             || efetuarLigacaoAguaComInstalacaoHidrometroActionForm.getValorParcelas().trim().equals("")) {
		...
		//Validar Enter Tombamento
		String tombamento = httpServletRequest.getParameter("tombamento");
		if (tombamento != null && !tombamento.trim().equals("")) {
			
			String numeroTombamento = efetuarLigacaoAguaComInstalacaoHidrometroActionForm.getNumeroTombamento();
			...
			Hidrometro hidro = null;
			
			//[FS0018] - Verificar Situação do Tombamento
			//Caso o tombamento informado não esteja cadastrado
			if (colecaoHidrometro == null || colecaoHidrometro.isEmpty()) {
				efetuarLigacaoAguaComInstalacaoHidrometroActionForm.setNumeroTombamento("");
				throw new ActionServletException("atencao.tombamento_inexistente");
			}else{
				hidro = (Hidrometro) Util.retonarObjetoDeColecao(colecaoHidrometro);

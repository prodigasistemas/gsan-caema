...
public class ExibirConsultarRegistroAtendimentoSolicitanteDetalhadoAction extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping,
		...
		String enderecoSolicitante = 
			fachada.obterEnderecoSolicitanteRA(registroAtendimentoSolicitante.getID(), registroAtendimentoSolicitante.getRegistroAtendimento().getId());
	...
	private RegistroAtendimentoSolicitante pesquisarRegistroAtendimentoSolicitante(Integer idRASolicitante){
		...
		filtroRegistroAtendimentoSolicitante.adicionarCaminhoParaCarregamentoEntidade("registroAtendimento");

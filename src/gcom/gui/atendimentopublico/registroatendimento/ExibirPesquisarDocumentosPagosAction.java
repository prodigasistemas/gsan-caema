 ...
 * 
 */
public class ExibirPesquisarDocumentosPagosAction extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping,
		...
		ActionForward retorno = actionMapping.findForward("exibirPesquisarDocumentosPagos");
		...
		//Id do RA
		String idRA = (String)httpServletRequest.getParameter("idRA");
		form.setIdRA(idRA);

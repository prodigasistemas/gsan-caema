...
public class FiltrarRegistroAtendimentoActionForm extends ValidatorActionForm {
	...
	private String selectedGrupoAtendimentoSize = "0";
	...
	public String getSelectedGrupoAtendimentoSize() {
		return selectedGrupoAtendimentoSize;
	}


	public void setSelectedGrupoAtendimentoSize(String selectedGrupoAtendimentoSize) {
		this.selectedGrupoAtendimentoSize = selectedGrupoAtendimentoSize;
	}


	public String getMudouGrupo() {
		return mudouGrupo;
	}


	public void setMudouGrupo(String mudouGrupo) {
		this.mudouGrupo = mudouGrupo;
	}

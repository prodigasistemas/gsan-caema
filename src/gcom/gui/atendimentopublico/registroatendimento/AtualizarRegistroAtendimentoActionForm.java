...
public class AtualizarRegistroAtendimentoActionForm extends ValidatorForm {
	...
	private String prazoPrevistoArpe;
	...
	private String indicadorInformarPagamentoDuplicidade;
	...
	public String getIndicadorInformarPagamentoDuplicidade() {
		return indicadorInformarPagamentoDuplicidade;
	}

	public void setIndicadorInformarPagamentoDuplicidade(
			String indicadorInformarPagamentoDuplicidade) {
	...
	public String getPrazoPrevistoArpe() {
		return prazoPrevistoArpe;
	}

	public void setPrazoPrevistoArpe(String prazoPrevistoArpe) {
		this.prazoPrevistoArpe = prazoPrevistoArpe;
	}

...
public class AtualizarTipoSolicitacaoEspecificacaoActionForm extends
	...
	private String indicadorPermiteClienteDesconhecido;
	
	private String indicadorFactivelFaturavel;
	...
	public String getIndicadorPermiteClienteDesconhecido() {
		return indicadorPermiteClienteDesconhecido;
	}

	public void setIndicadorPermiteClienteDesconhecido(
			String indicadorPermiteClienteDesconhecido) {
		this.indicadorPermiteClienteDesconhecido = indicadorPermiteClienteDesconhecido;
	}

	public String getIndicadorFactivelFaturavel() {
		return indicadorFactivelFaturavel;
	}

	public void setIndicadorFactivelFaturavel(String indicadorFactivelFaturavel) {

...
public class ConcluirAtualizarRegistroAtendimentoAction extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping,
		...
		fachada.validarCamposObrigatoriosRA_2ABA(idImovel, pontoReferencia,
				...
				colecaoPagValorMaiorDocumento, colecaoPagamentosValoresCobIndevidamente);
		...
		if(idImovel != null && !idImovel.equals("") &&
			...
			fachada.verificarImovelClienteDesconhecido(new Integer(idImovel), new Integer(form.getTipoSolicitacao()));
		...
		if ((idlocalidade != null) && (!idlocalidade.equals(""))){
			...
			if ((incluidasCoordenadasPROGIS == true && indicadorCoordenadaProgisEspecificacao) && 
					(((valorNnCoordenadaNorte == null)) ||			
					((valorNnCoordenadaLeste == null)))){
		...
		Integer[] idsGerados = fachada.atualizarRegistroAtendimento(
				    ...
				    colecaoPagamento, nnDiametro,colecaoPagValorMaiorDocumento,
				    colecaoPagamentosValoresCobIndevidamente,
     ...
     * @date 22/04/2012
     */
    private SolicitacaoTipoEspecificacao pesquisarSolicitacaoTipoEspecificacao(AtualizarRegistroAtendimentoActionForm form){

		...
		if(solicitacaoTipoEspecificacao != null){
			...
			if(solicitacaoTipoEspecificacao.getSolicitacaoTipo() != null){
				...
				if (solicitacaoTipoEspecificacao.getSolicitacaoTipo().getSolicitacaoTipoGrupo() != null){
					consultarRegistroAtendimentoPopupActionForm.setIdGrupoTipoSolicitacao(""+solicitacaoTipoEspecificacao.getSolicitacaoTipo().getSolicitacaoTipoGrupo().getId());
					consultarRegistroAtendimentoPopupActionForm.setGrupoTipoSolicitacao(solicitacaoTipoEspecificacao.getSolicitacaoTipo().getSolicitacaoTipoGrupo().getDescricao());
				}
			}

...
public class ExibirAtualizarTipoSolicitacaoEspecificacaoAction extends
	...
	public ActionForward execute(ActionMapping actionMapping,
		...
		filtroSolicitacaoTipoGrupo.setCampoOrderBy(FiltroSolicitacaoTipoGrupo.DESCRICAO);
		...
		if (sessao.getAttribute("colecaoTipoSolicitacaoTela") == null) {
			...
			if (sessao.getAttribute("objetoSolicitacaoTipo") != null) {
				...
				atualizarTipoSolicitacaoEspecificacaoActionForm
						.setIndicadorFactivelFaturavel(""
								+ solicitacaoTipo.getIndicadorFactivelFaturavel());
				...
				atualizarTipoSolicitacaoEspecificacaoActionForm
				.setIndicadorPermiteClienteDesconhecido(""
						+ solicitacaoTipo.getIndicadorPermiteClienteDesconhecido());
		...
		if (httpServletRequest.getParameter("desfazer") != null
			...
			if ((solicitacaoTipoID == null) && (id == null)) {
				...
				atualizarTipoSolicitacaoEspecificacaoActionForm
						.setIndicadorFactivelFaturavel(""+ solicitacaoTipo.getIndicadorFactivelFaturavel());

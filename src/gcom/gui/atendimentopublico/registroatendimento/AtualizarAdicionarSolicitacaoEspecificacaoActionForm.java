...
public class AtualizarAdicionarSolicitacaoEspecificacaoActionForm extends
    ...
    //RM  3790
  	...
  	private String indicadorMotivoCorteObrigatorio;
  	private String indicadorEspecificacaoObrigatorio;
    
	//RM 6899
	private String indicadorUso;
	
	//RM 7566
	private String indicadorInstalacaoHidrometro;
	
	//7753 
	private String indicadorTipoInstalacaoHidrometro;
	private String indicadorTipoSubstituicaoHidrometro;
	
	private String indicadorInformarDocumentoPagamentoAMaior;
	private String indicadorInformarDocumentoPagamentoIndevido;
	
	//RM 8848
	private String indicadorCoordenadaProgisRA;
	
	private String indicadorFactivelFaturavelEsp;
	
	private String prazoAtendimentoArpe;
	...
	public String getIndicadorMotivoCorteObrigatorio() {
		return indicadorMotivoCorteObrigatorio;
	}


	public void setIndicadorMotivoCorteObrigatorio(
			String indicadorMotivoCorteObrigatorio) {
		this.indicadorMotivoCorteObrigatorio = indicadorMotivoCorteObrigatorio;
	}


	public String getIndicadorEspecificacaoObrigatorio() {
		return indicadorEspecificacaoObrigatorio;
	}


	public void setIndicadorEspecificacaoObrigatorio(
			String indicadorEspecificacaoObrigatorio) {
		this.indicadorEspecificacaoObrigatorio = indicadorEspecificacaoObrigatorio;
	}


	public String getIndicadorInstalacaoHidrometro() {
		return indicadorInstalacaoHidrometro;
	}


	public void setIndicadorInstalacaoHidrometro(
			String indicadorInstalacaoHidrometro) {
		this.indicadorInstalacaoHidrometro = indicadorInstalacaoHidrometro;
	}


	public String getIndicadorTipoInstalacaoHidrometro() {
		return indicadorTipoInstalacaoHidrometro;
	}


	public void setIndicadorTipoInstalacaoHidrometro(
			String indicadorTipoInstalacaoHidrometro) {
		this.indicadorTipoInstalacaoHidrometro = indicadorTipoInstalacaoHidrometro;
	}


	public String getIndicadorTipoSubstituicaoHidrometro() {
		return indicadorTipoSubstituicaoHidrometro;
	}


	public void setIndicadorTipoSubstituicaoHidrometro(
			String indicadorTipoSubstituicaoHidrometro) {
		this.indicadorTipoSubstituicaoHidrometro = indicadorTipoSubstituicaoHidrometro;
	}


	public String getIndicadorInformarDocumentoPagamentoAMaior() {
		return indicadorInformarDocumentoPagamentoAMaior;
	}


	public void setIndicadorInformarDocumentoPagamentoAMaior(
			String indicadorInformarDocumentoPagamentoAMaior) {
		this.indicadorInformarDocumentoPagamentoAMaior = indicadorInformarDocumentoPagamentoAMaior;
	}


	public String getIndicadorInformarDocumentoPagamentoIndevido() {
		return indicadorInformarDocumentoPagamentoIndevido;
	}


	public void setIndicadorInformarDocumentoPagamentoIndevido(
			String indicadorInformarDocumentoPagamentoIndevido) {
		this.indicadorInformarDocumentoPagamentoIndevido = indicadorInformarDocumentoPagamentoIndevido;
	}

	public String getIndicadorCoordenadaProgisRA() {
		return indicadorCoordenadaProgisRA;
	}


	public void setIndicadorCoordenadaProgisRA(String indicadorCoordenadaProgisRA) {
		this.indicadorCoordenadaProgisRA = indicadorCoordenadaProgisRA;
	}


	public String getIndicadorFactivelFaturavelEsp() {
		return indicadorFactivelFaturavelEsp;
	}


	public void setIndicadorFactivelFaturavelEsp(
			String indicadorFactivelFaturavelEsp) {
		this.indicadorFactivelFaturavelEsp = indicadorFactivelFaturavelEsp;
	}


	public String getPrazoAtendimentoArpe() {
		return prazoAtendimentoArpe;
	}


	public void setPrazoAtendimentoArpe(String prazoAtendimentoArpe) {
		this.prazoAtendimentoArpe = prazoAtendimentoArpe;
	}

...
public class ComandarEncerramentoRegistroAtendimentoAction extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping,
		...
		this.verificarPermissaoUsuario(usuarioResponsavelEncerramento,raEncerramentoComando.getUnidadeOrganizacionalAtual(),raEncerramentoComando.getUnidadeOrganizacionalSuperior(), sistemaParametros, colecaoCentralAtendimento);
	 ...
	 */
	private void verificarPermissaoUsuario(Usuario usuario, UnidadeOrganizacional unidadeAtual, UnidadeOrganizacional unidadeSuperior,SistemaParametro sistemaParametros, Collection colecaoCentralAtendimento){
		...
		boolean flagCentralAtendimento = false;
		...
		if (colecaoCentralAtendimento != null && !colecaoCentralAtendimento.isEmpty()) { 

			Iterator centralAtendimentoIterator = colecaoCentralAtendimento.iterator();
			
			while (centralAtendimentoIterator.hasNext()) {
				UnidadeOrganizacional centralAtendimento = (UnidadeOrganizacional) centralAtendimentoIterator.next();
				
				if (lotacaoUsuario.getId().equals(centralAtendimento.getId())) {
					flagCentralAtendimento = true;
				}
			}

...
public class InserirTipoSolicitacaoEspecificacaoAction extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping,
		...
		// indicativo de Ligado Decreto
		if (inserirTipoSolicitacaoEspecificacaoActionForm.getIndicadorFactivelFaturavel() != null
				&& !inserirTipoSolicitacaoEspecificacaoActionForm.getIndicadorFactivelFaturavel().equals("") ) {
			
			solicitacaoTipo.setIndicadorFactivelFaturavel(new Short(inserirTipoSolicitacaoEspecificacaoActionForm.getIndicadorFactivelFaturavel()));
		...
		//Inseri valor Padrão
		solicitacaoTipo.setIndicadorRALojaVirtualSemMatricula(new Short("2"));
		solicitacaoTipo.setIndicadorPermiteClienteDesconhecido(new Short("2"));

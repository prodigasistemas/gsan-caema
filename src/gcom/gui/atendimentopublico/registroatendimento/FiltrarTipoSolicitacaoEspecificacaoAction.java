...
//		}
		...
		// indicativo de tarifa solcial
		if (filtrarTipoSolicitacaoEspecificacaoActionForm.getIndicadorFactivelFaturavel() != null
				&& !filtrarTipoSolicitacaoEspecificacaoActionForm.getIndicadorFactivelFaturavel().equals("3")) {

			peloMenosUmParametroInformado = true;

			filtroSolicitacaoTipo.adicionarParametro(new ParametroSimples(
					FiltroSolicitacaoTipo.INDICADOR_FACTIVEL_FATURAVEL,filtrarTipoSolicitacaoEspecificacaoActionForm.getIndicadorFactivelFaturavel()));

...
public class ConsultarRegistroAtendimentoActionForm extends ActionForm{
    ...
    private String grupoTipoSolicitacao;
    ...
    public void reset(ActionMapping actionMapping, HttpServletRequest httpServletRequest) {
        ...
        idGrupoTipoSolicitacao = null;
        grupoTipoSolicitacao = null;
	...
	public String getGrupoTipoSolicitacao() {
		return grupoTipoSolicitacao;
	}

	public void setGrupoTipoSolicitacao(String grupoTipoSolicitacao) {
		this.grupoTipoSolicitacao = grupoTipoSolicitacao;
	}

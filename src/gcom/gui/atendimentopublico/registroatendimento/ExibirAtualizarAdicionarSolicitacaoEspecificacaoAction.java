...
public class ExibirAtualizarAdicionarSolicitacaoEspecificacaoAction extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping,
				...
				while (colecaoSolicitacaoTipoEspecificacaoIterator.hasNext()) {
					...
					if (index == posicaoComponente) {
						...
						if (sessao.getAttribute("atualizarAdicionarSolicitacaoEspecificacaoActionForm") == null) {
							...
							//RM 8848
							atualizarAdicionarSolicitacaoEspecificacaoActionForm.setIndicadorCoordenadaProgisRA("" + solicitacaoTipoEspecificacao.getIndicadorCoordenadaProgisRA());
							...
							//RM 5924 - Amélia Pessoa - lista de arquivos POP
							...
							if (solicitacaoTipoEspecificacao.getMotivoCorte() != null
									&& !solicitacaoTipoEspecificacao.getMotivoCorte().equals("")) {
								atualizarAdicionarSolicitacaoEspecificacaoActionForm.setIdMotivoCorte("" + solicitacaoTipoEspecificacao.getMotivoCorte().getId());
							} else {
								atualizarAdicionarSolicitacaoEspecificacaoActionForm.setIdMotivoCorte("");
							}
							...
							atualizarAdicionarSolicitacaoEspecificacaoActionForm.setIndicadorAnexoObrigatorio(
							         String.valueOf(solicitacaoTipoEspecificacao.getIndicadorAnexoObrigatorio()));
							...
							// colocado por Maxwell Moreira em 23/11/2012
							if (solicitacaoTipoEspecificacao.getIndicadorInformarDocumentoPagamentoAMaior() != null){
                            	atualizarAdicionarSolicitacaoEspecificacaoActionForm.setIndicadorInformarDocumentoPagamentoAMaior(
    									String.valueOf(solicitacaoTipoEspecificacao.getIndicadorInformarDocumentoPagamentoAMaior()));	
							} else {
								atualizarAdicionarSolicitacaoEspecificacaoActionForm.setIndicadorInformarDocumentoPagamentoAMaior(
    									String.valueOf("2"));
							}
							...
							if (solicitacaoTipoEspecificacao.getIndicadorInformarDocumentoPagamentoAMaior() != null){
								atualizarAdicionarSolicitacaoEspecificacaoActionForm.setIndicadorInformarDocumentoPagamentoIndevido(
										String.valueOf(solicitacaoTipoEspecificacao.getIndicadorInformarDocumentoPagamentoIndevido()));	
							} else {
								atualizarAdicionarSolicitacaoEspecificacaoActionForm.
								setIndicadorInformarDocumentoPagamentoIndevido(String.valueOf("2"));
							}
							...
							//Colocado por Ary Lins em 23/08/2012
							atualizarAdicionarSolicitacaoEspecificacaoActionForm.setIndicadorInstalacaoHidrometro(
							         String.valueOf(solicitacaoTipoEspecificacao.getIndicadorInstalacaoHidrometro()));
							
							//Colocado por Diego Maciel em 19/08/2012
							atualizarAdicionarSolicitacaoEspecificacaoActionForm.setIndicadorTipoInstalacaoHidrometro(
							         String.valueOf(solicitacaoTipoEspecificacao.getIndicadorTipoInstalacaoHidrometro()));							
							atualizarAdicionarSolicitacaoEspecificacaoActionForm.setIndicadorTipoSubstituicaoHidrometro(
							         String.valueOf(solicitacaoTipoEspecificacao.getIndicadorTipoSubstituicaoHidrometro()));
							atualizarAdicionarSolicitacaoEspecificacaoActionForm.setIndicadorFactivelFaturavelEsp(
							         String.valueOf(solicitacaoTipoEspecificacao.getIndicadorFactivelFaturavel()));
							if(solicitacaoTipoEspecificacao.getDiasPrazoArpe() != null){
								atualizarAdicionarSolicitacaoEspecificacaoActionForm.setPrazoAtendimentoArpe(String.valueOf(solicitacaoTipoEspecificacao.getDiasPrazoArpe()));
							...
							// Colocado por Fernanda Almeida em 16/05/2012
							// RM6899
							atualizarAdicionarSolicitacaoEspecificacaoActionForm.setIndicadorUso("" + solicitacaoTipoEspecificacao.getIndicadorUso());
		...
		if (httpServletRequest.getParameter("desfazer") != null	&& !httpServletRequest.getParameter("desfazer").equals("")) {
			...
			atualizarAdicionarSolicitacaoEspecificacaoActionForm.setIndicadorPermiteCancelarDebito(
			String.valueOf(solicitacaoTipoEspecificacao.getIndicadorPermiteCancelarDebito()));
			...
			atualizarAdicionarSolicitacaoEspecificacaoActionForm.setPrazoAtendimentoArpe(
					String.valueOf(solicitacaoTipoEspecificacao.getDiasPrazoArpe()));
		...
		if (httpServletRequest.getParameter("limpaSessao") != null
			...
			atualizarAdicionarSolicitacaoEspecificacaoActionForm.setIndicadorCoordenadaProgisRA("");
...
//			filtroUnidadeOrganizacional.adicionarParametro(new ParametroSimples(FiltroUnidadeOrganizacional.INDICADOR_USO,ConstantesSistema.INDICADOR_USO_ATIVO));
		...
		if ( atualizarAdicionarSolicitacaoEspecificacaoActionForm.getIdTipoSolicitacao() != null && 
				!atualizarAdicionarSolicitacaoEspecificacaoActionForm.getIdTipoSolicitacao() .equals("")){
			atualizarAdicionarSolicitacaoEspecificacaoActionForm.setIndicadorEspecificacaoObrigatorio("1");
		} else {
			atualizarAdicionarSolicitacaoEspecificacaoActionForm.setIndicadorEspecificacaoObrigatorio("");
		}
		
		if ( sessao.getAttribute("idTipoSolicitacao") != null && 
				sessao.getAttribute("idTipoSolicitacao") .equals("201") ){
			atualizarAdicionarSolicitacaoEspecificacaoActionForm.setIndicadorMotivoCorteObrigatorio("1");
		} else{
			atualizarAdicionarSolicitacaoEspecificacaoActionForm.setIndicadorMotivoCorteObrigatorio("2");
    ...
    private void adicionarEspecificacao( 
        ...
        if ( trocou ){
            if ( solicitacaoTipoEspecificacao.getSolicitacaoTipoEspecificacaoNovoRA() != null ){
            	if(solicitacaoTipoEspecificacao.getSolicitacaoTipoEspecificacaoNovoRA().getId() != null){

...
public class ExibirConsultarDadosOrdemServicoVisitaAction extends GcomAction {
    ...
    public ActionForward execute(ActionMapping actionMapping,
        ...
        ConsultarDadosOrdemServicoVisitaActionForm form = 
        	(ConsultarDadosOrdemServicoVisitaActionForm) actionForm;
        ...
        StatusWizard statusWizard = 
    		new StatusWizard(
    		"consultarDadosOrdemServicoVisitaWizardAction", 
    		"consultarDadosOrdemServicoVisitaAction",
    		null,
    		null);
        ...
        statusWizard.inserirNumeroPaginaCaminho(
        	statusWizard.new StatusWizardItem(
        			1, 
        			"AbaAnormalidadeA.gif", 
        			"AbaAnormalidadeD.gif",
    ...
    public void carregarCampos( HttpSession sessao, HttpServletRequest httpServletRequest, 
        ...
        if (dadosOS != null) {
        	...
        	// 4. Anormalidade Encontrada (ID)
        	if (dadosOS[7] != null) {
        		form.setIdAnormalidadeEncontrada(((Integer) dadosOS[7]).toString()); 
        	} else {
        		form.setIdAnormalidadeEncontrada(null);
        	}

...
public class ExibirFiltrarTipoServicoAction extends GcomAction {
    ...
    public ActionForward execute(ActionMapping actionMapping,
		...
		if(httpServletRequest.getParameter("indicadorGerarResumo") != null){
			form.setIndicadorGerarResumo(httpServletRequest.getParameter("indicadorGerarResumo"));
		}else{
			form.setIndicadorGerarResumo("");
		}		

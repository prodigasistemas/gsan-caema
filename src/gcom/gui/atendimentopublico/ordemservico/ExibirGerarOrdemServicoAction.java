	...
	public ActionForward execute(ActionMapping actionMapping,
		...
		if (Util.validarNumeroMaiorQueZERO(idServicoTipo)) {
			...
			if (servicoTipo != null) {
				...
				if(servicoTipo.getIndicadorPavimento() == ConstantesSistema.SIM.shortValue()){
					form.setIndicadorPavimentoRua(ConstantesSistema.SIM.toString());
				}else{
					form.setIndicadorPavimentoRua("");
				}
		...
		if(form.getIndicadorPavimentoRua()!=null &&
				!form.getIndicadorPavimentoRua().equals("") &&
				form.getIndicadorPavimentoRua().equals(ConstantesSistema.SIM.toString())){
			...
			if (colecaoUnidadeOrgazanicional != null && !colecaoUnidadeOrgazanicional.isEmpty()) {
				...
				if(idRA!=null){
					Integer idUnidadeRepavimentadoraSugerida = 
							fachada.obterUnidadeRepavimentadoraSugerida(idRA);
					
					if(idUnidadeRepavimentadoraSugerida!=null){
						form.setIdUnidadeRepavimentadora(idUnidadeRepavimentadoraSugerida+"");
					}

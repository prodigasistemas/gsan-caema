...
public class FiltrarOrdemProcessoRepavimentacaoActionForm extends ActionForm {
	...
	private String periodoEnvioOsInicial;
	private String periodoEnvioOsFinal;
	...
	public void reset(ActionMapping arg0, ServletRequest arg1) {
		...
		this.periodoEnvioOsInicial = "";
		this.periodoEnvioOsFinal = "";
	...
	/**
	 * @return Retorna o campo periodoEnvioOsFinal.
	 */
	public String getPeriodoEnvioOsFinal() {
		return periodoEnvioOsFinal;
	}

	/**
	 * @param periodoEnvioOsFinal O periodoEnvioOsFinal a ser setado.
	 */
	public void setPeriodoEnvioOsFinal(String periodoEnvioOsFinal) {
		this.periodoEnvioOsFinal = periodoEnvioOsFinal;
	}

	/**
	 * @return Retorna o campo periodoEnvioOsInicial.
	 */
	public String getPeriodoEnvioOsInicial() {
		return periodoEnvioOsInicial;
	}

	/**
	 * @param periodoEnvioOsInicial O periodoEnvioOsInicial a ser setado.
	 */
	public void setPeriodoEnvioOsInicial(String periodoEnvioOsInicial) {
		this.periodoEnvioOsInicial = periodoEnvioOsInicial;
	}

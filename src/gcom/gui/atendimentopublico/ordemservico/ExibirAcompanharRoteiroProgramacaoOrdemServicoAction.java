...
public class ExibirAcompanharRoteiroProgramacaoOrdemServicoAction extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping,ActionForm actionForm, 
		...
		// Recuperar Os Programacao para controle de transação
				...
				for (Iterator iterator = colecaoAcompanhamentoArquivosRoteiro.iterator(); iterator.hasNext();) {
					...
					for (Iterator iOsProgramacao = acompanhamentoArquivosRoteiroHelper.getOsProgramacaoAcompServicoHelper().iterator(); iOsProgramacao.hasNext();) {
						...
						if (osProgramacaoAcompServico.getIdOrdemServico().equals(acompanharActionForm.getIdOrdemServico())){
		...
		// [SB0007] - Remaneja Ordem de Serviço
			...
			this.remanejaOrdemServico(acompanharActionForm,usuario, osProgramacaoAcompanhamentoServico);
	...
	private void incluirOrdemServicoProgramacao(AcompanharRoteiroProgramacaoOrdemServicoActionForm acompanharActionForm,
		...
		fachada.validarInclusaoOsNaProgramacao(os, idUnidadeLotacao,null, usuario);
		...
		for (int i = 0; i < equipeSelecionadaBanco.length; i++) {
			...
			if(!equipeSelecionadaParaAlocar.contains(idEquipeBanco)){
				...
				fachada.alocaEquipeParaOs(new Integer(acompanharActionForm.getIdOrdemServico()),
					dataRoteiro,new Integer(idEquipeBanco), false, null, null);
	...
	private void remanejaOrdemServico(AcompanharRoteiroProgramacaoOrdemServicoActionForm acompanharActionForm,
		Usuario usuario, OSProgramacaoAcompanhamentoServicoHelper osProgramacaoAcompanhamentoServico){
		...
		fachada.alocaEquipeParaOs(idOrdemServico,dataRoteiro,equipeAtual, false, null, osProgramacaoAcompanhamentoServico);

...
public class ExibirFiltrarImovelEmissaoOrdensSeletivasHidrometro extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping,
		...
		if(imovelEmissaoOrdensSeletivas.getIndicadorMedicaoTelemedido() == null)
			imovelEmissaoOrdensSeletivas.setIndicadorMedicaoTelemedido(String.valueOf(ConstantesSistema.NAO));
		...
		if (imovelEmissaoOrdensSeletivas.getTipoOrdem().
			...
			if (imovelEmissaoOrdensSeletivas.getAnormalidadeHidrometro() == null) {
				...
				filtroLeituraAnormalidade.adicionarParametro(new ParametroSimples(FiltroLeituraAnormalidade.INDICADOR_EXIBIR_ANORMALIDADE_RELATORIO, 

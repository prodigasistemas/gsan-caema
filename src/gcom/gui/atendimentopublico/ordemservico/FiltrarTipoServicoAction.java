...
public class FiltrarTipoServicoAction extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping,
        ...
        String descricao = form.getDescricaoTipoServico().trim();
        ...
        String indicadorGerarResumo = form.getIndicadorGerarResumo();
        ...
        //indicador Atividade Única
        if(form.getIndicadorAtividadeUnica() != null && !form.getIndicadorAtividadeUnica().equals("")){
        	peloMenosUmParametroInformado = true;
        	filtroTipoServico.adicionarParametro(new ParametroSimples(FiltroTipoServico.INDICADOR_ATIVIDADE_UNICA, form.getIndicadorAtividadeUnica()));
        }
...
*/        
        ...
        //Indicador Gerar Resumo
        if(indicadorGerarResumo != null && !indicadorGerarResumo.equals("")){
        	peloMenosUmParametroInformado = true;
        	filtroTipoServico.adicionarParametro(new ParametroSimples(FiltroTipoServico.INDICADOR_GERAR_RESUMO, indicadorGerarResumo));
        }

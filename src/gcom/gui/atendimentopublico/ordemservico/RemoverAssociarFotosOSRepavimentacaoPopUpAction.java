 ...
 */
public class RemoverAssociarFotosOSRepavimentacaoPopUpAction extends GcomAction {
	/**
	 * < <Descrição do método>>
	 * 
	 * @param actionMapping
	...
	public ActionForward execute(ActionMapping actionMapping,
		...
		retorno = actionMapping.findForward("removerAssociarFotosOSRepavimentacaoPopUp");
		...
		if (idRemover != null && !idRemover.equals("") ) {
			...
			if (colecaoArquivos != null && !colecaoArquivos.isEmpty()) {
				...
				Iterator it = colecaoArquivos
						.iterator();

				while (it.hasNext()) {
					count++;
					raAnexo = (RegistroAtendimentoAnexo) it
							.next();

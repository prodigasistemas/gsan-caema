 ...
 * @date 24/09/2012
 */
public class FiltrarFiscalizarOSAcompanhamentoServicoSimRessalvaActionForm extends ValidatorActionForm {
	private static final long serialVersionUID = 1L;
	
	private String servicoEmCampo;
	private String servicoNovo;
	...
	public String getServicoNovo() {
		return servicoNovo;
	}
	public void setServicoNovo(String servicoNovo) {

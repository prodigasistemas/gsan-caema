		...
		if (unidadeOrganizacionalId != null && !unidadeOrganizacionalId.equals("")) {
			...
			httpServletRequest.removeAttribute("colecaoEquipesGruposDeBairros");
				...
				if(inserirEquipeActionForm.getIndicadorManterProgramacaoOSdiaAnterior() == null
						|| inserirEquipeActionForm.getIndicadorManterProgramacaoOSdiaAnterior().equals("") ){
					
					inserirEquipeActionForm.setIndicadorManterProgramacaoOSdiaAnterior(ConstantesSistema.NAO.toString());

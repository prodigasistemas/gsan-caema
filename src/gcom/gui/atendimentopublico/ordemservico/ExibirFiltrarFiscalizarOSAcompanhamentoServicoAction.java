...
import gcom.gui.relatorio.cobranca.RelatorioDocumentosAReceberForm;
...
public class ExibirFiltrarFiscalizarOSAcompanhamentoServicoAction extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping,
		...
		if (menu != null && !menu.equalsIgnoreCase("") && httpServletRequest.getParameter("limpar") == null){
		...
		if (objetoConsulta != null && !objetoConsulta.trim().equals("") && 
			...
			pesquisarLocalidade(filtrarFiscalizarOSAcompanhamentoServicoActionForm,sessao);			
		...
		/**
		 * [UC1249] FiltroOSEncerradasAcompanhamentoServico
		 * @author Diogo Luiz
		 * @date 02/09/2013
		 */		
		if(objetoConsulta != null && !objetoConsulta.trim().equals("") &&
		...
		// Recupera os valores da unidade do form
				String idUnidade = filtrarFiscalizarOSAcompanhamentoServicoActionForm.getIdUnidade();
				String nomeUnidade = filtrarFiscalizarOSAcompanhamentoServicoActionForm.getNomeUnidade();
				...
				if (idUnidade != null && !idUnidade.trim().equals("")
					...
					if (colecaoUnidade != null && !colecaoUnidade.isEmpty()) {
						...
						filtrarFiscalizarOSAcompanhamentoServicoActionForm.setNomeUnidade(unidadeOrganizacional
								.getDescricao());
					} else {

						filtrarFiscalizarOSAcompanhamentoServicoActionForm.setIdUnidade("");
						filtrarFiscalizarOSAcompanhamentoServicoActionForm.setNomeUnidade("Unidade inexistente");
					...
					filtrarFiscalizarOSAcompanhamentoServicoActionForm.setNomeUnidade("");
				}			
		}
	...
	private void pesquisarLocalidade(FiltrarFiscalizarOSAcompanhamentoServicoActionForm filtrarFiscalizarOSAcompanhamentoServicoActionForm, HttpSession sessao){

		FiltroLocalidade filtroLocalidade = new FiltroLocalidade();
		filtroLocalidade.adicionarParametro(new ParametroSimples(FiltroLocalidade.ID,filtrarFiscalizarOSAcompanhamentoServicoActionForm.getIdLocalidade()));
		...
		if ( Util.isVazioOrNulo(colecaoLocalidade)) {
				filtrarFiscalizarOSAcompanhamentoServicoActionForm.setIdLocalidade("");
				filtrarFiscalizarOSAcompanhamentoServicoActionForm.setNomeLocalidade("Localidade Inexistente");
		...
		filtrarFiscalizarOSAcompanhamentoServicoActionForm.setIdLocalidade(localidade.getId().toString());
		filtrarFiscalizarOSAcompanhamentoServicoActionForm.setNomeLocalidade(localidade.getDescricao());	

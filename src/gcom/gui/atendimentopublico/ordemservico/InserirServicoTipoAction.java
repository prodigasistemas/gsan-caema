...
public class InserirServicoTipoAction extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping,
		...
		if (form.getIndicadorNovaEtapa() != null) {
			servicoTipo.setIndicadorNovaEtapa(Short.parseShort(form.getIndicadorNovaEtapa()));
		} else {
			servicoTipo.setIndicadorNovaEtapa(ConstantesSistema.NAO);
		}
		
		if (form.getIndicadorServicoCobranca() != null) {
			servicoTipo.setIndicadorServicoCobranca(Short.parseShort(form.getIndicadorServicoCobranca()));
		} else {
			servicoTipo.setIndicadorServicoCobranca(ConstantesSistema.NAO);
		}
		...
		if (servicoTipo.getIndicadorTipoCalcArea() == null){
			servicoTipo.setIndicadorTipoCalcArea(ConstantesSistema.NAO);
		}
		
		String valorServico = form.getValor().replace(".","").replace(",", ".");
		
		servicoTipo.setValor(Util.formatarStringParaBigDecimal(valorServico));		
		
		servicoTipo.setIndicadorGerarResumo(Short.parseShort(form.getIndicadorGerarResumo()));

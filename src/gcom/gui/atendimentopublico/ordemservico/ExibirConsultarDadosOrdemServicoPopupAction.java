...
public class ExibirConsultarDadosOrdemServicoPopupAction extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping,
		...
		//[RM7263] Exibe popup na tela de acompanhamento de serviço - retira o botão de encerrar
		if(httpServletRequest.getParameter("acompanhamento")!= null && !httpServletRequest.getParameter("acompanhamento").equals("")){
			httpServletRequest.setAttribute("acompanhamento","s");
		}
		/*[RM7363]
		Exibir link 'Exibir Fotos'
		...
		filtroOsProgramacao.adicionarParametro(new ParametroSimples(FiltroOSProgramacaoAcompanhamentoServico.ORDEM_SERVICO_ID,ordemServico.getId()));
		...
		if (new Short(ordemServico.getSituacao()).intValue() == OrdemServico.SITUACAO_ENCERRADO.intValue()) {
			...
			if (servicoCobrado) {
				...
				if (ordemServico.getServicoNaoCobrancaMotivo() != null){
					...
					consultarDadosOrdemServicoPopupActionForm.setMotivoNaoCobranca(ordemServico

...
public class ExibirManterOrdemProcessoRepavimentacaoAction extends GcomAction {
    ...
    public ActionForward execute(ActionMapping actionMapping,
		...
		if (sessao.getAttribute("osPavimentoHelper") != null) {
			...
			adicionaOsParametrosNoForm( osPavimentoHelper , form , fachada, sessao );
    ...
    private void adicionaOsParametrosNoForm( OSPavimentoHelper osPavimentoHelper, 
    		FiltrarOrdemProcessoRepavimentacaoActionForm form , Fachada fachada, HttpSession sessao) {
    	...
    	if(osPavimentoHelper.getIdUnidadeResponsavel() != null){
			...
			sessao.setAttribute("idUnidadeRepavimentadora", osPavimentoHelper.getIdUnidadeResponsavel().toString());
			form.setIdUnidadeResponsavel(osPavimentoHelper.getIdUnidadeResponsavel().toString());
		}
		...
		if(osPavimentoHelper.getPeriodoEnvioOsInicial() != null && osPavimentoHelper.getPeriodoEnvioOsInicial()!= null){
			form.setPeriodoEnvioOsInicial(osPavimentoHelper.getPeriodoEnvioOsInicial());
			form.setPeriodoEnvioOsFinal(osPavimentoHelper.getPeriodoEnvioOsFinal());
		}else{
			form.setPeriodoEnvioOsInicial(null);
			form.setPeriodoEnvioOsFinal(null);
		}

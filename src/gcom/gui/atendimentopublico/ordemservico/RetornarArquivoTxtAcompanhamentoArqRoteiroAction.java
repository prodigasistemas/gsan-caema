...
public class RetornarArquivoTxtAcompanhamentoArqRoteiroAction extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping,
		...
		String nomeArquivo = fachada.nomeArquivoAcompanhamentoServico(arquivoTextoAcompanhamentoServico.getEquipe());
			...
			if (!arquivoPossuiExtensaoGZ) {
				...
				outputStream.write( 
					fachada.gerarArquivoTextoOrdensServicoAcompanhamentoEquipe(
						arquivoTextoAcompanhamentoServico.getEquipe(),
			    ...
			    if (arquivoTextoAcompanhamentoServico.getEquipe().getAgrupamentoBairroRepavimentadora() != null 
			    		&& !arquivoTextoAcompanhamentoServico.getEquipe().getAgrupamentoBairroRepavimentadora().equals("")){
			    	
			    	nomeArquivo = nomeArquivo.replace(".txt", ".zip");

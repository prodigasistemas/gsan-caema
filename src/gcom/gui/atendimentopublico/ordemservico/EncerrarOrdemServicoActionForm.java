...
public class EncerrarOrdemServicoActionForm extends ActionForm {
    ...
    private String observacaoEncerramentoHidden;
    private String idMotivoEncerramentoHidden;
    private String verificadorReloadPagina;
	/**
	...
	public String getObservacaoEncerramentoHidden() {
		return observacaoEncerramentoHidden;
	}

	public void setObservacaoEncerramentoHidden(String observacaoEncerramentoHidden) {
		this.observacaoEncerramentoHidden = observacaoEncerramentoHidden;
	}

	public String getIdMotivoEncerramentoHidden() {
		return idMotivoEncerramentoHidden;
	}

	public void setIdMotivoEncerramentoHidden(String idMotivoEncerramentoHidden) {
		this.idMotivoEncerramentoHidden = idMotivoEncerramentoHidden;
	}

	public String getVerificadorReloadPagina() {
		return verificadorReloadPagina;
	}

	public void setVerificadorReloadPagina(String verificadorReloadPagina) {
		this.verificadorReloadPagina = verificadorReloadPagina;
	}

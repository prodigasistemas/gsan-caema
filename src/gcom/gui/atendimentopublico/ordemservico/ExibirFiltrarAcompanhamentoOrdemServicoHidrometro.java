...
import gcom.gui.relatorio.atendimentopublico.GerarRelatorioBoletimMedicaoOrdemServicoInspecaoAnormalidadeActionForm2;
...
public class ExibirFiltrarAcompanhamentoOrdemServicoHidrometro extends
	...
	public ActionForward execute(ActionMapping actionMapping,
		...
		if (httpServletRequest.getAttribute("tipoOrdem") == null && gerarRelatorioAcompanhamento.getTipoOrdem() != null) {
			httpServletRequest.setAttribute("tipoOrdem", gerarRelatorioAcompanhamento.getTipoOrdem());
		}
		...
		if(sessao.getAttribute("colecaoGerencia") == null){
			pesquisarGerencia(sessao);
		}
		
		if(sessao.getAttribute("colecaoHidrometroCapacidade") == null){
			pesquisarCapacidadeHidrometro(sessao);
		}
	...
	/**
	 * Pesquisa Capacidade do Hidrômetro
	 *
	 * @author Anderson Cabral
	 * @date 31/07/2012
	 */
	private void pesquisarCapacidadeHidrometro(HttpSession sessao){
		...
		Collection colecaoHidrometroCapacidade = Fachada.getInstancia().pesquisar(
	 ...
	 * @param session
	 */
	private void pesquisarGerencia(HttpSession sessao){

...
public class AcompanharRoteiroProgramacaoOrdemServicoActionForm extends ValidatorActionForm {
	...
	public String getHabilitarGerar() {
		return habilitarGerar;
	}

	public void setHabilitarGerar(String habilitarGerar) {
	...
	public String getDescricoesOs() {
		return descricoesOs;
	}

	public void setDescricoesOs(String descricoesOs) {
		this.descricoesOs = descricoesOs;
	}

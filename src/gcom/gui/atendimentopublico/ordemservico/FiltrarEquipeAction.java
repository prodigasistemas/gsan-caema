...
public class FiltrarEquipeAction extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping,
		...
		String indicadorManterProgramacaoOSdiaAnterior = filtrarEquipeActionForm.getIndicadorManterProgramacaoOSdiaAnterior();
		String equipeNatureza = filtrarEquipeActionForm.getNaturezaEquipe();
		...
		if(equipeNatureza != null && equipeNatureza.trim().equals(""+ConstantesSistema.NUMERO_NAO_INFORMADO)){
			peloMenosUmParametroInformado = true;
		}
		...
		sessao.setAttribute("indicadorManterProgramacaoOSdiaAnterior", indicadorManterProgramacaoOSdiaAnterior);

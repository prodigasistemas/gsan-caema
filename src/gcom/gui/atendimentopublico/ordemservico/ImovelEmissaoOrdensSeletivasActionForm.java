...
public class ImovelEmissaoOrdensSeletivasActionForm extends ValidatorActionForm {
	...
	public static final String TIPO_INSTALACAO_CAIXA_PROTECAO ="INSTALACAOPROTECAO";
	...
	public String getDigitados() {
		return digitados;
	}
	public void setDigitados(String digitados) {
		this.digitados = digitados;
	}

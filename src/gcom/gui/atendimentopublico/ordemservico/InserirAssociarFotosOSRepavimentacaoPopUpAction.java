 ...
 */
public class InserirAssociarFotosOSRepavimentacaoPopUpAction extends GcomAction {
	/**
	 * < <Descrição do método>>
	 * 
	 * @param actionMapping
	...
	public ActionForward execute(ActionMapping actionMapping,
		...
		if(form.getIdRA() != null && !form.getIdRA().equals("")){
			RegistroAtendimento registroAtendimento = fachada.pesquisarRegistroAtendimentoPorRA(new Integer(form.getIdRA()));		
			...
			if(registroAtendimento != null){
				...
				fachada.removerInserirRegistroAtendimentoAnexo(registroAtendimento,colecaoArquivos);

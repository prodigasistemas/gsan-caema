...
public class ExibirManterEquipeAction extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping,
		...
		String indicadorManterProgramacaoOSdiaAnterior = (String) sessao.getAttribute("indicadorManterProgramacaoOSdiaAnterior");
		String naturezaEquipe = (String) sessao.getAttribute("equipeNatureza");
		...
		Integer totalRegistros = fachada.pesquisarEquipesCount(idEquipe, nome,
				...
				idPerfilServico, indicadorUso, tipoPesquisa,equipamentosEspeciasId, cdUsuarioRespExcServico, 
				indicadorProgramacaoAutomatica, indicadorManterProgramacaoOSdiaAnterior,naturezaEquipe);
		...
		Collection colecaoEquipes = fachada.pesquisarEquipes(idEquipe, nome,
				...
				idPerfilServico, indicadorUso, tipoPesquisa, (Integer) httpServletRequest
						.getAttribute("numeroPaginasPesquisa"),equipamentosEspeciasId, cdUsuarioRespExcServico,
						indicadorProgramacaoAutomatica,indicadorManterProgramacaoOSdiaAnterior,naturezaEquipe);

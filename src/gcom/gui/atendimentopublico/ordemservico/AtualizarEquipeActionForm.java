...
public class AtualizarEquipeActionForm extends ActionForm{
    ...
    private String naturezaEquipe;
    private String indicadorManterProgramacaoOSdiaAnterior;
    ...
    private String agrupamentoBairroRepavimentadora;
    ...
    public String getAgrupamentoBairroRepavimentadora() {
		return agrupamentoBairroRepavimentadora;
	}
	public void setAgrupamentoBairroRepavimentadora(String agrupamentoBairroRepavimentadora) {
		this.agrupamentoBairroRepavimentadora = agrupamentoBairroRepavimentadora;
	}
	public String getNaturezaEquipe() {
		return naturezaEquipe;
	}
	public void setNaturezaEquipe(String naturezaEquipe) {
		this.naturezaEquipe = naturezaEquipe;
	}
	public String getIndicadorManterProgramacaoOSdiaAnterior() {
		return indicadorManterProgramacaoOSdiaAnterior;
	}
	public void setIndicadorManterProgramacaoOSdiaAnterior(String indicadorManterProgramacaoOSdiaAnterior) {
		this.indicadorManterProgramacaoOSdiaAnterior = indicadorManterProgramacaoOSdiaAnterior;
	}

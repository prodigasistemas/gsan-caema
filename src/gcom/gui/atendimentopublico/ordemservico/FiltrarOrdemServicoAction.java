...
public class FiltrarOrdemServicoAction extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping,
		...
		if ((filtrarOrdemServicoActionForm.getNumeroOS() == null || filtrarOrdemServicoActionForm.getNumeroOS().equals(""))&&
			...
			String dtExecucaoInicial = filtrarOrdemServicoActionForm.getPeriodoExecucaoInicial();
			String dtExecucaoFinal = filtrarOrdemServicoActionForm.getPeriodoExecucaoFinal();
				...
				if((dtGeracaoIni==null || dtGeracaoIni.equals(""))
					...
					if((dtProgramacaoIni==null || dtProgramacaoIni.equals("")) 
						...
						if((dtEncerramentoIni==null || dtEncerramentoIni.equals("")) 
							...
							if((dtExecucaoInicial==null || dtExecucaoInicial.equals("")) 
									&& (dtExecucaoFinal==null || dtExecucaoFinal.equals(""))){
...
//			parametroInformado = true;
		...
		if (filtrarOrdemServicoActionForm.getPeriodoExecucaoInicial() != null &&
			...
			dataExecucaoInicial = 
				Util.converteStringParaDate(filtrarOrdemServicoActionForm.getPeriodoExecucaoInicial());
			...
			if (filtrarOrdemServicoActionForm.getPeriodoExecucaoFinal() != null &&
				...
				dataExecucaoFinal = 
					Util.converteStringParaDate(filtrarOrdemServicoActionForm.getPeriodoExecucaoFinal());

...
public class AtualizarFaturamentoSituacaoTipoAction extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping,
		...
		//RM 5981
		String indicadorDesconsiderarEstouroAltoConsumo = atualizarFaturamentoSituacaoTipoActionForm.getIndicadorDesconsiderarEstouroAltoConsumo();
		
		//RM 7209
		String indicadorCobrarConsumoMinimo = atualizarFaturamentoSituacaoTipoActionForm.getIndicadorCobrarConsumoMinimo();
        ...
        //Indicador Cobrar Consumo Minimo
        faturamentoSituacaoTipo.setIndicadorCobrarConsumoMinimo(new Short (indicadorCobrarConsumoMinimo));
        ...
        //Indicador de Desconsiderar Estouro de Consumo e Alto Consumo 
        faturamentoSituacaoTipo.setIcDescEstouroAltoConsumo(new Short (indicadorDesconsiderarEstouroAltoConsumo));

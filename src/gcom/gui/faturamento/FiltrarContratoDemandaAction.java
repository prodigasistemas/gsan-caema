...
public class FiltrarContratoDemandaAction extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping,
		...
		FiltroContratoDemandaImovelComercialIndustrial filtroContratoDemanda = new FiltroContratoDemandaImovelComercialIndustrial(
				FiltroContratoDemandaImovelComercialIndustrial.ID_CONTRATO_DEMANDA_COMERCIAL_INDUSTRIAL);
		...
		if (numeroContrato != null
			...
			filtroContratoDemanda.adicionarParametro(new ParametroSimples(
					FiltroContratoDemandaImovelComercialIndustrial.NUMERO_CONTRATO, numeroContrato));
		...
		if (dataInicioContrato != null
			...
			filtroContratoDemanda.adicionarParametro(new MaiorQue(
					FiltroContratoDemandaImovelComercialIndustrial.DATA_CONTRATO_INICIO,
					dataInicioFormatada));
		}
		...
		if (dataFimContrato != null
			...
			filtroContratoDemanda.adicionarParametro(new MenorQue(
					FiltroContratoDemandaImovelComercialIndustrial.DATA_CONTRATO_FIM, dataFimFormatada));
		}

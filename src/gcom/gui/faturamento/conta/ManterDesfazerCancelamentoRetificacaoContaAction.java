...
public class ManterDesfazerCancelamentoRetificacaoContaAction extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping,
		...
		if (fachada.verificarContasEmitidas2Via(colecaoContasRemocao)){
			
			if (confirmado == null || !confirmado.trim().equalsIgnoreCase("ok")) {

				httpServletRequest.setAttribute("caminhoActionConclusao",
						"/gsan/manterDesfazerCancelamentoRetificacaoContaAction.do");
				// Monta a página de confirmação para perguntar se o usuário
				// quer desfazer o cancelamento/retificação
				// mesmo com segunda via de conta emitida
				return montarPaginaConfirmacao(
						"atencao.existe_segunda_via_conta",

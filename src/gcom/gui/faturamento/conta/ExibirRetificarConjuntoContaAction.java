...
public class ExibirRetificarConjuntoContaAction extends GcomAction {
	...
	private void recebimentoParametrosManterConta(HttpServletRequest httpServletRequest,
          ...
          */            
		 	...
		 	/**********************
		 	 * Verificar se existe alguma conta com o cliente diferente do cliente do imovel
		 	 * Caso tenha, exibe a mensagem de confirmacao da substituicao do cliente (mensagem exibida pelo jsp)
		 	 * 
	    	...
	    	boolean clienteDiferente = this.getFachada().verificarClienteImovelDiferenteClienteConta(contas);
	    	httpServletRequest.setAttribute("clienteDiferente", clienteDiferente);

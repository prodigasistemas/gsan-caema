...
public class ExibirInserirContaAction extends GcomAction {
    ...
    public ActionForward execute(ActionMapping actionMapping,
        ...
        if (idImovel != null && !idImovel.equalsIgnoreCase("") &&
        	...
        	if (colecaoImovel == null || colecaoImovel.isEmpty()){
	    		...
	    		ContratoDemandaImovelComercialIndustrial contratoDemandaImovel = this.pesquisarContratoDemandaImovel(objetoImovel.getId(), fachada);
	    		if(contratoDemandaImovel != null){
	    			contratoDemanda = contratoDemandaImovel.getComp_id().getContratoDemandaComercialIndustrial();
	    			sessao.setAttribute("volumeAguaContratoDemanda", String.valueOf(contratoDemanda.getNumeroVolumeAgua()));
	    		}else{
	    			sessao.setAttribute("volumeAguaContratoDemanda", "");
	    		}
    ...
    /*
     * [SB0009] Pesquisar Contrato de Demanda do Imovel
     * @author Davi Menezes - 05/06/2013
     * RM 8621 - analista responsável: Claudio Lira
     */

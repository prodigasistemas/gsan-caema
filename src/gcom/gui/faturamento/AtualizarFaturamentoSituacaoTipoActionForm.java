...
public class AtualizarFaturamentoSituacaoTipoActionForm extends ValidatorActionForm {
	...
	private String indicadorCobrarConsumoMinimo;
	

	/* RM 5981 
	Desconsiderar o Alto Consumo e o Estouro de Consumo para Localidades pre-definidas
	Amelia Pessoa */ 
	private String indicadorDesconsiderarEstouroAltoConsumo;
	...
	public String getIndicadorDesconsiderarEstouroAltoConsumo() {
		return indicadorDesconsiderarEstouroAltoConsumo;
	}
	public void setIndicadorDesconsiderarEstouroAltoConsumo(
			String indicadorDesconsiderarEstouroAltoConsumo) {
		this.indicadorDesconsiderarEstouroAltoConsumo = indicadorDesconsiderarEstouroAltoConsumo;
	}
	public String getIndicadorCobrarConsumoMinimo() {
		return indicadorCobrarConsumoMinimo;
	}
	public void setIndicadorCobrarConsumoMinimo(String indicadorCobrarConsumoMinimo) {

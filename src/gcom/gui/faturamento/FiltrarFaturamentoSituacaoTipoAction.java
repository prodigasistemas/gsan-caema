...
public class FiltrarFaturamentoSituacaoTipoAction extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping,
		...
		String indicadorCobrarConsumoMinimo = filtrarFaturamentoSituacaoTipoActionForm.getIndicadorCobrarConsumoMinimo();
		...
		if (indicadorCobrarConsumoMinimo != null && !indicadorCobrarConsumoMinimo.trim().equals("")) {
			peloMenosUmParametroInformado = true;
			filtroFaturamentoSituacaoTipo
					.adicionarParametro(new ParametroSimples(
							FiltroFaturamentoSituacaoTipo.INDICADOR_COBRAR_CONSUMO_MINIMO,
							indicadorCobrarConsumoMinimo));
		}

...
public class InserirFaturamentoSituacaoTipoAction extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping,
		...
		//RM 5981
		Short indicadorDesconsiderarEstouroAltoConsumo = inserirFaturamentoSituacaoTipoActionForm.getIndicadorDesconsiderarEstouroAltoConsumo();
		
		//RM 7209
		Short indicadorCobrarConsumoMinimo = inserirFaturamentoSituacaoTipoActionForm.getIndicadorCobrarConsumoMinimo();
		...
		faturamentoSituacaoTipo.setIndicadorCobrarConsumoMinimo(indicadorCobrarConsumoMinimo);

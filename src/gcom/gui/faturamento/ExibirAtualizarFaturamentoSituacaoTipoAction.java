	...
	public ActionForward execute(ActionMapping actionMapping,
		...
		if (id != null && !id.trim().equals("") && Integer.parseInt(id) > 0) {
			...
			if (id != null && !id.trim().equals("")) {
				...
				//RM 5981
				atualizarFaturamentoSituacaoTipoActionForm
				.setIndicadorDesconsiderarEstouroAltoConsumo(faturamentoSituacaoTipo
						.getIcDescEstouroAltoConsumo().toString());
				
				atualizarFaturamentoSituacaoTipoActionForm
						.setIndicadorCobrarConsumoMinimo(faturamentoSituacaoTipo
								.getIndicadorCobrarConsumoMinimo().toString());
			...
			//RM 5981
			atualizarFaturamentoSituacaoTipoActionForm.setIndicadorDesconsiderarEstouroAltoConsumo(
					faturamentoSituacaoTipo.getIcDescEstouroAltoConsumo().toString());
			
			//RM 7209
			atualizarFaturamentoSituacaoTipoActionForm.setIndicadorCobrarConsumoMinimo(
					faturamentoSituacaoTipo.getIndicadorCobrarConsumoMinimo().toString());

 ...
 */
public class ExibirInserirReajusteConsumoTarifaPPPAction extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping,
		...
		ActionForward retorno = actionMapping
				.findForward("inserirReajusteConsumoTarifaPPP");
		...
		for (int i = 0; i < ids.length; i++) {
			...
			filtroConsumoTarifaVigenPpp.adicionarParametro(new ParametroSimples(FiltroConsumoTarifaVigenPpp.ID,idConsumoTarifaVigencia));
			filtroConsumoTarifaVigenPpp.adicionarCaminhoParaCarregamentoEntidade(FiltroConsumoTarifaVigenPpp.CONSUMO_TARIFA);
			
			Collection colecaoConsumoTarifaVigencia = (Collection) fachada.pesquisar(filtroConsumoTarifaVigenPpp, ConsumoTarifaVigenPpp.class.getName());	

			ConsumoTarifaVigenPpp consumoTarifaVigencia = (ConsumoTarifaVigenPpp) colecaoConsumoTarifaVigencia.iterator().next();
			
			
			adicionarConsumoTarifa(colecaoIdsConsumoTarifa,consumoTarifaVigencia.getConsumoTarifaPpp().getId().toString());
			
			colecaoIdsConsumoTarifa.add(consumoTarifaVigencia.getConsumoTarifaPpp().getId().toString());
		}

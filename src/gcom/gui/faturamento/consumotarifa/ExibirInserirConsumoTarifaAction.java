...
public class ExibirInserirConsumoTarifaAction extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping,
		...
		//Verificar se veio do Contrato de Demanda
		String tipoContratoDemanda = (String) httpServletRequest.getParameter("tipoContratoDemanda");
		...
		if ((sessao.getAttribute("indicadorContratoDemanda") != null)
				&& (! sessao.getAttribute("indicadorContratoDemanda").equals(""))) {
			inserirConsumoTarifaActionForm.setIndicadorContratoDemanda((String) sessao.getAttribute("indicadorContratoDemanda"));
		}
		...
		if (tipoContratoDemanda != null && !tipoContratoDemanda.trim().equals("")){
			inserirConsumoTarifaActionForm.reset(actionMapping, httpServletRequest);
			
			sessao.removeAttribute("vigencia");
			sessao.removeAttribute("descricao");
			sessao.removeAttribute("select");
			sessao.removeAttribute("selectLigacaoAguaPerfil");
			sessao.removeAttribute("selectTarifaTipoCalculo");
			sessao.removeAttribute("indicadorContratoDemanda");
			sessao.removeAttribute("colecaoConsumoTarifaCategoria");
		
			if(tipoContratoDemanda.equals("1")){
				sessao.setAttribute("habilitarVoltar", "1");
			}else if(tipoContratoDemanda.equals("2")){
				sessao.setAttribute("habilitarVoltar", "2");
			}
		}

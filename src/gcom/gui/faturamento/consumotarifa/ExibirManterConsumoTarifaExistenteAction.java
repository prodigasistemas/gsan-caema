...
public class ExibirManterConsumoTarifaExistenteAction extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping,
		...
		if ((idVigencia != null)
			...
			if (colecaoLigacaoAguaPerfil == null || colecaoLigacaoAguaPerfil.isEmpty()) {
				...
				if (consumoTarifaVigencia.getConsumoTarifa()!=null){
					...
					indicadorContratoDemanda = consumoTarifaVigencia.getConsumoTarifa().getIndicadorContratoDemanda();
					inserirConsumoTarifaActionForm.setIndicadorContratoDemanda(indicadorContratoDemanda.toString());
				}else{
					sessao.setAttribute("selectLigacaoAguaPerfil", "");
				}
			}
		...
		if(	sessao.getAttribute("indicadorContratoDemanda") != null){
			inserirConsumoTarifaActionForm.setIndicadorContratoDemanda(
					sessao.getAttribute("indicadorContratoDemanda").toString());
		}		

 ...
 */
public class ExibirAtualizarCategoriaFaixaConsumoTarifaPPPAction extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping,
		...
		ActionForward retorno = actionMapping
				.findForward("atualizarCategoriaFaixaConsumoTarifaPPP");
		...
		if ((colecaoFaixa != null) && (!colecaoFaixa.isEmpty())){
			...
			while (colecaoFaixaIt.hasNext()) {
				ConsumoTarifaFaixaPpp consumoTarifaFaixa = (ConsumoTarifaFaixaPpp) colecaoFaixaIt.next();

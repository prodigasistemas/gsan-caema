 ...
 */
public class ExibirManterConsumoTarifaPPPAction extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping,
		...
		ActionForward retorno = actionMapping
				.findForward("manterConsumoTarifaPPP");
		...
		sessao.setAttribute("ultimaBuscaManter",new Date());
		
		if (sessao.getAttribute("idLigacaoAguaPerfil")!=null){
			sessao.removeAttribute("idLigacaoAguaPerfil");
		}
		
		if ((retorno != null)&&(retorno.getName().equalsIgnoreCase("manterConsumoTarifaPPP"))) {
			
			FiltroConsumoTarifaVigenPpp filtroConsumoTarifaVigenPpp = (FiltroConsumoTarifaVigenPpp) 
			sessao.getAttribute("filtroConsumoTarifaVigenciaPPP");
			
			Collection colecaoResultado = this.getFachada().pesquisar(filtroConsumoTarifaVigenPpp,0,ConsumoTarifaVigenPpp.class.getName());
			
			Map resultado = controlarPaginacao(httpServletRequest, retorno,
					filtroConsumoTarifaVigenPpp, ConsumoTarifaVigenPpp.class.getName());
			...
			if (colecaoFiltroConsumoTarifaVigencia.size()== 1 && identificadorAtualizar != null){
				...
				ConsumoTarifaVigenPpp consumoTarifaVigencia = (ConsumoTarifaVigenPpp) colecaoFiltroConsumoTarifaVigencia.iterator().next();

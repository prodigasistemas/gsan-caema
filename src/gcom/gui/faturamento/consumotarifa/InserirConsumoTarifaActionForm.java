...
public class InserirConsumoTarifaActionForm extends ValidatorActionForm {
	...
	private String indicadorContratoDemanda;
	...
	public String getIndicadorContratoDemanda() {
		return indicadorContratoDemanda;
	}

	public void setIndicadorContratoDemanda(String indicadorContratoDemanda) {
	...
	public void reset(ActionMapping actionMapping, HttpServletRequest httpServletRequest) {
		...
		slcDescTarifa = "-1";
		dataVigencia = "";
		idLigacaoAguaPerfil = "-1";
		idTarifaTipoCalculo = "-1";
		indicadorContratoDemanda = "" + ConstantesSistema.NAO;
	}

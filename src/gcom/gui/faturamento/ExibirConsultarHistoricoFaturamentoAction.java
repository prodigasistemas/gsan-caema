           ...
           (reloadPage == null || reloadPage.equalsIgnoreCase(""))){
            ...
            if (objetoImovel != null ) {
              ...
              /*Pesquisar o cliente usuário do imóvel selecionado
          	  ...
          	  //==================================================================
          	  Iterator contas = colecaoContaImovel.iterator();
          	  Iterator contasHistorico = colecaoContaHistoricoImovel.iterator();
          	  
          	  
          	  DebitoCreditoSituacao debcredsit = new DebitoCreditoSituacao();
          	  debcredsit.setDescricaoAbreviada("PCR");
          	  
          	  while(contas.hasNext()){
          		  
          		  Conta conta = (Conta)contas.next();
          		  
          		  boolean verificarParcelamento = fachada.verificarRevisaoContratoParcelamento(conta.getId());
          		  
          		  if(verificarParcelamento){
          			  conta.setDebitoCreditoSituacaoAtual(debcredsit);
          		  }

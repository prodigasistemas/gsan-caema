...
public class ExibirInserirFaturamentoSituacaoTipoAction extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping,
		...
		if (httpServletRequest.getParameter("menu") != null && httpServletRequest.getParameter("menu").equals("sim")) {
			...
			//RM 5981
			inserirFaturamentoSituacaoTipoActionForm.setIndicadorDesconsiderarEstouroAltoConsumo(new Short("2"));
			//RM 7209
			inserirFaturamentoSituacaoTipoActionForm.setIndicadorCobrarConsumoMinimo(ConstantesSistema.NAO);
		}

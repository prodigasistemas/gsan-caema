...
public class AtualizarSubsistemaAbastecimentoAction extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping,
		...
		subsistemaAbastecimento.setId(Integer.valueOf(form.getCodigo()));
		...
		subsistemaAbastecimento.setIndicadorUso(Short.valueOf(form.getIndicadorUso()));
		subsistemaAbastecimento.setSubsistemaSistemaAbastecimento(this.obterSubsistemaSistemaAbastecimento(form));
		
		fachada.atualizarSubsistemaAbastecimento(subsistemaAbastecimento);
		
		montarPaginaSucesso(httpServletRequest, 
				"Subsistema de abastecimento " + form.getDescricao() + " atualizado com sucesso.",
				"Realizar outra Manutenção de Subsistema de Abastecimento ",
				"exibirFiltrarSubsistemaAbastecimentoAction.do?menu=sim");
		
		return retorno;
	}
	
	private Set<SubsistemaSistemaAbastecimento> obterSubsistemaSistemaAbastecimento(AtualizarSubsistemaAbastecimentoActionForm form){

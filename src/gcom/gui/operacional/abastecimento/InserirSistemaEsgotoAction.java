...
public class InserirSistemaEsgotoAction extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping,
			...
			if ((inserirSistemaEsgotoActionForm.getDivisaoEsgoto() == null) || 
					(inserirSistemaEsgotoActionForm.getDivisaoEsgoto().equals("-1"))) {
				inserirSistemaEsgotoActionForm.setDivisaoEsgoto("");
			}

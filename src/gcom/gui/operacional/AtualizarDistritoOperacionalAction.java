...
public class AtualizarDistritoOperacionalAction extends GcomAction{
	...
	public ActionForward execute(ActionMapping actionMapping,
		...
		distritoOperacional.setId(Integer.parseInt(atualizarDistritoOperacionalActionForm.getCodigoDistritoOperacional()));
		...
		distritoOperacional.setUltimaAlteracao(atualizarDistritoOperacionalActionForm.getUltimaAlteracao());
		...
		//atualiza na base de dados de Municipio
		 fachada.atualizarDistritoOperacional(distritoOperacional,usuarioLogado,
				 atualizarDistritoOperacionalActionForm.getIdSetorAbastecimentoPrincipal(),
				 atualizarDistritoOperacionalActionForm.getSetoresSelecionados());
		
		//Monta a página de sucesso
		montarPaginaSucesso(httpServletRequest, "Distrito Operacional de código " + atualizarDistritoOperacionalActionForm.getCodigoDistritoOperacional() + " atualizado com sucesso.", "Realizar outra Manutenção de Distrito Operacional",

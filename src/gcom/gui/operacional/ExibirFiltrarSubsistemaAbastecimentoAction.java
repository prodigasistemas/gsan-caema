...
public class ExibirFiltrarSubsistemaAbastecimentoAction extends GcomAction {

	public ActionForward execute(ActionMapping actionMapping,
			ActionForm actionForm, HttpServletRequest httpServletRequest,
			HttpServletResponse httpServletResponse) {

		ActionForward retorno = actionMapping.findForward("filtrarSubsistemaAbastecimento");
		...
		if (sessao.getAttribute("colecaoSistemaAbastecimento") == null) {
			...
			filtrarSubsistemaAbastecimentoActionForm.setTipoPesquisa(ConstantesSistema.TIPO_PESQUISA_INICIAL.toString());
			filtrarSubsistemaAbastecimentoActionForm.setIndicadorUso("3");

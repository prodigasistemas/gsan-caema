...
public class AtualizarDistritoOperacionalActionForm extends ValidatorForm {
    ...
    private String idSetorAbastecimentoPrincipal;
    private Collection<SetorAbastecimento> setoresSelecionados;
    
    public AtualizarDistritoOperacionalActionForm(){
    	this.setoresSelecionados = new ArrayList<SetorAbastecimento>();
    }
	...
	public String getIdSetorAbastecimentoPrincipal() {
		return idSetorAbastecimentoPrincipal;
	}
	public void setIdSetorAbastecimentoPrincipal(
			String idSetorAbastecimentoPrincipal) {
		this.idSetorAbastecimentoPrincipal = idSetorAbastecimentoPrincipal;
	}
	public Collection<SetorAbastecimento> getSetoresSelecionados() {
		return setoresSelecionados;
	}
	public void setSetoresSelecionados(
			Collection<SetorAbastecimento> setoresSelecionados) {

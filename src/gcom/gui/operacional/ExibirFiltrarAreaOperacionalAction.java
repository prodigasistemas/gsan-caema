...
public class ExibirFiltrarAreaOperacionalAction extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping,
		...
		ActionForward retorno = actionMapping.findForward("filtrarAreaOperacional");	
		
		Fachada fachada = Fachada.getInstancia();			
		
		FiltrarAreaOperacionalActionForm form = (FiltrarAreaOperacionalActionForm) actionForm;
        ...
        if (httpServletRequest.getParameter("desfazer") != null && httpServletRequest.getParameter("desfazer").equalsIgnoreCase("S")) {
        	//-------------- bt DESFAZER ---------------
        	form.setDescricao("");
        	form.setIdSistemaAbastecimento("" + ConstantesSistema.NUMERO_NAO_INFORMADO);
        	form.setIdSubsistemaAbastecimento("" + ConstantesSistema.NUMERO_NAO_INFORMADO);
        	form.setIdDistritoOperacional("" + ConstantesSistema.NUMERO_NAO_INFORMADO);
		...
		String idSubsistemaAbastecimento = form.getIdSubsistemaAbastecimento();

...
public class AtualizarSetorAbastecimentoAction extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping,
		...
		setorAbastecimento.setId(Integer.parseInt(codigo));
		setorAbastecimento.setDescricao(descricao);
		setorAbastecimento.setDescricaoAbreviada(descricaoAbreviada);
		setorAbastecimento.setIndicadorUso(Short.valueOf(indicadorUso));
		...
		//Gravando no banco
		fachada.atualizar(setorAbastecimento);
		
		//Removendo os setores subsistemas associados
		fachada.removerSetorSubsistemaAbastecimento(setorAbastecimento.getId());
		...
		setor.setId(setorAbastecimento.getId());
		...
		montarPaginaSucesso(httpServletRequest,
				"Setor de abastecimento atualizado com sucesso.",
				"Atualizar outro setor de abastecimento",

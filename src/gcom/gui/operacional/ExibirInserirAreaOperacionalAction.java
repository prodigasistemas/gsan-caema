...
public class ExibirInserirAreaOperacionalAction extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping,
		...
		ActionForward retorno = actionMapping.findForward("inserirAreaOperacional");	
		...
		if (remover != null && !remover.equals("")){
			this.removerDistrito(remover, sessao);
		}

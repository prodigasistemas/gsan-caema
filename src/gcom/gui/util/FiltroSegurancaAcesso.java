		...
		if ( sessao != null && sessao.getAttribute("caminhoMenuFuncionalidade") != null && 
			...
			if(enderecoURL != null) { 
				if(enderecoURL.contains("exibirAtualizarResolucaoDiretoriaAction")){
					...
					caminhoMenuFuncionalidade = "Gsan -> Atendimento ao Publico -> Ordem de Servico -> Inspecao de Anormalidade -> Consultar Comandos de OS Seletiva de Inspeção de Anormalidade";

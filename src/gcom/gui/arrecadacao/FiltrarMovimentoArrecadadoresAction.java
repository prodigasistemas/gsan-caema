...
public class FiltrarMovimentoArrecadadoresAction extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping,
		...
		String tipoSaida = filtrarMovimentoArrecadadoresActionForm.getTipoSaida();
		String email = filtrarMovimentoArrecadadoresActionForm.getEmail();
        ...
        if(tipoSaida != null && tipoSaida.equals("1")){
	        if(email == null || email.equals("")){
	        	  throw new ActionServletException(
	        	            "atencao.campo_selecionado.obrigatorio","E-mail");
	        }
	        
	        if(!validarEmail(email)){
	        	 throw new ActionServletException("atencao.erro_invalido","E-mail");
	        }
        ...
        if(indicadorRelatorio != null && indicadorRelatorio.equals("" + ConstantesSistema.SIM)){
           ...
           sessao.setAttribute("tipoSaida", tipoSaida);
	...
	public boolean validarEmail(String hex) {	
		...
		Pattern pattern  = Pattern.compile(PADRAO_EMAIL);

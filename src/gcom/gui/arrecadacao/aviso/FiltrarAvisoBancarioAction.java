...
public class FiltrarAvisoBancarioAction extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping,
		...
		String idFormaArrecadacao = filtrarAvisoBancarioActionForm.getIdFormaArrecadacao();
        String observacoes = filtrarAvisoBancarioActionForm.getObservacoes();
		...
		if ((idFormaArrecadacao != null) && (!idFormaArrecadacao.equals("")) && (!idFormaArrecadacao.equals("-1"))){
			avisoBancarioHelper.setIdFormaArrecadacao(Integer.valueOf(idFormaArrecadacao));
			peloMenosUmParametroInformado = true;
		}
		
		if ((observacoes != null) && (!observacoes.equals(""))){
			avisoBancarioHelper.setObservacoes(observacoes);
			peloMenosUmParametroInformado = true;
		}

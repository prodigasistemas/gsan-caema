...
public class ConsultarDocumentoArrecadacaoNossoNumeroAction extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping,
		...
		if(!tipoDocumento.equals("01") && !tipoDocumento.equals("07")){
			...
			filtroCobrancaDocumento.adicionarParametro(new ParametroSimples(FiltroDocumentoCobranca.ID, idDocumento));
			...
			if(Util.isVazioOrNulo(colDocumentoCobranca)){
				...
				filtroCobrancaDocumentoHistorico.adicionarParametro(new ParametroSimples(FiltroCobrancaDocumentoHistorico.ID, idDocumento));
			...
			filtroConta.adicionarParametro(new ParametroSimples(FiltroConta.NUMERO_BOLETO, idDocumento));
			...
			if(Util.isVazioOrNulo(colConta)){
				...
				if(Util.isVazioOrNulo(colConta)){
					...
					filtroContaHistorico.adicionarParametro(new ParametroSimples(FiltroContaHistorico.NUMERO_BOLETO, idDocumento));
					...
					if(Util.isVazioOrNulo(colContaHistorico)){
						...
						filtroContaHistorico.adicionarParametro(new ParametroSimples(FiltroContaHistorico.ID, idDocumento));
			...
			filtroGuiaPagamento.adicionarParametro(new ParametroSimples(FiltroGuiaPagamento.ID, idDocumento));
			...
			if(Util.isVazioOrNulo(colGuiasPagamento)){
				...
				filtroGuiaPagamentoHistorico.adicionarParametro(new ParametroSimples(FiltroGuiaPagamentoHistorico.ID, idDocumento));

...
public class InformarAcertoDocumentosNaoAceitosActionForm  extends ActionForm {
	...
	private String[] documentosCobrancaSelecao;
	...
	public String[] getDocumentosCobrancaSelecao() {
		return documentosCobrancaSelecao;
	}

	public void setDocumentosCobrancaSelecao(String[] documentosCobrancaSelecao) {
		this.documentosCobrancaSelecao = documentosCobrancaSelecao;
	}

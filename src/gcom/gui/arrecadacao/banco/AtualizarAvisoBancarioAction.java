...
//        operacaoEfetuada.setOperacao(operacao);
		...
		if ((form.getObservacoes() != null) && 
				(!form.getObservacoes().equals("")) &&
				(form.getObservacoes().length() > 400)){
				throw new ActionServletException("atencao.campo_excede_numero_maximo_caracteres", null,
						"Observações");	
		} else if ((form.getObservacoes() != null) && 
				(!form.getObservacoes().equals(""))){
			avisoBancario.setObservacoes(form.getObservacoes());
		} else {
			avisoBancario.setObservacoes("");
		}

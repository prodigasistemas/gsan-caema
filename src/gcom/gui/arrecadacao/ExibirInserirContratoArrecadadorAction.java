...
public class ExibirInserirContratoArrecadadorAction extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping,
		...
		ArrayList<ArrecadadorContratoTarifa> colecaoArrecadadorContratoTarifaSelecionados ;
		...
		if (inserirContratoArrecadadorActionForm.getDtInicioVigencia() != null
				&& !inserirContratoArrecadadorActionForm.getDtInicioVigencia().equals("") ) {
			dtInicioVigencia = Util.converteStringParaDate(inserirContratoArrecadadorActionForm.getDtInicioVigencia());
        ...
        if (sessao.getAttribute("colecaoArrecadadorContratoTarifaSelecionados") != null){
        	...
        	colecaoArrecadadorContratoTarifaSelecionados = (ArrayList<ArrecadadorContratoTarifa>) sessao.getAttribute("colecaoArrecadadorContratoTarifaSelecionados");
        }else{
        	colecaoArrecadadorContratoTarifaSelecionados = new ArrayList<ArrecadadorContratoTarifa>();
        }
        
        //Mapa com as colecoes de ArrecadadorContratoTarifa por forma
        HashMap<Integer, ArrayList<ArrecadadorContratoTarifa>> mapaArrecadadorContratoTarifa = null;
       
        if (sessao.getAttribute("mapaArrecadadorContratoTarifaSelecionados") != null){
...
//	    		}
				...
				for(ArrecadadorContratoTarifa arrecadador : colecaoArrecadadorContratoTarifaSelecionados){
					if(arrecadadorContratoTarifa.getArrecadacaoForma().getId().equals(arrecadador.getArrecadacaoForma().getId()) 
...
//				Collections.sort(colecaoArrecadadorContratoTarifaSelecionados, new ACTarifaInicioComparator());
	    		...
	    		inserirContratoArrecadadorActionForm.setDtInicioVigencia("");
        }
        ...
        if ( httpServletRequest.getParameter("acao") != null && 
        	...
        	mapaArrecadadorContratoTarifa.clear();

...
public class ExibirInformarAcertoDocumentosNaoAceitosPagamentoAction extends GcomAction {
    ...
    public ActionForward execute(ActionMapping actionMapping,
		...
		if (idArrecadador != null
        	...
        	if(!Util.isInteger(idArrecadador)){
        		throw new ActionServletException("atencao.campo_texto.caracter_invalido", "Arrecadador");
        	}
        ...
        if (idAvisoBancario != null && !idAvisoBancario.trim().equals("")) {
        	...
        	if(!Util.isInteger(idAvisoBancario)){
        		throw new ActionServletException("atencao.campo_texto.caracter_invalido", "Aviso Bancário");
        	}

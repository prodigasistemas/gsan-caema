...
public class ExibirPesquisarGuiaPagamentoAction extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping,
		...
		//Recupera o código do imóvel, o do cliente e a situação do débito do request
		String idImovel = httpServletRequest.getParameter("idImovel");
		String idCliente = httpServletRequest.getParameter("idCliente");
		String situacaoDebito = httpServletRequest.getParameter("situacaoDebito");
		...
		if(situacaoDebito != null){
			if(situacaoDebito.equals("1")){
				filtroDebitoCreditoSituacao.adicionarParametro(new ParametroSimples(FiltroDebitoCreditoSituacao.ID, 
						DebitoCreditoSituacao.NORMAL, ParametroSimples.CONECTOR_OR));
				filtroDebitoCreditoSituacao.adicionarParametro(new ParametroSimples(FiltroDebitoCreditoSituacao.ID, 
						DebitoCreditoSituacao.RETIFICADA, ParametroSimples.CONECTOR_OR));
				filtroDebitoCreditoSituacao.adicionarParametro(new ParametroSimples(FiltroDebitoCreditoSituacao.ID, 
						DebitoCreditoSituacao.INCLUIDA));
			}else{
				filtroDebitoCreditoSituacao.adicionarParametro(new ParametroSimples(FiltroDebitoCreditoSituacao.ID, 
						DebitoCreditoSituacao.PARCELADA, ParametroSimples.CONECTOR_OR));
				filtroDebitoCreditoSituacao.adicionarParametro(new ParametroSimples(FiltroDebitoCreditoSituacao.ID, 

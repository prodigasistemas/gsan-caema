...
import gcom.gui.cobranca.ConsultarComandosAcaoCobrancaCronogramaActionForm;
...
public class ExibirConsultarComandosAcaoCobrancaAction  extends GcomAction{
    ...
    public ActionForward execute(ActionMapping actionMapping,
        ...
        if((httpServletRequest.getParameter("reabrir") != null 
        		&& httpServletRequest.getParameter("reabrir").equals("sim"))
        		|| (sessao.getAttribute("reabrir") !=null 
        		&& sessao.getAttribute("reabrir").equals("sim"))){
        	sessao.setAttribute("titulo", "Filtrar Comandos de Ação de Cobrança Encerradas - Tipo do Comando");
        	sessao.setAttribute("reabrir", "sim");
        }else{
        	sessao.setAttribute("titulo", "Filtrar Comandos de Ação de Cobrança - Tipo do Comando");
        }
        
        
        if(sessao.getAttribute("reabrir") != null 
        		&& sessao.getAttribute("reabrir").equals("sim")){
        	consultarComandosAcaoCobrancaCronogramaActionForm.setSituacaoComando("reabrir");
        }else{
        	consultarComandosAcaoCobrancaCronogramaActionForm.setSituacaoComando("");
        }

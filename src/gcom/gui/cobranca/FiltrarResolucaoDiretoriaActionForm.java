...
public class FiltrarResolucaoDiretoriaActionForm  extends ActionForm {
	...
	public void limpar(){
		...
		this.dataInicio = "";
		this.dataFim = "";
		this.indicadorParcelamentoUnico = ConstantesSistema.TODOS.toString();
		this.indicadorUtilizacaoLivre = ConstantesSistema.TODOS.toString();
		this.indicadorDescontoSancoes = ConstantesSistema.TODOS.toString();
		this.indicadorParcelasEmAtraso = ConstantesSistema.TODOS.toString();
		this.idParcelasEmAtraso = "";
		this.indicadorParcelamentoEmAndamento = ConstantesSistema.TODOS.toString();
		this.idParcelamentoEmAndamento = "";
		this.indicadorNegociacaoSoAVista = ConstantesSistema.TODOS.toString();
		this.indicadorDescontoSoEmContaAVista = ConstantesSistema.TODOS.toString();
		this.indicadorParcelamentoLojaVirtual = ConstantesSistema.TODOS.toString();
	}

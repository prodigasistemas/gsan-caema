...
/*        //limpar formulario
        ...
        Date dataPrevistaEncerramento = fachada.pesquisarDataPrevistaEncerramentoComandoCronograma(Integer.parseInt(idCobrancaAcaoAtividadeCronograma));
        if(dataPrevistaEncerramento != null){
        	exibirResultadoConsultarComandosAcaoCobrancaCronogramaDadosComandoActionForm.setDataPrevistaEncerramento(
        		Util.formatarData(dataPrevistaEncerramento));
        }else{
        	exibirResultadoConsultarComandosAcaoCobrancaCronogramaDadosComandoActionForm.setDataPrevistaEncerramento("");
        }

...
public class ExibirFiltrarResolucaoDiretoriaAction extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping,
		...
		if(httpServletRequest.getParameter("limpar") != null){
			filtrarResolucaoDiretoriaActionForm.limpar();
		}
		...
		if (httpServletRequest.getParameter("paginacao") != null) {
			...
			filtrarResolucaoDiretoriaActionForm.setIndicadorNegociacaoSoAVista((String) sessao.getAttribute("indicadorNegociacaoSoAVista"));
			filtrarResolucaoDiretoriaActionForm.setIndicadorDescontoSoEmContaAVista((String) sessao.getAttribute("indicadorDescontoSoEmContaAVista"));
			filtrarResolucaoDiretoriaActionForm.setIndicadorParcelamentoLojaVirtual((String) sessao.getAttribute("indicadorParcelamentoLojaVirtual"));

...
public class ManterComandoAcaoCobrancaEventualConcluirAction extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping,
		...
		if(manterComandoAcaoCobrancaDetalhesActionForm.getImoveisSitLigacaoNaoAlteradaDeb() == null ||
				manterComandoAcaoCobrancaDetalhesActionForm.getImoveisSitLigacaoNaoAlteradaDeb().equals("")){
			manterComandoAcaoCobrancaDetalhesActionForm.setImoveisSitLigacaoNaoAlteradaDeb("1");
		}
		...
		fachada.concluirManterComandoAcaoCobranca(
				...
				manterComandoAcaoCobrancaDetalhesActionForm.getImoveisSitLigacaoNaoAlteradaDeb(),
				nomeArquivo,
				colecaoIdsImovel, 
				manterComandoAcaoCobrancaDetalhesActionForm.getIdRegistrosLocalidade(),
				manterComandoAcaoCobrancaDetalhesActionForm.getIdRegistrosSetorComercial(),
				manterComandoAcaoCobrancaDetalhesActionForm.getIdLocalidade());

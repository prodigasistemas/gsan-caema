...
public class ExibirResultadoConsultarComandosAcaoCobrancaEventualDadosComandoAction  extends GcomAction{
    ...
    public ActionForward execute(ActionMapping actionMapping,
        ...
        if(cobrancaAcaoAtividadeComando.getLigacaoAlteradaDebito()!=null 
        		&&  cobrancaAcaoAtividadeComando.getLigacaoAlteradaDebito().toString().equals("1")){
        	exibirResultadoConsultarComandosAcaoCobrancaEventualDadosComandoActionForm
    			.setCodigoSelecaoImovelSituacaoLigacaoAlteradaDebito("INCLUSIVE");
        }else if(cobrancaAcaoAtividadeComando.getLigacaoAlteradaDebito()!=null 
        		&&  cobrancaAcaoAtividadeComando.getLigacaoAlteradaDebito().toString().equals("2")){
        	exibirResultadoConsultarComandosAcaoCobrancaEventualDadosComandoActionForm
    			.setCodigoSelecaoImovelSituacaoLigacaoAlteradaDebito("APENAS");
        }else{
        	exibirResultadoConsultarComandosAcaoCobrancaEventualDadosComandoActionForm
        	.setCodigoSelecaoImovelSituacaoLigacaoAlteradaDebito("NÃO INCLUIR");
        }
        ...
        Integer idComando = Integer.parseInt(idCobrancaAcaoAtividadeComando);
        Collection colecaoLocalidades = Fachada.getInstancia().pesquisarListaDeLocalidadesParaComandosAcaoCobrancaEventual(idComando);
        httpServletRequest.setAttribute("colecaoLocalidades", colecaoLocalidades);
        
        Collection colecaoLocalidades2 = Fachada.getInstancia().pesquisarLocalidadeParaComandoAcaoCobrancaEventual(idComando);
        Localidade objtoColecao = new Localidade();
        
        if(!Util.isVazioOrNulo(colecaoLocalidades2)){
        objtoColecao =  (Localidade) Util.retonarObjetoDeColecao(colecaoLocalidades2);
        }
        
        httpServletRequest.setAttribute("localidade", objtoColecao);
        
        Collection colecaoSetrocomercia = Fachada.getInstancia().pesquisarListaDeSetoresComercialParaComandoCobrancaEventual(idComando);
        httpServletRequest.setAttribute("colecaoSetrocomercia", colecaoSetrocomercia);

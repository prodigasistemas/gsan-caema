...
public class ParcelamentoPerfilActionForm extends ActionForm {
    ...
    private String indicadorPercentualDescontoPagAVistaValorDebito;
    
    private String indicadorPercentualDescontoPagParceladoEntrada;
    ...
    private String valorFixoParcelaMinima;  
    private String qtdFaturasAnterioresPagVista;    
    private String qtdFaturasAnterioresPagParcelado;  
    private String indicadorDescontoVistaDebParcelado;
	...
	public String getIndicadorPercentualDescontoPagAVistaValorDebito() {
		return indicadorPercentualDescontoPagAVistaValorDebito;
	}

	public void setIndicadorPercentualDescontoPagAVistaValorDebito(
			String indicadorPercentualDescontoPagAVistaValorDebito) {
		this.indicadorPercentualDescontoPagAVistaValorDebito = indicadorPercentualDescontoPagAVistaValorDebito;
	}

	public String getIndicadorPercentualDescontoPagParceladoEntrada() {
		return indicadorPercentualDescontoPagParceladoEntrada;
	}

	public void setIndicadorPercentualDescontoPagParceladoEntrada(
			String indicadorPercentualDescontoPagParceladoEntrada) {
		this.indicadorPercentualDescontoPagParceladoEntrada = indicadorPercentualDescontoPagParceladoEntrada;
	}
	...
	public String getValorFixoParcelaMinima() {
		return valorFixoParcelaMinima;
	}

	public void setValorFixoParcelaMinima(String valorFixoParcelaMinima) {
		this.valorFixoParcelaMinima = valorFixoParcelaMinima;
	}

	public String getQtdFaturasAnterioresPagVista() {
		return qtdFaturasAnterioresPagVista;
	}

	public void setQtdFaturasAnterioresPagVista(String qtdFaturasAnterioresPagVista) {
		this.qtdFaturasAnterioresPagVista = qtdFaturasAnterioresPagVista;
	}

	public String getQtdFaturasAnterioresPagParcelado() {
		return qtdFaturasAnterioresPagParcelado;
	}

	public void setQtdFaturasAnterioresPagParcelado(String qtdFaturasAnterioresPagParcelado) {
		this.qtdFaturasAnterioresPagParcelado = qtdFaturasAnterioresPagParcelado;
	}

	public String getIndicadorDescontoVistaDebParcelado() {
		return indicadorDescontoVistaDebParcelado;
	}

	public void setIndicadorDescontoVistaDebParcelado(String indicadorDescontoVistaDebParcelado) {
		this.indicadorDescontoVistaDebParcelado = indicadorDescontoVistaDebParcelado;
	}

 ...
 * Adicionar Percentual de Desconto por Percentual de Entradav
 * 
 * @author Anderson Cabral
 * @created 31/07/2013
 */
public class ExibirAdicionarPercentualDescontoPopupAction  extends GcomAction {
    ...
    public ActionForward execute(ActionMapping actionMapping,
        ...
        ActionForward retorno = actionMapping.findForward("adicionarPercentualDescontoPopup");        

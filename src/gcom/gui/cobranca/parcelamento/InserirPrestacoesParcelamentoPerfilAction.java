...
public class InserirPrestacoesParcelamentoPerfilAction extends GcomAction {
    ...
    public ActionForward execute(ActionMapping actionMapping,
	    ...
	    if (sessao.getAttribute("collectionParcelamentoQuantidadePrestacaoHelper") != null
			...
			ArrayList<ParcelaEntradaDesconto> collectionParcelaEntradaDesconto = null;
			if (sessao.getAttribute("collectionParcelaEntradaDesconto")!= null){
				collectionParcelaEntradaDesconto = (ArrayList<ParcelaEntradaDesconto>) sessao.getAttribute("collectionParcelaEntradaDesconto");
			...
			while (iterator.hasNext()) {
				...
				if (parcelamentoQuantidadeReparcelamentoHelper.getQuantidadeMaximaReparcelamento().toString()
					...
					parcelamentoQuantidadeReparcelamentoHelper.setCollectionParcelaEntradaDesconto(collectionParcelaEntradaDesconto);

...
public class InserirPrestacoesParcelamentoPerfilActionForm extends ActionForm {
	...
	private String indicadorVerificarMaiorValor;
	...
	public void setValorMinimoParcela(String valorMinimoParcela) {
	...
	public String getIndicadorVerificarMaiorValor() {
		return indicadorVerificarMaiorValor;
	}

	public void setIndicadorVerificarMaiorValor(String indicadorVerificarMaiorValor) {
		this.indicadorVerificarMaiorValor = indicadorVerificarMaiorValor;
	}

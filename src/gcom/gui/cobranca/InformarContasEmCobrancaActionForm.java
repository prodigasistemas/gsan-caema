...
public class InformarContasEmCobrancaActionForm  extends ActionForm {
	...
	private String qtdImoveisMaximaComando;
	
	private String[] percentualImoveisFaixa;
	
	private String[] idsAcoesCobrancaNaoGeracao;
	...
	public String getQtdImoveisMaximaComando() {
		return qtdImoveisMaximaComando;
	}

	public void setQtdImoveisMaximaComando(String qtdImoveisMaximaComando) {
		this.qtdImoveisMaximaComando = qtdImoveisMaximaComando;
	}

	public String[] getPercentualImoveisFaixa() {
		return percentualImoveisFaixa;
	}

	public void setPercentualImoveisFaixa(String[] percentualImoveisFaixa) {
		this.percentualImoveisFaixa = percentualImoveisFaixa;
	}

	public String[] getIdsAcoesCobrancaNaoGeracao() {
		return idsAcoesCobrancaNaoGeracao;
	}

	public void setIdsAcoesCobrancaNaoGeracao(String[] idsAcoesCobrancaNaoGeracao) {
		this.idsAcoesCobrancaNaoGeracao = idsAcoesCobrancaNaoGeracao;
	}

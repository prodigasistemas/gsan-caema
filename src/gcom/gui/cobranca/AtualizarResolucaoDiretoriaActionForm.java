...
public class AtualizarResolucaoDiretoriaActionForm  extends ActionForm {
	...
	private String indicadorValidoAcaoCobranca;
	
	private String indicadorAcessoRestrito;
	...
	public String getIndicadorValidoAcaoCobranca() {
		return indicadorValidoAcaoCobranca;
	}

	public void setIndicadorValidoAcaoCobranca(String indicadorValidoAcaoCobranca) {
		this.indicadorValidoAcaoCobranca = indicadorValidoAcaoCobranca;
	}

	public String getIndicadorAcessoRestrito() {
		return indicadorAcessoRestrito;
	}

	public void setIndicadorAcessoRestrito(String indicadorAcessoRestrito) {
		this.indicadorAcessoRestrito = indicadorAcessoRestrito;
	}

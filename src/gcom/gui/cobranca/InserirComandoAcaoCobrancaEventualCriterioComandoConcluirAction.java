...
public class InserirComandoAcaoCobrancaEventualCriterioComandoConcluirAction extends
	...
	public ActionForward execute(ActionMapping actionMapping,
        ...
        Collection colecaoCobrancaAcaoAtividadeComando = fachada.concluirComandoAcaoCobranca(
				...
				inserirComandoAcaoCobrancaEventualCriterioComandoActionForm.getImoveisSitLigacaoNaoAlteradaDeb(),
				nomeArquivo,
				colecaoIdsImovel, 
				inserirComandoAcaoCobrancaEventualCriterioComandoActionForm.getIdRegistrosLocalidade(), 
				inserirComandoAcaoCobrancaEventualCriterioComandoActionForm.getIdRegistrosSetorComercial(), 
				inserirComandoAcaoCobrancaEventualCriterioComandoActionForm.getIdLocalidade()
				);	

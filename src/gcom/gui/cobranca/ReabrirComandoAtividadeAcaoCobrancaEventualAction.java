...
public class ReabrirComandoAtividadeAcaoCobrancaEventualAction extends
		GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping,
        ...
        //---------------------------------------------------------------------------
  		...
  		//5.2. [IT 0004 - Reabrir Comandos Eventual]
		this.getFachada().reabrirComandoAtividadeAcaoCobrancaEventual(idsSelecionados,Util.converteStringParaDate(novaDataEncerramento));
		
  		
        
		montarPaginaSucesso(httpServletRequest, "Reabrir Comando Enviado para Processamento.", "", "","exibirFiltrarComandosAcaoCobrancaEventualReabrirAction.do?ultimoacesso=-1&situacaoComando=reabrir&tipoComando=Eventual","Reabrir Outros Comandos de Atividade de Ação de Cobrança");

 ...
 * @date 16/03/2013
 */
public class CancelarParcelamentoJudicialActionForm extends ValidatorActionForm {
	...
	private Collection<ParcelamentoMotivoDesfazer> listaMotivoCancelamento;
	...
	public Collection<ParcelamentoMotivoDesfazer> getListaMotivoCancelamento() {
	...
	public void setListaMotivoCancelamento(
			Collection<ParcelamentoMotivoDesfazer> listaMotivoCancelamento) {

...
public class ExibirFiltrarComandosAcaoCobrancaEventualAction extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping,
		...
		String ligacaoAlteradaDebito = filtrarComandosAcaoCobrancaEventualActionForm
				.getLigacaoAlteradaDebito(); 
  	
		if(ligacaoAlteradaDebito == null){
			filtrarComandosAcaoCobrancaEventualActionForm
			.setLigacaoAlteradaDebito("Todos");
		}
		...
		if(carregando != null && !carregando.equals("")){
			...
			if (sessao.getAttribute("filtrarComandosAcaoCobrancaEventualActionForm") != null) {
		        ...
		        filtrarComandosAcaoCobrancaEventualActionForm.setLigacaoAlteradaDebito(filtrarComandosAcaoCobrancaEventualActionFormRecarregar.getLigacaoAlteradaDebito());
		        
		        if ( filtrarComandosAcaoCobrancaEventualActionForm.getLocalidadeUnica() != null && !filtrarComandosAcaoCobrancaEventualActionForm.getLocalidadeUnica().equals("") ) {
		        	pesquisarLocalidade(fachada, filtrarComandosAcaoCobrancaEventualActionForm, httpServletRequest);
		        }
		        pesquisarGerencia(filtrarComandosAcaoCobrancaEventualActionForm, httpServletRequest, fachada);
			}
		...
		if (objetoConsulta != null && objetoConsulta.equals("4")){
			
			pesquisarGerencia(filtrarComandosAcaoCobrancaEventualActionForm, httpServletRequest, fachada);
		}else if (objetoConsulta != null && objetoConsulta.equals("5")){
	...
	private void pesquisarLocalidade(Fachada fachada, FiltrarComandosAcaoCobrancaEventualActionForm filtrarComandosAcaoCobrancaEventualActionForm, HttpServletRequest httpServletRequest){
		Localidade objetoLocalidade = fachada.obterLocalidadeGerenciaRegional(filtrarComandosAcaoCobrancaEventualActionForm.getLocalidadeUnica());
		
		if(objetoLocalidade != null){
			filtrarComandosAcaoCobrancaEventualActionForm.setDescricaoLocalidadeUnica(objetoLocalidade.getDescricao());
			...
			filtroSetorComercial.adicionarParametro(
				new ParametroSimples(FiltroSetorComercial.LOCALIDADE,objetoLocalidade.getId()));
			...
			filtrarComandosAcaoCobrancaEventualActionForm.setLocalidadeUnica("");
			filtrarComandosAcaoCobrancaEventualActionForm.setDescricaoLocalidadeUnica("LOCALIDADE INEXISTENTE");
			
			httpServletRequest.setAttribute("localidadeInexistente", "true");
		}
	}
	
	private void pesquisarGerencia(FiltrarComandosAcaoCobrancaEventualActionForm filtrarComandosAcaoCobrancaEventualActionForm, HttpServletRequest httpServletRequest, Fachada fachada){
		if(filtrarComandosAcaoCobrancaEventualActionForm.getGerenciaRegional() != null && !filtrarComandosAcaoCobrancaEventualActionForm.getGerenciaRegional().equals("")){
			...
			filtroLocalidade.adicionarParametro(
				new ParametroSimples(FiltroLocalidade.GERENCIA,filtrarComandosAcaoCobrancaEventualActionForm.getGerenciaRegional()));

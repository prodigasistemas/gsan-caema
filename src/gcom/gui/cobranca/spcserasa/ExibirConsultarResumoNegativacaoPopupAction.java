		...
		while(itcolecaoResumoNegativacao.hasNext()){
			...
			if(retumoTotais.getIdSituacaoCobranca() != null && retumoTotais.getIdSituacaoCobranca().equals(1)){ // POTENCIAL
				...
				if (idSituacaoDebito.equals(ConstantesSistema.PENDENTE)){
					...
					valorPotencial = valorPotencial.add(retumoTotais.getSomatorioValorDebito());
				...
				if (idSituacaoDebito.equals(ConstantesSistema.PENDENTE)){
					quantidadePendente += retumoTotais.getSomatorioQuantidadeInclusoes();
					valorFactivel = valorFactivel.add(retumoTotais.getSomatorioValorDebito());
				}
				else if (idSituacaoDebito.equals(ConstantesSistema.PAGO)){
					quantidadePago += retumoTotais.getSomatorioQuantidadeInclusoes();
					valorFactivel = valorFactivel.add(retumoTotais.getSomatorioValorDebito());
				...
				if (idSituacaoDebito.equals(ConstantesSistema.PENDENTE)){
					quantidadePendente += retumoTotais.getSomatorioQuantidadeInclusoes();
					valorLigado = valorLigado.add(retumoTotais.getSomatorioValorDebito());
				}
				else if (idSituacaoDebito.equals(ConstantesSistema.PAGO)){
					quantidadePago += retumoTotais.getSomatorioQuantidadeInclusoes();
					valorLigado = valorLigado.add(retumoTotais.getSomatorioValorDebito());
				...
				if (idSituacaoDebito.equals(ConstantesSistema.PENDENTE)){
					quantidadePendente += retumoTotais.getSomatorioQuantidadeInclusoes();
					valorEmAnalise = valorEmAnalise.add(retumoTotais.getSomatorioValorDebito());
				}
				else if (idSituacaoDebito.equals(ConstantesSistema.PAGO)){
					quantidadePago += retumoTotais.getSomatorioQuantidadeInclusoes();
					valorEmAnalise = valorEmAnalise.add(retumoTotais.getSomatorioValorDebito());
				...
				if (idSituacaoDebito.equals(ConstantesSistema.PENDENTE)){
					quantidadePendente += retumoTotais.getSomatorioQuantidadeInclusoes();
					valorCortado = valorCortado.add(retumoTotais.getSomatorioValorDebito());
				}
				else if (idSituacaoDebito.equals(ConstantesSistema.PAGO)){
					quantidadePago += retumoTotais.getSomatorioQuantidadeInclusoes();
					valorCortado = valorCortado.add(retumoTotais.getSomatorioValorDebito());
				...
				if (idSituacaoDebito.equals(ConstantesSistema.PENDENTE)){
					quantidadePendente += retumoTotais.getSomatorioQuantidadeInclusoes();
					valorSuprimido = valorSuprimido.add(retumoTotais.getSomatorioValorDebito());
				}
				else if (idSituacaoDebito.equals(ConstantesSistema.PAGO)){
					quantidadePago += retumoTotais.getSomatorioQuantidadeInclusoes();
					valorSuprimido = valorSuprimido.add(retumoTotais.getSomatorioValorDebito());
				...
				if (idSituacaoDebito.equals(ConstantesSistema.PENDENTE)){
					quantidadePendente += retumoTotais.getSomatorioQuantidadeInclusoes();
					valorSuprimidoParc = valorSuprimidoParc.add(retumoTotais.getSomatorioValorDebito());
				}
				else if (idSituacaoDebito.equals(ConstantesSistema.PAGO)){
					quantidadePago += retumoTotais.getSomatorioQuantidadeInclusoes();
					valorSuprimidoParc = valorSuprimidoParc.add(retumoTotais.getSomatorioValorDebito());
				...
				if (idSituacaoDebito.equals(ConstantesSistema.PENDENTE)){
					quantidadePendente += retumoTotais.getSomatorioQuantidadeInclusoes();
					valorSuprimidoParcPedido = valorSuprimidoParcPedido.add(retumoTotais.getSomatorioValorDebito());
				}
				else if (idSituacaoDebito.equals(ConstantesSistema.PAGO)){
					quantidadePago += retumoTotais.getSomatorioQuantidadeInclusoes();
					valorSuprimidoParcPedido = valorSuprimidoParcPedido.add(retumoTotais.getSomatorioValorDebito());

...
public class FiltrarResolucaoDiretoriaAction extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping,
		...
		if ( !filtrarResolucaoDiretoriaActionForm.getIndicadorParcelasEmAtraso().equals( ConstantesSistema.TODOS.toString() ) ){
			...
			if (filtrarResolucaoDiretoriaActionForm.getIndicadorParcelasEmAtraso().equals( ConstantesSistema.SIM.toString() ) ){
				if(filtrarResolucaoDiretoriaActionForm.getIdParcelasEmAtraso() != null && !filtrarResolucaoDiretoriaActionForm.getIdParcelasEmAtraso().equals(""))
		...
		if ( !filtrarResolucaoDiretoriaActionForm.getIndicadorParcelamentoEmAndamento().equals( ConstantesSistema.TODOS.toString() ) ){
			...
			if (filtrarResolucaoDiretoriaActionForm.getIndicadorParcelamentoEmAndamento().equals( ConstantesSistema.SIM.toString() ) ){
				if(filtrarResolucaoDiretoriaActionForm.getIdParcelamentoEmAndamento() != null && !filtrarResolucaoDiretoriaActionForm.getIdParcelamentoEmAndamento().equals(""))

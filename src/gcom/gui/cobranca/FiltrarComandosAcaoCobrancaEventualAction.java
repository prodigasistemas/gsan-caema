...
public class FiltrarComandosAcaoCobrancaEventualAction  extends GcomAction{
    ...
    public ActionForward execute(ActionMapping actionMapping,
        ...
        if(sessao.getAttribute("filtroCobrancaAcaoAtividadeComando") == null){
			...
			String[] idsLocalidade = (String[]) httpServletRequest.getParameterValues("idLocalidadeGerenciaRegional");
			String[] idsSetores = (String[]) httpServletRequest.getParameterValues("idSetorComercialLocalidadeUnica");
			
			
			
			FiltrarComandosAcaoCobrancaEventualHelper filtrarComandosAcaoCobrancaEventualHelper = 
	        	fachada.construirFiltroComandosAcaoCobrancaEventualHelper(
	                    ...
	                    filtrarComandosAcaoCobrancaEventualActionForm.getLigacaoAlteradaDebito(),
	                    idsLocalidade,
	                    filtrarComandosAcaoCobrancaEventualActionForm.getLocalidadeUnica(),
	                    idsSetores);
	       
	        sessao.setAttribute("filtrarComandosAcaoCobrancaEventualHelper",
	        	filtrarComandosAcaoCobrancaEventualHelper);

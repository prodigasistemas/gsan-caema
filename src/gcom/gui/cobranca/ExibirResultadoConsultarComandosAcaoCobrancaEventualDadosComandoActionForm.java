...
public class ExibirResultadoConsultarComandosAcaoCobrancaEventualDadosComandoActionForm  extends ActionForm {
	...
	private String codigoSelecaoImovelSituacaoLigacaoAlteradaDebito;
	...
	public String getCodigoSelecaoImovelSituacaoLigacaoAlteradaDebito() {
		return codigoSelecaoImovelSituacaoLigacaoAlteradaDebito;
	}

	public void setCodigoSelecaoImovelSituacaoLigacaoAlteradaDebito(String codigoSelecaoImovelSituacaoLigacaoAlteradaDebito) {
		this.codigoSelecaoImovelSituacaoLigacaoAlteradaDebito = codigoSelecaoImovelSituacaoLigacaoAlteradaDebito;
	}

...
//		}
		...
		BigDecimal valorAcrescimosServicosCurtoPrazo = BigDecimal.ZERO;
		if(efetuarParcelamentoDebitosActionForm.get("valorAcrescimosServicosCurtoPrazo") != null
				&& !efetuarParcelamentoDebitosActionForm.get("valorAcrescimosServicosCurtoPrazo").equals("")){
			valorAcrescimosServicosCurtoPrazo = Util.formatarMoedaRealparaBigDecimal(
					(String)(efetuarParcelamentoDebitosActionForm.get("valorAcrescimosServicosCurtoPrazo")));
		}
		
		BigDecimal valorAcrescimosServicosLongoPrazo = BigDecimal.ZERO;
		if(efetuarParcelamentoDebitosActionForm.get("valorAcrescimosServicosLongoPrazo") != null
				&& !efetuarParcelamentoDebitosActionForm.get("valorAcrescimosServicosLongoPrazo").equals("")){
			valorAcrescimosServicosLongoPrazo = Util.formatarMoedaRealparaBigDecimal(
					(String)(efetuarParcelamentoDebitosActionForm.get("valorAcrescimosServicosLongoPrazo")));
		}
		
		BigDecimal valorAcrescimosParcelamentosCurtoPrazo = BigDecimal.ZERO;
		if(efetuarParcelamentoDebitosActionForm.get("valorAcrescimosParcelamentosCurtoPrazo") != null
				&& !efetuarParcelamentoDebitosActionForm.get("valorAcrescimosParcelamentosCurtoPrazo").equals("")){
			valorAcrescimosParcelamentosCurtoPrazo = Util.formatarMoedaRealparaBigDecimal(
					(String)(efetuarParcelamentoDebitosActionForm.get("valorAcrescimosParcelamentosCurtoPrazo")));
		}
		
		BigDecimal valorAcrescimosParcelamentosLongoPrazo = BigDecimal.ZERO;
		if(efetuarParcelamentoDebitosActionForm.get("valorAcrescimosParcelamentosLongoPrazo") != null
				&& !efetuarParcelamentoDebitosActionForm.get("valorAcrescimosParcelamentosLongoPrazo").equals("")){
			valorAcrescimosParcelamentosLongoPrazo = Util.formatarMoedaRealparaBigDecimal(
					(String)(efetuarParcelamentoDebitosActionForm.get("valorAcrescimosParcelamentosLongoPrazo")));
		}
...
//		}	
		...
		new	ConcluirParcelamentoDebitosHelper(colecaoContaValores, 
				...
				descontoTarifaSocialRDEspecial, colecaoContasEmAntiguidade,descontoSobreDebitoTotal);
		//=============================================================================================================

...
public class ConsultarComandosContasCobrancaEmpresaActionForm  extends ActionForm {
	...
	public String getQtdMaxImoveis() {
		return qtdMaxImoveis;
	}


	public void setQtdMaxImoveis(String qtdMaxImoveis) {
		this.qtdMaxImoveis = qtdMaxImoveis;
	}

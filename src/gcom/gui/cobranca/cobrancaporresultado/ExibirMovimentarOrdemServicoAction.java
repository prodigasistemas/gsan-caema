...
public class ExibirMovimentarOrdemServicoAction extends GcomAction {
    ...
    public ActionForward execute(ActionMapping actionMapping,
        ...
        //monta a quarta aba do processo
        statusWizard
                .inserirNumeroPaginaCaminho(statusWizard.new StatusWizardItem(
                        4, "abaConsultarOsB.gif", "abaConsultarOsA.gif",
                        "exibirMovimentarOrdemServicoConsultarOSAction",
                        "movimentarOrdemServicoConsultarOSAction"));

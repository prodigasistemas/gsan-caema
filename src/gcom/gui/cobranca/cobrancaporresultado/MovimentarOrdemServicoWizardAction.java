...
public class MovimentarOrdemServicoWizardAction extends WizardAction {
    ...
    public ActionForward exibirMovimentarOrdemServicoConsultarOSAction(
            ActionMapping actionMapping, 
            ActionForm actionForm,
            HttpServletRequest httpServletRequest,
            HttpServletResponse httpServletResponse) {

    	return new ExibirMovimentarOrdemServicoConsultarOSAction().execute(actionMapping,
                												  actionForm, 
                												  httpServletRequest, 
                												  httpServletResponse);
    }
    ...
    public ActionForward movimentarOrdemServicoConsultarOSAction(
            ActionMapping actionMapping,
            ActionForm actionForm,
            HttpServletRequest httpServletRequest,
            HttpServletResponse httpServletResponse) {
    	
        new MovimentarOrdemServicoConsultarOSAction().execute(actionMapping, actionForm,
                httpServletRequest, httpServletResponse);

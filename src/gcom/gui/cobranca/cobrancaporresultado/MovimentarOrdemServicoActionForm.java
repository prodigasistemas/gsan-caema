...
public class MovimentarOrdemServicoActionForm extends ActionForm {
	...
	private String dataGeracaoInicialOS;
	
	private String dataGeracaoFinalOS;
	
	private String dataEncerramentoInicialOS;
	
	private String dataEncerramentoFinalOS;
	
	private String tipoRelatorio;
	
	private String[] idsLocalidade;
	...
	public String[] getIdsLocalidade() {
		return idsLocalidade;
	}

	public void setIdsLocalidade(String[] idsLocalidade) {
		this.idsLocalidade = idsLocalidade;
	}

	public String getDataGeracaoInicialOS() {
		return dataGeracaoInicialOS;
	}

	public void setDataGeracaoInicialOS(String dataGeracaoInicialOS) {
		this.dataGeracaoInicialOS = dataGeracaoInicialOS;
	}

	public String getDataGeracaoFinalOS() {
		return dataGeracaoFinalOS;
	}

	public void setDataGeracaoFinalOS(String dataGeracaoFinalOS) {
		this.dataGeracaoFinalOS = dataGeracaoFinalOS;
	}

	public String getDataEncerramentoInicialOS() {
		return dataEncerramentoInicialOS;
	}

	public void setDataEncerramentoInicialOS(String dataEncerramentoInicialOS) {
		this.dataEncerramentoInicialOS = dataEncerramentoInicialOS;
	}

	public String getDataEncerramentoFinalOS() {
		return dataEncerramentoFinalOS;
	}

	public void setDataEncerramentoFinalOS(String dataEncerramentoFinalOS) {
		this.dataEncerramentoFinalOS = dataEncerramentoFinalOS;
	}

...
public class RemoverMotivoNaoGeracaoCobrancaResultadoAction extends GcomAction {
    ...
    public ActionForward execute(ActionMapping actionMapping,
        ...
        operacao.setId(Operacao.OPERACAO_REMOVER_MOTIVO_NAO_GERACAO_COB_RESULTADO);

        OperacaoEfetuada operacaoEfetuada = new OperacaoEfetuada();
        operacaoEfetuada.setOperacao(operacao);
        //------------ REGISTRAR TRANSAÇÃO ----------------

        String[] selecaoMotivos = form
                .getIdRegistrosRemocao();

        if (selecaoMotivos == null || selecaoMotivos.length < 1) {
            ...
            fachada.remover(selecaoMotivos, MotivoNaoGeracaoCobrancaResultado.class.getName(),operacaoEfetuada, colecaoUsuarios);
        }

        montarPaginaSucesso(httpServletRequest,
        		selecaoMotivos.length +
				" Motivo(s) de Não Geração de Cobrança por Resultado removido(s) com sucesso.",
				"Realizar outra Manutenção de Motivo de Não Geração de Cobrança por Resultado",

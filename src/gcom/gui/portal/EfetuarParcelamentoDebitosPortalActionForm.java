...
public class EfetuarParcelamentoDebitosPortalActionForm extends ValidatorActionForm {
	...
	private String valorAcrescimosServicosCurtoPrazo;
	private String valorAcrescimosServicosLongoPrazo;
	private String valorAcrescimosParcelamentosCurtoPrazo;
	private String valorAcrescimosParcelamentosLongoPrazo;
	...
	private String valorTotalDoacoes;
	...
	public String getValorAcrescimosServicosCurtoPrazo() {
		return valorAcrescimosServicosCurtoPrazo;
	}

	public void setValorAcrescimosServicosCurtoPrazo(
			String valorAcrescimosServicosCurtoPrazo) {
		this.valorAcrescimosServicosCurtoPrazo = valorAcrescimosServicosCurtoPrazo;
	}

	public String getValorAcrescimosServicosLongoPrazo() {
		return valorAcrescimosServicosLongoPrazo;
	}

	public void setValorAcrescimosServicosLongoPrazo(
			String valorAcrescimosServicosLongoPrazo) {
		this.valorAcrescimosServicosLongoPrazo = valorAcrescimosServicosLongoPrazo;
	}

	public String getValorAcrescimosParcelamentosCurtoPrazo() {
		return valorAcrescimosParcelamentosCurtoPrazo;
	}

	public void setValorAcrescimosParcelamentosCurtoPrazo(
			String valorAcrescimosParcelamentosCurtoPrazo) {
		this.valorAcrescimosParcelamentosCurtoPrazo = valorAcrescimosParcelamentosCurtoPrazo;
	}

	public String getValorAcrescimosParcelamentosLongoPrazo() {
		return valorAcrescimosParcelamentosLongoPrazo;
	}

	public void setValorAcrescimosParcelamentosLongoPrazo(
			String valorAcrescimosParcelamentosLongoPrazo) {
		this.valorAcrescimosParcelamentosLongoPrazo = valorAcrescimosParcelamentosLongoPrazo;
	}
	...
	public String getValorTotalDoacoes() {
		return valorTotalDoacoes;
	}

	public void setValorTotalDoacoes(String valorTotalDoacoes) {
		this.valorTotalDoacoes = valorTotalDoacoes;
	}

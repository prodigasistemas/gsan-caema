...
//			Fachada.getInstancia().verificarExistenciaAcessoLojaVirtual(ip, AcessoLojaVirtual.TARIFA_SOCIAL); 
//
//		} else 
			if (method.equalsIgnoreCase("negociacaoDebitos")) {
			...
			httpServletRequest.setAttribute("voltarInformacoes", true);
			Fachada.getInstancia().verificarExistenciaAcessoLojaVirtual(ip, AcessoLojaVirtual.NORMAS_INSTALACAO, AcessoLojaVirtual.INDICADOR_SERVICO_EXECUTADO); 

...
public class ConsultarPagamentoDebitosPortalActionForm extends ValidatorActionForm {
	...
	public String getPeriodoDebitos() {
		return periodoDebitos;
	}

	public void setPeriodoDebitos(String periodoDebitos) {
		this.periodoDebitos = periodoDebitos;
	}

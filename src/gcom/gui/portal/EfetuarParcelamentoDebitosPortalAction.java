...
public class EfetuarParcelamentoDebitosPortalAction extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, 
		...
		if(parcelamentoEfetuado == null){
			...
			if(form.getValorAcrescimosServicosCurtoPrazo() != null
					&& !form.getValorAcrescimosServicosCurtoPrazo().equals("")){
				valorAcrescimosServicosCurtoPrazo = Util.formatarMoedaRealparaBigDecimal(
						form.getValorAcrescimosServicosCurtoPrazo());
			}
			
			BigDecimal valorAcrescimosServicosLongoPrazo = BigDecimal.ZERO;
			if(form.getValorAcrescimosServicosLongoPrazo() != null
					&& !form.getValorAcrescimosServicosLongoPrazo().equals("")){
				valorAcrescimosServicosLongoPrazo = Util.formatarMoedaRealparaBigDecimal(
						form.getValorAcrescimosServicosLongoPrazo());
			}
			
			BigDecimal valorAcrescimosParcelamentosCurtoPrazo = BigDecimal.ZERO;
			if(form.getValorAcrescimosParcelamentosCurtoPrazo() != null
					&& !form.getValorAcrescimosParcelamentosCurtoPrazo().equals("")){
				valorAcrescimosParcelamentosCurtoPrazo = Util.formatarMoedaRealparaBigDecimal(
						form.getValorAcrescimosParcelamentosCurtoPrazo());
			}
			
			BigDecimal valorAcrescimosParcelamentosLongoPrazo = BigDecimal.ZERO;
			if(form.getValorAcrescimosParcelamentosLongoPrazo() != null
					&& !form.getValorAcrescimosParcelamentosLongoPrazo().equals("")){
				valorAcrescimosParcelamentosLongoPrazo = Util.formatarMoedaRealparaBigDecimal(
						form.getValorAcrescimosParcelamentosLongoPrazo());
			}

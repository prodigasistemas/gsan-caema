	...
	public Object executar() throws TarefaException {
		...
		if(!Util.isVazioOrNulo(helperResidencial)){
			...
			if(consumoNaoMedido != null){
				...
				parametros.put("quantidadeResidencial11a20milLitros", consumoNaoMedido.getQuantidade() );
			}
			...
			if(consumoNaoMedido != null){
				...
				parametros.put("quantidadeResidencial11a30milLitros", consumoNaoMedido.getQuantidade());
			}
			...
			if(consumoNaoMedido != null){
				...
				parametros.put("quantidadeResidencial11a40milLitros", consumoNaoMedido.getQuantidade());
			}
			...
			if(consumoNaoMedido != null){
				...
				parametros.put("quantidadeResidencial11a50milLitros", consumoNaoMedido.getQuantidade() );
			}
			...
			if(consumoNaoMedido != null){
				...
				parametros.put("quantidadeResidencial11a90milLitros", consumoNaoMedido.getQuantidade());
			}
		}
		...
		ConsultarEstruturaTarifariaPortalHelper  helperChafariz = Fachada.getInstancia().pesquisarEstruturaTarifariaChafarizPublico();

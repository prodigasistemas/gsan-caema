...
public class ConsultarArquivoTextoOSCobrancaSmartphoneAction extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping,
		...
		ActionForward retorno = actionMapping
				.findForward("consultarArquivoTextoOSCobrancaSmartphone");
		...
		String idGerencia = form.getGerenciaRegional();
		String idUnidade = form.getUnidadeNegocio();
		...
		String dtGeracaoInicial = form.getPeriodoGeracaoInicial();
		String dtGeracaoFinal = form.getPeriodoGeracaoFinal();
		String idTipoOrdemServico = form.getIdTipoOS();
		String[] idsServicoTipo = form.getIdsServicoTipo();
		
		
		
		if (httpServletRequest.getAttribute("situacao") != null) {
			String idSituacaoRequest = ((Integer) httpServletRequest.getAttribute("situacao")).toString();
			form.setSituacaoArquivoTexto(idSituacaoRequest);
		}
		...
		Collection<ArquivoTxtOSCobrancaSmartphoneHelper> colecaoArquivoTextoOSCobrancaSmartphone = 
					fachada.buscarColecaoArquivoTextoOSCobrancaSmartphone(
															idEmpresa,
															idGerencia,
															idUnidade,
															idLocalidade,

...
public class GerarRelatorioDadosDiariosLocalidadeAction extends
	...
	public ActionForward execute(ActionMapping actionMapping,
		...
		if (sessao.getAttribute("colecaoDadosDiariosLocalidade") != null) {
			colecaoDadosDiarios = (Collection<FiltrarDadosDiariosArrecadacaoHelper>) sessao.getAttribute("colecaoDadosDiariosLocalidade");
		}
		...
		relatorioDadosDiariosLocalidade.addParametro("dadosAtual", 
				dadosAtual);
		relatorioDadosDiariosLocalidade.addParametro("colecaoDadosDiariosLocalidade", 
				colecaoDadosDiarios);

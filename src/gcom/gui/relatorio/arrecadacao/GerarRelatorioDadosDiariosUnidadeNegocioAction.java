...
public class GerarRelatorioDadosDiariosUnidadeNegocioAction extends
	...
	public ActionForward execute(ActionMapping actionMapping,
		...
		if (sessao.getAttribute("colecaoDadosDiariosUnidade") != null) {
			colecaoDadosDiarios = (Collection<FiltrarDadosDiariosArrecadacaoHelper>) sessao.getAttribute("colecaoDadosDiariosUnidade");
		}
		...
		relatorioDadosDiariosUnidadeNegocio.addParametro("colecaoDadosDiariosUnidade",
				colecaoDadosDiarios);

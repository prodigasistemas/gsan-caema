...
public class GerarRelatorioDadosDiariosValoresDiariosAction extends
	...
	public ActionForward execute(ActionMapping actionMapping,
		...
		if (sessao.getAttribute("colecaoDadosDiariosValores") != null) {
			colecaoDadosDiarios = (Collection<FiltrarDadosDiariosArrecadacaoHelper>) sessao.getAttribute("colecaoDadosDiariosValores");
		}
		...
		relatorioDadosDiariosValoresDiarios.addParametro("colecaoDadosDiariosValores",
				colecaoDadosDiarios);

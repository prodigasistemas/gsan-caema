...
public class GerarRelatorioDadosDiariosEloAction extends
	...
	public ActionForward execute(ActionMapping actionMapping,
		...
		if (sessao.getAttribute("colecaoDadosDiariosElo") != null) {
			colecaoDadosDiarios = (Collection<FiltrarDadosDiariosArrecadacaoHelper>) sessao.getAttribute("colecaoDadosDiariosElo");
		}
		...
		relatorioDadosDiariosElo.addParametro("valorTotalGerencia", 
				valorTotalGerencia);
		relatorioDadosDiariosElo.addParametro("colecaoDadosDiariosElo", 
				colecaoDadosDiarios);

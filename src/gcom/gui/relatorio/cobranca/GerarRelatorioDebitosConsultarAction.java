...
public class GerarRelatorioDebitosConsultarAction extends
	...
	public ActionForward execute(ActionMapping actionMapping,
		...
		Collection colecaoContratoParcelamentoClienteResp = new ArrayList();
		Collection colecaoContratoParcelamentoClienteRespParcAVencer = new ArrayList();
		String valorTotalDebitos = null;
		String valorTotalDebitosAtualizado = null;
		String valorTotalGeralDebitos = null;
		String valorTotalGeralDebitosAtualizado = null;
		 ...
		 if (sessao.getAttribute("valorTotalGeralSemAcrescimo") != null) {
			 valorTotalGeralDebitos = (String) sessao.getAttribute("valorTotalGeralSemAcrescimo");
		 }
		 
		 if (sessao.getAttribute("valorTotalGeralComAcrescimo") != null) {
			 valorTotalGeralDebitosAtualizado = (String) sessao.getAttribute("valorTotalGeralComAcrescimo");
		 }
		...
		if (actionForm instanceof ConsultarImovelActionForm) {
			...
			if(relatorioEndereco == null || relatorioEndereco.equals("")){
				 if(sessao.getAttribute("colecaoContratoParcelamentoClienteResp") != null){
					 colecaoContratoParcelamentoClienteResp = (Collection) sessao.getAttribute("colecaoContratoParcelamentoClienteResp");
				 }
				 
				 if(sessao.getAttribute("colecaoContratoParcelamentoClienteRespParcAVencer") != null){
					 colecaoContratoParcelamentoClienteRespParcAVencer = (Collection) sessao.getAttribute("colecaoContratoParcelamentoClienteRespParcAVencer");
				 }
			}
			 else{
					...
					if (consultarDebitoClienteActionForm.getCodigoCliente() != null 
						...
						colecaoContratoParcelamentoClienteResp = 
							fachada.pesquisarContratosParcelamentoCliente(new Integer(consultarDebitoClienteActionForm.getCodigoCliente()));
						
						colecaoContratoParcelamentoClienteRespParcAVencer = 
							fachada.pesquisarContratosParcelamentoClienteParcelasAVencer(new Integer(consultarDebitoClienteActionForm.getCodigoCliente()));
					}
					else{
						colecaoContratoParcelamentoClienteResp = 
									fachada.pesquisarContratosParcelamentoCliente(new Integer(consultarDebitoClienteActionForm.getCodigoClienteSuperior()));

						colecaoContratoParcelamentoClienteRespParcAVencer = 
							fachada.pesquisarContratosParcelamentoClienteParcelasAVencer(new Integer(consultarDebitoClienteActionForm.getCodigoClienteSuperior()));
					}
			 }
			
			relatorioConsultarDebitos.addParametro("colecaoContratoParcelamentoClienteResp", colecaoContratoParcelamentoClienteResp);

			relatorioConsultarDebitos.addParametro("colecaoContratoParcelamentoClienteRespParcAVencer", colecaoContratoParcelamentoClienteRespParcAVencer);
		...
		relatorioConsultarDebitos.addParametro("valorTotalGeralDebitos", valorTotalGeralDebitos);
		relatorioConsultarDebitos.addParametro("valorTotalGeralDebitosAtualizado", valorTotalGeralDebitosAtualizado);

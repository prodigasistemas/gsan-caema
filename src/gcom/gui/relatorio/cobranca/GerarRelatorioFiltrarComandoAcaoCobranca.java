...
public class GerarRelatorioFiltrarComandoAcaoCobranca extends ExibidorProcessamentoTarefaRelatorio {
	...
	public ActionForward execute(
		...
		if (session.getAttribute("colecaoCobrancaAcaoAtividadeEventual") != null){
			...
			Collection colecaoCobrancaAcaoAtividadeEventual = (Collection) session.getAttribute("colecaoCobrancaAcaoAtividadeEventual");
			relatorio.addParametro("colecaoCobrancaAcaoAtividadeEventual", colecaoCobrancaAcaoAtividadeEventual);

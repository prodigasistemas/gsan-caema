...
public class GerarRelatorioDebitosResumidoConsultarAction extends
	...
	public ActionForward execute(ActionMapping actionMapping,
		...
		Collection<ContratoParcelamentoClieRespHelper> colecaoContratoParcelamentoClienteResp = 
				new ArrayList<ContratoParcelamentoClieRespHelper>();
		...
		if (sessao.getAttribute("valorTotalGeralSemAcrescimo") != null) {
			valorTotalGeralDebitos = (String) sessao
					.getAttribute("valorTotalGeralSemAcrescimo");
		}

		if (sessao.getAttribute("valorTotalGeralComAcrescimo") != null) {
			valorTotalGeralDebitosAtualizado = (String) sessao
					.getAttribute("valorTotalGeralComAcrescimo");
		}
		...
		relatorioConsultarDebitosResumido.addParametro("valorTotalGeralDebitos",
				valorTotalGeralDebitos);
		relatorioConsultarDebitosResumido.addParametro("valorTotalGeralDebitosAtualizado", 
				valorTotalGeralDebitosAtualizado);
		
		relatorioConsultarDebitosResumido.addParametro("colecaoContratoParcelamentoClienteResp", colecaoContratoParcelamentoClienteResp);

		relatorioConsultarDebitosResumido.addParametro("colecaoContratoParcelamentoClienteRespParcAVencer", colecaoContratoParcelamentoClienteRespParcAVencer);

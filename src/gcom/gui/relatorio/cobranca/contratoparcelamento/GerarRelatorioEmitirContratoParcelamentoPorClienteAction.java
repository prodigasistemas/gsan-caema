...
public class GerarRelatorioEmitirContratoParcelamentoPorClienteAction  extends
	...
	public ActionForward execute(ActionMapping actionMapping,
		...
		// [FS0002] - Verificar o número contrato recebido.
		if(contratoParcelamentoBase.getNumero().compareTo(contratoParcelamentoBase.getId().toString()) == 0) {
			throw new ActionServletException(
					"atencao.nao_possivel.emitir_cont_parc_clie.numero_provisorio");
		}

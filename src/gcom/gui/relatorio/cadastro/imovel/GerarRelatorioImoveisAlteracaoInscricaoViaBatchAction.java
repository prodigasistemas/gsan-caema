...
import gcom.relatorio.cadastro.imovel.RelatorioResumoImoveisAlteracaoInscricaoViaBatch;
...
//					peloMenosUmParametroInformado = true;
		...
		if((form.getSetorComercialOrigemID() != null && !form.getSetorComercialOrigemID().equals("")) || 
			...
			if(form.getSetorComercialOrigemID() != null && 
				...
				helper.setCodigoSetorComercialInicial(new Integer(form.getSetorComercialOrigemCD()));
				peloMenosUmParametroInformado = true;
			}else{
				...
				helper.setCodigoSetorComercialInicial(objetoSetorComercial.getCodigo());
				peloMenosUmParametroInformado = true;
			}
		}
		...
		if((form.getSetorComercialDestinoID() != null && !form.getSetorComercialDestinoID().equals("")) || 
			...
			if(form.getSetorComercialDestinoID() != null && 
				...
				helper.setCodigoSetorComercialFinal(new Integer(form.getSetorComercialDestinoCD()));
				peloMenosUmParametroInformado = true;
			}else{
				...
				helper.setCodigoSetorComercialFinal(objetoSetorComercial.getCodigo());
				peloMenosUmParametroInformado = true;
			}
		}
		...
		if((form.getQuadraOrigemNM() != null && !form.getQuadraOrigemNM().equals("")) || 
			...
			if(form.getQuadraOrigemID() != null && !form.getQuadraOrigemID().equals("")){
				...
				helper.setNumeroQuadraInicial(new Integer(form.getQuadraOrigemNM()));
				peloMenosUmParametroInformado = true;
			}else{
				...
				helper.setNumeroQuadraInicial(objetoQuadra.getNumeroQuadra());
				peloMenosUmParametroInformado = true;
			}
		}
		...
		if((form.getQuadraDestinoNM() != null && !form.getQuadraDestinoNM().equals("")) || 
			...
			if(form.getQuadraDestinoID() != null && !form.getQuadraDestinoID().equals("")){
				...
				helper.setNumeroQuadraFinal(new Integer(form.getQuadraDestinoNM()));
				peloMenosUmParametroInformado = true;
			}else{
				...
				helper.setNumeroQuadraFinal(objetoQuadra.getNumeroQuadra());
				peloMenosUmParametroInformado = true;
			}
		}
		...
		if(form.getIndicadorInscricaoAtualAnterior() != null){
			helper.setIndicadorInscricaoAtualAnterior(new Short(form.getIndicadorInscricaoAtualAnterior()));
		}else if(peloMenosUmParametroInformado){
			throw new ActionServletException("atencao.campo.informado", null, "Pesquisar por");
		}
		
		if(form.getOrigemAtualizacao() != null){
			helper.setOrigemAtualizacao(form.getOrigemAtualizacao());
		}
...
//		}
		...
		if(form.getTipoGeracao() == null){
			throw new ActionServletException("atencao.campo.informado", null, "Tipo Geração");
		}else{
		
			if(form.getTipoGeracao().equals("1")){
				//RELATÓRIO
				 relatorio = new RelatorioImoveisAlteracaoInscricaoViaBatch((Usuario)
						(httpServletRequest.getSession(false)).getAttribute("usuarioLogado"));
			}else{
				//RESUMO
				relatorio = new RelatorioResumoImoveisAlteracaoInscricaoViaBatch((Usuario)
						(httpServletRequest.getSession(false)).getAttribute("usuarioLogado"));
			}
		}

...
public class GerarRelatorioCadastroConsumidoresInscricaoAction extends ExibidorProcessamentoTarefaRelatorio {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest, HttpServletResponse httpServletResponse) {
		...
		Collection<Integer> colecaoIdSituacaoAgua = null;
		Collection<Integer> colecaoIdSituacaoEsgoto = null;
...
//		}
		...
		//Colecao Situação Ligação Esgoto
		if (imovelOutrosCriteriosActionForm.getColecaoSituacaoLigacaoEsgoto() != null 
			&& (!imovelOutrosCriteriosActionForm.getColecaoSituacaoLigacaoEsgoto()[0].equals(ConstantesSistema.NUMERO_NAO_INFORMADO+"")
					|| imovelOutrosCriteriosActionForm.getColecaoSituacaoLigacaoEsgoto().length > 1 )) {
			colecaoIdSituacaoEsgoto = new ArrayList<Integer>();
			for (String idSituacaoEsgoto : imovelOutrosCriteriosActionForm.getColecaoSituacaoLigacaoEsgoto()) {
				
				if (idSituacaoEsgoto != null
						&& !idSituacaoEsgoto.equals("")
						&& !idSituacaoEsgoto
								.equals(ConstantesSistema.NUMERO_NAO_INFORMADO + "")) {
					FiltroLigacaoEsgotoSituacao filtroLigacaoEsgotoSituacao = new FiltroLigacaoEsgotoSituacao();
					...
					if (colecaoSituacoesLigacoesEsgoto != null
						...
						colecaoLigacaoEsgotoSituacao = new ArrayList<LigacaoEsgotoSituacao>();
						
						colecaoLigacaoEsgotoSituacao.add((LigacaoEsgotoSituacao) situacaoLigacaoEsgotoIterator.next());
						
						colecaoIdSituacaoEsgoto.add(new Integer(idSituacaoEsgoto));
					...
					colecaoLigacaoEsgotoSituacao = null;
				}
		...
		//Colecao Situação Ligação Agua
		if (imovelOutrosCriteriosActionForm.getColecaoSituacaoLigacaoAgua() != null 
				&& (!imovelOutrosCriteriosActionForm.getColecaoSituacaoLigacaoAgua()[0].equals(ConstantesSistema.NUMERO_NAO_INFORMADO+"") 
						|| imovelOutrosCriteriosActionForm.getColecaoSituacaoLigacaoAgua().length > 1 )) {
			colecaoIdSituacaoAgua = new ArrayList<Integer>();
			for (String idSituacaoAgua : imovelOutrosCriteriosActionForm.getColecaoSituacaoLigacaoAgua()) {
				
				if (idSituacaoAgua != null
						&& !idSituacaoAgua.equals("")
						&& !idSituacaoAgua
								.equals(ConstantesSistema.NUMERO_NAO_INFORMADO + "")) {
					FiltroLigacaoAguaSituacao filtroLigacaoAguaSituacao = new FiltroLigacaoAguaSituacao();
					...
					if (colecaoSituacoesLigacoesAgua != null
							&& !colecaoSituacoesLigacoesAgua.isEmpty()) {
						// A Situação da Ligação de Agua foi encontrada
						Iterator situacaoLigacaoAguaIterator = colecaoSituacoesLigacoesAgua
								.iterator();

						colecaoLigacaoAguaSituacao = new ArrayList<LigacaoAguaSituacao>();
						
						colecaoLigacaoAguaSituacao.add((LigacaoAguaSituacao) situacaoLigacaoAguaIterator.next());
						
						colecaoIdSituacaoAgua.add(new Integer(idSituacaoAgua));
					...
					colecaoLigacaoAguaSituacao = null;
				}
...
//		imovelParametrosInicial.setNomeConta(nomeConta);
		...
		// indicador Cpf Cnpj
		relatorio.addParametro("indicadorCpfCnpj", 
				imovelOutrosCriteriosActionForm.getIndicadorCpfCnpjInformado());
		
		// Cpj Cnpj
		relatorio.addParametro("cpfCnpj", 
				imovelOutrosCriteriosActionForm.getCpfCnpj());
		
		// Colecao situacao Ligacao Esgoto
		relatorio.addParametro(
				"colecaoSituacaoLigacaoEsgoto", imovelOutrosCriteriosActionForm
						.getColecaoSituacaoLigacaoEsgoto());
		
		// Colecao situacao Ligacao Agua
		relatorio.addParametro(
				"colecaoSituacaoLigacaoAgua", imovelOutrosCriteriosActionForm
						.getColecaoSituacaoLigacaoAgua());
		
		//Colecao perfil Imovel ID
		relatorio.addParametro(
				"colecaoPerfilImovelID", imovelOutrosCriteriosActionForm
						.getColecaoPerfilImovel());
				
		//Colecao categoria Imovel ID
		relatorio.addParametro(
				"colecaoCategoriaImovelID", imovelOutrosCriteriosActionForm
						.getColecaoCategoriaImovel());

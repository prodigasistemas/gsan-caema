...
/*			String idBairro = (String) form
			...
			String idSituacaoLigacaoAgua = (String) form.getSituacaoAgua();
...
/*			String idCategoria = (String) form
		...
		/*	CobrancaSituacao cobrancaSituacao = null;
			...
			if (form.getColecaoSituacaoLigacaoEsgoto() != null 
				&& (!form.getColecaoSituacaoLigacaoEsgoto()[0].equals(ConstantesSistema.NUMERO_NAO_INFORMADO+"")
						|| form.getColecaoSituacaoLigacaoEsgoto().length > 1 )) {
				colecaoIdSituacaoEsgoto = new ArrayList<Integer>();
				for (String idSituacaoEsgoto : form.getColecaoSituacaoLigacaoEsgoto()) {
			...
			if (form.getColecaoSituacaoLigacaoAgua() != null 
					&& (!form.getColecaoSituacaoLigacaoAgua()[0].equals(ConstantesSistema.NUMERO_NAO_INFORMADO+"") 
							|| form.getColecaoSituacaoLigacaoAgua().length > 1 )) {
				colecaoIdSituacaoAgua = new ArrayList<Integer>();
				for (String idSituacaoAgua : form.getColecaoSituacaoLigacaoAgua()) {

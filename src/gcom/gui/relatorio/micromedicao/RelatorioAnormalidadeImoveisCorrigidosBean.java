...
public class RelatorioAnormalidadeImoveisCorrigidosBean implements RelatorioBean {
	...
	public RelatorioAnormalidadeImoveisCorrigidosBean(RelatorioAnormalidadeImoveisCorrigidosHelper helper){
		
		this.inscricaoImovel = helper.getInscricaoImovel();
		this.anormalidadeAnterior = helper.getAnormalidadeAnterior();
		this.dataCorrecaoAnormalidadeAnterior = helper.getDataCorrecaoAnormalidadeAnterior();
		this.anormalidadeAtual = helper.getAnormalidadeAtual();
		this.dataLeituraAnormalidadeAtual = helper.getDataLeituraAnormalidadeAtual();
		this.nomeGerenciaRegional = helper.getNomeGerenciaRegional();
		this.nomeUnidadeNegocio = helper.getNomeUnidadeNegocio();

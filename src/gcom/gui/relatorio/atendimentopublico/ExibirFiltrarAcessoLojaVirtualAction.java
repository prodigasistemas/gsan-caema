...
public class ExibirFiltrarAcessoLojaVirtualAction extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping,
		...
		if ( form.getIndicadorServicoExecutado() == null || form.getIndicadorServicoExecutado().equals("") ) {
			form.setIndicadorServicoExecutado("3");//Todos
		}
		...
		if ( periodoInicial != null && periodoFinal == null ) {
			throw new ActionServletException("atencao.campo.informado",
					"Periodo de Atendimento Final");
		} else if ( periodoFinal != null && periodoInicial == null ) {
			throw new ActionServletException("atencao.campo.informado",
					"Periodo de Atendimento Inicial");
		...
		if (  httpServletRequest.getParameter("acao") != null && httpServletRequest.getParameter("acao").equals("pesquisa") ) {
			...
			colecaoHelper = fachada.pesquisarAcessoLojaVirtual(periodoInicial, periodoFinal, tipoAtendimento,indicadorServicoExecutado);

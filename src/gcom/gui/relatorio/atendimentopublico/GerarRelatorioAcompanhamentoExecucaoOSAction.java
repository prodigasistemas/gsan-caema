...
public class GerarRelatorioAcompanhamentoExecucaoOSAction extends
	...
	public ActionForward execute(ActionMapping actionMapping,
		...
		Date periodoExecucaoInicialFormatado = null;

		if (periodoExecucaoInicial != null
				&& !periodoExecucaoInicial.trim().equals("")) {
			periodoExecucaoInicialFormatado = Util
					.converteStringParaDate(periodoExecucaoInicial);
		}

		Date periodoExecucaoFinalFormatado = null;

		if (periodoExecucaoFinal != null
				&& !periodoExecucaoFinal.trim().equals("")) {
			periodoExecucaoFinalFormatado = Util
					.converteStringParaDate(periodoExecucaoFinal);
		}
		...
		validarGeracaoRelatorio(origemServico, situacaoOS, idsServicosTipos,
				...
				periodoExecucaoInicialFormatado,
				periodoExecucaoFinalFormatado,
				idEquipeProgramacao,
				idEquipeExecucao);
		...
		relatorioAcompanhamentoExecucaoOS.addParametro("periodoExecucaoInicial", periodoExecucaoInicialFormatado);
		relatorioAcompanhamentoExecucaoOS.addParametro("periodoExecucaoFinal", periodoExecucaoFinalFormatado);
	...
	private void validarGeracaoRelatorio(String origemServico,
			...
			Date periodoEncerramentoFinal, Date periodoExecucaoInicial, Date periodoExecucaoFinal,
			String idEquipeProgramacao, String idEquipeExecucao) {
...
//		}
		...
		int qtdeResultados = fachada
				.pesquisarOSGerarRelatorioAcompanhamentoExecucaoCount(
						...
						periodoEncerramentoFinal, periodoExecucaoInicial, periodoExecucaoFinal,
						idEquipeProgramacao,
						idEquipeExecucao);

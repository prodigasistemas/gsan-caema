...
public class ExibirAcessoLojaVirtualPopupAction extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping,
		...
		Collection<AcessoLojaVirtualHelper> colecaoHelper = null;
		...
		Integer totalRegistros = (Integer) fachada.pesquisarQuantidadeAcessoLojaVirtualTipoAtendimento(periodoInicial, periodoFinal, tipoAtendimento,indicadorServicoExecutado);

		if (totalRegistros == null || totalRegistros <= 0 ) {
			// Nenhum cliente cadastrado
			throw new ActionServletException(
					"atencao.pesquisa.nenhumresultado", "exibirFiltrarAcessoLojaVirtualAction.do?limparFormulario=sim", null, new String[0] );
		}
		...
		colecaoHelper = fachada.pesquisarAcessoLojaVirtualTipoAtendimento(periodoInicial, periodoFinal, tipoAtendimento, (Integer) httpServletRequest
				.getAttribute("numeroPaginasPesquisa"),indicadorServicoExecutado);
	    
		
		httpServletRequest.setAttribute("colecaoHelperPopup", colecaoHelper);

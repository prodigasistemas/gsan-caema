...
import gcom.gui.operacional.FiltrarDistritoOperacionalActionForm;
import gcom.relatorio.ExibidorProcessamentoTarefaRelatorio;
import gcom.relatorio.operacional.RelatorioManterDistritoOperacional;
...
/**
 * Action responsável pela geração do relatório de setor de abastecimento
 * 
 * @author Hugo Azevedo
 * @created 09/06/2014
 */
public class GerarRelatorioDistritoOperacionalManterAction extends ExibidorProcessamentoTarefaRelatorio {
	...
	public ActionForward execute(ActionMapping actionMapping,
		...
		RelatorioManterDistritoOperacional relatorio = new RelatorioManterDistritoOperacional((Usuario)(httpServletRequest.getSession(false)).getAttribute("usuarioLogado"));
		...
		relatorio.addParametro("indicadorPosicaoTexto",indicadorTexto);

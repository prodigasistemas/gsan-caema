 ...
 * @date 13/02/2012
 */
public class ExibirGerarRelatorioImoveisRateioNegativoAction extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping,
		...
		ActionForward retorno = actionMapping.findForward("exibirGerarRelatorioImoveisRateioNegativo");
		...
		// Verifica se a opção do usuário é selecionar todos os imóveis ou filtrar
		// a partir da sua localidade para bloquear e desbloquear os campos.
		if (form.getTipoSelecao() != null && !form.getTipoSelecao().equals("")){
			form.setTipoSelecao(form.getTipoSelecao());
		}else{
			form.setTipoSelecao("todosImoveis");
		}
	...
	private void pesquisarLocalidade(GerarRelatorioImoveisRateioNegativoActionForm form,
	 ...
	 */
	@SuppressWarnings("unchecked")
	private void pesquisarSetorComercial(GerarRelatorioImoveisRateioNegativoActionForm form,
		String objetoConsulta) {

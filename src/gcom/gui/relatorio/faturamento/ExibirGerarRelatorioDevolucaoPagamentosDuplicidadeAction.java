...
public class ExibirGerarRelatorioDevolucaoPagamentosDuplicidadeAction extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping,
		...
		this.pesquisarTipoEspecificacao(httpServletRequest, form);
		this.pesquisarMotivoDevolucao(httpServletRequest, form);
        ...
        if ((form.getTipoDocumento() == null) || (form.getTipoDocumento().trim().equals(""))) {
        	form.setTipoDocumento("4");
		}
		
		return retorno;
	}
	
	private void pesquisarTipoEspecificacao(HttpServletRequest httpServletRequest,
			GerarRelatorioDevolucaoPagamentosDuplicidadeActionForm form){		
		
		Collection<SolicitacaoTipoEspecificacao> colecaoSolicitacaoTipoEspecificacao = fachada.obterTiposEspecificacoes();
		httpServletRequest.setAttribute("colecaoSolicitacaoTipoEspecificacao", colecaoSolicitacaoTipoEspecificacao);
	
	}
	
	private void pesquisarMotivoDevolucao(HttpServletRequest httpServletRequest,
			GerarRelatorioDevolucaoPagamentosDuplicidadeActionForm form){
		
		Collection<CobrancaIndevidaMotivo> colecaoCobrancaIndevidaMotivo = fachada.obterMotivosDevolucao();
		httpServletRequest.setAttribute("colecaoCobrancaIndevidaMotivo", colecaoCobrancaIndevidaMotivo);

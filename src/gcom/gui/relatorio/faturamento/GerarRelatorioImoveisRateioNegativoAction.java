...
import gcom.relatorio.faturamento.RelatorioImoveisRateioNegativo;
...
/**
 * [RM6602] Identificar Imóveis Condomínios com Rateio Negativo. [UC1281]
 ...
 * @date 13/02/2012
 */
public class GerarRelatorioImoveisRateioNegativoAction extends ExibidorProcessamentoTarefaRelatorio {
	...
	public ActionForward execute(ActionMapping actionMapping,
		...
		ActionForward retorno = actionMapping.findForward("emitirRelatorioImoveisRateioNegativo");
		
		// Form
		GerarRelatorioImoveisRateioNegativoActionForm form = 
			(GerarRelatorioImoveisRateioNegativoActionForm) actionForm;
		
		FiltrarRelatorioImoveisRateioNegativoHelper filtro = 
			new FiltrarRelatorioImoveisRateioNegativoHelper();
		
		filtro.setTipoSelecao(form.getTipoSelecao());
		
		// Verifica o tipo de seleção do usuário
		if (filtro.getTipoSelecao() != null && filtro.getTipoSelecao().equals("porLocalizacao")){
			...
			if (form.getGerenciaRegional() != null && 
				...
				filtro.setNomeGerenciaRegional(gerenciaRegional.getNome());
			}
			...
			if (form.getUnidadeNegocio() != null && 
				...
				filtro.setNomeUnidadeNegocio(unidadeNegocio.getNome());
			}
			...
			if (form.getLocalidadeInicial() != null && 
				...
				if (form.getSequencialRotaInicial() != null && 
					...
					filtro.setSequencialRotaInicial(new Integer(form.getSequencialRotaInicial()));
				}
			}else{
			...
			if (form.getLocalidadeFinal() != null && 
				...
				if (form.getSequencialRotaFinal() != null && 
					...
					filtro.setSequencialRotaFinal(new Integer(form.getSequencialRotaFinal()));
				}
		...
		RelatorioImoveisRateioNegativo relatorio = 
			new RelatorioImoveisRateioNegativo(this.getUsuarioLogado(httpServletRequest));
		
		relatorio.addParametro("filtrarRelatorioImoveisRateioNegativoHelper", filtro);

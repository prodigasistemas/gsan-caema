 ...
 * 
 */
public class ExibirConsultarResumoAcaoCobrancaSituacaoAcaoAnoMesDetalhesPopupAction extends
		GcomAction {
	/**
	 * < <Descrição do método>>
	 * 
	...
	public ActionForward execute(ActionMapping actionMapping,
		...
		ActionForward retorno = actionMapping
				.findForward("consultarResumoAcaoCobrancaSituacaoAcaoMesAnoDetalhesPopup");
		...
		Collection colecaoResumoCobrancaAcaoSituacaoAcaoAnoMesDetalhes = new ArrayList();
		if (tipoDetalhe.equals("eRF")){
			colecaoResumoCobrancaAcaoSituacaoAcaoAnoMesDetalhes = fachada
			.consultarResumoCobrancaAcaoResumoRetornoFiscalizacaoEventual(
		...
		sessao.setAttribute("colecaoResumoCobrancaAcaoSituacaoAcaoAnoMesDetalhes",
				colecaoResumoCobrancaAcaoSituacaoAcaoAnoMesDetalhes);			

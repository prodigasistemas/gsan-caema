...
public class FiltrarProcessoAction extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping,
		...
		//Caso tenha sido informado o Grupo de Faturamento, o sistema faz a seleção com 
		//PROC_ID="PROCESSO COMANDADO DE FATURAMENTO" e PROI_NNGRUPO = GRUP_ID do grupo selecionado pelo usuário.
		...
		//Caso tenha sido informado o Grupo de Cobrança, o sistema faz a seleção com 
		//PRTP_ID="PROCESSO COMANDADO DE COBRANCA" e PROI_NNGRUPO = GRUP_ID do grupo selecionado pelo usuário.
		if(idCobrancaGrupo!=null && !idCobrancaGrupo.equals("-1")){
			...
			//Caso tenha sido informado a Ação de Cobrança, o sistema faz a seleção com 
			//PROI_DSCOMPLEMENTO LIKE "%(CBAC_DSCOBRANCAACAO)" selecionada pelo usuário.

...
public class ExibirAtualizarGrupoDadosGeraisAction extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping,
        ...
        if(form.get("diasExpiracaoSenha")!=null){
        	
        	if(form.get("diasExpiracaoSenha").toString().equals("0")){
            	form.set("diasExpiracaoSenha", null);
            }
        }
        ...
        // Carregar lista de grupo Inferior
 		if (sessao.getAttribute("colecaoGrupoInferior") == null
 			...
 			Comparator comp = new Comparator<Grupo>() {
	        ...
	        if (colecaoPermissaoEspecialSession==null) {
				...
				if (colecaoPermissaoEspecialParaAtualizar != null
					...
					while(ite.hasNext()){
						...
						FiltroPermissaoEspecial filtroPE = new FiltroPermissaoEspecial();
						filtroPE.adicionarParametro(new ParametroSimples(FiltroPermissaoEspecial.ID, grupoPermissaoEspecial.getComp_id().getPermissaoEspecialId()));

...
public class ExibirManterSolicitacaoAcessoAction extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping,
		...
		Collection collectionSolicitacaoAcesso = null;
		...
		FiltroSolicitacaoAcessoGrupo filtroSolicitacaoAcessoGrupo = 
			(FiltroSolicitacaoAcessoGrupo)sessao.getAttribute("filtroSolicitacaoAcessoGrupo");
...
//			filtroSolicitacaoAcessoGrupo, SolicitacaoAcessoGrupo.class.getName());
		...
		collectionSolicitacaoAcesso = Fachada.getInstancia()
		.pesquisarSolicitacaoAcessoGrupos(
		...
		if (collectionSolicitacaoAcesso != null
				&& !collectionSolicitacaoAcesso.isEmpty()) {
			...
			if (collectionSolicitacaoAcesso.size() == 1
				...
				if (httpServletRequest.getAttribute("atualizar") != null) {
					...
					SolicitacaoAcesso solicitacaoAcesso = 
						(SolicitacaoAcesso) collectionSolicitacaoAcesso.iterator().next();
					
					sessao.setAttribute("objetoSolicitacaoAcesso", solicitacaoAcesso);
					sessao.setAttribute("telaAtualizar", httpServletRequest.getParameter("atualizar"));
					...
					httpServletRequest.setAttribute(
							"colecaoSolicitacaoAcesso",collectionSolicitacaoAcesso);
				}
			} else {
				httpServletRequest.setAttribute("colecaoSolicitacaoAcesso", collectionSolicitacaoAcesso);
			}
		} else {

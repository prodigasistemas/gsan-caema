...
public class ExibirInserirSolicitacaoAcessoActionForm extends ActionForm {
	...
	private String loginUsuarioPesquisa;
	private String nomeUsuarioPesquisa;
	private String usuarioPesquisaNaoEncontrado = "true";
	...
	private String exibirPermissao = "2";
	...
	public void reset(){
		...
		this.competenciaRetificacao = null;
	...
	public String getLoginUsuarioPesquisa() {
		return loginUsuarioPesquisa;
	}

	public void setLoginUsuarioPesquisa(String loginUsuarioPesquisa) {
		this.loginUsuarioPesquisa = loginUsuarioPesquisa;
	}
	...
	public String getUsuarioPesquisaNaoEncontrado() {
		return usuarioPesquisaNaoEncontrado;
	}

	public void setUsuarioPesquisaNaoEncontrado(String usuarioPesquisaNaoEncontrado) {
		this.usuarioPesquisaNaoEncontrado = usuarioPesquisaNaoEncontrado;
	}
	...
	public String getExibirPermissao() {
		return exibirPermissao;
	}

	public void setExibirPermissao(String exibirPermissao) {
		this.exibirPermissao = exibirPermissao;
	}

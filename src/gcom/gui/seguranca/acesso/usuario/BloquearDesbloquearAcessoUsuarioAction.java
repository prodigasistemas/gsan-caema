	...
	public ActionForward execute(ActionMapping actionMapping,
		...
		if (idAfastamento != 3){			
			...
			if (afastamento!=null && afastamento.equals("sim")){				
				...
				montarPaginaSucesso(httpServletRequest, "Dados do afastamento do usuário informados/mantidos com sucesso",
			...
			if (idSituacaoUsuario != null
				...
				if (usuario.getUsuarioSituacao().getId().equals(idSituacaoUsuario)) {
				 ...
				 throw new ActionServletException("atencao.campo_texto.obrigatorio", null, "Situação do Usuário");
			}

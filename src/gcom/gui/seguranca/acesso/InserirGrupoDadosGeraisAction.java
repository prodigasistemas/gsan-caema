...
public class InserirGrupoDadosGeraisAction extends GcomAction {
    ...
    public ActionForward execute(ActionMapping actionMapping,
        ...
        grupo.setIndicadorGrupoEspecial((Short)grupoActionForm.get("indicadorGrupoEspecial"));
        grupo.setIndicadorVisualizacaoRestrita((Short)grupoActionForm.get("indicadorVisualizacaoRestrita"));
        grupo.setIndicadorEspecialSeguranca((Short)grupoActionForm.get("indicadorEspecialSeguranca"));
        
        Grupo grupoInferior = new Grupo();
        
	    if(grupoActionForm.get("indicadorGrupoEspecial").equals(ConstantesSistema.NAO) 
	    		&& grupoActionForm.get("idGrupoInferior") !=null 
	    			&& !grupoActionForm.get("idGrupoInferior").equals("") ){
	    	
	    	if(!grupoActionForm.get("idGrupoInferior").equals("-1")){
	    		
	    		String idGrupoInferior =  grupoActionForm.get("idGrupoInferior").toString(); 
	            grupoInferior.setId(Integer.parseInt(idGrupoInferior));
	    	}   	
	    }
        ...
        if(grupoActionForm.get("diasExpiracaoSenha")!=null
        	...
        	Integer numeroDiasExpiracaoSenha = new Integer(grupoActionForm.get("diasExpiracaoSenha").toString());

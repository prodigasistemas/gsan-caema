...
public class InserirUsuarioTipoActionForm extends ValidatorActionForm {
	...
	private String indicadorInsereSolicitacaoAcesso = "2";
	
	public String getIndicadorInsereSolicitacaoAcesso() {
		return indicadorInsereSolicitacaoAcesso;
	}

	public void setIndicadorInsereSolicitacaoAcesso(
			String indicadorInsereSolicitacaoAcesso) {
		this.indicadorInsereSolicitacaoAcesso = indicadorInsereSolicitacaoAcesso;
	}

...
public class AtualizarTipoRateioPopupAction extends GcomAction {
    ...
    public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
        ...
        String indicadorRateioNegativo = form.getRateioNegativo();
        
        String indicadorRateioConsumoFranquia = form.getRateioConsumoFranquia();
        ...
        if (sessao.getAttribute("imovelVinculado") != null) {
            ...
            // Seta o novo valor do indicador de rateio negativo
            imovel.setIndicadorRateioNegativo(Short.valueOf(indicadorRateioNegativo));
           
            // Seta o novo valor do indicador de rateio consumo franquia
            imovel.setIndicadorRateioConsumoFranquia(Short.valueOf(indicadorRateioConsumoFranquia));
            
            
            //atualiza todos os imoveis micros com o indicador de consumo franquia selecionado pelo usuario.
            fachada.atualizarIndicadorConsumoFranquiaImovelMicro(imovel.getId(), Integer.valueOf(indicadorRateioConsumoFranquia));         
            ...
            if (httpServletRequest.getParameter("confirmado") != null) {
                ...
                if (tipoRateioLigacaoAgua != null
                        ...
                        !form.getMatriculaImovelAreaComum().isEmpty()) {
                	
                	form.setRateioConsumoFranquia("2");
                	imovel.setIndicadorRateioConsumoFranquia(new Short("2"));
                ...
                }else if (tipoRateioLigacaoAgua != null && Integer.valueOf(tipoRateioLigacaoAgua).equals(RateioTipo.RATEIO_AREA_COMUM) && !form.getMatriculaImovelAreaComumAtual().isEmpty()){
                	atualizarTipoRateio(sessao, imovel, hidrometroInstalacaoHistoricoAgua, hidrometroInstalacaoHistoricoPoco, true, Util.converterStringParaInteger(form.getMatriculaImovelAreaComum()));
                }else{
                    atualizarTipoRateio(sessao, imovel, hidrometroInstalacaoHistoricoAgua, hidrometroInstalacaoHistoricoPoco, false, Util.converterStringParaInteger(form.getMatriculaImovelAreaComumAtual()));
                }
            }
        }

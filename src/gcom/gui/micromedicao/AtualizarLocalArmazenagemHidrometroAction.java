...
public class AtualizarLocalArmazenagemHidrometroAction extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping,
        ...
        String idLeiturista = atualizarLocalArmazenagemHidrometroActionForm.getIdLeiturista();
        ...
        if(idLeiturista != null && !idLeiturista.equals("-1")){
        	leiturista.setId(Integer.parseInt(idLeiturista));
        }
        
        hidromedroLocalArmazenagem.setLeiturista(leiturista);

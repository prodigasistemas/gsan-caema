...
public class InserirRotaAction extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping,
    	...
    	while ( iteratorComercialAssociadoRota.hasNext() ) {
    		...
    		//Caso o usuário informe que a rota é alternativa e setor informado não seja alternativo
    		...
    		//Caso o usuário informe que a rota não é alternativa e setor informado seja alternativo
    		if ( new Short(indicadorRotaAlternativa).equals( ConstantesSistema.INDICADOR_USO_DESATIVO )&&
    				setor.getIndicadorSetorAlternativo().equals( ConstantesSistema.INDICADOR_USO_ATIVO) ) {
    			
    			throw new ActionServletException("atencao.rota_deve_ser_alternativa");

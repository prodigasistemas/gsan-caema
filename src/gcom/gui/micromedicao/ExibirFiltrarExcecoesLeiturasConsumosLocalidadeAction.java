...
public class ExibirFiltrarExcecoesLeiturasConsumosLocalidadeAction extends
	...
	public ActionForward execute(ActionMapping actionMapping,
		...
		Collection<UnidadeNegocio> colecaoUnidadesNegocio = fachada
				.pesquisar(filtroUnidadeNegocio, UnidadeNegocio.class
						.getName());

		httpServletRequest.setAttribute("colecaoUnidadesNegocio",
				colecaoUnidadesNegocio);

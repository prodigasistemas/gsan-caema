	...
	public void finalizarMovimentacao(DataInputStream data, HttpServletResponse response,OutputStream out, int indicadorAndroid) throws IOException{
		...
		try{
			String registro0 = buffer.readLine();
			 ...
			 String[] arrayRegistro0 = parseResgistroTipo0(registro0, indicadorAndroid);
             
             int indcFinalizacao = Integer.parseInt(arrayRegistro0[1]);
         	 Integer codRota = Integer.parseInt(arrayRegistro0[2]);
         	 Integer setorComercial = Integer.parseInt(arrayRegistro0[3]);
         	 Integer localidade = Integer.parseInt(arrayRegistro0[4]);

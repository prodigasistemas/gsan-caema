...
public class InserirConsumoAnormalidadeAction extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping,
		...
		String indicadorFotoObrigatoria = inserirConsumoAnormalidadeActionForm
				.getIndicadorFotoObrigatoria();
		...
		consumoAnormalidade.setIndicadorFotoObrigatoria(new Short(indicadorFotoObrigatoria));

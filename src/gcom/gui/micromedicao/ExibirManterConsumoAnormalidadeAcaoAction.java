...
public class ExibirManterConsumoAnormalidadeAcaoAction extends GcomAction{
	...
	public ActionForward execute(ActionMapping actionMapping,
		...
		Collection<ConsumoAnormalidadeAtividadeAcao> colecaoConsumoAnormalidadeAtividadeAcao = null;
		...
		if (sessao.getAttribute("filtroConsumoAnormalidadeAcao") != null) {
			filtroConsumoAnormalidadeAcao = (FiltroConsumoAnormalidadeAtividadeAcao) sessao.getAttribute("filtroConsumoAnormalidadeAcao");
		}
		
		if ((retorno != null)&&(retorno.getName().equalsIgnoreCase("exibirManterConsumoAnormalidadeAcao"))) {

			Map resultado = controlarPaginacao(
					httpServletRequest, retorno,	filtroConsumoAnormalidadeAcao, ConsumoAnormalidadeAtividadeAcao.class.getName());
			colecaoConsumoAnormalidadeAtividadeAcao = (Collection<ConsumoAnormalidadeAtividadeAcao>) resultado.get("colecaoRetorno");
			retorno = (ActionForward) resultado.get("destinoActionForward");

			// Nenhum registro encontrado				
			if (colecaoConsumoAnormalidadeAtividadeAcao == null || colecaoConsumoAnormalidadeAtividadeAcao.isEmpty()) {
				throw new ActionServletException(
						"atencao.pesquisa.nenhumresultado");
			}
			
			if (colecaoConsumoAnormalidadeAtividadeAcao != null
					&& !colecaoConsumoAnormalidadeAtividadeAcao.isEmpty()) {
				if (colecaoConsumoAnormalidadeAtividadeAcao.size() == 1
					...
					if (httpServletRequest.getParameter("indicadorAtualizar") != null) {
						...
						ConsumoAnormalidadeAtividadeAcao consumoAnormalidadeAcao = (ConsumoAnormalidadeAtividadeAcao) colecaoConsumoAnormalidadeAtividadeAcao
								.iterator().next();
						...
						httpServletRequest.setAttribute("colecaoConsumoAnormalidadeAcao",
								colecaoConsumoAnormalidadeAtividadeAcao);
					}
				} else {
					httpServletRequest.setAttribute("colecaoConsumoAnormalidadeAcao",
							colecaoConsumoAnormalidadeAtividadeAcao);

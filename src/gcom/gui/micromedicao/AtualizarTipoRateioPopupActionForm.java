...
public class AtualizarTipoRateioPopupActionForm extends ActionForm {
	...
	private String rateioNegativo;
	
	private String rateioConsumoFranquia;
	...
	public String getRateioNegativo() {
		return rateioNegativo;
	}

	public void setRateioNegativo(String rateioNegativo) {
		this.rateioNegativo = rateioNegativo;
	}

	public String getRateioConsumoFranquia() {
		return rateioConsumoFranquia;
	}

	public void setRateioConsumoFranquia(String rateioConsumoFranquia) {
		this.rateioConsumoFranquia = rateioConsumoFranquia;
	}
}
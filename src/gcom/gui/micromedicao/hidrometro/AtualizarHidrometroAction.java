...
public class AtualizarHidrometroAction extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping,
        ...
        if (atualizarHidrometroActionForm.getIdHidrometroClasseMetrologica() != null
				&& !atualizarHidrometroActionForm.getIdHidrometroClasseMetrologica().trim().equals("")
				&& !atualizarHidrometroActionForm.getIdHidrometroClasseMetrologica().trim().equals("-1")) {
			...
			hidrometro.setHidrometroClasseMetrologica(null);
		}
		...
		// Cria o objeto hidrômetro fator correção 	
		
       BigDecimal hidrometroFatorCorrecao = null;
		
		if (atualizarHidrometroActionForm.getHidrometroFatorCorrecao() != null 
				&& !atualizarHidrometroActionForm.getHidrometroFatorCorrecao().equals("") ) {
			hidrometroFatorCorrecao = Util.formatarMoedaRealparaBigDecimal( atualizarHidrometroActionForm.getHidrometroFatorCorrecao() ) ;
		}
		
		// Cria o objeto hidrômetro classe pressão
		
        Integer hidrometroClassePressao = null;
		
		if ( atualizarHidrometroActionForm.getHidrometroClassePressao() != null
				&& !atualizarHidrometroActionForm.getHidrometroClassePressao().equals("") ) {
			hidrometroClassePressao = new Integer (atualizarHidrometroActionForm.getHidrometroClassePressao() ) ;
		}
		
		// Cria o objeto hidrômetro Hidrometro Modelo Sensor o id
				if(atualizarHidrometroActionForm.getIdHidrometroModeloSensor() != null
						&& !atualizarHidrometroActionForm.getIdHidrometroModeloSensor().trim().equals("")
						&& !atualizarHidrometroActionForm.getIdHidrometroModeloSensor().trim().equals("-1")){
					
				HidrometroModeloSensor hidrometroModeloSensor = new HidrometroModeloSensor();
					hidrometroModeloSensor.setId(new Integer(atualizarHidrometroActionForm
						.getIdHidrometroModeloSensor()));
					hidrometro.setHidrometroModeloSensor(hidrometroModeloSensor);
					
				}else{
					hidrometro.setHidrometroModeloSensor(null);
				}
		...
		// Método utilizado para montar a página de sucesso para Macro
		if (atualizarHidrometroActionForm.getIndicadorMacromedidor().trim().toString().equals("1")) {
			montarPaginaSucesso(httpServletRequest, "Hidrômetro de Tombamento "
					+ hidrometro.getTombamento() + " atualizado com sucesso.",
					"Realizar outra Manutenção de Hidrômetro",
					"exibirManterHidrometroAction.do?menu=sim");
			
        } else {// Método utilizado para montar a página de sucesso para Micro
		...
		sessao.removeAttribute("colecaoHidrometroModeloSensor");		

...
public class ExibirPesquisarHidrometroAction extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping,
		...
		if (httpServletRequest.getParameter("limparForm") != null){
			...
			sessao.removeAttribute("tipoMacromedidor");
        ...
        //Caso o tipo de hidrômetro seja macromedidor
        if (httpServletRequest.getParameter("tipoMacromedidor") != null && 
            	!httpServletRequest.getParameter("tipoMacromedidor").trim().equals("")) {
        	
        	sessao.setAttribute("tipoMacromedidor","SIM");

...
public class PesquisarHidrometroAction extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping,
		...
		String numeroTombamento = pesquisarHidrometroActionForm.getNumeroTombamento();
		...
		if ((fixo != null && !fixo.trim().equalsIgnoreCase(""))
			...
			String tipoMacromedidor = (String)sessao.getAttribute("tipoMacromedidor");
			
			if(tipoMacromedidor != null && !tipoMacromedidor.equals("")){
				//Número do Tombamento
				if(numeroTombamento != null && 
						!numeroTombamento.equals("")){
			...
			if(tipoMacromedidor != null && !tipoMacromedidor.equals("")){
				filtroHidrometro.setCampoOrderBy(FiltroHidrometro.TOMBAMENTO);
				filtroHidrometro.adicionarParametro(new ParametroSimples(FiltroHidrometro.INDICADOR_MACROMEDIDOR, 1));
			}

...
public class FiltrarHidrometroAction extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping,
		...
		String idHidrometroModeloSensor = hidrometroActionForm.getIdHidrometroModeloSensor();
		String hidrometroClassePressao = hidrometroActionForm.getHidrometroClassePressao();
		String hidrometroFatorCorrecao = hidrometroActionForm.getHidrometroFatorCorrecao();
...
//			if (anoFabricacao != null && !anoFabricacao.trim().equalsIgnoreCase("")) {
			...
			if (idHidrometroModeloSensor != null
					&& !idHidrometroModeloSensor.trim().equals("")
					&& !idHidrometroModeloSensor.trim().equals(ConstantesSistema.NUMERO_NAO_INFORMADO + "")) {
				
				peloMenosUmParametroInformado = true;
				helper.setIdHidrometroModeloSensor(idHidrometroModeloSensor);
			}
			...
			if ( hidrometroFatorCorrecao != null && !hidrometroFatorCorrecao.equals("") ) {
				helper.setHidrometroFatorCorrecao( hidrometroFatorCorrecao );
			}
			
			if ( hidrometroClassePressao != null && !hidrometroClassePressao.equals("") ) {
				helper.setHidrometroClassePressao( hidrometroClassePressao );
			}
			...
			if (idHidrometroModeloSensor != null
				...
				filtroHidrometro.adicionarParametro(
					new ParametroSimples(
						FiltroHidrometro.HIDROMETRO_MODELO_SENSOR_ID,
						idHidrometroModeloSensor));
			}
			...
			if ( vazaoTransicao != null && !vazaoTransicao.equals("") ) {
				...
				filtroHidrometro.adicionarParametro( 
					new ParametroSimples(
						...
						Util.formatarMoedaRealparaBigDecimal( vazaoTransicao ) ));
			}
			...
			if ( vazaoNominal != null && !vazaoNominal.equals("") ) {
				...
				filtroHidrometro.adicionarParametro( 
					new ParametroSimples(
						...
						Util.formatarMoedaRealparaBigDecimal( vazaoNominal ) ));
			}
			...
			if ( vazaoMinima != null && !vazaoMinima.equals("") ) {
				...
				filtroHidrometro.adicionarParametro( 
					new ParametroSimples(
						...
						Util.formatarMoedaRealparaBigDecimal( vazaoMinima ) ));
			}
			...
			if ( hidrometroFatorCorrecao != null && !hidrometroFatorCorrecao.equals("") ) {
				...
				filtroHidrometro.adicionarParametro( 
					new ParametroSimples(
						FiltroHidrometro.HIDROMETRO_FATOR_CORRECAO, 
						Util.formatarMoedaRealparaBigDecimal( hidrometroFatorCorrecao ) ));
			}
			...
			if ( hidrometroClassePressao != null && !hidrometroClassePressao.equals("") ) {
				...
				filtroHidrometro.adicionarParametro( 
					new ParametroSimples(
						FiltroHidrometro.HIDROMETRO_CLASSE_PRESSAO,  

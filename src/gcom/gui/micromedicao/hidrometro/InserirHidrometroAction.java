...
//		 Obtendo uma instancia da sessao
        ...
        //hidrometro Fator Correcao
		BigDecimal hidrometroFatorCorrecao = null;
		// Cria o objeto hidrômetro Correção
		if (hidrometroActionForm.getHidrometroFatorCorrecao() != null
				&& !"".equals(hidrometroActionForm.getHidrometroFatorCorrecao() ) ) {
			hidrometroFatorCorrecao = Util.formatarMoedaRealparaBigDecimal( hidrometroActionForm.getHidrometroFatorCorrecao() );
		}
			
       //Hidrometro Classe Pressao		
		Integer hidrometroClassePressao = null;
		// Cria o objeto hidrômetro pressão
		if (hidrometroActionForm.getHidrometroClassePressao() != null
				&& !"".equals(hidrometroActionForm.getHidrometroClassePressao() ) ) {
			hidrometroClassePressao =new Integer( hidrometroActionForm.getHidrometroClassePressao() ) ;
		}

		// Cria o objeto hidrômetro Modelo Sensor o id
				HidrometroModeloSensor hidrometroModeloSensor = null;

				if (hidrometroActionForm.getIdHidrometroModeloSensor() != null
						&& !hidrometroActionForm.getIdHidrometroModeloSensor().trim().equals("")
						&& !hidrometroActionForm.getIdHidrometroModeloSensor().trim().equals("-1")) {
					
					hidrometroModeloSensor = new HidrometroModeloSensor();
					
					hidrometroModeloSensor.setId(new Integer(hidrometroActionForm
							.getIdHidrometroModeloSensor()));
				}
				
				HidrometroClasseMetrologica hidrometroClasseMetrologica = null;

				if (hidrometroActionForm.getIdHidrometroClasseMetrologica() != null
						&& !hidrometroActionForm.getIdHidrometroClasseMetrologica().trim().equals("")
						&& !hidrometroActionForm.getIdHidrometroClasseMetrologica().trim().equals("-1")) {

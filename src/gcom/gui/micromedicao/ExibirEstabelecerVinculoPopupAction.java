...
public class ExibirEstabelecerVinculoPopupAction extends GcomAction {
    ...
    public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
        ...
        if (acao != null && acao.trim().equalsIgnoreCase("EXIBIR")) {
            ...
            form.setRateioConsumoFranquia(null);
            ...
            if (imovelPesquisado != null && !imovelPesquisado.isEmpty()) {
                ...
                form.setRateioConsumoFranquia(imovel.getIndicadorRateioConsumoFranquia().toString());
                ...
                //Validar se existe contrato de demanda ativo para o imóvel informado
                FiltroContratoDemandaImovelComercialIndustrial filtroContratoDemanda = new FiltroContratoDemandaImovelComercialIndustrial();
                filtroContratoDemanda.adicionarParametro(new ParametroSimples(FiltroContratoDemandaImovelComercialIndustrial.ID_IMOVEL, imovel.getId()));
                filtroContratoDemanda.adicionarParametro(new ParametroNulo(FiltroContratoDemandaImovelComercialIndustrial.DATA_CONTRATO_ENCERRADO));
                
                Collection<?> colecaoContratoDemanda = fachada.pesquisar(filtroContratoDemanda, ContratoDemandaImovelComercialIndustrial.class.getName());
                if(!Util.isVazioOrNulo(colecaoContratoDemanda)){
                	throw new ActionServletException("atencao.imovel_vinculado_contrato_demanda");
                }
                
                fachada.validarVinculoImovelCondomionio(imovel.getId(), anoMesFaturamento, idRota);
            ...
            //Validar se existe contrato de demanda ativo para o imóvel informado
            FiltroContratoDemandaImovelComercialIndustrial filtroContratoDemanda = new FiltroContratoDemandaImovelComercialIndustrial();
            filtroContratoDemanda.adicionarParametro(new ParametroSimples(FiltroContratoDemandaImovelComercialIndustrial.ID_IMOVEL, imovelASerVinculado.getId()));
            filtroContratoDemanda.adicionarParametro(new ParametroNulo(FiltroContratoDemandaImovelComercialIndustrial.DATA_CONTRATO_ENCERRADO));

...
//		sessao.removeAttribute("leituraConsumoActionForm");
		...
		String idEmpresa =  leituraConsumoActionForm
				.getIdEmpresaFiltro();
		String idGerenciaRegional = leituraConsumoActionForm
				.getIdGerenciaRegional();
		String idUnidadeNegocio = leituraConsumoActionForm
				.getIdUnidadeNegocio();
		...
		if (idGerenciaRegional != null
			...
			filtroMedicaoHistoricoSql.adicionarParametro(new ParametroSimples(
					FiltroMedicaoHistoricoSql.ID_GERENCIA_REGIONAL, idGerenciaRegional));
			filtrarAnaliseExcecoesLeiturasHelper.setIdGerenciaRegional(idGerenciaRegional);
		}
		...
		if (idUnidadeNegocio != null
			...
			filtroMedicaoHistoricoSql.adicionarParametro(new ParametroSimples(
					FiltroMedicaoHistoricoSql.ID_UNIDADE_NEGOCIO, idUnidadeNegocio));
			filtrarAnaliseExcecoesLeiturasHelper.setIdUnidadeNegocio(idUnidadeNegocio);
		}

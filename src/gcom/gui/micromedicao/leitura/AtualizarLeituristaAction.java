	...
	public ActionForward execute(ActionMapping actionMapping,
        ...
        if(form.getIdFuncionario() != null && !form.getIdFuncionario().equals("")){
            ...
            if(!Util.isVazioOrNulo(colLeituristaFunc)){
                ...
                if(!leituristaFuncionario.getEmpresa().getId().toString().equals(form.getEmpresaID())){
        ...
        if(form.getNumeroImei() == 0){
        	form.setNumeroImei(null);
        }
		...
		if(form.getNumeroEnderecoMac() != null && !form.getNumeroEnderecoMac().equals("")){
			if(form.getNumeroEnderecoMac().replaceAll(":", "").length() != 12){
		...
		if (form.getIndicadorAtualizacaoCadastral().equals("2") &&
				((form.getIdFuncionario() == null
...
//		
		...
		leiturista.setIndicadorAtualizacaoCadastral(new Short(form.getIndicadorAtualizacaoCadastral()));
		...
		if ( form.getLoginUsuario() != null && !form.getLoginUsuario().equals( "" ) ){
			...
			if (colecaoUsuario != null && !colecaoUsuario.isEmpty()) {
			 ...
			 if (form.getIndicadorAtualizacaoCadastral().toString()
		...
		if(form.getNumeroEnderecoMac() != null && !form.getNumeroEnderecoMac().equals("")){
			leiturista.setNumeroEnderecoMac(form.getNumeroEnderecoMac().replaceAll(":", "").toUpperCase());
		}

...
public class InserirLeituristaAction extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping,
		...
		//Validar se o Endereço MAC possui 12 caracteres
		if(inserirLeituristaActionForm.getNumeroEnderecoMac() != null && !inserirLeituristaActionForm.getNumeroEnderecoMac().equals("")){
			if(inserirLeituristaActionForm.getNumeroEnderecoMac().replaceAll(":", "").length() != 12){
				throw new ActionServletException("atencao.numero_endereco_mac_invalido");
			}
		}
		...
		if (inserirLeituristaActionForm.getIdFuncionario() != null && 
			...
			if (colFuncionario == null || !colFuncionario.iterator().hasNext()) {
				...
				if(func.getEmpresa() != null){
					if(func.getEmpresa().getId() != Integer.parseInt(inserirLeituristaActionForm.getEmpresaID())){
						throw new ActionServletException("atencao.empresa_diferente_funcionario");
					}
				}
		...
		if ((inserirLeituristaActionForm.getIndicadorAtualizacaoCadastral().equals("2") && 
				(inserirLeituristaActionForm.getIdFuncionario() == null
		...
		// Numero do IMEI
		if(inserirLeituristaActionForm.getNumeroImei() != null && !inserirLeituristaActionForm.getNumeroImei().equals("")){
		...
		String indicadorAtualizacaoCadastral = inserirLeituristaActionForm.getIndicadorAtualizacaoCadastral();
		if(indicadorAtualizacaoCadastral != null && !indicadorAtualizacaoCadastral.trim().equals("")){
			leiturista.setIndicadorAtualizacaoCadastral(new Short(indicadorAtualizacaoCadastral));
		}else{
			leiturista.setIndicadorAtualizacaoCadastral(ConstantesSistema.NAO);
		}
		
		//Endereço MAC
		String enderecoMac = inserirLeituristaActionForm.getNumeroEnderecoMac().replaceAll(":", "");
		if(enderecoMac != null && !enderecoMac.trim().equals("")){
			leiturista.setNumeroEnderecoMac(enderecoMac.toUpperCase());
		}else{			
			leiturista.setNumeroEnderecoMac(null);
		}
		...
		if ( inserirLeituristaActionForm.getLoginUsuario() != null && 
			...
			if (colecaoUsuario != null && !colecaoUsuario.isEmpty()) {
			 ...
			 if(inserirLeituristaActionForm.getIndicadorAtualizacaoCadastral().toString()

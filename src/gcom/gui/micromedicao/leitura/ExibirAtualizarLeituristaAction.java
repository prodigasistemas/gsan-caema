...
//				}
	...
	private void exibirDadosLeiturista(AtualizarLeituristaActionForm form, Leiturista leiturista,HttpSession sessao){
        	...
        	if(leiturista.getNumeroImei() != null && leiturista.getNumeroImei() != 0){        	
        	...
        	if( leiturista.getNumeroEnderecoMac() != null && !leiturista.getNumeroEnderecoMac().equals("")){
        		String enderecoMac = leiturista.getNumeroEnderecoMac();
        		enderecoMac = enderecoMac.substring(0, 2) + ":" + enderecoMac.substring(2, 4) + ":" + enderecoMac.substring(4,6) + ":"
        						+ enderecoMac.substring(6, 8) + ":" + enderecoMac.substring(8, 10) + ":" + enderecoMac.substring(10);
        		form.setNumeroEnderecoMac(enderecoMac);
        	}else{
        		form.setNumeroEnderecoMac("");
        	}

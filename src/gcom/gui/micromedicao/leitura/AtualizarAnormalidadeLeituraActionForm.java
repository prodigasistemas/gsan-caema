...
public class AtualizarAnormalidadeLeituraActionForm extends ValidatorActionForm {
	...
	private String indicadorAnormalidadeImpactaLeitura;
	
	private String idAnormalidadeAtualizar;
	...
	public String getIndicadorAnormalidadeImpactaLeitura() {
		return indicadorAnormalidadeImpactaLeitura;
	}

	public void setIndicadorAnormalidadeImpactaLeitura(
			String indicadorAnormalidadeImpactaLeitura) {
		this.indicadorAnormalidadeImpactaLeitura = indicadorAnormalidadeImpactaLeitura;
	}

	public String getIdAnormalidadeAtualizar() {
		return idAnormalidadeAtualizar;
	}

	public void setIdAnormalidadeAtualizar(String idAnormalidadeAtualizar) {
		this.idAnormalidadeAtualizar = idAnormalidadeAtualizar;
	}

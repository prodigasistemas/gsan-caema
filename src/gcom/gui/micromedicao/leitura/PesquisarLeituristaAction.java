...
public class PesquisarLeituristaAction extends GcomAction {
    ...
    public ActionForward execute(ActionMapping actionMapping,
        ...
        if (httpServletRequest.getParameter("limparForm") != null
            ...
            pesquisarActionForm.setIndicadorAtualizacaoCadastral(""+ConstantesSistema.NAO);
            pesquisarActionForm.setLoginUsuario("");
        }
        
        Integer idUsuario = null;
        if(pesquisarActionForm.getLoginUsuario() != null && !pesquisarActionForm.getLoginUsuario().equals("")){
			FiltroUsuario filtroUsuario = new FiltroUsuario();
			filtroUsuario.adicionarParametro(new ParametroSimples(
					FiltroUsuario.LOGIN, pesquisarActionForm.getLoginUsuario()));
	
			Collection colecaoUsuario = getFachada().pesquisar(filtroUsuario,
					Usuario.class.getName());
	
			if (colecaoUsuario != null && !colecaoUsuario.isEmpty()) {
	
				Usuario usuarioPesquisar = (Usuario) colecaoUsuario.iterator().next();
				idUsuario = usuarioPesquisar.getId();
			}
        }
        ...
        String atualizacaoCadastral = pesquisarActionForm.getIndicadorAtualizacaoCadastral();
        ...
        if(atualizacaoCadastral != null && !atualizacaoCadastral.trim().equals("")) {
        	filtroLeiturista.adicionarParametro(new ParametroSimples(
        			FiltroLeiturista.ATUALIZACAO_CADASTRAL, new Short(atualizacaoCadastral)));
        	peloMenosUmParametroInformado = true;
        }
        
        if(idUsuario != null) {
        	filtroLeiturista.adicionarParametro(new ParametroSimples(
        			FiltroLeiturista.USUARIO_ID,  idUsuario));
        	peloMenosUmParametroInformado = true;
        }

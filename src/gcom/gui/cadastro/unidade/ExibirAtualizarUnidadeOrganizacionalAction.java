    ...
    public ActionForward execute(ActionMapping actionMapping,
        ...
        if (idUnidadeOrganizacional != null && !idUnidadeOrganizacional.equals("")) {         
            ...
            if (unidadeOrganizacional != null && !unidadeOrganizacional.equals("")) {               
                ...
                form.setIdAntigo(formatarResultado(""+unidadeOrganizacional.getId()));
                ...
                //unidade de tramitacao
                if(unidadeOrganizacional.getUnidadeTramitacao() != null && !unidadeOrganizacional.getUnidadeTramitacao().equals("")){
                    form.setIdUnidadeTramitacao(formatarResultado(""+unidadeOrganizacional.getUnidadeTramitacao().getId()));
                    form.setDescricaoUnidadeTramitacao(formatarResultado(unidadeOrganizacional.getUnidadeTramitacao().getDescricao()));
...
//          .............................................................................................
		...
		//Consulta a unidade tramitacao
		consultarUnidadeTramitacao(httpServletRequest, form, fachada);
...
private void consultarUnidadeTramitacao(HttpServletRequest httpServletRequest, AtualizarUnidadeOrganizacionalActionForm form, Fachada fachada) {
		
		String consultaUnidadeTramitacao = (String) httpServletRequest.getParameter("consultaUnidadeTramitacao");
		
		if (consultaUnidadeTramitacao != null
				&& !consultaUnidadeTramitacao.trim().equalsIgnoreCase("")
				&& (Integer.parseInt(consultaUnidadeTramitacao)) == 1) {
			
			// Filtro para obter o Unidade de tramitacao ativo de id informado
			FiltroUnidadeOrganizacional filtroUnidadeOrganizacional = new FiltroUnidadeOrganizacional();

			filtroUnidadeOrganizacional.adicionarParametro(new ParametroSimples(
					FiltroUnidadeOrganizacional.ID, new Integer(form.getIdUnidadeTramitacao()),
							ParametroSimples.CONECTOR_AND));

			// Pesquisa de acordo com os parâmetros informados no filtro
			Collection colecaoUnidadeTramitacao = fachada.pesquisar(
					filtroUnidadeOrganizacional, UnidadeOrganizacional.class.getName());

			// Verifica se a pesquisa retornou algum objeto para a coleção
			if (colecaoUnidadeTramitacao != null && !colecaoUnidadeTramitacao.isEmpty()) {

				// Obtém o objeto da coleção pesquisada
				UnidadeOrganizacional unidadeTramitacao = (UnidadeOrganizacional) Util
						.retonarObjetoDeColecao(colecaoUnidadeTramitacao);

				// Exibe o código e a descrição pesquisa na página
				httpServletRequest.setAttribute("corUnidadeTramitacao", "valor");
				form.setIdUnidadeTramitacao(unidadeTramitacao.getId().toString());
				form.setDescricaoUnidadeTramitacao(unidadeTramitacao.getDescricao());
				httpServletRequest.setAttribute("nomeCampo", "fixo");
			} else {
				// Exibe mensagem de código inexiste e limpa o campo de código
				httpServletRequest.setAttribute("corUnidadeTramitacao","exception");
				form.setIdUnidadeTramitacao("");
				form.setDescricaoUnidadeTramitacao("UNIDADE ORGANIZACIONAL INEXISTENTE");
	...
	private ArrayList controlaColecaoMunicipio(AtualizarUnidadeOrganizacionalActionForm 
        ...
        if ( httpServletRequest.getParameter("desfazer") != null &&
        	...
        	form.setIdUnidadeSuperior("");
        	form.setIdUnidadeTramitacao("");
        	form.setDescricaoUnidadeSuperior("");
        	form.setDescricaoUnidadeTramitacao("");
        	form.setIdMunicipio("");
        	form.setDescricaoMunicipio("");

...
public class InserirUnidadeOrganizacionalAction extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping,
		...
		String codigoUnidade = inserirUnidadeOrganizacionalActionForm.getCodigoUnidade();
		...
		UnidadeOrganizacional unidadeTramitacao = null;
		if(idUnidadeTramitacao != null && !idUnidadeTramitacao.equals("")){
			unidadeTramitacao = this.pesquisarUnidadeOrganizacional(idUnidadeTramitacao);
		}
		...
		UnidadeOrganizacional verificarUnidade = this.pesquisarUnidadeOrganizacional(codigoUnidade);
		...
		unidadeOrganizacional.setUnidadeTramitacao(unidadeTramitacao);

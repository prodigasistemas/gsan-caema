...
//		httpServletRequest.setAttribute("telaSucessoRelatorio",true);
		...
		ArrayList<ImovelSubcategoriaAtualizacaoCadastral> colecaoSubCategoria = (ArrayList<ImovelSubcategoriaAtualizacaoCadastral>) sessao.getAttribute("colecaoSubCategoria");

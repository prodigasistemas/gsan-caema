 ...
 * @date 17/04/2014
 */
public class GerarRelatorioImoveisLigadosParaQuadraSemRedeAction extends ExibidorProcessamentoTarefaRelatorio{
...
//		httpServletRequest.setAttribute("telaSucessoRelatorio",true);
		...
		Collection<DadosImovelRedeAguaEsgotoEmQuadraSemRedeHelper> colecaoImoveisLigadosParaQuadraSemRede =
				fachada.pesquisarImovelRedeAguaEsgotoEmQuadraSemRede(parametros);
		
		if(colecaoImoveisLigadosParaQuadraSemRede != null && !colecaoImoveisLigadosParaQuadraSemRede.isEmpty()){
			
			RelatorioImoveisLigadosParaQuadraSemRede relatorioCpfCnpjInconsistentesImoveisNovos = new RelatorioImoveisLigadosParaQuadraSemRede(
			...
			relatorioCpfCnpjInconsistentesImoveisNovos.addParametro("colecaoImoveisLigadosParaQuadraSemRede", colecaoImoveisLigadosParaQuadraSemRede);
			relatorioCpfCnpjInconsistentesImoveisNovos.addParametro("tipoFormatoRelatorio",	Integer.parseInt(tipoRelatorio));
			relatorioCpfCnpjInconsistentesImoveisNovos.addParametro("parametrosHelper", parametros);

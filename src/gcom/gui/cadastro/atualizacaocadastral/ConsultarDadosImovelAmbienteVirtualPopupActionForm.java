...
public class ConsultarDadosImovelAmbienteVirtualPopupActionForm extends ValidatorActionForm {
	...
	private String alertaTarifaSocial;
	...
	public void limpar(){
		...
		setAlertaTarifaSocial(null);
		setAreaConstruida(null);
		setNumeroMedidorEnergia(null);
		setContratoEnergia(null);
	...
	public String getAlertaTarifaSocial() {
		return alertaTarifaSocial;
	}
	public void setAlertaTarifaSocial(String alertaTarifaSocial) {
		this.alertaTarifaSocial = alertaTarifaSocial;
	}

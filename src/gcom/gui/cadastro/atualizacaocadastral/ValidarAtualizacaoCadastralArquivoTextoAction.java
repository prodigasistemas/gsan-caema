...
public class ValidarAtualizacaoCadastralArquivoTextoAction extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping,
		...
		if(form.getIdsRegistros() != null && form.getIdsRegistros().length > 0){
			...
			if(this.validarSituacao(colecaoArquivoTextoRoteiroDispositivoMovel, SituacaoTransmissaoLeitura.DISPONIVEL)){
			...
			if(this.validarSituacao(colecaoArquivoTextoRoteiroDispositivoMovel, SituacaoTransmissaoLeitura.LIBERADO)){
			...
			if(this.validarSituacao(colecaoArquivoTextoRoteiroDispositivoMovel, SituacaoTransmissaoLeitura.TRANSMITIDO)){
			...
			if(this.validarSituacao(colecaoArquivoTextoRoteiroDispositivoMovel, SituacaoTransmissaoLeitura.EM_CAMPO)){

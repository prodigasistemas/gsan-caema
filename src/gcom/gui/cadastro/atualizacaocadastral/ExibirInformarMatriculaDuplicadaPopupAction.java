...
import gcom.cadastro.atualizacaocadastral.bean.DadosImovelDuplicadoPreGsanHelper;
...
public class ExibirInformarMatriculaDuplicadaPopupAction extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping,
		...
		String idAtualizacaoCadastralDuplicado = httpServletRequest.getParameter("idAtualizacaoCadastralDuplicado");
		form.setMatricula(idAtualizacaoCadastralDuplicado);
		...
		if(colecaoDadosImovelPreGsanHelper != null && !colecaoDadosImovelPreGsanHelper.isEmpty()){
			...
			while ( iteratorHelper.hasNext() ) {
				...
				if ( helper.getIdImovelAtualizacaoCadastral().equals(idAtualizacaoCadastralDuplicado) ) {

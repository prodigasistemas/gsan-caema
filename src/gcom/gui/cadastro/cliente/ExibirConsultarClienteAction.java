...
public class ExibirConsultarClienteAction extends GcomAction {
	...
	private void pesquisarHistoricoCliente(HttpServletRequest httpServletRequest,ConsultarClienteActionForm consultarClienteActionForm){
		...
		Collection colecaoAlteracaoCliente = Fachada.getInstancia().pesquisarUsuarioAlteracaoDasOperacoesEfetuadas(idUsuarioAcao, idOperacoes,
			idUsuario, dataInicial, dataFinal, horaInicial, horaFinal, argumentos, null, null , unidadeNegocio, true);

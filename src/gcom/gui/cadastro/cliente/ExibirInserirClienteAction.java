...
public class ExibirInserirClienteAction extends GcomAction {
    ...
    public ActionForward execute(ActionMapping actionMapping,
		...
		if(httpServletRequest.getParameter("POPUP") != null && httpServletRequest.getParameter("POPUP").equals("true")){
			if(httpServletRequest.getParameter("tipoBotao") == null){
        ...
        if (fachada.verificarPermissaoEspecial(PermissaoEspecial.INSERIR_DEBITO_ORIUNDO_ENTREGA_POSTAL, usuario) == true){
        	clienteActionForm.set("indicadorBloquearDespesasPostais", ConstantesSistema.NAO.toString());
        ...
        if (fachada.verificarPermissaoEspecial(PermissaoEspecial.INSERIR_INDICADOR_BLOQUEIO_IMOVEIS_ASSOCIADOS, usuario) == true){
        	clienteActionForm.set("indicadorBloquearAlterarImoveis", ConstantesSistema.NAO.toString());
...
//        clienteActionForm.set("indicadorVencimentoMesSeguinte", ConstantesSistema.NAO.toString());
        ...
        if(httpServletRequest.getParameter("idClienteVirtual")!=null 
        	...
        	if(clientesVirtual!=null && !clientesVirtual.isEmpty()){
	        	...
	        	clienteActionForm.set("clienteNome", clienteVirtual.getNome());
	        	...
	        	String idClienteVirtual = (String) httpServletRequest.getParameter("idClienteVirtual");

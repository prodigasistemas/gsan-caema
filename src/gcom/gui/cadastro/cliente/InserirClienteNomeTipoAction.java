...
public class InserirClienteNomeTipoAction extends GcomAction {
    ...
    public ActionForward execute(ActionMapping actionMapping,
        ...
        sessao.setAttribute("tipoPessoa", tipoPessoa);
       ...
       /* if(clienteActionForm.get("idCleinte") !=null 
        		&& !clienteActionForm.get("idCleinte").equals("-1")){
        	httpServletRequest.setAttribute("clienteTipo", clienteActionForm.get("idCleinte"));
        }*/

...
public class ExibirManterClienteAction extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping,
		...
		String nomeClienteReceitaFederal =  (String) sessao.getAttribute("clienteNome");;
		String tipoPesquisaNomeCliente =  (String) sessao.getAttribute("tipoPesquisaNomeClienteReceita");

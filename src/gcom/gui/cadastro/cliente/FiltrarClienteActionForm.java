...
public class FiltrarClienteActionForm extends ValidatorForm {
	...
	private String tipoPesquisaNomeClienteReceita;
	...
	/**
	 * @return the nomeClienteReceitaFederal
	 */
	public String getNomeClienteReceitaFederal() {
		return nomeClienteReceitaFederal;
	}
	/**
	 * @param nomeClienteReceitaFederal the nomeClienteReceitaFederal to set
	 */
	...
	/**
	 * @return the tipoPesquisaNomeClienteReceita
	 */
	public String getTipoPesquisaNomeClienteReceita() {
		return tipoPesquisaNomeClienteReceita;
	}
	/**
	 * @param tipoPesquisaNomeClienteReceita the tipoPesquisaNomeClienteReceita to set
	 */
	public void setTipoPesquisaNomeClienteReceita(
			String tipoPesquisaNomeClienteReceita) {
		this.tipoPesquisaNomeClienteReceita = tipoPesquisaNomeClienteReceita;
	}

...
public class ExibirInserirClienteNomeTipoAction extends GcomAction {
    ...
    public ActionForward execute(ActionMapping actionMapping,
	    ...
	    if(httpServletRequest.getAttribute("menu")!=null ){
	    	session.removeAttribute("tipoPessoa");
	    }
	...
	/*	if(httpServletRequest.getAttribute("idCliente") !=null 
        		&& !httpServletRequest.getAttribute("idCliente").equals("-1")){
			clienteActionForm.set("clienteTipo",httpServletRequest.getAttribute("atribitlkv")); 
		}
	*/	
		...
		if (session.getAttribute("tipoPessoa") != null ){
			clienteActionForm.set("tipoPessoa", (Short)session.getAttribute("tipoPessoa"));
		}

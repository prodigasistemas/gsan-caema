...
public class FiltrarClienteAction extends Action {
	...
	public ActionForward execute(ActionMapping actionMapping,
		...
		String nomeClienteReceitaFederal = (String) filtrarClienteActionForm.getNomeClienteReceitaFederal();
		String tipoPesquisaNomeCliente = (String) filtrarClienteActionForm.getTipoPesquisa();
		
		nomeClienteReceitaFederal = nomeClienteReceitaFederal.replace("'", "''");
		nome = nome.replace("'", "''");
		...
		if (nomeClienteReceitaFederal != null && !nomeClienteReceitaFederal.trim().equalsIgnoreCase("")) {
			peloMenosUmParametroInformado = true;
			if (tipoPesquisaNomeCliente != null
					&& tipoPesquisaNomeCliente
							.equals(ConstantesSistema.TIPO_PESQUISA_COMPLETA
									.toString())) {
				filtroCliente.adicionarParametro(new ComparacaoTextoCompleto(
						FiltroCliente.NOME_CLIENTE_RECEITA_FEDERAL, nomeClienteReceitaFederal));
			} else {
				filtroCliente.adicionarParametro(new ComparacaoTexto(
						FiltroCliente.NOME_CLIENTE_RECEITA_FEDERAL, nomeClienteReceitaFederal));
			}
		...
		sessao.setAttribute("nome",(String) filtrarClienteActionForm.getNomeClienteFiltro().replace("'", "''"));
		...
		sessao.setAttribute("clienteNome",(String) filtrarClienteActionForm.getNomeClienteReceitaFederal().replace("'", "''"));
		sessao.setAttribute("tipoPesquisaNomeClienteReceita",(String) filtrarClienteActionForm.getTipoPesquisaNomeClienteReceita());

...
public class PesquisarClienteAction extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping,
		...
		String nomeClienteReceitaFederal = (String) pesquisarActionForm.get("nomeClienteReceitaFederal");
		String tipoPesquisaNomeCliente = (String) pesquisarActionForm.get("tipoPesquisaNomeCliente");
...
//					FiltroCliente.BAIRRO_CODIGO, new Integer(codigoBairro)));
		...
		if (idLogradouro != null && !idLogradouro.trim().equalsIgnoreCase("")) {
			...
			if(idMunicipio != null && !idMunicipio.trim().equalsIgnoreCase("")){
				filtroLogradouro.adicionarParametro(new ParametroSimples(FiltroLogradouro.ID_MUNICIPIO, idMunicipio));
			}
...
//					FiltroCliente.LOGRADOURO, new Integer(idLogradouro)));
		...
		Integer totalRegistros = (Integer) fachada.filtrarQuantidadeCliente(null,
				...
				tipoPesquisa,
				null,
				idTipoCliente.toString(), idEsferaPoder,nomeClienteReceitaFederal, tipoPesquisaNomeCliente);
		...
		Collection clientes = fachada.filtrarCliente(
				...
				(Integer) httpServletRequest
						.getAttribute("numeroPaginasPesquisa"), nomeClienteReceitaFederal, tipoPesquisaNomeCliente);

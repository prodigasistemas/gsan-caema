...
public class AtualizarMunicipioAction extends GcomAction{
	...
	public ActionForward execute(ActionMapping actionMapping,
		...
		if(atualizarMunicipioActionForm.getIdClienteFiltro().trim().equals("")){
		...
		if(!atualizarMunicipioActionForm.getIdClienteFiltro().trim().equals("")){
			...
			this.pesquisarCliente(atualizarMunicipioActionForm.getIdClienteFiltro(),atualizarMunicipioActionForm,fachada,httpServletRequest);

...
public class FiltrarMunicipioAction extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping,
		...
		String logradoroBloqueado = form.getIndicadorLogradouroBloqueado();
		...
		if (logradoroBloqueado != null && !logradoroBloqueado.equalsIgnoreCase("")&& !logradoroBloqueado.equalsIgnoreCase("3")) {
			
			peloMenosUmParametroInformado = true;
			
			if (logradoroBloqueado.equalsIgnoreCase(String.valueOf(ConstantesSistema.INDICADOR_USO_ATIVO))) {
				
				filtroMunicipio.adicionarParametro(new ParametroSimples(FiltroMunicipio.INDICADOR_LOGRADOURO_BLOQUEADO,
						ConstantesSistema.INDICADOR_USO_ATIVO));
			} else {

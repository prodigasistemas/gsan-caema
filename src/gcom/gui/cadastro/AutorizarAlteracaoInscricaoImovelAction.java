	...
	public ActionForward execute(ActionMapping actionMapping,
		...
		Usuario usuario = (Usuario) sessao.getAttribute("usuarioLogado");
	        ...
	        if(helper.getIndicadorSelecionarPorLocalizacaoGeografica().equals("1")){
		        filtroImovelInscricaoAlterada.adicionarParametro(
		        		new ParametroSimplesIn(
		        				FiltroImovelInscricaoAlterada.SETOR_COMERCIAL_ATUAL_ID, helper.getColecaoIdSetorComercial()));
		        filtroImovelInscricaoAlterada.adicionarParametro(
	        	...
	        	filtroImovelInscricaoAlterada.adicionarParametro(
		        		new ParametroSimplesIn(
		        				FiltroImovelInscricaoAlterada.IMOVEL_ID, helper.getColecaoMatriculas()));
	        }
	        ...
	        if ( helper.getIndicadorImovelAlteradoExcluido() != null ) {
	        	filtroImovelInscricaoAlterada.adicionarParametro(
		        		new ParametroSimples(
		        				FiltroImovelInscricaoAlterada.INDICADOR_IMOVEL_EXCLUIDO, helper.getIndicadorImovelAlteradoExcluido()));
			}
	        ...
	        if ( helper.getIndicadorOrigemAtualizacao() != null && !helper.getIndicadorOrigemAtualizacao().equals("")) {
	        	if(helper.getIndicadorOrigemAtualizacao().equals("1")){
	        		...
	        		origens.add(ImovelInscricaoAlterada.DIGITACAO);
	        		origens.add(ImovelInscricaoAlterada.RESETORIZACAO);
	        		origens.add(ImovelInscricaoAlterada.TABLET);
	        		
	        		filtroImovelInscricaoAlterada.adicionarParametro(
			        		new ParametroSimplesIn(
			        				FiltroImovelInscricaoAlterada.CODIGO_ORIGEM, origens));
	        	}
	        }

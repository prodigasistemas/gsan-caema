...
public class FiltrarEmpresaAction extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping,
		...
		String indicadorEmpresaPPP = filtrarEmpresaActionForm.getIndicadorEmpresaPPP();
		...
		//Indicador Empresa PPP
				if(indicadorEmpresaPPP != null && !indicadorEmpresaPPP.trim().equals("")){
					peloMenosUmParametroInformado = true;
					filtroEmpresa.adicionarParametro(new ParametroSimples(
							FiltroEmpresa.INDICADOR_EMPRESA_PPP, indicadorEmpresaPPP));
				}
				else{
					peloMenosUmParametroInformado = true;
				}

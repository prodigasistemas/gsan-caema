...
public class ExibirInserirLocalidadeAction extends GcomAction {
    ...
    public ActionForward unspecified(ActionMapping actionMapping,
        ...
        if (objetoConsulta != null && !objetoConsulta.trim().equalsIgnoreCase("")) {
        	...
        	inserirLocalidadeActionForm.setIndicadorCoordenadaProgisRA("2");
        	inserirLocalidadeActionForm.setIndicadorContratoPpp("2");
        ...
        if (httpServletRequest.getParameter("desfazer") != null && httpServletRequest.getParameter("desfazer").equalsIgnoreCase("S")) {
        	...
        	inserirLocalidadeActionForm.setCentroCustoEsgoto("");
	...
	public ActionForward atualizarListaAbastecimentoSecundario(ActionMapping actionMapping,
		 ...
		 InserirLocalidadeActionForm form = (InserirLocalidadeActionForm) actionForm;

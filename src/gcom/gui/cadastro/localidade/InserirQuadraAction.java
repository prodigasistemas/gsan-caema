...
public class InserirQuadraAction extends GcomAction {
	...
	private InserirQuadraHelper carregarInserirQuadraHelper(InserirQuadraActionForm inserirQuadraActionForm){
		...
		helper.setSubsistemaID(inserirQuadraActionForm.getSubsistemaID());
		...
		if (inserirQuadraActionForm.getBairroID() != null && !inserirQuadraActionForm.getBairroID().equals("")
				&& Util.validarValorNaoNumerico(inserirQuadraActionForm.getBairroID())){

...
public class InserirLocalidadeActionForm extends ActionForm {
    ...
    private String indicadorContratoPpp;
    
    private String idSistemaAbastecimento;
    
    private String[] idsSistemasAbastecimentoSecundários;
	...
	public String getIndicadorContratoPpp() {
		return indicadorContratoPpp;
	}

	public void setIndicadorContratoPpp(String indicadorContratoPpp) {
		this.indicadorContratoPpp = indicadorContratoPpp;
	}
	...
	public String[] getIdsSistemasAbastecimentoSecundários() {
		return idsSistemasAbastecimentoSecundários;
	}

	public void setIdsSistemasAbastecimentoSecundários(
			String[] idsSistemasAbastecimentoSecundários) {
		this.idsSistemasAbastecimentoSecundários = idsSistemasAbastecimentoSecundários;
	}

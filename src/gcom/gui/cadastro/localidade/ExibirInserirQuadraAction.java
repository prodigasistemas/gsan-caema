...
public class ExibirInserirQuadraAction extends GcomAction {
        ...
        if (objetoConsulta != null && !objetoConsulta.trim().equalsIgnoreCase("")) {
            ...
            case 7:
                ...
                if (sistemaEsgotoID != null && !sistemaEsgotoID
                    ...
                    sessao.setAttribute("colecaoSubsistema", colecaoPesquisa);

                } 
                else {
                    
                	inserirQuadraActionForm.setSubsistemaID(String
                    .valueOf(ConstantesSistema.NUMERO_NAO_INFORMADO));
                    
                	sessao.removeAttribute("colecaoSubsistema");
                }
            ...
            case 10:
            	...
            	if(inserirQuadraActionForm.getQuadraNM() != null && !inserirQuadraActionForm.getQuadraNM().equals("")){
            		FiltroSetorComercial filtroSetor = new FiltroSetorComercial();
            		filtroSetor.adicionarParametro(new ParametroSimples(FiltroSetorComercial.ID, inserirQuadraActionForm.getSetorComercialID()));
            		colecaoPesquisa = fachada.pesquisar(filtroSetor, SetorComercial.class.getName());
            		SetorComercial objetoSetorComercial = (SetorComercial) Util
                            .retonarObjetoDeColecao(colecaoPesquisa);
            		int numeroQuadra = new Integer(inserirQuadraActionForm.getQuadraNM());
                    
                    Rota rotaPesquisada = fachada.pesquisarRotaParaEncaixarQuadra(objetoSetorComercial, numeroQuadra);
                    
                    if(rotaPesquisada != null){
                    	inserirQuadraActionForm.setCodigoRota(rotaPesquisada.getCodigo().toString());
                    	inserirQuadraActionForm.setRotaID(rotaPesquisada.getId().toString());
                    	inserirQuadraActionForm.setRotaMensagem(rotaPesquisada.getLeituraTipo().getDescricao());
                    }
            	}
    ...
    private void carregamentoInicialFormulario(Fachada fachada, HttpServletRequest httpServletRequest,
        ...
        if(inserirQuadraActionForm.getIndicadorAtualizacaoCadastral() == null 
        		|| inserirQuadraActionForm.getIndicadorAtualizacaoCadastral().equals("")) {
        	inserirQuadraActionForm.setIndicadorAtualizacaoCadastral("" + ConstantesSistema.NAO);
        }
    ...
    private void desfazer(HttpServletRequest httpServletRequest, HttpSession sessao,
    	...
    	if (httpServletRequest.getParameter("desfazer") != null
            ...
            inserirQuadraActionForm.setSubsistemaID("");

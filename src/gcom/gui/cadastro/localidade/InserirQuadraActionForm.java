...
public class InserirQuadraActionForm extends ActionForm {
    ...
    public String getSubsistemaID() {
		return subsistemaID;
	}

	public void setSubsistemaID(String subsistemaID) {
	...
	public void setIndicadorRelacionamentoQuadraBairro(String indicadorRelacionamentoQuadraBairro) {

...
public class ExibirAtualizarQuadraAction extends GcomAction {
        ...
        if (objetoConsulta != null && !objetoConsulta.trim().equalsIgnoreCase("")) {
            ...
            case 7:
                ...
                if (sistemaEsgotoID != null && !sistemaEsgotoID
                    ...
                    colecaoPesquisa = fachada.pesquisar(filtroSubSistemaEsgoto,
                    ...
                    atualizarQuadraActionForm.setSubsistemaID(String
    ...
    private void exibirQuadra(String quadraID, 
         ...
         filtroQuadra.adicionarCaminhoParaCarregamentoEntidade("subSistemaEsgoto");
         ...
         if (sistemaParametro.getIndicadorQuadraFace().equals(ConstantesSistema.NAO)){
             ...
             //Sistema de esgoto e Subsistema
             if (quadraSelect.getSubSistemaEsgoto() != null) {
                 atualizarQuadraActionForm.setSubsistemaID(String.valueOf(quadraSelect
                         .getSubSistemaEsgoto().getId()));

                 atualizarQuadraActionForm.setSistemaEsgotoID(String
                         .valueOf(quadraSelect.getSubSistemaEsgoto().getSistemaEsgoto()
                                 .getId()));
                 
                 FiltroSubSistemaEsgoto filtroSubSistemaEsgoto = new FiltroSubSistemaEsgoto();
                 filtroSubSistemaEsgoto.adicionarParametro(new ParametroSimples(
                		 FiltroSubSistemaEsgoto.SISTEMA_ESGOTO_ID, quadraSelect.getSubSistemaEsgoto()
                                 .getSistemaEsgoto().getId()));

                 filtroSubSistemaEsgoto.adicionarParametro(new ParametroSimples(
                		 FiltroSubSistemaEsgoto.INDICADOR_USO,
                         ConstantesSistema.INDICADOR_USO_ATIVO));

                 //Retorna uma coleção de subsistemas
                 colecaoPesquisa = fachada.pesquisar(filtroSubSistemaEsgoto, SubSistemaEsgoto.class
                         .getName());

                 sessao.setAttribute("colecaoSubsistema", colecaoPesquisa);
                 atualizarQuadraActionForm.setSistemaEsgotoID(quadraSelect.getSubSistemaEsgoto()
         ...
         if (quadraSelect.getIndicadorAtualizacaoCadastral() != null){
        	 atualizarQuadraActionForm.setIndicadorAtualizacaoCadastral(
        			 String.valueOf(quadraSelect.getIndicadorAtualizacaoCadastral()));
         }

...
public class ExibirPesquisarQuadraAction extends GcomAction {
    ...
    public ActionForward execute(ActionMapping actionMapping,
        ...
        if ( httpServletRequest.getParameter("quadraInicial") != null 
                && !httpServletRequest.getParameter("quadraInicial").trim().equalsIgnoreCase("")){
        	
        	numeroQuadraInicial = (String) httpServletRequest.getParameter("quadraInicial");
        	sessao.setAttribute("numeroQuadraInicial", numeroQuadraInicial);
        }
		...
		if (numeroQuadraInicial != null && !numeroQuadraInicial.trim().equalsIgnoreCase("")) {
			
			filtroQuadra.adicionarParametro(new MaiorQue(FiltroQuadra.NUMERO_QUADRA, new Integer(numeroQuadraInicial)));
		}
		...
		Collection<Quadra> quadras = fachada.pesquisar(filtroQuadra, Quadra.class
				.getName());

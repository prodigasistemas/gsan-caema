...
public class AtualizarLocalidadeAction extends GcomAction {
    ...
    public ActionForward execute(ActionMapping actionMapping,
        ...
        String indicadorContratoPpp = atualizarLocalidadeActionForm.getIndicadorContratoPpp();
        ...
        String indicadorCoordenadaProgisRA = atualizarLocalidadeActionForm.getIndicadorCoordenadaProgisRA();
        Localidade localidadeAlterar = (Localidade) sessao.getAttribute("localidadeManter");
        Collection colecaoPesquisa = null;
        String idSistemaAbastecimento = atualizarLocalidadeActionForm.getIdSistemaAbastecimento();
        String[] idsSistemasAbastecimentoSecundarios = atualizarLocalidadeActionForm.getIdsSistemasAbastecimentoSecundários();
		...
		if(indicadorContratoPpp==null
			...
			localidadeAlterar.setIndicadorContratoPpp(new Short(indicadorContratoPpp));
		}
...
//            			inserirLocalidadeActionForm.getLocalidadeID()));
        ...
        if (indicadorCoordenadaProgisRA != null && !indicadorCoordenadaProgisRA.equals("")){
        	localidadeAlterar.setIndicadorCoordenadaProgisRA(Short.valueOf(indicadorCoordenadaProgisRA));
        }
        ...
        fachada.verificarImovelAssociadoLocalidadeSistemaAbastecimento(localidadeID, idSistemaAbastecimento, idsSistemasAbastecimentoSecundarios);
        ...
        //Removendo os dados de loclaidade sistema abastecimento com a localidade
        this.fachada.removerLocalidadeSistemaAbastecimento(localidadeAlterar.getId());
        ...
        if((idSistemaAbastecimento != null && !idSistemaAbastecimento.equals("-1"))){
			...
			localSisP.setLocalidade(localidadeAlterar);
			localSisP.setSistemaAbastecimento(null);
		...
		if(idsSistemasAbastecimentoSecundarios != null && idsSistemasAbastecimentoSecundarios.length > 0){
			for(String id : idsSistemasAbastecimentoSecundarios){
				if(id != null && !id.equals(ConstantesSistema.NUMERO_NAO_INFORMADO+"")){
					
					sisAb.setId(new Integer(id));
					LocalidadeSistemaAbastecimento localSisS = new LocalidadeSistemaAbastecimento();
					localSisS.setLocalidade(localidadeAlterar);
        ...
        //3.2. Verifica a existência da unidade organizacional para a localidade
        UnidadeOrganizacional unidadeOrganizacional = pesquisarUnidadeOrganizacionalLocalidade(localidadeAlterar.getId());
        
        Integer idUnidade = null;
        
        //3.2.1. Caso não tenha unidade organizacional para a localidade
        if(unidadeOrganizacional == null){
        	
        	//[SB0003] - Inserir Unidade Organizacional
        	unidadeOrganizacional = new UnidadeOrganizacional();
        	UnidadeOrganizacional unidadeSuperior = fachada.pesquisarUnidadeOrganizacionalSuperior(localidadeAlterar.getId());
			...
			if(unidadeSuperior != null){
	        	...
	        	unidadeOrganizacional.setId(new Integer(localidadeAlterar.getId().toString()+"0"));
				...
				unidadeOrganizacional.setLocalidade(localidadeAlterar);
				...
				idUnidade = (Integer)fachada.inserir(unidadeOrganizacional);
				
				retorno = actionMapping.findForward("exibirAtualizarTramitesGrupos");
			}
        }
        else{
        	retorno = actionMapping.findForward("exibirAtualizarTramitesGrupos");
        ...
        httpServletRequest.setAttribute("idLocalidade", localidadeAlterar.getId());
        httpServletRequest.setAttribute("idUnidadeOrganizacional", idUnidade);
    ...
    private UnidadeOrganizacional pesquisarUnidadeOrganizacionalLocalidade(Integer idLocalidade) {
		...
		filtroUnidadeOrganizacional.adicionarParametro(
			new ParametroSimples(FiltroUnidadeOrganizacional.ID_LOCALIDADE, idLocalidade));

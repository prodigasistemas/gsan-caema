...
public class ExibirAtualizarTramitesGruposSolicitacoesAction extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping,
		...
		// Seta o retorno
		ActionForward retorno = actionMapping.findForward("exibirAtualizarTramitesGrupos");
		...
		//Form
		AtualizarTramitesGruposSolicitacoesActionForm form = (AtualizarTramitesGruposSolicitacoesActionForm) actionForm;
		...
		if(httpServletRequest.getParameter("primeiroAcesso") != null && httpServletRequest.getParameter("primeiroAcesso").equals("sim")){
			...
			sessao.removeAttribute("colecaoTramitesGruposSolicitacoesHelperAntiga");
			...
			while(it.hasNext()){
				...
				LocalidadeSolicTipoGrupo localidadeSolicTipoGrupo = fachada.pesquisarLocalidadeSolicTipoGrupo(localidade.getId(),tipoGrupo.getId());
				
				
				if(localidadeSolicTipoGrupo != null)
					helper.setUnidadeOrganizacional(localidadeSolicTipoGrupo.getUnidadeOrganizacional());
				else
			...
			sessao.setAttribute("colecaoTramitesGruposSolicitacoesHelperAntiga", colecaoHelper);
		}

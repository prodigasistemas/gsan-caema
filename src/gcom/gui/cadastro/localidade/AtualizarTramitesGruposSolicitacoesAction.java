...
public class AtualizarTramitesGruposSolicitacoesAction extends GcomAction {
    ...
    public ActionForward execute(ActionMapping actionMapping,
        ...
        Collection colecaoHelperBuscaAntiga = (Collection)sessao.getAttribute("colecaoTramitesGruposSolicitacoesHelperAntiga");
        ...
        atualizarColecaoHelper(colecaoHelperBusca,form.getIdsUnidadeOrganizacional(),form.getDescricoesUnidadeOrganizacional());
	       ...
	       //Excluir os trâmites antigos
	       Iterator remover = colecaoHelperBuscaAntiga.iterator();
	       while(remover.hasNext()){
	    	   
	    	   InserirTramitesGruposSolicitacoesHelper helperRemover = (InserirTramitesGruposSolicitacoesHelper)remover.next();
	    	   
	    	   LocalidadeSolicTipoGrupo localidadeSOlicTipoGr = fachada.pesquisarLocalidadeSolicTipoGrupo(localidade.getId(),helperRemover.getSolicitacaoTipoGrupo().getId());
	    	   /*localidadeSOlicTipoGr.setLocalidade(localidade);
	    	   localidadeSOlicTipoGr.setSolicitacaoTipoGrupo(helperRemover.getSolicitacaoTipoGrupo());
	    	   localidadeSOlicTipoGr.setComp_id(new LocalidadeSolicTipoGrupoPK(localidade.getId(),helperRemover.getSolicitacaoTipoGrupo().getId()));*/
	    	   
	    	   if(localidadeSOlicTipoGr != null)
	    		   fachada.remover(localidadeSOlicTipoGr);
	       ...
	       montarPaginaSucesso(httpServletRequest, "Localidade de código  "
	                + localidade.getId() + "  atualizada com sucesso.",

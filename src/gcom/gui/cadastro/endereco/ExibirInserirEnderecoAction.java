...
public class ExibirInserirEnderecoAction extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping,
		...
		String logradouroId = (String) httpServletRequest.getAttribute("logradouroId");
		String bairroId = (String) httpServletRequest.getAttribute("bairroId");	
		
		if(logradouroId != null && bairroId != null){
			sessao.setAttribute("logradouroBloqueado", "OK");
			sessao.setAttribute("bairroCEPBloqueado", "OK");
		}else if(tipoOperacao != null){
			sessao.removeAttribute("logradouroBloqueado");
			sessao.removeAttribute("bairroCEPBloqueado");
		}
...
//			inserirEnderecoActionForm.setTipoPesquisaTela(tipoPesquisaTela);
		...
		if(logradouroId != null){
			inserirEnderecoActionForm.setLogradouro(logradouroId);
		}
		...
		if (objetoConsulta != null && !objetoConsulta.trim().equals("")) {
			...
			if (exibirEndereco != null && !exibirEndereco.equals("")){
			    ...
			    if (tipoRetorno.trim().equalsIgnoreCase("cliente")) {
			    	...
			    	while (iteratorEnderecos.hasNext()){
			    		...
			    		if (obterTimestampIdObjeto(clienteEndereco) == 
			    			...
			    			inserirEnderecoActionForm, null, bairroId, actionMapping);
				...
				, logradouroJSP, inserirEnderecoActionForm, limparLogradouro, bairroId, actionMapping);
	...
	public Cep carregarValidarEndereco(String pesquisarCep, String pesquisarLogradouro, Fachada fachada,
			...
			InserirEnderecoActionForm inserirEnderecoActionForm, String limparLogradouro, String bairroId,
				...
				if (sessao.getAttribute("colecaoCepSelecionadosUsuario") != null &&
					...
					if (colecaoBairros != null && !colecaoBairros.isEmpty()) {
						...
						if (colecaoBairros.size() == 1){
							...
							inserirEnderecoActionForm.setBairro(bairroId);
						}
					}

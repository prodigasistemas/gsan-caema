...
public class ExibirConsultarImovelAction extends GcomAction {
    ...
    public ActionForward execute(ActionMapping actionMapping,
        ...
        if ( httpServletRequest.getParameter("objetoConsulta") != null && 
        	...
        	statusWizard.setCaminhoActionVoltarFiltro("exibirFiltrarDadosCadastraisImoveisInconsistentesAction.do?objetoConsulta=atualizar");
        	...
        	if ( httpServletRequest.getParameter("idImovel") != null && 
        		...
        		sessao.setAttribute("atualizacaoCadastral", true);
            }
        }

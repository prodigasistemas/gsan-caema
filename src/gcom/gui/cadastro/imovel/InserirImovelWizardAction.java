    ...
    public ActionForward exibirInserirImovelConclusaoAction(
    	...
    	if(!Util.verificarIdNaoVazio(metodo) || !Util.verificaSeNumeroNatural(metodo)){
    		...
    		switch(Integer.parseInt(metodo)){
    			...
    			case 1:
    				 return new ExibirInserirImovelConclusaoAction().atualizarListaSubsistemaAbastecimento(actionMapping,
    			                actionForm, httpServletRequest, httpServletResponse);
    			case 2:
    				return new ExibirInserirImovelConclusaoAction().atualizarListaSetorAbastecimento(actionMapping,
			                actionForm, httpServletRequest, httpServletResponse);
    			case 3:
    				return new ExibirInserirImovelConclusaoAction().atualizarListaDistritoOperacional(actionMapping,
			                actionForm, httpServletRequest, httpServletResponse);
    				
    			case 4:
    				return new ExibirInserirImovelConclusaoAction().atualizarListaAreaOperacional(actionMapping,
			                actionForm, httpServletRequest, httpServletResponse);
    				
    			case 5:
    				return new ExibirInserirImovelConclusaoAction().atualizarListaZonaPressao(actionMapping,
			                actionForm, httpServletRequest, httpServletResponse);	

...
public class ConsultarImovelActionForm extends ValidatorActionForm {
	...
	private String subsistemaEsgotoDadosCadastrais;
	private String indicadorImovelRateioNegativo;
	
	private String indicadorNivelInstalacaoEsgotoDadosCadastrais;
	private String msgImovelAptoSorteioDadosCadastrais;
	...
	private String msgImovelAptoSorteioComplementares;
	...
	private String msgImovelAptoSorteioAnaliseMedicaoConsumo;
	...
	private String indicadorTelemedidoLigacaoAgua;
	private String indicadorTelemedidoPoco;
	...
	private String hidrometroModeloSensor;
	...
	private String motivoCorteAgua;
	...
	private String msgImovelAptoSorteioHistoricoFaturamento;
	...
	private String msgImovelAptoSorteio;
	...
	private String msgImovelAptoSorteioPagamentos;
	...
	private String msgImovelAptoSorteioDevolucoesImovel;
	...
	private String msgImovelAptoSorteioDocumentosCobranca;
	...
	private String msgImovelAptoSorteioParcelamentosDebitos;
	...
	private String msgImovelAptoSorteioRegistroAtendimento;
    
    private String imovIdAnt;
	
  //Dados Gerais da Ordem de Serviço
	...
	public String getSubsistemaEsgotoDadosCadastrais() {
		return subsistemaEsgotoDadosCadastrais;
	}


	public void setSubsistemaEsgotoDadosCadastrais(String subsistemaEsgotoDadosCadastrais) {
		this.subsistemaEsgotoDadosCadastrais = subsistemaEsgotoDadosCadastrais;
	}
	...
	public String getHidrometroModeloSensor() {
		return hidrometroModeloSensor;
	}


	public void setHidrometroModeloSensor(String hidrometroModeloSensor) {
		this.hidrometroModeloSensor = hidrometroModeloSensor;
	}

	public String getIndicadorImovelRateioNegativo() {
		return indicadorImovelRateioNegativo;
	}

	public void setIndicadorImovelRateioNegativo(
			String indicadorImovelRateioNegativo) {
	...
	public String getMotivoCorteAgua() {
		return motivoCorteAgua;
	}

	public void setMotivoCorteAgua(String motivoCorteAgua) {
		this.motivoCorteAgua = motivoCorteAgua;
	}
		

	public String getMsgImovelAptoSorteio() {
		return msgImovelAptoSorteio;
	}


	public void setMsgImovelAptoSorteio(String msgImovelAptoSorteio) {
		this.msgImovelAptoSorteio = msgImovelAptoSorteio;
	}


	public String getMsgImovelAptoSorteioDadosCadastrais() {
		return msgImovelAptoSorteioDadosCadastrais;
	}


	public void setMsgImovelAptoSorteioDadosCadastrais(
			String msgImovelAptoSorteioDadosCadastrais) {
		this.msgImovelAptoSorteioDadosCadastrais = msgImovelAptoSorteioDadosCadastrais;
	}

	public String getMsgImovelAptoSorteioComplementares() {
		return msgImovelAptoSorteioComplementares;
	}


	public void setMsgImovelAptoSorteioComplementares(
			String msgImovelAptoSorteioComplementares) {
		this.msgImovelAptoSorteioComplementares = msgImovelAptoSorteioComplementares;
	}


	public String getMsgImovelAptoSorteioAnaliseMedicaoConsumo() {
		return msgImovelAptoSorteioAnaliseMedicaoConsumo;
	}


	public void setMsgImovelAptoSorteioAnaliseMedicaoConsumo(
			String msgImovelAptoSorteioAnaliseMedicaoConsumo) {
		this.msgImovelAptoSorteioAnaliseMedicaoConsumo = msgImovelAptoSorteioAnaliseMedicaoConsumo;
	}


	public String getMsgImovelAptoSorteioHistoricoFaturamento() {
		return msgImovelAptoSorteioHistoricoFaturamento;
	}


	public void setMsgImovelAptoSorteioHistoricoFaturamento(
			String msgImovelAptoSorteioHistoricoFaturamento) {
		this.msgImovelAptoSorteioHistoricoFaturamento = msgImovelAptoSorteioHistoricoFaturamento;
	}


	public String getMsgImovelAptoSorteioPagamentos() {
		return msgImovelAptoSorteioPagamentos;
	}


	public void setMsgImovelAptoSorteioPagamentos(
			String msgImovelAptoSorteioPagamentos) {
		this.msgImovelAptoSorteioPagamentos = msgImovelAptoSorteioPagamentos;
	}


	public String getMsgImovelAptoSorteioDevolucoesImovel() {
		return msgImovelAptoSorteioDevolucoesImovel;
	}


	public void setMsgImovelAptoSorteioDevolucoesImovel(
			String msgImovelAptoSorteioDevolucoesImovel) {
		this.msgImovelAptoSorteioDevolucoesImovel = msgImovelAptoSorteioDevolucoesImovel;
	}


	public String getMsgImovelAptoSorteioDocumentosCobranca() {
		return msgImovelAptoSorteioDocumentosCobranca;
	}


	public void setMsgImovelAptoSorteioDocumentosCobranca(
			String msgImovelAptoSorteioDocumentosCobranca) {
		this.msgImovelAptoSorteioDocumentosCobranca = msgImovelAptoSorteioDocumentosCobranca;
	}


	public String getMsgImovelAptoSorteioParcelamentosDebitos() {
		return msgImovelAptoSorteioParcelamentosDebitos;
	}


	public void setMsgImovelAptoSorteioParcelamentosDebitos(
			String msgImovelAptoSorteioParcelamentosDebitos) {
		this.msgImovelAptoSorteioParcelamentosDebitos = msgImovelAptoSorteioParcelamentosDebitos;
	}


	public String getMsgImovelAptoSorteioRegistroAtendimento() {
		return msgImovelAptoSorteioRegistroAtendimento;
	}


	public void setMsgImovelAptoSorteioRegistroAtendimento(
			String msgImovelAptoSorteioRegistroAtendimento) {
		this.msgImovelAptoSorteioRegistroAtendimento = msgImovelAptoSorteioRegistroAtendimento;
	}


	/**
	 * Montar o hint que é mostrado ao lado da situação da ligacao de água
	 * 
	 * @author Rafael Pinto
	 * @date 28/02/2012
	 * 
	...
	public String getHint1(){
		...
		String hint1 = null;
		StringBuilder hintMontado = null;
        ...
        if ( imovId != null && !imovId.equals("") ){
        	...
        	Imovel imovel = Fachada.getInstancia().consultarImovelDadosCadastrais(new Integer(imovId));
        	
        	if ( imovel.getLigacaoAguaSituacao() != null && 
				imovel.getLigacaoAguaSituacao().getId().equals(LigacaoAguaSituacao.CORTADO ) ){	
				
				hintMontado = new StringBuilder();
				
				hintMontado.append("Tipo do corte: ");
				String tipoCorte = "-";
				
				if(imovel.getLigacaoAgua() != null && 
					imovel.getLigacaoAgua().getCorteTipo() != null &&
					imovel.getLigacaoAgua().getCorteTipo().getDescricao() != null){
					
					tipoCorte = imovel.getLigacaoAgua().getCorteTipo().getDescricao();
				}
				hintMontado.append(tipoCorte);
				
				hintMontado.append(" <br> Motivo do corte: ");
				String motivoCorte = "-";
				
				if(imovel.getLigacaoAgua() != null &&					
					imovel.getLigacaoAgua().getMotivoCorte() != null &&					
					imovel.getLigacaoAgua().getMotivoCorte().getDescricao() != null ){
					
					motivoCorte = imovel.getLigacaoAgua().getMotivoCorte().getDescricao();
				}
				hintMontado.append(motivoCorte);
				
				hintMontado.append(" <br> Data do corte: ");
				String dataCorte = "-";
	
				if(imovel.getLigacaoAgua() != null && 
					imovel.getLigacaoAgua().getDataCorte() != null){
					
					dataCorte = Util.formatarData(imovel.getLigacaoAgua().getDataCorte());
				}
				hintMontado.append(dataCorte);
				
				hintMontado.append(" <br> Número do selo do corte: ");
				String numeroSeloCorte = "-";
	
				if(imovel.getLigacaoAgua() != null && 
					imovel.getLigacaoAgua().getNumeroSeloCorte() != null){
					
					numeroSeloCorte = imovel.getLigacaoAgua().getNumeroSeloCorte().toString();
				}
				hintMontado.append(numeroSeloCorte);
	
				hintMontado.append("<br>");
				...
				hintMontado.append("Tipo de supressão: ");
				String tipoSupressao = "-";
				
				if(imovel.getLigacaoAgua() != null && 
					imovel.getLigacaoAgua().getSupressaoTipo() != null &&
					imovel.getLigacaoAgua().getSupressaoTipo().getDescricao() != null){
					
					tipoSupressao = imovel.getLigacaoAgua().getSupressaoTipo().getDescricao();
				}
				hintMontado.append(tipoSupressao);
				
				hintMontado.append(" <br> Motivo da supressao: ");
				String motivoSupressao = "-";
				
				if(imovel.getLigacaoAgua() != null &&					
					imovel.getLigacaoAgua().getSupressaoMotivo() != null &&					
					imovel.getLigacaoAgua().getSupressaoMotivo().getDescricao() != null ){
					
					motivoSupressao = imovel.getLigacaoAgua().getSupressaoMotivo().getDescricao();
				}
				hintMontado.append(motivoSupressao);
				
				hintMontado.append(" <br> Data do supressão: ");
				String dataSupressao = "-";
	
				if(imovel.getLigacaoAgua() != null && 
					imovel.getLigacaoAgua().getDataSupressao() != null){
					
					dataSupressao = Util.formatarData(imovel.getLigacaoAgua().getDataSupressao());
				}
				hintMontado.append(dataSupressao);
				
				hintMontado.append(" <br> Número do selo da supressão: ");
				String numeroSeloSupressao = "-";
	
				if(imovel.getLigacaoAgua() != null && 
					imovel.getLigacaoAgua().getNumeroSeloSupressao() != null){
					
					numeroSeloSupressao = imovel.getLigacaoAgua().getNumeroSeloSupressao().toString();
				}
				hintMontado.append(numeroSeloSupressao);
	...
	public String getHoraCadastramento() {
		return horaCadastramento;
	}


	public void setHoraCadastramento(String horaCadastramento) {
		this.horaCadastramento = horaCadastramento;
	}


	public String getIndicadorTelemedidoLigacaoAgua() {
		return indicadorTelemedidoLigacaoAgua;
	}
	public void setIndicadorTelemedidoLigacaoAgua(String indicadorTelemedidoLigacaoAgua) {
		this.indicadorTelemedidoLigacaoAgua = indicadorTelemedidoLigacaoAgua;
	}

	public String getIndicadorTelemedidoPoco() {
		return indicadorTelemedidoPoco;
	}
	public void setIndicadorTelemedidoPoco(String indicadorTelemedidoPoco) {
		this.indicadorTelemedidoPoco = indicadorTelemedidoPoco;
	}
}
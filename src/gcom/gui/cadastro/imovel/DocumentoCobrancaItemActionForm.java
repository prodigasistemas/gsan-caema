...
public class DocumentoCobrancaItemActionForm extends ActionForm {
	...
	private String valorDescontoEfetivo;
	...
	private String codigoSeloCorte;
	...
	public String getValorDescontoEfetivo() {
		return valorDescontoEfetivo;
	}
	public void setValorDescontoEfetivo(String valorDescontoEfetivo) {
		this.valorDescontoEfetivo = valorDescontoEfetivo;
	}
	...
	public String getCodigoSeloCorte() {
		return codigoSeloCorte;
	}
	public void setCodigoSeloCorte(String codigoSeloCorte) {
		this.codigoSeloCorte = codigoSeloCorte;
	}
	public String getHintCorte(){
				
		String hintCorte=" ";
		
		if(this.getSituacaoAguaImovel() != null && this.getSituacaoAguaImovel().equals( "CORTADO" )){
			hintCorte= "Tipo do corte: " + getDescricaoTipoCorte() + "<br>" +
                    "Motivo do corte: " + getDescricaoMotivoCorte() + "<br>" +
                    "Data do corte: " + getDataCorte() + "<br>" +                     
                    "Numero do selo: " + getCodigoSeloCorte() + "<br>";
                    System.out.println(hintCorte);
			return hintCorte;
		} else {

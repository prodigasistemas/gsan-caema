...
public class FiltrarImovelOutrosCriteriosAction extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping,
		...
		if(imovelLocalizacaoFiltrarActionForm.getIndicadorImovelTarifaSocial() != null &&
				!imovelLocalizacaoFiltrarActionForm.getIndicadorImovelTarifaSocial().equals("")){
			
			filtrarImovelOutrosCriteriosHelper.setIndicadorImovelTarifaSocial(
				imovelLocalizacaoFiltrarActionForm.getIndicadorImovelTarifaSocial());			
		}
		...
		filtrarImovelOutrosCriteriosHelper
			.setColecaoSituacaoLigacaoAgua(imovelLocalizacaoFiltrarActionForm
				.getColecaoSituacaoLigacaoAgua() == null ? new String [] {"-1"} 
				: imovelLocalizacaoFiltrarActionForm.getColecaoSituacaoLigacaoAgua());
		
		filtrarImovelOutrosCriteriosHelper
			.setColecaoSituacaoLigacaoEsgoto((imovelLocalizacaoFiltrarActionForm
					.getColecaoSituacaoLigacaoEsgoto() == null ? new String [] {"-1"} 
				: imovelLocalizacaoFiltrarActionForm
					.getColecaoSituacaoLigacaoEsgoto()));
		
		filtrarImovelOutrosCriteriosHelper
			.setColecaoPerfilImovel((imovelLocalizacaoFiltrarActionForm
				.getColecaoPerfilImovel() == null ? new String [] {"-1"} 
				: imovelLocalizacaoFiltrarActionForm
				.getColecaoPerfilImovel()));
		
		filtrarImovelOutrosCriteriosHelper
			.setColecaoCategoriaImovel((imovelLocalizacaoFiltrarActionForm
				.getColecaoCategoriaImovel() == null ? new String [] {"-1"} 
				: imovelLocalizacaoFiltrarActionForm
		...
		String [] colecaoIdSituacaoLigacaoEsgoto = imovelLocalizacaoFiltrarActionForm
						.getColecaoSituacaoLigacaoEsgoto();
		
		// Colecao situacao Ligacao Agua		
		String [] colecaoIdSituacaoLigacaoAgua = imovelLocalizacaoFiltrarActionForm
				.getColecaoSituacaoLigacaoAgua();
		
		// Colecao perfil Imovel ID
		String [] colecaoIdImovelPerfil = imovelLocalizacaoFiltrarActionForm
				.getColecaoPerfilImovel();
				
		// Colecao categoria Imovel ID		
		String [] colecaoIdCategoria = imovelLocalizacaoFiltrarActionForm
				.getColecaoCategoriaImovel();
		...
		// colecao situação ligação de esgoto
		if (colecaoIdSituacaoLigacaoEsgoto != null
				&& !colecaoIdSituacaoLigacaoEsgoto[0].equals("")
				&& ( !colecaoIdSituacaoLigacaoEsgoto[0].trim().equalsIgnoreCase(
						new Integer(ConstantesSistema.NUMERO_NAO_INFORMADO)
								.toString()) || colecaoIdSituacaoLigacaoEsgoto.length >1) ) {
			
			peloMenosUmParametroInformado = true;
		}
		
		// colecao situação ligação de agua
		if (colecaoIdSituacaoLigacaoAgua != null
				&& !colecaoIdSituacaoLigacaoAgua[0].equals("")
				&& ( !colecaoIdSituacaoLigacaoAgua[0].trim().equalsIgnoreCase(
						new Integer(ConstantesSistema.NUMERO_NAO_INFORMADO)
								.toString()) || colecaoIdSituacaoLigacaoAgua.length >1) ) {
			
			peloMenosUmParametroInformado = true;
		}
		
		// Colecao perfil Imovel ID
		if (colecaoIdImovelPerfil != null
				&& !colecaoIdImovelPerfil[0].equals("")
				&& ( !colecaoIdImovelPerfil[0].trim().equalsIgnoreCase(
						new Integer(ConstantesSistema.NUMERO_NAO_INFORMADO)
								.toString()) || colecaoIdImovelPerfil.length >1) ) {
		...
		// Colecao categoria Imovel ID
		if (colecaoIdCategoria != null
				&& !colecaoIdCategoria[0].equals("")
				&& ( !colecaoIdCategoria[0].trim().equalsIgnoreCase(
						new Integer(ConstantesSistema.NUMERO_NAO_INFORMADO)
								.toString()) || colecaoIdCategoria.length >1) ) {

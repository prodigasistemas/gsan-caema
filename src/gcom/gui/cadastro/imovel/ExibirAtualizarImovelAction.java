...
public class ExibirAtualizarImovelAction extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping,
		...
		ActionForward retorno = actionMapping
				.findForward("exibirAtualizarImovelAction");
		...
		if (httpServletRequest.getParameter("desfazer") == null) {
			...
			if (httpServletRequest.getParameter("idRegistroAtualizacao") != null) {
				...
				idImovel = (String) httpServletRequest
					...
					.getParameter("idRegistroTransferencia") != null) {
				idImovel = (String) httpServletRequest
						.getParameter("idRegistroTransferencia");
			}

			FiltroImovel filtroImovel = new FiltroImovel();
			filtroImovel.adicionarParametro(new ParametroSimples(
					FiltroImovel.IMOVEL_PERFIL_CORPORATIVO,
			...
			if (imoveis.size() > 0) {
				...
				boolean possuiPermissaoManterClienteResponsavelImoveisPublicos = fachada
						.verificarPermissaoEspecialAtiva(
								PermissaoEspecial.MANTER_IMOVEL_PERFIL_CORPORATIVO,
								usuarioLogado);
			...
			if (fachada
					.verificarImovelAssociadoClienteBloqueiaAlteracao(new Integer(
							idImovel))) {
				// verificar se o usuário tem permissão especial para manter
				// imóvel
				boolean possuiPermissaoAlterarImoveisAssociados = fachada
						.verificarPermissaoEspecialAtiva(
								PermissaoEspecial.ALTERAR_IMOVEIS_ASSOCIADOS,
								usuarioLogado);
			...
			/*
			 * Verifica se chegou no atualizar imovel através da tela de filtrar
			 * devido a um único registro ou através da lista de imóveis no
			 * manter imovel
			 */
			if (httpServletRequest.getAttribute("atualizar") != null) {

				statusWizard = new StatusWizard("atualizarImovelWizardAction",
						"atualizarImovelAction",
						"cancelarAtualizarImovelAction",
						"exibirFiltrarImovelAction",
						"exibirAtualizarImovelAction.do", idImovel);
		...
		sessao.removeAttribute("pesquisarFotos");
		
		sessao.removeAttribute("colecaoSistemaAbastecimento");
		sessao.removeAttribute("colecaoSubsistemaAbastecimento");
		...
		boolean temPermissao = fachada.verificarPermissaoEspecial(
				PermissaoEspecial.ALTERAR_IMOVEL, usuario);

		if (!temPermissao) {

			fachada.verificarExistenciaRegistroAtendimento(
					new Integer(idImovel),
					"atencao.imovel_existencia_registro_atendimento",
		...
		filtroImovel
				.adicionarCaminhoParaCarregamentoEntidade("ligacaoEsgoto.ligacaoEsgotoEsgotamento");
		filtroImovel
		...
		filtroImovel
				.adicionarCaminhoParaCarregamentoEntidade("subSistemaEsgoto.sistemaEsgoto");
		...
		filtroImovel
				.adicionarCaminhoParaCarregamentoEntidade("imovelTipoConstrucao");
		filtroImovel
				.adicionarCaminhoParaCarregamentoEntidade("imovelTipoCobertura");

		filtroImovel
				.adicionarCaminhoParaCarregamentoEntidade("imovelPrincipal.localidade");
		filtroImovel
				.adicionarCaminhoParaCarregamentoEntidade("imovelPrincipal.quadra");
		filtroImovel
				.adicionarCaminhoParaCarregamentoEntidade("imovelPrincipal.setorComercial");
		filtroImovel
				.adicionarCaminhoParaCarregamentoEntidade("imovelPrincipal.logradouroCep.cep");
		filtroImovel
				.adicionarCaminhoParaCarregamentoEntidade("imovelPrincipal.logradouroCep.logradouro.logradouroTipo");
		filtroImovel
				.adicionarCaminhoParaCarregamentoEntidade("imovelPrincipal.logradouroCep.logradouro.logradouroTitulo");
		filtroImovel
				.adicionarCaminhoParaCarregamentoEntidade("imovelPrincipal.logradouroBairro.bairro.municipio.unidadeFederacao");
		filtroImovel
				.adicionarCaminhoParaCarregamentoEntidade("imovelPrincipal.enderecoReferencia");
		filtroImovel
				.adicionarCaminhoParaCarregamentoEntidade("imovelPrincipal.perimetroInicial.logradouroTipo");
		filtroImovel
				.adicionarCaminhoParaCarregamentoEntidade("imovelPrincipal.perimetroInicial.logradouroTitulo");
		filtroImovel
				.adicionarCaminhoParaCarregamentoEntidade("imovelPrincipal.perimetroFinal.logradouroTipo");
		filtroImovel
				.adicionarCaminhoParaCarregamentoEntidade("imovelPrincipal.perimetroFinal.logradouroTitulo");
		filtroImovel
				.adicionarCaminhoParaCarregamentoEntidade("imovelPrincipal.ligacaoAguaSituacao");
		filtroImovel
				.adicionarCaminhoParaCarregamentoEntidade("imovelPrincipal.ligacaoEsgotoSituacao");
		filtroImovel
				.adicionarCaminhoParaCarregamentoEntidade("imovelPrincipal.imovelPrincipal");
		filtroImovel
				.adicionarCaminhoParaCarregamentoEntidade(FiltroImovel.COLECAO_CLIENTE_IMOVEL);
		filtroImovel
				.adicionarCaminhoParaCarregamentoEntidade(FiltroImovel.ROTA_ENTREGA);
		filtroImovel
				.adicionarCaminhoParaCarregamentoEntidade(FiltroImovel.ROTA_ALTERNATIVA);
		filtroImovel
			.adicionarCaminhoParaCarregamentoEntidade("sistemaAbastecimento");
		filtroImovel
			.adicionarCaminhoParaCarregamentoEntidade("subsistemaAbastecimento");
		filtroImovel
			.adicionarCaminhoParaCarregamentoEntidade("setorAbastecimento");
		filtroImovel
			.adicionarCaminhoParaCarregamentoEntidade("distritoOperacional");
		filtroImovel
			.adicionarCaminhoParaCarregamentoEntidade("areaOperacional");
		filtroImovel
			.adicionarCaminhoParaCarregamentoEntidade("zonaPressao");
		...
		statusWizard.adicionarItemHint("Inscrição:",
				imovel.getInscricaoFormatada());
		statusWizard.adicionarItemHint("Endereço:",
		...
		atualizarImovelActionForm.set(
				"idLocalidade",
				""
						+ Util.adicionarZerosEsquedaNumero(3,
								formatarResultado(imovel.getLocalidade())
										.toString()));
		 ...
		 * (PARM_ICQUADRAFACE = 1 da tabela SISTEMA_PARAMETROS) O campo face da
		 * quadra ficará disponível para atualização;
		 */
		if (sistemaParametro.getIndicadorQuadraFace().equals(
				ConstantesSistema.SIM)
				&& imovel.getQuadraFace() != null) {

			atualizarImovelActionForm.set("idQuadraFace", imovel
					.getQuadraFace().getId().toString());
		} else {
		...
		atualizarImovelActionForm.set(
				"lote",
				""
						+ Util.adicionarZerosEsquedaNumero(4, new Integer(
								imovel.getLote()).toString()));
		...
		atualizarImovelActionForm.set(
				...
				""
						+ Util.adicionarZerosEsquedaNumero(
								3,
								new Short(formatarResultado(""
										+ imovel.getSubLote())).toString()));
		...
		if (imovel.getLogradouroCep().getLogradouro() != null
				&& !imovel.getLogradouroCep().getLogradouro().getId()
						.toString().trim().equalsIgnoreCase("")) {

			atualizarImovelActionForm.set("logradouro", ""
					+ formatarResultado(imovel.getLogradouroCep()
							.getLogradouro()));
		}
		...
		if (imovel.getAreaConstruida() != null) {
			...
			valorAreaConstruida = formatarResultadoDecimalDuasCasas(valorAreaConstruida);
		...
		if (imovel.getVolumeReservatorioInferior() != null) {
			volumeReservatorioInferior = formatarResultado(
					...
					'.', ',');
			volumeReservatorioInferior = formatarResultadoDecimalDuasCasas(volumeReservatorioInferior);
		} else {
			volumeReservatorioInferior = "";
		}

		atualizarImovelActionForm.set("reservatorioInferior",
				volumeReservatorioInferior);
		...
		if (imovel.getVolumeReservatorioSuperior() != null) {
			volumeReservatorioSuperior = formatarResultado(
					...
					'.', ',');
			volumeReservatorioSuperior = formatarResultadoDecimalDuasCasas(volumeReservatorioSuperior);
		...
		atualizarImovelActionForm.set("reservatorioSuperior",
				volumeReservatorioSuperior);
		atualizarImovelActionForm.set(
		...
		if (imovel.getVolumePiscina() != null) {
			voPiscina = formatarResultado(imovel.getVolumePiscina().toString())
					.replace('.', ',');
			voPiscina = formatarResultadoDecimalDuasCasas(voPiscina);
		} else {
			voPiscina = "";
		}
		...
		if (imovel.getIndicadorJardim() != null) {
			atualizarImovelActionForm.set("jardim", imovel.getIndicadorJardim()
					.toString());
		} else {
			atualizarImovelActionForm.set("jardim", "2");
		}

		atualizarImovelActionForm.set("indicadorNivelInstalacaoEsgoto", imovel
				.getIndicadorNivelInstalacaoEsgoto().toString());

		// Quadra de Entrega
		if (imovel.getNumeroQuadraEntrega() != null) {
			atualizarImovelActionForm.set("numeroQuadraEntrega", imovel
					.getNumeroQuadraEntrega().toString());
		} else {
		...
		if (imovel.getNumeroSequencialRota() != null) {
			atualizarImovelActionForm.set("sequencialRota", imovel
		...
		if (imovel.getNumeroSequencialRotaEntrega() != null) {
			atualizarImovelActionForm.set("sequencialRotaEntrega", imovel
					.getNumeroSequencialRotaEntrega().toString());
		} else {
		...
		if (imovel.getRotaEntrega() != null) {
			atualizarImovelActionForm.set("idRota", imovel.getRotaEntrega()
					.getId().toString());
			atualizarImovelActionForm.set("codigoRota", imovel.getRotaEntrega()
					.getCodigo().toString());
		} else {
		...
		if (imovel.getRotaAlternativa() != null) {
			atualizarImovelActionForm.set("idRotaAlternativa", imovel
					.getRotaAlternativa().getId().toString());
			atualizarImovelActionForm.set("codigoRotaAlternativa", imovel
					.getRotaAlternativa().getCodigo().toString());
		} else {
		...
		if (imovel.getFuncionario() != null) {
			atualizarImovelActionForm.set("idFuncionario", imovel
					.getFuncionario().getId().toString());
			atualizarImovelActionForm.set("nomeFuncionario", imovel
		...
		atualizarImovelActionForm.set("faixaPiscina", ""
				+ formatarResultado(imovel.getPiscinaVolumeFaixa()));
		atualizarImovelActionForm.set("pavimentoCalcada", ""
				+ formatarResultado(imovel.getPavimentoCalcada()));
		atualizarImovelActionForm.set("pavimentoRua", ""
				+ formatarResultado(imovel.getPavimentoRua()));
		atualizarImovelActionForm.set("fonteAbastecimento", ""
				+ formatarResultado(imovel.getFonteAbastecimento()));
		atualizarImovelActionForm.set("situacaoLigacaoAgua", ""
				+ formatarResultado(imovel.getLigacaoAguaSituacao()));
		atualizarImovelActionForm.set("situacaoLigacaoEsgoto", ""
				+ formatarResultado(imovel.getLigacaoEsgotoSituacao()));
		atualizarImovelActionForm.set("perfilImovel", ""
				+ formatarResultado(imovel.getImovelPerfil()));

		if (imovel.getPocoTipo() != null) {
			atualizarImovelActionForm.set("poco",
					"" + formatarResultado(imovel.getPocoTipo()));
		} else {
			atualizarImovelActionForm.set("poco", "");
		}
		...
		if (imovel.getDespejo() != null) {
			atualizarImovelActionForm.set("tipoDespejo", ""
					+ formatarResultado(imovel.getDespejo()));
		} else {
			atualizarImovelActionForm.set("tipoDespejo", "");
		}
		...
		if (imovel.getImovelTipoHabitacao() != null) {
			idImovelTipoHabitacao = imovel.getImovelTipoHabitacao().getId()
					.toString();
		}
		if (imovel.getImovelTipoPropriedade() != null) {
			idImovelTipoPropriedade = imovel.getImovelTipoPropriedade().getId()
					.toString();
		}
		if (imovel.getImovelTipoConstrucao() != null) {
			idImovelTipoConstrucao = imovel.getImovelTipoConstrucao().getId()
					.toString();
		}
		if (imovel.getImovelTipoCobertura() != null) {
			idImovelTipoCobertura = imovel.getImovelTipoCobertura().getId()
					.toString();
		}
		if (imovel.getLigacaoEsgoto() != null
				&& imovel.getLigacaoEsgoto().getLigacaoEsgotoEsgotamento() != null) {
			idLigacaoEsgotoEsgotamento = imovel.getLigacaoEsgoto()
					.getLigacaoEsgotoEsgotamento().getId().toString();
		}

		atualizarImovelActionForm.set("imovelTipoHabitacao",
				idImovelTipoHabitacao);
		atualizarImovelActionForm.set("imovelTipoPropriedade",
				idImovelTipoPropriedade);
		atualizarImovelActionForm.set("imovelTipoConstrucao",
				idImovelTipoConstrucao);
		atualizarImovelActionForm.set("imovelTipoCobertura",
				idImovelTipoCobertura);
		atualizarImovelActionForm.set("idLigacaoEsgotoEsgotamento",
		...
		if (imovel.getNumeroCelpe() != null) {
			numeroContratoCelpe = formatarResultado(imovel.getNumeroCelpe()
					.toString());
		} else {
			numeroContratoCelpe = "";
		}
		atualizarImovelActionForm.set("numeroContratoCelpe",
				numeroContratoCelpe);
		...
		atualizarImovelActionForm.set("numeroMedidorEnergia",
				numeroMedidorEnergia);
		...
		if (imovel.getCoordenadaX() != null) {
			coordenadaUtmX = formatarResultado(imovel.getCoordenadaX()
					.toString().replace('.', ','));
		} else {
			coordenadaUtmX = "";
		}
		...
		if (imovel.getCoordenadaY() != null) {
			coordenadaUtmY = formatarResultado(imovel.getCoordenadaY()
					.toString().replace('.', ','));
		} else {
			coordenadaUtmY = "";
		}
		...
		if(imovel.getSistemaAbastecimento() != null){
			atualizarImovelActionForm.set("sistemaAbastecimento", imovel.getSistemaAbastecimento().getId().toString());
		}
		else{
			atualizarImovelActionForm.set("sistemaAbastecimento", null);
		}
		
		if(imovel.getSubsistemaAbastecimento() != null){
			atualizarImovelActionForm.set("subsistemaAbastecimento", imovel.getSubsistemaAbastecimento().getId().toString());
		}
		else{
			atualizarImovelActionForm.set("subsistemaAbastecimento", null);
		}
		
		if(imovel.getSetorAbastecimento() != null){
			atualizarImovelActionForm.set("setorAbastecimento", imovel.getSetorAbastecimento().getId().toString());
		}
		else{
			atualizarImovelActionForm.set("setorAbastecimento", null);
		}
		
		if(imovel.getDistritoOperacional() != null){
			atualizarImovelActionForm.set("distritoOperacional", imovel.getDistritoOperacional().getId().toString());
		}
		else{
			atualizarImovelActionForm.set("distritoOperacional", null);
		}
		
		if(imovel.getAreaOperacional() != null){
			atualizarImovelActionForm.set("areaOperacional", imovel.getAreaOperacional().getId().toString());
		}
		else{
			atualizarImovelActionForm.set("areaOperacional", null);
		}
		
		if(imovel.getZonaPressao() != null){
			atualizarImovelActionForm.set("zonaPressao", imovel.getZonaPressao().getId().toString());
		}
		else{
			atualizarImovelActionForm.set("zonaPressao", null);
		}
		

		/*
		 * Alterado por Raphael Rossiter em 10/09/2007 (Analista: Aryed Lins)
		 * OBJ: Marcar o indicador de emissão de extrato de faturamento, na aba
		 * de conclusão, de acordo com o campo
		 * IndicadorEmissaoExtratoFaturamento da tabela de Imovel
		 */
		if (imovel.getIndicadorEmissaoExtratoFaturamento() != null) {
			atualizarImovelActionForm.set("extratoResponsavel", imovel
					.getIndicadorEmissaoExtratoFaturamento().toString());
		} else {
		...
		if (imovel.getLogradouroCep() != null
				&& imovel.getLogradouroCep().getCep() != null
				&& !imovel.getLogradouroCep().getCep().getCepId().toString()
		...
		if (imovel.getLogradouroCep() != null
				&& imovel.getLogradouroCep().getLogradouro() != null
				&& !imovel.getLogradouroCep().getLogradouro().getId()
						.toString().trim().equalsIgnoreCase("")) {

			logradouroCep.setLogradouro(imovel.getLogradouroCep()
					.getLogradouro());

		}

		if (logradouroCep.getCep() != null
				&& logradouroCep.getLogradouro() != null) {

			logradouroCep = fachada.pesquisarAssociacaoLogradouroCep(
		...
		if (imovel.getLogradouroBairro() != null
			...
			logradouroBairro = fachada.pesquisarAssociacaoLogradouroBairro(
					imovel.getLogradouroBairro().getBairro().getId(),
					logradouroCep.getLogradouro().getId());

		}
		if (imovel.getEnderecoReferencia() != null) {
			imovel_endereco.setEnderecoReferencia(imovel
		...
		if (logradouroBairro != null && logradouroBairro.getBairro() != null
				&& logradouroBairro.getLogradouro() != null) {

			logradouroBairro = fachada.pesquisarAssociacaoLogradouroBairro(
					logradouroBairro.getBairro().getId(), logradouroBairro
							.getLogradouro().getId());
			...
			if (logradouroBairro.getBairro().getMunicipio() != null) {
				imovel_endereco
						...
						.getLogradouro()
						.setMunicipio(
								logradouroBairro.getBairro().getMunicipio());
			}
		}
		...
		// A data de última alteração será utilizada para identificar o endereço
		// do imóvel.
		...
		if (imoveisCliente != null && !imoveisCliente.isEmpty()) {
			...
			while (iteratorClientes.hasNext()) {
				ClienteImovel clienteImovel = (ClienteImovel) iteratorClientes
						.next();
				if (clienteImovel.getClienteRelacaoTipo().getId().intValue() == ClienteRelacaoTipo.USUARIO
						.intValue()) {
					sessao.setAttribute("idClienteImovelUsuario", clienteImovel
							.getCliente().getId());
					atualizarImovelActionForm.set("idClienteImovelUsuario",
							clienteImovel.getCliente().getId().toString());
				} else if (clienteImovel.getClienteRelacaoTipo().getId()
						.intValue() == ClienteRelacaoTipo.RESPONSAVEL
						.intValue()) {
		...
		filtroImovelSubCategoria
				.adicionarCaminhoParaCarregamentoEntidade("comp_id.imovel");
		filtroImovelSubCategoria
				.adicionarCaminhoParaCarregamentoEntidade("imovelEconomias");
		...
		filtroImovelRamoAtividade
				.adicionarCaminhoParaCarregamentoEntidade("comp_id.imovel");
		filtroImovelRamoAtividade
				.adicionarCaminhoParaCarregamentoEntidade("comp_id.ramo_atividade");
		...
		Collection ramosAtividades = fachada.pesquisar(
				filtroImovelRamoAtividade, ImovelRamoAtividade.class.getName());
		...
		if (httpServletRequest.getParameter("promais") != null) {
			sessao.setAttribute("promais",
					httpServletRequest.getParameter("promais"));
			sessao.setAttribute("caminhoVoltarPromais",
					statusWizard.getCaminhoActionVoltarFiltro());
		}
	...
	private String formatarResultadoDecimalDuasCasas(String parametro) {
		if (parametro != null) {
			if(parametro.matches("\\d+\\,\\d{1}")){
				parametro += 0;
			}
			return parametro;
		} else {

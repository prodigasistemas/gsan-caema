...
///		}
		...
		if ( tipoRelatorio!= null && tipoRelatorio.equals("RelatorioImoveis")) {
		...
		}else if (tipoRelatorio!= null && tipoRelatorio.equals("EmitirBoletimCadastro")){
	        ...
	        statusWizard = new StatusWizard(
					...
					"",
	                "",
	                "exibirFiltrarImovelOutrosCriteriosBoletimCadastro.do?menu=sim&gerarRelatorio="+tipoRelatorio+"&limpar=S",
	                "");		
		...
		if(parametroGerarRelatorio != null){
			...
			if(parametroGerarRelatorio.equals("EmitirBoletimCadastro")
					 || parametroGerarRelatorio.equals("RelatorioCadastroConsumidoresInscricao")){
				
				//RM 7960
				//Carlos Chaves 07/11/2012
				//Atributo utilizado para habiltiar a multipla selecao
				//dos campos (Situacao Ligacao Agua e Esgoto),
				// Perfil do imovel, categoria do imovel
				sessao.setAttribute("habilitarCamposComMultiplaSelecao", ConstantesSistema.SIM);
			}
		}

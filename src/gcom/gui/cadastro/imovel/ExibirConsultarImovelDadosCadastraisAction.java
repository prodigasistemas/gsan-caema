...
public class ExibirConsultarImovelDadosCadastraisAction extends GcomAction {
    ...
    public ActionForward execute(ActionMapping actionMapping,
        ...
        if( isLimparDadosTela(httpServletRequest)){
    		...
    		httpServletRequest.removeAttribute("exibirVisualizarCoordenadas");
	...
	private void setarDadosImovelNoFormESessao(ConsultarImovelActionForm consultarImovelActionForm, 
		...
		if(imovel.getIndicadorRateioNegativo() != null){
			if(imovel.getIndicadorRateioNegativo().equals(ConstantesSistema.SIM)){
				consultarImovelActionForm.setIndicadorImovelRateioNegativo("SIM");		
			}else{
				consultarImovelActionForm.setIndicadorImovelRateioNegativo("NÃO");
			}
		} else {
			consultarImovelActionForm.setIndicadorImovelRateioNegativo("");
		}
		...
		if(imovel.getSubSistemaEsgoto() != null){
			consultarImovelActionForm.setSubsistemaEsgotoDadosCadastrais(imovel.getSubSistemaEsgoto().getDescricao());	
		} else {
			consultarImovelActionForm.setSubsistemaEsgotoDadosCadastrais("");
		}
		
		if(imovel.getDataCadastramento() != null){
			consultarImovelActionForm.setDataCadastramento(Util.formatarDataComHora(imovel.getDataCadastramento()));
		} else {
			consultarImovelActionForm.setDataCadastramento("");
		}

		
		httpServletRequest.setAttribute("exibirVisualizarCoordenadas", true);
		...
		if(dataSorteio != null && Util.compararData(dataAtual, dataSorteio) !=  1 && fachada.pesquisarImovelCadastradoSorteio(imovel.getId())) {
			consultarImovelActionForm.setMsgImovelAptoSorteioDadosCadastrais("IMÓVEL INSCRITO NO SORTEIO");
		  	    ...
		  	    (colecaoDebitoImovel.getColecaoContasValoresImovel()== null 
					...
					if(imovel.getLigacaoAguaSituacao().getId().equals(LigacaoAguaSituacao.LIGADO) || 
						...
						if(fachada.verificarImovelAptoSorteio(imovel.getId())){
							consultarImovelActionForm.setMsgImovelAptoSorteioDadosCadastrais("IMÓVEL APTO NÃO INSCRITO NO SORTEIO");
						}else{
							consultarImovelActionForm.setMsgImovelAptoSorteioDadosCadastrais("");
						}
					}else{
						consultarImovelActionForm.setMsgImovelAptoSorteioDadosCadastrais("");
					}
	...
	private void limparFormSessao(ConsultarImovelActionForm consultarImovelActionForm,
		...
		consultarImovelActionForm.setSubsistemaEsgotoDadosCadastrais(null);
		consultarImovelActionForm.setDataCadastramento(null);
		consultarImovelActionForm.setIndicadorImovelRateioNegativo(null);
		...
		consultarImovelActionForm.setMsgImovelAptoSorteioDadosCadastrais(null);

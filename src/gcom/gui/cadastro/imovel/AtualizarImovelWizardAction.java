...
public class AtualizarImovelWizardAction extends WizardAction {
    ...
    public ActionForward exibirAtualizarImovelConclusaoAction(
    	...
    	String metodo = (String)httpServletRequest.getParameter("metodo");
    	
    	if(!Util.verificarIdNaoVazio(metodo) || !Util.verificaSeNumeroNatural(metodo)){
    		...
    		switch(Integer.parseInt(metodo)){
    			...
    			case 1:
    				 return new ExibirAtualizarImovelConclusaoAction().atualizarListaSubsistemaAbastecimento(actionMapping,
    			                actionForm, httpServletRequest, httpServletResponse);
    			case 2:
    				return new ExibirAtualizarImovelConclusaoAction().atualizarListaSetorAbastecimento(actionMapping,
			                actionForm, httpServletRequest, httpServletResponse);
    			case 3:
    				return new ExibirAtualizarImovelConclusaoAction().atualizarListaDistritoOperacional(actionMapping,
			                actionForm, httpServletRequest, httpServletResponse);
    				
    			case 4:
    				return new ExibirAtualizarImovelConclusaoAction().atualizarListaAreaOperacional(actionMapping,
			                actionForm, httpServletRequest, httpServletResponse);
    				
    			case 5:
    				return new ExibirAtualizarImovelConclusaoAction().atualizarListaZonaPressao(actionMapping,
			                actionForm, httpServletRequest, httpServletResponse);	
    				
    			default:
    				return new ExibirAtualizarImovelConclusaoAction().execute(actionMapping,
    		                actionForm, httpServletRequest, httpServletResponse);
    		}

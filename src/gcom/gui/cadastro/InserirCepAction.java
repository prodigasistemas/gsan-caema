...
public class InserirCepAction extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping,
		...
		String descricaoMunicipio = inserirCepActionForm.getMunicipio();
		...
		boolean cepValido = Util.validarCepParaMunicipio(municipioId, codigo);
		if(!cepValido){
			throw new ActionServletException("atencao.cep.invalido.para.municpio", codigo , descricaoMunicipio);
		}

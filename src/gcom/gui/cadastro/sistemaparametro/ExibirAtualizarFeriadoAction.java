...
public class ExibirAtualizarFeriadoAction extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping,
			...
			String indicadorPerene = atualizarFeriadoActionForm.getIndicadorPerene();
			...
			if (tipoFeriado.equals("2")) {
				...
				if ((idMunicipio != null && !idMunicipio.equals(""))&& (httpServletRequest.getParameter("pesquisa") != null &&
					...
					atualizarFeriadoActionForm.setIndicadorPerene(municipioFeriado.getIndicadorPerene().toString());
				...
				atualizarFeriadoActionForm.setIndicadorPerene(nacionalFeriado.getIndicadorPerene().toString());
				
				atualizarFeriadoActionForm.setIdMunicipio(null);
				
				atualizarFeriadoActionForm.setDescricaoMunicipio("");

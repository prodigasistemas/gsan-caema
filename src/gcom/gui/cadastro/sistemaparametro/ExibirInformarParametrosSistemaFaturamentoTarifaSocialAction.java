...
public class ExibirInformarParametrosSistemaFaturamentoTarifaSocialAction extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping,
		...
		if (sessao.getAttribute("FaturamentoTarifaSocial") == null) {
			...
			Collection colecaoContaMotivoRetificacao = null;
			
			FiltroContaMotivoRetificacao filtroContaMotivoRetificacao = new FiltroContaMotivoRetificacao();
			filtroContaMotivoRetificacao
					.setCampoOrderBy(FiltroContaMotivoRetificacao.DESCRICAO);
		
			filtroContaMotivoRetificacao.adicionarParametro(new ParametroSimples(
					FiltroContaMotivoRetificacao.INDICADOR_USO,
					ConstantesSistema.INDICADOR_USO_ATIVO));
		
			colecaoContaMotivoRetificacao = this.getFachada().pesquisar(
					filtroContaMotivoRetificacao,

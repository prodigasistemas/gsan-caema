...
public class InserirFeriadoActionForm extends ValidatorActionForm {
	...
	private String indicadorPerene;
	...
	public String getIndicadorPerene() {
		return indicadorPerene;
	}

	public void setIndicadorPerene(String indicadorPerene) {
		this.indicadorPerene = indicadorPerene;
	}
	...
	public MunicipioFeriado setFormValuesMunicipal(MunicipioFeriado municipioFeriado) {
		...
		municipioFeriado.setIndicadorPerene(Short.parseShort(getIndicadorPerene()));
	...
	public NacionalFeriado setFormValuesNacional(NacionalFeriado nacionalFeriado) {
		...
		nacionalFeriado.setIndicadorPerene(Short.parseShort(getIndicadorPerene()));

...
public class ConsultarParametrosSistemaActionForm extends ActionForm {
	...
	private String diretorGestao;

	private String nomeDiretorGestao;
	...
	private String indicadorDocumentoObrigatorioManterCliente;
	...
	private String clienteUsuarioDesconhecido;
	
	private String nomeClienteUsuarioDesconhecido;
	
	private String dataLimiteCadastroSorteio;
	...
	private String qtdEconomiaContratoDemanda;
	...
	private String qtdDigitosQuadra;
	...
	private String numeroVezesAlterarVinculo;
	
	private String quantidadeMaximaContasItensEspecialFaturamento;
	
	private String qtdDiasDebitoVencidoParaSuspensaoGeracaoDeDoacoes;
	
	private String qtdeContasRetificadas;
	
	private String percentualBonusSocial;
	
	private String indicadorPercentualColetaEsgoto;
	
	private String indicadorDesconsiderarRateioEsgoto;
	
	private String motivoRetificacaoContaPagtoAntecipado;
	
	private String numeroLimiteAlteracoesVencimento;
	...
	private String numeroDiasInserirProcessoCobranca;
	
	private String indicadorControleDividaAtiva;
	
	private String indicadorEmissaoExtratoDebitoNaConsulta;
	
	private String indicadorInclusaoContasCanceladasBoletim;
	
	private String indicadorIncluirContaEmCobranca;
	
	private String numeroDiasVencimentoCobrancaResultado;
	...
	private String numeroDiasBloqueiaSenha;
	
	private String indicadorPermissaoEspecialGrupo;
	
	private String indicadorModuloSeguranca;
	...
	private String indicadorBloqFuncInstalacaoSubtHidrometro;
	
	//RM 5929
			private String consumoAguaFixadoAnormalidadeHidro;
			private String qtdMesIstalSubistituicaoHidro;
			private String qtdVezIncidenciaAnormalidadeHidro;
	
	//RM 5759 
	private String indicadorPermiteCancelarDebito;

	//RM 3892
	private String periodoRevalidarSenha;
	private String diasRevalidarSenha;
	
	//RM 7609
	private String diasAtualizarLigacaoAguaImovelFisc;
		
	private String indicadorTramiteEsgoto;
	
	private String indicadorImprimirExtratoSorteio;
	
	private String faturamentoInicioContratoPPP;
	private String percentualPPP;
	private String quantidadeDiasFaturarFactivel;
	
	private String numeroLimiteOSCobranca;
	
	private String numeroDiasEncerramentoOrdemServicoFactivelFatural;
	...
	public String getDiretorGestao() {
		return diretorGestao;
	}

	public void setDiretorGestao(String diretorGestao) {
		this.diretorGestao = diretorGestao;
	}
	...
	public String getNomeDiretorGestao() {
		return nomeDiretorGestao;
	}

	public void setNomeDiretorGestao(String nomeDiretorGestao) {
		this.nomeDiretorGestao = nomeDiretorGestao;
	}
	...
	public String getQtdEconomiaContratoDemanda() {
		return qtdEconomiaContratoDemanda;
	}

	public void setQtdEconomiaContratoDemanda(String qtdEconomiaContratoDemanda) {
	...
	public String getPeriodoRevalidarSenha() {
		return periodoRevalidarSenha;
	}

	public void setPeriodoRevalidarSenha(String periodoRevalidarSenha) {
		this.periodoRevalidarSenha = periodoRevalidarSenha;
	}

	public String getDiasRevalidarSenha() {
		return diasRevalidarSenha;
	}

	public void setDiasRevalidarSenha(String diasRevalidarSenha) {
		this.diasRevalidarSenha = diasRevalidarSenha;
	}

	public String getClienteUsuarioDesconhecido() {
		return clienteUsuarioDesconhecido;
	}

	public void setClienteUsuarioDesconhecido(String clienteUsuarioDesconhecido) {
		this.clienteUsuarioDesconhecido = clienteUsuarioDesconhecido;
	}

	public String getNomeClienteUsuarioDesconhecido() {
		return nomeClienteUsuarioDesconhecido;
	}

	public void setNomeClienteUsuarioDesconhecido(
			String nomeClienteUsuarioDesconhecido) {
		this.nomeClienteUsuarioDesconhecido = nomeClienteUsuarioDesconhecido;
	}
	
	public String getDiasAtualizarLigacaoAguaImovelFisc() {
		return diasAtualizarLigacaoAguaImovelFisc;
	}

	public void setDiasAtualizarLigacaoAguaImovelFisc(
			String diasAtualizarLigacaoAguaImovelFisc) {
		this.diasAtualizarLigacaoAguaImovelFisc = diasAtualizarLigacaoAguaImovelFisc;
	}

	public String getConsumoAguaFixadoAnormalidadeHidro() {
		return consumoAguaFixadoAnormalidadeHidro;
	}

	public void setConsumoAguaFixadoAnormalidadeHidro(
			String consumoAguaFixadoAnormalidadeHidro) {
		this.consumoAguaFixadoAnormalidadeHidro = consumoAguaFixadoAnormalidadeHidro;
	}

	public String getQtdMesIstalSubistituicaoHidro() {
		return qtdMesIstalSubistituicaoHidro;
	}

	public void setQtdMesIstalSubistituicaoHidro(
			String qtdMesIstalSubistituicaoHidro) {
		this.qtdMesIstalSubistituicaoHidro = qtdMesIstalSubistituicaoHidro;
	}

	public String getQtdVezIncidenciaAnormalidadeHidro() {
		return qtdVezIncidenciaAnormalidadeHidro;
	}

	public void setQtdVezIncidenciaAnormalidadeHidro(
			String qtdVezIncidenciaAnormalidadeHidro) {
		this.qtdVezIncidenciaAnormalidadeHidro = qtdVezIncidenciaAnormalidadeHidro;
	}

	public String getIndicadorBloqFuncInstalacaoSubtHidrometro() {
		return indicadorBloqFuncInstalacaoSubtHidrometro;
	}

	public void setIndicadorBloqFuncInstalacaoSubtHidrometro(
			String indicadorBloqFuncInstalacaoSubtHidrometro) {
		this.indicadorBloqFuncInstalacaoSubtHidrometro = indicadorBloqFuncInstalacaoSubtHidrometro;
	}

	public String getDataLimiteCadastroSorteio() {
		return dataLimiteCadastroSorteio;
	}

	public void setDataLimiteCadastroSorteio(String dataLimiteCadastroSorteio) {
	...
	public String getIndicadorImprimirExtratoSorteio() {
		return indicadorImprimirExtratoSorteio;
	}

	public void setIndicadorImprimirExtratoSorteio(
			String indicadorImprimirExtratoSorteio) {
		this.indicadorImprimirExtratoSorteio = indicadorImprimirExtratoSorteio;
	}

	public String getNumeroVezesAlterarVinculo() {
		return numeroVezesAlterarVinculo;
	}

	public void setNumeroVezesAlterarVinculo(String numeroVezesAlterarVinculo) {
		this.numeroVezesAlterarVinculo = numeroVezesAlterarVinculo;
	}

	public String getNumeroDiasInserirProcessoCobranca() {
		return numeroDiasInserirProcessoCobranca;
	}

	public void setNumeroDiasInserirProcessoCobranca(
			String numeroDiasInserirProcessoCobranca) {
		this.numeroDiasInserirProcessoCobranca = numeroDiasInserirProcessoCobranca;
	}

	public String getQuantidadeMaximaContasItensEspecialFaturamento() {
		return quantidadeMaximaContasItensEspecialFaturamento;
	}

	public void setQuantidadeMaximaContasItensEspecialFaturamento(
			String quantidadeMaximaContasItensEspecialFaturamento) {
		this.quantidadeMaximaContasItensEspecialFaturamento = quantidadeMaximaContasItensEspecialFaturamento;
	}

	public String getPercentualPPP() {
		return percentualPPP;
	}

	public void setPercentualPPP(String percentualPPP) {
		this.percentualPPP = percentualPPP;
	}

	public String getQuantidadeDiasFaturarFactivel() {
		return quantidadeDiasFaturarFactivel;
	}

	public void setQuantidadeDiasFaturarFactivel(
			String quantidadeDiasFaturarFactivel) {
		this.quantidadeDiasFaturarFactivel = quantidadeDiasFaturarFactivel;
	}

	public String getFaturamentoInicioContratoPPP() {
		return faturamentoInicioContratoPPP;
	}

	public void setFaturamentoInicioContratoPPP(String faturamentoInicioContratoPPP) {
		this.faturamentoInicioContratoPPP = faturamentoInicioContratoPPP;
	}

	public String getNumeroDiasEncerramentoOrdemServicoFactivelFatural() {
		return numeroDiasEncerramentoOrdemServicoFactivelFatural;
	}

	public void setNumeroDiasEncerramentoOrdemServicoFactivelFatural(String numeroDiasEncerramentoOrdemServicoFactivelFatural) {
		this.numeroDiasEncerramentoOrdemServicoFactivelFatural = numeroDiasEncerramentoOrdemServicoFactivelFatural;
	}
	...
	public String getNumeroLimiteOSCobranca() {
		return numeroLimiteOSCobranca;
	}

	public void setNumeroLimiteOSCobranca(String numeroLimiteOSCobranca) {
		this.numeroLimiteOSCobranca = numeroLimiteOSCobranca;
	}

	public String getQtdDiasDebitoVencidoParaSuspensaoGeracaoDeDoacoes() {
		return qtdDiasDebitoVencidoParaSuspensaoGeracaoDeDoacoes;
	}

	public void setQtdDiasDebitoVencidoParaSuspensaoGeracaoDeDoacoes(String qtdDiasDebitoVencidoParaSuspensaoGeracaoDeDoacoes) {
		this.qtdDiasDebitoVencidoParaSuspensaoGeracaoDeDoacoes = qtdDiasDebitoVencidoParaSuspensaoGeracaoDeDoacoes;
	}
	
	public String getQtdDigitosQuadra() {
		return qtdDigitosQuadra;
	}

	public void setQtdDigitosQuadra(String qtdDigitosQuadra) {
		this.qtdDigitosQuadra = qtdDigitosQuadra;
	}
	...
	public String getIndicadorDocumentoObrigatorioManterCliente() {
		return indicadorDocumentoObrigatorioManterCliente;
	}

	public void setIndicadorDocumentoObrigatorioManterCliente(String indicadorDocumentoObrigatorioManterCliente) {
	...
	public String getIndicadorPercentualColetaEsgoto() {
		return indicadorPercentualColetaEsgoto;
	}

	public void setIndicadorPercentualColetaEsgoto(
			String indicadorPercentualColetaEsgoto) {
		this.indicadorPercentualColetaEsgoto = indicadorPercentualColetaEsgoto;
	}

	public String getIndicadorDesconsiderarRateioEsgoto() {
		return indicadorDesconsiderarRateioEsgoto;
	}

	public void setIndicadorDesconsiderarRateioEsgoto(
			String indicadorDesconsiderarRateioEsgoto) {
		this.indicadorDesconsiderarRateioEsgoto = indicadorDesconsiderarRateioEsgoto;
	}

	public String getMotivoRetificacaoContaPagtoAntecipado() {
		return motivoRetificacaoContaPagtoAntecipado;
	}

	public void setMotivoRetificacaoContaPagtoAntecipado(
			String motivoRetificacaoContaPagtoAntecipado) {
		this.motivoRetificacaoContaPagtoAntecipado = motivoRetificacaoContaPagtoAntecipado;
	}

	public String getNumeroLimiteAlteracoesVencimento() {
		return numeroLimiteAlteracoesVencimento;
	}

	public void setNumeroLimiteAlteracoesVencimento(
			String numeroLimiteAlteracoesVencimento) {
		this.numeroLimiteAlteracoesVencimento = numeroLimiteAlteracoesVencimento;
	}
	...
	public void setIndicadorControleDividaAtiva(String indicadorControleDividaAtiva) {
		this.indicadorControleDividaAtiva = indicadorControleDividaAtiva;
	}

	public String getIndicadorEmissaoExtratoDebitoNaConsulta() {
		return indicadorEmissaoExtratoDebitoNaConsulta;
	}

	public void setIndicadorEmissaoExtratoDebitoNaConsulta(
			String indicadorEmissaoExtratoDebitoNaConsulta) {
		this.indicadorEmissaoExtratoDebitoNaConsulta = indicadorEmissaoExtratoDebitoNaConsulta;
	}

	public String getIndicadorInclusaoContasCanceladasBoletim() {
		return indicadorInclusaoContasCanceladasBoletim;
	}

	public void setIndicadorInclusaoContasCanceladasBoletim(
			String indicadorInclusaoContasCanceladasBoletim) {
		this.indicadorInclusaoContasCanceladasBoletim = indicadorInclusaoContasCanceladasBoletim;
	}

	public String getIndicadorIncluirContaEmCobranca() {
		return indicadorIncluirContaEmCobranca;
	}

	public void setIndicadorIncluirContaEmCobranca(
			String indicadorIncluirContaEmCobranca) {
		this.indicadorIncluirContaEmCobranca = indicadorIncluirContaEmCobranca;
	}

	public String getNumeroDiasVencimentoCobrancaResultado() {
		return numeroDiasVencimentoCobrancaResultado;
	}

	public void setNumeroDiasVencimentoCobrancaResultado(
			String numeroDiasVencimentoCobrancaResultado) {
	...
	public String getIndicadorTramiteEsgoto() {
		return indicadorTramiteEsgoto;
	}

	public void setIndicadorTramiteEsgoto(String indicadorTramiteEsgoto) {
		this.indicadorTramiteEsgoto = indicadorTramiteEsgoto;
	}	
	...
	public String getNumeroDiasBloqueiaSenha() {
		return numeroDiasBloqueiaSenha;
	}

	public void setNumeroDiasBloqueiaSenha(String numeroDiasBloqueiaSenha) {
		this.numeroDiasBloqueiaSenha = numeroDiasBloqueiaSenha;
	}

	public String getIndicadorPermissaoEspecialGrupo() {
		return indicadorPermissaoEspecialGrupo;
	}

	public void setIndicadorPermissaoEspecialGrupo(
			String indicadorPermissaoEspecialGrupo) {
		this.indicadorPermissaoEspecialGrupo = indicadorPermissaoEspecialGrupo;
	}

	public String getIndicadorModuloSeguranca() {
		return indicadorModuloSeguranca;
	}

	public void setIndicadorModuloSeguranca(String indicadorModuloSeguranca) {
		this.indicadorModuloSeguranca = indicadorModuloSeguranca;
	}

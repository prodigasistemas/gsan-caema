...
public class ConsultarParametrosSistemaAction extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping,
		...
		if (form.getNumeroDiasEncerramentoOrdemServico() != null
				&& !form.getNumeroDiasEncerramentoOrdemServico().trim()
						.equalsIgnoreCase("")) {
		...
		if (form.getNumeroDiasAlteracaoVencimentoPosterior() != null
				&& !form.getNumeroDiasAlteracaoVencimentoPosterior().trim()
						.equalsIgnoreCase("")) {

			sistemaParametro
					.setNumeroDiasAlteracaoVencimentoPosterior(new Short(form
	...
	private void montarSistemaParametro(
		...
		if (validaCampo(form.getClienteUsuarioDesconhecido())) {
			Cliente cliente = new Cliente();
			cliente.setId(new Integer(form.getClienteUsuarioDesconhecido()));
		...
		if (validaCampo(form.getIdClienteResponsavelPrograma())) {
			Cliente cliente = new Cliente();
			cliente.setId(new Integer(form.getIdClienteResponsavelPrograma()));
		...
		// Número dias para validar extrato
		...
		if (validaCampo(form.getIndicadorBloqFuncInstalacaoSubtHidrometro())) {
			sistemaParametro
					.setIndicadorBloqFuncInstalacaoSubtHidrometro(new Short(
							form.getIndicadorBloqFuncInstalacaoSubtHidrometro()));
		}

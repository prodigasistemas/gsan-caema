...
public class FiltroPagamento extends Filtro {
	...
	public final static String DEBITO_A_COBRAR_HISTORICO = "debitoACobrarGeral.debitoACobrarHistorico";
    ...
    public final static String VALOR_EXCEDENTE = "valorExcedente";

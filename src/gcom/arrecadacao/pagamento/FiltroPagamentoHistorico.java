...
public class FiltroPagamentoHistorico extends Filtro {
    ...
    public final static String COBRANCA_DOCUMENTO = "cobrancaDocumentoAgregador";
  
    public final static String ID_COBRANCA_DOCUMENTO = "cobrancaDocumentoAgregador.id";

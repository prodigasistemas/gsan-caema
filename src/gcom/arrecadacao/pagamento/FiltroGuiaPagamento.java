...
public class FiltroGuiaPagamento extends Filtro implements Serializable {
	...
	public final static String DEBITO_TIPO_INDICADOR_USO = "debitoTipo.indicadorUso";
    ...
    public final static String PARCELAMENTO_JUDICIAL_ID = "parcelamentoJudicial.id";

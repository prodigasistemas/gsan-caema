...
public interface IControladorArrecadacao {
	 ...
	 */
	 ...
	 /**
		 ...
		 * @throws ControladorException
		 */
		public void gerarDetalharArrecLiquidaEncerramentoMes(
				int idFuncionalidadeIniciada)	throws ControladorException;		
		 ...
		 * @throws ControladorException
		 */
		public void gerarResumoSIMporMunicipio(Integer idFuncionalidadeIniciada) throws ControladorException;
		...
		public Collection<ArrecadadorMovimentoCriticas> pesquisarArrecadadorMovimentoCriticas(String cdArrecadador, 
			...
			Date periodoProcessamentoFinal, int pagina, boolean comLimite) throws ControladorException;
		...
		public Integer pesquisarArrecadadorMovimentoCriticasCount(String cdArrecadador, 
			String idServico, String nsa, Date periodoGeracaoInicial, Date periodoGeracaoFinal, Date periodoProcessamentoInicial,
			Date periodoProcessamentoFinal) throws ControladorException;
		 ...
		 * @date 18/05/2012
		 */
		public void registrarAutomaticamenteMovimentosArrecadadores(Integer idFuncionalidadeIniciada, Usuario usuario, boolean jaIniciado) throws ControladorException;
		 ...
		 * @date 20/11/2012
		 */
		public void retirarSituacaoEspecialFaturamento(Integer idFuncionalidadeIniciada) throws ControladorException;
		 ...
		 * @date 20/11/2012
		 */
		public Collection<Integer> pesquisarImoveisSuspensoPorInadiplencia() throws ControladorException;
		 ...
		 * @date 20/11/2012
		 */
		public void suspenderSituacaoEspecial(Integer idImovel) throws ControladorException;
		 ...
		 * 
		 */
		public Collection pesquisarPagamentosValorMaiorDocumento(Integer idImovel) throws ControladorException;
		 ...
		 * 
		 */
		public Collection pesquisarDocumentosPagos(String matriculaImovel,
				String tipoDocumento, String referenciaInicial,
				...
				String dataPagamentoFinal)  throws ControladorException;
		 ...
		 * 
		 */
		public boolean enviarEmailTxtMovimentoArrecadadores(
				Collection<MovimentoArrecadadoresPorNSAHelper> colecaoMovimentoArrecadadoresPorNSA,
				String email) throws ControladorException;
		 ...
		 * @throws ControladorException
		 */
		public void gerarDadosDiariosArrecadacaoProcedure(int idFuncionalidadeIniciada)throws ControladorException ;
		 ...
		 * @date 08/04/2013
		 */
		public Collection <MovimentoRoteiroEmpresaFoto> pesquisarFotosAnormalidadeConsumo(Integer idImovel, Integer anoMesReferencia, 
				Integer idTipoMedicao, Integer idConsumoAnormalidade) throws ControladorException;
		
		/**
		 * [UC1214] Informar Acerto Documentos Não Aceitos
		 * 
		 * Pesquisa a guia de pagamento do imóvel informado pelo usuário para parcelamento
		 * 
		 * [FS0009] Verificar existência da guia de pagamento
		 * 
		 * @author Davi Menezes
		 ...
		 * @throws ControladorException 
		 */
		public GuiaPagamentoValoresHelper pesquisarGuiaPagamentoDigitadaParcelamento(String idImovel, 
				String idGuiaPagamento) throws ControladorException;
		
		/**
		 * [UC1214] Informar Acerto Documentos Não Aceitos
		 * 
		 * Pesquisa o débito a cobrar de parcelamento do imóvel informado pelo usuário
		 * 
		 * [FS0012] - Verificar existência do débito.
		 * 
		 * @author Davi Menezes
		 ...
		 * @throws ControladorException
		 */
		public DebitoACobrarValoresHelper pesquisarDebitoACobrarParceladoImovelDigitado(String idImovel,
				String idDebitoACobrar) throws ControladorException;
		 ...
		 * @date 30/10/2013
		 */
		public boolean pesquisarContratoArrecadadorPorArrecadador(Integer idArrecadador, Integer idArrecadadorContrato) throws ControladorException;
}	

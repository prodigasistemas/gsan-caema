...
*/
     ...
     * @throws ErroRepositorioException
     */
    public Collection pesquisarAnoMesArrecadacaoPagamentoMaiorAnoMesArrecadacaoAtual(Integer anoMesArrecadacaoAtual, Integer idLocalidade) throws ErroRepositorioException ;
	...
	public Integer[] pesquisarExistenciaGuiaPagamentoPorLotePagamento(Imovel imovel,
 	 ...
 	 * 
 	 */
 	public ArrecadadorContratoTarifa pesquisarArrecadadorContratoTarifa(Integer idArrecadador,Integer idFormaArrecadacao, Date dataPagamento) throws ErroRepositorioException;
	/**
	...
	*/
	...
	public Collection<Object[]> pesquisarContasNaoPagasContratosDemandasResidencial(
		Integer idLocalidade,Integer idDebitoTipo,Integer idCreditoTipo,Integer anoMesReferenciaArrecadacao, short numeroDiasVencimentoCobranca)
		throws ErroRepositorioException ;
	 ...
	 * @throws ErroRepositorioException
	 */
	public Collection pesquisarClienteGuiaPagamentoECliente(
			Integer idGuiaPagamento) throws ErroRepositorioException;
	 ...
	 * 
	 * Metodo que pesquisa os movimentos de criticas
	 * do arrecadador
	 * 
	 * @author Raimundo Martins
	 * @date 03/05/2012  
	 * */
	public Collection<ArrecadadorMovimentoCriticas> pesquisarArrecadadorMovimentoCriticas(String cdArrecadador, 
		String idServico, String nsa, Date periodoGeracaoInicial, Date periodoGeracaoFinal, Date periodoProcessamentoInicial,
		Date periodoProcessamentoFinal, int pagina, int qtdRegistros, boolean comLimite)	throws ErroRepositorioException;
	
	
	/**
	 * [RM6839]
	 * [UC1343] Detalhar Arrecadação Líquida do Encerramento do Mês
	 * 
	 ...
	 * @throws SQLException 
	 */
	public void gerarDetalharArrecLiquidaEncerramentoMes(Integer amReferencia)
			throws ErroRepositorioException, SQLException;
	
	
	/**
	 * UC1344 - Gerar Resumo SIM por Município
	 * @author Amelia Pessoa
	 * @throws SQLException 
	 * @date 01/06/2012
	 * @throws ControladorException
	 */
	public void gerarResumoSIMporMunicipio(Integer anoMes) throws ErroRepositorioException, SQLException;
	
	/**
	* [UC 0867] Atualizar Pagamentos Contas Em Cobrança 
	* 
	 * Metódo que verifica um pagamento de uma conta
	 * 
	 * @author Raimundo Martins, Raphael Rossiter
	 * @date 05/06/2012, 17/12/2013 
	 * */
	public Pagamento pesquisarPagamentoConta(Integer idConta, Date dataExecucaoComando, Date dataEncerramentoComando, boolean pagamentoParcela) 
			throws ErroRepositorioException ;
	
	/**
	 * [UC 0867] Atualizar Pagamentos Contas Em Cobrança
	 * 
	 * Metódo que verifica um pagamento de uma guia
	 * 
	 * @author Raimundo Martins
	 * @date 05/06/2012 
	 * */
	public Pagamento pesquisarPagamentoGuia(Integer idGuia, Date dataExecucaoComando) throws ErroRepositorioException;
	
	/**
	 * [UC 0867] Atualizar Pagamentos Contas Em Cobrança
	 * 
	 * Metódo que verifica um pagamento de uma conta em pagamento historico
	 * 
	 * @author Raimundo Martins
	 * @date 05/06/2012 
	 * */
	public PagamentoHistorico pesquisarPagamentoHistoricoConta(Integer idConta, Date dataExecucaoComando) throws ErroRepositorioException;
	
	/**
	 * [UC 0867] Atualizar Pagamentos Contas Em Cobrança
	 * 
	 * Metódo que verifica um pagamento de uma guia em pagamento historico
	 * 
	 * @author Raimundo Martins
	 * @date 05/06/2012 
	 * */
	public PagamentoHistorico pesquisarPagamentoHistoricoGuia(Integer idGuia, Date dataExecucaoComando) throws ErroRepositorioException;


	/**
	 * [UC 1332] Consultar Crítica Movimento Arrecadadores
	 * 
	 * Metodo que pesquisa as quantidades de 
	 * movimentos de criticas do arrecadador
	 * 
	 * @author Raimundo Martins
	 * @date 08/05/2012  
	 * */
	public Integer pesquisarArrecadadorMovimentoCriticasCount(String cdArrecadador, 
		String idServico, String nsa, Date periodoGeracaoInicial, Date periodoGeracaoFinal, Date periodoProcessamentoInicial,
		Date periodoProcessamentoFinal) throws ErroRepositorioException;
	
	/**
	 * [UC1331] Registrar Automaticamente Movimento Arrecadadores
	 * [SB0001] Validar Arquivo de Movimento de Arrecadador
	 * 
	 * @author Hugo Azevedo
	 * @date 18/05/2012
	 */
	public ArrecadadorContrato obterSequencialArquivoMovimentoArrecadador(Short codigoAgente) throws ErroRepositorioException;
	
	/**
	 * [UC 0867] Atualizar Pagamentos Contas Em Cobrança
	 * 
	 * Metódo que verifica se um pagamento está 
	 * em uma situação inválida
	 * 
	 * @author Raimundo Martins
	 * @date 23/05/2012 
	 * */
	public Boolean pagamentoSituacaoInvalida(Integer idPagamento) throws ErroRepositorioException;
	
	/**
	* [UC 0867] Atualizar Pagamentos Contas Em Cobrança 
	* 
	* 3.1.1.3. Para cada parcelamento selecionado	o sistema deverá verificar se o débito a cobrar do parcelamento foi pago 
	* 
	* @author Mariana Victor
	* @date 05/07/2012
	* */
	public Collection<Object[]> pesquisarPagamentoDebitoACobrar(Integer idParcelamento, Date dataExecucaoComando) throws ErroRepositorioException;
	 ...
	 * @date 19/07/2012
	 */
	public Collection pesquisarFotoMovimentoRoteiroEmpresa(Integer idRota, Integer anoMesReferencia) throws ErroRepositorioException;
	...
	/**
	 * [UC 1390] Consultar imoveis com SUSPENSAO DO FATURAMENTO POR INADIMPLENCIA
	 *  e com quantidade de contas nao superior a sistemaParamentro.getQuantidadeMaximaContasItensEspecialFaturamento())
	 *  [IT 0001][IT0002]
	 * @author Carlos Chaves
	 * @date 20/11/2012
	 */
	public Collection<Integer> pesquisarImoveisSuspensoPorInadiplencia(Integer quantidadeMaximaContasItensEspecialFaturamento) throws ErroRepositorioException;
	
	
	/**
	 * [UC 1390] [SB0002] - Supender Situacao Especial
	 * @author Carlos Chaves
	 * @date 20/11/2012
	 */
	public void suspenderSituacaoEspecial(Integer idImovel) throws ErroRepositorioException;
	 ...
	 * [SB0039] Verifica Indicadores de Devolução
	 * 
	 * @author Hugo Azevedo
	 * @date 19/11/2012
	 * 
	 */
	public Collection pesquisarPagamentosValorMaiorDocumento(Integer idImovel)  throws ErroRepositorioException;
	 ...
	 * 
	 */
	public Collection pesquisarDocumentosPagosConta(String matriculaImovel,
			String referenciaInicial,
			String referenciaFinal, String dataEmissaoInicial,
			String dataEmissaoFinal, String dataVencimentoInicial,
			String dataVencimentoFinal, String dataPagamentoInicial,
			String dataPagamentoFinal)  throws ErroRepositorioException;
	 ...
	 * 
	 */
	public Collection pesquisarDocumentosPagosGuiaPag(String matriculaImovel,
			String referenciaInicial,
			String referenciaFinal, String dataEmissaoInicial,
			String dataEmissaoFinal, String dataVencimentoInicial,
			String dataVencimentoFinal, String dataPagamentoInicial,
	 ...
	 * 
	 */
	public Collection pesquisarDocumentosPagosDebCob(String matriculaImovel,
			String referenciaInicial,
			String referenciaFinal, String dataEmissaoInicial,
			String dataEmissaoFinal, String dataPagamentoInicial,
			String dataPagamentoFinal)  throws ErroRepositorioException;
	 ...
	 * @throws SQLException 
	 */
	public void gerarDadosDiariosArrecadacaoProcedure() throws ErroRepositorioException, SQLException ;	
	 ...
	 * @date 16/03/2013
	 */
	public Collection<Pagamento> obterPagamentoParcelamentoJudicial(Integer idParcelamento) throws ErroRepositorioException;
	 ...
	 * @date 16/03/2013
	 */
	public Collection<PagamentoHistorico> obterPagamentoHistoricoParcelamentoJudicial(Integer idParcelamento) throws ErroRepositorioException;
	 ...
	 * @date 17/04/2013
	 */
	public void removerClienteGuiaPagamentoParcelamentoJudicial(Integer idParcelamento) throws ErroRepositorioException;
	 ...
	 * @date 17/04/2013
	 */
	public void removerGuiaPagamentoCategoriaParcelamentoJudicial(Integer idParcelamento) throws ErroRepositorioException;
	 ...
	 * @date 17/04/2013
	 */
	public void removerGuiaPagamentoItemCategoriaParcelamentoJudicial(Integer idParcelamento) throws ErroRepositorioException;
	 ...
	 * @date 17/04/2013
	 */
	public void removerGuiaPagamentoItemParcelamentoJudicial(Integer idParcelamento) throws ErroRepositorioException;
	 ...
	 * @date 17/04/2013
	 */
	public Collection<GuiaPagamentoGeral> pesquisarGuiaPagamentoParcelamentoJudicial(Integer idParcelamento) throws ErroRepositorioException;

	
	/**
	 * [ UC0932 ] - Monitorar Leituras Transmitidas
	 * Buscar Imagens Leitura Anormalidades de Consumo
	 * 
	 * @author Davi Menezes
	 * @date 08/04/2013
	 */
	public Collection <MovimentoRoteiroEmpresaFoto> pesquisarFotosAnormalidadeConsumo(Integer idImovel, 
			Integer anoMesReferencia, Integer idTipoMedicao, Integer idConsumoAnormalidade) throws ErroRepositorioException;
	...
	/**
	 * [UC1214] Informar Acertos Documentos Não Aceitos
	 * 
	 * Pesquisar o Código de Barras
	 * 
	 * @author Davi Menezes
	 * @date 17/06/2013
	 */
	public String pesquisarCodigoBarrasPagamento(Integer idArrecadadorMovimentoItem)
			throws ErroRepositorioException;
	 ...
	 * @date 30/10/2013
	 */
	public boolean pesquisarContratoArrecadadorPorArrecadador(Integer idArrecadador, Integer idArrecadadorContrato) 
			throws ErroRepositorioException;

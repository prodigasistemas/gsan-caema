...
public class Processo extends ObjetoGcom {
	...
	public static final int BATCH_ENCERRAR_FATURAMENTO_PARTE_2 = 66;
	...
	public static final int GER_VALOR_VOL_CONS_NAO_FATURADOS = 127;
	...
	public static final int GERAR_RELATORIO_IMOVEIS_CORTADOS = 281;
	
	public static final int ATUALIZAR_DADOS_DOS_IMOVEIS_PELO_RECADASTRAMENTO = 282;
	
	public static final int GERAR_ARQUIVOS_EFD_PIS_CONFINS = 291;

	public static final int GERAR_RELATORIO_RETORNO_OS_FISCALIZACAO = 293;	
	
	public static final int GERAR_RELATORIO_COBRANCA_ATIVIDADE_MANTER = 294;  /** identifier field */
	
	public static final int GERAR_RESUMO_DEVEDORES_DUVIDOSOS_PERDAS_SOCIETARIAS_SIMULACAO = 295;
	
	public static final int GERAR_ARQ_TXT_COD_BARRAS_DOC_COBRANCA = 298;
	
	public static final int GERAR_RELATORIO_DOCUMENTO_COBRANCA = 299;
	
	public static final int GERAR_RELATORIO_ANALISE_FATURAMENTO_POR_PERIODO = 300;
	
	public static final int CONCEDER_CREDITO_CONJUNTO_CONTAS = 302;
	
	public static final int GERAR_ROTEIRO_DISPOSITIVO_MOVEL = 306;

	public static final int UNIFICAR_ID_CLIENTES_COM_MESMO_DOCUMENTO = 307;
	
	public static final int RELATORIO_ANORMALIDADE_IMOVEIS_CORRIGIDOS = 309;
	
	public static final int RELATORIO_ANALISE_IMOVEL = 311;
	
	public static final int GERAR_ORDEM_SERVICO_CONEXAO_ESGOTO = 320;
	
	public static final int GERAR_CARTA_ORDEM_SERVICO_CONEXAO_ESGOTO = 321;
	
	public static final int RELATORIO_IMOVEIS_CARTAS_NAO_IMPRESSAS = 323;
	
	public static final int ENCERRAR_ORDEM_SERVICO_CONEXAO_ESGOTO_CONCLUSAO_SERVICO = 322;
	
	public static final int RELATORIO_SUPRESSOES_RELIGACOES_REESTABELECIMENTOS = 326;

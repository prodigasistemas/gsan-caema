...
public class BatchRegistrarAutomaticamenteMovimentosArrecadadoresMDB
		implements
			MessageDrivenBean,
			MessageListener {
	private static final long serialVersionUID = 1L;

	public BatchRegistrarAutomaticamenteMovimentosArrecadadoresMDB() {
		super();
	}
	...
	public void onMessage(Message message) {
		if (message instanceof ObjectMessage) {
			...
			try {
				this.getControladorArrecadacao().registrarAutomaticamenteMovimentosArrecadadores(

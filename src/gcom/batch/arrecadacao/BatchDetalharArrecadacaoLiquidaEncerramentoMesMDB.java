 ...
 * @date 24/02/2012
 */
public class BatchDetalharArrecadacaoLiquidaEncerramentoMesMDB implements MessageDrivenBean,
		MessageListener {
	
	private static final long serialVersionUID = 1L;

	public BatchDetalharArrecadacaoLiquidaEncerramentoMesMDB() {
		super();
	}
    ...
    public void onMessage(Message message) {
        if (message instanceof ObjectMessage) {
            ...
            try {
				...
				gerarDetalharArrecLiquidaEncerramentoMes((Integer) ((Object[]) objectMessage.getObject())[0]);

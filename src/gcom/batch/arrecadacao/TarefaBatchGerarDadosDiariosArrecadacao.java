...
public class TarefaBatchGerarDadosDiariosArrecadacao extends TarefaBatch {
	...
	public Object executar() throws TarefaException {
		...
		Boolean ehAnoMesMaiorSistemaParametro = 
           	(Boolean) getParametro("ehAnoMesMaiorSistemaParametro"); 
        
		if(ehAnoMesMaiorSistemaParametro != null && ehAnoMesMaiorSistemaParametro.booleanValue()){
	            ...
	            enviarMensagemControladorBatch(
	            	ConstantesJNDI.BATCH_GERAR_DADOS_DIARIOS_ARRECADACAO_MDB,
	                    new Object[] { this.getIdFuncionalidadeIniciada(), 
	                                  Collections.singletonList(idLocalidade),
	                                  ehAnoMesMaiorSistemaParametro}
	                    );
	        }		

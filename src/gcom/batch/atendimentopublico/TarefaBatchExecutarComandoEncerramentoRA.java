...
public class TarefaBatchExecutarComandoEncerramentoRA extends TarefaBatch {
	...
	public Object executar() throws TarefaException {
		...
		Collection<RaEncerramentoComando> colRaEncerramentoComando = (Collection<RaEncerramentoComando>) getParametro("colRaEncerramentoComando");
		...
		while (iterator.hasNext()) {
			...
			enviarMensagemControladorBatch(
					...
					new Object[]{colRaEncerramentoComando,

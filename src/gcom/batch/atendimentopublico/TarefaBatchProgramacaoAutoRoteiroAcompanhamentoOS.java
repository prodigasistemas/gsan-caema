...
public class TarefaBatchProgramacaoAutoRoteiroAcompanhamentoOS extends TarefaBatch {
	...
	public Object executar() throws TarefaException {
			...
			Collection unidadesOrganizacionais = (Collection) getParametro(ConstantesSistema.COLECAO_UNIDADES_PROCESSAMENTO_BATCH);
			Date dataAtual = (Date) getParametro("dataAtual");

			Iterator iterator = unidadesOrganizacionais.iterator();
			...
			while (iterator.hasNext()) {
				...
				enviarMensagemControladorBatch(
						...
						new Object[]{unidadeOrganizacional,

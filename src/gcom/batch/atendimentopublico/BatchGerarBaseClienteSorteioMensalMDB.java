 ...
 * @created 18/10/2012
 */
public class BatchGerarBaseClienteSorteioMensalMDB  implements MessageDrivenBean,
		MessageListener {

	private static final long serialVersionUID = 1L;

	public BatchGerarBaseClienteSorteioMensalMDB() {
		super();
	}
		...
		if (message instanceof ObjectMessage) {
			...
			try {
				...
				this.getControladorAtendimentoPublico().
					gerarBaseClienteSorteioMensal((Integer) ((Object[]) objectMessage.getObject())[0],(Integer) ((Object[]) objectMessage.getObject())[1]);

...
public class BatchEncerrarOrdemServicoConexaoEsgotoConclusaoServico implements
MessageDrivenBean, MessageListener {
	...
	public BatchEncerrarOrdemServicoConexaoEsgotoConclusaoServico() {
		super();
	}
		 ...
		 if (message instanceof ObjectMessage) {
			ObjectMessage objectMessage = (ObjectMessage) message;
	            try {
	            	...
	            	this.getControladorOrdemServico().encerrarOrdemServicoConexaoEsgotoConclusaoServico(

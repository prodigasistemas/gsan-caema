...
public class TarefaBatchGerarDadosArquivoAcompanhamentoServico extends TarefaBatch {
	...
	public Object executar() throws TarefaException {
		...
		Collection colecaoUnidadesOrganizacional = (Collection) getParametro(ConstantesSistema.COLECAO_UNIDADES_PROCESSAMENTO_BATCH);
		Date dataRoteiro = (Date) getParametro("dataAtual");		

		Iterator iterator = colecaoUnidadesOrganizacional.iterator();
        
        while (iterator.hasNext()) {
        	UnidadeOrganizacional unidadeOrganizacional = (UnidadeOrganizacional) iterator.next();
            enviarMensagemControladorBatch(
                    ConstantesJNDI.BATCH_GERAR_DADOS_ARQUIVO_ACOMPANHAMENTO_SERVICO_MDB,
                    new Object[] { this.getIdFuncionalidadeIniciada(),unidadeOrganizacional, dataRoteiro });

 ...
 * @created 28/12/2012
 */
public class TarefaBatchGerarResumoConsumoAguaBD extends TarefaBatch {
	
	private static final long serialVersionUID = 1L;

	public TarefaBatchGerarResumoConsumoAguaBD(Usuario usuario,
	...
	@Deprecated
	public TarefaBatchGerarResumoConsumoAguaBD() {
		super(null, 0);
	}
	...
	public Object executar() throws TarefaException {
		...
		enviarMensagemControladorBatch(
				ConstantesJNDI.BATCH_GERAR_RESUMO_CONSUMO_AGUA_BD,
				new Object[]{
	...
	public void agendarTarefaBatch() {
		AgendadorTarefas.agendarTarefa("BatchGerarResumoConsumoAguaBDMDB",
				this);
	}

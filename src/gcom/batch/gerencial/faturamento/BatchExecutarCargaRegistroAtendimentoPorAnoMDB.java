 ...
 * @date 30/04/2012
 */
public class BatchExecutarCargaRegistroAtendimentoPorAnoMDB implements MessageDrivenBean, MessageListener {
		...
		if (message instanceof ObjectMessage) {
			...
			try {
				this.getControladorGerencialFaturamento()
					.executarCargaRegistroAtendimentoPorAno((Integer) ((Object[]) objectMessage.getObject())[0]);

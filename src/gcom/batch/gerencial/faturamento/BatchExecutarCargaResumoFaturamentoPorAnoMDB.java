 ...
 * @date 30/04/2012
 */
public class BatchExecutarCargaResumoFaturamentoPorAnoMDB implements MessageDrivenBean, MessageListener {
		...
		if (message instanceof ObjectMessage) {
			...
			try {
				this.getControladorGerencialFaturamento()
					.executarCargaResumoFaturamentoPorAno((Integer) ((Object[]) objectMessage.getObject())[0]);

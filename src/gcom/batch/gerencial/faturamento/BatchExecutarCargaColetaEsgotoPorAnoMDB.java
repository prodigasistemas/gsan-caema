 ...
 * @date 30/04/2012
 */
public class BatchExecutarCargaColetaEsgotoPorAnoMDB implements MessageDrivenBean, MessageListener {
		...
		if (message instanceof ObjectMessage) {
			...
			try {
				this.getControladorGerencialFaturamento()
					.executarCargaColetaEsgotoPorAno((Integer) ((Object[]) objectMessage.getObject())[0]);

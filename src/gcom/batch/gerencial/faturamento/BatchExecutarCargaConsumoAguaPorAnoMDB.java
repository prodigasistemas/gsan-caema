 ...
 * @date 02/05/2012
 */
public class BatchExecutarCargaConsumoAguaPorAnoMDB implements MessageDrivenBean, MessageListener {
		...
		if (message instanceof ObjectMessage) {
			...
			try {
				this.getControladorGerencialFaturamento()
					.executarCargaConsumoAguaPorAno((Integer) ((Object[]) objectMessage.getObject())[0]);

 ...
 * @date 02/05/2012
 */
public class BatchExecutarCargaIndicadoresDesempenhoMicromedicaoVariosAnosMDB implements MessageDrivenBean, MessageListener {
		...
		if (message instanceof ObjectMessage) {
			...
			try {
				this.getControladorGerencialFaturamento()
					.executarCargaIndicadoresDesempenhoMicromedicaoVariosAnos((Integer) ((Object[]) objectMessage.getObject())[0]);

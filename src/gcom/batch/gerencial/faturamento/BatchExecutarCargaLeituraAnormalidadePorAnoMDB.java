 ...
 * @date 02/05/2012
 */
public class BatchExecutarCargaLeituraAnormalidadePorAnoMDB implements MessageDrivenBean, MessageListener {
		...
		if (message instanceof ObjectMessage) {
			...
			try {
				this.getControladorGerencialFaturamento()
					.executarCargaLeituraAnormalidadePorAno((Integer) ((Object[]) objectMessage.getObject())[0]);

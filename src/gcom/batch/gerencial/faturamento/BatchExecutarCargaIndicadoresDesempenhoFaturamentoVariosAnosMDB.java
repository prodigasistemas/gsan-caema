 ...
 * @date 30/04/2012
 */
public class BatchExecutarCargaIndicadoresDesempenhoFaturamentoVariosAnosMDB implements MessageDrivenBean, MessageListener {
		...
		if (message instanceof ObjectMessage) {
			...
			try {
				this.getControladorGerencialFaturamento()
					.executarCargaIndicadoresDesempenhoFaturamentoVariosAnos((Integer) ((Object[]) objectMessage.getObject())[0]);

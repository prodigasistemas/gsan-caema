 ...
 * @date 30/04/2012
 */
public class BatchExecutarCargaIndicadoresDesempenhoFaturamentoPorAnoMDB implements MessageDrivenBean, MessageListener {
		...
		if (message instanceof ObjectMessage) {
			...
			try {
				this.getControladorGerencialFaturamento()
					.executarCargaIndicadoresDesempenhoFaturamentoPorAno((Integer) ((Object[]) objectMessage.getObject())[0]);

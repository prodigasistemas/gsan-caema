 ...
 * @date 02/05/2012
 */
public class BatchExecutarCargaIndicadoresDesempenhoMicromedicaoPorAnoMDB implements MessageDrivenBean, MessageListener {
		...
		if (message instanceof ObjectMessage) {
			...
			try {
				this.getControladorGerencialFaturamento()
					.executarCargaIndicadoresDesempenhoMicromedicaoPorAno((Integer) ((Object[]) objectMessage.getObject())[0]);

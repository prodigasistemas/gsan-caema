...
public class Relatorio implements Serializable {
	...
	public static final int IMOVEIS_RATEIO_NEGATIVO = 217;
	
	public static final int RELATORIO_IMOVEIS_CORTADOS = 218;
	
	public static final int RELATORIO_RETORNO_OS_FISCALIZACAO = 219;
	
	public static final int RELATORIO_COBRANCA_ATIVIDADE_MANTER = 220;
	
	public static final int RELATORIO_ANALISE_FATURAMENTO_PERIODO = 221;
	
	public static final int RELATORIO_IMPOSTOS_CLIENTE_RESPONSAVEL = 223;
	
	public static final int RELATORIO_CLIENTES_MESMO_CPF_CNPJ = 224;
	
	public static final int RELATORIO_ANORMALIDADE_IMOVEIS_CORRIGIDOS = 225;
	
	public static final int RELATORIO_VALIDAR_CLIENTE_RECEITA_FEDERAL = 227;
	
	public static final int RELATORIO_EMITIR_RESUMO_PARCELAMENTO_JUDICIAL = 228;
	
	public static final int RELATORIO_RESUMO_FATURAMENTO_PPP = 229;
	
	public static final int RELATORIO_FATURAMENTO_PPP = 231;
	
	public static final int RELATORIO_RESUMO_IMOVEIS_ALTERACAO_INSCRICAO_VIA_BATCH = 234;
	
	public static final int RELATORIO_ORDEM_SERVICO_CONEXAO_ESGOTO_BATCH = 235;
	
	public static final int RELATORIO_IMOVEIS_CARTAS_NAO_IMPRESSAS = 237;
	
	public static final int RELATORIO_RESUMO_ACOES_ORDEM_SERVICO = 238;
	
	public static final int RELATORIO_SUPRESSOES_RELIGACOES_REESTABELECIMENTOS = 239;
	
	public static final int RELATORIO_PAGAMENTOS_ABASTECIMENTOS_CARROS_PIPA = 240;
	
	public static final int RELATORIO_MANTER_SUBSISTEMA_ABASTECIMENTO = 242;
	
	public static final int RELATORIO_MANTER_AREA_OPERACIONAL = 243;

 ...
 * @created 04/06/2012
 */
public class BatchEncerrarAutomaticamenteComandosCobResultadoMDB implements MessageDrivenBean,
		MessageListener {
	
	private static final long serialVersionUID = 1L;

	public BatchEncerrarAutomaticamenteComandosCobResultadoMDB() {
		super();
	}
        ...
        if (message instanceof ObjectMessage) {
            ...
            try {
				...
				this.getControladorCobranca().
						encerrarAutomaticamenteComandosCobResultado(

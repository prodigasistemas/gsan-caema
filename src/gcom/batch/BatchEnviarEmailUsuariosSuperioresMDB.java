 ...
 * @date 26/01/2012
 */
public class BatchEnviarEmailUsuariosSuperioresMDB implements MessageDrivenBean,
		MessageListener {
	
	private static final long serialVersionUID = 1L;

	public BatchEnviarEmailUsuariosSuperioresMDB() {
		super();
	}
    ...
    public void onMessage(Message message) {
        if (message instanceof ObjectMessage) {
            ...
            try {
				...
				this.getControladorAcessoLocal().
				enviarEmailUsuariosSuperiores((Integer) ((Object[]) objectMessage.getObject())[0]);
	 ...
	 */
	private ControladorAcessoLocal getControladorAcessoLocal() {

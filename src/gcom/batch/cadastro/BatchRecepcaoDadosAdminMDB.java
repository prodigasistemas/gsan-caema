 ...
 * @created 18/04/2012
 */
public class BatchRecepcaoDadosAdminMDB implements MessageDrivenBean,
		MessageListener {
	
	private static final long serialVersionUID = 1L;

	public BatchRecepcaoDadosAdminMDB() {
		super();
	}
    ...
    public void onMessage(Message message) {
        if (message instanceof ObjectMessage) {
            ...
            try {
                this
                        .getControladorIntegracao().recepcaoDadosAdmin((Integer) ((Object[]) objectMessage.getObject())[0]);

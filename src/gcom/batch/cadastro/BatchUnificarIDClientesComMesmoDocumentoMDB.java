 ...
 * @date 19/01/2013
 */
public class BatchUnificarIDClientesComMesmoDocumentoMDB implements
	MessageDrivenBean,
	MessageListener{

	private static final long serialVersionUID = 1L;

	public BatchUnificarIDClientesComMesmoDocumentoMDB() {
		super();
	}
		...
		if (message instanceof ObjectMessage) {
			...
			try {
				...
				this.getControladorCadastro().
					unificarIDClientesComMesmoDocumento(

 ...
 * @created 18/04/2012
 */
public class BatchInserirDadosAdminMDB implements MessageDrivenBean,
		MessageListener {
	
	private static final long serialVersionUID = 1L;

	public BatchInserirDadosAdminMDB() {
		super();
	}
    ...
    public void onMessage(Message message) {
        if (message instanceof ObjectMessage) {
            ...
            try {
                this.getControladorIntegracao().inserirDadosAdmin((Integer) ((Object[]) objectMessage.getObject())[0], 

 ...
 * @created 18/04/2012
 */
public class BatchAtualizarTabelasBasicasRecepcaoDadosAdminMDB implements MessageDrivenBean,
		MessageListener {
	
	private static final long serialVersionUID = 1L;

	public BatchAtualizarTabelasBasicasRecepcaoDadosAdminMDB() {
		super();
	}
    ...
    public void onMessage(Message message) {
        if (message instanceof ObjectMessage) {
            ...
            try {
                this
                        .getControladorIntegracao().atualizarTabelasBasicasRecepcaoDadosAdmin((Integer) ((Object[]) objectMessage.getObject())[0]);

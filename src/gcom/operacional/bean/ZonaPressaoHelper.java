...
public class ZonaPressaoHelper implements Serializable {

	private static final long serialVersionUID = 1L;
	
	private Integer idZonaPressao;
	...
	public ZonaPressaoHelper() {
	}

	public Integer getIdZonaPressao() {
		return idZonaPressao;
	}

	public void setIdZonaPressao(Integer idZonaPressao) {
		this.idZonaPressao = idZonaPressao;
	}

	public String getDescricaoZonaPressao() {
		return descricaoZonaPressao;
	}
	...
	public void setDescricaoAbreviada(

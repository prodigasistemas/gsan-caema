...
public class SubsistemaSistemaAbastecimento implements Serializable {
    ...
    public SubsistemaSistemaAbastecimento(){}

	public SubsistemaSistemaAbastecimento(
			Short indicadorPrincipal, Date ultimaAlteracao, SubsistemaAbastecimento subsistemaAbastecimento,
			SistemaAbastecimento sistemaAbastecimento) {
		super();
	...
	public void setSubsistemaAbastecimento(SubsistemaAbastecimento subsistemaAbastecimento) {
		this.subsistemaAbastecimento = subsistemaAbastecimento;
	}

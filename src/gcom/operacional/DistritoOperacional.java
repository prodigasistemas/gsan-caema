...
public class DistritoOperacional extends ObjetoTransacao implements Serializable {
    ...
    private Set<DistritoSetorAbastecimento> distritoSetorAbastecimento;
	...
	public Set<DistritoSetorAbastecimento> getDistritoSetorAbastecimento() {
		return distritoSetorAbastecimento;
	}



	public void setDistritoSetorAbastecimento(Set<DistritoSetorAbastecimento> distritoSetorAbastecimento) {
		this.distritoSetorAbastecimento = distritoSetorAbastecimento;
	}    

...
public class AreaDistritoOperacional implements Serializable {
    ...
    public AreaDistritoOperacional(){}

	public AreaDistritoOperacional(
			Short indicadorPrincipal, Date ultimaAlteracao, AreaOperacional areaOperacional,

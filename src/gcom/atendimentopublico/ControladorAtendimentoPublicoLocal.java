...
public interface ControladorAtendimentoPublicoLocal extends
	...
	public void validacaoSubstituicaoHidrometro(String matriculaImovel,
			String numeroHidrometro, String situacaoHidrometroSubstituido,String numeroTombamento)
			throws ControladorException; 
	 ...
	 * @throws ControladorException
	 */
	public void validacaoInstalacaoHidrometro(String numeroHidrometro,String numeroTombamento)
			throws ControladorException;
	...
	public Integer alterarSituacaoLigacao(IntegracaoComercialHelper helper) throws ControladorException;
	 ...
	 * @throws ErroRepositorioException
	 */
	public Collection<AcessoLojaVirtualHelper> pesquisarAcessoLojaVirtualTipoAtendimento(Date periodoInicial , Date periodoFinal , String tipoAtendimento, 
			int numeroPagina,String indicadorServicoExecutado) throws ControladorException ;
	 ...
	 * @throws ErroRepositorioException
	 */
	public Integer pesquisarQuantidadeAcessoLojaVirtualTipoAtendimento(Date periodoInicial , Date periodoFinal, String tipoAtendimento ,
	 ...
	 * 
	 * */
	public Collection<SolicitacaoTipoGrupo> obterSolicitacaoTipoGrupo() throws ControladorException;
	 ...
	 * @throws ControladorException
	 */
	public void gerarBaseDeClienteParaSorteio(Collection<Integer> colecaoIdsLocalidade,int idFuncionalidadeIniciada)
			throws ControladorException;
	
	/**
	 * [UC 1286] Relatorio de Pesquisa de Satisfacao Sintetico
	 * @author Davi Menezes
	 * @date 29/02/2012
	 * @param PesquisaSatisfacaoHelper
	 * @throws ControladorException
	 */
	...
	/**
	 * [UC 1286] Relatorio de Pesquisa de Satisfacao Analitico
	 * @author Davi Menezes
	 * @date 29/02/2012
	 * @param PesquisaSatisfacaoHelper
	 * @throws ControladorException
	 ...
	 * @throws ErroRepositorioException
	 */
	public boolean verificarImoveisAptoSorteio(
		Integer idImovel) throws ControladorException;
	 ...
	 * 
	 */
	public Short pesquisarIndicadorTipoCalcArea(
		Integer servicoTipoId) throws ControladorException;
	 ...
	 * @date 22/08/2012
	 */
	public LigacaoAgua pesquisarLigacaoAgua(Integer idImovel) throws ControladorException;
	 ...
	 * 
	 * [UC0364] Efetuar Substituição de Hidrômetro
	 * [SB0007] - Verificar Situação Especial Faturamento
	 *  
	 * [UC0540] Efetuar Restabelecimento da Ligação de Água com Instalação de Hidrômetro
	 * [SB0005] - Verificar Situação Especial Faturamento
	 *  
	 * @author Mariana Victor
	 * @date 28/08/2012
	 * */	
	public void verificarStuacaoEspecialFaturamento(
			Imovel imovel, Integer idOrdemServico, Integer idUsuario) throws ControladorException;
	 ...
	 * @throws ControladorException
	 */
	public void gerarBaseClienteSorteioMensal(int idFuncionalidadeIniciada, Integer idLocalidade) 
			 throws ControladorException;
	 ...
	 * @throws ErroRepositorioException
	 */
	public Collection<UnidadeOrganizacional> obterUnidadesOrganizacionaisAssociadasEquipe() throws ControladorException;
	 ...
	 * @throws ErroRepositorioException
	 */
	public void excluirUnidadesOrganizacionaisAssociadasUsuario(Integer idUsuario) throws ControladorException;
	...
	/**
	 * [UC1402] - Enviar Mensagem SMS para celular 
	 * Metodo que envia mensagem sms para um celular por meio de um web service
	 * e persiste os dados na tabela atendimentopublico.mensagem_sms. 
	 * @author Carlos Chaves
	 * @since 12/12/2012
	 * @param Long nroDestino - Telefone de destino.
	 * @param Integer idRegistroAtendimento.
	 * @param Integer idSmsTipo.
	 * @return boolean
	 */
	public boolean enviarSmsRegistroAtendimento(Long nroDestino, Integer idRegistroAtendimento ,Integer idSmsTipo) 
			throws ControladorException;
	
	/**[UC1400]
	 * Obter mensagem da SMS pelo SmsTipo
	 * @param idTipoEspecificacao
	 * @author Carlos Chaves
	 * @since 11/12/2012
	 */
	public String obterMensagemSmsRegistroAtendimento(SmsTipo smsTipo, Integer idRegistroAtendimento, Integer idOrdemServico) throws ControladorException;
	
	
	/**[UC1400]
	 * [IT001] - Obter protocolo Registro de atendimento
	 * @param Integer idRegistroAtendimento
	 ...
	 * @since 12/12/2012
	 */
	public String obterProtocoloRegistroAtendimentoSms(Integer idRegistroAtendimento) throws ControladorException;
	
	
	/**[UC1400]
	 * Obter Registro de atendimento
	 * @param Integer idRegistroAtendimento
	 ...
	 * @since 12/12/2012
	 */
	public RegistroAtendimento obterRegistroAtendimento(Integer idRegistroAtendimento) throws ControladorException;
	 ...
	 * @throws ControladorException
	 */
	public boolean existeSubstInstHidrometroRepeticoesConsecutivasAnorm(Integer id, Integer id2,
			Integer qtdMesIstalSubistituicaoHidro, Integer qtdVezIncidenciaAnormalidadeHidro) throws ControladorException;
	 ...
	 * @author Arthur Carvalho
	 * @date 22/05/2013
	 * [UC1468]GerarEsgotoFactivelFaturavel
	 * @param helper
	 * @return
	 * @throws FachadaException
	 */
	public void informarImovelFactivelFaturavel(DadosContratoPPPHelper helper) throws ControladorException;
	 ...
	 * @throws FachadaException
	 */
	public void retirarImovelFactivelFaturavel(DadosContratoPPPHelper helper) throws ControladorException;
	 ...
	 * @param usuarioLogado
	 */
	public void removerServicoRepavimentadora(String[] ids, Usuario usuarioLogado) throws ControladorException;
	 ...
	 * @date 21/05/2013
	 */
	public void informarServicosRepavimentadora(Collection<OrdemRepavimentadoraServico> colecaoOrdemRepavimentadoraServico, 
			Collection<OrdemRepavimentadoraServico> colecaoOrdemRemovidas) throws ControladorException;
	 ...
	 * @throws ControladorException
	 */
	public Collection<OrdemServicoCobrancaSmartphoneHelper> pesquisarDadosOrdensServicoCobrancaSmartphone(Integer idArquivoTexto)
		throws ControladorException;
	/**
	 ...
	 * @date 01/07/2013
	 */
	public void atualizarMotivoDeNaoExecucaoDoServicoAction(MotivoDeNaoExecucaoDoServico motivoNaoExecucaoServico, 
			Collection<UnidadeRepavimentadoraHelper> colecaoHelper) throws ControladorException;
	 ...
	 * 
	 */
	public void removerMotivoDeNaoExecucaoDoServico(String[] ids, Usuario usuarioLogado) throws ControladorException;
	 ...
	 * @date 04/07/2013
	 * 
	 * @param Integer - Id do arquivo a qual a foto pertence
	 * @param Integer - Id da Ordem de Servico das fotos
	 * 
	 * @return Collection<ExecucaoOSFoto> - Colecao das Fotos da OS
	 * @throws FachadaExpcetion
	 */
	public Collection<ExecucaoOSFoto> pesquisarFotosOSCobrancaSmartphone(Integer idArquivo,
	 ...
	 * @param Integer - Id do arquivo a qual a foto pertence
	 * @param Integer - Id da Ordem de Servico das fotos
	 * @param Integer - Id da Situacao da foto
	 * 
	...
	public void atualizarClienteAPartirDoDispositivoMovelCobrancaSmartphone( Integer idArquivo, Integer idOrdemServico, Usuario usuarioLogado )
			throws ControladorException;
	
	public void verificarDadosRGClienteCobrancaSmartphone(ExecucaoOSCliente clienteRetorno, 
			Usuario usuarioLogado)throws ControladorException;
	
	public Integer inserirNovoClienteCobrancaSmartphone(ExecucaoOSCliente clienteRetorno, 
			Usuario usuarioLogado, Cliente clienteAnterior) throws ControladorException;
	
	public void atualizarDadosRGClienteAtualCobrancaSmartphone(ExecucaoOSCliente clienteRetorno, 
			Integer idCliente, Usuario usuarioLogado)
		throws ControladorException;
	
	public void atualizarDadosFoneClienteAtualCobrancaSmartphone(ExecucaoOSCliente clienteRetorno,
			Integer idCliente, Usuario usuarioLogado)
		throws ControladorException;
	 ...
	 * 
	 */
	public Collection<Integer> obterComandoOSConexaoEsgotoExecucao(Integer idFaturamentoGrupo) throws ControladorException;
	 ...
	 * 
	 */
	public void gerarOrdensServicoFactivelFaturavel(Integer idFuncionalidade, Collection<Integer> colecaoComandos, Integer idFaturamentoGrupo, Usuario usuario) throws ControladorException;
	 ...
	 * 
	 */
	public Collection<Integer> obterComandoOSConexaoEsgotoExecucaoEncerramentoNaoExecucao(Integer idFaturamentoGrupo) 
									throws ControladorException;
	 ...
	 * 
	 */
	public void encerrarOrdemServicoNaoExecucao(Integer idFuncionalidade, Collection<Integer> colecaoComandos, Integer idFaturamentoGrupo, Usuario usuario) throws ControladorException;
	 ...
	 * @since 19/08/2013
	 */
	public ArrayList<RelatorioAcompanhamentoOSCobrancaSmartphoneBean> pesquisarOSCobrancaSmartphone(RelatorioAcompanhamentoOSCobrancaSmartphoneHelper helper) 
			throws ControladorException;
	 ...
	 * @throws ControladorException
	 */
	public ComandoOSConexaoEsgoto obterDadosComandoOSConexaoEsgoto(Integer idComandoOSConexaoEsgoto)
		throws ControladorException;
	 ...
	 * @date 23/05/2013
	 */
	public void informarAgrupamentoBairrosUnidadeRepavimentadora(UnidadeRepavimentadoraMunicipio unidadeRepavimentadoraMunicipio, 
			String[] bairros, boolean novoAgrupamento) throws ControladorException;
	...
	public Collection<RelatorioComandosConexaoEsgotoHelper> pesquisarDadosRelatorioComandosConexaoEsgotoAnalitico(
		FiltrarRelatorioComandosConexaoEsgotoHelper helperFiltro) throws ControladorException;
	 ...
	 * 
	 */
	public void gerarRelatorioImoveisCartasNaoImpressas(Integer idGrupo,Usuario usuario,Integer idFuncionalidade) throws ControladorException;
	 ...
	 * @param usuarioLogado
	 */
	public void removerNaturezaEquipe(String[] ids, Usuario usuarioLogado) throws ControladorException;
	...
	public void gerarResumoAcoesOrdemDeServico(int idFuncionalidadeIniciada) throws ControladorException;
	 ...
	 * 
	 */
	public AtualizarClienteAPartirDispositivoMovelHelper atualizarClienteAPartirDoDispositivoMovel(AtualizarClienteAPartirDispositivoMovelHelper helper) throws ControladorException;
	
	/**
	 * Metodo auxiliar para montar o objeto AtualizarClienteAPartirDispositivoMovelHelper  
	 * 
	 ...
	 * @throws ControladorException
	 */
	public AtualizarClienteAPartirDispositivoMovelHelper montarAtualizarClienteAPartirDispositivoMovelHelper(ClieOsSeletivaVisitaCampo clieOsSeletivaVisitaCampo, 
			ArquivoTextoRetornoClienteVisitaCampo arquivoTextoRetornoClienteVisitaCampo, Integer idImovel , ArquivoTextoOSCobrancaCliente clienteIda , 
			ExecucaoOSCliente clienteRetorno ,  ClienteAtualizacaoCadastral clienteAtualizacaoCadastral, ClienteImovel clienteImovel, Integer tipoOperacao) throws ControladorException;

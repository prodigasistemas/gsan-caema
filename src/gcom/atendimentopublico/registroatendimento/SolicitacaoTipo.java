...
public class SolicitacaoTipo extends ObjetoTransacao {
	...
	@ControleAlteracao(funcionalidade={ATRIBUTO_SOLICITACAO_TIPO_ESPECIFICACAO_INSERIR,ATRIBUTO_SOLICITACAO_TIPO_ESPECIFICACAO_REMOVER,ATRIBUTO_SOLICITACAO_TIPO_ESPECIFICACAO_ATUALIZAR})
	private short indicadorPermiteClienteDesconhecido;
	...
	public final static Integer FISCALIZACAO_ANALISE = new Integer("712");
    public final static Integer VAZAMENTO = new Integer("603");
    public final static Integer RAMAL_DE_AGUA 	= new Integer("601");
    public final static Integer RAMAL_DE_ESGOTO = new Integer("701");
	...
	public short getIndicadorPermiteClienteDesconhecido() {
		return indicadorPermiteClienteDesconhecido;
	}

	public void setIndicadorPermiteClienteDesconhecido(
			short indicadorPermiteClienteDesconhecido) {
		this.indicadorPermiteClienteDesconhecido = indicadorPermiteClienteDesconhecido;
	}

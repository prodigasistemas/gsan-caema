 ...
 * 
 */
public class FiltroRegistroAtendimentoDevolucaoValores  extends Filtro implements Serializable {
	 ...
	 */
	public FiltroRegistroAtendimentoDevolucaoValores() {
	}
	 ...
	 */
	public FiltroRegistroAtendimentoDevolucaoValores(String campoOrderBy) {
	...
	public final static String REGISTRO_ATENDIMENTO_ID = "comp_id.registroAtendimentoId";
	
    public final static String CONTA_ID = "contaGeral.id";
    
    public final static String PAGAMENTO_ID = "comp_id.pagamentoId";

...
public class AtendimentoMotivoEncerramento extends ObjetoTransacao{
	...
	public final static String ATUALIZACAO_CADASTRAL_COMPESA = "70";
    ...
    public final static Integer DEBITO_PARCELADO_COM_ENTRADA = 70;
    public final static Integer DEBITO_PARCELADO_SEM_ENTRADA = 71;
    
    public final static Integer DEBITO_QUITADO = 72;
    public final static Integer DEBITO_PARCELADO = 73;
    public final static Integer DEBITO_CANCELADO = 102;
    public final static Integer DEBITO_PARTE_QUITADO_PARTE_PARCELADO = 74;
    public final static Integer DEBITO_PARTE_QUITADO_PARTE_CANCELADO = 103;
    public final static Integer DEBITO_PARTE_PARCELADO_PARTE_CANCELADO = 104;
    public final static Integer DEBITO_PARTE_QUITADO_PARTE_PARCELADO_PARTE_CANCELADO = 105;
    

    public final static short DESISTENCIA_DO_USUARIO = 4;
    
    public final static Integer NAO_CONCLUSAO_SERVICO = new Integer(101);
    
    public final static Integer CANCELAMENTO_PELA_COMPESA = 1;

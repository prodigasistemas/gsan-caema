...
public class SolicitacaoTipoEspecificacao extends ObjetoTransacao {
    ...
    @ControleAlteracao(funcionalidade={SolicitacaoTipo.ATRIBUTO_SOLICITACAO_TIPO_ESPECIFICACAO_INSERIR,SolicitacaoTipo.ATRIBUTO_SOLICITACAO_TIPO_ESPECIFICACAO_REMOVER
    ,SolicitacaoTipo.ATRIBUTO_SOLICITACAO_TIPO_ESPECIFICACAO_ATUALIZAR})
    private Short indicadorInstalacaoHidrometro;
    ...
    private Short indicadorAnexoObrigatorio;
    
    //RM 7753
    private Short indicadorTipoInstalacaoHidrometro;
    
    private Short indicadorTipoSubstituicaoHidrometro;

    private Short indicadorInformarDocumentoPagamentoAMaior;
    private Short indicadorInformarDocumentoPagamentoIndevido;
    private Short indicadorRALojaVirtualSemMatricula;
    private Short indicadorFactivelFaturavel;
    //RM 8848
    private Short indicadorCoordenadaProgisRA;
	...
	public final static Integer REVISAO_CONSUMO = 958;
	...
	public boolean equals(Object other) {
		...
		if(this.getDescricao().equalsIgnoreCase(castOther.getDescricao()) && this.getId().equals(castOther.getId())){
			return true;
		}
		return retorno;
	}
	...
	public Short getIndicadorAnexoObrigatorio() {
		return indicadorAnexoObrigatorio;
	}

	public void setIndicadorAnexoObrigatorio(Short indicadorAnexoObrigatorio) {
	...
	public Short getIndicadorInstalacaoHidrometro() {
		return indicadorInstalacaoHidrometro;
	}

	public void setIndicadorInstalacaoHidrometro(Short indicadorInstalacaoHidrometro) {
		this.indicadorInstalacaoHidrometro = indicadorInstalacaoHidrometro;
	}

	public Short getIndicadorTipoInstalacaoHidrometro() {
		return indicadorTipoInstalacaoHidrometro;
	}

	public void setIndicadorTipoInstalacaoHidrometro(
			Short indicadorTipoInstalacaoHidrometro) {
		this.indicadorTipoInstalacaoHidrometro = indicadorTipoInstalacaoHidrometro;
	}

	public Short getIndicadorTipoSubstituicaoHidrometro() {
		return indicadorTipoSubstituicaoHidrometro;
	}

	public void setIndicadorTipoSubstituicaoHidrometro(
			Short indicadorTipoSubstituicaoHidrometro) {
		this.indicadorTipoSubstituicaoHidrometro = indicadorTipoSubstituicaoHidrometro;
	}

	public Short getIndicadorInformarDocumentoPagamentoAMaior() {
		return indicadorInformarDocumentoPagamentoAMaior;
	}

	public void setIndicadorInformarDocumentoPagamentoAMaior(
			Short indicadorInformarDocumentoPagamentoAMaior) {
		this.indicadorInformarDocumentoPagamentoAMaior = indicadorInformarDocumentoPagamentoAMaior;
	}

	public Short getIndicadorInformarDocumentoPagamentoIndevido() {
		return indicadorInformarDocumentoPagamentoIndevido;
	}

	public void setIndicadorInformarDocumentoPagamentoIndevido(
			Short indicadorInformarDocumentoPagamentoIndevido) {
		this.indicadorInformarDocumentoPagamentoIndevido = indicadorInformarDocumentoPagamentoIndevido;
	}

	public Short getIndicadorRALojaVirtualSemMatricula() {
		return indicadorRALojaVirtualSemMatricula;
	}

	public void setIndicadorRALojaVirtualSemMatricula(
			Short indicadorRALojaVirtualSemMatricula) {
		this.indicadorRALojaVirtualSemMatricula = indicadorRALojaVirtualSemMatricula;
	}

	public Short getIndicadorCoordenadaProgisRA() {
		return indicadorCoordenadaProgisRA;
	}

	public void setIndicadorCoordenadaProgisRA(Short indicadorCoordenadaProgisRA) {
		this.indicadorCoordenadaProgisRA = indicadorCoordenadaProgisRA;
	}

	public Short getIndicadorFactivelFaturavel() {
		return indicadorFactivelFaturavel;
	}

	public void setIndicadorFactivelFaturavel(Short indicadorFactivelFaturavel) {
		this.indicadorFactivelFaturavel = indicadorFactivelFaturavel;
	}

	public Integer getDiasPrazoArpe() {
		return diasPrazoArpe;
	}

	public void setDiasPrazoArpe(Integer diasPrazoArpe) {
		this.diasPrazoArpe = diasPrazoArpe;
	}

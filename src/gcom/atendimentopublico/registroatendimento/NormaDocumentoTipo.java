...
public class NormaDocumentoTipo implements Serializable {
	...
	/** full constructor */
	public NormaDocumentoTipo(String descricaoDocumentoTipo,
    ...
    public boolean equals(Object other) {
		...
		if (other instanceof NormaDocumentoTipo) {
			
			NormaDocumentoTipo castOther = (NormaDocumentoTipo) other;

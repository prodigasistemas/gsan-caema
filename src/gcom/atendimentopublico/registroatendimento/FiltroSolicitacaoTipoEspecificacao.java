...
public class FiltroSolicitacaoTipoEspecificacao extends Filtro implements Serializable {
    ...
    public final static String INDICADOR_INFORMAR_PAGAMENTO_DUPLICIDADE = "indicadorInformarPagamentoDuplicidade";
    
    public final static String INDICADOR_INFORMAR_PAGAMENTO_A_MAIOR = "indicadorInformarDocumentoPagamentoAMaior";
    
    public final static String INDICADOR_INFORMAR_PAGAMENTO_INDEVIDO = "indicadorInformarDocumentoPagamentoIndevido";
    
 // RM 5759   
    public final static String INDICADOR_PERMITE_CANCELAR_DEBITO = "indicadorPermiteCancelarDebito";
    
    public final static String INDICADOR_INFORMA_PAGAMENTO_DUPLICIDADE = "indicadorInformarPagamentoDuplicidade";
    
    public final static String INDICADOR_INFORMA_DOCUMENTO_PAGAMENTO_A_MAIOR = "indicadorInformarDocumentoPagamentoAMaior";
    
    public final static String INDICADOR_INFORMA_DOCUMENTO_PAGAMENTO_INDEVIDO = "indicadorInformarDocumentoPagamentoIndevido";
    
    public final static String INDICADOR_OBRIGATORIEDADE_MATRICULA = "indicadorMatricula";
    
    public final static String INDICADOR_RA_LOJA_VIRTUAL_SEM_MATRICULA = "indicadorRALojaVirtualSemMatricula";
    
    public final static String INDICADOR_FACTIVEL_FATURAVEL = "indicadorFactivelFaturavel";
}

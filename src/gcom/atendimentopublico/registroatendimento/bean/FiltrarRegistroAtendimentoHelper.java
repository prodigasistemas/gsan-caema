...
public class FiltrarRegistroAtendimentoHelper implements Serializable {
	...
	private Collection<Integer> colecaoTipoSolicitacaoGrupo = null;
	...
	public Collection<Integer> getColecaoTipoSolicitacaoGrupo() {
		return colecaoTipoSolicitacaoGrupo;
	}



	public void setColecaoTipoSolicitacaoGrupo(
			Collection<Integer> colecaoTipoSolicitacaoGrupo) {
		this.colecaoTipoSolicitacaoGrupo = colecaoTipoSolicitacaoGrupo;
	}

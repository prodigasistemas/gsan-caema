...
public class RaEncerramentoComandoEspecificacoes extends ObjetoTransacao {
    ...
    public Filtro retornaFiltro() {
    	FiltroRaEncerramentoComandoEspecificacoes filtro = new FiltroRaEncerramentoComandoEspecificacoes();
    	filtro.adicionarCaminhoParaCarregamentoEntidade("raEncerramentoComando");

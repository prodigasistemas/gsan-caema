...
public class FiltroRaEncerramentoComando extends Filtro {
     ...
     * Description of the Field
     */
    public final static String UNIDADE_ATENDIMENTO = "unidadeOrganizacionalAtendimento";
    ...
    public final static String UNIDADE_ATUAL = "unidadeOrganizacionalAtual";
    public final static String UNIDADE_ATUAL_ID = "unidadeOrganizacionalAtual.id";
    
    /**
     * Description of the Field
     */
    public final static String UNIDADE_SUPERIOR = "unidadeOrganizacionalSuperior";
    ...
    public final static String ATENDIMENTO_MOTIVO_ENC = "atendimentoMotivoEncerramento";

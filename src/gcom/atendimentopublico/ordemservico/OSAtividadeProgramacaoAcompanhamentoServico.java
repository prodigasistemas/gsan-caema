...
public class OSAtividadeProgramacaoAcompanhamentoServico implements Serializable {
	...
	/* RM 7889 */
	private Integer codigoServTerceiroAcompServ;
	private Date dataAlteracaoCodServico;
	private Usuario usuario;
	
	public Integer getCodigoServTerceiroAcompServ() {
		return codigoServTerceiroAcompServ;
	}

	public void setCodigoServTerceiroAcompServ(Integer codigoServTerceiroAcompServ) {
		this.codigoServTerceiroAcompServ = codigoServTerceiroAcompServ;
	}

	public Date getDataAlteracaoCodServico() {
		return dataAlteracaoCodServico;
	}

	public void setDataAlteracaoCodServico(Date dataAlteracaoCodServico) {
		this.dataAlteracaoCodServico = dataAlteracaoCodServico;
	}

...
public interface IRepositorioOrdemServico {
	...
	/**
	 * [UC0362] Efetuar Instalação de Hidrometro
	 * 
	 * @author Leonardo Regis
	 * @date 19/09/2006
	 * 
	...
	public int pesquisarEquipesCount(String idEquipe, String nome,
			...
			String indicadorProgramcaoAutomatica,
			String indicadorManterProgramacaoOSdiaAnterior,
			String equipeNatureza) throws ErroRepositorioException;
	...
	public List filtrarImovelEmissaoOrdensSeletivas(ImovelEmissaoOrdensSeletivasHelper helper,
			...
			String dataInstalacaoFinalHidrometro,Short codigoEmpresaFebraban, ComandoOsSetor comandoOs) throws ErroRepositorioException ;
	...
	public Collection<Integer[]> pesquisarNumeroDeOcorrenciasConsecultivasAnormalidades(			
			...
			ImovelEmissaoOrdensSeletivasHelper  helper, ComandoOsSetor comandoOs 		
			   )throws ErroRepositorioException;
	...
	/**
	 * [UC0461] Manter Dados das Atividades da Ordem de Servico
	 * 
	 * @author Sávio Luiz
	 * @date 19/09/2006
	 * 
	...
	/**
	 * [UC1184] - Gerar Arquivo para Acompanhar o Servico do Roteiro Programado
	 * 
	 * 
	 * @author Sávio Luiz
	 * @date 06/07/2011
	...
	public Collection<?> pesquisarAcompanhamentoArquivosRoteiro( 
			...
			String idEmpresa,
			String idSituacao, Integer idUsuario) 
			throws ErroRepositorioException;
	 ...
	 * de uma inspeção e anormalidade
	 * 
	 * @author Raimundo Martins
	 * @date 23/01/2012
	 * */
	...
	/**	 * [UC 0153] Apresentar Dados Para Análise da Medição e Consumo	 * 	 * Metodo que verifica se um imovel possui Ordens de Serviço	 * com fotos associadas	 * 	 * @author Raimundo Martins	 * @date 13/04/2012	 * */		
	 ...
	 * * Ordem de Serviço	 * 	 * @author Raimundo Martins	 * @date 16/04/2012	 * */		
	 ...
	 * @throws ErroRepositorioException
	 */
	public Equipe pesquisarEquipeUsuarioOSProgramacao(Integer id) throws ErroRepositorioException;
	 ...
	 * @throws ErroRepositorioException
	 */
	public String obterEquipeOsProgramacaoAcompServico(Integer numeroOS) throws ErroRepositorioException;
	 ...
	 * Mudar Situacao da Ligacao - OS Fiscalizacao
	 * 
	 * Atualiza indicador de imovel fiscalizado com debito para NAO (2)
	 * 
	 * @author Anderson Cabral
	 * @date 20/08/2012	 
	 * */
	 ...
	 * @throws ErroRepositorioException
	 */
	public void atualizarOrdemServicoFiscalizacao(Integer osID) throws ErroRepositorioException;
	...
	public Collection<OrdemServicoFoto> pesquisarOrdemServicoFotoRepavimentacao(
			Integer idOs, Integer idRA) throws ErroRepositorioException;
	...
	public Collection<Object[]> pesquisarOrdemServicoEtapaRa(Integer idOs,
			Integer idRa, short icNovaEtapa) throws ErroRepositorioException;
	 ...
	 * @date 13/08/2013
	 */
	public Integer pesquisarOSEmissaoCartaConexaoEsgoto(Integer idImovel, Integer anoMes) throws ErroRepositorioException;
	 ...
	 * @throws ErroRepositorioException 
	 */
	public Collection<Object[]> obterOSComandoConexaoEsgoto(ComandoOSConexaoEsgoto comandoOSConexaoEsgoto,boolean verificadorOSPosteriorSistemaParametro)
	throws ErroRepositorioException;

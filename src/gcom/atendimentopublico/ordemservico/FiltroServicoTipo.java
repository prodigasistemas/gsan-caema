...
public class FiltroServicoTipo extends Filtro implements Serializable {
    ...
    public static final String INDICADOR_FISCALIZACAO_INFRACAO = "indicadorFiscalizacaoInfracao";
    
    public static final String INDICADOR_SERVICO_COBRANCA = "indicadorServicoCobranca";
    public static final String INDICADOR_SERVICO_MICROMEDICAO = "indicadorTipoServicoMicromedicao";

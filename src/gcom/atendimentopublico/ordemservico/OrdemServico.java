...
public class OrdemServico extends ObjetoTransacao {
	...
	public final static Short INDICADOR_MANUTENCAO_OS_NAO = new Short("2");
	
	public final static Integer ORDEM_SERVICO_COBRANCA = 1;
	public final static Integer ORDEM_SERVICO_MICROMEDICAO = 2;
	public final static String DESCRICAO_ORDEM_SERVICO_COBRANCA = "O.S. DE COBRANCA";
	public final static String DESCRICAO_ORDEM_SERVICO_MICROMEDICAO = "O.S. DE MICROMEDICAO";
    ...
    private Integer indicadorImovelFicalizadoDebito;
    
    private LigacaoAguaSituacao ligacaoAguaSituacao;
    
    private ComandoOSConexaoEsgoto comandoOSConexaoEsgoto;
    
    private CobrancaDebitoSituacao cobrancaDebitoSituacaoResumo;
    
    private OrdemServicoSituacao ordemServicoSituacaoResumo;
    ...
    public OrdemServico(short situacao, Date dataGeracao, Date dataEmissao, Date dataEncerramento, 
    	...
    	this.indicadorImovelFicalizadoDebito = new Integer(ConstantesSistema.NAO);
    }
...
//		filtroOrdemServico.adicionarCaminhoParaCarregamentoEntidade("dataEncerramento");
    ...
    public Integer getIndicadorImovelFicalizadoDebito() {
		return indicadorImovelFicalizadoDebito;
	}

	public void setIndicadorImovelFicalizadoDebito(
			Integer indicadorImovelFicalizadoDebito) {
		this.indicadorImovelFicalizadoDebito = indicadorImovelFicalizadoDebito;
	}
	...
	public ComandoOSConexaoEsgoto getComandoOSConexaoEsgoto() {
		return comandoOSConexaoEsgoto;
	}

	public void setComandoOSConexaoEsgoto(ComandoOSConexaoEsgoto comandoOSConexaoEsgoto) {
		this.comandoOSConexaoEsgoto = comandoOSConexaoEsgoto;
	}

	public CobrancaDebitoSituacao getCobrancaDebitoSituacaoResumo() {
		return cobrancaDebitoSituacaoResumo;
	}

	public void setCobrancaDebitoSituacaoResumo(CobrancaDebitoSituacao cobrancaDebitoSituacaoResumo) {
		this.cobrancaDebitoSituacaoResumo = cobrancaDebitoSituacaoResumo;
	}

	public OrdemServicoSituacao getOrdemServicoSituacaoResumo() {
		return ordemServicoSituacaoResumo;
	}

	public void setOrdemServicoSituacaoResumo(OrdemServicoSituacao ordemServicoSituacaoResumo) {
		this.ordemServicoSituacaoResumo = ordemServicoSituacaoResumo;
	}
}

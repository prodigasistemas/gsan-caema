...
public class FiltroOSAtividadeProgramacaoAcompanhamentoServico extends Filtro {
	...
	public final static String OS_PROG_ACOMP_SERVICO_ORDEM_SERVICO_ID = "osProgramacaoAcompanhamentoServico.ordemServico.id";
	
	public final static String ID_ATIVIDADE = "atividade.id";
	
	public final static String SERVICO_TERCEIRO_ACOMPANHAMENTO_SERVICO = "servicoTerceiroAcompanhamentoServico";

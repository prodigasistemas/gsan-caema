...
public class OSProgramacaoAcompanhamentoServico implements Serializable {
	...
	/** persistent field */
	private OsAcompanhamentoMotivoNaoAceite osAcompanhamentoMotivoNaoAceite;
	
	/** persistent field */
	private String descricaoObservacaoMotNaoAceite;
	
	private BigDecimal quantidadeAreaPavimentoEnviado;
	
	private BigDecimal quantidadeAreaPavimentoRetornado;
	
	private PavimentoRua pavimentoRuaEnviado;
	
	private PavimentoRua pavimentoRuaRetornado;
	
	private PavimentoCalcada pavimentoCalcadaEnviado;
	
	private PavimentoCalcada pavimentoCalcadaRetornado;
	...
	private BigDecimal numeroDiametro;
	
	private BigDecimal numeroDistanciaRede;
	
	private String descricaoElementoReferencia;
	
	private Short indicadorProgramacaoManual;
    ...
    public OsAcompanhamentoMotivoNaoAceite getOsAcompanhamentoMotivoNaoAceite() {
		return osAcompanhamentoMotivoNaoAceite;
	}

	public void setOsAcompanhamentoMotivoNaoAceite(
			OsAcompanhamentoMotivoNaoAceite osAcompanhamentoMotivoNaoAceite) {
		this.osAcompanhamentoMotivoNaoAceite = osAcompanhamentoMotivoNaoAceite;
	}

	public String getDescricaoObservacaoMotNaoAceite() {
		return descricaoObservacaoMotNaoAceite;
	}

	public void setDescricaoObservacaoMotNaoAceite(
			String descricaoObservacaoMotNaoAceite) {
		this.descricaoObservacaoMotNaoAceite = descricaoObservacaoMotNaoAceite;
	}
	...
	public BigDecimal getQuantidadeAreaPavimentoEnviado() {
		return quantidadeAreaPavimentoEnviado;
	}

	public void setQuantidadeAreaPavimentoEnviado(BigDecimal quantidadeAreaPavimentoEnviado) {
		this.quantidadeAreaPavimentoEnviado = quantidadeAreaPavimentoEnviado;
	}

	public BigDecimal getQuantidadeAreaPavimentoRetornado() {
		return quantidadeAreaPavimentoRetornado;
	}

	public void setQuantidadeAreaPavimentoRetornado(BigDecimal quantidadeAreaPavimentoRetornado) {
		this.quantidadeAreaPavimentoRetornado = quantidadeAreaPavimentoRetornado;
	}

	public PavimentoRua getPavimentoRuaEnviado() {
		return pavimentoRuaEnviado;
	}

	public void setPavimentoRuaEnviado(PavimentoRua pavimentoRuaEnviado) {
		this.pavimentoRuaEnviado = pavimentoRuaEnviado;
	}

	public PavimentoRua getPavimentoRuaRetornado() {
		return pavimentoRuaRetornado;
	}

	public void setPavimentoRuaRetornado(PavimentoRua pavimentoRuaRetornado) {
		this.pavimentoRuaRetornado = pavimentoRuaRetornado;
	}

	public PavimentoCalcada getPavimentoCalcadaEnviado() {
		return pavimentoCalcadaEnviado;
	}

	public void setPavimentoCalcadaEnviado(PavimentoCalcada pavimentoCalcadaEnviado) {
		this.pavimentoCalcadaEnviado = pavimentoCalcadaEnviado;
	}

	public PavimentoCalcada getPavimentoCalcadaRetornado() {
		return pavimentoCalcadaRetornado;
	}

	public void setPavimentoCalcadaRetornado(PavimentoCalcada pavimentoCalcadaRetornado) {
		this.pavimentoCalcadaRetornado = pavimentoCalcadaRetornado;
	}
	...
	public void setMotivoDeNaoExecucaoDoServico(MotivoDeNaoExecucaoDoServico motivoDeNaoExecucaoDoServico) {
	...
	public BigDecimal getNumeroDiametro() {
		return numeroDiametro;
	}

	public void setNumeroDiametro(BigDecimal numeroDiametro) {
		this.numeroDiametro = numeroDiametro;
	}

	public BigDecimal getNumeroDistanciaRede() {
		return numeroDistanciaRede;
	}

	public void setNumeroDistanciaRede(BigDecimal numeroDistanciaRede) {
		this.numeroDistanciaRede = numeroDistanciaRede;
	}
	...
	public Short getIndicadorProgramacaoManual() {
		return indicadorProgramacaoManual;
	}

	public void setIndicadorProgramacaoManual(Short indicadorProgramacaoManual) {
		this.indicadorProgramacaoManual = indicadorProgramacaoManual;
	}
}
...
public class Equipe extends ObjetoTransacao {
	...
	private Short indicadorManterProgramacaoAnterior;
	
	private Set equipeComponentes;
	
	private UnidadeRepavimentadoraMunicipio agrupamentoBairroRepavimentadora;
	...
	public Set getEquipeComponentes() {
		return equipeComponentes;
	}

	public void setEquipeComponentes(Set equipeComponentes) {
	...
	public UnidadeRepavimentadoraMunicipio getAgrupamentoBairroRepavimentadora() {
		return agrupamentoBairroRepavimentadora;
	}

	public void setAgrupamentoBairroRepavimentadora(UnidadeRepavimentadoraMunicipio agrupamentoBairroRepavimentadora) {
		this.agrupamentoBairroRepavimentadora = agrupamentoBairroRepavimentadora;
	}
	
	public Short getIndicadorManterProgramacaoAnterior() {
		return indicadorManterProgramacaoAnterior;
	}

	public void setIndicadorManterProgramacaoAnterior(Short indicadorManterProgramacaoAnterior) {
		this.indicadorManterProgramacaoAnterior = indicadorManterProgramacaoAnterior;
	}

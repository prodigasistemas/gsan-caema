...
public class ServicoTipo extends ObjetoTransacao {
	...
	public final static int TIPO_RELIGACAO_AGUA_COM_INSTALACAO_HIDROMETRO = 1020;

	public final static int TIPO_ORDEM_SERVICO_FISCALIZACAO = 33;
	
	/*** [SB0009] - Informar instalacao de caixa de protecao do hidrometro ***/
	public final static int TIPO_INSTALACAO_CAIXA_PROTECAO = 303;
	...
	public final static int FISCALIZACAO_DE_CORTE = 209;
	
	public final static Integer LIGADO_DECRETO =760;
	
	public final static Integer ALTERAR_SITUACAO_LIGACAO =761;
	...
	private short indicadorNovaEtapa;

	private Short indicadorTipoCalcArea;
	
	private Short indicadorServicoCobranca;
	
	private Short indicadorGerarResumo;
	
	private Short indicadorTipoServicoMicromedicao;
	
	private Collection<ServicoPerfilTipo> colecaoServicoPerfilTipo;
	
	private Set<ServicoTipoPerfilEquipe> servicoTipoPerfisEquipe;
	...
	public ServicoTipo(
			...
			short indicadorProgramacaoAutomatica, short indicadorNovaEtapa, Short indicadorTipoCalcArea) {
		...
		if (indicadorTipoCalcArea == null) {
			indicadorTipoCalcArea = ConstantesSistema.NAO;
		}
		this.indicadorTipoCalcArea = indicadorTipoCalcArea;
	}
	...
	public short getIndicadorNovaEtapa() {
		return indicadorNovaEtapa;
	}

	public void setIndicadorNovaEtapa(short indicadorNovaEtapa) {
		this.indicadorNovaEtapa = indicadorNovaEtapa;
	}

	public Short getIndicadorTipoCalcArea() {
		return indicadorTipoCalcArea;
	}

	public void setIndicadorTipoCalcArea(Short indicadorTipoCalcArea) {
		this.indicadorTipoCalcArea = indicadorTipoCalcArea;
	}
	...
	public Short getIndicadorGerarResumo() {
		return indicadorGerarResumo;
	}

	public void setIndicadorGerarResumo(Short indicadorGerarResumo) {
		this.indicadorGerarResumo = indicadorGerarResumo;
	}

	public Short getIndicadorTipoServicoMicromedicao() {
		return indicadorTipoServicoMicromedicao;
	}

	public void setIndicadorTipoServicoMicromedicao(Short indicadorTipoServicoMicromedicao) {
		this.indicadorTipoServicoMicromedicao = indicadorTipoServicoMicromedicao;
	}

	public Collection<ServicoPerfilTipo> getColecaoServicoPerfilTipo() {
		return colecaoServicoPerfilTipo;
	}

	public void setColecaoServicoPerfilTipo(Collection<ServicoPerfilTipo> colecaoServicoPerfilTipo) {
		this.colecaoServicoPerfilTipo = colecaoServicoPerfilTipo;
	}

	public Set<ServicoTipoPerfilEquipe> getServicoTipoPerfisEquipe() {
		return servicoTipoPerfisEquipe;
	}

	public void setServicoTipoPerfisEquipe(Set<ServicoTipoPerfilEquipe> servicoTipoPerfisEquipe) {
		this.servicoTipoPerfisEquipe = servicoTipoPerfisEquipe;
	}
}

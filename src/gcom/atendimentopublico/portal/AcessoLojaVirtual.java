...
public class AcessoLojaVirtual extends ObjetoTransacao {
	...
	public final static String AUTO_ATENDIMENTO = new String("3");
	...
	public final static String TARIFA_SOCIAL = new String("6");
	
	public final static String NORMAS_INSTALACAO = new String("7");
	
	//Modulo: Serviços
	public final static String SEGUNDA_VIA_CONTA = new String("8");
	
	public final static String DECLARACAO_ANUAL_QUITACAO_DEBITO = new String("9");
	
	public final static String RECEBIMENTO_FATURA_EMAIL = new String("10");
	
	public final static String SOLICITAR_CONTA_BRAILE = new String("11");
	
	public final static String OUTROS_SERVICOS = new String("12");
	
	public final static String PARCELAMENTO_DEBITOS = new String("13");
	
	public final static String ALTERAR_VENCIMENTO = new String("14");
	
	public final static String CERTIDAO_NEGATIVA_DEBITOS = new String("15");
	
	public final static String CONTRATO_ADESAO_TACITA = new String("16");
	
	public final static String CONSULTAR_PAGAMENTOS = new String("17");

	public final static String CONSULTAR_CONSUMO_HISTORICO = new String("18");

	public final static String ACOMPANHAR_REGISTRO_ATENDIMENTO = new String("19");

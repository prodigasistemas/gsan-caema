...
public class IntegracaoComercialHelper implements Serializable {
    ...
    //Alterar tipo Situacao Ligacao 
    private String indicadorTipoLigacao;
    private String idSituacaoLigacaoAguaNova;
    private String idSituacaoLigacaoEsgotoNova;
	...
	public String getIdSituacaoLigacaoAguaNova() {
		return idSituacaoLigacaoAguaNova;
	}

	public void setIdSituacaoLigacaoAguaNova(String idSituacaoLigacaoAguaNova) {
		this.idSituacaoLigacaoAguaNova = idSituacaoLigacaoAguaNova;
	}

	public String getIdSituacaoLigacaoEsgotoNova() {
		return idSituacaoLigacaoEsgotoNova;
	}

	public void setIdSituacaoLigacaoEsgotoNova(String idSituacaoLigacaoEsgotoNova) {
		this.idSituacaoLigacaoEsgotoNova = idSituacaoLigacaoEsgotoNova;
	}
	...
	public void setLigacaoEsgotoSituacaoAnterior(

...
public class RelatorioTotalizadorSistemaAbastecimentoAnalitico extends TarefaRelatorio {
	private static final long serialVersionUID = 1L;
	public RelatorioTotalizadorSistemaAbastecimentoAnalitico(Usuario usuario) {
		super(usuario, ConstantesRelatorios.RELATORIO_IMOVEIS_SISTEMA_ABASTECIMENTO_ANALITICO);
	}
	
	@Deprecated
	public RelatorioTotalizadorSistemaAbastecimentoAnalitico() {
		super(null, "");
	}
	...
	public Object executar() throws TarefaException {
		...
		retorno = this.gerarRelatorio(
				ConstantesRelatorios.RELATORIO_IMOVEIS_SISTEMA_ABASTECIMENTO_ANALITICO, parametros,
	...
	public void agendarTarefaBatch() {
		AgendadorTarefas.agendarTarefa("RelatorioTotalizadorSistemaAbastecimentoAnalitico", this);
	}

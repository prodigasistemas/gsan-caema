...
//		Integer idFuncionalidadeIniciada = this.getIdFuncionalidadeIniciada();
		...
		Collection<ZonaPressaoHelper> colecaoZonaPressao = (Collection<ZonaPressaoHelper>) getParametro("colecaoZonaPressao");
		ZonaPressaoHelper zonaPressaoParametros = (ZonaPressaoHelper) getParametro("zonaPressaoParametros");
		...
		if (colecaoZonaPressao != null && !colecaoZonaPressao.isEmpty()) {
			...
			for (ZonaPressaoHelper zonaPressaoHelper : colecaoZonaPressao) {

				String ativoInativo = "";

				if ( zonaPressaoHelper.getIndicadorUso().equals( ConstantesSistema.INDICADOR_USO_ATIVO ) ){
					ativoInativo = "Ativo";
				} else {
				...
				relatorioBean = new RelatorioManterZonaPressaoBean(
						// Código
						zonaPressaoHelper.getIdZonaPressao().toString(), 
						
						// Descrição
						zonaPressaoHelper.getDescricaoZonaPressao(), 
						
						// Descrição Abreviada
						zonaPressaoHelper.getSubSistema(), 
						
						// Distrito Operacional
						zonaPressaoHelper.getSetor(),
		...
		if (zonaPressaoParametros.getIdZonaPressao() != null) {
			parametros.put("id",
					zonaPressaoParametros.getIdZonaPressao().toString());
		} else {
			parametros.put("id", "");
		}
		...
		parametros.put("sistema", zonaPressaoParametros.getSistema());
		
		parametros.put("subsistema", zonaPressaoParametros.getSubSistema());
		
		parametros.put("setor", zonaPressaoParametros.getSetor());
		
		parametros.put("areaOperacional", zonaPressaoParametros.getAreaOperacional());

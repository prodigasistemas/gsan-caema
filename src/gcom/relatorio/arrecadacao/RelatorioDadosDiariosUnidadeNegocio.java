...
public class RelatorioDadosDiariosUnidadeNegocio extends TarefaRelatorio {
	...
	public Object executar() throws TarefaException {
		...
		if (getParametro("colecaoDadosDiariosUnidade") != null) {
			colecaoDadosDiarios = (Collection<FiltrarDadosDiariosArrecadacaoHelper>) getParametro("colecaoDadosDiariosUnidade");
		}

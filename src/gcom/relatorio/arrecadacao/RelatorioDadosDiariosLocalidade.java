...
public class RelatorioDadosDiariosLocalidade extends TarefaRelatorio {
	...
	public Object executar() throws TarefaException {
		...
		if (getParametro("colecaoDadosDiariosLocalidade") != null) {
			colecaoDadosDiarios = (Collection<FiltrarDadosDiariosArrecadacaoHelper>) getParametro("colecaoDadosDiariosLocalidade");
		}

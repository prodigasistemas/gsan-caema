...
public class RelatorioDadosDiariosValoresDiarios extends TarefaRelatorio {
	...
	public Object executar() throws TarefaException {
		...
		if (getParametro("colecaoDadosDiariosValores") != null) {
			colecaoDadosDiarios = (Collection<FiltrarDadosDiariosArrecadacaoHelper>) getParametro("colecaoDadosDiariosValores");
		}

...
public class RelatorioManterMotivoNaoAutorizacaoBean implements RelatorioBean {
	...
	public RelatorioManterMotivoNaoAutorizacaoBean(String id,
			String descricao, String indicadorUso) {
		this.id = id;

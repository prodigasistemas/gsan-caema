...
public class GerenciadorExecucaoTarefaRelatorio {
	...
	public static int obterProcessoRelatorio(String nomeRelatorio) {
    	...
    	}  else if (nomeRelatorio.equals(ConstantesRelatorios.RELATORIO_IMOVEIS_CORTADOS)) {
            
            retornoCodigoProcesso = Processo.GERAR_RELATORIO_IMOVEIS_CORTADOS;
            
    	} else if (nomeRelatorio.equals(ConstantesRelatorios.RELATORIO_RETORNO_OS_FISCALIZACAO)) {
        
    		retornoCodigoProcesso = Processo.GERAR_RELATORIO_RETORNO_OS_FISCALIZACAO;
    	...
    	} else if (nomeRelatorio.equals(ConstantesRelatorios.RELATORIO_ANALISE_FATURAMENTO_PERIODO)) {
    		
    		retornoCodigoProcesso = Processo.GERAR_RELATORIO_ANALISE_FATURAMENTO_POR_PERIODO;
    		
    	} else if (nomeRelatorio.equals(ConstantesRelatorios.RELATORIO_ANALISE_FATURAMENTO)) {
    	...
    	} else if(nomeRelatorio.equals(ConstantesRelatorios.RELATORIO_CLIENTES_MESMO_CPF_CNPJ)){
    		
    		retornoCodigoProcesso =  Processo.UNIFICAR_ID_CLIENTES_COM_MESMO_DOCUMENTO;
    		
    	}else if(nomeRelatorio.equals(ConstantesRelatorios.RELATORIO_ANORMALIDADE_IMOVEIS_CORRIGIDOS)){
    		
    		retornoCodigoProcesso = Processo.RELATORIO_ANORMALIDADE_IMOVEIS_CORRIGIDOS;
    		
    	}else if(nomeRelatorio.equals(ConstantesRelatorios.RELATORIO_ANALISE_IMOVEL_CORPORATIVO_GRANDE)){
    		
    		retornoCodigoProcesso = Processo.RELATORIO_ANALISE_IMOVEL;
    		
    	}else if(nomeRelatorio.equals(ConstantesRelatorios.RELATORIO_ORDEM_SERVICO_CONEXAO_ESGOTO_BATCH)){
    		retornoCodigoProcesso = Processo.GERAR_CARTA_ORDEM_SERVICO_CONEXAO_ESGOTO;
    	}
		
		else if(nomeRelatorio.equals(ConstantesRelatorios.RELATORIO_IMOVEIS_CARTAS_NAO_IMPRESSAS)){
			retornoCodigoProcesso = Processo.RELATORIO_IMOVEIS_CARTAS_NAO_IMPRESSAS;
		} 
		
		else if (nomeRelatorio.equals(ConstantesRelatorios.RELATORIO_SUPRESSOES_RELIGACOES_REESTABELECIMENTOS)){
			retornoCodigoProcesso = Processo.RELATORIO_SUPRESSOES_RELIGACOES_REESTABELECIMENTOS;
		}

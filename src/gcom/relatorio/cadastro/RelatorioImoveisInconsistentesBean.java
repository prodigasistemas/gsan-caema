 ...
 *
 */
public class RelatorioImoveisInconsistentesBean implements RelatorioBean {
  ...
  public boolean equals(Object other) {
        ...
        if (!(other instanceof RelatorioImoveisInconsistentesBean)) {
			return false;
		}

		boolean retorno = true;

		RelatorioImoveisInconsistentesBean castOther = (RelatorioImoveisInconsistentesBean) other;

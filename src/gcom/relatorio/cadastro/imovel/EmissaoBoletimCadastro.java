...
//		int tipoFormatoRelatorio = (Integer) getParametro("tipoFormatoRelatorio");
		...
		String [] colecaoSituacaoLigacaoEsgoto = (String []) getParametro("colecaoSituacaoLigacaoEsgoto");
		
		String idsSituacaoLigacaoEsgoto = "";
		
		if(colecaoSituacaoLigacaoEsgoto != null){
			
			for (String idSituacaoEsgoto : colecaoSituacaoLigacaoEsgoto) {
				if(!idSituacaoEsgoto.equals(ConstantesSistema.NUMERO_NAO_INFORMADO)){
					idsSituacaoLigacaoEsgoto += idSituacaoEsgoto+",";
				}
				
			}
			//Retirar Ultima Vigurla
			if(!idsSituacaoLigacaoEsgoto.trim().equals("")){
				idsSituacaoLigacaoEsgoto = idsSituacaoLigacaoEsgoto.substring(0,idsSituacaoLigacaoEsgoto.length()-1 );
				situacaoLigacaoEsgoto = idsSituacaoLigacaoEsgoto;
			}
			
		}
		
		String [] colecaoSituacaoLigacaoAgua = (String []) getParametro("colecaoSituacaoLigacaoAgua");
		
		String idsSituacaoLigacaoAgua = "";
		
		if(colecaoSituacaoLigacaoAgua != null){
			
			for (String idSituacaoAgua : colecaoSituacaoLigacaoAgua) {
				if(!idSituacaoAgua.equals(ConstantesSistema.NUMERO_NAO_INFORMADO)){
					idsSituacaoLigacaoAgua += idSituacaoAgua+",";
				}
				
			}
			//Retirar Ultima Vigurla
			if(!idsSituacaoLigacaoAgua.trim().equals("")){
				idsSituacaoLigacaoAgua = idsSituacaoLigacaoAgua.substring(0,idsSituacaoLigacaoAgua.length()-1 );
				situacaoAgua = idsSituacaoLigacaoAgua;
			}
			
		}
		
		// Colecao Perfil Imovel ID
		String [] colecaoPerfilImovelID = (String []) getParametro("colecaoPerfilImovelID");
		
		String idsPerfilImovelID = "";
		
		if(colecaoPerfilImovelID != null){
			
			for (String idPerfilImovel : colecaoPerfilImovelID) {
				if(!idPerfilImovel.equals(ConstantesSistema.NUMERO_NAO_INFORMADO)){
					idsPerfilImovelID += idPerfilImovel+",";
				}
			}
			//Retirar Ultima Vigurla
			if(!idsPerfilImovelID.trim().equals("")){
				idsPerfilImovelID = idsPerfilImovelID.substring(0,idsPerfilImovelID.length()-1 );
				perfilImovelID = idsPerfilImovelID;
			}
		}
		
		// Colecao categoria Imovel ID
		String [] colecaoCategoriaImovelID = (String []) getParametro("colecaoCategoriaImovelID");
		
		String idsCategoriaImovelID = "";
		
		if(colecaoCategoriaImovelID != null){
			
			for (String idCategoriaImovelID : colecaoCategoriaImovelID) {
				if(!idCategoriaImovelID.equals(ConstantesSistema.NUMERO_NAO_INFORMADO)){
					idsCategoriaImovelID += idCategoriaImovelID+",";
				}
			}
			//Retirar Ultima Vigurla
			if(!idsCategoriaImovelID.trim().equals("")){
				idsCategoriaImovelID = idsCategoriaImovelID.substring(0,idsCategoriaImovelID.length()-1 );
				categoriaImovelID = idsCategoriaImovelID;
			}
		}

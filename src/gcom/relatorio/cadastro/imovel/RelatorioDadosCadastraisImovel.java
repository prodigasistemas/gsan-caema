...
public class RelatorioDadosCadastraisImovel extends TarefaRelatorio {
	...
	private RelatorioDadosCadastraisImovelBean criarRelatorioBean() {
		...
		relatorioBean.setSubsistemaEsgotoDadosCadastrais(consultarImovelForm.getSubsistemaEsgotoDadosCadastrais());
		relatorioBean.setIndicadorImovelRateioNegativo(consultarImovelForm.getIndicadorImovelRateioNegativo());

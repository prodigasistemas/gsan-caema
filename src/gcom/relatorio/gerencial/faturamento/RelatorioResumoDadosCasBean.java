...
public class RelatorioResumoDadosCasBean implements RelatorioBean{
	...
	private BigDecimal percentualAnormalidadeHidrometro;
	...
	private BigDecimal indiceHidrometracaoFaturado;
	...
	public BigDecimal getIndiceHidrometracaoFaturado() {
		return indiceHidrometracaoFaturado;
	}
	public void setIndiceHidrometracaoFaturado(
			BigDecimal indiceHidrometracaoFaturado) {
		this.indiceHidrometracaoFaturado = indiceHidrometracaoFaturado;
	}
	public BigDecimal getPercentualAnormalidadeHidrometro() {
		return percentualAnormalidadeHidrometro;
	}
	public void setPercentualAnormalidadeHidrometro(
			BigDecimal percentualAnormalidadeHidrometro) {
		this.percentualAnormalidadeHidrometro = percentualAnormalidadeHidrometro;
	}

...
public class RelatorioAnaliseFaturamentoBean implements RelatorioBean {
	...
	private Long quantidadeConta;
	
	private Long quantidadeEconomia;
	
	private Long volumeConsumidoAgua;
	
	private BigDecimal valorFaturadoAgua;
	
	private Long volumeColetadoEsgoto;
	...
	public RelatorioAnaliseFaturamentoBean(String descricao,
			Long quantidadeConta, Long quantidadeEconomia,
			Long volumeConsumidoAgua, BigDecimal valorFaturadoAgua,
			Long volumeColetadoEsgoto, BigDecimal valorFaturadoEsgoto,
	...
	public Long getQuantidadeConta() {
		return quantidadeConta;
	}

	public void setQuantidadeConta(Long quantidadeConta) {
		this.quantidadeConta = quantidadeConta;
	}

	public Long getQuantidadeEconomia() {
		return quantidadeEconomia;
	}

	public void setQuantidadeEconomia(Long quantidadeEconomia) {
		this.quantidadeEconomia = quantidadeEconomia;
	}

	public Long getVolumeConsumidoAgua() {
		return volumeConsumidoAgua;
	}

	public void setVolumeConsumidoAgua(Long volumeConsumidoAgua) {
		this.volumeConsumidoAgua = volumeConsumidoAgua;
	}

	public Long getVolumeColetadoEsgoto() {
		return volumeColetadoEsgoto;
	}

	public void setVolumeColetadoEsgoto(Long volumeColetadoEsgoto) {
		this.volumeColetadoEsgoto = volumeColetadoEsgoto;
	}

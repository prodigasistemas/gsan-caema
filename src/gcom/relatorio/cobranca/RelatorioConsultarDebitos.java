...
public class RelatorioConsultarDebitos extends TarefaRelatorio {
	...
	private Collection<RelatorioConsultarDebitosBean> inicializarBeanRelatorio(
		...
		String valorTotalGeralDebitos = (String) getParametro("valorTotalGeralDebitos");
		String valorTotalGeralDebitosAtualizado = (String) getParametro("valorTotalGeralDebitosAtualizado");
		...
		if (colecaoContratoParcelamentoClienteResp != null 
			...
			this.adicionarAoUltimo(retorno,colecaoContratoParcelamentoClienteResp,relatorioEndereco);
		}
		...
		if (colecaoContratoParcelamentoClienteRespParcAVencer != null 
			...
			this.adicionarSubRelatorioParcAVencer(retorno, colecaoContratoParcelamentoClienteRespParcAVencer, relatorioEndereco);
			
			if (valorTotalDebitos != null) {
				
				RelatorioConsultarDebitosBean bean = new RelatorioConsultarDebitosBean();
				bean.setValorTotalGeralDebitos("R$" + valorTotalGeralDebitos);
				bean.setValorTotalGeralDebitosAtualizado("R$" + valorTotalGeralDebitosAtualizado);
	...
	private void adicionarAoUltimo(
			Collection<RelatorioConsultarDebitosBean> retorno,
			Collection<ContratoParcelamentoClieRespHelper> colecaoContratoParcelamentoClienteResp, String relatorioEndereco) {

			Iterator construtor = colecaoContratoParcelamentoClienteResp.iterator();
			
			List<RelatorioConsultarDebitosContratoSubBean> colecaoSubBean = new ArrayList<RelatorioConsultarDebitosContratoSubBean>();
			
			while(construtor.hasNext()){
				ContratoParcelamentoClieRespHelper helper = (ContratoParcelamentoClieRespHelper)construtor.next();
				
				RelatorioConsultarDebitosContratoSubBean subBean = new RelatorioConsultarDebitosContratoSubBean();
				
				subBean.setContrato(helper.getContrato());
				subBean.setParcela(helper.getParcelaFormatada());
				subBean.setValidade(helper.getDataVencimento());
				subBean.setValor(helper.getValor());
				
				if (relatorioEndereco != null
						&& !relatorioEndereco.trim().equals("")) {
					
					subBean.setIdCliente(helper.getIdCliente());
					subBean.setNomeCliente(helper.getNomeCliente());
					
					String endereco = Fachada.getInstancia()
							.pesquisarEnderecoClienteAbreviado(helper.getIdCliente());
					
					subBean.setEnderecoCliente(endereco);
			...
			RelatorioConsultarDebitosBean bean = new RelatorioConsultarDebitosBean();
			bean.setArrayJRContratos(colecaoSubBean);
			retorno.add(bean);
		
	}

	
	private void adicionarSubRelatorioParcAVencer(
			Collection<RelatorioConsultarDebitosBean> retorno,
			Collection<ContratoParcelamentoClieRespHelper> colecaoContratoParcelamentoClienteRespParcAVencer, String relatorioEndereco) {

			Iterator construtor = colecaoContratoParcelamentoClienteRespParcAVencer.iterator();
			...
			RelatorioConsultarDebitosBean bean = new RelatorioConsultarDebitosBean();
			bean.setArrayJRContratosAVencer(colecaoSubBean);
			retorno.add(bean);
	...
	public Object executar() throws TarefaException {
		...
		Collection colecaoContratoParcelamentoClienteResp = (Collection) getParametro("colecaoContratoParcelamentoClienteResp");
		Collection colecaoContratoParcelamentoClienteRespParcAVencer = (Collection) getParametro("colecaoContratoParcelamentoClienteRespParcAVencer");
		String pesquisaCliente = (String) getParametro("pesquisaCliente");
		String relatorioEndereco = (String) getParametro("relatorioEndereco");
		String codigoCliente = (String) getParametro("codigoCliente");
		String nomeCliente = (String) getParametro("nomeCliente");
		...
		Collection<RelatorioConsultarDebitosBean> colecaoBean = this
				.inicializarBeanRelatorio(colecaoContaValores,
						...
						colecaoContratoParcelamentoClienteResp, 
						colecaoContratoParcelamentoClienteRespParcAVencer);

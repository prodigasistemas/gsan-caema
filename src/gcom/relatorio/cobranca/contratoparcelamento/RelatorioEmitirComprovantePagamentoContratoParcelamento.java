...
public class RelatorioEmitirComprovantePagamentoContratoParcelamento extends TarefaRelatorio {
	...
	public Object executar() throws TarefaException {
		...
		Collection<SistemaParametro> colecaoSistemaParametro = fachada.pesquisar(filtroSistemaParametro,SistemaParametro.class.getName());		
	...
	private RelatorioDataSource montarBeans(String parcelaInicial, Fachada fachada, ArrayList<PrestacaoItemContratoParcelamento> prestacoes) {
		ArrayList<RelatorioEmitirComprovantePagamentoContratoParcelamentoBean> beans = new ArrayList<RelatorioEmitirComprovantePagamentoContratoParcelamentoBean>();
		Iterator<PrestacaoItemContratoParcelamento> it = prestacoes.iterator();
		while(it.hasNext()){
	...
	private Map<String, Object> emitirCabecalho(ContratoParcelamentoCliente contratoParcelamentoCliente, Map<String, Object> parametros, SistemaParametro sistemaParametro, String ocultarParcela) {
		...
		//Linha 2
		if (contratoParcelamentoCliente.getContrato().getNumero().compareTo(contratoParcelamentoCliente.getContrato().getId().toString()) == 0) {
			parametros.put("numeroContrato","SEM NÚMERO");
		} else {

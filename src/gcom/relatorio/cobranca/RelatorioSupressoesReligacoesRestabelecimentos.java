...
public class RelatorioSupressoesReligacoesRestabelecimentos extends TarefaRelatorio {
	...
	@Deprecated
	public RelatorioSupressoesReligacoesRestabelecimentos() {
		super(null, "");
	}
	...
	public Object executar() throws TarefaException {
		...
		if (filtro.getIndicadorTipoRelatorio() != 1){
		...
		byte[] retorno = this.gerarRelatorio(ConstantesRelatorios.RELATORIO_SUPRESSOES_RELIGACOES_REESTABELECIMENTOS,
				parametros, new RelatorioDataSource(beans), tipoFormatoRelatorio);
		
		// ------------------------------------
		// Grava o relatório no sistema
		try {
			persistirRelatorioConcluido(retorno, Relatorio.RELATORIO_SUPRESSOES_RELIGACOES_REESTABELECIMENTOS,
	...
	public int calcularTotalRegistrosRelatorio() {
		...
		FiltroSupressoesReligacoesReestabelecimentoHelper filtro = 
				(FiltroSupressoesReligacoesReestabelecimentoHelper) getParametro("filtroSupressoesReligacoesReestabelecimentos");

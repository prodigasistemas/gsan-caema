		...
		private ArrayList<RelatorioBoletimMedicaoRecuperacaoCreditosBean> montarRelatorio(
			...
			while(it.hasNext()){
				...
				if(helper.getValorPagamentoAVista() != null)
					...
					bean.setPagoOriginal(new BigDecimal("0"));
				...
				bean.setValorPagamentoAVista(valorAVistaMenosDesconto);
				...
				subBean.setValorOriginal(bean.getPagoOriginal());
				...
				subBeanTotalGeral.setValorOriginal(bean.getPagoOriginal());

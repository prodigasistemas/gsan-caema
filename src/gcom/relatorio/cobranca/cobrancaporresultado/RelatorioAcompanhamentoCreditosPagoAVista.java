...
public class RelatorioAcompanhamentoCreditosPagoAVista extends TarefaRelatorio {
		...
		private ArrayList<RelatorioAcompanhamentoCreditosPagosAVistaBean> montarRelatorio(
			...
			while(it.hasNext()){
				...
				bean.setPagoOriginal(helper.getValorPagamentoAVista());
				...
				BigDecimal valorAVistaMenosDesconto = Util.subtrairBigDecimal(bean.getPagoOriginal(), bean.getValorDesconto());
				
				bean.setValorPago(valorAVistaMenosDesconto);
				bean.setPorPagoPrestadora((valorAVistaMenosDesconto.multiply(bean.getPercentualFaixa())).divide(new BigDecimal("100"),2,BigDecimal.ROUND_HALF_EVEN));
				...
				subBean.setPagoOriginal(bean.getPagoOriginal());
				subBean.setPorPagoPrestadora(bean.getPorPagoPrestadora());
				...
				subBeanTotalGeral.setPagoOriginal(bean.getPagoOriginal());
				subBeanTotalGeral.setPorPagoPrestadora(bean.getPorPagoPrestadora());

...
public class RelatorioAcompanhamentoParcelamentosRecuperacaoCreditos extends TarefaRelatorio {
		...
		private ArrayList<RelatorioAcompanhamentoParcelamentosRecuperacaoCreditosBean> montarRelatorio(
			...
			while(it.hasNext()){
				...
				bean.setQtdParcelasAberto(new Integer(helper.getQuantidadeParcelasEmAberto().intValue()
													+ helper.getQuantidadeParcelasEmAbertoHist().intValue()));
				bean.setSaldoAberto(helper.getSaldoEmAberto()
								.add(helper.getSaldoEmAbertoHist()));

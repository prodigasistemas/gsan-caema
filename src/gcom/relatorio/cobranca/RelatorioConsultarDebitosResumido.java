...
public class RelatorioConsultarDebitosResumido extends TarefaRelatorio {
	...
	private Collection<RelatorioConsultarDebitosResumidoBean> inicializarBeanRelatorio(
		...
		if(valorGuiasCliente != null) {
			parametros.put("valorGuiasCliente", 
		...
		if (colecaoContratoParcelamentoClienteResp != null 
			...
			this.adicionarAoUltimo(retorno,colecaoContratoParcelamentoClienteResp);
		}

		if (colecaoContratoParcelamentoClienteRespParcAVencer != null 
				&& !colecaoContratoParcelamentoClienteRespParcAVencer.isEmpty()) {
			this.adicionarSubRelatorioParcAVencer(retorno,colecaoContratoParcelamentoClienteRespParcAVencer);
		}
	...
	private void adicionarAoUltimo(
			Collection<RelatorioConsultarDebitosResumidoBean> retorno,
			Collection<ContratoParcelamentoClieRespHelper> colecaoContratoParcelamentoClienteResp) {
			...
			while(it.hasNext()){
				...
				RelatorioConsultarDebitosResumidoBean bean = (RelatorioConsultarDebitosResumidoBean)it.next();
				
				if(contador == retorno.size())
	...
	public Object executar() throws TarefaException {
		...
		Collection<ContratoParcelamentoClieRespHelper> colecaoContratoParcelamentoClienteResp = (Collection<ContratoParcelamentoClieRespHelper>) getParametro("colecaoContratoParcelamentoClienteResp");
		Collection<ContratoParcelamentoClieRespHelper> colecaoContratoParcelamentoClienteRespParcAVencer = (Collection<ContratoParcelamentoClieRespHelper>) getParametro("colecaoContratoParcelamentoClienteRespParcAVencer");
		...
		parametros.put("valorTotalDebitos", "R$" + valorTotalDebitos);
		parametros.put("valorTotalDebitosAtualizado", "R$" + valorTotalDebitosAtualizado);

		if (colecaoContratoParcelamentoClienteRespParcAVencer != null 
				&& !colecaoContratoParcelamentoClienteRespParcAVencer.isEmpty()) {
			parametros.put("valorTotalGeralDebitos", "R$" + valorTotalGeralDebitos);
			parametros.put("valorTotalGeralDebitosAtualizado", "R$" + valorTotalGeralDebitosAtualizado);
		}
		...
		Collection<RelatorioConsultarDebitosResumidoBean> colecaoBean = this
				.inicializarBeanRelatorio(colecaoContaValores,
						...
						colecaoGuiaPagamento,colecaoContratoParcelamentoClienteResp, 

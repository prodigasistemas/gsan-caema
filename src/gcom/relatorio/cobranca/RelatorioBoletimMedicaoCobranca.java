...
public class RelatorioBoletimMedicaoCobranca extends TarefaRelatorio {
	...
	public Object executar() throws TarefaException {
		...
		Collection<Integer> penalidades = fachada
				.pesquisarNaoPenalidades(Integer.parseInt(relatorioHelper.getGrupoCobranca()), Integer.parseInt(relatorioHelper.getMesAnoReferencia()));
		...
		if (colecaoBean == null || colecaoBean.isEmpty()) {
			...
			if(boletinsPenalidades !=null && !boletinsPenalidades.isEmpty()){
				RelatorioBoletimMedicaoCobrancaBean bean = (RelatorioBoletimMedicaoCobrancaBean) Util.retonarObjetoDeColecao(colecaoBean);
				bean.setArrayRelatorioBoletimPenalidades(boletinsPenalidades);
	...
	private Collection<RelatorioBoletimMedicaoCobrancaBean> inicializarBeanRelatorioExecutado(
		...
		if (colecaoHelper != null && !colecaoHelper.isEmpty()) {
			...
			while (iterator.hasNext()) {
				...
				Object[] valores = null;
				BigDecimal valorUnitario = BigDecimal.ZERO, valorItem = BigDecimal.ZERO;
				String quantidade = "";
				String unidade = "";				

		...
		if (colecaoNovos != null && !colecaoNovos.isEmpty()) {
			...
			while(it.hasNext()){
				...
				if (negativadorMovimentoReg.getNumeroCnpj() != null ) {
					cpfCnpj = Util.formatarCnpj(negativadorMovimentoReg.getNumeroCnpj());
				}else if(negativadorMovimentoReg.getNumeroCpf() != null){
					cpfCnpj = Util.formatarCpf(negativadorMovimentoReg.getNumeroCpf());
				}
...
//					parametros.put("negativador", negativador.getCliente().getNome());
		...
		if (parametrosHelper.getPeriodoEnvioNegativacaoInicio() != null) {
			retorno.setPeriodoEnvioNegativacao(Util.formatarData(parametrosHelper.getPeriodoEnvioNegativacaoInicio()) + " à " + Util.formatarData(parametrosHelper.getPeriodoEnvioNegativacaoFim()));
		} else {
		...
		if (parametrosHelper.getColecaoCobrancaGrupo() != null) {
			...
			while(itt.hasNext()){
				...
				if(cobrancaGrupo!=null && !cobrancaGrupo.getId().toString().trim().equalsIgnoreCase("-1")){
					if (primeiro) {
		...
		if (parametrosHelper.getColecaoGerenciaRegional() != null) {
			...
			while(itt.hasNext()){
				...
				if(gerenciaRegional!=null && !gerenciaRegional.getId().toString().trim().equalsIgnoreCase("-1")){
					if (primeiro) {
		...
		if (parametrosHelper.getColecaoUnidadeNegocio() != null) {
			...
			while(itt.hasNext()){
				...
				if(unidadeNegocio!=null && !unidadeNegocio.getId().toString().trim().equalsIgnoreCase("-1")){
					if (primeiro) {
		...
		if (parametrosHelper.getColecaoImovelPerfil() != null) {
			...
			while(itt.hasNext()){
				...
				if(imovelPerfil!=null && !imovelPerfil.getId().toString().trim().equalsIgnoreCase("-1")){
					if (primeiro) {
		...
		if (parametrosHelper.getColecaoCategoria() != null) {
			...
			while(itt.hasNext()){
				...
				if(categoria!=null && !categoria.getId().toString().trim().equalsIgnoreCase("-1")){
					if (primeiro) {
		...
		if (parametrosHelper.getColecaoClienteTipo() != null) {
			...
			while(itt.hasNext()){
				...
				if(clienteTipo!=null && !clienteTipo.getId().toString().trim().equalsIgnoreCase("-1")){
					if (primeiro) {
		...
		if (parametrosHelper.getColecaoEsferaPoder() != null) {
			...
			while(itt.hasNext()){
				...
				if(esferaPoder!=null && !esferaPoder.getId().toString().trim().equalsIgnoreCase("-1")){
					if (primeiro) {
		...
		if (parametrosHelper.getColecaoLigacaoAguaSituacao() != null) {
			...
			while(itt.hasNext()){
				...
				if(ligacaoAguaSituacao!=null && !ligacaoAguaSituacao.getId().toString().trim().equalsIgnoreCase("-1")){
					if (primeiro) {
		...
		if (parametrosHelper.getColecaoLigacaoEsgotoSituacao() != null) {
			...
			while(itt.hasNext()){
				...
				if(ligacaoEsgotoSituacao != null && !ligacaoEsgotoSituacao.getId().toString().trim().equalsIgnoreCase("-1")){
					if (primeiro) {

...
public class RelatorioComandosAcaoCobrancaEventual extends TarefaRelatorio{
	...
	public Object executar() throws TarefaException {
		...
		Collection colecaoCobrancaAcaoAtividadeEventual = (Collection) getParametro("colecaoCobrancaAcaoAtividadeEventual");
		
		
		if (colecaoCobrancaAcaoAtividadeEventual != null){
			for (Iterator colecaoCobrancaAcaoAtividadeIterator = colecaoCobrancaAcaoAtividadeEventual.iterator(); colecaoCobrancaAcaoAtividadeIterator
					.hasNext();) {
	...
	public int calcularTotalRegistrosRelatorio() {
		...
		if (colecaoCobrancaAcaoAtividadeEventual != null){
			retorno = colecaoCobrancaAcaoAtividadeEventual.size();
		}

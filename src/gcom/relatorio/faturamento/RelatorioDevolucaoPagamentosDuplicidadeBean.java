...
public class RelatorioDevolucaoPagamentosDuplicidadeBean implements RelatorioBean {
	...
	private BigDecimal valorGuiaDevolucao;
	...
	public RelatorioDevolucaoPagamentosDuplicidadeBean(String gerencia, String nomeGerencia, 
			...
			BigDecimal creditoRealizado, BigDecimal creditoARealizar, BigDecimal valorGuiaDevolucao, String dataAtualizacao) {
	...
	public BigDecimal getValorGuiaDevolucao() {
		return valorGuiaDevolucao;
	}

	public void setValorGuiaDevolucao(BigDecimal valorGuiaDevolucao) {
		this.valorGuiaDevolucao = valorGuiaDevolucao;
	}

...
public class RelatorioDevolucaoPagamentosDuplicidade extends TarefaRelatorio {
	...
	public Object executar() throws TarefaException {
		...
		String tipoEspecificacao = (String) getParametro("tipoEspecificacao");
		String motivoDevolucao = (String) getParametro("motivoDevolucao");
		String tipoDocumento = (String) getParametro("tipoDocumento");
		...
		parametros.put("tipoEspecificacao", tipoEspecificacao);
		parametros.put("motivoDevolucao", motivoDevolucao);

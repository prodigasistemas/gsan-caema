...
public class Relatorio2ViaContaBoletoBancarioBean implements RelatorioBean {
	...
	private String mensagemConsumoStringBoleto;
	...
	public Relatorio2ViaContaBoletoBancarioBean(
		...
		this.somaValorAguaEsgotoBoleto = emitirContaHelper.getSomaValorAguaEsgotoBoleto();
		this.valorImpostoPisBoleto = emitirContaHelper.getValorImpostoPisBoleto();
		this.valorImpostoConfinsBoleto = emitirContaHelper.getValorImpostoConfinsBoleto();
		this.mensagemConsumoStringBoleto = emitirContaHelper.getMensagemConsumoString();
		this.dataVencimentoBoleto = Util.formatarData(emitirContaHelper.getDataVencimentoConta());
	...
	public String getMensagemConsumoStringBoleto() {
		return mensagemConsumoStringBoleto;
	}

	public void setMensagemConsumoStringBoleto(String mensagemConsumoStringBoleto) {
		this.mensagemConsumoStringBoleto = mensagemConsumoStringBoleto;
	}

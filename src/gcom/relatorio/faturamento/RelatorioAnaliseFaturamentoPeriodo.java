...
public class RelatorioAnaliseFaturamentoPeriodo extends TarefaRelatorio {
	...
	@Deprecated
	public RelatorioAnaliseFaturamentoPeriodo() {
		super(null, "");
	}
	/**
	 * < <Descrição do método>>
	...
	public Object executar() throws TarefaException {
		...
		Long quantidadeConta = new Long(0);
		
		Long quantidadeEconomia = new Long(0);
		
		Long volumeConsumidoAgua = new Long(0);
		
		Long volumeColetadoEsgoto = new Long(0);
		...
		if( retornoConsulta != null && !retornoConsulta.equals("")
			...
			for (Object[] retornoObject : retornoConsulta) {
					...
					if((Long)retornoObject[0] != null)
					{
						quantidadeConta = ((Long)retornoObject[0]);
					}
					if((Long)retornoObject[1] != null)
					{
						quantidadeEconomia = ((Long)retornoObject[1]);
					}
					if((Long)retornoObject[2] != null)
					{
						volumeConsumidoAgua = ((Long)retornoObject[2]);
					}
					...
					if((Long)retornoObject[4] != null)
					{
						volumeColetadoEsgoto = ((Long)retornoObject[4]);
					}
		...
		try {
			persistirRelatorioConcluido(retorno, 
				Relatorio.RELATORIO_ANALISE_FATURAMENTO_PERIODO, 
	...
	public void agendarTarefaBatch() {
		...
		AgendadorTarefas.agendarTarefa("RelatorioAnaliseFaturamentoPeriodo", this);
	}

...
public class RelatorioFiltrarRegistroAtendimentoCoordenadasSemLogradouro extends TarefaRelatorio {
	...
	public Object executar() throws TarefaException {
		...
		String grupoAtendimento = "Grupo Atendimento: TODOS ";
		
		if(filtroRA.getColecaoTipoSolicitacaoGrupo() != null && !filtroRA.getColecaoTipoSolicitacaoGrupo().isEmpty()) {
			grupoAtendimento = "Grupo Atendimento: ";
			
			FiltroSolicitacaoTipoGrupo filtro = new FiltroSolicitacaoTipoGrupo();
			filtro.setCampoOrderBy(FiltroSolicitacaoTipoGrupo.DESCRICAO);
			Collection<SolicitacaoTipoGrupo> pesquisa = fachada.pesquisar(filtroRA.getColecaoTipoSolicitacaoGrupo(), filtro, SolicitacaoTipoGrupo.class.getName());
			
			for (SolicitacaoTipoGrupo solicitacaoTipoGrupo : pesquisa) {
				grupoAtendimento += solicitacaoTipoGrupo.getDescricao() + "; ";
			}
		}		
		...
		parametros.put("grupoAtendimento", grupoAtendimento);

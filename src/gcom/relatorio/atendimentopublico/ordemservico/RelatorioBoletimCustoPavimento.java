...
import gcom.atendimentopublico.ordemservico.bean.OrdemServicoRepavimentacaoHelper;
...
public class RelatorioBoletimCustoPavimento extends TarefaRelatorio {
	...
	public Object executar() throws TarefaException {
		...
		OrdemServicoRepavimentacaoHelper osRepavimentacaoHelper = null;
		...
		if(relatorioHelper.getIndicadorTipoBoletim().equals("1")){
			...
			if (colecao != null && !colecao.isEmpty()) {
				...
				for (RelatorioBoletimCustoPavimentoHelper helper : colecao) {
					...
					if(Util.isVazioOrNulo(helper.getCollOSRepavimentacaoHelper())){
						relatorioBean = 
						...
						Iterator<?> it = helper.getCollOSRepavimentacaoHelper().iterator();
						while(it.hasNext()){
							osRepavimentacaoHelper = (OrdemServicoRepavimentacaoHelper) it.next();
							...
							relatorioBean.setIndicadorPrimeiraOcorrenciaDemandadas3Meses(indicadorPrimeiraOcorrenciaDemandadas3Meses);
							relatorioBean.setIndicadorPrimeiraOcorrenciaAceitas(indicadorPrimeiraOcorrenciaAceitas);
							relatorioBean.setDescricaoServico(osRepavimentacaoHelper.getDescricaoServico());
							relatorioBean.setQuantidadeServico(osRepavimentacaoHelper.getQuantidadeServico());
							relatorioBean.setValorUnitarioServico(osRepavimentacaoHelper.getValorUnitarioServico());
							relatorioBean.setValorServico(osRepavimentacaoHelper.getValorServico());

	...
	public Object executar() throws TarefaException {
		...
		if (collOrdemServicoPavimentoHelper != null && !collOrdemServicoPavimentoHelper.isEmpty()) {
			...
			for (OSPavimentoRetornoHelper oSPavimentoRetornoHelper : collOrdemServicoPavimentoHelper) {
				...
				// Outros Custos
				BigDecimal outrosCustos = null;				
				if (oSPavimentoRetornoHelper.getOrdemServicoPavimento() != null && oSPavimentoRetornoHelper.getOrdemServicoPavimento().getOutrosCustos()!= null) {
					outrosCustos =oSPavimentoRetornoHelper.getOrdemServicoPavimento().getOutrosCustos();
				}
		...
		if(oSPavimentoHelperParametros.getPeriodoEnvioOsInicial()!= null && oSPavimentoHelperParametros.getPeriodoEnvioOsFinal()!= null){
			periodoEncerramentoOs = oSPavimentoHelperParametros.getPeriodoEnvioOsInicial() + "-" +
			oSPavimentoHelperParametros.getPeriodoEnvioOsFinal();

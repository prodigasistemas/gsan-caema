...
public class RelatorioOrdemFiscalizacaoOnline extends TarefaRelatorio {
	...
	public Object executar() throws TarefaException {
		...
		Collection<EmitirOrdemFiscalizacaoForm> colecaoDados = (Collection<EmitirOrdemFiscalizacaoForm>) getParametro("colecaoForm");
		
		if ( dados != null && !dados.equals("") ) {
			colecaoDados = new ArrayList();
		...
		while(iteratorDados.hasNext()) {
			...
			dados = (EmitirOrdemFiscalizacaoForm) iteratorDados.next();

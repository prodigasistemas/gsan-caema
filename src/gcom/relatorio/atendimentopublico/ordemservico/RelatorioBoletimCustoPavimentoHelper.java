...
public class RelatorioBoletimCustoPavimentoHelper implements Serializable {
	...
	private Collection collOSRepavimentacaoHelper;
	...
	public Collection getCollOSRepavimentacaoHelper() {
		return collOSRepavimentacaoHelper;
	}

	public void setCollOSRepavimentacaoHelper(Collection collOSRepavimentacaoHelper) {
		this.collOSRepavimentacaoHelper = collOSRepavimentacaoHelper;
	}

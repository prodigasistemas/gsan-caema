...
public class ImovelEmissaoOrdensSeletivasHelper {
	...
	private ArrayList<ComandoOsSetor> comandoOsSetor;
	...
	public ArrayList<ComandoOsSetor> getComandoOsSetor() {
		return comandoOsSetor;
	}

	public void setComandoOsSetor(ArrayList<ComandoOsSetor> comandoOsSetor) {
		this.comandoOsSetor = comandoOsSetor;
	}

...
//			for (Integer idImovel : colecaoIdsImoveis) {
	    ...
	    */
		...
		if(relatorioBeans !=null && !relatorioBeans.isEmpty()){
			...
			ArrayList<RelatorioEmitirOrdemServicoSeletivaAnaliticoBean> beansVazios = new ArrayList<RelatorioEmitirOrdemServicoSeletivaAnaliticoBean>();
			RelatorioEmitirOrdemServicoSeletivaAnaliticoBean beanVazio = new RelatorioEmitirOrdemServicoSeletivaAnaliticoBean();
			beansVazios.add(beanVazio);
			
			RelatorioDataSource ds = new RelatorioDataSource(beansVazios);

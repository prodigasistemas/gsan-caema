...
public class RelatorioTiposServicoBean implements RelatorioBean{
	...
	public RelatorioTiposServicoBean(String codigo, String tipoServico, String perfilImovel,
		String categoriaSubcategoria, String descricao, String economiasInicial, String economiasFinal, 
		String valor, String dataVigenciaInicial, String dataVigenciaFinal){
		...
		this.setValor(valor);
		this.setDataVigenciaInicial(dataVigenciaInicial);
		this.setDataVigenciaFinal(dataVigenciaFinal);
	}

...
public class RelatorioComandosConexaoEsgotoSintetico extends TarefaRelatorio {

	private static final long serialVersionUID = 1L;
	
	public RelatorioComandosConexaoEsgotoSintetico(Usuario usuario) {
		super(usuario, ConstantesRelatorios.RELATORIO_COMANDOS_CONEXAO_ESGOTO_SINTETICO);
	}

	@Deprecated
	public RelatorioComandosConexaoEsgotoSintetico() {
		super(null, "");
	}
	...
	public Object executar() throws TarefaException {
		...
		Collection<RelatorioComandosConexaoEsgotoHelper> colecaoHelperBean =
				fachada.pesquisarDadosRelatorioComandosConexaoEsgotoSintetico(helperFiltro);
		...
		retorno = gerarRelatorio(ConstantesRelatorios.RELATORIO_COMANDOS_CONEXAO_ESGOTO_SINTETICO,
	...
	private List<RelatorioComandosConexaoEsgotoBean> montarRelatorio(
		...
		while(iterator.hasNext()){
			...
			bean.setQuantidadeOS(helper.getQuantidadeOS());
			if (helper.getIdMotivoEncerramento() != null) {
				bean.setIdMotivoEncerramento(helper.getIdMotivoEncerramento().toString());
			}

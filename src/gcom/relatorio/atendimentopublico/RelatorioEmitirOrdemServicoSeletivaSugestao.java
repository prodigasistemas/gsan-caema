...
public class RelatorioEmitirOrdemServicoSeletivaSugestao extends TarefaRelatorio {
	...
	public Object executar() throws TarefaException {
		...
		if ( helper.getTipoEmissao().equals("SINTETICO") &&
			...
			(helper.getComandoOsSetor() !=null && !helper.getComandoOsSetor().isEmpty())
			){
		...
		else if ( helper.getTipoEmissao().equals("SINTETICO") &&
				(colecaoDadosRelatorio != null && !colecaoDadosRelatorio.isEmpty() ) &&			
	...
	private ImovelEmissaoOrdensSeletivasHelper gerarObjetoHelper() {
		...
		helper.setComandoOsSetor((ArrayList<ComandoOsSetor>) getParametro("comandosOsSetor"));
		...
		helper.setIndicadorMedicaoTelemedido((String) getParametro("indicadorMedicaoTelemedido"));
	...
	private RelatorioEmitirOrdemServicoSeletivaSugestaoBean gerarRelatorioBean(
		...
		if(helper.getTipoOrdem().equals(ImovelEmissaoOrdensSeletivasActionForm.TIPO_INSTALACAO_CAIXA_PROTECAO)){
			relatorioEmitirOrdemServicoSeletivaSugestaoBean.setDescricaoTipoServico("INSTALAÇÃO DE CAIXA DE PROTEÇÃO");
		}else{
		...
		/*relatorioEmitirOrdemServicoSeletivaSugestaoBean.setNomeLocalidadeInicial("");
		relatorioEmitirOrdemServicoSeletivaSugestaoBean.setNomeLocalidadeFinal("");
		
		// Foi Solicitado o Codigo em vez do Nome
		relatorioEmitirOrdemServicoSeletivaSugestaoBean.setNomeSetorComercialInicial("");
		relatorioEmitirOrdemServicoSeletivaSugestaoBean.setNomeSetorComercialFinal("");
		
		relatorioEmitirOrdemServicoSeletivaSugestaoBean.setQuadraInicial("");
		relatorioEmitirOrdemServicoSeletivaSugestaoBean.setQuadraFinal("");*/
	...
	private List gerarRelatorioBeanAgrupadoLocalidadeOuSetor(
		...
		//Preenche o BEAN do Relatorio
		if(helper.getComandoOsSetor() == null || helper.getComandoOsSetor().isEmpty()){
			if ((helper.getLocalidadeInicial() == null && helper.getLocalidadeFinal() == null) ||
				(helper.getLocalidadeInicial().equalsIgnoreCase("") && helper.getLocalidadeFinal().equalsIgnoreCase("")) ||
				(helper.getLocalidadeInicial() != null && (!helper.getLocalidadeFinal().equals(helper.getLocalidadeInicial())))){
				String idLocalidade  = "";
				String desLocalidade = "";
				if(colecaoDados.get("idLocalidade")	!= null){
					idLocalidade = colecaoDados.get("idLocalidade").toString();
				}
				if(colecaoDados.get("desLocalidade")	!= null){
					desLocalidade = colecaoDados.get("desLocalidade").toString();
				}
				relatorioEmitirOrdemServicoSeletivaSugestaoBean.setIdLocalidade(idLocalidade);
				relatorioEmitirOrdemServicoSeletivaSugestaoBean.setDesLocalidade(desLocalidade);

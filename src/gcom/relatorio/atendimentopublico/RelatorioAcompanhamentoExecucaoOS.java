...
public class RelatorioAcompanhamentoExecucaoOS extends TarefaRelatorio {
	...
	public Object executar() throws TarefaException {
		...
		Date periodoExecucaoInicial = (Date) getParametro("periodoExecucaoInicial");
		Date periodoExecucaoFinal = (Date) getParametro("periodoExecucaoFinal");
		...
		Collection colecaoOSRelatorioAcompanhamentoExecucaoHelper = fachada
				.pesquisarOSGerarRelatorioAcompanhamentoExecucao(origemServico,
						...
						periodoExecucaoInicial, periodoExecucaoFinal,
		...
		if (periodoExecucaoInicial != null) {
			String periodoExecucaoInicialFormatado = Util
					.formatarData(periodoExecucaoInicial);
			String periodoExecucaoFinalFormatado = Util
					.formatarData(periodoExecucaoFinal);
			periodoExecucao = periodoExecucaoInicialFormatado + " a "
					+ periodoExecucaoFinalFormatado;
			parametros.put("periodoExecucao", periodoExecucao);
		} else {
			parametros.put("periodoExecucao", periodoExecucao);
		}
	...
	public int calcularTotalRegistrosRelatorio() {
		...
		retorno = fachada.pesquisarOSGerarRelatorioAcompanhamentoExecucaoCount(
				...
				periodoAtendimentoInicial, periodoAtendimentoFinal,
				periodoEncerramentoInicial, periodoEncerramentoFinal, periodoExecucaoInicial,
				periodoExecucaoFinal, idEquipeProgramacao, idEquipeExecucao);

...
public class ConstantesRelatorios {
	...
	public static final String RELATORIO_PAGAMENTOS_ABASTECIMENTOS_CARROS_PIPA = "/relatorioPagamentosAbastecimentosCarrosPipa.jasper";
	...
	public static final String RELATORIO_ACOMPANHAMENTO_OS_COBRANCA_ANALITICO = "/relatorioAcompanhamentoOSCobrancaAnalitico.jasper";
	
	public static final String RELATORIO_ACOMPANHAMENTO_OS_COBRANCA_SINTETICO = "/relatorioAcompanhamentoOSCobrancaSintetico.jasper";
	...
	public static final String RELATORIO_IMOVEIS_RATEIO_NEGATIVO = "/relatorioImoveisRateioNegativo.jasper";

	public static final String RELATORIO_SEGUNDA_VIA_CONTRATO_ADESAO_TACITA= "/relatorioSegundaViadeContratoAdesaoTacita.jasper";
	
	public static final String RELATORIO_PESQUISA_SATISFACAO_SINTETICO = "/relatorioPesquisaSatisfacaoSintetico.jasper";
	
	public static final String RELATORIO_PESQUISA_SATISFACAO_ANALITICO = "/relatorioPesquisaSatisfacaoAnalitico.jasper";
	
	public static final String RELATORIO_SORTEIO_PREMIOS= "/relatorioSorteioPremios.jasper";
	
	public static final String RELATORIO_SORTEIO_PREMIOS_ARQUIVO_TEXTO = "RelatorioSorteioPremiosArquivoTexto";
		
	public static final String RELATORIO_IMOVEIS_CORTADOS = "/relatorioImoveisCortados.jasper";
	
	public static final String RELATORIO_DADOS_KIT_CAS_SERVICOS = "/relatorioDadosKitCASServico.jasper"; 
	
	public static final String RELATORIO_QUANTITATIVO_CONTAS_REIMPRESSAS = "/relatorioQuantitativoContasReimpressas.jasper";
	
	public static final String RELATORIO_PAGAMENTO_PORTAL = "/relatorioPagamentosPortal.jasper";
	
	public static final String RELATORIO_IMOVEIS_INCONSISTENTES = "/relatorioImoveisInconsistentes.jasper";
	...
	public static final String RELATORIO_QUANTITATIVO_IMOVEIS_TIPO_SERVICO = "/relatorioQuantitativoImoveisTipoServico.jasper";
	...
	public static final String RELATORIO_RESUMO_POSICAO_ATUALIZACAO_CADASTRAL_PACOTE = "relatorioResumoPosicaoAtualizacaoCadastralPorPacote.jasper";
	
	public static final String RELATORIO_CLIENTE_VIRTUAL = "/relatorioClienteVirtual.jasper";
	
	public static final String RELATORIO_TIPO_SERVICO_MEIO = "/relatorioTipoServicoMeio.jasper";
	
	public static final String RELATORIO_TIPO_SERVICO_USUARIO = "/relatorioTipoServicoUsuario.jasper";
	
	public static final String RELATORIO_TIPO_SERVICO_LOCALIDADE = "/relatorioTipoServicoLocalidade.jasper";
	
	public static final String RELATORIO_CONSULTAR_CRITICAS_MOVIMENTO_ARRECADADORES = "/relatorioConsultaCriticasMovimentoArrecadadores.jasper";
	
	public static final String RELATORIO_MOVIMENTAR_OS_CONSULTAR_ANALITICO = "/relatorioMovimentarOSConsultarAnalitico.jasper";
	
	public static final String RELATORIO_MOVIMENTAR_OS_CONSULTAR_SINTETICO = "/relatorioMovimentarOSConsultarSintetico.jasper";

	public static final String RELATORIO_RETORNO_OS_FISCALIZACAO = "/relatorioRetornoOrdemServicoFiscalizacao.jasper";
	
	public static final String RELATORIO_COBRANCA_ATIVIDADE_MANTER = "/relatorioCobrancaAtividadeManter.jasper";
	
	public static final String RELATORIO_MOTIVO_NAO_AUTORIZACAO_MANTER = "/relatorioManterMotivoNaoAutorizacao.jasper";
	
	public static final String RELATORIO_MOTIVO_NAO_ACEITE_MANTER = "/relatorioManterMotivoNaoAceite.jasper";
	
	public static final String RELATORIO_COMPROVANTE_CADAST_SORTEIO = "relatorioComprovanteCadastramentoSorteio.jasper";	

	public static final String RELATORIO_SITUACAO_ESPECIAL_FATURAMENTO = "/relatorioSituacaoEspecialFaturamento.jasper";

	public static final String RELATORIO_MENSAGEM_CRITICA_ATUALIZACAO_INSCRICOES = "/relatorioMensagemCriticaAtualizacaoInscricoes.jasper";

	public static final String RELATORIO_CLIENTES_MESMO_CPF_CNPJ = "/relatorioClientesMesmoCpfCnpj.jasper";
	
	public static final String RELATORIO_VALIDAR_CLIENTE_RECEITA_FEDERAL = "/relatorioValidarDadosClienteReceitaFederal.jasper";
	
	public static final String RELATORIO_ANORMALIDADE_IMOVEIS_CORRIGIDOS = "/relatorioAnormalidadeImoveisCorrigidos.jasper";
	...
	public static final String RELATORIO_CPF_CNPJ_INCONSISTENTES_IMOVEIS_NOVOS = "/relatorioCpfCnpjInconsistentesImoveisNovos.jasper";
	...
	public static final String RELATORIO_EMITIR_RESUMO_PARCELAMENTO_JUDICIAL = "/relatorioResumoParcelamentoJudicial.jasper";
	
	public static final String RELATORIO_PARCELAS_EM_ATRASO_PARCELAMENTO_JUDICIAL = "/relatorioParcelasEmAtrasoParcelamentoJudicial.jasper";
	
	public static String RELATORIO_RESUMO_FATURAMENTO_PPP = "/relatorioResumoFaturamentoPpp.jasper";
	
	public static String RELATORIO_FATURAMENTO_PPP = "/relatorioFaturamentoPpp.jasper";
	
	public static final String RELATORIO_MANTER_SUBSISTEMA_ESGOTO = "/relatorioManterSubSistemaEsgoto.jasper";
	
	public static final String RELATORIO_ARQUIVOS_SUBSISTEMA_ESGOTO_ERRO = "/relatorioSubSistemaEsgotoErro.jasper";
	
	public static final String RELATORIO_RESUMO_IMOVEIS_ALTERACAO_INSCRICAO_VIA_BATCH = "/relatorioResumoImoveisAlteracaoInscricaoViaBatch.jasper";
	
	public static final String RELATORIO_ORDEM_SERVICO_CONEXAO_ESGOTO_BATCH = "/relatorioOrdemServicoConexaoEsgoto.jasper";
	
	public static final String RELATORIO_COMANDOS_CONEXAO_ESGOTO_SINTETICO = "/relatorioComandosConexaoEsgotoSintetico.jasper";
	
	public static final String RELATORIO_COMANDOS_CONEXAO_ESGOTO_ANALITICO = "/relatorioComandosConexaoEsgotoAnalitico.jasper";
	
	public static final String RELATORIO_IMOVEIS_CARTAS_NAO_IMPRESSAS = "/relatorioImoveisCartasNaoImpressas.jasper";
	
	public static final String RELATORIO_NATUREZA_EQUIPE_MANTER = "/relatorioManterNaturezaEquipe.jasper";
	
	public static final String RELATORIO_RESUMO_ACOES_ORDEM_SERVICO = "/relatorioResumoAcoesOrdemDeServico.jasper";
	
	public static final String RELATORIO_LOGRADOUROS_PARA_ATUALIZACAO = "/relatorioLogradourosParaAtualizacao.jasper";
	
	public static final String RELATORIO_ORDEM_CORTE_ONLINE_COMPENSACAO = "/relatorioOrdemCorteOnlineCompensacao.jasper";
	
	public static final String RELATORIO_ANALISE_INCONSISTESNCIAS_ATUALIZACAO_CADASTRAL = "/relatorioAnaliseInconsistenciasAtualizacaoCadastral.jasper";
	
	public static final String RELATORIO_IMOVEIS_LIGADOS_PARA_QUADRA_SEM_REDE = "/relatorioImoveisLigadosParaQuadraSemRede.jasper";
	
	public static final String RELATORIO_COBRANCA_POR_RESULTADO_POR_COMANDO_MES = "/relatorioCobrancaPorResultadoPorComandoMes.jasper";
	
	public static final String RELATORIO_MANTER_SUBSISTEMA_ABASTECIMENTO = "/relatorioManterSubsistemaAbastecimento.jasper";
	
	public static final String RELATORIO_AREA_OPERACIONAL_MANTER = "/relatorioManterAreaOperacional.jasper";
	public static final String RELATORIO_MANTER_SETOR_ABASTECIMENTO = "/relatorioManterSetorAbastecimento.jasper";
	
	public static final String RELATORIO_MANTER_DISTRITO_OPERACIONAL = "/relatorioManterDistritoOperacional.jasper";
	
	public static final String RELATORIO_IMOVEIS_SISTEMA_ABASTECIMENTO_ANALITICO = "/relatorioTotalizadorSistemaAbastecimentoAnalitico.jasper";
	public static final String RELATORIO_IMOVEIS_SISTEMA_ABASTECIMENTO_SINTETICO = "/relatorioTotalizadorSistemaAbastecimentoSintetico.jasper";

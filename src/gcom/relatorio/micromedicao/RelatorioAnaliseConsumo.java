		...
		if (colecaoAnaliseConsumoHelper != null && !colecaoAnaliseConsumoHelper.isEmpty()) {
			...
			while (iter.hasNext()) {
				...
				try {
					...
					//Inscrição Imóvel
					String inscricaoImovel = fachada.pesquisarInscricaoImovel(Integer.parseInt(relatorioAnaliseConsumoHelper.getMatriculaImovel()));
					...
					if(!colecaoObjeto.isEmpty()){
						...
						relatorioAnaliseConsumoBean.setInscricaoImovel(inscricaoImovel);

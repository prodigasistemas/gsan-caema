...
public class RelatorioComparativoLeiturasEAnormalidades extends TarefaRelatorio {
	...
	public Object executar() throws TarefaException {
		...
		String indicadorAnormalidadeImpactaLeitura = (String)getParametro("indicadorAnormalidadeImpactaLeitura");
		...
		Collection colecaoAnormalidadesLeiturasRelatorio = fachada
				.pesquisarAnormalidadesRelatorioComparativoLeiturasEAnormalidades(
						...
						idSetorInicial, idSetorFinal,
						idGerencia, idUnidadeNegocio, idLeiturista, idRotaInicial, idRotaFinal,
						idPerfilImovel, numOcorrenciasConsecutivas, colecaoAnormalidadesLeituras, indicadorAnormalidadeImpactaLeitura);
		...
		BigDecimal indiceAnormalidade = Util.calcularPercentualBigDecimal(
			new BigDecimal(totalAnormalidades), 
			new BigDecimal(totalRegistrosRecebidos));
		
		parametros.put("indiceAnormalidade", indiceAnormalidade);
		...
		if(indicadorAnormalidadeImpactaLeitura != null && indicadorAnormalidadeImpactaLeitura.equals(ConstantesSistema.SIM.toString())){
			parametros.put("indicadorImpacto", "Sim");
		}
		else{
			parametros.put("indicadorImpacto", "Nao");
		}

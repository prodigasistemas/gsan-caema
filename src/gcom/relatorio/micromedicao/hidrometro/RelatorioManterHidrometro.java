...
public class RelatorioManterHidrometro extends TarefaRelatorio {
	...
	public Object executar() throws TarefaException {
		...
		if (hidrometroParametros.getHidrometroFatorCorrecao() != null) {
			parametros.put("hidrometroFatorCorrecao", 
				Util.formatarMoedaReal(hidrometroParametros.getHidrometroFatorCorrecao()));
		}
		if (hidrometroParametros.getHidrometroClassePressao() != null) {
			parametros.put("hidrometroClassePressao", 
				hidrometroParametros.getHidrometroClassePressao());
		}

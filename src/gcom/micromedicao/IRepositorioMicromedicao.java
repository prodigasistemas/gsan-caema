...
public interface IRepositorioMicromedicao {
	...
	public Collection pesquisarAnormalidadesRelatorioComparativoLeiturasEAnormalidades(
			...
			SistemaParametro sistemaParametro, String indicadorAnormalidadeImpactaLeitura) throws ErroRepositorioException;
...
//	public byte[] baixarArquivoTextoAtualizacaoCadastral(long imei) throws ErroRepositorioException;
	...
	public Collection pesquisarDadosRelatorioAnaliseImovelGrande(
			...
			Collection<Integer> colecaoLigacaoAguaSituacao, Collection<Integer> colecaoLigacaoEsgotoSituacao)throws ErroRepositorioException;
	 ...
	 */
	public HidrometroInstalacaoHistorico pesquisarHidrometroInstalacaoHistoricoAgua(Integer idImovel) throws ErroRepositorioException;
	 ...
	 * @return HidrometroInstalacaoHistorico
	 */
	public HidrometroInstalacaoHistorico pesquisarHidrometroInstalacaoHistoricoPoco(Integer idImovel) throws ErroRepositorioException;
	 ...
	 * @return HidrometroInstalacaoHistorico
	 */
	public Hidrometro pesquisarHidrometro(Integer hidrId) throws ErroRepositorioException;
	 ...
	 * @date 28/08/2012
	 * */	
	public Integer obterSistuacaoFaturamentoAnormalidadeEncontrada(Integer idAnormalidadeEncontrada)
			throws ErroRepositorioException;
	...
	/** 
	 * [UC 1361][FS0026] - Verificar a existencia do Cadastrador
	 * Pesquisa o Leiturista pelo Login
	 * 
	 * @author Anderson Cabral
	 * @date 03/06/2013
	 * @param String cpf
	...
	/**
	 * Método que retorna um arrey de Object com informações do histórico de
	 * medição e leitura da conta com tipo de medição agua
	 * 
	 * [UC0348] Emitir Contas
	 * 
	 * [SB0004] Obter Dados de medição da conta
	...
	/**
	 * Método que retorna um arrey de Object com informações do histórico de
	 * medição e leitura da conta com tipo de medição esgoto
	 * 
	 * [UC0348] Emitir Contas
	 * 
	 * [SB0004] Obter Dados de medição da conta

...
public class FiltroMedicaoHistoricoSql extends Filtro implements Serializable {
    ...
    public final static String LOCALIDADE_IMOVEL = "localidade.loca_id"; 
    
    public final static String SETOR_COMERCIAL_IMOVEL = "setorComercial.stcm_id";
    ...
    public final static String ID_GERENCIA_REGIONAL = "localidade.greg_id";
    
    public final static String ID_UNIDADE_NEGOCIO = "localidade.uneg_id";

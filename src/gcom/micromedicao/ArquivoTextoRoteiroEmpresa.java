...
public class ArquivoTextoRoteiroEmpresa implements Serializable {
    ...
    private Collection<ArquivoTextoRoteiroEmpresaFotoHelper> colecaoArquivoTextoRoteiroEmpresaFotoHelper;
	...
	public Collection<ArquivoTextoRoteiroEmpresaFotoHelper> getColecaoArquivoTextoRoteiroEmpresaFotoHelper() {
		return colecaoArquivoTextoRoteiroEmpresaFotoHelper;
	}

	public void setColecaoArquivoTextoRoteiroEmpresaFotoHelper(
			Collection<ArquivoTextoRoteiroEmpresaFotoHelper> colecaoArquivoTextoRoteiroEmpresaFotoHelper) {
		this.colecaoArquivoTextoRoteiroEmpresaFotoHelper = colecaoArquivoTextoRoteiroEmpresaFotoHelper;
	}

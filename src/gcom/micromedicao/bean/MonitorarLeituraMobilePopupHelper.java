...
public class MonitorarLeituraMobilePopupHelper implements Serializable {
	...
	private String consumoAnormalidadeId;
	private String consumoAnormalidadeDescAbrv;
	...
	public String getConsumoAnormalidadeId() {
		return consumoAnormalidadeId;
	}
	public void setConsumoAnormalidadeId(String consumoAnormalidadeId) {
		this.consumoAnormalidadeId = consumoAnormalidadeId;
	}
	public String getConsumoAnormalidadeDescAbrv() {
		return consumoAnormalidadeDescAbrv;
	}
	public void setConsumoAnormalidadeDescAbrv(
			String consumoAnormalidadeDescAbrv) {
		this.consumoAnormalidadeDescAbrv = consumoAnormalidadeDescAbrv;
	}

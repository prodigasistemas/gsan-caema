...
public class ConsultarArquivoTextoRoteiroEmpresaHelper implements Serializable {
	...
	private boolean indicadorEmpresaPpp;
	
	private boolean indicadorLocalidadePpp;
	...
	public boolean getIndicadorEmpresaPpp() {
		return indicadorEmpresaPpp;
	}

	public void setIndicadorEmpresaPpp(boolean indicadorEmpresaPpp) {
		this.indicadorEmpresaPpp = indicadorEmpresaPpp;
	}

	public boolean getIndicadorLocalidadePpp() {
		return indicadorLocalidadePpp;
	}

	public void setIndicadorLocalidadePpp(boolean indicadorLocalidadePpp) {
		this.indicadorLocalidadePpp = indicadorLocalidadePpp;
	}

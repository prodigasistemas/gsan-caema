...
public class LeituraAnormalidade extends ObjetoTransacao {
	...
	private Short indicadorAnormalidadeImpactaLeitura;
	...
	public LeituraAnormalidade(
			...
			Short indicadorFotoObrigatoria) {
	...
	public Short getIndicadorAnormalidadeImpactaLeitura() {
		return indicadorAnormalidadeImpactaLeitura;
	}

	public void setIndicadorAnormalidadeImpactaLeitura(
			Short indicadorAnormalidadeImpactaLeitura) {

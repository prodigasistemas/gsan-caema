...
public class Rota extends ObjetoTransacao {
    ...
    private String setorRotaFormatado;
    
    private Short indicadorCoordenadas = new Short("2");
...
*/
    ...
    public String getSetorRotaFormatado() {
    	if ( getSetorComercial() != null ) {
    		setorRotaFormatado = getSetorComercial().getCodigo() + " - " + getCodigo();
    	}
        return setorRotaFormatado;
    }

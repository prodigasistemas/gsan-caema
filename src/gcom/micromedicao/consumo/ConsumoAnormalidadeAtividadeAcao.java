...
public class ConsumoAnormalidadeAtividadeAcao implements Serializable {
    ...
    public ConsumoAnormalidadeAtividadeAcao(){}

	public ConsumoAnormalidadeAtividadeAcao(Integer id,
			ConsumoAnormalidade consumoAnormalidade, Categoria categoria,
			ImovelPerfil imovelPerfil, Short indicadorUso, Date ultimaAlteracao) {
	...
	public void setIndicadorValidarRetificacao(
			Short indicadorValidarRetificacao) {

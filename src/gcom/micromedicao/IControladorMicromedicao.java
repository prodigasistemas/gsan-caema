...
import gcom.gui.relatorio.micromedicao.RelatorioAnormalidadeImoveisCorrigidosHelper;
...
public interface IControladorMicromedicao {
	...
	public Collection pesquisarAnormalidadesRelatorioComparativoLeiturasEAnormalidades(
			...
			String indicadorAnormalidadeImpactaLeitura)
			throws ControladorException;
...
//			Integer anoMesFaturamento)throws ControladorException;
   ...
   /** < <Descrição do método>>
	 ...
	 * @throws ErroRepositorioException
	 */
	public ConsumoAnormalidadeAtividadeAcao verificaAcaoASerTomada(Integer idConsumoAnormalidade, 
   ...
   public boolean releituraJaRealizada( String matricula )
	...
	/**
	 * Obter ações mensais dado o id do
	 * consumoAnormalidade
	 * 
	 * @author Amelia Pessoa
	 * @date 25/05/2012
	 */
	public Collection<ConsumoAnormalidadeAtividadeAcaoMensal> obterAcoesMensais(Integer consumoAnormalidadeAcaoId) 
			throws ControladorException;
	 ...
	 * @date 08/06/2012
	 */
	public ConsumoAnormalidadeAtividadeAcaoMensal recuperarAnormalidadeAcaoMensal(
			ConsumoAnormalidadeAtividadeAcao consumoAnormalidadeAtividadeAcao, Integer idMedicao, Integer anoMesreferencia,
			Imovel imovel, Integer idAnormalidadeConsumo) throws ControladorException;
	...
	public void inserirFotoMovimentoRoteiroEmpresa(int numeroImovel,
			int idLeituraAnormalidade, int anoMesReferencia, int tipoFoto, int tipoMedicao, int idConsumoAnormalidade, byte[] bytesFoto) throws ControladorException;
	 ...
	 * @date 22/08/2012
	 */
	public LigacaoAgua atualizarDataRetiradaHidrometroHistorico(Integer idImovel, LigacaoAgua ligacaoAgua)
			throws ControladorException;
	
	/**
	 * [UC0364] - Efetuar Substituição de Hidrômetro
	 * 
	 * Pesquisa o id do hidrômetro e a sua situação pelo número do tombamento
	 * 
	 * @author Davi Menezes
	 * @date 18/09/2012
	 * 
	 ...
	 * @throws ControladorException
	 */
	public Hidrometro pesquisarHidrometroPeloTombamento(String numeroTombamento)
			throws ControladorException;
	...
	public Collection pesquisarAnormalidadeInformadaImovel(Integer idImovel, Integer qtdIncidencia, 
			Collection<Integer> colecaoAnoMes, Integer idAnormalidade) throws ControladorException;
	 ...
	 * 
	 */
	public Collection<RelatorioAnormalidadeImoveisCorrigidosHelper> pesquisarRelatorioAnormalidadeImoveisCorrigidos(
	 ...
	 * 
	 */
	public Collection<FiltroAnormalidade> pesquisarAnormalidade() 
	throws ControladorException;
	 ...
	 * @return
	 */
	public Date obterMenorData(Integer idFaturamentoGrupo) throws ControladorException;
	
	/**
	 * Metodo Reponsavel por Recalcular o consumo de Imovel
	 * Com Contrato de damanda. Esse metodo foi 
	 * criado para atender a impressão simultanea de conta
	 * 
	 * [UC0103] - Efetuar Rateio de Consumo AGUARDANDO UC //TODO
	 * 
	 * @author Carlos Chaves
	 * @date 24/05/2013
	 * 
	 * @param Integer idContratoDemanda
	 * @param Integer anoMesFaturamento
	 */
	public void recalcularConsumoImovelContratroDemanada( Integer idContratoDemanda , Integer anoMesFaturamento, SistemaParametro sistemaParametro )
			throws ControladorException;
	 ...
	 * @return Leiturista
	 */
	public Leiturista pesquisarLeituristaPorCPF(String cpf) 
			throws ControladorException;
	 ...
	 * @return Leiturista
	 */
	public Leiturista pesquisarLeituristaPeloLogin(String login) 
			throws ControladorException;
	 ...
	 * @throws ControladorException
	 */
	public void verificarComandoNaoRealizadoParaRota(Integer idFaturamentoGrupo)
		throws ControladorException;
	 ...
	 * @return Leiturista
	 */
	public void ajustarLeituraMacro(ConsumoHistorico consumoHistorico, 
			int quantEconomia, Integer consumoImoveisVinculados,Integer consumoARatear) throws ControladorException;
	
	/**
	 * [UC1360] Gerar Arquivo Texto para Faturamento Versão Android
	 *
	 * @author Raphael Rossiter, Mariana Victor
	 * @date 24/04/2008, 07/01/2014
	 *
	 * @param imovel
	 * @return Collection
	 * @throws ControladorException
	 */
	public Collection obterUltimosConsumosImovelAguaEsgoto(Imovel imovel) throws ControladorException;
	 ...
	 * @date 24/01/2014 
	 */
	public boolean verificarIndicadorTelemedido(Integer idImovel) throws ControladorException;

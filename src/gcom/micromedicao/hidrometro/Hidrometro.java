...
public class Hidrometro extends ObjetoTransacao {
	public Hidrometro(Integer id, String numero, Date dataAquisicao,
			Short anoFabricacao, Short indicadorOperacional,
			Date dataUltimaRevisao, Date dataBaixa,
			Integer numeroLeituraAcumulada, Short numeroDigitosLeitura,
			Date ultimaAlteracao, HidrometroTipo hidrometroTipo,
			HidrometroSituacao hidrometroSituacao,
			HidrometroMarca hidrometroMarca,
			HidrometroCapacidade hidrometroCapacidade,
			HidrometroMotivoBaixa hidrometroMotivoBaixa,
			...
			HidrometroRelojoaria hidrometroRelojoaria,
			BigDecimal vazaoTransicao, BigDecimal vazaoNominal,
			BigDecimal vazaoMinima, Integer notaFiscal,
			Short tempoGarantiaAnos, Set hidrometroMovimentados,
			Short indicadorMacromedidor, String tombamento,
			Integer hidrometroClassePressao,
			BigDecimal hidrometroFatorCorrecao,
			HidrometroModeloSensor hidrometroModeloSensor) {
		super();
		this.id = id;
		this.numero = numero;
	...
	private Integer hidrometroClassePressao;
	
	private BigDecimal hidrometroFatorCorrecao;

	private HidrometroModeloSensor hidrometroModeloSensor;
	...
	public Integer getHidrometroClassePressao() {
		return hidrometroClassePressao;
	}

	public void setHidrometroClassePressao(Integer hidrometroClassePressao) {
		this.hidrometroClassePressao = hidrometroClassePressao;
	}

	public BigDecimal getHidrometroFatorCorrecao() {
		return hidrometroFatorCorrecao;
	}

	public void setHidrometroFatorCorrecao(BigDecimal hidrometroFatorCorrecao) {
		this.hidrometroFatorCorrecao = hidrometroFatorCorrecao;
	}
	
		

	public HidrometroModeloSensor getHidrometroModeloSensor() {
		return hidrometroModeloSensor;
	}

	public void setHidrometroModeloSensor(
			HidrometroModeloSensor hidrometroModeloSensor) {
		this.hidrometroModeloSensor = hidrometroModeloSensor;
	}
	...
	public Hidrometro(
			...
			gcom.micromedicao.hidrometro.HidrometroClasseMetrologica hidrometroClasseMetrologica,
			gcom.micromedicao.hidrometro.HidrometroDiametro hidrometroDiametro,
			Short indicadorMacromedidor,HidrometroModeloSensor hidrometroModeloSensor) {
		this.numero = numero;
		this.dataAquisicao = dataAquisicao;
		this.anoFabricacao = anoFabricacao;
		this.indicadorOperacional = indicadorOperacional;
	...
	public Hidrometro(
			...
			String tombamento, Integer hidrometroClassePressao ,
			BigDecimal hidrometroFatorCorrecao, HidrometroModeloSensor hidrometroModeloSensor) {
		this.numero = numero;
		this.dataAquisicao = dataAquisicao;
		this.anoFabricacao = anoFabricacao;
		this.indicadorOperacional = indicadorOperacional;

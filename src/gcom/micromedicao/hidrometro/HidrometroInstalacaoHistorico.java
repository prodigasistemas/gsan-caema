...
public class HidrometroInstalacaoHistorico extends ObjetoTransacao {
	...
	private MedicaoTipo medicaoTipo;
	 ...
	 private Short indicadorMedicaoHistorico;
	 
	 /** persistent field */
	@ControleAlteracao(value=FiltroHidrometroInstalacaoHistorico.INDICADOR_MEDICAO_TELEMEDIDO,
			funcionalidade={ATRIBUTOS_EFETUAR_INSTALACAO_HIDROMETRO, ATRIBUTOS_EFETUAR_SUBSTITUICAO_HIDROMETRO,
			ATRIBUTOS_ATUALIZAR_INSTALACAO_HIDROMETRO})
	 private Short indicadorMedicaoTelemedido;
	...
	public String getDescricaoParaRegistroTransacao() {
		if (hidrometro != null){
			if (this.hidrometro.getNumero() != null && !this.hidrometro.getNumero().trim().equals("")){
				return this.hidrometro.getNumero();	
			} 
			else{
				return this.hidrometro.getTombamento();
			}		
		} 
		return "";		
	}
	...
	public Short getIndicadorMedicaoHistorico() {
		return indicadorMedicaoHistorico;
	}

	public void setIndicadorMedicaoHistorico(Short indicadorMedicaoHistorico) {
		this.indicadorMedicaoHistorico = indicadorMedicaoHistorico;
	}

	public Short getIndicadorMedicaoTelemedido() {
		return indicadorMedicaoTelemedido;
	}

	public void setIndicadorMedicaoTelemedido(Short indicadorMedicaoTelemedido) {

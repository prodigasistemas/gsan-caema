...
public class FiltroHidrometro extends Filtro implements Serializable {
	...
	public final static String HIDROMETRO_FATOR_CORRECAO = "hidrometroFatorCorrecao";

	public final static String HIDROMETRO_CLASSE_PRESSAO = "hidrometroClassePressao";
	
	public final static String HIDROMETRO_MODELO_SENSOR_ID = "hidrometroModeloSensor.id";
	
	public final static String INDICADOR_MACROMEDIDOR = "indicadorMacromedidor";
	
	public final static String TOMBAMENTO = "tombamento";

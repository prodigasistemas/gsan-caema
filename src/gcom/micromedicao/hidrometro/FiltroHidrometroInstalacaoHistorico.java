...
public class FiltroHidrometroInstalacaoHistorico extends Filtro implements
    ...
    public final static String USUARIO_RETIRADA = "usuarioRetirada";
    
    public final static String USUARIO_INSTALACAO = "usuarioInstalacao";
    
    public final static String INDICADOR_MEDICAO_TELEMEDIDO = "indicadorMedicaoTelemedido";

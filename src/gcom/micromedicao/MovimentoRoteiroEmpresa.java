...
public class MovimentoRoteiroEmpresa implements Serializable {
   ...
   // private String descricaoAbreviadaCategoriaImovel2;
	...
	//RM6197 - Permitir exibir macromedidor do imóvel
	private String tombamento;
	
	private Short indicadorEmitirCartaConexaoEsgoto;
    ...
    public MovimentoRoteiroEmpresa(Integer id, Integer anoMesMovimento, Integer codigoSetorComercial, 
    	...
    	this.indicadorEmitirCartaConexaoEsgoto = ConstantesSistema.NAO;
    }
	...
	public Short getIndicadorEmitirCartaConexaoEsgoto() {
		return indicadorEmitirCartaConexaoEsgoto;
	}

	public void setIndicadorEmitirCartaConexaoEsgoto(Short indicadorEmitirCartaConexaoEsgoto) {
		this.indicadorEmitirCartaConexaoEsgoto = indicadorEmitirCartaConexaoEsgoto;
	}

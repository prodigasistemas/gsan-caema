...
public class ObterDocumentosNegativacaoPorPeriodoHelper implements Cloneable {
	...
	private NegativacaoCriterio nCriterio;
	private Categoria categoriaPrincipalDoImovel;
	private NegativacaoComando nComando;
	...
	public ObterDocumentosNegativacaoPorPeriodoHelper(
			...
			Collection<GuiaPagamentoValoresHelper> colecaoGuiasPagamentoValores, boolean contaParcelada,
			NegativacaoCriterio nCriterio, Categoria categoriaPrincipalDoImovel, NegativacaoComando nComando,
	...
	public NegativacaoCriterio getnCriterio() {
		return nCriterio;
	}
	public void setnCriterio(NegativacaoCriterio nCriterio) {
		this.nCriterio = nCriterio;
	}
	...
	public NegativacaoComando getnComando() {
		return nComando;
	}
	public void setnComando(NegativacaoComando nComando) {
		this.nComando = nComando;
	}

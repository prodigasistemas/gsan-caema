...
public class Localidade extends ObjetoTransacao {
	...
	private Short indicadorContratoPpp;
	
	//Atributo usado na funcionalidade manter comando acao cobranca, para identificar as localidades selecionadas.
	...
	public Short getIndicadorContratoPpp() {
		return indicadorContratoPpp;
	}

	public void setIndicadorContratoPpp(Short indicadorContratoPpp) {

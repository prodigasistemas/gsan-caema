...
public class SetorComercial extends ObjetoTransacao implements Serializable{
  ...
  //Atributo usado na funcionalidade manter comando acao cobranca, para identificar os setores comerciais selecionados.
	...
	public String getDescricaoIndicadorSetorAlternativo(){
		String retorno = "NÃO";
		if ( getIndicadorSetorAlternativo().equals(ConstantesSistema.SIM) ) {
			retorno = "SIM";
		}
		return retorno;
	}

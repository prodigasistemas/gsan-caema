...
public class FiltroImovelAtualizacaoCadastral extends Filtro implements Serializable {
	 ...
	 * Description of the Field
	 */
	public final static String CADASTRADOR = "cadastrador";
	 ...
	 * Description of the Field
	 */
	public final static String SUB_LOTE = "subLote";
	 ...
	 * Description of the Field
	 */
	public final static String CAPA_LOTE_ATUALIZACAO_CADASTRAL = "capaLoteAtualizacaoCadastral";
	
	/**
	 * Description of the Field
	 */
	public final static String ID_CAPA_LOTE_ATUALIZACAO_CADASTRAL = "capaLoteAtualizacaoCadastral.id";

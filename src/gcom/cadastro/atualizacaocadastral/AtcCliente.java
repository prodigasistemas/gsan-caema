...
public class AtcCliente implements Serializable {
    ...
    /** full constructor */
    public AtcCliente(Long atcCliId, String atcCliCnpj, String atcCliEmail, String atcCliNomeFantasia, String atcCliNomeReceita, String atcCliCpf, String atcCliRg, String atcCliDataExpedicao, String atcCliDataNascimento, Integer atcOrgId, Integer atcUnfId, Integer atcProId, Integer atcRamId, Integer atcCltId, int atcCliTipoPessoa, Integer atcCliSexo, String atcCliNomeMae) {
    ...
    /** minimal constructor */
    public AtcCliente(Long atcCliId, int atcCliTipoPessoa) {
        this.atcCliId = atcCliId;
        this.atcCliTipoPessoa = atcCliTipoPessoa;
    }

 ...
 * @since 06/03/2013 
 *****/
public class FiltroLogradouroCepAtlzCad extends Filtro implements Serializable {
    ...
    public FiltroLogradouroCepAtlzCad() {
    }

    public FiltroLogradouroCepAtlzCad(String campoOrderBy) {

 ...
 * @since 06/03/2013 
 *****/
public class FiltroLogradouroAtlzCad extends Filtro implements Serializable {
    ...
    public FiltroLogradouroAtlzCad() {
    }

    public FiltroLogradouroAtlzCad(String campoOrderBy) {

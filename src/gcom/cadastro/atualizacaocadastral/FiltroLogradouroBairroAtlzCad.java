 ...
 * @since 06/03/2013 
 *****/
public class FiltroLogradouroBairroAtlzCad extends Filtro implements Serializable {
    ...
    public final static String NOME_LOGRADOURO_ATLZ_CAD = "logradouroAtlzCad.nome";

    public final static String NOME_POPULAR_LOGRADOURO_ATLZ_CAD = "logradouroAtlzCad.nomePopular";
    ...
    public FiltroLogradouroBairroAtlzCad() {
    }

    public FiltroLogradouroBairroAtlzCad(String campoOrderBy) {

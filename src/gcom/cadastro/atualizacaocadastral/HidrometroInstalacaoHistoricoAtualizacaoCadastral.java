...
@ControleAlteracao()
public class HidrometroInstalacaoHistoricoAtualizacaoCadastral extends ObjetoTransacao {
	...
	public HidrometroInstalacaoHistoricoAtualizacaoCadastral(){
	...
	public String getDescricaoTipoMedicao(){
		...
		if (getMedicaoTipo() != null) {
			MedicaoTipo medicaoTipo = getMedicaoTipo();
			if ( medicaoTipo.getId() != null ){
				if ( medicaoTipo.getId().equals(MedicaoTipo.LIGACAO_AGUA) ) {
					descricaoTipoMedicao = "LIGACAO DE AGUA";
				} else if ( medicaoTipo.getId().equals(MedicaoTipo.POCO) ) {
					descricaoTipoMedicao = "POCO";
				}
			}
		}

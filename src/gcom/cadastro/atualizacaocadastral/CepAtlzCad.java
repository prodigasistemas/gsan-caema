 ...
 * @created 06/03/2013
 */
public class CepAtlzCad extends ObjetoGcom {
	...
	public CepAtlzCad(String id, Integer codigoCep, Date ultimaAlteracao) {
		super();
		this.id = id;
	...
	public boolean equals(Object other) {
		...
		if(!(other instanceof CepAtlzCad)){
			return false;
		}
		
		CepAtlzCad castOther = (CepAtlzCad) other;

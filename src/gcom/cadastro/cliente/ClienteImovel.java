...
public class ClienteImovel extends ObjetoTransacao {
	...
	@ControleAlteracao(value=FiltroClienteImovel.CLIENTE,
			funcionalidade={Cliente.OPERACAO_CONSULTAR_DADOS_DA_OS_DE_VISITA,ClienteVirtual.ATRIBUTOS_CLIENTE_ATUALIZAR_VIRTUAL})
	...
	/** persistent field */
    @ControleAlteracao(funcionalidade={ClienteVirtual.ATRIBUTOS_CLIENTE_ATUALIZAR_VIRTUAL})
    private ClienteVirtual clienteVirtual;    
	...
	public ClienteVirtual getClienteVirtual() {
		return clienteVirtual;
	}

	public void setClienteVirtual(ClienteVirtual clienteVirtual) {
	...
	public String getDescricaoParaRegistroTransacao() {
		if(this.getClienteRelacaoTipo().getDescricao() != null && !this.getClienteRelacaoTipo().getDescricao().equals("")){ 

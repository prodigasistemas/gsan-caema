...
public class FiltroClienteEndereco extends Filtro implements Serializable {
	...
	public final static String LOGRADOURO_BAIRRO_LOGRADOURO_TIPO = "logradouroBairro.logradouro.logradouroTipo";
	
	public final static String LOGRADOURO_BAIRRO_LOGRADOURO_TITULO = "logradouroBairro.logradouro.logradouroTitulo";
	
	public final static String LOGRADOURO_BAIRRO_LOGRADOURO_MUNICIPIO = "logradouroBairro.logradouro.municipio";
	
	public final static String LOGRADOURO_BAIRRO_LOGRADOURO_MUNICIPIO_UNIDADE_FEDERACAO = "logradouroBairro.logradouro.municipio.unidadeFederacao";

...
public class Cliente extends ObjetoTransacao {
	...
	public static final Short CLIE_ICBLOQUEARDESPESASPOSTAIS = 2;
    ...
    /** nullable persistent field */
    @ControleAlteracao(funcionalidade={ATRIBUTOS_CLIENTE_INSERIR, ATRIBUTOS_CLIENTE_ATUALIZAR})
    private Short indicadorBloquearDespesasPostais;

    /** nullable persistent field */
    @ControleAlteracao(funcionalidade={ATRIBUTOS_CLIENTE_INSERIR, ATRIBUTOS_CLIENTE_ATUALIZAR})
    private Short indicadorBloquearAlterarImoveis;
...
//    		funcionalidade={ATRIBUTOS_CLIENTE_INSERIR, ATRIBUTOS_CLIENTE_ATUALIZAR})
	...
	public Cliente(String nome, String nomeAbreviado, String cpf, String rg,
		...
		this.indicadorBloquearDespesasPostais = ConstantesSistema.NAO;
		this.indicadorBloquearAlterarImoveis = ConstantesSistema.NAO;
	}
	...
	public Short getIndicadorBloquearDespesasPostais() {
		return indicadorBloquearDespesasPostais;
	}

	public void setIndicadorBloquearDespesasPostais(
			Short indicadorBloquearDespesasPostais) {
		this.indicadorBloquearDespesasPostais = indicadorBloquearDespesasPostais;
	}
	
	public Short getIndicadorBloquearAlterarImoveis() {
		return indicadorBloquearAlterarImoveis;
	}

	public void setIndicadorBloquearAlterarImoveis(
			Short indicadorBloquearAlterarImoveis) {
		this.indicadorBloquearAlterarImoveis = indicadorBloquearAlterarImoveis;
	}

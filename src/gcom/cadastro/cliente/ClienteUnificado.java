...
public class ClienteUnificado extends ObjetoTransacao {
	...
	public Filtro retornaFiltro() {
		FiltroClienteUnificado filtroClienteUnificado = new FiltroClienteUnificado();

		filtroClienteUnificado.adicionarParametro(new ParametroSimples(
				FiltroClienteUnificado.ID, this.getId()));
		
		return filtroClienteUnificado;
	}

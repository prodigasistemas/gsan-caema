...
//			funcionalidade={ATRIBUTOS_IMOVEL_ATUALIZAR,ATRIBUTOS_IMOVEL_REMOVER})
	...
	@ControleAlteracao(value=FiltroImovel.LIGACAO_ESGOTO_SITUACAO,
			funcionalidade={ATRIBUTOS_IMOVEL_INSERIR, LigacaoEsgoto.ATRIBUTOS_EFETUAR_LIGACAO_ESGOTO,LigacaoEsgoto.ATRIBUTOS_ATUALIZAR_LIGACAO_ESGOTO, 
...
//	@ControleAlteracao(FiltroImovel.CLIENTES_IMOVEIS)
	...
	private Set contratosDemandaImovelComercialIndustrial;
    ...
    private Short indicadorRateioConsumoFranquia;

    //RM 6602
    private Short indicadorRateioNegativo;
	...
	//Campos não Mapeados (RM8621)
	//ID contrato de Demanda 
	private Integer idContratoDemandaHelper;
	//Volume do contrato de Demanda
	private Integer volumeInformadoEsgotoRateadoHelper;
	
	private Integer idLigacaoEsgotoSituacaoAnterior;
	
	private Date dataCadastramento;

	private SistemaAbastecimento sistemaAbastecimento;
	private SubsistemaAbastecimento subsistemaAbastecimento;
	private SetorAbastecimento setorAbastecimento;
	private DistritoOperacional distritoOperacional;
	private AreaOperacional areaOperacional;
	private ZonaPressao zonaPressao;
	...
	public Imovel(
		...
		this.indicadorRateioNegativo = indicadorRateioNegativo;
		this.indicadorRateioConsumoFranquia = ConstantesSistema.NAO;
	}
	...
	public String getEnderecoFormatado() {
		...
		if (this.getLogradouroCep() != null
			...
			if (this.getLogradouroCep().getLogradouro().getLoteamento() != null 
					&& !this.getLogradouroCep().getLogradouro().getLoteamento().equals("")){
				endereco = endereco + " - "
						+ this.getLogradouroCep().getLogradouro().getLoteamento().trim();
			}
...
//		filtroImovel.adicionarCaminhoParaCarregamentoEntidade("imovelDoacao");
	...
	public Short getIndicadorRateioNegativo() {
		return indicadorRateioNegativo;
	}

	public void setIndicadorRateioNegativo(Short indicadorRateioNegativo) {
		this.indicadorRateioNegativo = indicadorRateioNegativo;
	}
	...
	public Short getIndicadorRateioConsumoFranquia() {
		return indicadorRateioConsumoFranquia;
	}

	public void setIndicadorRateioConsumoFranquia(
			Short indicadorRateioConsumoFranquia) {
		this.indicadorRateioConsumoFranquia = indicadorRateioConsumoFranquia;
	}

	public Set getContratosDemandaImovelComercialIndustrial() {
		return contratosDemandaImovelComercialIndustrial;
	}

	public void setContratosDemandaImovelComercialIndustrial(Set contratosDemandaImovelComercialIndustrial) {
		this.contratosDemandaImovelComercialIndustrial = contratosDemandaImovelComercialIndustrial;
	}

	public Integer getIdContratoDemandaHelper() {
		return idContratoDemandaHelper;
	}

	public void setIdContratoDemandaHelper(Integer idContratoDemandaHelper) {
		this.idContratoDemandaHelper = idContratoDemandaHelper;
	}

	public Integer getVolumeInformadoEsgotoRateadoHelper() {
		return volumeInformadoEsgotoRateadoHelper;
	}

	public void setVolumeInformadoEsgotoRateadoHelper(Integer volumeInformadoEsgotoRateadoHelper) {
		this.volumeInformadoEsgotoRateadoHelper = volumeInformadoEsgotoRateadoHelper;
	}

	public Integer getIdLigacaoEsgotoSituacaoAnterior() {
		return idLigacaoEsgotoSituacaoAnterior;
	}

	public void setIdLigacaoEsgotoSituacaoAnterior(
			Integer idLigacaoEsgotoSituacaoAnterior) {
		this.idLigacaoEsgotoSituacaoAnterior = idLigacaoEsgotoSituacaoAnterior;
	}
	...
	public AreaOperacional getAreaOperacional() {
		return areaOperacional;
	}

	public void setAreaOperacional(AreaOperacional areaOperacional) {
		this.areaOperacional = areaOperacional;
	}

	public ZonaPressao getZonaPressao() {
		return zonaPressao;
	}

	public void setZonaPressao(ZonaPressao zonaPressao) {
	...
	public SubsistemaAbastecimento getSubsistemaAbastecimento() {
		return subsistemaAbastecimento;
	}

	public void setSubsistemaAbastecimento(
			SubsistemaAbastecimento subsistemaAbastecimento) {

...
public class ImovelPerfil extends ObjetoTransacao{
    ...
    public final static Integer CHAFARIZ = new Integer(6);
    
    public final static Integer MICRO_TELEMEDIDO = new Integer(11);
    
    public final static int NORMAL_INT = 5;
    
    public final static int TARIFA_SOCIAL_INT = 4;
    
    public final static int GRANDE_INT = 1;
    
    public final static int CORPORATIVO_INT = 3;
    
    public final static int GRANDE_TELEMEDIDO_INT = 7;
    
    public final static int CORPORATIVO_TELEMED_INT = 8;
    
    public final static int CHAFARIZ_INT = 6;
    
    public final static int MICRO_TELEMEDIDO_INT = 11;
    
    public final static int CADASTRO_PROVISORIO_INT = 9;

...
public class InserirImovelHelper implements Serializable {
	...
	private Collection colecaoFotos;
	...
	public InserirImovelHelper(Imovel imovel, Collection subcategorias, Collection ramosAtividades, Collection endereco,
			Collection clientes, Collection colecaoFotos, LigacaoEsgotoEsgotamento ligacaoEsgotoEsgotamento, 
			Usuario usuario ){
		...
		this.colecaoFotos = colecaoFotos;
	...
	public Collection getColecaoFotos() {
		return colecaoFotos;
	}

	public void setColecaoFotos(Collection colecaoFotos) {
		this.colecaoFotos = colecaoFotos;
	}

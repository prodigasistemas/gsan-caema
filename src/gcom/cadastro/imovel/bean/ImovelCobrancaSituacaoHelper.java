...
public class ImovelCobrancaSituacaoHelper {
	...
	private String valorTotalEnviadas;
	private String valorTotalPagas;
	...
	public String getValorTotalEnviadas() {
		return valorTotalEnviadas;
	}
	public void setValorTotalEnviadas(String valorTotalEnviadas) {
		this.valorTotalEnviadas = valorTotalEnviadas;
	}
	public String getValorTotalPagas() {
		return valorTotalPagas;
	}
	public void setValorTotalPagas(String valorTotalPagas) {
		this.valorTotalPagas = valorTotalPagas;
	}

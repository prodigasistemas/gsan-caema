...
public class FonteAbastecimento extends ObjetoTransacao {
    ...
    // --CONSTANTES
 	...
 	public final static Integer COMPESA = new Integer(1);
 	
 	public final static Integer POCO = new Integer(2);
 	
 	public final static Integer VIZINHO = new Integer(3);
 	
 	public final static Integer CACIMBA = new Integer (4);
 	
 	public final static Integer CHAFARIZ = new Integer (5);
 	
 	public final static Integer CARRO_PIPA = new Integer (6);
 	
 	public final static Integer SEM_ABASTECIMENTO = new Integer (7);

...
public class EnvioEmail implements Serializable {		private static final long serialVersionUID = 1L;
    ...
    public static final Integer ENVIAR_EMAIL_USUARIOS_SUPERIORES = 54;
    public static final Integer ENVIAR_EMAIL_ARQUIVO_EFD_PIS_COFINS = 55;

    public static final Integer GERAR_TXT_PARCELAMENTOS_NEGOCIADOS_EMPRESAS_COBRANCA = 56;
    public static final Integer GERAR_TXT_PARCELAMENTOS_NEGOCIADOS_EMPRESAS_COBRANCA_SEM_DADOS = 57;
    public static final Integer GERAR_TXT_CODIGO_BARRAS_DOCUMENTO_COBRANCA = 58;
    
    public static final Integer EMITIR_COMPROVANTE_CADASTRAMENTO_SORTEIO = 59;
    
    public static final Integer GERAR_RELATORIO_CLIENTES_MESMO_CPF_CNPJ = 60;
    public static final Integer GERAR_RELATORIO_CLIENTES_MESMO_CPF_CNPJ_VAZIO = 61;
    public static final Integer GERAR_TXT_MOVIMENTOS_ARRECADADORES_POR_NSA = 62;
    public static final Integer GERAR_TXT_MOVIMENTOS_ARRECADADORES_POR_NSA_VAZIO = 63;
    public static final Integer RELATORIO_IMOVEIS_CARTAS_NAO_IMPRESSAS = 64;
    
    public static final Integer CARRO_PIPA_ABASTECIMENTO_ARQUIVO_TXT = 65;
    
    public static final Integer GERAR_TXT_BOLETIM_MEDICAO_ACOMPANHAMENTO = 66;

...
public class Bairro extends ObjetoTransacao {
    ...
    private Short indicadorEnvioAtualizacaoCadastral;
    
    private String pertenceAgrupamentoBairros;
	...
	public Short getIndicadorEnvioAtualizacaoCadastral() {
		return indicadorEnvioAtualizacaoCadastral;
	}

	public void setIndicadorEnvioAtualizacaoCadastral(
			Short indicadorEnvioAtualizacaoCadastral) {
		this.indicadorEnvioAtualizacaoCadastral = indicadorEnvioAtualizacaoCadastral;
	}

	public String getPertenceAgrupamentoBairros() {
		return pertenceAgrupamentoBairros;
	}

	public void setPertenceAgrupamentoBairros(String pertenceAgrupamentoBairros) {
		this.pertenceAgrupamentoBairros = pertenceAgrupamentoBairros;
	}

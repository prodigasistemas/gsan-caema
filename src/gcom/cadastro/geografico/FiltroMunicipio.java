...
public class FiltroMunicipio extends Filtro implements Serializable {
    ...
    /**
     * Indicador de logradouro bloqueado durante atualização cadastral
     */
    public final static String INDICADOR_LOGRADOURO_BLOQUEADO = "indicadorLogradouroBloqueado";
     ...
     * Código do DDD
     */
    public final static String ID_CLIENTE_PREFEITURA = "clientePrefeitura.id";
}

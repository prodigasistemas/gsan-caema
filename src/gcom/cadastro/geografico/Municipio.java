...
public class Municipio extends ObjetoTransacao {
    ...
    /** nullable persistent field */
    private Short indicadorDebitoCobrancaJudicial;
    
    /** nullable persistent field */
    private Short indicadorParcelaPagaIcms;
    
    /** nullable persistent field */
    private Short indicadorFaturaPagaIcms;
    
    /** nullable persistent field */
    private Short indicadorConvenioRepavimentacaoCompesa;
    
   
    private Cliente clientePrefeitura;
     

    private Short indicadorLogradouroBloqueado;
	...
	public Short getIndicadorDebitoCobrancaJudicial() {
		return indicadorDebitoCobrancaJudicial;
	}

	public void setIndicadorDebitoCobrancaJudicial(
			Short indicadorDebitoCobrancaJudicial) {
		this.indicadorDebitoCobrancaJudicial = indicadorDebitoCobrancaJudicial;
	}

	public Short getIndicadorParcelaPagaIcms() {
		return indicadorParcelaPagaIcms;
	}

	public void setIndicadorParcelaPagaIcms(Short indicadorParcelaPagaIcms) {
		this.indicadorParcelaPagaIcms = indicadorParcelaPagaIcms;
	}

	public Short getIndicadorFaturaPagaIcms() {
		return indicadorFaturaPagaIcms;
	}

	public void setIndicadorFaturaPagaIcms(Short indicadorFaturaPagaIcms) {
		this.indicadorFaturaPagaIcms = indicadorFaturaPagaIcms;
	}

	public Short getIndicadorConvenioRepavimentacaoCompesa() {
		return indicadorConvenioRepavimentacaoCompesa;
	}

	public void setIndicadorConvenioRepavimentacaoCompesa(
			Short indicadorConvenioRepavimentacaoCompesa) {
		this.indicadorConvenioRepavimentacaoCompesa = indicadorConvenioRepavimentacaoCompesa;
	}

	public Cliente getClientePrefeitura() {
		return clientePrefeitura;
	}

	public void setClientePrefeitura(Cliente clientePrefeitura) {
		this.clientePrefeitura = clientePrefeitura;
	}
	

    public Short getIndicadorLogradouroBloqueado() {
		return indicadorLogradouroBloqueado;
	}

	public void setIndicadorLogradouroBloqueado(Short indicadorLogradouroBloqueado) {

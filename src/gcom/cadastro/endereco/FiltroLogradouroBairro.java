...
public class FiltroLogradouroBairro extends Filtro implements Serializable {
    ...
    public final static String LOGRADOURO_MUNICIPIO = "logradouro.municipio";
	
	public final static String LOGRADOURO_MUNICIPIO_UNIDADE_FEDERACAO = "logradouro.municipio.unidadeFederacao";

...
public class UnidadeOrganizacional extends ObjetoTransacao {
	...
	public static int UNIDADE_ATENDIMENTO_SOLICITACAOES_VIA_CELULAR = 9855;
	
	public static int UNIDADE_ATENDIMENTO_INTERNET = 9756;
    ...
    /** persistent field */
    private gcom.cadastro.unidade.UnidadeOrganizacional unidadeTramitacao;
	...
	public gcom.cadastro.unidade.UnidadeOrganizacional getUnidadeTramitacao() {
		return unidadeTramitacao;
	}

	public void setUnidadeTramitacao(
			gcom.cadastro.unidade.UnidadeOrganizacional unidadeTramitacao) {

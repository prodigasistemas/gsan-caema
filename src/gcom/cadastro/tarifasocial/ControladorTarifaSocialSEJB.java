	...
	public AtendimentoMotivoEncerramento manterTarifaSocial(Imovel imovelSessao,
		...
		if (colecaoTarifaSocialExcluida != null && !colecaoTarifaSocialExcluida.isEmpty()) {
			...
			while (colecaoTarifaSocialExcluidaIterator.hasNext()) {
				...
				//
				if (imovelSessao.getFaturamentoSituacaoTipo() != null) {
					if (imovelSessao.getFaturamentoSituacaoTipo().getId() != null 
							&& imovelSessao.getFaturamentoSituacaoTipo().getId().equals(FaturamentoSituacaoTipo.PARALISAR_FATURAMENTO_DE_ESGOTO)  ){

/*
f * Copyright (C) 2007-2007 the GSAN - Sistema Integrado de Gestão de Serviços de Saneamento
 *
...
public class SistemaParametro extends ObjetoTransacao {
	...
	private Integer consumoAguaFixadoAnormalidadeHidro;

	private Integer qtdMesIstalSubistituicaoHidro;

	private Integer qtdVezIncidenciaAnormalidadeHidro;
	...
	private UnidadeOrganizacional UnidadeOrganizacionalTramiteIdGrandeConsumidor;
	...
	private Short indicadorBloqFuncInstalacaoSubtHidrometro;
	...
	private Short numeroDiasEncerramentoOrdemServicoFactivelFaturavel;
	...
	private Cliente clienteDiretorGestao;
	...
	private Integer numeroDiasBloqueiaSenha;
	private Integer icModulosSeguranca;
	private Integer periodoRevalidarSenha;
	private Integer diasRevalidarSenha;
	
	private String pastaMovimentoArrecadadoresCritica;
	
	private String pastaMovimentoArrecadadoresProcessar;
	
	private String pastaMovimentoArrecadadoresProcessados;
	
	private Integer qtdEconomiaContratoDemanda;
	
	private Integer qtdDiasParaSuspensaoDoacao;
	...
	private Short indicadorPercentualColetaEsgoto;
	private Short indicadorDesconsiderarRateioEsgoto;
	
	private Short indicadorTramitarRAEsgoto;
	private Integer diasAtualizarLigacaoAguaImovelFisc;
	
	private Date dataLimiteCadastroSorteio;
	private Date dataSorteio;
	
	/** RM 5120 **/
	
	/** nullable persistent field */
	private String arquivosResetorizacaoAProcessar;
	
	/** nullable persistent field */
	private String arquivosResetorizacaoProcessado;
	
	/** nullable persistent field */
	private String arquivosResetorizacaoCritica;

	//private Integer qtdEconomiaContratoDemanda;
	
	private Short indicadorImprimirExtratoSorteio;
	
	// quantidade maxima de vezes para alterar o vinculo de uma conta.
	private Integer numeroVezesAlterarVinculo;
	
	//Numero de dias que é permitido para inserir processo de comando de cobranca
	private Integer numeroDiasInserirProcessoCobranca;
	
	//Quantidade maxima de contas itens especial faturamento.
	private Integer quantidadeMaximaContasItensEspecialFaturamento;

    private Integer faturamentoInicioContratoPPP;
	
	private BigDecimal percentualPPP;
	
	// Quantidade de dia para faturar imovel com situacao de ligacao de esgoto Faturar Factivel.
	private Integer quantidadeDiasFaturarFactivel;

	//RM9188
	private short idadeMinimaUsuario;
	
	private Integer numeroLimiteOSCobranca;
	
	private String imagemArpe;
	
	private String imagemRodapeConta;
	
	private Integer anoMesReferenciaContaModeloAnterior;
	
	public Date getDataLimiteCadastroSorteio() {
		return dataLimiteCadastroSorteio;
	}

	public void setDataLimiteCadastroSorteio(Date dataLimiteCadastroSorteio) {
		this.dataLimiteCadastroSorteio = dataLimiteCadastroSorteio;
	}
	...
	public Short getIndicadorTramitarRAEsgoto() {
		return indicadorTramitarRAEsgoto;
	}

	public void setIndicadorTramitarRAEsgoto(Short indicadorTramitarRAEsgoto) {
		this.indicadorTramitarRAEsgoto = indicadorTramitarRAEsgoto;
	}
	...
	public UnidadeOrganizacional getUnidadeOrganizacionalTramiteIdGrandeConsumidor() {
		return UnidadeOrganizacionalTramiteIdGrandeConsumidor;
	}

	public void setUnidadeOrganizacionalTramiteIdGrandeConsumidor(
			UnidadeOrganizacional unidadeOrganizacionalTramiteIdGrandeConsumidor) {
		UnidadeOrganizacionalTramiteIdGrandeConsumidor = unidadeOrganizacionalTramiteIdGrandeConsumidor;
	}
	...
	public Integer getConsumoAguaFixadoAnormalidadeHidro() {
		return consumoAguaFixadoAnormalidadeHidro;
	}

	public void setConsumoAguaFixadoAnormalidadeHidro(
			Integer consumoAguaFixadoAnormalidadeHidro) {
		this.consumoAguaFixadoAnormalidadeHidro = consumoAguaFixadoAnormalidadeHidro;
	}

	public Integer getQtdEconomiaContratoDemanda() {
		return qtdEconomiaContratoDemanda;
	}

	public void setQtdEconomiaContratoDemanda(Integer qtdEconomiaContratoDemanda) {
		this.qtdEconomiaContratoDemanda = qtdEconomiaContratoDemanda;
	}

	public Integer getQtdMesIstalSubistituicaoHidro() {
		return qtdMesIstalSubistituicaoHidro;
	}

	public void setQtdMesIstalSubistituicaoHidro(
			Integer qtdMesIstalSubistituicaoHidro) {
		this.qtdMesIstalSubistituicaoHidro = qtdMesIstalSubistituicaoHidro;
	}

	public Integer getQtdVezIncidenciaAnormalidadeHidro() {
		return qtdVezIncidenciaAnormalidadeHidro;
	}

	public void setQtdVezIncidenciaAnormalidadeHidro(
			Integer qtdVezIncidenciaAnormalidadeHidro) {
		this.qtdVezIncidenciaAnormalidadeHidro = qtdVezIncidenciaAnormalidadeHidro;
	}
...
//	}
	 ...
	 * @autor Jonathan
	 * @date 13/01/2014
	 * @return enderecoFormatado com nome CEP
	 */
	public String getEnderecoFormatado2ViaContaFichaCompensacao() {
		String endereco = null;
	...
	public Integer getNumeroDiasBloqueiaSenha() {
		return numeroDiasBloqueiaSenha;
	}

	public void setNumeroDiasBloqueiaSenha(Integer numeroDiasBloqueiaSenha) {
		this.numeroDiasBloqueiaSenha = numeroDiasBloqueiaSenha;
	}

	public Integer getIcModulosSeguranca() {
		return icModulosSeguranca;
	}

	public void setIcModulosSeguranca(Integer icModulosSeguranca) {
		this.icModulosSeguranca = icModulosSeguranca;
	}

	public Integer getPeriodoRevalidarSenha() {
		return periodoRevalidarSenha;
	}

	public void setPeriodoRevalidarSenha(Integer periodoRevalidarSenha) {
		this.periodoRevalidarSenha = periodoRevalidarSenha;
	}

	public Integer getDiasRevalidarSenha() {
		return diasRevalidarSenha;
	}

	public void setDiasRevalidarSenha(Integer diasRevalidarSenha) {
		this.diasRevalidarSenha = diasRevalidarSenha;
	}

	public Short getIndicadorPercentualColetaEsgoto() {
		return indicadorPercentualColetaEsgoto;
	}

	public void setIndicadorPercentualColetaEsgoto(
			Short indicadorPercentualColetaEsgoto) {
	...
	public void setClienteUsuarioDesconhecido(Cliente clienteUsuarioDesconhecido) {
		ClienteUsuarioDesconhecido = clienteUsuarioDesconhecido;
	}

	public Cliente getClienteDiretorGestao() {
		return clienteDiretorGestao;
	}

	public void setClienteDiretorGestao(Cliente clienteDiretorGestao) {
		this.clienteDiretorGestao = clienteDiretorGestao;
	}

	public Short getIndicadorDesconsiderarRateioEsgoto() {
		return indicadorDesconsiderarRateioEsgoto;
	}

	public void setIndicadorDesconsiderarRateioEsgoto(Short indicadorDesconsiderarRateioEsgoto) {
	...
	public String getPastaMovimentoArrecadadoresCritica() {
		return pastaMovimentoArrecadadoresCritica;
	}

	public String getPastaMovimentoArrecadadoresProcessar() {
		return pastaMovimentoArrecadadoresProcessar;
	}

	public String getPastaMovimentoArrecadadoresProcessados() {
		return pastaMovimentoArrecadadoresProcessados;
	}

	public void setPastaMovimentoArrecadadoresCritica(
			String pastaMovimentoArrecadadoresCritica) {
		this.pastaMovimentoArrecadadoresCritica = pastaMovimentoArrecadadoresCritica;
	}

	public void setPastaMovimentoArrecadadoresProcessar(
			String pastaMovimentoArrecadadoresProcessar) {
		this.pastaMovimentoArrecadadoresProcessar = pastaMovimentoArrecadadoresProcessar;
	}

	public void setPastaMovimentoArrecadadoresProcessados(
			String pastaMovimentoArrecadadoresProcessados) {
		this.pastaMovimentoArrecadadoresProcessados = pastaMovimentoArrecadadoresProcessados;
	}

	public Integer getDiasAtualizarLigacaoAguaImovelFisc() {
		return diasAtualizarLigacaoAguaImovelFisc;
	}

	public void setDiasAtualizarLigacaoAguaImovelFisc(
			Integer diasAtualizarLigacaoAguaImovelFisc) {
		this.diasAtualizarLigacaoAguaImovelFisc = diasAtualizarLigacaoAguaImovelFisc;
	}

	public Short getIndicadorBloqFuncInstalacaoSubtHidrometro() {
		return indicadorBloqFuncInstalacaoSubtHidrometro;
	}

	public void setIndicadorBloqFuncInstalacaoSubtHidrometro(
			Short indicadorBloqFuncInstalacaoSubtHidrometro) {
		this.indicadorBloqFuncInstalacaoSubtHidrometro = indicadorBloqFuncInstalacaoSubtHidrometro;
	}

	public String getArquivosResetorizacaoAProcessar() {
		return arquivosResetorizacaoAProcessar;
	}

	public void setArquivosResetorizacaoAProcessar(String arquivosResetorizacaoAProcessar) {
		this.arquivosResetorizacaoAProcessar = arquivosResetorizacaoAProcessar;
	}

	public String getArquivosResetorizacaoProcessado() {
		return arquivosResetorizacaoProcessado;
	}

	public void setArquivosResetorizacaoProcessado(String arquivosResetorizacaoProcessado) {
		this.arquivosResetorizacaoProcessado = arquivosResetorizacaoProcessado;
	}

	public String getArquivosResetorizacaoCritica() {
		return arquivosResetorizacaoCritica;
	}

	public void setArquivosResetorizacaoCritica(String arquivosResetorizacaoCritica) {
		this.arquivosResetorizacaoCritica = arquivosResetorizacaoCritica;
	}

	public Short getIndicadorImprimirExtratoSorteio() {
		return indicadorImprimirExtratoSorteio;
	}

	public void setIndicadorImprimirExtratoSorteio(
			Short indicadorImprimirExtratoSorteio) {
		this.indicadorImprimirExtratoSorteio = indicadorImprimirExtratoSorteio;
	}

	public Integer getNumeroVezesAlterarVinculo() {
		return numeroVezesAlterarVinculo;
	}

	public void setNumeroVezesAlterarVinculo(Integer numeroVezesAlterarVinculo) {
		this.numeroVezesAlterarVinculo = numeroVezesAlterarVinculo;
	}

	public Integer getNumeroDiasInserirProcessoCobranca() {
		return numeroDiasInserirProcessoCobranca;
	}

	public void setNumeroDiasInserirProcessoCobranca(
			Integer numeroDiasInserirProcessoCobranca) {
		this.numeroDiasInserirProcessoCobranca = numeroDiasInserirProcessoCobranca;
	}

	public Integer getQuantidadeMaximaContasItensEspecialFaturamento() {
		return quantidadeMaximaContasItensEspecialFaturamento;
	}

	public void setQuantidadeMaximaContasItensEspecialFaturamento(
			Integer quantidadeMaximaContasItensEspecialFaturamento) {
		this.quantidadeMaximaContasItensEspecialFaturamento = quantidadeMaximaContasItensEspecialFaturamento;
	}

	public Integer getFaturamentoInicioContratoPPP() {
		return faturamentoInicioContratoPPP;
	}

	public void setFaturamentoInicioContratoPPP(Integer faturamentoInicioContratoPPP) {
		this.faturamentoInicioContratoPPP = faturamentoInicioContratoPPP;
	}

	public BigDecimal getPercentualPPP() {
		return percentualPPP;
	}

	public void setPercentualPPP(BigDecimal percentualPPP) {
		this.percentualPPP = percentualPPP;
	}

	public Integer getQuantidadeDiasFaturarFactivel() {
		return quantidadeDiasFaturarFactivel;
	}

	public void setQuantidadeDiasFaturarFactivel(
			Integer quantidadeDiasFaturarFactivel) {
		this.quantidadeDiasFaturarFactivel = quantidadeDiasFaturarFactivel;
	}
	public short getIdadeMinimaUsuario() {
		return idadeMinimaUsuario;
	}

	public void setIdadeMinimaUsuario(short idadeMinimaUsuario) {
		this.idadeMinimaUsuario = idadeMinimaUsuario;
	}

	public Integer getNumeroLimiteOSCobranca() {
		return numeroLimiteOSCobranca;
	}

	public void setNumeroLimiteOSCobranca(Integer numeroLimiteOSCobranca) {
		this.numeroLimiteOSCobranca = numeroLimiteOSCobranca;
	}

	public Short getNumeroDiasEncerramentoOrdemServicoFactivelFaturavel() {
		return numeroDiasEncerramentoOrdemServicoFactivelFaturavel;
	}

	public void setNumeroDiasEncerramentoOrdemServicoFactivelFaturavel(Short numeroDiasEncerramentoOrdemServicoFactivelFaturavel) {
		this.numeroDiasEncerramentoOrdemServicoFactivelFaturavel = numeroDiasEncerramentoOrdemServicoFactivelFaturavel;
	}
	...
	public Integer getQtdDiasParaSuspensaoDoacao() {
		return qtdDiasParaSuspensaoDoacao;
	}

	public void setQtdDiasParaSuspensaoDoacao(Integer qtdDiasParaSuspensaoDoacao) {
		this.qtdDiasParaSuspensaoDoacao = qtdDiasParaSuspensaoDoacao;
	}

	public String getImagemArpe() {
		return imagemArpe;
	}

	public void setImagemArpe(String imagemArpe) {
		this.imagemArpe = imagemArpe;
	}

	public String getImagemRodapeConta() {
		return imagemRodapeConta;
	}

	public void setImagemRodapeConta(String imagemRodapeConta) {
		this.imagemRodapeConta = imagemRodapeConta;
	}

	public Integer getAnoMesReferenciaContaModeloAnterior() {
		return anoMesReferenciaContaModeloAnterior;
	}

	public void setAnoMesReferenciaContaModeloAnterior(Integer anoMesReferenciaContaModeloAnterior) {
		this.anoMesReferenciaContaModeloAnterior = anoMesReferenciaContaModeloAnterior;
	}

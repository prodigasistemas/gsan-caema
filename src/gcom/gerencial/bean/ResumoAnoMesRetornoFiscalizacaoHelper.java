...
public class ResumoAnoMesRetornoFiscalizacaoHelper implements Serializable  {
	...
	private Collection<ResumoCobrancaAcaoSituacaoAcaoDetalhesHelper> colecaoResumoCobrancaAcaoSituacaoAcaoDetalhesHelper;


	public ResumoAnoMesRetornoFiscalizacaoHelper() {
	}	
	
	public ResumoAnoMesRetornoFiscalizacaoHelper(String anoMes,
	...
	public Collection getColecaoResumoCobrancaAcaoSituacaoAcaoDetalhesHelper() {
		return colecaoResumoCobrancaAcaoSituacaoAcaoDetalhesHelper;
	}

	public void setColecaoResumoCobrancaAcaoSituacaoAcaoDetalhesHelper(
			Collection colecaoResumoCobrancaAcaoSituacaoAcaoDetalhesHelper) {
		this.colecaoResumoCobrancaAcaoSituacaoAcaoDetalhesHelper = colecaoResumoCobrancaAcaoSituacaoAcaoDetalhesHelper;
	}
	public String getAnoMesFormatado() {
		String anoMesFormatado = Util.formatarAnoMesParaMesAno(this.anoMes);

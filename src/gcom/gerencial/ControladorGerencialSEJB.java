...
/*                Object[] totalLigacoes = 
	 ...
	 * 
	 */
	public Collection obterColecaoUnidadeNegocioGerencial() throws ControladorException{
		
		try{
			return this.repositorioGerencial.obterColecaoUnidadeNegocioGerencial();
		} catch (ErroRepositorioException ex) {
			throw new ControladorException("erro.sistema", ex);
		}
	 ...
	 * 
	 */
	public boolean validarReferenciaGerencial(String anoMesReferencia) throws ControladorException{
		try{
			return this.repositorioGerencial.validarReferenciaGerencial(anoMesReferencia);
		} catch (ErroRepositorioException ex) {
			throw new ControladorException("erro.sistema", ex);
		}
	}
	...
	public Collection obterDadosKitCASInstalacaoHidrometro(
			FiltrarResumoDadosCasHelper helper, Integer idCategoria, Integer idPerfilImovel) throws ControladorException
	{
		try{
			return this.repositorioGerencial.obterDadosKitCASInstalacaoHidrometro(helper,idCategoria,idPerfilImovel);
		} catch (ErroRepositorioException ex) {
			throw new ControladorException("erro.sistema", ex);
		}
	}
	...
	public Collection obterDadosKitCASLigacaoEconomia(
			...
			try{
				return this.repositorioGerencial.obterDadosKitCASLigacaoEconomia(helper,idCategoria,idPerfilImovel);
			} catch (ErroRepositorioException ex) {
				throw new ControladorException("erro.sistema", ex);
			}
		}
	...
	public Collection obterDadosKitCASServicos(
			...
			{
				try{
					return this.repositorioGerencial.obterDadosKitCASServicos(helper,idCategoria,idPerfilImovel);
				} catch (ErroRepositorioException ex) {
					throw new ControladorException("erro.sistema", ex);
				}
	}
	...
	public Collection obterDadosKitCASResumoFaturamento(
			FiltrarResumoDadosCasHelper helper, Integer idCategoria, Integer idPerfilImovel) throws ControladorException{
		try{
			return this.repositorioGerencial.obterDadosKitCASResumoFaturamento(helper,idCategoria,idPerfilImovel);
		} catch (ErroRepositorioException ex) {
			throw new ControladorException("erro.sistema", ex);
		}
	...
	public Collection obterDadosKitCASDesempenhoMicromedicao(
		...
		try{
			return this.repositorioGerencial.obterDadosKitCASDesempenhoMicromedicao(helper,idCategoria,idPerfilImovel);
		} catch (ErroRepositorioException ex) {
			throw new ControladorException("erro.sistema", ex);
		}
	}
	...
	public Collection obterDadosKitCASLeituraAnormalidade(
			FiltrarResumoDadosCasHelper helper, Integer idCategoria, Integer idPerfilImovel) throws ControladorException{
			try{
				return this.repositorioGerencial.obterDadosKitCASLeituraAnormalidade(helper,idCategoria,idPerfilImovel);
			} catch (ErroRepositorioException ex) {
				throw new ControladorException("erro.sistema", ex);
			}
	}
	...
	public Collection obterDadosKitCASConsumoAgua(
			FiltrarResumoDadosCasHelper helper, Integer idCategoria, Integer idPerfilImovel) throws ControladorException{
			try{
				return this.repositorioGerencial.obterDadosKitCASConsumoAgua(helper,idCategoria,idPerfilImovel);
			} catch (ErroRepositorioException ex) {
				throw new ControladorException("erro.sistema", ex);
			}
	}
	...
	public Collection obterDadosKitCASConsumoAgua2(
			FiltrarResumoDadosCasHelper helper, Integer idCategoria, Integer idPerfilImovel) throws ControladorException{
			try{
				return this.repositorioGerencial.obterDadosKitCASConsumoAgua2(helper,idCategoria,idPerfilImovel);
			} catch (ErroRepositorioException ex) {
				throw new ControladorException("erro.sistema", ex);
			}
	}
	...
	public Collection obterDadosKitCASLigacaoInativaEconomia(
			FiltrarResumoDadosCasHelper helper, Integer idCategoria, Integer idPerfilImovel) throws ControladorException{
			try{
				return this.repositorioGerencial.obterDadosKitCASLigacaoInativaEconomia(helper,idCategoria,idPerfilImovel);
			} catch (ErroRepositorioException ex) {
				throw new ControladorException("erro.sistema", ex);
			}
	}
	...
	public Collection obterDadosKitCASServicosTipoRevisao(
			FiltrarResumoDadosCasHelper helper, Integer idCategoria, Integer idPerfilImovel, Integer idTipoRevisao) throws ControladorException{
			try{
				return this.repositorioGerencial.obterDadosKitCASServicosTipoRevisao(helper,idCategoria,idPerfilImovel,idTipoRevisao);
			} catch (ErroRepositorioException ex) {
				throw new ControladorException("erro.sistema", ex);
			}
	}
	...
	public Collection obterDadosKitCASServicosCartasNegativacao(
			FiltrarResumoDadosCasHelper helper, Integer idCategoria, Integer idPerfilImovel) throws ControladorException{
		try{
			return this.repositorioGerencial.obterDadosKitCASServicosCartasNegativacao(helper,idCategoria,idPerfilImovel);
		} catch (ErroRepositorioException ex) {
			throw new ControladorException("erro.sistema", ex);
		}
	}

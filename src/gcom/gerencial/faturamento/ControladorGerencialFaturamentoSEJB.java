...
import gcom.gerencial.faturamento.bean.ResumoKitCasServicoHelper;
...
public class ControladorGerencialFaturamentoSEJB implements SessionBean {
     ...
     */
    public void gerarResumoKitCASServico(Integer idLocalidade, 
    		Integer idFuncionalidadeIniciada, Integer anoMesReferenciaFaturamento) 
    		throws ControladorException {
        ...
        try {         
            ...
            //[FS0001] - Verificar existência de resumo para o ano/mês de referência
            repositorioGerencialCadastro.removerResumoKisCasServico(anoMesReferenciaFaturamento, idLocalidade);
        	
            List<ResumoKitCasServicoHelper> listaResumo = new ArrayList<ResumoKitCasServicoHelper>();
            // 1.1.	Gera o resumo das ligações de água 
        	// [SB0001 - Gerar Resumo Ligação de Água].
            listaResumo = this.gerarResumoKitCasServicoLigacaoAgua(idLocalidade, anoMesReferenciaFaturamento, listaResumo);
        	
            // 1.2.	Gera o resumo das Ordens Serviços
        	// [SB0002 - Gerar Resumo Ordens Serviço].
            this.gerarResumoKitCasServicoOrdemServico(idLocalidade, anoMesReferenciaFaturamento, listaResumo);
        	
            // 1.3.	Gera o resumo dos Documentos Cobrança 
        	// [SB0003 - Gerar Resumo Documentos Cobrança].
            this.gerarResumoKitCasServicoDocumentoCobranca(idLocalidade, anoMesReferenciaFaturamento, listaResumo);
            
            // 1.4.	Gera o resumo das Contas
        	// [SB0007 - Gerar Resumo Contas].
            List<ResumoKitCasServicoHelper> listaResumoConta = this.gerarResumoKitCasServicoConta(idLocalidade, anoMesReferenciaFaturamento);
        	
            // 1.5.	Gera o resumo das Situações de Cobrança Imóvel
        	// [SB0009 - Gerar Resumo Situações de Cobrança Imóvel].
            this.gerarResumoKitCasServicoSituacaoCobranca(idLocalidade, anoMesReferenciaFaturamento, listaResumo);

        	// 1.6.	Gera o resumo dos Registros de Atendimentos
        	// [SB0011 - Gerar Resumo RA].
            this.gerarResumoKitCasServicoRegistroAtendimento(idLocalidade, anoMesReferenciaFaturamento, listaResumo);

        	// 1.7.	Gera o resumo do Movimento Roteiro Empresa
            // [SB0013 - Gerar Resumo Movimento Roteiro Empresa].
            this.gerarResumoKitCasServicoMovimentoRoteiroEmpresa(idLocalidade, anoMesReferenciaFaturamento, listaResumo);

        	// 1.7.	Gera o resumo do Movimento Roteiro Empresa
            // [SB0013 - Gerar Resumo Movimento Roteiro Empresa].
            this.gerarResumoKitCasServicoMovimentoRoteiroEmpresaRegRecebidos(idLocalidade, anoMesReferenciaFaturamento, listaResumo);
            
            //1.8. Gera o resumo das Alterações de Economia
       	    //[SB0015 - Gerar Resumo Alterações de Economia]
            this.gerarResumoKitCaServicoAlteracoesEconomia(idLocalidade, anoMesReferenciaFaturamento, listaResumo);
            
            //1.9. Gera o resumo das Alterações de Categoria
       	    //[SB0017 - Gerar Resumo Alterações de Categoria]
            this.gerarResumoKitCaServicoAlteracoesCategoria(idLocalidade, anoMesReferenciaFaturamento, listaResumo);
            
            //1.10. Gera o resumo das Inclusões na Tarifa Social
            //[SB0019 - Gerar Resumo Inclusão Tarifa Social]
            this.gerarResumoKitCaServicoInclusaoTarifaSocial(idLocalidade, anoMesReferenciaFaturamento, listaResumo);
            
            //1.11. Gera o resumo das Exclusões na Tarifa Social
            //[SB0021 - Gerar Resumo Exclusão Tarifa Social]
            this.gerarResumoKitCaServicoExclusaoTarifaSocial(idLocalidade, anoMesReferenciaFaturamento, listaResumo);
            
            //1.12. Gera o resumo dos Faturamentos Suspensos
            //[SB0023 - Gerar Resumo Faturamento Suspenso]
            this.gerarResumoKitCaServicoFaturamentoSuspenso(idLocalidade, anoMesReferenciaFaturamento, listaResumo);
            
            
            Integer quantidade = listaResumo.size() + listaResumoConta.size();
            
            System.out.println("Quantidade de Registros a inserir para Localidade " + idLocalidade + ": " + quantidade);
            // Inserimos todos os helpers de resumo
            Iterator iteResumo = listaResumo.iterator();
            while (iteResumo.hasNext()){
            	ResumoKitCasServicoHelper helper = (ResumoKitCasServicoHelper) iteResumo.next();
                
                repositorioGerencialFaturamento.inserirResumoKitCasServico(helper);
            }    
            Iterator iteResumoConta = listaResumoConta.iterator();
            while (iteResumoConta.hasNext()){
            	ResumoKitCasServicoHelper helperConta = (ResumoKitCasServicoHelper) iteResumoConta.next();
                
                repositorioGerencialFaturamento.inserirResumoKitCasServico(helperConta);
            }   
            ...
            System.out.println(" Gerar Resumo do Kit CAS de Serviço - ERRO NA LOCALIDADE " + idLocalidade);
            ex.printStackTrace();
     ...
     * [UC1306] Gerar Resumo do Kit CAS de Serviço
     *
     * [SB0001] - Gerar Resumo Ligação Água
     *
     * @author Mariana Victor
     * @date 02/04/2012
     *
     ...
     * @throws ControladorException
     */
    private List<ResumoKitCasServicoHelper> gerarResumoKitCasServicoLigacaoAgua(Integer idLocalidade, 
    		Integer anoMesReferenciaFaturamento, List<ResumoKitCasServicoHelper> listaResumo) 
    		throws ControladorException {
    	
    	try{
            // Selecionamos as Ligações de Água
            Collection<Object[]> colLigacaoAgua = this.repositorioGerencialFaturamento
                .pesquisarDadosResumoKitCasServicoLigacaoAgua(idLocalidade, anoMesReferenciaFaturamento);        
            
            Iterator iteLigacaoAgua = colLigacaoAgua.iterator();

            System.out.println("Gerar Resumo do Kit CAS de Serviço - LOCA " + idLocalidade + " - QUANTIDADE LIGAÇÃO DE ÁGUA " + colLigacaoAgua.size());
            
            // 2.1.	Para cada ligação de água selecionada:
            while (iteLigacaoAgua.hasNext()) {
                Object[] dadosLigacaoAgua = (Object[]) iteLigacaoAgua.next();
                
                ResumoKitCasServicoHelper helperLigacaoAgua = new ResumoKitCasServicoHelper();

                helperLigacaoAgua.setAnoMesFaturamento(anoMesReferenciaFaturamento);
                //1.1.	Gerência Regional
                helperLigacaoAgua.setIdGerenciaRegional((Integer) dadosLigacaoAgua[0]);
                //1.2.	Unidade de Negócio
                helperLigacaoAgua.setIdUnidadeNegocio((Integer) dadosLigacaoAgua[1]);
                //1.3.	Elo
                helperLigacaoAgua.setCdElo((Integer) dadosLigacaoAgua[2]);
                //1.4.	Localidade
                helperLigacaoAgua.setIdLocalidade((Integer) dadosLigacaoAgua[3]);
                //1.5.	Setor Comercial
                helperLigacaoAgua.setIdSetorComercial((Integer) dadosLigacaoAgua[4]);
                //1.6.	Código do Setor Comercial
                helperLigacaoAgua.setCdSetorComercial((Integer) dadosLigacaoAgua[5]);
                //1.7.	Rota
                helperLigacaoAgua.setIdRota((Integer) dadosLigacaoAgua[6]);
                //1.8.	Quadra
                helperLigacaoAgua.setIdQuadra((Integer) dadosLigacaoAgua[7]);
                //1.9.	Número da Quadra
                helperLigacaoAgua.setNmQuadra((Integer) dadosLigacaoAgua[8]);
                //1.10.	Perfil do Imóvel
                helperLigacaoAgua.setIdPerfilImovel((Integer) dadosLigacaoAgua[9]);
                //1.11.	Situação da Ligação de Água
                helperLigacaoAgua.setSituacaoLigacaoAgua((Integer) dadosLigacaoAgua[10]);
                //1.12.	Situação da Ligação de Esgoto
                helperLigacaoAgua.setSituacaoLigacaoEsgoto((Integer) dadosLigacaoAgua[11]);
                //1.13.	Categoria
                helperLigacaoAgua.setIdCategoria((Integer) dadosLigacaoAgua[12]);
                //1.14.	Subcategoria
                helperLigacaoAgua.setIdSubcategoria((Integer) dadosLigacaoAgua[13]);
                //1.15.	Esfera de Poder
                helperLigacaoAgua.setIdEsferaPoder((Integer) dadosLigacaoAgua[14]);
                //1.16.	Tipo de Cliente
                helperLigacaoAgua.setIdTipoCliente((Integer) dadosLigacaoAgua[15]);
                ...
                if (listaResumo.contains(helperLigacaoAgua)) {
                    int posicao = listaResumo.indexOf(helperLigacaoAgua);
                    helperLigacaoAgua = 
                        (ResumoKitCasServicoHelper) listaResumo.get(posicao);
                }

                Integer quantidade = (Integer) dadosLigacaoAgua[18];
                
                // 2.1.1. Caso o ano/mês da data de supressão da ligação de água seja igual ao ano/mês do faturamento menos um mês
                if(((String) dadosLigacaoAgua[16]).trim().equalsIgnoreCase("sim")) {
                	helperLigacaoAgua.setQuantidadeSupressoesExecutadas(
                		helperLigacaoAgua.getQuantidadeSupressoesExecutadas() + quantidade);
                } 
                
                // 2.1.2. Caso o ano/mês da data de restabelecimento da ligação de água seja igual ao ano/mês do faturamento menos um mês 
                if(((String) dadosLigacaoAgua[17]).trim().equalsIgnoreCase("sim")) {
                	helperLigacaoAgua.setQuantidadeRestabelecimentos(
                		helperLigacaoAgua.getQuantidadeRestabelecimentos() + quantidade);
                }
                
                if (!listaResumo.contains(helperLigacaoAgua)) {
                    listaResumo.add(helperLigacaoAgua);
                }
            }
     ...
     * [UC1306] Gerar Resumo do Kit CAS de Serviço
     *
     * [SB0002] - Gerar Resumo Ordens de Serviço 
     *
     * @author Mariana Victor
     * @date 02/04/2012
     *
     ...
     * @throws ControladorException
     */
    private List<ResumoKitCasServicoHelper> gerarResumoKitCasServicoOrdemServico(Integer idLocalidade, 
    		Integer anoMesReferenciaFaturamento, List<ResumoKitCasServicoHelper> listaResumo) 
    		throws ControladorException {
    	
    	try{
            // Selecionamos as Ordens de Serviço
            Collection<Object[]> colOrdemServico = this.repositorioGerencialFaturamento
                .pesquisarDadosResumoKitCasServicoOrdemServico(idLocalidade, anoMesReferenciaFaturamento);        
            
            Iterator iteOrdemServico = colOrdemServico.iterator();
    
            System.out.println("Gerar Resumo do Kit CAS de Serviço - LOCA " + idLocalidade + " - QUANTIDADE ORDEM DE SERVIÇO " + colOrdemServico.size());
            
            // 2. Para cada OS lida, o sistema deverá acumular os valores conforme a seguir:
            while (iteOrdemServico.hasNext()) {
                Object[] dadosOrdemServico = (Object[]) iteOrdemServico.next();
                
                ResumoKitCasServicoHelper helperOrdemServico = new ResumoKitCasServicoHelper();

                helperOrdemServico.setAnoMesFaturamento(anoMesReferenciaFaturamento);
                //1.1.	Gerência Regional
                helperOrdemServico.setIdGerenciaRegional((Integer) dadosOrdemServico[0]);
                //1.2.	Unidade de Negócio
                helperOrdemServico.setIdUnidadeNegocio((Integer) dadosOrdemServico[1]);
                //1.3.	Elo
                helperOrdemServico.setCdElo((Integer) dadosOrdemServico[2]);
                //1.4.	Localidade
                helperOrdemServico.setIdLocalidade((Integer) dadosOrdemServico[3]);
                //1.5.	Setor Comercial
                helperOrdemServico.setIdSetorComercial((Integer) dadosOrdemServico[4]);
                //1.6.	Código do Setor Comercial
                helperOrdemServico.setCdSetorComercial((Integer) dadosOrdemServico[5]);
                //1.7.	Rota
                helperOrdemServico.setIdRota((Integer) dadosOrdemServico[6]);
                //1.8.	Quadra
                helperOrdemServico.setIdQuadra((Integer) dadosOrdemServico[7]);
                //1.9.	Número da Quadra
                helperOrdemServico.setNmQuadra((Integer) dadosOrdemServico[8]);
                //1.10.	Perfil do Imóvel
                helperOrdemServico.setIdPerfilImovel((Integer) dadosOrdemServico[9]);
                //1.11.	Situação da Ligação de Água
                helperOrdemServico.setSituacaoLigacaoAgua((Integer) dadosOrdemServico[10]);
                //1.12.	Situação da Ligação de Esgoto
                helperOrdemServico.setSituacaoLigacaoEsgoto((Integer) dadosOrdemServico[11]);
                //1.13.	Categoria
                helperOrdemServico.setIdCategoria((Integer) dadosOrdemServico[12]);
                //1.14.	Subcategoria
                helperOrdemServico.setIdSubcategoria((Integer) dadosOrdemServico[13]);
                //1.15.	Esfera de Poder
                helperOrdemServico.setIdEsferaPoder((Integer) dadosOrdemServico[14]);
                //1.16.	Tipo de Cliente
                helperOrdemServico.setIdTipoCliente((Integer) dadosOrdemServico[15]);

                // Verificamos se ja existe um helper com as quebras
                // inserido na lista de resumo. Se sim, apenas somamos
                // os valores, senão, colocamos um helper novo na lista
                if (listaResumo.contains(helperOrdemServico)){
                    int posicao = listaResumo.indexOf(helperOrdemServico);
                    helperOrdemServico = 
                        (ResumoKitCasServicoHelper) listaResumo.get(posicao);
                }

                Integer quantidade = (Integer) dadosOrdemServico[17];
                
                // 2.1.1. Caso o ano/mês da data de supressão da ligação de água seja igual ao ano/mês do faturamento menos um mês
                if(((String) dadosOrdemServico[16]).trim().equalsIgnoreCase("cortados")) {
                	helperOrdemServico.setQuantidadeFiscalizacoesOriundasCortados(
                		helperOrdemServico.getQuantidadeFiscalizacoesOriundasCortados() + quantidade);
                } else {
                	helperOrdemServico.setQuantidadeFiscalizacoesOriundasSuprimidos(
                		helperOrdemServico.getQuantidadeFiscalizacoesOriundasSuprimidos() + quantidade);
                }
                
                if (!listaResumo.contains(helperOrdemServico)){
                    listaResumo.add(helperOrdemServico);
                }
            }
     ...
     * @throws ControladorException
     */
    private List<ResumoKitCasServicoHelper> gerarResumoKitCasServicoDocumentoCobranca(Integer idLocalidade, 
    		Integer anoMesReferenciaFaturamento, List<ResumoKitCasServicoHelper> listaResumo) 
    		throws ControladorException {
    	
    	try{
            // Selecionamos as Ordens de Serviço
            Collection<Object[]> colDocumentoCobranca = this.repositorioGerencialFaturamento
                .pesquisarDadosResumoKitCasServicoDocumentoCobranca(idLocalidade, anoMesReferenciaFaturamento);
            
            Iterator iteDocumentoCobranca = colDocumentoCobranca.iterator();
    
            System.out.println("Gerar Resumo do Kit CAS de Serviço - LOCA " + idLocalidade + " - QUANTIDADE DOCUMENTO DE COBRANÇA " + colDocumentoCobranca.size());
            
            // 2. Para cada Documento de Cobrança lida, o sistema deverá acumular os valores conforme a seguir:
            while (iteDocumentoCobranca.hasNext()) {
                Object[] dadosDocumentoCobranca = (Object[]) iteDocumentoCobranca.next();
                
                ResumoKitCasServicoHelper helperDocumentoCobranca = new ResumoKitCasServicoHelper();

                helperDocumentoCobranca.setAnoMesFaturamento(anoMesReferenciaFaturamento);
                //1.1.	Gerência Regional
                helperDocumentoCobranca.setIdGerenciaRegional((Integer) dadosDocumentoCobranca[0]);
                //1.2.	Unidade de Negócio
                helperDocumentoCobranca.setIdUnidadeNegocio((Integer) dadosDocumentoCobranca[1]);
                //1.3.	Elo
                helperDocumentoCobranca.setCdElo((Integer) dadosDocumentoCobranca[2]);
                //1.4.	Localidade
                helperDocumentoCobranca.setIdLocalidade((Integer) dadosDocumentoCobranca[3]);
                //1.5.	Setor Comercial
                helperDocumentoCobranca.setIdSetorComercial((Integer) dadosDocumentoCobranca[4]);
                //1.6.	Código do Setor Comercial
                helperDocumentoCobranca.setCdSetorComercial((Integer) dadosDocumentoCobranca[5]);
                //1.7.	Rota
                helperDocumentoCobranca.setIdRota((Integer) dadosDocumentoCobranca[6]);
                //1.8.	Quadra
                helperDocumentoCobranca.setIdQuadra((Integer) dadosDocumentoCobranca[7]);
                //1.9.	Número da Quadra
                helperDocumentoCobranca.setNmQuadra((Integer) dadosDocumentoCobranca[8]);
                //1.10.	Perfil do Imóvel
                helperDocumentoCobranca.setIdPerfilImovel((Integer) dadosDocumentoCobranca[9]);
                //1.11.	Situação da Ligação de Água
                helperDocumentoCobranca.setSituacaoLigacaoAgua((Integer) dadosDocumentoCobranca[10]);
                //1.12.	Situação da Ligação de Esgoto
                helperDocumentoCobranca.setSituacaoLigacaoEsgoto((Integer) dadosDocumentoCobranca[11]);
                //1.13.	Categoria
                helperDocumentoCobranca.setIdCategoria((Integer) dadosDocumentoCobranca[12]);
                //1.14.	Subcategoria
                helperDocumentoCobranca.setIdSubcategoria((Integer) dadosDocumentoCobranca[13]);
                //1.15.	Esfera de Poder
                helperDocumentoCobranca.setIdEsferaPoder((Integer) dadosDocumentoCobranca[14]);
                //1.16.	Tipo de Cliente
                helperDocumentoCobranca.setIdTipoCliente((Integer) dadosDocumentoCobranca[15]);

                // Verificamos se ja existe um helper com as quebras
                // inserido na lista de resumo. Se sim, apenas somamos
                // os valores, senão, colocamos um helper novo na lista
                
                if (listaResumo.contains(helperDocumentoCobranca)){
                    int posicao = listaResumo.indexOf(helperDocumentoCobranca);
                    helperDocumentoCobranca = 
                        (ResumoKitCasServicoHelper) listaResumo.get(posicao);
                }
                
                // 2.1.	Acumula as quantidades de Documento de Cobrança
                Integer quantidade = (Integer) dadosDocumentoCobranca[16];
    			helperDocumentoCobranca.setQuantidadeAvisosCorteEmitidos(
    				helperDocumentoCobranca.getQuantidadeAvisosCorteEmitidos() + quantidade);
    			
    			if (!listaResumo.contains(helperDocumentoCobranca)){
                    listaResumo.add(helperDocumentoCobranca);
                }
     ...
     * @throws ControladorException
     */
    private List<ResumoKitCasServicoHelper> gerarResumoKitCasServicoConta(Integer idLocalidade, 
    		Integer anoMesReferenciaFaturamento) 
    		throws ControladorException {
    	
    	try{
            // Selecionamos as Contas
            Collection<Object[]> colConta = this.repositorioGerencialFaturamento
                .pesquisarDadosResumoKitCasServicoConta(idLocalidade, anoMesReferenciaFaturamento);
            List<ResumoKitCasServicoHelper> listaResumoConta = new ArrayList<ResumoKitCasServicoHelper>();
            Iterator iteConta = colConta.iterator();
    
            System.out.println("Gerar Resumo do Kit CAS de Serviço - LOCA " + idLocalidade + " - QUANTIDADE CONTA " + colConta.size());
            
            // 2. Para cada Conta lida, o sistema deverá acumular os valores conforme a seguir:
            while (iteConta.hasNext()) {
                Object[] dadosConta = (Object[]) iteConta.next();
                
                ResumoKitCasServicoHelper helperConta = new ResumoKitCasServicoHelper();

                helperConta.setAnoMesFaturamento(anoMesReferenciaFaturamento);
                //1.1.	Gerência Regional
                helperConta.setIdGerenciaRegional((Integer) dadosConta[0]);
                //1.2.	Unidade de Negócio
                helperConta.setIdUnidadeNegocio((Integer) dadosConta[1]);
                //1.3.	Elo
                helperConta.setCdElo((Integer) dadosConta[2]);
                //1.4.	Localidade
                helperConta.setIdLocalidade((Integer) dadosConta[3]);
                //1.5.	Setor Comercial
                helperConta.setIdSetorComercial((Integer) dadosConta[4]);
                //1.6.	Código do Setor Comercial
                helperConta.setCdSetorComercial((Integer) dadosConta[5]);
                //1.7.	Rota
                helperConta.setIdRota((Integer) dadosConta[6]);
                //1.8.	Quadra
                helperConta.setIdQuadra((Integer) dadosConta[7]);
                //1.9.	Número da Quadra
                helperConta.setNmQuadra((Integer) dadosConta[8]);
                //1.10.	Perfil do Imóvel
                helperConta.setIdPerfilImovel((Integer) dadosConta[9]);
                //1.11.	Situação da Ligação de Água
                helperConta.setSituacaoLigacaoAgua((Integer) dadosConta[10]);
                //1.12.	Situação da Ligação de Esgoto
                helperConta.setSituacaoLigacaoEsgoto((Integer) dadosConta[11]);
                //1.13.	Categoria
                helperConta.setIdCategoria((Integer) dadosConta[12]);
                //1.14.	Subcategoria
                helperConta.setIdSubcategoria((Integer) dadosConta[13]);
                //1.15.	Esfera de Poder
                helperConta.setIdEsferaPoder((Integer) dadosConta[14]);
                //1.16.	Tipo de Cliente
                helperConta.setIdTipoCliente((Integer) dadosConta[15]);
                //1.17.	Motivo Revisão (CMRV_ID)
                helperConta.setIdContaMotivoRevisao((Integer) dadosConta[16]);               
                //2.1.	Acumula as quantidades de Contas
                helperConta.setQuantidadeFaturasRevisao((Integer) dadosConta[17]);
                //2.2.	Acumula as quantidades de Imóveis
                helperConta.setQuantidadeImoveisFaturasRevisao((Integer) dadosConta[18]);
                
            	listaResumoConta.add(helperConta);
                
            }
            
            return listaResumoConta;
     ...
     * [UC1306] Gerar Resumo do Kit CAS de Serviço
     *
     * [SB0009] - Gerar Resumo Situação de Cobrança do Imóvel
     *
     * @author Mariana Victor
     * @date 04/04/2012
     *
     ...
     * @throws ControladorException
     */
    private List<ResumoKitCasServicoHelper> gerarResumoKitCasServicoSituacaoCobranca(Integer idLocalidade, 
    		Integer anoMesReferenciaFaturamento, List<ResumoKitCasServicoHelper> listaResumo) 
    		throws ControladorException {
    	
    	try{
            // Selecionamos as Situações de Cobrança
            Collection<Object[]> colSituacaoCobranca = this.repositorioGerencialFaturamento
                .pesquisarDadosResumoKitCasServicoSituacaoCobranca(idLocalidade, anoMesReferenciaFaturamento);
            
            Iterator iteSituacaoCobranca = colSituacaoCobranca.iterator();
    
            System.out.println("Gerar Resumo do Kit CAS de Serviço - LOCA " + idLocalidade + " - QUANTIDADE SITUAÇÃO DE COBRANÇA " + colSituacaoCobranca.size());
            
            // 4. Para cada situação de cobrança do imóvel lida, o sistema deverá acumular os valores conforme a seguir:
            while (iteSituacaoCobranca.hasNext()) {
                Object[] dadosSituacaoCobranca = (Object[]) iteSituacaoCobranca.next();
                
                ResumoKitCasServicoHelper helperSituacaoCobranca = new ResumoKitCasServicoHelper();

                helperSituacaoCobranca.setAnoMesFaturamento(anoMesReferenciaFaturamento);
                //3.1.	Gerência Regional
                helperSituacaoCobranca.setIdGerenciaRegional((Integer) dadosSituacaoCobranca[0]);
                //3.2.	Unidade de Negócio
                helperSituacaoCobranca.setIdUnidadeNegocio((Integer) dadosSituacaoCobranca[1]);
                //3.3.	Elo
                helperSituacaoCobranca.setCdElo((Integer) dadosSituacaoCobranca[2]);
                //3.4.	Localidade
                helperSituacaoCobranca.setIdLocalidade((Integer) dadosSituacaoCobranca[3]);
                //3.5.	Setor Comercial
                helperSituacaoCobranca.setIdSetorComercial((Integer) dadosSituacaoCobranca[4]);
                //3.6.	Código do Setor Comercial
                helperSituacaoCobranca.setCdSetorComercial((Integer) dadosSituacaoCobranca[5]);
                //3.7.	Rota
                helperSituacaoCobranca.setIdRota((Integer) dadosSituacaoCobranca[6]);
                //3.8.	Quadra
                helperSituacaoCobranca.setIdQuadra((Integer) dadosSituacaoCobranca[7]);
                //3.9.	Número da Quadra
                helperSituacaoCobranca.setNmQuadra((Integer) dadosSituacaoCobranca[8]);
                //3.10.	Perfil do Imóvel
                helperSituacaoCobranca.setIdPerfilImovel((Integer) dadosSituacaoCobranca[9]);
                //3.11.	Situação da Ligação de Água
                helperSituacaoCobranca.setSituacaoLigacaoAgua((Integer) dadosSituacaoCobranca[10]);
                //3.12.	Situação da Ligação de Esgoto
                helperSituacaoCobranca.setSituacaoLigacaoEsgoto((Integer) dadosSituacaoCobranca[11]);
                //3.13.	Categoria
                helperSituacaoCobranca.setIdCategoria((Integer) dadosSituacaoCobranca[12]);
                //3.14.	Subcategoria
                helperSituacaoCobranca.setIdSubcategoria((Integer) dadosSituacaoCobranca[13]);
                //3.15.	Esfera de Poder
                helperSituacaoCobranca.setIdEsferaPoder((Integer) dadosSituacaoCobranca[14]);
                //3.16.	Tipo de Cliente
                helperSituacaoCobranca.setIdTipoCliente((Integer) dadosSituacaoCobranca[15]);

                // Verificamos se ja existe um helper com as quebras
                // inserido na lista de resumo. Se sim, apenas somamos
                // os valores, senão, colocamos um helper novo na lista
                if (listaResumo.contains(helperSituacaoCobranca)){
                    int posicao = listaResumo.indexOf(helperSituacaoCobranca);
                    helperSituacaoCobranca = 
                        (ResumoKitCasServicoHelper) listaResumo.get(posicao);
                } 

                // 4.1.	Acumula as quantidades de Documento de Cobrança
                Integer quantidade = (Integer) dadosSituacaoCobranca[16];
                helperSituacaoCobranca.setQuantidadeCartasNegativasEmitidas(
                	helperSituacaoCobranca.getQuantidadeCartasNegativasEmitidas() + quantidade);
                
                if (!listaResumo.contains(helperSituacaoCobranca)){
                	listaResumo.add(helperSituacaoCobranca);
                }
            }
     ...
     * @throws ControladorException
     */
    private List<ResumoKitCasServicoHelper> gerarResumoKitCasServicoRegistroAtendimento(Integer idLocalidade, 
    		Integer anoMesReferenciaFaturamento, List<ResumoKitCasServicoHelper> listaResumo) 
    		throws ControladorException {
    	
    	try{
            // Selecionamos as Situações de Cobrança
            Collection<Object[]> colRegistroAtendimento = this.repositorioGerencialFaturamento
                .pesquisarDadosResumoKitCasServicoRegistroAtendimento(idLocalidade, anoMesReferenciaFaturamento);
            
            Iterator<Object[]> iteRegistroAtendimento = colRegistroAtendimento.iterator();
    
            System.out.println("Gerar Resumo do Kit CAS de Serviço - LOCA " + idLocalidade + " - QUANTIDADE REGISTRO DE ATENDIMENTO " + colRegistroAtendimento.size());
            
            // 6. Para cada RA lida, o sistema deverá acumular os valores conforme a seguir:
            while (iteRegistroAtendimento.hasNext()) {
                Object[] dadosRegistroAtendimento = (Object[]) iteRegistroAtendimento.next();
                
                ResumoKitCasServicoHelper helperRegistroAtendimento = new ResumoKitCasServicoHelper();

                helperRegistroAtendimento.setAnoMesFaturamento(anoMesReferenciaFaturamento);
                //5.1.	Gerência Regional
                helperRegistroAtendimento.setIdGerenciaRegional((Integer) dadosRegistroAtendimento[0]);
                //5.2.	Unidade de Negócio
                helperRegistroAtendimento.setIdUnidadeNegocio((Integer) dadosRegistroAtendimento[1]);
                //5.3.	Elo
                helperRegistroAtendimento.setCdElo((Integer) dadosRegistroAtendimento[2]);
                //5.4.	Localidade
                helperRegistroAtendimento.setIdLocalidade((Integer) dadosRegistroAtendimento[3]);
                //5.5.	Setor Comercial
                helperRegistroAtendimento.setIdSetorComercial((Integer) dadosRegistroAtendimento[4]);
                //5.6.	Código do Setor Comercial
                helperRegistroAtendimento.setCdSetorComercial((Integer) dadosRegistroAtendimento[5]);
                //5.7.	Rota
                helperRegistroAtendimento.setIdRota((Integer) dadosRegistroAtendimento[6]);
                //5.8.	Quadra
                helperRegistroAtendimento.setIdQuadra((Integer) dadosRegistroAtendimento[7]);
                //5.9.	Número da Quadra
                helperRegistroAtendimento.setNmQuadra((Integer) dadosRegistroAtendimento[8]);
                //5.10.	Perfil do Imóvel
                helperRegistroAtendimento.setIdPerfilImovel((Integer) dadosRegistroAtendimento[9]);
                //5.11.	Situação da Ligação de Água
                helperRegistroAtendimento.setSituacaoLigacaoAgua((Integer) dadosRegistroAtendimento[10]);
                //5.12.	Situação da Ligação de Esgoto
                helperRegistroAtendimento.setSituacaoLigacaoEsgoto((Integer) dadosRegistroAtendimento[11]);
                //5.13.	Categoria
                helperRegistroAtendimento.setIdCategoria((Integer) dadosRegistroAtendimento[12]);
                //5.14.	Subcategoria
                helperRegistroAtendimento.setIdSubcategoria((Integer) dadosRegistroAtendimento[13]);
                //5.15.	Esfera de Poder
                helperRegistroAtendimento.setIdEsferaPoder((Integer) dadosRegistroAtendimento[14]);
                //5.16.	Tipo de Cliente
                helperRegistroAtendimento.setIdTipoCliente((Integer) dadosRegistroAtendimento[15]);
                
                Short indicadorGeracaoOS = (Short) dadosRegistroAtendimento[16];
                Date dataPrevisao = (Date) dadosRegistroAtendimento[17];
                Integer quantidade = (Integer) dadosRegistroAtendimento[18];
                
                // Verificamos se ja existe um helper com as quebras
                // inserido na lista de resumo. Se sim, apenas somamos
                // os valores, senão, colocamos um helper novo na lista
                if (listaResumo.contains(helperRegistroAtendimento)){
                    int posicao = listaResumo.indexOf(helperRegistroAtendimento);
                    helperRegistroAtendimento = 
                        (ResumoKitCasServicoHelper) listaResumo.get(posicao);
                    
                }
                
                Date dafaFinal = Util.converteStringParaDateHora(
	        			Util.formatarData(Util.gerarDataApartirAnoMesRefencia(anoMesReferenciaFaturamento))
	       			 		+ " 00:00:00");
                
                // SE (AAMM de RGAT_DTPREVISTAORIGINAL >=(AAMM da Data Corrente) 
                //      e STEP_ICGERACAOORDEMSERVICO = 2)
            	if((dataPrevisao.compareTo(dafaFinal) >= 0)) {
            		if(indicadorGeracaoOS.compareTo(ConstantesSistema.NAO) ==0) {
	            		helperRegistroAtendimento.setQuantidadeRAPendentesComerciaisNoPrazo(
	            			helperRegistroAtendimento.getQuantidadeRAPendentesComerciaisNoPrazo() + quantidade);
            		} else {
                		helperRegistroAtendimento.setQuantidadeRAPendentesOperacionaisNoPrazo(
                    			helperRegistroAtendimento.getQuantidadeRAPendentesOperacionaisNoPrazo() + quantidade);
                	}
            	} 
                // SE (AAMM de RGAT_DTPREVISTAORIGINAL <(AAMM de
                //     Data Corrente) e STEP_ICGERACAOORDEMSERVICO = 1)
            	if((dataPrevisao.compareTo(dafaFinal) < 0)) {
            		if (indicadorGeracaoOS.compareTo(ConstantesSistema.NAO) ==0) {
                		helperRegistroAtendimento.setQuantidadeRAPendentesComerciaisForaPrazo(
                    			helperRegistroAtendimento.getQuantidadeRAPendentesComerciaisForaPrazo() + quantidade);
	            	} else {
	            		helperRegistroAtendimento.setQuantidadeRAPendentesOperacionaisForaPrazo(
	            			helperRegistroAtendimento.getQuantidadeRAPendentesOperacionaisForaPrazo() + quantidade);
	            	}
            	}
            	
            	
            	if (!listaResumo.contains(helperRegistroAtendimento)){
                    listaResumo.add(helperRegistroAtendimento);
                }
     ...
     * @throws ControladorException
     */
    private List<ResumoKitCasServicoHelper> gerarResumoKitCasServicoMovimentoRoteiroEmpresa(Integer idLocalidade, 
    		Integer anoMesReferenciaFaturamento, List<ResumoKitCasServicoHelper> listaResumo) 
    		throws ControladorException {
    	
    	try{
            // Selecionamos as Situações de Cobrança
            Collection<Object[]> colMovimentoRoteiroEmpresa = this.repositorioGerencialFaturamento
                .pesquisarDadosResumoKitCasServicoMovimentoRoteiroEmpresa(idLocalidade, anoMesReferenciaFaturamento);
            
            Iterator iteMovimentoRoteiroEmpresa = colMovimentoRoteiroEmpresa.iterator();
    
            System.out.println("Gerar Resumo do Kit CAS de Serviço - LOCA " + idLocalidade + " - QUANTIDADE MOVIMENTO ROT. EMPRESA " + colMovimentoRoteiroEmpresa.size());
            
            // 8. Para cada movimento lido, o sistema deverá acumular os valores conforme a seguir:
            while (iteMovimentoRoteiroEmpresa.hasNext()) {
                Object[] dadosMovimentoRoteiroEmpresa = (Object[]) iteMovimentoRoteiroEmpresa.next();
                
                ResumoKitCasServicoHelper helperMovimentoRoteiroEmpresa = new ResumoKitCasServicoHelper();

                helperMovimentoRoteiroEmpresa.setAnoMesFaturamento(anoMesReferenciaFaturamento);
                //5.1.	Gerência Regional
                helperMovimentoRoteiroEmpresa.setIdGerenciaRegional((Integer) dadosMovimentoRoteiroEmpresa[0]);
                //5.2.	Unidade de Negócio
                helperMovimentoRoteiroEmpresa.setIdUnidadeNegocio((Integer) dadosMovimentoRoteiroEmpresa[1]);
                //5.3.	Elo
                helperMovimentoRoteiroEmpresa.setCdElo((Integer) dadosMovimentoRoteiroEmpresa[2]);
                //5.4.	Localidade
                helperMovimentoRoteiroEmpresa.setIdLocalidade((Integer) dadosMovimentoRoteiroEmpresa[3]);
                //5.5.	Setor Comercial
                helperMovimentoRoteiroEmpresa.setIdSetorComercial((Integer) dadosMovimentoRoteiroEmpresa[4]);
                //5.6.	Código do Setor Comercial
                helperMovimentoRoteiroEmpresa.setCdSetorComercial((Integer) dadosMovimentoRoteiroEmpresa[5]);
                //5.7.	Rota
                helperMovimentoRoteiroEmpresa.setIdRota((Integer) dadosMovimentoRoteiroEmpresa[6]);
                //5.8.	Quadra
                helperMovimentoRoteiroEmpresa.setIdQuadra((Integer) dadosMovimentoRoteiroEmpresa[7]);
                //5.9.	Número da Quadra
                helperMovimentoRoteiroEmpresa.setNmQuadra((Integer) dadosMovimentoRoteiroEmpresa[8]);
                //5.10.	Perfil do Imóvel
                helperMovimentoRoteiroEmpresa.setIdPerfilImovel((Integer) dadosMovimentoRoteiroEmpresa[9]);
                //5.11.	Situação da Ligação de Água
                helperMovimentoRoteiroEmpresa.setSituacaoLigacaoAgua((Integer) dadosMovimentoRoteiroEmpresa[10]);
                //5.12.	Situação da Ligação de Esgoto
                helperMovimentoRoteiroEmpresa.setSituacaoLigacaoEsgoto((Integer) dadosMovimentoRoteiroEmpresa[11]);
                //5.13.	Categoria
                helperMovimentoRoteiroEmpresa.setIdCategoria((Integer) dadosMovimentoRoteiroEmpresa[12]);
                //5.14.	Subcategoria
                helperMovimentoRoteiroEmpresa.setIdSubcategoria((Integer) dadosMovimentoRoteiroEmpresa[13]);
                //5.15.	Esfera de Poder
                helperMovimentoRoteiroEmpresa.setIdEsferaPoder((Integer) dadosMovimentoRoteiroEmpresa[14]);
                //5.16.	Tipo de Cliente
                helperMovimentoRoteiroEmpresa.setIdTipoCliente((Integer) dadosMovimentoRoteiroEmpresa[15]);
                
                Integer quantidadeAnormalidadesInformadas = (Integer) dadosMovimentoRoteiroEmpresa[16];

                // Verificamos se ja existe um helper com as quebras
                // inserido na lista de resumo. Se sim, apenas somamos
                // os valores, senão, colocamos um helper novo na lista
                if (listaResumo.contains(helperMovimentoRoteiroEmpresa)){
                    int posicao = listaResumo.indexOf(helperMovimentoRoteiroEmpresa);
                    helperMovimentoRoteiroEmpresa = 
                        (ResumoKitCasServicoHelper) listaResumo.get(posicao);
                    
                }
                
            	if(quantidadeAnormalidadesInformadas != null 
            			&& quantidadeAnormalidadesInformadas.compareTo(new Integer(0)) > 0) {
            		helperMovimentoRoteiroEmpresa.setQuantidadeAnormalidadesInformadas(
            			helperMovimentoRoteiroEmpresa.getQuantidadeAnormalidadesInformadas() + quantidadeAnormalidadesInformadas);
            	} 
            	
            	if (!listaResumo.contains(helperMovimentoRoteiroEmpresa)){
                    listaResumo.add(helperMovimentoRoteiroEmpresa);
                }
     ...
     * @throws ControladorException
     */
    private List<ResumoKitCasServicoHelper> gerarResumoKitCasServicoMovimentoRoteiroEmpresaRegRecebidos(Integer idLocalidade, 
    		Integer anoMesReferenciaFaturamento, List<ResumoKitCasServicoHelper> listaResumo) 
    		throws ControladorException {
    	...
    	try{
            // Selecionamos as Situações de Cobrança
            Collection<Object[]> colMovimentoRoteiroEmpresa = this.repositorioGerencialFaturamento
                .pesquisarDadosResumoKitCasServicoMovimentoRoteiroEmpresaRegRecebidos(idLocalidade, anoMesReferenciaFaturamento);
            
            Iterator iteMovimentoRoteiroEmpresa = colMovimentoRoteiroEmpresa.iterator();
    
            System.out.println("Gerar Resumo do Kit CAS de Serviço - LOCA " + idLocalidade + " - QUANTIDADE MOVIMENTO ROT. EMPRESA REG. RECEBIDOS " + colMovimentoRoteiroEmpresa.size());
            ...
            while (iteMovimentoRoteiroEmpresa.hasNext()) {
                ...
                Integer quantidadeRegistrosRecebidos = (Integer) dadosMovimentoRoteiroEmpresa[16];
            	...
            	if(quantidadeRegistrosRecebidos != null 
            			&& quantidadeRegistrosRecebidos.compareTo(new Integer(0)) > 0) {
            		helperMovimentoRoteiroEmpresa.setQuantidadeRegistrosRecebidos(
            			helperMovimentoRoteiroEmpresa.getQuantidadeRegistrosRecebidos() + quantidadeRegistrosRecebidos);
            	} 
     ...
     * @throws ControladorException
     */
    private List<ResumoKitCasServicoHelper> gerarResumoKitCaServicoAlteracoesEconomia(Integer idLocalidade, 
    		Integer anoMesReferenciaFaturamento, List<ResumoKitCasServicoHelper> listaResumo) 
    		throws ControladorException {
    	...
    	try{
    		...
    		//3. O sistema seleciona as subcategorias alteradas no ano/mês de faturamento 
    		//   e gera o resumo do KIT CAS de Serviço acumulando as quantidades de economias e de imóveis
    		Collection<Object[]> colAlteracoesEconomia = this.repositorioGerencialFaturamento
                    .gerarResumoKitCaServicoAlteracoesEconomia(idLocalidade, anoMesReferenciaFaturamento);

    		 System.out.println("Gerar Resumo do Kit CAS de Serviço - LOCA " + idLocalidade + " - QUANTIDADE ALTERAÇÕES ECONOMIA " + colAlteracoesEconomia.size());
    		
    		 Iterator itemAlteracaoEconomia = colAlteracoesEconomia.iterator();
    		    
             // 8. Para cada movimento lido, o sistema deverá acumular os valores conforme a seguir:
             while (itemAlteracaoEconomia.hasNext()) {
                 Object[] dadosAlteracaoEconomia = (Object[]) itemAlteracaoEconomia.next();
                 
                 ResumoKitCasServicoHelper helperMovimentoAlteracoesEconomia = new ResumoKitCasServicoHelper();

                 helperMovimentoAlteracoesEconomia.setAnoMesFaturamento(anoMesReferenciaFaturamento);
                 //5.1.	Gerência Regional
                 helperMovimentoAlteracoesEconomia.setIdGerenciaRegional((Integer) dadosAlteracaoEconomia[0]);
                 //5.2.	Unidade de Negócio
                 helperMovimentoAlteracoesEconomia.setIdUnidadeNegocio((Integer) dadosAlteracaoEconomia[1]);
                 //5.3.	Elo
                 helperMovimentoAlteracoesEconomia.setCdElo((Integer) dadosAlteracaoEconomia[2]);
                 //5.4.	Localidade
                 helperMovimentoAlteracoesEconomia.setIdLocalidade((Integer) dadosAlteracaoEconomia[3]);
                 //5.5.	Setor Comercial
                 helperMovimentoAlteracoesEconomia.setIdSetorComercial((Integer) dadosAlteracaoEconomia[4]);
                 //5.6.	Código do Setor Comercial
                 helperMovimentoAlteracoesEconomia.setCdSetorComercial((Integer) dadosAlteracaoEconomia[5]);
                 //5.7.	Rota
                 helperMovimentoAlteracoesEconomia.setIdRota((Integer) dadosAlteracaoEconomia[6]);
                 //5.8.	Quadra
                 helperMovimentoAlteracoesEconomia.setIdQuadra((Integer) dadosAlteracaoEconomia[7]);
                 //5.9.	Número da Quadra
                 helperMovimentoAlteracoesEconomia.setNmQuadra((Integer) dadosAlteracaoEconomia[8]);
                 //5.10.	Perfil do Imóvel
                 helperMovimentoAlteracoesEconomia.setIdPerfilImovel((Integer) dadosAlteracaoEconomia[9]);
                 //5.11.	Situação da Ligação de Água
                 helperMovimentoAlteracoesEconomia.setSituacaoLigacaoAgua((Integer) dadosAlteracaoEconomia[10]);
                 //5.12.	Situação da Ligação de Esgoto
                 helperMovimentoAlteracoesEconomia.setSituacaoLigacaoEsgoto((Integer) dadosAlteracaoEconomia[11]);
                 //5.13.	Categoria
                 helperMovimentoAlteracoesEconomia.setIdCategoria((Integer) dadosAlteracaoEconomia[12]);
                 //5.14.	Subcategoria
                 helperMovimentoAlteracoesEconomia.setIdSubcategoria((Integer) dadosAlteracaoEconomia[13]);
                 //5.15.	Esfera de Poder
                 helperMovimentoAlteracoesEconomia.setIdEsferaPoder((Integer) dadosAlteracaoEconomia[14]);
                 //5.16.	Tipo de Cliente
                 helperMovimentoAlteracoesEconomia.setIdTipoCliente((Integer) dadosAlteracaoEconomia[15]);
                 
                 
                 //	Verificamos se ja existe um helper com as quebras
                 // inserido na lista de resumo. Se sim, apenas somamos
                 // os valores, senão, colocamos um helper novo na lista
                 if (listaResumo.contains(helperMovimentoAlteracoesEconomia)){
                     int posicao = listaResumo.indexOf(helperMovimentoAlteracoesEconomia);
                     helperMovimentoAlteracoesEconomia = 
                         (ResumoKitCasServicoHelper) listaResumo.get(posicao);
                 } 
                 
                 //4.1. Caso a quantidade de economias com data de inclusão
                 //     seja diferente da quantidade de economias com data de exclusão
                 if(((Integer) dadosAlteracaoEconomia[17]).compareTo((Integer) dadosAlteracaoEconomia[18]) != 0){
                	 
                	 //4.1.1. Caso a quantidade de economias com data de inclusão 
                	 //       seja maior do que a quantidade de economias com data de exclusão
                	 if(((Integer) dadosAlteracaoEconomia[17]).compareTo((Integer) dadosAlteracaoEconomia[18]) > 0){
                		 
                		 //4.1.1.1. Somar a quantidade de economias 
                		 //         (quantidade de economias com data de inclusão 
                		 //				- quantidade de economias com data de exclusão) 
                		 //         a RKCA_QTECONOMIASACRESC
                		 helperMovimentoAlteracoesEconomia.setQuantidadeEconomiaCres(
                			 helperMovimentoAlteracoesEconomia.getQuantidadeEconomiaCres() 
                			 	+ ((Integer) dadosAlteracaoEconomia[17] - (Integer) dadosAlteracaoEconomia[18]));
                		 
                		 //4.1.1.2. Somar 1 a RKCA_QTIMOVECONOMIAACRESC
                		 helperMovimentoAlteracoesEconomia.setQuantidadeImoveisEconomiaCres(
                				 helperMovimentoAlteracoesEconomia.getQuantidadeImoveisEconomiaCres() + 1);
                	 ...
                	 //4.1.2. Caso contrário
                		 ...
                		 //4.1.2.1. Somar a quantidade de economias 
                		 //         (quantidade de economias com data de exclusão - quantidade de economias com data de inclusão) 
                		 //         a RKCA_QTECONOMIASDECRESC
                		 helperMovimentoAlteracoesEconomia.setQuantidadeEconomiaDecres(
                			 helperMovimentoAlteracoesEconomia.getQuantidadeEconomiaDecres()
                				 + ((Integer) dadosAlteracaoEconomia[18] - (Integer) dadosAlteracaoEconomia[17]));
                		 
                		 //4.1.2.2. Somar 1 a RKCA_QTIMOVECONOMIADECRESC
                		 helperMovimentoAlteracoesEconomia.setQuantidadeImoveisEconomiaDecres(
                				 helperMovimentoAlteracoesEconomia.getQuantidadeImoveisEconomiaDecres() + 1);
                		 
                	 }
                	 
                 }
                 
                 //4.2. Acumula as quantidades de Alterações de Economia
                 //[FS0002 - Verificar existência do resumo]
                 if (!listaResumo.contains(helperMovimentoAlteracoesEconomia)){
                     listaResumo.add(helperMovimentoAlteracoesEconomia);
                 }
     ...
     * @throws ControladorException
     */
    private List<ResumoKitCasServicoHelper> gerarResumoKitCaServicoAlteracoesCategoria(Integer idLocalidade, 
    		Integer anoMesReferenciaFaturamento, List<ResumoKitCasServicoHelper> listaResumo) 
    		throws ControladorException {
    	...
    	try{
    		...
    		//   e gera o resumo do KIT CAS de Serviço acumulando as quantidades de economias e de imóveis
    		Collection<Object[]> colAlteracoesEconomia = this.repositorioGerencialFaturamento
                    .gerarResumoKitCaServicoAlteracoesCategoria(idLocalidade, anoMesReferenciaFaturamento);

    		System.out.println("Gerar Resumo do Kit CAS de Serviço - LOCA " + idLocalidade + " - QUANTIDADE ALTERAÇÕES CATEGORIA " + colAlteracoesEconomia.size());
             ...
             while (itemAlteracaoEconomia.hasNext()) {
                 ...
                 Integer quantidadeImoveis = (Integer) dadosAlteracaoEconomia[16];
                 ...
                 //2.1. Caso as categorias selecionadas no histórico para o imóvel
                 //     sejam diferentes das categorias associadas para o imóvel
                 if(quantidadeImoveis != null 
             			&& quantidadeImoveis.compareTo(new Integer(0)) > 0) {
                	 
                	 //2.1.1. Acumula as quantidades de Alterações de Categoria Imóvel
                	 //       [SB0018 - Preparar Dados do Resumo para Alterações de Categoria]
                	 helperMovimentoAlteracoesEconomia.setQuantidadeAlteracaoCategoria(
                			 helperMovimentoAlteracoesEconomia.getQuantidadeAlteracaoCategoria() + quantidadeImoveis);	
                 }
     ...
     * @throws ControladorException
     */
    private List<ResumoKitCasServicoHelper> gerarResumoKitCaServicoInclusaoTarifaSocial(Integer idLocalidade, 
    		Integer anoMesReferenciaFaturamento, List<ResumoKitCasServicoHelper> listaResumo) 
    		throws ControladorException {
    	...
    	try{
    		...
    		//3. O sistema seleciona as subcategorias alteradas no ano/mês de faturamento 
    		//   e gera o resumo do KIT CAS de Serviço acumulando as quantidades de economias e de imóveis
    		Collection<Object[]> colInclusaoTarSocial = this.repositorioGerencialFaturamento
                    .gerarResumoKitCaServicoInclusaoTarifaSocial(idLocalidade, anoMesReferenciaFaturamento);
    		
    		System.out.println("Gerar Resumo do Kit CAS de Serviço - LOCA " + idLocalidade + " - QUANTIDADE INCLUSÃO TAR. SOCIAL " + colInclusaoTarSocial.size());

    		 Iterator itemAlteracaoEconomia = colInclusaoTarSocial.iterator();
             ...
             while (itemAlteracaoEconomia.hasNext()) {
                 ...
                 Integer quantidadeRegistrosIncluidos = (Integer) dadosAlteracaoEconomia[16];
                 ...
                 //4.1. Acumula as quantidades de Tarifa Social
                 //[SB0020 - Preparar Dados do Resumo para Inclusão Tarifa Social]
            	 if(quantidadeRegistrosIncluidos != null 
            			&& quantidadeRegistrosIncluidos.compareTo(new Integer(0)) > 0) {
	                 helperMovimentoAlteracoesEconomia
	                 		.setQuantidadeImoveisInclusaoTarSocial(helperMovimentoAlteracoesEconomia.getQuantidadeImoveisInclusaoTarSocial() + quantidadeRegistrosIncluidos);
            	 }
     ...
     * @throws ControladorException
     */
    private List<ResumoKitCasServicoHelper> gerarResumoKitCaServicoExclusaoTarifaSocial(Integer idLocalidade, 
    		Integer anoMesReferenciaFaturamento, List<ResumoKitCasServicoHelper> listaResumo) 
    		throws ControladorException {
    	...
    	try{
    		...
    		//3. O sistema seleciona as subcategorias alteradas no ano/mês de faturamento 
    		//   e gera o resumo do KIT CAS de Serviço acumulando as quantidades de economias e de imóveis
    		Collection<Object[]> colExclusaoTarSocial = this.repositorioGerencialFaturamento
                    .gerarResumoKitCaServicoExclusaoTarifaSocial(idLocalidade, anoMesReferenciaFaturamento);
    		
    		System.out.println("Gerar Resumo do Kit CAS de Serviço - LOCA " + idLocalidade + " - QUANTIDADE EXCLUSÃO TAR. SOCIAL " + colExclusaoTarSocial.size());

    		 Iterator itemAlteracaoEconomia = colExclusaoTarSocial.iterator();
             ...
             while (itemAlteracaoEconomia.hasNext()) {
                 ...
                 Integer quantidadeRegistrosExcluidos = (Integer) dadosAlteracaoEconomia[16];
                 ...
                 //6.1. Acumula as quantidades de Tarifa Social
                 //[SB0022 - Preparar Dados do Resumo para Exclusão Tarifa Social]
            	 if(quantidadeRegistrosExcluidos != null 
             			&& quantidadeRegistrosExcluidos.compareTo(new Integer(0)) > 0) {
	                 helperMovimentoAlteracoesEconomia
	                 		.setQuantidadeImoveisExclusaoTarSocial(helperMovimentoAlteracoesEconomia.getQuantidadeImoveisExclusaoTarSocial() + quantidadeRegistrosExcluidos);
            	 }
     ...
     * @throws ControladorException
     */
    private List<ResumoKitCasServicoHelper> gerarResumoKitCaServicoFaturamentoSuspenso(Integer idLocalidade, 
    		Integer anoMesReferenciaFaturamento, List<ResumoKitCasServicoHelper> listaResumo) 
    		throws ControladorException {
    	...
    	try{
    		...
    		//3. O sistema seleciona as subcategorias alteradas no ano/mês de faturamento 
    		//   e gera o resumo do KIT CAS de Serviço acumulando as quantidades de economias e de imóveis
    		Collection<Object[]> colFaturamentoSuspenso = this.repositorioGerencialFaturamento
                    .gerarResumoKitCaServicoFaturamentoSuspenso(idLocalidade, anoMesReferenciaFaturamento);
    		
    		System.out.println("Gerar Resumo do Kit CAS de Serviço - LOCA " + idLocalidade + " - QUANTIDADE FATURAMENTO SUSPENSO " + colFaturamentoSuspenso.size());

    		 Iterator itemAlteracaoEconomia = colFaturamentoSuspenso.iterator();
             ...
             while (itemAlteracaoEconomia.hasNext()) {
                 ...
                 Integer quantidadeRegistros = (Integer) dadosAlteracaoEconomia[16];
                 ...
                 //8.1. Acumula as quantidades de Faturamento Suspenso
                 //[SB0024 - Preparar Dados do Resumo para Faturamento Suspenso]
                 if(quantidadeRegistros != null 
              			&& quantidadeRegistros.compareTo(new Integer(0)) > 0) {
	                 helperMovimentoAlteracoesEconomia
	                 		.setQuantidadeFaturamentoSuspenso(helperMovimentoAlteracoesEconomia.getQuantidadeFaturamentoSuspenso() + quantidadeRegistros);
                 }
...
//			}
  ...
  */
  ...
  private Collection montarResumoFaturamentoGuia( Object[] linha ) throws ControladorException, ErroRepositorioException{
      ...
      boolean existeSetorSemQuadra = false;
      ...
      for (Iterator iterGuiaPagamentoCategoria = colGuiaPagamentoCategoria.iterator(); iterGuiaPagamentoCategoria.hasNext();) {
	      ...
	      if ( (Integer) linha[19] != null ){
	          ...
	          if(quadra != null){
		    	  ...
		    	  existeSetorSemQuadra = true;
		    	  System.out.println("Setor: " + setorComercial.getId());
	          }
  ...
  */
 	private Collection montarResumoFinanciamento( Object[] linha ) throws ControladorException, ErroRepositorioException{
 		...
 		while (iterDebitoACobrarCategoria.hasNext()) {
			...
			DebitoACobrarCategoria debitoACobrarCategoria = (DebitoACobrarCategoria) iterDebitoACobrarCategoria.next();
	 		...
	 		Integer anoMesFaturamentoParametros =  this.getControladorUtil().pesquisarParametrosDoSistema().getAnoMesFaturamento();
	     
	 		// Setamos as quebras para o helper
	 		helperFinanciamento.setAnoMesFaturamento( anoMesFaturamentoParametros );
		    ...
		    helperFinanciamento.setIdEsferaPoder(
		     ...
		     //RM7022 - Alteração Contabilização dos Juros.
		     if( debitoACobrarCategoria.getDebitoACobrar().getAnoMesReferenciaContabil().equals(anoMesFaturamentoParametros) &&
		    		 (debitoCreditoSituacaoAtual.intValue() == DebitoCreditoSituacao.NORMAL.intValue() ||
		    		 ...
		    		 (helperFinanciamento.getIdItemLancamentoContabil()!=null &&
		    		 !helperFinanciamento.getIdItemLancamentoContabil().equals(LancamentoItemContabil.ACRESCIMOS_POR_IMPONTUALIDADE))){
		    	 if (helperFinanciamento.getValorFinanciadoIncluido()==null){
		    		 helperFinanciamento.setValorFinanciadoIncluido(debitoACobrarCategoria.getValorCategoria());
		    	 } else {
		    		 helperFinanciamento.setValorFinanciadoIncluido(helperFinanciamento.getValorFinanciadoIncluido()
		    				 .add(debitoACobrarCategoria.getValorCategoria()));
		    	 }
		     }
		     
		     if ((debitoACobrarCategoria.getDebitoACobrar().getAnoMesRefContabilizacao() == null ||
		    		 debitoACobrarCategoria.getDebitoACobrar().getAnoMesRefContabilizacao().intValue() >= 201203) &&
		    		 debitoACobrarCategoria.getDebitoACobrar().getLancamentoItemContabil().getId().equals(LancamentoItemContabil.ACRESCIMOS_POR_IMPONTUALIDADE)){
		    	 
				Collection<DebitoCobradoCategoria> colecaoDebitoCobradoCategoria = this.repositorioGerencialFaturamento.pesquisarDebitosContasPorLancamentoItem(DebitoCreditoSituacao.NORMAL, DebitoCreditoSituacao.NORMAL, LancamentoItemContabil.ACRESCIMOS_POR_IMPONTUALIDADE, anoMesFaturamentoParametros, debitoACobrarCategoria.getCategoria().getId(), debitoACobrarCategoria.getDebitoACobrar().getId());
				
				 if (colecaoDebitoCobradoCategoria!=null){
			    	 for (DebitoCobradoCategoria debitoCobradoCategoria : colecaoDebitoCobradoCategoria){
			    		 if (helperFinanciamento.getValorFinanciadoIncluido()==null){
				    		 helperFinanciamento.setValorFinanciadoIncluido(debitoCobradoCategoria.getValorCategoria());
				    	 } else {
				    		 helperFinanciamento.setValorFinanciadoIncluido(helperFinanciamento.getValorFinanciadoIncluido()
				    				 .add(debitoCobradoCategoria.getValorCategoria()));
				    	 }	
			    	 }
				 }
				 
				 Collection<DebitoACobrarCategoria> colecaoDebitoACobrarCategoria = this.pesquisarDebitosPagamentos(LancamentoItemContabil.ACRESCIMOS_POR_IMPONTUALIDADE, 
		    		 anoMesFaturamentoParametros,debitoACobrarCategoria.getCategoria().getId(),DebitoCreditoSituacao.NORMAL, DebitoCreditoSituacao.NORMAL,debitoACobrarCategoria.getDebitoACobrar().getId());
				 if (colecaoDebitoACobrarCategoria!=null){
			    	 for (DebitoACobrarCategoria debACobrarCategoria : colecaoDebitoACobrarCategoria){
			    		 
			    		 BigDecimal valor = debACobrarCategoria.getValorCategoria().subtract(
			    				 ((debACobrarCategoria.getValorCategoria().divide(
			    						 new BigDecimal(debACobrarCategoria.getDebitoACobrar().getNumeroPrestacaoDebito()))
			    						 ).multiply(new BigDecimal(debACobrarCategoria.getDebitoACobrar().getNumeroPrestacaoCobradas()))));
			    		
			    		 if (helperFinanciamento.getValorFinanciadoIncluido()==null){
				    		 helperFinanciamento.setValorFinanciadoIncluido(valor);
				    	 } else {
				    		 helperFinanciamento.setValorFinanciadoIncluido(helperFinanciamento.getValorFinanciadoIncluido()
				    				 .add(valor));
				    	 }
		     ...
		     if(debitoCreditoSituacaoAtual.intValue() == DebitoCreditoSituacao.CANCELADA.intValue()  && 
		    		 debitoACobrarCategoria.getDebitoACobrar().getAnoMesReferenciaContabil().equals(anoMesFaturamentoParametros) &&
		    		 helperFinanciamento.getIdTipoFinanciamento().equals(FinanciamentoTipo.SERVICO_NORMAL) &&
		    		 (!helperFinanciamento.getIdItemLancamentoContabil().equals(LancamentoItemContabil.ACRESCIMOS_POR_IMPONTUALIDADE) ||
		    		 (helperFinanciamento.getIdItemLancamentoContabil().equals(LancamentoItemContabil.ACRESCIMOS_POR_IMPONTUALIDADE) &&
		    		 debitoACobrarCategoria.getDebitoACobrar().getAnoMesRefContabilizacao()!=null &&
		    		 debitoACobrarCategoria.getDebitoACobrar().getAnoMesRefContabilizacao().intValue() < 201203))){
		     ...
		     if(parcelamentoGrupo.intValue() == ParcelamentoGrupo.JUROS_COBRADOS.intValue() && 
		    		 (debitoACobrarCategoria.getDebitoACobrar().getAnoMesRefContabilizacao() == null ||
				    		 debitoACobrarCategoria.getDebitoACobrar().getAnoMesRefContabilizacao().intValue() >= 201203)){
		    	 
		    	 Collection<DebitoCobradoCategoria> colecaoDebitoCobrado = this.pesquisarDebitosContas(DebitoCreditoSituacao.NORMAL, DebitoCreditoSituacao.NORMAL,
 		    		ParcelamentoGrupo.JUROS_COBRADOS, anoMesFaturamentoParametros, debitoACobrarCategoria.getCategoria().getId(),
 		    		debitoACobrarCategoria.getDebitoACobrar().getId());	
		    	 
		    	 if (colecaoDebitoCobrado!=null){
			    	 
			    	 for (DebitoCobradoCategoria debito : colecaoDebitoCobrado){
			    		 
			    		 BigDecimal valor = debito.getValorCategoria();
			    		 
			    		 if (helperFinanciamento.getValorJurosParcelamento()==null){
				    		 helperFinanciamento.setValorJurosParcelamento(valor);
				    	 } else {
				    		 helperFinanciamento.setValorJurosParcelamento(helperFinanciamento.getValorJurosParcelamento()
				    				 .add(valor));
				    	 }
			    	 }
			     }
		     ...
		     if(parcelamentoGrupo.intValue() == ParcelamentoGrupo.ACRESCIMOS_POR_IMPONTUALIDADE.intValue() && 
		    		 (debitoACobrarCategoria.getDebitoACobrar().getAnoMesRefContabilizacao()==null ||
				    		 debitoACobrarCategoria.getDebitoACobrar().getAnoMesRefContabilizacao().intValue() >= 201203)){
	     
		     
			     Collection<DebitoCobradoCategoria> colecaoDebitoCobrado = this.pesquisarDebitosContas(DebitoCreditoSituacao.NORMAL, DebitoCreditoSituacao.NORMAL,
			    		    		ParcelamentoGrupo.ACRESCIMOS_POR_IMPONTUALIDADE, anoMesFaturamentoParametros, debitoACobrarCategoria.getCategoria().getId(),
			    		    		debitoACobrarCategoria.getDebitoACobrar().getId());		 
			     ...
			     if (colecaoDebitoCobrado!=null){
			    	 ...
			    	 for (DebitoCobradoCategoria debito : colecaoDebitoCobrado){
			    		 ...
			    		 if (helperFinanciamento.getValorParcelamentosAcresImp()==null){
				    		 helperFinanciamento.setValorParcelamentosAcresImp(valor);
				    	 } else {
				    		 helperFinanciamento.setValorParcelamentosAcresImp(helperFinanciamento.getValorParcelamentosAcresImp()
				    				 .add(valor));
				    	 }
			    	 }
			     }
 	...
 	/**
	 * Retorna débitos a cobrar dos pagamentos efetuados referentes ao lançamento item contábil 
	 * e ano/mes passados como parametro com anoMesRefContabilizacao nulos ou >= 201203
	 * 
	 ...
	 * @throws ErroRepositorioException
	 */
 	public Collection<DebitoACobrarCategoria> pesquisarDebitosPagamentos(Integer lancamentoItemContabil, Integer anoMesReferencia,Integer idCategoria,Integer debitoCreditoSituacaoAtual, Integer debitoCreditoSituacaoAnterior,Integer idDebitoACobrar) throws ControladorException {
    	try {
			return repositorioGerencialFaturamento.pesquisarDebitosPagamentos(lancamentoItemContabil, anoMesReferencia,idCategoria,debitoCreditoSituacaoAtual,debitoCreditoSituacaoAnterior,idDebitoACobrar);
	    } catch (ErroRepositorioException ex) {
			ex.printStackTrace();
			throw new ControladorException("erro.sistema", ex);
		}
    ...
    /**
	 * Retorna débitos a cobrar referentes a situação de debito/credito atual e anterior,
	 * id do grupo de parcelamento e ano/mes passados como parametro com anoMesRefContabilizacao 
	 * nulos ou >= 201203
	 * 
	 * @param debitoCreditoSituacaoAtual, debitoCreditoSituacaoAnterior, idParcelamentoGrupo, anoMesReferencia
	 * @author Amelia Pessoa
	 * @return Collection<DebitoACobrar>
	 * @throws ErroRepositorioException
	 */
    public Collection<DebitoCobradoCategoria> pesquisarDebitosContas(Integer debitoCreditoSituacaoAtual, Integer debitoCreditoSituacaoAnterior,
    		Integer idParcelamentoGrupo, Integer anoMesReferencia,Integer idCategoria,Integer idDebitoACobrar) throws ControladorException {
    	try {
			return repositorioGerencialFaturamento.pesquisarDebitosContas(debitoCreditoSituacaoAtual, debitoCreditoSituacaoAnterior,
		    		idParcelamentoGrupo, anoMesReferencia,idCategoria,idDebitoACobrar);
	    } catch (ErroRepositorioException ex) {
			ex.printStackTrace();
			throw new ControladorException("erro.sistema", ex);
		}
    ...
    private void somarValoresParaResumoFaturamentoFinanciamento( ResumoFaturamentoHelper jaCadastrado, ResumoFaturamentoHelper helperFinanciamento ){
        ...
        jaCadastrado.setValorFinanciadoCancelado( 
       	...
       	jaCadastrado.setValorParcelamentosAcresImp( 
   			jaCadastrado.getValorParcelamentosAcresImp().add(helperFinanciamento.getValorParcelamentosAcresImp()));
...
//			 sessionContext.setRollbackOnly();
	 ...
	 * @return Collection<Object>
	 */
	public Collection<Object> pesquisarAnormalidadeHidrometroResumoDadosCas(FiltrarResumoDadosCasHelper filtro)throws ControladorException {
    	Collection retorno = null;
    	try {
			retorno = this.repositorioGerencialFaturamento.pesquisarAnormalidadeHidrometroResumoDadosCas(filtro);
		} catch (ErroRepositorioException e) {
			throw new ControladorException( e.getMessage(), e );
		}
    	return retorno;
...
//										AnoMesReferencia
	...
	public void gerarFaturamentoBrutoLiquido(int anoMesFaturamento, int idFuncionalidadeIniciada)	throws ControladorException {
		...
		*/
		...
		try {
			System.out.println("Iniciou Gerar Faturmamento Bruto liquido");
			repositorioGerencialFaturamento.gerarFaturamentoBrutoLiquido();
			System.out.println("Finalizou Gerar Faturmamento Bruto liquido");

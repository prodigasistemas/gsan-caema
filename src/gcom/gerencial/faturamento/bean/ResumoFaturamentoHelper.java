...
public class ResumoFaturamentoHelper {
    ...
    /* RM7720 */
    private BigDecimal valorParcelamentosAcresImp = new BigDecimal(0);
	...
	public BigDecimal getValorParcelamentosAcresImp() {
		return valorParcelamentosAcresImp;
	}



	public void setValorParcelamentosAcresImp(BigDecimal valorParcelamentosAcresImp) {
		this.valorParcelamentosAcresImp = valorParcelamentosAcresImp;
	}
}

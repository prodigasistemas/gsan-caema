...
public class UnResumoLeituraAnormalidade implements Serializable {
    ...
    private int quantidadeLeiturasAnormalidades;
    private int quantidadeLeiturasAnormalidadesRecebidas;
	 ...
	 */
	public int getQuantidadeLeiturasAnormalidades() {
	 ...
	 */
	public void setQuantidadeLeiturasAnormalidades(int quantidadeLeiturasAnormalidades) {
		this.quantidadeLeiturasAnormalidades = quantidadeLeiturasAnormalidades;
	}
	/**
	 * @return Retorna o campo getQuantidadeLeiturarAnormalidadesRecebidas.
	 */
	public int getQuantidadeLeiturasAnormalidadesRecebidas() {
	 ...
	 */
	public void setQuantidadeLeiturasAnormalidadesRecebidas(int quantidadeLeiturasAnormalidadesRecebidas) {
		this.quantidadeLeiturasAnormalidadesRecebidas = quantidadeLeiturasAnormalidadesRecebidas;
	}

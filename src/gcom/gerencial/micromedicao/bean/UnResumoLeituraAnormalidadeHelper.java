...
public class UnResumoLeituraAnormalidadeHelper {
	...
	private Integer quantidadeLeiturasAnormalidades = new Integer(0);
	private Integer quantidadeLeiturasAnormalidadesRecebidas = new Integer(0);
	...
	/**
	 * @return Retorna o campo quantidadeLeiturasAnormalidades.
	 */
	public Integer getQuantidadeLeiturasAnormalidades() {
		return quantidadeLeiturasAnormalidades;
	}
	/**
	 * @param quantidadeLeiturasAnormalidades O quantidadeLeiturasAnormalidades a ser setado.
	 */
	public void setQuantidadeLeiturasAnormalidades(Integer quantidadeLeiturarAnormalidades) {
		this.quantidadeLeiturasAnormalidades = quantidadeLeiturarAnormalidades;
	}
	/**
	 * @return Retorna o campo getQuantidadeLeiturarAnormalidadesRecebidas.
	 */
	public Integer getQuantidadeLeiturasAnormalidadesRecebidas() {
		return quantidadeLeiturasAnormalidadesRecebidas;
	}
	/**
	 * @param quantidadeLeiturasAnormalidadesRecebidas O quantidadeLeiturasAnormalidadesRecebidas a ser setado.
	 */
	public void setQuantidadeLeiturasAnormalidadesRecebidas(Integer quantidadeLeiturarAnormalidadesRecebidas) {
		this.quantidadeLeiturasAnormalidadesRecebidas = quantidadeLeiturarAnormalidadesRecebidas;
	}

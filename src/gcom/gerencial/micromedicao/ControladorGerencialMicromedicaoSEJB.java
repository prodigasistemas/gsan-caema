	...
	*/
	...
	public void gerarResumoLeituraAnormalidade(int idSetorComercial, int anoMesLeitura, int idFuncionalidadeIniciada)
		...
		try {
			...
			for (int i = 0; i < imoveisResumoLeituraAnormalidade.size(); i++) {
				...
				if (obj instanceof Object[]) {
                    ...
                    */
					...
					helper.setQuantidadeLeiturasAnormalidades((Integer) retorno[9]); //Quantidade Leituras Anormalidades
					helper.setQuantidadeLeiturasAnormalidadesRecebidas((Integer) retorno[10]); //Quantidade Leituras Anormalidades Recebidas
					...
					*/
					...
					if (listaSimplificada.contains(helper)) {
						...
						//Adicionando Quantidade Leituras Anormalidades
						jaCadastrado.setQuantidadeLeiturasAnormalidades(jaCadastrado.getQuantidadeLeiturasAnormalidades() + 
							helper.getQuantidadeLeiturasAnormalidades());

						//Adicionando Quantidade Leituras Anormalidades Recebidas
						jaCadastrado.setQuantidadeLeiturasAnormalidadesRecebidas(jaCadastrado.getQuantidadeLeiturasAnormalidadesRecebidas() + 
							helper.getQuantidadeLeiturasAnormalidadesRecebidas());
					} else {
						// Incrementamos as Leituras
			...
			Integer quantidadeLeiturasAnormalidadesRecebidas = null;
			Integer quantidadeLeiturasAnormalidades = null;
			...
			for (int i = 0; i < listaSimplificada.size(); i++) {
				...
				quantidadeLeiturasAnormalidades = helper.getQuantidadeLeiturasAnormalidades();
				quantidadeLeiturasAnormalidadesRecebidas = helper.getQuantidadeLeiturasAnormalidadesRecebidas();
				...
				resumoLeituraAnormalidade.setQuantidadeLeiturasAnormalidades(quantidadeLeiturasAnormalidades);
				resumoLeituraAnormalidade.setQuantidadeLeiturasAnormalidadesRecebidas(quantidadeLeiturasAnormalidadesRecebidas);

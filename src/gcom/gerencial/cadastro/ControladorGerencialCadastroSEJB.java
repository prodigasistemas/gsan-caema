/*
* Copyright (C) 2007-2007 the GSAN ï¿½ Sistema Integrado de Gestï¿½o de Serviços de Saneamento
*
...
/*
* GSAN ï¿½ Sistema Integrado de Gestï¿½o de Serviços de Saneamento
* Copyright (C) <2007> 
...
//						}				
		...
		try {
			...
			for (int i = 0; i < imoveisResumoLigacaoEconomias.size(); i++) {
				...
				if (obj instanceof Object[]) {
					 ...
					 * RM 9232
					 * Analista: Aryed Lins
					 * OBJ: Nos casos de corte e religação apenas contabilizar se o imóvel possuir OS para o serviço.
					 */
					boolean contabilizar = true;
					Collection<Integer> colecaoServicoTipo = null;
					...
					if (listaSimplificada.contains(helper)) {
						...
						if(retorno[27] != null && Util.recuperaAnoMesDaData( (Date) retorno[27] ).intValue() ==
							...
							colecaoServicoTipo = new ArrayList();
							colecaoServicoTipo.add(ServicoTipo.TIPO_CORTE_ADMINISTRATIVO_LIGACAO_AGUA);
							colecaoServicoTipo.add(ServicoTipo.TIPO_CORTE_LIGACAO_AGUA);
							
							contabilizar = this.pesquisarOrdemServicoEncerradaPorServicoTipo(idImovel, (Date) retorno[27], colecaoServicoTipo);
						...
						if(retorno[28] != null && Util.recuperaAnoMesDaData( (Date) retorno[28] ).intValue() == 
							...
							colecaoServicoTipo = new ArrayList();
							colecaoServicoTipo.add(ServicoTipo.TIPO_RELIGACAO_AGUA);
							colecaoServicoTipo.add(ServicoTipo.TIPO_RELIGACAO_AGUA_COM_INSTALACAO_HIDROMETRO);
							
							contabilizar = this.pesquisarOrdemServicoEncerradaPorServicoTipo(idImovel, (Date) retorno[28], colecaoServicoTipo);
        ...
        try {
            ...
            for (int i = 0; i < imoveisResumoConsumoAgua.size(); i++) {
                ...
                if (obj instanceof Object[]) {
                    ...
                    // [UC0307] - Obter Indicador de Existência de Hidrï¿½metro
                    ...
                    // Marcamos o helper como possuindo ou não consumo excedente
	...
	public List consultarResumoLigacoesEconomias(
			...
			throws ControladorException {
		try {
			// [FS0001] Verificar existência de dados para o ano/mï¿½s de
			...
			for (int i = 0; i < imoveisResumoConsumoAgua.size(); i++) {
				...
				if (obj instanceof Object[]) {
					...
					ResumoMetasHelper helper = new ResumoMetasHelper(
							...
							(Integer) retorno[14],// Perfil da ligacao de
							// esgoto
							(Date) retorno[15],// Data Ligação
							(Date) retorno[16],// Data Supressï¿½o
							(Date) retorno[17],// Data Corte
							(Date) retorno[18],// Data Religação
...
//				}
	...
	public void gerarResumoConsumoAguaBD(int idFuncionalidadeIniciada)	throws ControladorException {
		...
		*/		
		...
		try {
			repositorioGerencialCadastro.gerarResumoConsumoAguaBD();
	...
	public boolean pesquisarOrdemServicoEncerradaPorServicoTipo(Integer idImovel, Date dataExecucaoServico, Collection<Integer> colecaoServicoTipo) 
		...
		try{
			...
			return this.repositorioGerencialCadastro.pesquisarOrdemServicoEncerradaPorServicoTipo(idImovel, dataExecucaoServico, colecaoServicoTipo);

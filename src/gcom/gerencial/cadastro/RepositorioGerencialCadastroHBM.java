...
* Foundation, Inc., 59 Temple Place ÔøΩ Suite 330, Boston, MA 02111-1307, USA
*/

/*
* GSAN ÔøΩ Sistema Integrado de GestÔøΩo de ServiÁos de Saneamento
* Copyright (C) <2007> 
* Adriano Britto Siqueira
* Alexandre Santos Cabral
* Ana Carolina Alves Breda
* Ana Maria Andrade Cavalcante
* Aryed Lins de AraÔøΩjo
* Bruno Leonardo Rodrigues Barros
* Carlos Elmano Rodrigues Ferreira
* ClÔøΩudio de Andrade Lira
* Denys GuimarÔøΩes Guenes Tavares
* Eduardo Breckenfeld da Rosa Borges
* FabÔøΩola Gomes de AraÔøΩjo
* Fl·vio Leonardo Cavalcanti Cordeiro
* Francisco do Nascimento JÔøΩnior
* Homero Sampaio Cavalcanti
* Ivan SÈrgio da Silva JÔøΩnior
* JosÔøΩ Edmar de Siqueira
* JosÔøΩ Thiago TenÔøΩrio Lopes
* KÔøΩssia Regina Silvestre de Albuquerque
* Leonardo Luiz Vieira da Silva
* MÔøΩrcio Roberto Batista da Silva
* Maria de FÔøΩtima Sampaio Leite
* Micaela Maria Coelho de AraÔøΩjo
* Nelson MendonÔøΩa de Carvalho
* Newton Morais e Silva
* Pedro Alexandre Santos da Silva Filho
* Rafael CorrÍa Lima e Silva
* Rafael Francisco Pinto
* Rafael Koury Monteiro
* Rafael Palermo de AraÔøΩjo
...
*
* Este programa ÔøΩ software livre; vocÔøΩ pode redistribuÔøΩ-lo e/ou
* modificÔøΩ-lo sob os termos de LicenÔøΩa PÔøΩblica Geral GNU, conforme
* publicada pela Free Software Foundation; versÔøΩo 2 da
* LicenÔøΩa.
* Este programa ÔøΩ distribuÔøΩdo na expectativa de ser ÔøΩtil, mas SEM
* QUALQUER GARANTIA; sem mesmo a garantia implÔøΩcita de
* COMERCIALIZAÔøΩÔøΩO ou de ADEQUAÔøΩÔøΩO A QUALQUER PROPÔøΩSITO EM
* PARTICULAR. Consulte a LicenÔøΩa PÔøΩblica Geral GNU para obter mais
* detalhes.
...
public class  RepositorioGerencialCadastroHBM implements
	...
	/**
	 * MÔøΩtodo que retona uma lista de objeto xxxxx que representa o agrupamento
	...
	/**
	 * MÔøΩtodo que retona uma lista de objeto xxxxx que representa os dados
	 ...
	 * por imovel
	 * 
	 * @author Bruno Barrros, Ivan SÈrgio
	...
	/**
	 * MÔøΩtodo que retona uma lista de objeto xxxxx que representa o agrupamento
	 * id do imovel, id da regiÔøΩo, id da microrregiÔøΩo, id do municÔøΩpio, id do
	 * bairro, id do perfil do imÛvel, esfera de poder, id do tipo de cliente,
	 * id da situaÁ„o da ligaÁ„o ÔøΩgua, id situacao da ligacao de esgoto,
	 * principal categoria do imovel, principal sub categoria do imovel perfil
	 * da ligaÁ„o da ÔøΩgua, perfil da ligaÁ„o do esgoto
	 * 
	 * @author Ivan SÈrgio
	 * @date 19/04/2007
	 * 
	...
	public List getImoveisResumoLigacaoEconomiaRegiao(int idLocalidade)
		...
		try {
			String hql = "SELECT "
					...
					+ "	imovel.ligacaoEsgoto.ligacaoEsgotoPerfil.id, "
					+
					// HaverÔøΩ hidrometro instalado quando a situaÁ„o da agua for
					// [ligada ou cortada] e houver histÔøΩrico,
					// ou quando a situaÁ„o estiver como ligada e n„o houver
					// histÔøΩrico
					"	CASE WHEN ("
	...
	public List consultarResumoLigacoesEconomias(
		...
		// retorna a coleÔøΩÔøΩo com os resultados da pesquisa
		return retorno;
	}
	...
	public void inserirResumoConsumoAgua(Integer anoMesReferencia,
		...
		try {
			...
			try {
				...
				throw new ErroRepositorioException(e, "Erro ao fechar conexıes");
			}
		}
	}

	/**
	 * Verifica se o consumo do imÛvel ÔøΩ real.
	 * 
	 * @author Bruno Barros
	 * @date 23/05/2007
	 * 
	 * @param idImovel
	 *            id do imovel que terÔøΩ seu consumo verificado *
	 ...
	 * 
	 * @param idImovel
	 *            id do imovel que terÔøΩ seu volume fixo verificado
	 ...
	 * parametros de uma determinada gerÔøΩncia regional por imovel
	 * 
	 * @author S·vio Luiz
	 * @date 20/07/2007
	 * 
	 ...
	 * por imovel
	 * 
	 * @author Marcio Roberto, Ivan SÈrgio
	 * @date 20/09/2007, 30/07/2008
	 * @alteracao: Ivan SÈrgio - 30/07/2008 - Adicionado o AnoMesFaturamento para agilizar o processo.
	 * 			   Ivan SÈrgio - 22/09/2008 - CRC185 - Considerar somente os imÛveis que foram faturados.
	 * 
	 * @param idSetor
	 *            id do Setor a ser pesquisado
	...
	public List getHistoricosColetaEsgoto(int idSetor, Integer anoMesFaturamento)
		...
		try {
			String hql = 
				...
				// 18 - Indicador de consumo mÌnimo
				"  case when ( leImo.consumoMinimo > 0 ) then \n" +
				"    1 \n" +
				"  else \n" +
				"    2 \n" +
				"  end, \n" +
				// 19 - Percentual da ligaÁ„o de esgoto
...
//				"  ch.indicadorFaturamento = 1 "
			...
			// HQL ANTIGO, QUE N√O LEVA A CONTA EM CONSIDERA«√O PARA SELE«√O DOS DADOS			
//			String hq2 = " select " +
//				 "    imovel.id, " +                                    // Imovel
...
//				 "     1 " +                                                           // 20 |
//				 "   else " +                                                          // 20 +- Existencia de Hidrometro no PoÔøΩo
//				 "     2 " +                                                           // 20 |  
//				 "   end, " +                                                          // 20 ]
	...
	public void inserirResumoColetaEsgoto(Integer anoMesReferencia,
		...
		try {
			...
			insert = "insert into micromedicao.un_resumo_coleta_esgoto ("
					...
					// Ic medido de Agua deve ser zero, pois esse informaÁ„o j· est·
	...
	public void atualizarDadosResumoIndicadorLigacaoEconomia(
		...
		try {
			...
			try {
				...
				System.out.println("Erro ao fechar conexıes");
			}
		}
      ...
      public void excluirResumoGerencial ( 
    	...
    	unidadeProcessamento = " and " + resumoCampoUnidadeProcessamento + " in ( " + idUnidadeProcessamento + " , null ) ";
 		...
 		try {
 			...
 			// levanta a excessao para a prÛxima camada
 			throw new ErroRepositorioException(e, "Erro no Hibernate");
 		} finally {
 			// fecha a sess„o
 			HibernateUtil.closeSession(session);
 ...
 */
 ...
 public void excluirResumoGerencialC ( int anomesreferencia , String resumoGerencial, String resumoCampoAnoMes, String campoEspecifico, int idcampoespecifico) throws ErroRepositorioException{
	 ...
	 * @date 25/08/2008
 	...
 	/**
	 * MÈtodo que retona uma lista de objeto que representa o agrupamento
	 * id do imovel id gerencia regional id licalidade id do setor comercial
...
//				"  end, \n" +
				...
				"  coalesce( ch.referenciaFaturamento, 0 ), \n" +
				// 15 - Indicador de consumo mÌnimo
				"  case when ( leImo.consumoMinimo > 0 ) then \n" +
				"    1 \n" +
				"  else \n" +
				"    2 \n" +
				"  end, \n" +
				// 16 - Percentual da ligaÁ„o de esgoto
				"  case when ( leImo.percentual > 0 ) then \n" +
				"    0.0 \n" +
				"  else \n" +
				"    coalesce( leImo.percentual, 0.0 ) \n" +
...
//					+ "  inner join quad.setorComercial as stcom "
	 ...
	 * @data 02/04/2012
	 */
	public void removerResumoKisCasServico(Integer anoMesReferenciaFaturamento,
		...
		try{	
			consulta = "DELETE gcom.atendimentopublico.UnResKitCasServico kitc "
				+ "  where kitc.referencia = " + anoMesReferenciaFaturamento
				+ "		and kitc.gerLocalidade.id = " + idLocalidade;
	...
	public void gerarResumoConsumoAguaBD() throws ErroRepositorioException, SQLException {
		...
		try {
			con = session.connection();
			sql = " call cadastro.sp_gerar_resumo_consumo_agua() ";
	...
	public boolean pesquisarOrdemServicoEncerradaPorServicoTipo(Integer idImovel, Date dataExecucaoServico, Collection<Integer> colecaoServicoTipo) 
		...
		consulta = "SELECT os.orse_id as idOrdemServico "
				  ...
				  + "INNER JOIN atendimentopublico.atend_motivo_encmt atendMotEnc on atendMotEnc.amen_id = os.amen_id "
				  +	"WHERE os.imov_id = :idImovel " 
				  + "AND os.orse_cdsituacao = :OS_ENCERRADA "
				  + "AND atendMotEnc.amen_icexecucao = :indicadorExecucao "
				  + "AND os.svtp_id in(:idsServicoTpo) "
				  + "AND os.orse_tmencerramento BETWEEN :dataExecucaoServicoInicial and :dataExecucaoServicoFinal ";
		
			Date dataExecucaoServicoInicial = Util.formatarDataInicialPrimeiroDiaDoMes(dataExecucaoServico);
			Date dataExecucaoServicoFinal = Util.formatarDataFinalUltimoDiaDoMes(dataExecucaoServico);
		
			colecaoRetorno = session.createSQLQuery(consulta)
					.addScalar("idOrdemServico",Hibernate.INTEGER)
					.setInteger("idImovel", idImovel)
					.setShort("OS_ENCERRADA", OrdemServico.SITUACAO_ENCERRADO)
					.setShort("indicadorExecucao", ConstantesSistema.SIM)
					.setParameterList("idsServicoTpo", colecaoServicoTipo)
					.setTimestamp("dataExecucaoServicoInicial", Util.getSQLTimesTemp(dataExecucaoServicoInicial))
					.setTimestamp("dataExecucaoServicoFinal", Util.getSQLTimesTemp(dataExecucaoServicoFinal))
					.list();

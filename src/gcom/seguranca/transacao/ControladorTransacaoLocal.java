...
public interface ControladorTransacaoLocal extends javax.ejb.EJBLocalObject {
	 ...
	 * @param idTabela
	 */
	public void processaRegistroOperacaoDadosCadastrais(UsuarioAcaoUsuarioHelper usuario, DadosCadastraisTransacaoBatchHelper parametrosHelper, OperacaoEfetuada operacaoEfetuada);
}

...
public class Grupo extends ObjetoTransacao {
	...
	/** nullable persistent field */
	private Short indicadorGrupoEspecial;
	
	private Short indicadorVisualizacaoRestrita;
	
	private Grupo grupoInferior;
	
	private Short indicadorEspecialSeguranca;
	
	public Short getIndicadorEspecialSeguranca() {
		return indicadorEspecialSeguranca;
	}

	public void setIndicadorEspecialSeguranca(Short indicadorEspecialSeguranca) {
		this.indicadorEspecialSeguranca = indicadorEspecialSeguranca;
	}
	...
	public Short getIndicadorGrupoEspecial() {
		return indicadorGrupoEspecial;
	}

	public void setIndicadorGrupoEspecial(Short indicadorGrupoEspecial) {
		this.indicadorGrupoEspecial = indicadorGrupoEspecial;
	}

	public Grupo getGrupoInferior() {
		return grupoInferior;
	}

	public void setGrupoInferior(Grupo grupoInferior) {
		this.grupoInferior = grupoInferior;
	}

	public Short getIndicadorVisualizacaoRestrita() {
		return indicadorVisualizacaoRestrita;
	}

	public void setIndicadorVisualizacaoRestrita(Short indicadorVisualizacaoRestrita) {
		this.indicadorVisualizacaoRestrita = indicadorVisualizacaoRestrita;
	}
}

...
public class FiltroGrupo extends Filtro implements Serializable {
	...
	public final static String INDICADOR_GRUPO_ESPECIAL = "indicadorGrupoEspecial";
	
	public final static String INDICADOR_VISUALIZACAO_RESTRITA = "indicadorVisualizacaoRestrita";

...
public class SolicitacaoAcessoPermissao implements Serializable {
	
	private static final long serialVersionUID = 1L;

	/** identifier field */
    private SolicitacaoAcessoPermissaoPK comp_id;
	...
	/** default constructor */
	public SolicitacaoAcessoPermissao() {}
	
    /** full constructor */
	public SolicitacaoAcessoPermissao(SolicitacaoAcessoPermissaoPK comp_id,
			SolicitacaoAcesso solicitacaoAcesso,
			PermissaoEspecial permissaoEspecial, Date ultimaAlteracao) {
		super();
		this.setComp_id(comp_id);
		this.solicitacaoAcesso = solicitacaoAcesso;
		this.setPermissaoEspecial(permissaoEspecial);
	...
	public SolicitacaoAcessoPermissaoPK getComp_id() {
		return comp_id;
	}

	public void setComp_id(SolicitacaoAcessoPermissaoPK comp_id) {

...
public class SolicitacaoAcesso implements Serializable {
	...
	//RM 2551
	private SolicitacaoAcessoMotivoNaoAutorizacao solicitacaoAcessoMotivoNaoAutorizacao;
	
	private Set solicitacaoAcessoGrupos;
	...
	public SolicitacaoAcesso(Funcionario funcionarioSolicitante, Funcionario funcionarioResponsavel, UsuarioTipo usuarioTipo,
			...
			Date periodoInicial, Date periodoFinal, Date dataSolicitacao, Usuario usuarioResponsavel) {
	...
	public SolicitacaoAcessoMotivoNaoAutorizacao getSolicitacaoAcessoMotivoNaoAutorizacao() {
		return solicitacaoAcessoMotivoNaoAutorizacao;
	}

	public void setSolicitacaoAcessoMotivoNaoAutorizacao(
			SolicitacaoAcessoMotivoNaoAutorizacao solicitacaoAcessoMotivoNaoAutorizacao) {
		this.solicitacaoAcessoMotivoNaoAutorizacao = solicitacaoAcessoMotivoNaoAutorizacao;
	}
	...
	public Set getSolicitacaoAcessoGrupos() {
		return solicitacaoAcessoGrupos;
	}

	public void setSolicitacaoAcessoGrupos(Set solicitacaoAcessoGrupos) {
		this.solicitacaoAcessoGrupos = solicitacaoAcessoGrupos;
	}
}

...
public class FiltroPemissaoEspecialOperacao extends Filtro implements
		Serializable {
	private static final long serialVersionUID = 1L;
	/**
	 * Constructor
	 */
	public FiltroPemissaoEspecialOperacao() {
	}
	 ...
	 */
	public FiltroPemissaoEspecialOperacao(String campoOrderBy) {
	...
	public final static String OPERACAO_COMP_ID = "comp_id.operacaoId";

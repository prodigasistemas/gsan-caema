...
/**
 * Filtro Solicitacao Acesso Permissao
 *
 * @author Amelia Pessoa
 * @date 26/06/2012
 */
public class FiltroSolicitacaoAcessoPermissao extends Filtro implements Serializable {
	...
	public final static String USUARIO_SOLICITACAO_ACESSO_ID = "solicitacaoAcesso.usuario.id";
	
	public final static String USUARIO_SOLICITACAO_ACESSO = "solicitacaoAcesso.usuario";
	
	public final static String SOLICITACAO_ACESSO_COMP_ID = "comp_id.solicitacaoAcessoId";
     ...
     */
    public FiltroSolicitacaoAcessoPermissao() {
    }
     ...
     */
    public FiltroSolicitacaoAcessoPermissao(String campoOrderBy) {

...
public interface ControladorUsuarioLocal extends javax.ejb.EJBLocalObject {
	 ...
	 */
	public Integer inserirUsuario(Usuario usuario, Integer[] idGrupos, Usuario usuarioLogado, 
	...
	* passando por par̢metro o id da guia de devolucao
	*
	* @author Daniel Alves
	* @date 22/02/2010
	*/
	 ...
	 * @throws ControladorException
	 */
	public void enviaEmailUsuarioESolicitante(Usuario usuario, String idSolicitacaoAcesso) throws ControladorException;

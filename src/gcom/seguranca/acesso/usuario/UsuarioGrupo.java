...
public class UsuarioGrupo extends ObjetoTransacao {
    ...
    private UsuarioAfastamento usuarioAfastamento;
    ...
    public boolean equals(Object other) {
        ...
        return new EqualsBuilder()
            .append(this.getComp_id().getGrupoId(), castOther.getComp_id().getGrupoId())
            .isEquals();
    }
	...
	public UsuarioAfastamento getUsuarioAfastamento() {
		return usuarioAfastamento;
	}

	public void setUsuarioAfastamento(UsuarioAfastamento usuarioAfastamento) {
		this.usuarioAfastamento = usuarioAfastamento;
	}
}
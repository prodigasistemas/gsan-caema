 ...
 *  
 */
public class SolicitacaoAcessoPermissaoPK extends ObjetoGcom{
    ...
    //Construtor vazio
    public SolicitacaoAcessoPermissaoPK() {}
    
   //Construtor completo
	public SolicitacaoAcessoPermissaoPK(Integer solicitacaoAcessoId,
			Integer permissaoEspecialId) {
    ...
    public String toString() {
        return new ToStringBuilder(this)
            .append("solicitacaoAcessoId", getSolicitacaoAcessoId())

...
throws ControladorException ;
	...
	/**
	 * Metódo responsável por registrar o acesso do usuário incrementando o nÂº de acessos
	...
	/**
	 * [UC0289] Efetuar Alteração da Senha
	 * [FP-04] -€“ Alterar o clone do usuário no banco de dados com mesmo login.
	...
	/**
	 * RM 3892
	 * [UC1278] â€“ Enviar e-mail para usuários superiores
	 * @author Amélia Pessoa
	 * @date 25/01/2012 
	 * @throws ControladorException
	 */
	...
	/**
	 * Obtem o id do Nivel associado a solicitacao de acesso
	 * @param idSolicitacaoAcesso
	 * @return
	 */
	...
	/**
	 * O sistema atualiza os usuários das solicitações de acesso
	 * 
	 * @author Fernanda Almeida
	 * @date 17/01/2013
	 ...
	 * @throws ControladorException
	 */
	public void atualizarSolicitacoesAcesso( Collection<SolicitacaoAcesso> colecaoSolicitacaoAcesso,

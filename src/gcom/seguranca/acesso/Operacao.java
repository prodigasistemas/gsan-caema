...
public class Operacao extends TabelaAuxiliarAbreviada {
	...
	public static final Integer OPERACAO_REMOVER_EMPRESA = new Integer(1417);
...
//	public static final Integer ATUALIZAR_IMPORTANCIA_LOGRADOURO = 1816;
	...
	public static final Integer OPERACAO_ATUALIZAR_MOTIVO_NAO_GERACAO_COB_RESULTADO = new Integer(1925);
	
	public static final Integer OPERACAO_REMOVER_MOTIVO_NAO_GERACAO_COB_RESULTADO = new Integer(1926);

	public static final Integer OPERACAO_INSERIR_MOTIVO_NAO_GERACAO_COB_RESULTADO = new Integer(1927);
	
	/** INSERIR MOTIVO NAO AUTORIZACAO */
	public static final Integer OPERACAO_MOTIVO_NAO_AUTORIZACAO_INSERIR = new Integer(1953);
	
	/** EXCLUIR MOTIVO NAO AUTORIZACAO */
	public static final Integer OPERACAO_MOTIVO_NAO_AUTORIZACAO_EXCLUIR = 1958;
	
	/** ATUALIZAR MOTIVO NAO AUTORIZACAO */
	public static final Integer OPERACAO_MOTIVO_NAO_AUTORIZACAO_ATUALIZAR = new Integer(1959);
	
	/** EXCLUIR MOTIVO NAO ACEITE */
	public static final Integer OPERACAO_MOTIVO_NAO_ACEITE_EXCLUIR = 1970;
	
	/** ATUALIZAR MOTIVO NAO ACEITE */
	public static final Integer OPERACAO_MOTIVO_NAO_ACEITE_ATUALIZAR = new Integer(1971);
	
	/** INSERIR SERVICO REPAVIMENTADORA */
	public static final Integer OPERACAO_INSERIR_SERVICO_REPAVIMENTADORA = new Integer(2055);
	
	/** INSERIR CONTRATO DEMANDA */
	public static final Integer OPERACAO_INSERIR_CONTRATO_DEMANDA = new Integer(837);
	
	public static final int OPERACAO_ALTERAR_SITUACAO_LIGACAO = 857;
	
	/** INSERIR SUBSISTEMA DE ESGOTO */
	public static final Integer OPERACAO_INSERIR_SUBSISTEMA_ESGOTO = new Integer(2078);
	
	/** REMOVER SUBSISTEMA DE ESGOTO */
	public static final Integer OPERACAO_SUBSISTEMA_ESGOTO_REMOVER = new Integer(2081);
	
	/** ATUALIZAR SUBSISTEMA DE ESGOTO */
	public static final Integer OPERACAO_SUBSISTEMA_ESGOTO_ATUALIZAR = new Integer(2084);
	
	public static final Integer OPERACAO_COMANDAR_ENCERRAMENTO_RA = new Integer(1141);	
	...
	public static final Integer OPERACAO_CONSULTAR_ORDENS_SERVICO_ARQUIVO_TEXTO = new Integer(1859);
	
	public static final Integer OPERACAO_CONSULTAR_DADOS_OS_COBRANCA_SMARTPHONE = new Integer(2073);
	
	public static final Integer OPERACAO_LIBERAR_LOGRADOURO_ATUALIZACAO = new Integer(2118);
	
	public static final Integer OPERACAO_ATUALIZAR_DADOS_INCONSISTENTES_ATUALIZACAO_CADASTRAL = new Integer(1913);
	
	public static final Integer OPERACAO_ATUALIZAR_CLIENTE_VIRTUAL = new Integer(2133);

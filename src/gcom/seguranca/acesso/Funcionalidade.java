...
public class Funcionalidade extends TabelaAuxiliarAbreviada {
	...
	public static final int GERAR_DADOS_DIARIOS_ARRECADACAO_ANO_MAIOR = 1746;
    ...
    public static final int GERAR_RESUMO_ACOES_ORDEM_DE_SERVICO = 1806;
	...
	public static final int GERAR_DEBITOS_ATUALIZADOS_PARA_JURIDICO = 1572;
	
	public static final int INFORMAR_SITUACAO_COBRANCA_JURIDICO = 1573;
	
	public static final int ATUALIZAR_PERIODO_FINAL_REFERENCIA_IMOVEL_COBRANCA_JUDICIAL = 1574;
	...
	public static final int ENVIAR_EMAIL_USUARIOS_SUPERIORES = 1577;
	
	public static final int GERAR_ARQUIVOS_EFD_PIS_CONFINS = 1578;
	
	public static final int ATUALIZAR_DADOS_DOS_IMOVEIS_PELO_RECADASTRAMENTO = 1592;
	
	public static final int GERAR_BASE_DE_CLIENTE_PARA_SORTEIO = 1593;

	public static final int GERAR_OS_ANORMALIDADE_CONSUMO = 1589;
	...
	public static final int RECEPCAO_DADOS_ADMIN = 1610;
	
	public static final int INSERIR_DADOS_ADMIN = 1625;
	
	public static final int ATUALIZAR_TABELAS_BASICAS_RECEPCAO_DADOS_ADMIN = 1635;
	
	public static final int ATUALIZAR_LOGRADOURO_IMOVEL_ATUALIZACAO_CADASTRAL = 1636;	

	public static final int DETALHAR_ARRECADACAO_LIQUIDA_ENCERRAMENTO_MES = 1653;
	
	public static final int GERAR_RESUMO_KIT_CAS_SERVICO = 1600;
	
	public static final int BATCH_GERAR_MOTIVOS_NAO_GERACAO_CONTAS_IMOVEIS_COB_EMPRESA = 1633;
	
	public static final int BATCH_REGISTRAR_AUTOMATICAMENTE_MOVIMENTO_ARRECADADORES = 1654; 
	
	public static final int GERAR_RESUMO_SIM = 1655;

	public static final int BATCH_ENCERRAR_AUTOMATICAMENTE_COMANDOS_COB_RESULTADO = 1657; 
	
	public static final int GERAR_RESUMO_PENDENCIA_BD = 1658;
	
	public static final int GERAR_ARQUIVO_TEXTO_PARCELAMENTOS_NEGOCIADOS_EMPRESAS_COBRANCA = 1668;

	public static final int ATUALIZAR_SITUACAO_LIGACAO_AGUA_IMOVEL_FISCALIZADO = 1675;
	
	public static final int GERAR_ARQUIVO_TEXTO_CODIGO_BARRA_DOCUMENTO_COBRANCA = 1679;
	
	public static final int CONCEDER_CREDITO_CONJUNTO_CONTAS = 1691;
	
	public static final int BATCH_PROCESSAR_ARQUIVO_RESETORIZACAO_IMOVEIS = 1696;
	
	public static final int BATCH_VALIDAR_RESETORIZACAO_IMOVEIS = 1698;

	public static final int GERAR_BASE_CLIENTE_SORTEIO_MENSAL = 1689;
	
	public static final int GERAR_ROTEIRO_DISPOSITIVO_MOVEL = 1703;
	
	public static final int RETIRAR_SITUACAO_ESPECIAL_FATURAMENTO = 1704;
	...
	public static final int BATCH_GERAR_INTEGRACAO_CONTABILIDADE = 1722;
	
	public static final int GERAR_RESUMO_CONSUMO_AGUA_BD = 1715;

	public static final int BATCH_UNIFICAR_ID_CLIENTES_MESMO_DOCUMENTO = 1720;
	
	public static final int BATCH_GERAR_RELATORIO_CLIENTES_MESMO_CPF_CNPJ = 1721;
	
	public static final int BATCH_ATUALIZAR_INDICADOR_FATURAMENTO_LIGACOES_CORTADAS = 1726;
	
	public static final int BATCH_ATUALIZAR_MES_ANO_CONTABIL_DEBITOS_A_COBRAR = 1727;
	
	public static final int BATCH_SUSPENDER_FATURAMENTO_AGUA_IMOVEIS_EM_ANALISE = 1728;
	
	public static final int BATCH_SUSPENDER_FATURAMENTO_ESGOTO_IMOVEIS_TARIFA_SOCIAL = 1729;
	
	public static final int BATCH_GERAR_GUIA_ATRASO_PARCELAMENTO_JUDICIAL = 1740;
	
	public static final int BATCH_ATUALIZAR_CONTAS_VALORES_ESGOTO_PPP = 1765;

	public static final int BATCH_GERAR_RESUMO_FATURAMENTO_ANALITICO_SINTETICO_PPP = 1763;
	
	public static final int BATCH_ATUALIZAR_SUBSISTEMA_ESGOTO_IMOVEL = 1780;
	
	public static final int BATCH_GERAR_ORDEM_SERVICO_CONEXAO_ESGOTO = 1793;
	
	public static final int BATCH_GERAR_OS_FACTIVEL_FATURAVEL = 1797;
	
	public static final int BATCH_ENCERRAR_OS_NAO_EXECUCAO = 1799;
	
	public static final int BATCH_ENCERRAR_ORDEM_SERVICO_CONEXAO_ESGOTO_CONCLUSAO_SERVICO = 1800;
	
	public static final int BATCH_VALIDAR_DADOS_DO_ENDERECO_ENVIADOS_PELO_GEO = 1807;
	
	public static final int BATCH_GERAR_DEBITO_A_COBRAR_CARRO_PIPA = 1814;

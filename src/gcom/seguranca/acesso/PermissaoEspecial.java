...
public class PermissaoEspecial extends ObjetoTransacao {
	...
	public static final int REVALIDAR_USUARIO = 119;

	public static final int ALTERAR_IMOVEIS_ASSOCIADOS = 125;
	
	public static final int INFORMAR_COMPETENCIA_RETIFICACAO = 124;

	public static final int INSERIR_DEBITO_ORIUNDO_ENTREGA_POSTAL  = 120;
	
	public static final int ALTERAR_DEBITO_ORIUNDO_ENTREGA_POSTAL  = 121;
	
	public static final int INSERIR_INDICADOR_BLOQUEIO_IMOVEIS_ASSOCIADOS  = 122;
	
	public static final int ALTERAR_INDICADOR_BLOQUEIO_IMOVEIS_ASSOCIADOS  = 123;
	
	public static final int AUTORIZAR_SOLICITACAO_ACESSO  = 126;
	
	public static final int ALTERAR_NOME_CLIENTE_DIFERENTE_NOME_RECEITA  = 127;

	public static final int DEVOLUCAO_VALORES_INDEVIDOS_RA = 129;

	public static final int ALTERAR_CONTA_MES_NO_RETIFICAR = 128;
	
	public static final int ALTERAR_VINCULO_CLIENTE_CONTA_ACIMA_LIMITE = 131;
	
	public static final int DEVOLUCAO_DE_VALORES_POR_GUIA_DE_DEVOLUCAO = 130;

	public static final int ALTERA_UNIDADE_ATENDIMENTO_MEIO_SOLICITACAO = 132;
	
	public static final int ALTERAR_TAM_MAXIMO_PARA_IDENT_DO_IMOVEL_NO_CONTRATO_DE_ARRECADADOR = 133;
	
	public static final int CANCELAR_GUIA_DE_ATRASO_PARCELAMENTO_JUDICIAL = 134;
	
	public static final int RETIFICAR_CONTA_IMOVEL_CONTRATO_DEMANDA = 135;
	
	public static final int INFORMA_LOCALIDADE_CONTRATO_PPP = 136;
	
	public static final int EXCLUIR_REGISTRO_CONSULTA_CPF_RECEITA_FEDERAL = 139;
	
	public static final int SELECIONAR_MEIO_SOLICITACAO_RESTRITO = 140;
	
	public static final int INFORMA_ENCERRAMENTO_AUTOMATICO = 141;
	
	public static final int DESBLOQUEAR_ALTERACAO_MUNICIPIO = 143;
	
	public static final int SUBDIVIDIR_ROTAS_GRUPOS_DIFERENTES = 144;
	
	public static final int CANCELAR_VARIOS_COMANDOS_COBRANCA = 146;
	
	public static final int DIGITAR_COORDENADAS_IMOVEL = 147;
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		PermissaoEspecial other = (PermissaoEspecial) obj;
		if (id == null) {
			if (other.id != null)
				return false;

...
public interface ControladorPermissaoEspecialLocal
	...
	/**
	 * [UC1357] Excluir Motivo de não autorização
	 * 
	 * @author Ricardo Germinio
	 * @date 31/07/2012
	 * 
	...
	public void excluirMotivoNaoAutorizacao(String[] ids, Usuario usuarioLogado) 
			throws ControladorException;

	/**
	 * [UC1357] Atualizar Motivo de não autorização
	 * 
	 * @author Ricardo Germinio
	 * @date 31/07/2012
	 * 
	...
	public void atualizarMotivoNaoAutorizacao(MotivoNaoAutorizacao motivoNaoAutorizacao, 
			Usuario usuarioLogado) throws ControladorException;
	
	/**
	 * Verificar Permissão Especial de Solicitacao de Acesso
	 * 
	 * @author Davi Menezes
	 * @date 04/06/2013
	 */
	public boolean verificarPermissaoEspecialSolicitacaoAcesso(int permissaoEspecial, Usuario usuario)
			throws ControladorException; 
}
...
<script language="JavaScript">
	...
	$(document).ready(function(){
		...
		$('[name=sistemaAbastecimento]').change(function() {
		  ...
		  chamarAjax('FiltrarDistritoOperacionalActionForm',
				  	 'exibirFiltrarDistritoOperacionalAction.do?action=atualizarListaSubsistemaAbastecimento',
		...
		$('[name=subsistemaAbastecimento]').change(function() {
			 ...
			 chamarAjax('FiltrarDistritoOperacionalActionForm',
				  	 	'exibirFiltrarDistritoOperacionalAction.do?action=atualizarListaSetorAbastecimento',
				     	sucessoAtSetor,null);
		});
	});

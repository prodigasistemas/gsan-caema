...
<html:html>
	<head>
		...
		<html:javascript formName="AtualizarSetorAbastecimentoActionForm" />
		...
		function carregarSubsistemaPrincipal(){
		   var theForm = $("form[name=AtualizarSetorAbastecimentoActionForm]");
		   var params = theForm.serialize();
		   var actionURL = 'exibirAtualizarSetorAbastecimentoAction.do?action=atualizarListaSubsistemaPrincipal'
		...
		function carregarSistema2(){
		   var theForm = $("form[name=AtualizarSetorAbastecimentoActionForm]");
		   var params = theForm.serialize();
		   var actionURL = 'exibirAtualizarSetorAbastecimentoAction.do?action=atualizarListaSistemaSecundario'
		...
		function carregarSubsistemasSecundiarios(){
			   var theForm = $("form[name=AtualizarSetorAbastecimentoActionForm]");
			   var params = theForm.serialize();
			   var actionURL = 'exibirAtualizarSetorAbastecimentoAction.do?action=atualizarListaSubsistemasSecundarios'
				   apagarSelect('subsistemasSecundarios');
	...
	<body leftmargin="5" topmargin="5" onload="">
		<div id="formDiv">
			<html:form action="/atualizarSetorAbastecimentoAction"
				   name="AtualizarSetorAbastecimentoActionForm"
				   type="gcom.gui.operacional.AtualizarSetorAbastecimentoActionForm"
				   method="post"
				   onsubmit="return validateAtualizarSetorAbastecimentoActionForm(this)">			
				...
				<tr>
					...
					<td width="600" valign="top" bgcolor="#003399" class="centercoltext">
						...
						<table width="100%" border="0">
							<tr>
								<td colspan="2">
									<p>Para atualizar um setor de abastecimento, informe os dados abaixo:</p>
									<p>&nbsp;</p>
								</td>
							</tr>
							<!--===================== CORPO DA VISÃO =========================-->
							<tr> 
					          ...
					          <td colspan="2"><bean:write name="AtualizarSetorAbastecimentoActionForm" property="codigo"/> </td>
					      	</tr>
							<tr> 
						    ...
						    <tr>
							   <td><strong>Sistema de Abastecimento Principal:</strong></td>
							   <td>
									<html:select property="sistemaAgua1" style="width: 200px;" tabindex="13">
						   ...
						   <tr>
							   <td><strong>Subsistema Principal:<font color="#FF0000">*</font></strong></td>
							   <td>
									<html:select property="subsistemaPrincipal" style="width: 200px;" tabindex="13">
										<html:option value="-1">&nbsp;</html:option>
						   ...
						   <tr>
							   ...
							   <td>
									<html:select property="sistemaAgua2" style="width: 200px;" tabindex="13">
										<html:option value="-1">&nbsp;</html:option>
						    ...
						    <tr>
							   <td><strong>Subsistemas Secundários:</strong></td>
							   <td>
									<html:select property="subsistemasSecundarios" style="width: 200px;height:150px;" tabindex="14" multiple="true">
										<html:option value="-1">&nbsp;</html:option>
							...
							<tr>
								<td colspan="2">
									...
									<input type="button" name="Button"
										   ...
										   onClick="javascript:window.location.href='/gsan/exibirAtualizarSetorAbastecimentoAction.do?idSetorAbastecimento=${AtualizarSetorAbastecimentoActionForm.codigo}&menu=sim'"
										   style="width: 80px" />&nbsp; 
									<input type="button" name="Button"
								...
								<input type="submit" name="Button"
									   class="bottonRightCol" value="Atualizar" tabindex="32" style="width: 80px" />
							</tr>		
						</table>
					</td>
				</tr>

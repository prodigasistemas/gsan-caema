		...
		<tr>
			...
			%>
				...
				<tr>
					...
					<table width="100%" align="center" bgcolor="#90c7fc" border="0">
						<tr bordercolor="#79bbfd">
							<td colspan="4" align="center" bgcolor="#79bbfd"><strong>Contrato de Parcelamento por Cliente Responsável (Parcelas Vencidas) </strong></td>
						</tr>
						<tr bordercolor="#000000">
							<td width="25%" bgcolor="#90c7fc">
							<div align="center" class="style9"><font color="#000000"
								style="font-size:9px"
								face="Verdana, Arial, Helvetica, sans-serif"> <strong>Contrato</strong> </font></div>
							</td>
							<td width="25%" bgcolor="#90c7fc">
							<div align="center" class="style9"><font color="#000000"
								style="font-size:9px"
						...
						<%cor = "#cbe5fe";%>
						<logic:present name="colecaoContratoParcelamentoClienteResp">
							<logic:iterate name="colecaoContratoParcelamentoClienteResp"
								id="contratoParcelamentoHelper">
								<%if (cor.equalsIgnoreCase("#cbe5fe")) {
				cor = "#FFFFFF";%>
								<tr bgcolor="#FFFFFF">
									<%} else {
				cor = "#cbe5fe";%>
								<tr bgcolor="#cbe5fe">
									...
									<div align="center" class="style9"><font color="#000000"
										...
										<bean:write name="contratoParcelamentoHelper" property="contrato" /></font></div>
									</td>
									<td>
									<div align="center" class="style9"><font color="#000000"
										style="font-size:9px"
										face="Verdana, Arial, Helvetica, sans-serif"> 
										<bean:write name="contratoParcelamentoHelper" property="parcelaFormatada" /></font></div>
									</td>
									<td>
									<div align="center" class="style9"><font color="#000000"
										style="font-size:9px"
										face="Verdana, Arial, Helvetica, sans-serif"> 
										<bean:write name="contratoParcelamentoHelper" property="valorFormatado" /></font></div>
									</td>
									<td>
									<div align="center" class="style9"><font color="#000000"
										style="font-size:9px"
										face="Verdana, Arial, Helvetica, sans-serif"> 
										<bean:write name="contratoParcelamentoHelper" property="dataVencimento" /></font></div>
										</font></div>
									</td>
								</tr>
							</logic:iterate>
				...
				<tr>
					...
					<table width="100%" align="center" bgcolor="#90c7fc" border="0">
						<tr bordercolor="#79bbfd">
							<td colspan="4" align="center" bgcolor="#79bbfd"><strong>Contrato de Parcelamento por Cliente Responsável (Parcelas A Vencer) </strong></td>
						</tr>
						<tr bordercolor="#000000">
							<td width="25%" bgcolor="#90c7fc">
							<div align="center" class="style9"><font color="#000000"
						...
						<%cor = "#cbe5fe";%>
						<logic:present name="colecaoContratoParcelamentoClienteRespParcAVencer">
							<logic:iterate name="colecaoContratoParcelamentoClienteRespParcAVencer"
								id="contratoParcelamentoHelper">
								<%if (cor.equalsIgnoreCase("#cbe5fe")) {
				cor = "#FFFFFF";%>
								<tr bgcolor="#FFFFFF">
					...
					<table width="100%" align="center" bgcolor="#90c7fc" border="0">
						<tr bordercolor="#000000">
							...
							<div align="center" class="style9"><font color="#000000"
								style="font-size:9px"
								face="Verdana, Arial, Helvetica, sans-serif"> <strong>Valor
							Total Geral dos Débitos</strong> </font></div>
							</td>
							<td width="50%" bgcolor="#90c7fc">
							<div align="center" class="style9"><font color="#000000"
								style="font-size:9px"
								face="Verdana, Arial, Helvetica, sans-serif"> <strong>Valor
							Total Geral dos Débitos Atualizado</strong> </font></div>
							</td>
						</tr>
						<tr bgcolor="#FFFFFF">
							<td>
							<div align="right" class="style9"><font color="#000000"
								style="font-size:9px"
								face="Verdana, Arial, Helvetica, sans-serif"> <%=session.getAttribute("valorTotalGeralSemAcrescimo")%>
							</font></div>
							</td>
							<td>
							<div align="right" class="style9"><font color="#000000"
								style="font-size:9px"
								face="Verdana, Arial, Helvetica, sans-serif"> <%=session.getAttribute("valorTotalGeralComAcrescimo")%>
							</font></div>
							</td>
						</tr>
					</table>

   			...
   			<table width="100%" border="0">
   				...
   				<tr> 
                       <td><strong>Núm. Dias de Validade da Ação:</strong></td>
   				     <td><html:text maxlength="5" property="numeroDiasValidade" size="5" tabindex="2"/></td>
                 </tr>
                 <tr> 
                  ...
                  <tr> 
   				...
   				<td><html:text property="numeroDiasEntreAcoes" size="5" maxlength="5" tabindex="4"/></td>
                </tr>
                <tr> 
   			...
   			<table width="100%" border="0">
                 <tr> 
                   ...
                   <tr>
                    ...
                    <tr>
   	                 <td width="45%"><strong>Efetuar Ação para CPF/CNPJ Válido:</strong></td>

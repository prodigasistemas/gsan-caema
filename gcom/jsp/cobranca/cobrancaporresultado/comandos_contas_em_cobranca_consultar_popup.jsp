	...
	<table width="700" border="0" cellspacing="5" cellpadding="0">
		<tr>
			...
			<table width="100%" border="0">
				...
				<logic:notPresent name="colecaoCobrancaAcao" scope="session">
					<tr>
						<td width="35%"><strong>Ações selecionadas para validação de documentos:</strong></td>
						<td colspan="3">
						<html:text property="idCobrancaAcao" size="10"
							maxlength="10" readonly="true"
							style="background-color:#EFEFEF; border:0; font-color: #000000" />
						<html:text property="descricaoCobrancaAcao" size="50" maxlength="40"
							readonly="true"
							style="background-color:#EFEFEF; border:0; font-color: #000000" />
						</td>
					</tr>
				...
				<logic:present name="colecaoCobrancaAcao" scope="session">
					...
					<logic:iterate name="colecaoCobrancaAcao"
										id="cobrancaAcao" type="CobrancaAcao">
						<tr>
							...
							<td colspan="3">
							<input type="text" value="<bean:write name='cobrancaAcao' property='descricaoCobrancaAcao' />" size="50" maxlength="40"
								readonly="true"
								style="background-color:#EFEFEF; border:0; font-color: #000000" />
							</td>
						</tr>
				...
				<logic:notPresent name="colecaoCobrancaSituacao" scope="session">
					<tr>
						<td width="35%"><strong>Situações de Cobrança selecionadas:</strong></td>
						<td colspan="3">
						<html:text property="idCobrancaSituacao" size="10"
							maxlength="10" readonly="true"
							style="background-color:#EFEFEF; border:0; font-color: #000000" />
						<html:text property="descricaoCobrancaSituacao" size="50" maxlength="40"
							readonly="true"
							style="background-color:#EFEFEF; border:0; font-color: #000000" />
						</td>
					</tr>
				...
				<logic:present name="colecaoCobrancaSituacao" scope="session">
					<c:set var="count2" value="0" />
					<logic:iterate name="colecaoCobrancaSituacao"
										id="cobrancaSituacao" type="CobrancaSituacao">
						<tr>
							<c:set var="count2" value="${count2+1}" />
							<c:choose>
								<c:when test="${count2 == '1'}">
							...
							<td colspan="3">
							<input type="text" value="<bean:write name='cobrancaSituacao' property='descricao' />" size="50" maxlength="40"
								readonly="true"
								style="background-color:#EFEFEF; border:0; font-color: #000000" />
							</td>
						</tr>
				...
				<tr>
					<td width="35%"><strong>Quantidade Máxima de Imóveis:</strong></td>
					<td colspan="3"><html:text property="qtdMaxImoveis" size="10"
						maxlength="10" readonly="true"
						style="background-color:#EFEFEF; border:0; font-color: #000000" />
					</td>
				</tr>
				...
				<logic:present name="exibeTabelaPropocionalidade">
					<table width="100%" >					
						<tr>
							<td colspan="4">
							<hr>
						...
						<tr>							
							<td bgcolor="#90c7fc" bordercolor="#90c7fc" align="center" ><strong>Descrição da Faixa</strong></td>
							<td bgcolor="#90c7fc" bordercolor="#90c7fc" align="center" ><strong>Quantidade Mínima de Contas</strong></td>							
							<td bgcolor="#90c7fc" bordercolor="#90c7fc" align="center" ><strong>Percentual da Faixa</strong></td>
							<td bgcolor="#90c7fc" bordercolor="#90c7fc" align="center" ><strong>Percentual de Imóveis</strong></td>
						</tr>
						<% int cont = 0; %>
						<logic:iterate name="dadosPropocionalidade" id="dadoProp" type="gcom.cobranca.cobrancaporresultado.DadosPropocionalidadeHelper">						
							<tr>
								<%if (cont%2 != 0){ %>
								<td align="center" bgcolor="#cbe5fe">
									<c:out value="${dadoProp.desc }" />
								</td>
								<td align="center" bgcolor="#cbe5fe">
									<c:out value="${dadoProp.qtdMinContas }" />
								</td>							
								<td align="center" bgcolor="#cbe5fe">
									<c:out value="${dadoProp.percentualFaixa }" />
								</td>							
								<td align="center" bgcolor="#cbe5fe">
									<c:out value="${dadoProp.percentualImoveis }" />
								</td>
								<% 
									}
								else{ %>
				...
				<logic:notPresent name="percentualInformado" scope="session">
					<logic:present name="colecaoQuantidadeContas" scope="session">
						<table width="100%" >
							...
							<tr>
								<td  align="center" bgcolor="#99CCFF"><strong>Percentual de Imóveis na Faixa:</strong></td>
								<logic:iterate name="colecaoPercentualImoveisFaixa" id="percentualImovelFaixa" type="BigDecimal">
									<td align="center"  bgcolor="#cbe5fe">
										<strong><bean:write name="percentualImovelFaixa" formatKey="money.format" />%</strong>
									</td>	
								</logic:iterate>
							</tr>

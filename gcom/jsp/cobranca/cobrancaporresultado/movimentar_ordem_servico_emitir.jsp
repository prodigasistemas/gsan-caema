...
<script language="JavaScript" src="<bean:message key="caminho.js"/>validacao/regras_validator.js"></script><html:javascript staticJavascript="false"  formName="MovimentarOrdemServicoActionForm" />
...
<script>
    ...
    function gerarArquivoTextoCodigoBarras() {
    	var form = document.forms[0];
    	var msg = "";
    	
    	if(form.idLocalidadeOrigem.value == "" || form.idLocalidadeDestino.value == ""){
    		msg = "Para geração do arquivo é necessário informar o intervalo de localidade, setor e quadra.";
    	}
    	
    	if(form.codigoSetorComercialOrigem.value == "" || form.codigoSetorComercialDestino.value == ""){
    		msg = "Para geração do arquivo é necessário informar o intervalo de localidade, setor e quadra.";
    	}
    	
    	if(form.codigoQuadraInicial.value == "" || form.codigoQuadraFinal.value == ""){
    		msg = "Para geração do arquivo é necessário informar o intervalo de localidade, setor e quadra.";
    	}
    	...
    	if(msg != ""){
    		...
    		form.action = 'gerarArquivoTextoCodigoBarrasDocumentoCobrancaAction.do';
    		form.submit();
    	}
    }
			...
			<td colspan="3">
		       <div id="tipoVisitaCobranca" style="display:none;">
			       <table border="0">
					...
					<tr>
						...
						<td colspan="2"><html:text maxlength="3" property="idLocalidadeOrigem" size="3"
							onkeypress="validaEnterComMensagem(event, 'movimentarOrdemServicoWizardAction.do?action=exibirMovimentarOrdemServicoEmitirOSAction&tipoPesquisa=localidadeOrigem', 'idLocalidadeOrigem' ,'Localidade Inicial');return isCampoNumerico(event);"
					...
					<tr>
						...
						<td colspan="2"><html:text maxlength="4" property="codigoQuadraInicial" size="3"
							onkeypress="validaEnterDependenciaComMensagem(event, 'movimentarOrdemServicoWizardAction.do?action=exibirMovimentarOrdemServicoEmitirOSAction&tipoPesquisa=quadraInicial', document.forms[0].codigoQuadraInicial, document.forms[0].codigoSetorComercialOrigem.value, 'Setor Comercial Inicial','Quadra Inicial');return isCampoNumerico(event);"
							tabindex="8"
					...
					<tr>
						...
						<td colspan="2"><html:text maxlength="3" property="idLocalidadeDestino"
							size="3"
							onkeypress="validaEnterComMensagem(event, 'movimentarOrdemServicoWizardAction.do?action=exibirMovimentarOrdemServicoEmitirOSAction&tipoPesquisa=localidadeDestino', 'idLocalidadeDestino' ,'Localidade Final');bloqueiaDados();return isCampoNumerico(event);"
					...
					<tr>
						...
						<td colspan="2"><html:text maxlength="3" property="codigoSetorComercialDestino"
							size="3"
							onkeypress="validaEnterDependenciaComMensagem(event, 'movimentarOrdemServicoWizardAction.do?action=exibirMovimentarOrdemServicoEmitirOSAction&tipoPesquisa=setorComercialDestino', document.forms[0].codigoSetorComercialDestino, document.forms[0].idLocalidadeDestino.value, 'Localidade Final', 'Setor Comercial Final');return isCampoNumerico(event);"
							onchange="javascript:limparTotalizacao();" 
					...
					<tr>
						...
						<td colspan="2"><html:text maxlength="4" property="codigoQuadraFinal" size="3"
							onkeypress="validaEnterDependenciaComMensagem(event, 'movimentarOrdemServicoWizardAction.do?action=exibirMovimentarOrdemServicoEmitirOSAction&tipoPesquisa=quadraFinal', document.forms[0].codigoQuadraFinal, document.forms[0].codigoSetorComercialDestino.value, 'Setor Comercial Final','Quadra Final');return isCampoNumerico(event);"
        		...
        		<table border="0" width="100%" >
					...
					<logic:present name="gerarArquivoTexto" scope="session" >
						<tr>
							<td align="right" colspan="4">
								<input name="Button" 
										   type="button"
										   class="bottonRightCol" 
										   value="TXT Código Barras" 
										   align="right"
										   onClick="javascript:gerarArquivoTextoCodigoBarras();" tabindex="9" />
							</td>
						</tr>
					</logic:present>
				</table>

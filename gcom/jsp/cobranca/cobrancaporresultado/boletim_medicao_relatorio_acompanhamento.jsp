...
<script language="JavaScript">
	 ...
	 function validaForm(){
		 ...
		 if(qtdSelecionadosRadio(form.formatoRelatorio) == 0){
			 alert('Informar Formato do Relatório');
			 return false;
		 }
	 ...
	 function habilitarDesabilitar(indicador){
		 ...
		 if(indicador == 2){
			 ...
			 if(form.opcaoRelatorio[1].checked){
				 form.formatoRelatorio[0].checked = true;
				 form.formatoRelatorio[1].checked = false;
				 form.formatoRelatorio[2].checked = false;
				 form.formatoRelatorio[1].disabled = true;
				 form.formatoRelatorio[2].disabled = true;
			 }else{
				 form.formatoRelatorio[1].disabled = false;
				 form.formatoRelatorio[2].disabled = false;
			 }
		 }
	 }
		...
		<tr>
			...
			<table width="100%" border="0">
				...
				<tr>
					...
					<td width="50%"><strong> <span class="style1"><strong> 
					<html:radio property="opcaoRelatorio" value="1" tabindex="4" onclick="habilitarDesabilitar(3)"/> <strong>Analítico 
					<html:radio property="opcaoRelatorio" value="2" tabindex="5" onclick="habilitarDesabilitar(3)"/> Resumido
					</strong></strong></span></strong></td>
				</tr>
				<tr>
					<td width="50%"><strong>Formato do Relatório:<font color="#FF0000">*</font></strong></td>
					<td width="50%"><strong> <span class="style1"><strong> 
					<html:radio property="formatoRelatorio" value="1" tabindex="6" /> <strong>PDF 
					<html:radio property="formatoRelatorio" value="2" tabindex="7" /> TXT
					<html:radio property="formatoRelatorio" value="3" tabindex="8" /> Ambos
					</strong></strong></span></strong></td>
				</tr>	

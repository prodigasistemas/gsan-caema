...
<script language="JavaScript">
	 ...
	 function validaForm(){
		 ...
		 if(form.periodoComandoInicial.value == '' && form.periodoComandoInicial.disabled == false &&
			 ...
			 alert('Informar Período de Execução do Comando ou Período Apuração');
			 return false;
		 }

		 if(form.periodoComandoInicial.value == '' && form.periodoApuracao.disabled == true){
			 alert('Informar Período de Execução do Comando');
			 return false;
		 }
		 ...
		 if(form.periodoComandoInicial.value != '' && form.periodoComandoFinal.value == ''){
			 alert('Informar Período Final de de Execução do Comando');
			 return false;
		 }

		 if(form.periodoComandoFinal.value != '' && form.periodoComandoInicial.value == ''){
			 alert('Informar Período Inicial de de Execução do Comando');
			 return false;
		 }
		...
		<tr>
			...
			<table width="100%" border="0" align="center" cellpadding="0"
				...
				<tr>
					...
					<td class="parabg">Relatório de Cobrança por Resultado por Comando/Mês</td>
			...
			<table width="100%" border="0">
				<tr>
					<td colspan="6">Para gerar o relatório de cobrança por resultado por comando/mês, informe os dados abaixo:</td>
					<td align="right"></td>
				</tr>
				<tr>
					<td>&nbsp;</td>
				...
				<tr>
					<td colspan="3"><strong>Opção Totalização Por Mês de Apuração:</strong></td>
				</tr>
				<tr>
					<td>&nbsp;</td>
				</tr>
				...
				<tr>
					<td colspan="3"><strong>Opção Totalização Por Comando:</strong></td>
				</tr>
				<tr>
					<td>&nbsp;</td>
				</tr>
				<tr>
	                <td><strong>Período Apuração:</strong></td>
		            <td colspan="2"><strong>

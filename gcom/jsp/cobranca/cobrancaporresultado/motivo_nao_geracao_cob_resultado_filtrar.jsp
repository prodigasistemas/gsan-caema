				...
				<td width="625" valign="top" class="centercoltext">
					...
					<table width="100%" border="0" align="center" cellpadding="0"
						...
						<tr>
							...
							<td class="parabg">Filtrar Motivo Não Geração Cobrança por
								Resultado</td>
							<td width="11"><img border="0"
					...
					<table border="0" width="100%">
						<tr>
							<td colspan="2">Para filtrar o(s) motivo(s) de não geração
								cobrança por resultado, informe os dados abaixo:</td>
						</tr>


						<tr>
							<td width="30%"><strong>Código:<font
									color="#ff0000"></font>
							</strong>
							</td>
						...
						<tr>
							<td width="30%"><strong>Descrição Abreviada:</strong>
							</td>

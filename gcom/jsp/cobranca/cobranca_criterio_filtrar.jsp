			...
			<table width="100%" border="0">
				...
				<tr>
					...
					<td width="40%"><html:text maxlength="10"
						...
						onkeyup="javascript:mascaraData(this,event);" tabindex="2" onkeypress="return isCampoNumerico(event);" /> <img
						border="0"
				...
				<tr>
					...
					<td width="40%"><html:text property="numeroAnoContaAntiga" size="2"
						maxlength="2" tabindex="3" onkeypress="return isCampoNumerico(event);" /></td>
				</tr>
				<tr>
			...
			<table width="100%" border="0">
				<tr>
					<td valign="top"><input name="button" type="button"
						...
						onclick="limpar(document.forms[0]);">

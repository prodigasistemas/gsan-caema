...
function selecionar(){
    	...
    	formulario.tipoComando[i].value
 		if(formulario.tipoComando[i].value == 'Cronograma' && formulario.situacaoComando.value != 'reabrir'){
    		formulario.action =  '/gsan/exibirFiltrarComandosAcaoCobrancaCronogramaAction.do?menu=sim'
    		formulario.submit();
		}else if(formulario.tipoComando[i].value == 'Eventual' && formulario.situacaoComando.value != 'reabrir'){
    		formulario.action =  '/gsan/exibirFiltrarComandosAcaoCobrancaEventualAction.do?menu=sim'
    		formulario.submit();
		}else if(formulario.tipoComando[i].value == 'Cronograma' && formulario.situacaoComando.value == 'reabrir'){
			formulario.action =  '/gsan/exibirFiltrarComandosAcaoCobrancaCronogramaReabrirAction.do?menu=sim';
			formulario.submit();
		}else if(formulario.tipoComando[i].value == 'Eventual' && formulario.situacaoComando.value == 'reabrir'){
			formulario.action ='/gsan/exibirFiltrarComandosAcaoCobrancaEventualReabrirAction.do?menu=sim';
			formulario.submit();
    		}	
...
<html:hidden name="ConsultarComandosAcaoCobrancaCronogramaActionForm" property="situacaoComando" />
		...
		<table width="100%" border="0" align="center" cellpadding="0"
			...
			<tr>
				...
				<td class="parabg"><bean:write name="titulo"  scope="session" /></td>
		...
		<table width="100%" border="0" dwcopytype="CopyTableRow">
			...
			<tr>
				...
				<table border="0" align="right">
					<tr>
						<td align="right"><input type="button" name="ButtonCancelar" class="bottonRightCol"
						value="Cancelar"
...
<%@ include file="/jsp/util/telaespera.jsp"%></form>

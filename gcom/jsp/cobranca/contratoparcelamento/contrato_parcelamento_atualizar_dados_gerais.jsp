    ...
    <table border="0" width="100%">
      ...
      <tr >
        ...
        <td width="19%"><div align="left"><strong>
       	 <html:text property="numeroContrato" size="15" maxlength="15" />
        </strong></div></td>
        <td width="14%" height="10"><strong>Data do 
            Contrato:<span class="style2"><strong><font color="#FF0000">*</font></strong></span></strong></td>
          <td colspan="5"> 
                  <html:text onkeyup="mascaraData(this, event);" onkeypress="return verificaData(event);"
      ...
      <tr>
       ...
       <table border="0">
        ...
        <tr>
          ...
          <td colspan="5">
          	<html:text onkeypress="return verificaData(event);" onkeyup="mascaraAnoMes(this, event);" property="anoMesDebitoInicio" size="7"  maxlength="7" />
            <strong> a</strong>
            <html:text onkeypress="return verificaData(event);" onkeyup="mascaraAnoMes(this, event);" property="anoMesDebitoFinal" size="7"  maxlength="7" />
            (mm/aaaa) </td>
        </tr>
        <tr>

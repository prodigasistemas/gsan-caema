    ...
    <table border="0" width="100%">
      <tr >
        ...
        <td width="19%"><div align="left"><strong>
         <logic:present name="numeroProvisorio" scope="session">
			<input type="text" disabled="disabled" size="20" value="SEM NÚMERO" maxlength="9" />
		 </logic:present>
         <logic:notPresent name="numeroProvisorio" scope="session">

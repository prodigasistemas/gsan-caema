...
<table>
	...
	<tr>
		...
		<div align="left"><span class="style2"><strong> 
				<html:text value="${contratoAtualizar.dataVencimentoPrimParcelaFormatada}" 
				...
				<a href="javascript:abrirCalendario('AtualizarContratoParcelamentoPorClienteActionForm', 'dataVencimentoPrimParcela')">
				<img border="0"
	...
	<tr>
		<td colspan="2"><strong>Dia do Vencimento das Parcelas:</strong></td>
		<td colspan="2"><strong> <input name="numeroEntreVencParcelas" type="text" value="28" 
			readonly="true" 
			style="background-color:#EFEFEF; border:0; color: #000000" 

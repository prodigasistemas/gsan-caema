...
<SCRIPT LANGUAGE="JavaScript">
	...
	function validateInformarPagamentoContratoParcelamentoPorClienteActionForm(form){
		return true;
	}
	...
	function informarPagamento(){
		...
		if (!selecionouContrato()) {
			...
			botaoAvancarTelaEspera('/gsan/informarPagamentoContratoParcelamentoPorClienteAction.do');

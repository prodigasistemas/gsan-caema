...
<script type="text/javascript" src="<bean:message key="caminho.js"/>popup.js"></script>
  ...
  function desfazerContratoParcel(){
	...
	function bloqueiaDados(){
		...
		if (form.contratoComPagamento.value != null 
				&& (form.contratoComPagamento.value == 'sim' || form.contratoComPagamento.value == 'SIM')) {
			
			form.numeroContratoAnt.style.color = "#000000";
			form.numeroContratoAnt.readOnly = true;
			form.numeroContratoAnt.style.backgroundColor = '#EFEFEF';
			
			form.relacaoAnterior.style.color = "#000000";
			form.relacaoAnterior.disabled = true;
			form.relacaoAnterior.readOnly = true;
			form.relacaoAnterior.style.backgroundColor = '#EFEFEF';
			
			form.loginUsuario.style.color = "#000000";
			form.loginUsuario.readOnly = true;
			form.loginUsuario.style.backgroundColor = '#EFEFEF';

			form.autocompleteClienteSuperior.style.color = "#000000";
			form.autocompleteClienteSuperior.readOnly = true;
			form.autocompleteClienteSuperior.style.backgroundColor = '#EFEFEF';

			form.autocompleteCliente.style.color = "#000000";
			form.autocompleteCliente.readOnly = true;
			form.autocompleteCliente.style.backgroundColor = '#EFEFEF';
			
			form.relacaoCliente.style.color = "#000000";
			form.relacaoCliente.disabled = true;
			form.relacaoCliente.readOnly = true;
			form.relacaoCliente.style.backgroundColor = '#EFEFEF';

			form.indicadorResponsavel[0].style.color = "#000000";
			form.indicadorResponsavel[0].disabled = true;
			form.indicadorResponsavel[0].style.backgroundColor = '#EFEFEF';

			form.indicadorResponsavel[1].style.color = "#000000";
			form.indicadorResponsavel[1].disabled = true;
			form.indicadorResponsavel[1].style.backgroundColor = '#EFEFEF';

			form.indicadorResponsavel[2].style.color = "#000000";
			form.indicadorResponsavel[2].disabled = true;
			form.indicadorResponsavel[2].style.backgroundColor = '#EFEFEF';

			form.anoMesDebitoInicio.style.color = "#000000";
			form.anoMesDebitoInicio.readOnly = true;
			form.anoMesDebitoInicio.style.backgroundColor = '#EFEFEF';

			form.anoMesDebitoFinal.style.color = "#000000";
			form.anoMesDebitoFinal.readOnly = true;
			form.anoMesDebitoFinal.style.backgroundColor = '#EFEFEF';

			form.dataVencimentoInicio.style.color = "#000000";
			form.dataVencimentoInicio.readOnly = true;
			form.dataVencimentoInicio.style.backgroundColor = '#EFEFEF';

			form.dataVencimentoFinal.style.color = "#000000";
			form.dataVencimentoFinal.readOnly = true;
			form.dataVencimentoFinal.style.backgroundColor = '#EFEFEF';

			form.observacao.style.color = "#000000";
			form.observacao.readOnly = true;
			form.observacao.style.backgroundColor = '#EFEFEF';
...
<html:form action="/atualizarContratoParcelamentoClienteAction.do"
	...
	<html:hidden property="contratoComPagamento" /> 
			              ...
			              <tr> 
			                ...
			                <table width="100%">
			                  ...
			                  <tr bgcolor="#99CCFF" align="center">
			                    <td height="18" colspan="3" bgcolor="#99CCFF">
			                    	<div align="center">
			                    		<span class="style2">
			                    			<logic:present name="contratoComPagamento" scope="session">
			                    				<b>Dados  Gerais do Contrato</b>
		                    				</logic:present>
			                    			<logic:notPresent name="contratoComPagamento" scope="session">
			                    				<a href="#" onclick="return clicouPrimeiraEtapa('<c:out value="${contratoAtualizar.numero}"></c:out>');"><b>Dados  Gerais do Contrato</b> </a>
		                    				</logic:notPresent>
		                    			</span>
		                    		</div>
	                    		</td>
			                   ...
			                   <tr bgcolor="#99CCFF" align="center">
			                    <td height="18" colspan="3" bgcolor="#99CCFF">
			                    	<div align="center">
			                    		<span class="style2">
			                    			<logic:present name="contratoComPagamento" scope="session">
												<b>D&eacute;bitos do Cliente</b>												
		                    				</logic:present>
			                    			<logic:notPresent name="contratoComPagamento" scope="session">
			                    				<a href="#" onclick="return clicouSegundaEtapa('<c:out value="${contratoAtualizar.numero}"></c:out>');"><b>D&eacute;bitos do Cliente</b> </a>
		                    				</logic:notPresent>
			                    		</span>
		                    		</div>
	                    		</td>
			                  ...
			                  <tr bgcolor="#99CCFF" align="center">
			                    <td height="18" colspan="3" bgcolor="#99CCFF">
			                    	<div align="center">
			                    		<span class="style2">
			                    			<logic:present name="contratoComPagamento" scope="session">
												<b>Dados do Parcelamento</b>
		                    				</logic:present>
			                    			<logic:notPresent name="contratoComPagamento" scope="session">
			                    				<a href="#" onclick="return clicouTerceiraEtapa('<c:out value="${etapa}"></c:out>', '<c:out value="${contratoAtualizar.numero}"></c:out>');"><b>Dados do Parcelamento</b></a>
		                    				</logic:notPresent>
			                    		</span>
		                    		</div>
	                    		</td>
			               ...
			               <table width="100%">    
			                    ...
			                    <tr > 
			                      ...
			                      <td width="56%" align="right" colspan="2"><div align="left"><strong><font color="#FF0000">*</font></strong> Campos obrigat&oacute;rios</div></td>
			                    </tr>
			                    <tr> 

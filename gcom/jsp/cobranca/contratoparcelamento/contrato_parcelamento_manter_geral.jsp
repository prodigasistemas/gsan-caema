			               ...
			               <table border="0">    
			                    ...
			                    <tr> 
			                      <td align="left" colspan="3"> 
			                        ...
			                        <input name="btnAtualizar" type="button" onclick="clicouAtualizar('<c:out value="${contratoManter.id}"></c:out>');" class="bottonRightCol"  value="Atualizar" <c:if test="${contratoManter.parcelamentoSituacao.id != 1}">disabled="disabled"</c:if> /> 

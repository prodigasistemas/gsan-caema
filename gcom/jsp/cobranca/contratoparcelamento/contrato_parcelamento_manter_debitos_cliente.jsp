...
<%@ page import="gcom.faturamento.conta.ContaMotivoRevisao"%>
	...
	<logic:present name="colecaoContaItens">
			...
			<logic:iterate name="colecaoContaItens"
				...
				<logic:notEmpty name="contaGeral" property="conta">
					...
					<td>
						<logic:notEmpty name="conta" property="contaMotivoRevisao">
							<bean:define name="conta" property="contaMotivoRevisao" id="contaMotivoRevisao" />
							<logic:equal name="contaMotivoRevisao" property="id" 
								value="<%=ContaMotivoRevisao.CONTA_EM_CONTRATO_PARCELAMENTO.toString()%>">
								<div align="left" title="PCR">
									<font color="#000000" style="font-size:9px" face="Verdana, Arial, Helvetica, sans-serif"> 
										PCR
									</font>
								</div>
							</logic:equal>
							<logic:notEqual name="contaMotivoRevisao" property="id" 
									value="<%=ContaMotivoRevisao.CONTA_EM_CONTRATO_PARCELAMENTO.toString()%>">
						...
						<logic:empty name="conta" property="contaMotivoRevisao">
								<div align="left" title="${conta.debitoCreditoSituacaoAtual.descricaoDebitoCreditoSituacao}">
									<font color="#000000" style="font-size:9px" face="Verdana, Arial, Helvetica, sans-serif"> 
										<bean:define name="conta" property="debitoCreditoSituacaoAtual" id="debitoCreditoSituacaoAtual" /> 
										<bean:write name="debitoCreditoSituacaoAtual" property="descricaoAbreviada" /> 
				...
				<logic:notEmpty name="contaGeral" property="contaHistorico">
						...
						<div align="right">
							<font color="#ff0000" style="font-size:9px" face="Verdana, Arial, Helvetica, sans-serif"> 
								<logic:notEqual name="contaHistorico" property="valorDebitos" value="0">
									<a href="javascript:abrirPopup('exibirConsultarDebitoCobradoAction.do?contaID=<c:out value="${contaHistorico.id }"></c:out>&tipoConsulta=conta', 600, 800);">
						...
						<div align="right">
							<font color="#000000" style="font-size:9px" face="Verdana, Arial, Helvetica, sans-serif"> 
								<logic:notEqual name="contaHistorico" property="valorCreditos" value="0">	
									<a href="javascript:abrirPopup('exibirConsultarCreditoRealizadoAction.do?contaID=<c:out value="${contaHistorico.id }"></c:out>&tipoConsulta=conta', 600, 800);" />
					...
					<td>
						<logic:notEmpty name="contaHistorico" property="contaMotivoRevisao">
							<bean:define name="contaHistorico" property="contaMotivoRevisao" id="contaMotivoRevisao" />
							<logic:equal name="contaMotivoRevisao" property="id" 
								value="<%=ContaMotivoRevisao.CONTA_EM_CONTRATO_PARCELAMENTO.toString()%>">
								<div align="left" title="PCR">
									<font color="#000000" style="font-size:9px" face="Verdana, Arial, Helvetica, sans-serif"> 
						...
						<logic:empty name="contaHistorico" property="contaMotivoRevisao">
								<div align="left" title="${contaHistorico.debitoCreditoSituacaoAtual.descricaoDebitoCreditoSituacao}">
									<font color="#000000" style="font-size:9px" face="Verdana, Arial, Helvetica, sans-serif"> 
										<bean:define name="contaHistorico" property="debitoCreditoSituacaoAtual" id="debitoCreditoSituacaoAtual" /> 
										<bean:write name="debitoCreditoSituacaoAtual" property="descricaoAbreviada" /> 
													...
													<font color="#000000"
														...
														<logic:notEmpty name="debitoacobrar" property="imovel">
															<a href="javascript:abrirPopup('exibirConsultarDebitoACobrarAction.do?imovelID=<bean:define name="debitoacobrar" property="imovel" id="imovel" /><bean:write name="imovel" property="id" />&debitoID=<bean:write name="debitoacobrar" property="id" />', 570, 720);">
																<logic:notEmpty name="debitoacobrar" property="debitoTipo">
												...
												<div align="left" class="style9">
													<font color="#000000"
														...
														<logic:notEmpty name="debitoACobrarHistorico" property="imovel">
															<a href="javascript:abrirPopup('exibirConsultarDebitoACobrarAction.do?imovelID=<bean:define name="debitoACobrarHistorico" property="imovel" id="imovel" /><bean:write name="imovel" property="id" />&debitoID=<bean:write name="debitoACobrarHistorico" property="id" />', 570, 720);">

...
$(document).ready(function() {
	...
	// 2.22. exibir com a opção "Inclusive" selecionada 
...
function validarPeriodoFiscalizacao(){
	...
	// 2.22. caso não informe o Período de Fiscalização do Imóvel 
	if($("input[@name='periodoInicialFiscalizacao']").val() == '' &&
	   $("input[@name='periodoFinalFiscalizacao']").val() == ''){
		
		// 2.22. exibir as opções "Apenas" e "Não Incluir" desabilitadas
		$("input[@name='imoveisSitLigacaoNaoAlteradaDeb']").filter('[value=2]').attr('disabled', true); //Apenas
		$("input[@name='imoveisSitLigacaoNaoAlteradaDeb']").filter('[value=3]').attr('disabled', true); //Não Incluir
		$("input[@name='imoveisSitLigacaoNaoAlteradaDeb']").filter('[value=1]').attr('checked', true);
	}
		...
		/* 	if(!primeiroAcesso)
			...
			$("input[@name='imoveisSitLigacaoNaoAlteradaDeb']").filter('[value=3]').attr('disabled', false); //Não Incluir
		}
	}
}
...
function validarExibicaoTipoCosumo(){
	...
	function selecionarLocalidadesGerencia(){
		...
		form.action =  '/gsan/exibirManterComandoAcaoCobrancaDetalhesAction.do?objetoConsulta=5&inscricaoTipo=gerencia'
		form.submit();	
	...
	function selecionarSetorLocalidade(){
		...
		form.action =  '/gsan/exibirManterComandoAcaoCobrancaDetalhesAction.do?objetoConsulta=6&inscricaoTipo=setor'
		form.submit();	
...
<body leftmargin="5" topmargin="5" onload="validarExibicaoTipoCosumo();habilitarCampos();">
		...
		<tr>
			...
			<table width="100%" border="0" dwcopytype="CopyTableRow">
				...
				<tr>
					...
					<td colspan="3">
					 <logic:empty name="ManterComandoAcaoCobrancaDetalhesActionForm" property="dataRealizacao"> 
					  <html:text property="quantidadeMaximaDocumentos" tabindex="4" size="5" maxlength="5" onblur="validaNumero(this);"/>
					 </logic:empty>
					 <logic:notEmpty name="ManterComandoAcaoCobrancaDetalhesActionForm" property="dataRealizacao">
					  <html:text property="quantidadeMaximaDocumentos" tabindex="4" size="5" maxlength="5" disabled="true" onblur="validaNumero(this);"/>
					 </logic:notEmpty> 
				   </td>
							                    ...
							                    <%	cont = cont + 1;
								             	...
								             	<%	}	%>
								                            <td width="10%" align="center" >
								                            	<logic:equal name="dados" property="selecionada" value="true">
								                            		<input type="checkbox" name="idRegistrosLocalidade" value="${dados.id}" checked="checked"/>
								                            	</logic:equal>
								                            	<logic:notEqual name="dados" property="selecionada" value="true">
				...
				<tr>
					...
					<div align="left">
						<html:text maxlength="3"
							...
							onkeypress="limparDescricao(document.forms[0].descricaoLocalidade);validaEnterComMensagem(event, 'exibirManterComandoAcaoCobrancaDetalhesAction.do?objetoConsulta=6&inscricaoTipo=localidade', 'idLocalidade', 'Localidade');return isCampoNumerico(event);"
							onkeyup="javaScript:desabilitarCobrancaAcao();somente_numero_zero_a_nove(this);"
							onblur="javascript:somente_numero_zero_a_nove(this);"/> 
						...
						<a href="javascript:limparOrigem(3, document.forms[0].idLocalidade);"> <img name="imagem"
										...
										<table width="100%" bgcolor="#90c7fc" >			
											...
											<logic:iterate name="colecaoSetorComercialLocalidade" 
							                    ...
							                    <%	cont = cont + 1;
								             	...
								             	<%	}	%>
								                            <td width="10%" align="center" >
								                            	<logic:equal name="dados" property="selecionado" value="true">
								                            		<input type="checkbox" name="idRegistrosSetorComercial" value="${dados.id}" checked="checked"/>
								                            	</logic:equal>
								                            	<logic:notEqual name="dados" property="selecionado" value="true">
				...
				<tr>
					...
					<logic:empty name="ManterComandoAcaoCobrancaDetalhesActionForm" property="dataRealizacao"> 
					  <html:text maxlength="7"
						...
						onblur="somente_numero(this);"/><strong> a</strong> <html:text
				...
				<tr>
						...
						<td colspan="3"><strong> <html:text maxlength="7"
							...
							onkeypress="return isCampoNumerico(event);" 
							onblur="validaNumero(this);replicarCampo(document.forms[0].consumoMedioFinal,this);"/><strong> a</strong> <html:text
				...
				<tr>
					<td width="30%"><strong>Selecionar Imóveis Com Situação da Ligação Não Alterada por Débito:<font color="#FF0000">*</font></strong></td>
					...
					<html:radio property="imoveisSitLigacaoNaoAlteradaDeb" value="3" tabindex="4" /> Não Incluir
				...
				<tr>
					<td width="30%"><strong>Arquivo: </strong></td>
					<td width="70%">
				...
				<tr>
					<td colspan="1" align="left"><!--  <input name="executarComando"

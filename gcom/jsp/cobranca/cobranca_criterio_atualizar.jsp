		...
		<tr>
			...
			<table width="100%" border="0">
				...
				<tr> 
                  <td><strong>Data de In&iacute;cio de Vig&ecirc;ncia do Crit&eacute;rio:<font color="#FF0000">*</font></strong></td>
				     ...
				     <logic:present name="desabilita">
				      <html:text maxlength="10" property="dataInicioVigencia" size="10" disabled="true" onkeypress="return isCampoNumerico(event);" />(dd/mm/aaaa)
				     </logic:present>
				     <logic:notPresent name="desabilita">
				       <html:text maxlength="10" property="dataInicioVigencia" size="10" onkeyup="javascript:mascaraData(this,event);" tabindex="2" onkeypress="return isCampoNumerico(event);" />
              ...
              <tr> 
                ...
                <td width="40%">
                  <logic:present name="desabilita">
                   <html:text property="numeroAnoContaAntiga" size="2" maxlength="2" tabindex="3" disabled="true" onkeypress="return isCampoNumerico(event);" />
                  </logic:present>
                  <logic:notPresent name="desabilita">
                   <html:text property="numeroAnoContaAntiga" size="2" maxlength="2" tabindex="3" onkeypress="return isCampoNumerico(event);" />
                  </logic:notPresent>  
                </td>
              ...
              <tr> 
	                  <td><strong>Valor Limite para Prioridade:<font color="#FF0000">*</font></strong></td>
               		 ...
               		 <td>
							...
							style="text-align:right;" disabled="true" onkeypress="return isCampoNumerico(event);" />
				  	  </td>
					 </logic:present>
              ...
              <tr> 
                <td height="24" colspan="2"></td>
                 ...
                 <tr>
                  ...
                  <logic:present name="desabilita">
                    <td><html:radio property="opcaoAcaoImovelSitEspecial" value="1" tabindex="7" disabled="true"/> 
                      <strong>Sim</strong>
                      <html:radio property="opcaoAcaoImovelSitEspecial" value="2" tabindex="8" disabled="true"/> 
                      <strong>N&atilde;o</strong></td>
                  </logic:present>
                  <logic:notPresent name="desabilita">
                     <td><html:radio property="opcaoAcaoImovelSitEspecial" value="1" tabindex="9"/> 
                        <strong>Sim</strong>
                     	<html:radio property="opcaoAcaoImovelSitEspecial" value="2" tabindex="10"/> 
                       <strong>N&atilde;o</strong></td>
                  </logic:notPresent>
                 </tr>
                 <tr> 
                  ...
                  <logic:present name="desabilita">
					<td><html:radio property="opcaoAcaoImovelSit" value="1" tabindex="11" disabled="true"/> 
                      <strong>Sim</strong>
                      <html:radio property="opcaoAcaoImovelSit" value="2" tabindex="12" disabled="true"/> 
                      <strong>N&atilde;o</strong></td>
                  </logic:present>
                  <logic:notPresent name="desabilita">
                     <td><html:radio property="opcaoAcaoImovelSit" value="1" tabindex="13" onclick="javascript:habilitarSelect(this, document.forms[0].idsCobrancaSituacao)" /> 
                      <strong>Sim</strong>
                  	  <html:radio property="opcaoAcaoImovelSit" value="2" tabindex="14" onclick="javascript:habilitarSelect(this, document.forms[0].idsCobrancaSituacao)"/> 
                      <strong>N&atilde;o</strong></td>
                  </logic:notPresent>                  
                 </tr>
                 <tr>
					<td width="65%"><strong>Situa&ccedil;&atilde;o de cobran&ccedil;a:<font color="#FF0000"></font><font color="#FF0000">*</font></strong></td>                 
                 	...
                 	<logic:present name="desabilita">
                 		<html:select property="idsCobrancaSituacao" multiple="multiple" disabled="true"
                 		  name="CriterioCobrancaActionForm" tabindex="15">
                 	...
                 	<logic:notPresent name="desabilita">
	             		<logic:equal name="CriterioCobrancaActionForm" property="opcaoAcaoImovelSit" value="1">
	                 		<html:select property="idsCobrancaSituacao" multiple="multiple" tabindex="16">
	              				<html:options collection="colecaoCobrancaSituacao" labelProperty="descricao" property="id"/>
	             			</html:select>	             		
	             		</logic:equal>
	             		<logic:equal name="CriterioCobrancaActionForm" property="opcaoAcaoImovelSit" value="2">                 	
	                 		<html:select property="idsCobrancaSituacao" multiple="multiple" disabled="true" tabindex="17">
	              				<html:options collection="colecaoCobrancaSituacao" labelProperty="descricao" property="id"/>
	             			</html:select>	             		
	             		</logic:equal>	             		
             		</logic:notPresent>             		
                 ...
                 <tr> 
                  ...
                  <logic:present name="desabilita">
					<td><html:radio property="opcaoContasRevisao" value="1" tabindex="18" disabled="true"/> 
                      <strong>Sim</strong>
                      <html:radio property="opcaoContasRevisao" value="2" tabindex="19" disabled="true"/> 
                      <strong>N&atilde;o</strong></td>
                  </logic:present>
                  <logic:notPresent name="desabilita">
                     <td><html:radio property="opcaoContasRevisao" value="1" tabindex="20"/> 
                      <strong>Sim</strong>
                      <html:radio property="opcaoContasRevisao" value="2" tabindex="21"/> 
                      <strong>N&atilde;o</strong></td>
                  </logic:notPresent>                  
                 </tr>
                 ...
                 <tr> 
                  ...
                  <logic:present name="desabilita">
					<td><html:radio property="opcaoAcaoImovelDebitoMesConta" value="1" tabindex="22" disabled="true"/> 
                      <strong>Sim</strong>
                      <html:radio property="opcaoAcaoImovelDebitoMesConta" value="2" tabindex="23" disabled="true"/> 
                      <strong>N&atilde;o</strong></td>
                  </logic:present>
                  <logic:notPresent name="desabilita">
                     <td><html:radio property="opcaoAcaoImovelDebitoMesConta" value="1" tabindex="24"/> 
                      <strong>Sim</strong>
                      <html:radio property="opcaoAcaoImovelDebitoMesConta" value="2" tabindex="25"/> 
                      <strong>N&atilde;o</strong></td>
                  </logic:notPresent>                  
                 </tr>
                 <tr> 
                  ...
                  <logic:present name="desabilita">
					<td><html:radio property="opcaoAcaoInquilinoDebitoMesConta" value="1" tabindex="26" disabled="true"/> 
                      <strong>Sim</strong>
                      <html:radio property="opcaoAcaoInquilinoDebitoMesConta" value="2" tabindex="27" disabled="true"/> 
                      <strong>N&atilde;o</strong></td>
                  </logic:present>
                  <logic:notPresent name="desabilita">
                     <td><html:radio property="opcaoAcaoInquilinoDebitoMesConta" value="1" tabindex="28"/> 
                      <strong>Sim</strong>
                      <html:radio property="opcaoAcaoInquilinoDebitoMesConta" value="2" tabindex="29"/> 
                      <strong>N&atilde;o</strong></td>
                  </logic:notPresent>                  
                 </tr>
                 <tr> 
                  ...
                  <logic:present name="desabilita">
					<td><html:radio property="opcaoAcaoImovelDebitoContasAntigas" value="1" tabindex="30" disabled="true"/> 
                      <strong>Sim</strong>
                      <html:radio property="opcaoAcaoImovelDebitoContasAntigas" value="2" tabindex="31" disabled="true"/> 
                      <strong>N&atilde;o</strong></td>
                  </logic:present>
                  <logic:notPresent name="desabilita">
                     <td><html:radio property="opcaoAcaoImovelDebitoContasAntigas" value="1" tabindex="32"/> 
                      <strong>Sim</strong>
                      <html:radio property="opcaoAcaoImovelDebitoContasAntigas" value="2" tabindex="33"/> 
                      <strong>N&atilde;o</strong></td>
                  </logic:notPresent>                  
               </tr>
               ...
               <tr>
					<td width="65%"><strong>Situa&ccedil;&atilde;o de Liga&ccedil;&atilde;o de &Aacute;gua:<font color="#FF0000"></font><font color="#FF0000">*</font></strong></td>                 
                 	<td colspan="2">
                 	<logic:present name="desabilita">
                 		<html:select property="idsSituacaoLigacaoAgua" multiple="multiple" disabled="true" tabindex="34">
              				<html:options collection="colecaoSituacaoLigacaoAgua" labelProperty="descricao" property="id"/>
             			</html:select>
           			</logic:present>
                 	<logic:notPresent name="desabilita">
                 		<html:select property="idsSituacaoLigacaoAgua" multiple="multiple" tabindex="34">
              				<html:options collection="colecaoSituacaoLigacaoAgua" labelProperty="descricao" property="id"/>
             			</html:select>
           			</logic:notPresent>
                 	</td>
               ...
               <tr>
					<td width="65%"><strong>Situa&ccedil;&atilde;o de Liga&ccedil;&atilde;o de Esgoto:<font color="#FF0000"></font><font color="#FF0000">*</font></strong></td>                 
                 	<td colspan="2">
                 	<logic:present name="desabilita">                 	
                 		<html:select property="idsSituacaoLigacaoEsgoto" multiple="multiple" disabled="true" tabindex="35">
              				<html:options collection="colecaoSituacaoLigacaoEsgoto" labelProperty="descricao" property="id"/>
             			</html:select>
             		</logic:present>
                 	<logic:notPresent name="desabilita">                 	
                 		<html:select property="idsSituacaoLigacaoEsgoto" multiple="multiple" tabindex="36">
              				<html:options collection="colecaoSituacaoLigacaoEsgoto" labelProperty="descricao" property="id"/>
             			</html:select>
             		</logic:notPresent>             		
                 	</td>
                 ...
                 <tr>
					...
					<td colspan=2>                 	              	
                 		<html:select property="idResolucaoDiretoria" tabindex="37">
               ...
               <tr> 
                ...
                <logic:notPresent name="desabilita">
                <input type="button" name="Submit24" class="bottonRightCol" value="Adicionar" onClick="abrirPopupComSubmit(document.forms[0],'','');" tabindex="38"> 
                </logic:notPresent>  
                </td>
               </tr>
				...
				<tr>
					<td valign="top">
						...
						<logic:equal name="voltar" value="filtrar">
							...
							onclick="document.forms[0].target='';window.location.href='<html:rewrite page="/exibirFiltrarCriterioCobrancaAction.do"/>'" tabindex="40">
						</logic:equal>
						<logic:equal name="voltar" value="manter">
							<input name="Button" type="button" class="bottonRightCol"
							value="Voltar" align="left"
							onclick="document.forms[0].target='';window.location.href='<html:rewrite page="/exibirManterCriterioCobrancaAction.do"/>'" tabindex="41">
						</logic:equal>
					</logic:present>
					<logic:notPresent name="voltar">
						<input name="Button" type="button" class="bottonRightCol"
						value="Voltar" align="left"
						onclick="document.forms[0].target='';window.location.href='<html:rewrite page="/exibirManterCriterioCobrancaAction.do"/>'" tabindex="42">
					</logic:notPresent>
					&nbsp;
					<input name="button" type="button"
						class="bottonRightCol" value="Desfazer" onclick="desfazer('${requestScope.voltar}');" tabindex="43">
						&nbsp;<input type="button"
						name="ButtonCancelar" class="bottonRightCol" value="Cancelar"
						onClick="javascript:document.forms[0].target='';window.location.href='/gsan/telaPrincipal.do'" tabindex="44" ></td>
					<td valign="top">
					  <div align="right">
					    <gsan:controleAcessoBotao name="botaoInserir" value="Atualizar" onclick="validarForm(document.forms[0]);" url="atualizarCriterioCobrancaAction.do" tabindex="39"/>

...
function limpar(){
		...
		formulario.ligacaoAlteradaDebito[0].checked = true;
...
function validarUnidadeNegocioParaBloquear(){
	...
	var form = document.forms[0];
		...
		if(form.unidadeNegocio.value != "-1"){
	    	...
	    	form.localidadeUnica.value = "";
	    	form.localidadeUnica.disabled = true;
	
	    	form.descricaoLocalidadeUnica.value = "";
			form.descricaoLocalidadeUnica.disabled = true;
        	...
        	form.localidadeUnica.disabled = false;
        	form.descricaoLocalidadeUnica.disabled = false;
...
function recuperarDadosPopup(codigoRegistro, descricaoRegistro, tipoConsulta) {
	...
	if (tipoConsulta == 'localidade') {
		...
		form.localidadeUnica.value = codigoRegistro;
		form.descricaoLocalidadeUnica.value = descricaoRegistro;
		
		form.action =  '/gsan/exibirFiltrarComandosAcaoCobrancaEventualAction.do?objetoConsulta=5'
		form.submit();				
	}
...
function validarExibicaoTipoCosumo(){
  ...
  function pesquisarSetorComercial() {
	...
	function selecionarLocalidade() {
		...
		formulario.action =  '/gsan/exibirFiltrarComandosAcaoCobrancaEventualAction.do?objetoConsulta=4'
   		formulario.submit();				
	}

	function limparLocalidadeAPartirUnidade() {
		var formulario = document.forms[0]; 

		form.localidadeUnica.value = "";
		form.descricaoLocalidadeUnica.value = "";
		
		formulario.action =  '/gsan/exibirFiltrarComandosAcaoCobrancaEventualAction.do?objetoConsulta=5'
   		formulario.submit();				
	}
	...
	function limparPesquisaLocalidade() {
	    ...
	    if (((form.grupoCobranca.value == "") || (form.grupoCobranca.value == null) || (form.grupoCobranca.value == "-1")) &&
			...
			form.action =  '/gsan/exibirFiltrarComandosAcaoCobrancaEventualAction.do?objetoConsulta=4'
			form.submit();
	    }
			
	}

	function validarLocalidadeUnicaGerencia(){
		var form = document.forms[0];
	    
	    if(form.localidadeUnica.readOnly == false){
			if ( form.localidadeUnica.value != ''){
		    ...
		    }else if ( form.unidadeNegocio.value == '' && form.gerenciaRegional.value == '' ){
	...
	function pesquisarLocalidadeUnica() {
		var form = document.forms[0];
		...
		if (((form.grupoCobranca.value == "") || (form.grupoCobranca.value == null) || (form.grupoCobranca.value == "-1")) && 
			...
			((form.unidadeNegocio.value == "") || (form.unidadeNegocio.value == null) || (form.unidadeNegocio.value == "-1"))) {
	 		...
	 		chamarPopup('exibirPesquisarLocalidadeAction.do', 'unica', null, null, 275, 480, '',document.forms[0].localidadeOrigemID);			
		}
	}
...
<body leftmargin="5" topmargin="5"
	onload="javascript:mensagem('${requestScope.mensagem}');setarFoco('${requestScope.nomeCampo}');validarLocalidarFinalMaiorInicial();habilitarRota();validarExibicaoTipoCosumo();validarGerenciaRegionalSelecionado();validarLocalidadeUnicaGerencia();">
<div id="formDiv">
		...
		<table width="100%" border="0" dwcopytype="CopyTableRow">
			<tr>
				...
				<td colspan="3">
					<html:text  name="FiltrarComandosAcaoCobrancaEventualActionForm"
								...
								size="10"
								onkeyup="javascript:mascaraData(this, event); replicaDados(document.FiltrarComandosAcaoCobrancaEventualActionForm.dataEmissaoInicio, document.FiltrarComandosAcaoCobrancaEventualActionForm.dataEmissaoFim);somente_numero(this);"
								onchange="javascript:replicaDados(document.FiltrarComandosAcaoCobrancaEventualActionForm.dataEmissaoInicio, document.FiltrarComandosAcaoCobrancaEventualActionForm.dataEmissaoFim);"
			...
			<tr>
				...
				<td><div align="left">
					...
					onchange="javaScript:validarGerenciaRegionalSelecionado();selecionarLocalidade();">
			...
			<tr>
				<td colspan="6" width="100%"  height="100">
				<div style="width: 100%; height: 100%; overflow: auto;"><!--corpo da segunda tabela-->
					...
					<table width="100%" align="left" border="0">
						<tr bordercolor="#79bbfd">
							...
							<td colspan="2" align="center" bgcolor="#79bbfd">
					...
					<logic:iterate name="colecaoLocalidade" id="localidade">
					...
					<%	}	%>
						...
						<td>
							<div align="center">
								<input type="checkbox"
									name="idLocalidadeGerenciaRegional"
									value="<bean:write name="localidade" property="id" />" />
							</div>
						</td>
						...
						<td colspan="2" align="center">
							...
							<font style="font-size: 9px;" color="#000000" face="Verdana, Arial, Helvetica, sans-serif">
								<bean:write name="localidade" property="id" /></font>
							</div>
						</td>
			...
			<tr>
				<td height="24"><strong>Unidade de Negócio:<strong></strong></strong></td>
				<td><div align="left">
			...
			<tr>
	            ...
	            <td height="24" colspan="2">
                  		<html:text maxlength="3" 
           				   property="localidadeUnica" 
           				   size="3"  
           				   tabindex="7"
           				   name="FiltrarComandosAcaoCobrancaEventualActionForm"
           				   onkeypress="javascript:validaEnterComMensagem(event, 'exibirFiltrarComandosAcaoCobrancaEventualAction.do?objetoConsulta=5', 'localidadeUnica', 'Localidade'); return isCampoNumerico(event);"
           				   onkeyup="javaScript:validarLocalidadeUnicaGerencia();" 
                  		/>
						...
						<img src="<bean:message key='caminho.imagens'/>pesquisa.gif" 
							...
							name="imagem" 
							onclick="pesquisarLocalidadeUnica();"
							title="Pesquisar Localidade">                     	

	   		      		<logic:present name="localidadeInexistente">
							<html:text property="descricaoLocalidadeUnica" 
	                       			   size="30" 
	                       			   readonly="true"
	                       			   name="FiltrarComandosAcaoCobrancaEventualActionForm" 
	                       			   style="background-color:#EFEFEF; border:0; color: #ff0000"/>
					...
					<a href="javascript:limparPesquisaLocalidade();document.forms[0].localidadeUnica.focus();"> <img
				...
				<div style="width: 100%; height: 100%; overflow: auto;"><!--corpo da segunda tabela-->
					...
					<table width="100%" align="left" border="0">
						<tr bordercolor="#79bbfd">
							...
							<td colspan="1" align="center" bgcolor="#79bbfd">
								<strong>Código</strong>
							</td>
							<td colspan="2" align="center" bgcolor="#79bbfd">
								<strong>Descrição</strong>
					...
					<logic:iterate name="colecaoSetorComercial" id="setorComercial">
					...
					<%	}	%>
						...
						<td>
							<div align="center">
								<input type="checkbox"
									name="idSetorComercialLocalidadeUnica"
									value="<bean:write name="setorComercial" property="id" />" />
							</div>
						</td>
						...
						<td colspan="1" align="center">
							<div class="style9">
							<font style="font-size: 9px;" color="#000000" face="Verdana, Arial, Helvetica, sans-serif">
								<bean:write name="setorComercial" property="codigo" /></font>
							</div>
						</td>
			...
			<tr>
				<td height="17" colspan="1"><strong>Selecionar Imóveis Com Situação da Ligação Não Alterada por Débito:</strong></td>
				<td colspan="3">
				<strong> <html:radio property="ligacaoAlteradaDebito" tabindex="54"
					name="FiltrarComandosAcaoCobrancaEventualActionForm" value="Todos" /> Todos </strong>
				<strong> <html:radio property="ligacaoAlteradaDebito" tabindex="55"
					name="FiltrarComandosAcaoCobrancaEventualActionForm" value="Apenas" /> Apenas </strong>
				<strong> <html:radio property="ligacaoAlteradaDebito" tabindex="56"
					name="FiltrarComandosAcaoCobrancaEventualActionForm" value="Inclusive" />
				Inclusive</strong>
				<strong> <html:radio property="ligacaoAlteradaDebito" tabindex="57" 
					name="FiltrarComandosAcaoCobrancaEventualActionForm" value="NaoIncluir" />
				Não Incluir</strong></td>
			</tr>

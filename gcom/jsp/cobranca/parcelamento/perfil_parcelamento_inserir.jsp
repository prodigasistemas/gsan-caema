...
<script language="JavaScript"><!--
	 ...
	 function InteiroZeroPositivoValidations () {
	     ...
	     this.ae = new Array("quantidadeEconomias", "Qtde. de Economias deve somente conter números positivos ou zero.", new Function ("varName", " return this[varName];"));
	     this.af = new Array("percentualEntradaSugerida", "Percentual Entrada Sugerida deve somente conter números positivos ou zero.", new Function ("varName", " return this[varName];"));
	 }
		...
		<td valign="top" class="centercoltext">
			...
			<table width="100%" border="0">
				...
				<tr>
              	...
              	<tr> 
                	<td><strong> Percentual de Desconto sobre os Acréscimos por Impontualidade:</strong><font color="#FF0000">*</font></td>
                	<td>

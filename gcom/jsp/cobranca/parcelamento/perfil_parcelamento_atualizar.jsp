 ...
 function validaCaracterEspeciaisInteger(form) {                                                                   
	...
	function validarForm(form){
		if(validateAtualizarParcelamentoPerfilActionForm(form)){
			...
			if(form.percentualDescontoAcrescimoPagamentoAVista.value == ""){
				alert("Informe Percentual de Desconto sobre os Acréscimos por Impontualidade para pagamento à vista.");
				return;
			}
...
<body leftmargin="0" topmargin="0"
	onload="setarFoco('${requestScope.nomeCampo}');bloquearCampo('1');bloquearCampo('2');bloquearCampoParcelaMinima();">
		...
		<tr>
			...
			<table width="100%" border="0">
				...
				<tr>
					...
					Impontualidade:</strong><font color="#FF0000">*</font></td>
					<td>
					<logic:equal name="readOnly" value="true">
						<html:text property="percentualDescontoAcrescimo" size="6"
				...
				<tr> 
					<td><strong>O percentual de desconto a ser utilizado para pagamento à vista leva em consideração o valor do débito no período: <font color="#FF0000">*</font></strong></td>
					<td>
						<strong>
				...
				<tr> 
					<td><strong>O percentual de desconto para pagamento parcelado levará em consideração o percentual da entrada? <font color="#FF0000">*</font></strong></td>
					<td>
						<strong>
				...
				<tr>
					...
					<td><logic:equal name="readOnly" value="true">
						<html:text property="percentualTarifaMinimaPrestacao" size="6" maxlength="6" tabindex="5"
							onkeyup="formataValorMonetario(this, 6)" style="text-align:right;" readonly="true" />
							
						&nbsp;<strong>, ou</strong>&nbsp;
                		&nbsp;<strong>Valor Fixo Parcela Mínima:<font color="#FF0000">*</font></strong>&nbsp;
					...
					<logic:notEqual name="readOnly" value="true">
						<html:text property="percentualTarifaMinimaPrestacao" size="6" maxlength="6" tabindex="5"
							onkeyup="formataValorMonetario(this, 6)" onkeypress="return isCampoNumerico(event);" style="text-align:right;" />
				...
				<tr> 
					<td><strong>Indicador de Desconto à vista de Débito de Parcelamento: <font color="#FF0000">*</font></strong></td>
					<td colspan="3">
						<strong>
							<html:radio property="indicadorDescontoVistaDebParcelado" value="1" tabindex="24"/>Sim
							<html:radio property="indicadorDescontoVistaDebParcelado" value="2" tabindex="25"/>N&atilde;o
						</strong>
					</td>
				</tr>

...
<%@ page import="gcom.cobranca.parcelamento.ParcelaEntradaDesconto" %>
...
<!-- Begin
	...
	function adicionarPercentualPorDesconto(form){
		redirecionarSubmit('exibirAdicionarPercentualDescontoPopupAction.do?primeiraVez=S');
	}
 ...
 function validateInserirPrestacoesParcelamentoPerfilActionForm(form) {                                                                   
   ...
   document.forms[0].target='';
	...
	function desabilitarCampos(){
		...
		var form = document.forms[0];
		if((form.indicadorVerificarMaiorValor[1].checked && form.indicadorMediaValorContas[1].checked && form.indicadorValorUltimaContaEmAtraso[1].checked)
			|| (form.indicadorVerificarMaiorValor[0].checked && form.indicadorMediaValorContas[1].checked && form.indicadorValorUltimaContaEmAtraso[1].checked)
			|| (form.indicadorVerificarMaiorValor[0].checked && form.indicadorMediaValorContas[0].checked && form.indicadorValorUltimaContaEmAtraso[1].checked)){
		...
		}else if(form.indicadorVerificarMaiorValor[0].checked && form.indicadorMediaValorContas[0].checked && form.indicadorValorUltimaContaEmAtraso[0].checked){
			form.percentualMinimoEntrada.disabled = false;
			form.adicionarPercentual.disabled = false;
		...
		}else if(form.indicadorVerificarMaiorValor[1].checked && form.indicadorMediaValorContas[0].checked && form.indicadorValorUltimaContaEmAtraso[0].checked){
		...
		}else if((form.indicadorVerificarMaiorValor[1].checked && form.indicadorMediaValorContas[1].checked && form.indicadorValorUltimaContaEmAtraso[0].checked)
				|| (form.indicadorVerificarMaiorValor[0].checked && form.indicadorMediaValorContas[1].checked && form.indicadorValorUltimaContaEmAtraso[0].checked)){
		...
		}else if(form.indicadorVerificarMaiorValor[1].checked && form.indicadorMediaValorContas[0].checked && form.indicadorValorUltimaContaEmAtraso[1].checked){
	...
	<table width="740" border="0" cellspacing="5" cellpadding="0">
		<tr>
			...
			<table width="100%" border="0">
				...
				<tr>
					<td colspan="6">
						...
						<tr bgcolor="#cbe5fe">
							...
							<table width="100%" border="0">
							<tr>
								<td><strong>Verificar Maior Valor: </strong></td>
								<td colspan="2">
									<html:radio property="indicadorVerificarMaiorValor" value="1" onclick="desabilitarCampos();" />SIM
									<html:radio property="indicadorVerificarMaiorValor" value="2" onclick="desabilitarCampos();" />NÃO
								</td>
							</tr>
							...
							<tr>
								...
								<logic:empty name="collectionParcelamentoFaixaValor">
									...
									<logic:notEqual name="readOnly" value="true">
										<td colspan="2">
											<html:radio property="indicadorMediaValorContas" value="1" onclick="desabilitarCampos();"/>SIM
											<html:radio property="indicadorMediaValorContas" value="2" onclick="desabilitarCampos();"/>NÃO
										</td>
									</logic:notEqual>
								</logic:empty>
							</tr>
							...
							<tr>
								...
								<logic:empty name="collectionParcelamentoFaixaValor">
									...
									<logic:notEqual name="readOnly" value="true">
										<td colspan="2">
											<html:radio property="indicadorValorUltimaContaEmAtraso" value="1" onclick="desabilitarCampos();"/>SIM
											<html:radio property="indicadorValorUltimaContaEmAtraso" value="2" onclick="desabilitarCampos();"/>NÃO
										</td>
									</logic:notEqual>
								</logic:empty>
							</tr>
				...
				<table width="100%" border="0">
					<tr>
						<td><strong> Percentual Por Desconto: </strong>
						</td>
						<logic:equal name="readOnly" value="true">
							<td align="right" colspan="5">
							<input name="botaoAdicionarPercentualPorDesconto" type="button"
								class="bottonRightCol" value="Adicionar" align="right"
						...
						<logic:notEqual name="readOnly" value="true">
							<td align="right" colspan="5">
								<input name="botaoAdicionarPercentualPorDesconto" type="button"
								class="bottonRightCol" value="Adicionar" align="right" tabindex="8"
								onclick="adicionarPercentualPorDesconto(document.forms[0]);" 
								/>
							</td>
						</logic:notEqual>
					</tr>
					...
					<div style="width: 100%; height: 80; overflow: auto;">
						<table width="100%" border="0" bgcolor="#90c7fc">
							<tr bgcolor="#90c7fc" height="18">
								...
								<td width="15%" align="center"><strong>%Entrada</strong></td>
								<td width="15%" align="center"><strong>%Desconto</strong></td>
								<td width="15%" align="center"><strong>Quant. Max Parcelas</strong></td>
								<td width="15%" align="center"><strong>Valor Mínimo Parcela</strong></td>
								<td width="15%" align="center"><strong>Quantidade de Meses</strong></td>
							</tr>									
							<logic:present name="collectionParcelaEntradaDesconto" scope="session">
								<%int cont = 1;%>
								<logic:iterate name="collectionParcelaEntradaDesconto" 
								id="parcelaEntradaDesconto"
								type="ParcelaEntradaDesconto"
								scope="session">
										<%cont = cont + 1;
											if (cont % 2 == 0) {%>
										<tr bgcolor="#FFFFFF">
											...
											<td width="6%">
												...
												<logic:notEqual name="readOnly" value="true">
													<div align="center"><font color="#333333"> <img width="14"
										             height="14" border="0"
										             src="<bean:message key="caminho.imagens"/>Error.gif"
		 								             onclick="javascript:document.forms[0].target='';if(confirm('Confirma remoção?')){redirecionarSubmit('removerPercentualDescontoAction.do?percentualEntrada=<bean:write name="parcelaEntradaDesconto" property="percentualEntrada"/>');}" />
										            </font></div>
												</logic:notEqual>
									       </td>
											
											<td width="15%" align="center">
												<div>${parcelaEntradaDesconto.percentualEntrada} &nbsp;</div>
											</td>
											
											<td width="15%" align="center">
												<div>${parcelaEntradaDesconto.percentualDesconto} &nbsp;</div>
											</td>
											
											<td width="15%" align="center">
												<div>${parcelaEntradaDesconto.quantidadeParcelas} &nbsp;</div>
											</td>
											
											<td width="15%" align="center">
												<div>${parcelaEntradaDesconto.valorMinimoParcela} &nbsp;</div>
											</td>
											
											<td width="15%" align="center">
												<div>${parcelaEntradaDesconto.quantidadeMeses} &nbsp;</div>
											</td>
					...
					<div style="width: 100%; height: 110; overflow: auto;">
						<table width="100%" border="0" bgcolor="#90c7fc">
							...
							<logic:present name="collectionParcelamentoQuantidadePrestacaoHelper">
								<%int cont1 = 1;%>
										<logic:iterate
											name="collectionParcelamentoQuantidadePrestacaoHelper"
											...
											<tr bgcolor="#cbe5fe">
												...
												<td width="6%"><logic:equal name="readOnly"
														value="true">
														<div align="center">
												...
												<td width="10%" align="center">
													<div>${parcelamentoQuantidadePrestacaoHelper.parcelamentoQuantidadePrestacao.quantidadeMaximaPrestacao}
														&nbsp;</div>
												</td>


												<td width="12%" align="center">
													<div>${parcelamentoQuantidadePrestacaoHelper.parcelamentoQuantidadePrestacao.quantidadeMaxPrestacaoEspecial}
														&nbsp;</div>
												</td>

												<td width="9%" align="center"><logic:equal
														name="readOnly" value="true">
														<input type="text" style="font-size: xx-small;" size="4"
															...
															value="" readonly="true" />
														<bean:write name="parcelamentoQuantidadePrestacaoHelper"
															property="parcelamentoQuantidadePrestacao.fatorQuantidadePrestacoes" />
													</logic:equal> <logic:notEqual name="readOnly" value="true">
														<input type="text" style="font-size: xx-small;" size="4"
															maxlength="3" align="center"
															name=<%="fatQtdPrest" + parcelamentoQuantidadePrestacaoHelper.getParcelamentoQuantidadePrestacao().getUltimaAlteracao().getTime()%>
												...
												<td width="10%" align="center"><logic:equal
													...
													<%}else{ %>
														...
														<input type="radio" align="center"
															name=<%="indMedVlCnta" + parcelamentoQuantidadePrestacaoHelper.getParcelamentoQuantidadePrestacao().getUltimaAlteracao().getTime()%>
															onclick="desabilitaPercentuaisTabela(this.value, <%="percMinEntrada" + parcelamentoQuantidadePrestacaoHelper.getParcelamentoQuantidadePrestacao().getUltimaAlteracao().getTime()%>, <%="percTarMinImovel" + parcelamentoQuantidadePrestacaoHelper.getParcelamentoQuantidadePrestacao().getUltimaAlteracao().getTime()%>,<%="indValorUltConta" + parcelamentoQuantidadePrestacaoHelper.getParcelamentoQuantidadePrestacao().getUltimaAlteracao().getTime()%>,<%="percVlReparcelado" + parcelamentoQuantidadePrestacaoHelper.getParcelamentoQuantidadePrestacao().getUltimaAlteracao().getTime()%>);"
															value="2" checked="true" disabled="true"
															onkeyup="desabilitaPercentuaisTabela(this.value, <%="percMinEntrada" + parcelamentoQuantidadePrestacaoHelper.getParcelamentoQuantidadePrestacao().getUltimaAlteracao().getTime()%>, <%="percTarMinImovel" + parcelamentoQuantidadePrestacaoHelper.getParcelamentoQuantidadePrestacao().getUltimaAlteracao().getTime()%>,<%="indValorUltConta" + parcelamentoQuantidadePrestacaoHelper.getParcelamentoQuantidadePrestacao().getUltimaAlteracao().getTime()%>,<%="percVlReparcelado" + parcelamentoQuantidadePrestacaoHelper.getParcelamentoQuantidadePrestacao().getUltimaAlteracao().getTime()%>);" />NÃO
												...
												<logic:notEqual name="readOnly" value="true">
													<td width="10%" align="center" onmouseover="this.T_BGCOLOR='whitesmoke';return escape('${parcelamentoQuantidadePrestacaoHelper.ligacoesAgua}');">
												...
												<td width="7%" align="center"><logic:equal
														...
														<input type="text"
															style="text-align: right; font-size: xx-small;" size="6"
															maxlength="6" align="center" disabled="true"
												...
												<td width="12%" align="center">
													...
													<logic:equal name="readOnly" value="true">
														...
														<logic:equal name="percentualValorReparceladoReadOnly"
															value="true">
															<input type="text"
																style="text-align: right; font-size: xx-small;" size="6"
																maxlength="6" align="center"
														...
														<logic:notEqual name="percentualValorReparceladoReadOnly"
															value="true">
															<% if((parcelamentoQuantidadePrestacaoHelper.getHabilitado().equals("1"))){%>
															<input type="text"
																style="text-align: right; font-size: xx-small;" size="6"
															...
															<input type="text"
																...
																maxlength="6" align="center"
																name=<%="percVlReparcelado" + parcelamentoQuantidadePrestacaoHelper.getParcelamentoQuantidadePrestacao().getUltimaAlteracao().getTime()%>
																value="" onkeyup="formataValorMonetario(this, 6);"
																style="text-align:right;"
																onkeypress="return isCampoNumerico(event);" />
															<% } %>
														</logic:notEqual>
													</logic:notEqual> <%}else{ %> <logic:equal name="readOnly" value="true">
														<input type="text"
															style="text-align: right; font-size: xx-small;" size="6"
															maxlength="6" align="center"
															name=<%="percVlReparcelado" + parcelamentoQuantidadePrestacaoHelper.getParcelamentoQuantidadePrestacao().getUltimaAlteracao().getTime()%>
												...
												<td width="10%" align="center"><logic:equal
														...
														<div align="center">
															<logic:notEmpty
																name="parcelamentoQuantidadePrestacaoHelper"
																property="collectionParcelamentoFaixaValor">
																<a
																	href="javascript:abrirPopupComSubmitLink(document.forms[0],'','',
																<%="" + parcelamentoQuantidadePrestacaoHelper.getParcelamentoQuantidadePrestacao().getQuantidadeMaximaPrestacao()%>);">Consultar</a>
															</logic:notEmpty>
															&nbsp;
														</div> 
												...
												<%}else{%>
												<logic:present
													name="${parcelamentoQuantidadePrestacaoHelper.parcelamentoQuantidadePrestacao}"
													property="percentualTarifaMinimaImovel">
												...
												<logic:present
													name="${parcelamentoQuantidadePrestacaoHelper.parcelamentoQuantidadePrestacao}"
													property="percentualMinimoEntrada">

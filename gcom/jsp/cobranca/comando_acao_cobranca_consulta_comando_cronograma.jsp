...
<%@ page import="gcom.cobranca.bean.CobrancaAcaoAtividadeCronogramaHelper" %>
...
<!-- Begin
	...
	function alterarDataPrevista() {
		abrirPopupComSubmit('exibirAlterarDataPrevistaEncerramentoComandoAcaoCobrancaPopupAction.do?tipoComando=1', 480, 300, 'cronograma');
	}
	
	function cancelarComandoAcaoCobranca() {
		botaoAvancarTelaEsperaComando('/gsan/cancelarComandoAcaoCobrancaAction.do?tipoComando=C');
	} 
...
<div id="formDiv">
<html:form action="/gerarRelatorioFiltrarComandoAcaoCobranca" 
		...
		<table height="100%">
			...
			<tr>
				...
				<table width="100%" align="center" bgcolor="#99CCFF">
					...
					<pg:pager isOffset="true" index="half-full" maxIndexPages="10"
						...
						<pg:param name="pg" />
						<pg:param name="q" />
						<logic:present name="colecaoCobrancaAcaoAtividadeCronogramaHelper"
							scope="session">
							<logic:iterate name="colecaoCobrancaAcaoAtividadeCronogramaHelper"
								id="cobrancaAcaoAtividadeCronogramaHelper" type="CobrancaAcaoAtividadeCronogramaHelper" >
								
								<bean:define id="cobrancaAcaoAtividadeCronograma" name="cobrancaAcaoAtividadeCronogramaHelper" 
									property="cobrancaAcaoAtividadeCronograma" type="CobrancaAcaoAtividadeCronograma" />	
								...
								<pg:item>
									...
									<tr bgcolor="#FFFFFF">
										...
										<div align="center">
											<logic:present name="possuiPermissao" scope="session">
												<% if(cobrancaAcaoAtividadeCronograma.getCobrancaAtividade().getId().equals(CobrancaAtividade.EMITIR) 
														&& cobrancaAcaoAtividadeCronograma.getRealizacao() != null
														&& cobrancaAcaoAtividadeCronogramaHelper.getDataRealizacao() == null) { %>
													<html:checkbox property="idsRegistros" value="${cobrancaAcaoAtividadeCronograma.id}" /> 
												<% } %>
											</logic:present>
										</div>
										</td>
			...
			<tr>
				<td colspan="3">
					...
					<logic:present name="possuiPermissao" scope="session">
						<input name="button" type="button" class="bottonRightCol"
							value="Alterar Data Prevista"
							onclick="javascript:alterarDataPrevista();"
							align="left" style="width: 160px;">
						
						<input name="button" type="button" class="bottonRightCol"
							value="Cancelar Comando de Cobrança"
							onclick="javascript:cancelarComandoAcaoCobranca();"
							align="left" style="width: 230px;">	
					</logic:present>
					<logic:notPresent name="possuiPermissao" scope="session">
						<input name="button" type="button" class="bottonRightCol"
							value="Alterar Data Prevista" disabled="disabled"
							align="left" style="width: 160px;">
						
						<input name="button" type="button" class="bottonRightCol"
							value="Cancelar Comando de Cobrança" disabled="disabled"
							align="left" style="width: 230px;">
					</logic:notPresent>
				</td>
				<td valign="top">

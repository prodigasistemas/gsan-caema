...
<!-- Begin
	...
	function totalizarOS(){
		...
		if(validarComandosSelecionados()){
			form.action="/gsan/exibirReabrirComandoAtividadeAcaoCobrancaAction.do?tipoConsulta=cronograma&totalizarOS=sim";
			form.submit();
		}
	}
	...
	function atualizar(){
		var form = document.forms[0];
		if(validarComandosSelecionados()){
			form.action="/gsan/reabrirComandoAtividadeAcaoCobrancaCronogramaAction.do";
			form.submit();
		}
	}
...
<html:form action="/reabrirComandoAtividadeAcaoCobrancaCronogramaAction.do"
		...
		<tr>
			...
			<table width="100%" border="0" align="center" cellpadding="0"
				...
				<tr>
					...
					<td class="parabg">Reabrir Comando de Ação de Cobrança de Cronograma</td>
			...
			<table width="100%" border="0" cellpadding="0"cellspacing="3">
				...
				<tr>
					...
					<table width="100%" align="center" bgcolor="#90c7fc" border="0">
						...
						<tr bordercolor="#79bbfd">
							<td colspan="5" bgcolor="#79bbfd" align="center"><strong>Comandos de Ação de Cobrança de Cronograma</strong></td>
						</tr>
						
						<logic:notEmpty name="colecaoHelperCronograma" scope="session">
						
						<tr>
							<%if (((Collection) session.getAttribute("colecaoHelperCronograma")).size() <= 5) {%>
								<td colspan="5" >
							<%} else { %>
							...
							<%} %>		
								<table>
									<tr bordercolor="#000000">
										...
										<div align="center" class="style9"><font color="#000000" style="font-size:9px" face="Verdana, Arial, Helvetica, sans-serif"> 
											<strong>Grupo de Cobrança</strong> </font></div>
										</td>
										<td width="13%" bgcolor="#90c7fc" align="center">
										<div align="center" class="style9"><font color="#000000" style="font-size:9px" face="Verdana, Arial, Helvetica, sans-serif"> 
											<strong>Referência da Cobrança</strong> </font></div>
										</td>
										<td width="36%" bgcolor="#90c7fc" align="center">
										<div align="center" class="style9"><font color="#000000" style="font-size:9px" face="Verdana, Arial, Helvetica, sans-serif"> 
								...
								<div style="width: 100%; height: 100%; overflow: auto;">
									<table width="100%">			
										<%String cor = "#cbe5fe";%>
										<logic:present name="colecaoHelperCronograma">
						
											<logic:iterate name="colecaoHelperCronograma" id="comandoAtividadeAcaoCobrancaHelper" indexId="ind">
												...
												<tr bgcolor="#cbe5fe">
													...
													<td width="15%">
														...
														<font color="#000000" style="font-size:9px" face="Verdana, Arial, Helvetica, sans-serif"> 
															<bean:write name="comandoAtividadeAcaoCobrancaHelper" property="grupoCobranca" />
														</font></div>
													</td>
													...
													<td width="15%">
														<div align="center" class="style9">
														<font color="#000000" style="font-size:9px" face="Verdana, Arial, Helvetica, sans-serif"> 
															<bean:write name="comandoAtividadeAcaoCobrancaHelper" property="referenciaCobranca" />
														</font></div>
													</td>
				...
				<tr>
					...
					<td colspan="5"><font color="#ff0000"> <input name="Submit22"
						...
						onclick="window.location.href='/gsan/exibirReabrirComandoAtividadeAcaoCobrancaAction.do?tipoConsulta=cronograma&desfazer=sim';" />
					...
					<input name="voltar" class="bottonRightCol" value="Voltar"
						type="button"
						onclick="window.location.href='/gsan/exibirFiltrarComandosAcaoCobrancaCronogramaReabrirAction.do?ultimoacesso=-1&situacaoComando=reabrir&tipoComando=Cronograma'" />	

...
function desfazer(){
 ...
 form.icOrdenarMaiorValor[0].checked = false;
 form.icOrdenarMaiorValor[1].checked = false;
 form.icValidarItem[0].checked = false;
 form.icValidarItem[1].checked = false;
 ...
 redirecionarSubmit('exibirInserirAcaoCobrancaAction.do');
}
		...
		<tr>
			...
			<table width="100%" border="0">
             ...
             <tr> 
                ...
                <td width="25%">
                    <html:select property="idTipoDocumentoGerado" tabindex="5" onchange="redirecionarSubmit('exibirInserirAcaoCobrancaAction.do');">
							<html:option value="">&nbsp;</html:option>
              ...
              <tr> 
                ...
                <table width="100%">
                 <tr>
                  ...
                  <td><html:radio property="icCompoeCronograma" value="1" tabindex="12"/> 
                    <strong>Sim</strong></td>
                  <td><html:radio property="icCompoeCronograma" value="2" tabindex="13"/> 
                      <strong>N&atilde;o</strong></td>
                 </tr>
                 <tr> 
                  <td width="45%"><strong>Ação Obrigatória:<font color="#FF0000"></font><font color="#FF0000">*</font></strong></td>
                  <td><html:radio property="icAcaoObrigatoria" value="1" tabindex="14"/> 
                      <strong>Sim</strong></td>
                  <td><html:radio property="icAcaoObrigatoria" value="2" tabindex="15"/> 
                      <strong>N&atilde;o</strong></td>
                 </tr>
                 <tr> 
                  <td width="45%"><strong>Pode ser Repetida no Ciclo:<font color="#FF0000"></font><font color="#FF0000">*</font></strong></td>
                  <td><html:radio property="icRepetidaCiclo" value="1" tabindex="16"/> 
                      <strong>Sim</strong></td>
                  <td><html:radio property="icRepetidaCiclo" value="2" tabindex="17"/> 
                      <strong>N&atilde;o</strong></td>
                 </tr>
                 <tr> 
                  <td width="45%"><strong>Provoca Suspensão de Abastecimento:<font color="#FF0000"></font><font color="#FF0000">*</font></strong></td>
                  <td><html:radio property="icSuspensaoAbastecimento" value="1" tabindex="18"/> 
                      <strong>Sim</strong></td>
                  <td><html:radio property="icSuspensaoAbastecimento" value="2" tabindex="19"/> 
                      <strong>N&atilde;o</strong></td>
                 </tr>
                 <tr> 
                  <td width="45%"><strong>Considera Débitos a Cobrar:<font color="#FF0000">*</font></strong></td>
                  <td><html:radio property="icDebitosACobrar" value="1" tabindex="20"/> 
                      <strong>Sim</strong></td>
                  <td><html:radio property="icDebitosACobrar" value="2" tabindex="21"/> 
                      <strong>N&atilde;o</strong></td>
                 </tr>
                 <tr> 
                  <td width="45%"><strong>Considera Créditos a Realizar:<font color="#FF0000">*</font></strong></td>
                  <td><html:radio property="icCreditosARealizar" value="1" tabindex="22"/> 
                      <strong>Sim</strong></td>
                  <td><html:radio property="icCreditosARealizar" value="2" tabindex="23"/> 
                      <strong>N&atilde;o</strong></td>
                 </tr>
                 <tr> 
                  <td width="45%"><strong>Considera Notas Promissória:<font color="#FF0000">*</font></strong></td>
                  <td><html:radio property="icNotasPromissoria" value="1" tabindex="24"/> 
                      <strong>Sim</strong></td>
                  <td><html:radio property="icNotasPromissoria" value="2" tabindex="25" /> 
                      <strong>N&atilde;o</strong></td>
                 </tr>         
                 <tr> 
                  <td width="45%"><strong>Considera Acréscimos por Impontualidade:<font color="#FF0000">*</font></strong></td>

                  <td><html:radio property="icAcrescimosImpontualidade" value="1" tabindex="26"/> 
                      <strong>Sim</strong></td>
                  <td><html:radio property="icAcrescimosImpontualidade" value="2" tabindex="27"/> 
                      <strong>N&atilde;o</strong></td>
                 </tr>
                 <tr> 
                  <td width="45%"><strong>Gera Taxa:<font color="#FF0000">*</font></strong></td>

                  <td><html:radio property="icGeraTaxa" value="1" tabindex="28"/> 
                      <strong>Sim</strong></td>
                  <td><html:radio property="icGeraTaxa" value="2" tabindex="29"/> 
                      <strong>N&atilde;o</strong></td>
                 </tr>
                 <tr> 
                  <td width="45%"><strong>Pode Emitir Boletins de Cadastro:<font color="#FF0000">*</font></strong></td>

                  <td><html:radio property="icEmitirBoletimCadastro" value="1" tabindex="30"/> 
                      <strong>Sim</strong></td>
                  <td><html:radio property="icEmitirBoletimCadastro" value="2" tabindex="31"/> 
                      <strong>N&atilde;o</strong></td>
                 </tr>
                 <tr> 
                  <td width="45%"><strong>Pode ser Executada para Imóveis sem D&eacute;bito:<font color="#FF0000">*</font></strong></td>

                  <td><html:radio property="icImoveisSemDebitos" value="1" tabindex="32"/> 
                      <strong>Sim</strong></td>
                  <td><html:radio property="icImoveisSemDebitos" value="2" tabindex="33"/> 
                      <strong>N&atilde;o</strong></td>
                 </tr>
                 <tr>
	                 <td width="45%"><strong>Usa Metas no Cronograma:<font color="#FF0000">*</font></strong></td>
	
	                  <td><html:radio property="icMetasCronograma" value="1" tabindex="34"/> 
	                      <strong>Sim</strong></td>
	                  <td><html:radio property="icMetasCronograma" value="2" tabindex="35"/> 
	                      <strong>N&atilde;o</strong></td>
                 </tr>
                 <tr>
	             ...
	             <tr>
						...
						<td><html:radio property="icOrdenamentoCronograma" value="1" tabindex="36"/> 
		                     <strong>Sim</strong></td>
		                <td><html:radio property="icOrdenamentoCronograma" value="2" tabindex="37"/> 
		                     <strong>N&atilde;o</strong></td>
		        </tr>
		         <tr>
		                ...
		                <td><html:radio property="icOrdenamentoEventual" value="1" tabindex="38"/> 
		                      <strong>Sim</strong></td>
		                 <td><html:radio property="icOrdenamentoEventual" value="2" tabindex="39"/> 
		                      <strong>N&atilde;o</strong></td>
		        </tr>
                <tr>
	                 <td width="45%"><strong>Situa&ccedil;&atilde;o do D&eacute;bito Interfere na Situa&ccedil;&atilde;o da A&ccedil;&atilde;o:<font color="#FF0000">*</font></strong></td>
	                  ...
	                  <td><html:radio property="icDebitoInterfereAcao" value="1" tabindex="40"/> 
	                      <strong>Sim</strong></td>
	                  <td><html:radio property="icDebitoInterfereAcao" value="2" tabindex="41"/> 
	                      <strong>N&atilde;o</strong></td>
                 </tr>
                 <tr> 
                ...
                <tr>
	                 <td width="45%"><strong>Seleção ordenando por valor decrescente:<font color="#FF0000">*</font></strong></td>
	                  ...
	                  <td><html:radio property="icOrdenarMaiorValor" value="1" tabindex="40"/> 
	                      <strong>Sim</strong></td>
	                  <td><html:radio property="icOrdenarMaiorValor" value="2" tabindex="41"/> 
	                      <strong>N&atilde;o</strong></td>
                 </tr>
                <tr>

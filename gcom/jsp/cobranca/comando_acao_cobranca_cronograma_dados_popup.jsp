...
function cancelarDocumentos(idCobrancaAcaoAtividadeCronograma){

	var form = document.forms[0];

	if (confirm('Confirma remoção?')){

		form.action =  '/gsan/cancelarDocumentosCobrancaAction.do?idCobrancaAcaoAtividadeCronograma=' + idCobrancaAcaoAtividadeCronograma;
		submitForm(form);
	}
		...
		<table width="100%" border="0">
			<tr>
				...
				<table width="100%" border="0">
					...
					<tr>
						<td width="150" height="24"><strong><strong>Grupo de Cobran&ccedil;a:</strong></strong></td>
					...
					<tr>
						<td height="24"><strong>Data Prevista de Encerramento:</strong></td>
						<td colspan="3"><strong><strong> 
						<html:text maxlength="10" readonly="true" style="background-color:#EFEFEF; border:0; color: #000000"
					name="ExibirResultadoConsultarComandosAcaoCobrancaCronogramaDadosComandoActionForm"
					property="dataPrevistaEncerramento" size="10"/> 
						<strong> </strong> </strong></strong></td>
					</tr>
					<tr>
						<td height="24" colspan="4">
					...
					<tr>
					    <logic:present name="emitir">
							...
							<div align="left"><input name="Button2" type="button"
								...
								onclick="cancelarDocumentos(${cobrancaAcaoAtividadeCronograma.id})"/>							
							</div> 
							</td>
						...
						<td height="27" colspan="2" align ="right">
							...
							<logic:present name="permissaoEmitir">
							 ...
							 <input name="Button2" type="button"
								...
								onclick="window.location.href='<html:rewrite page="/gerarRelatorioComandoDocumentoCobrancaAction.do?idCobrancaAcaoAtividadeCronograma=${cobrancaAcaoAtividadeCronograma.id}"/>'"/>

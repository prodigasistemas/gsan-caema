		...
		<td width="625" valign="top" class="centercoltext">
            ...
            <table width="100%" border="0">
								...
								<td>
									<logic:present name="clienteInexistente" scope="request">
										...
										<html:text property="cpfClienteParcelamento" size="14" maxlength="14" 
											...
											<input type="text" name="cpfInexistente" value="" 
											style="background-color:#cbe5fe; border:0; color: #FF0000"
											onkeypress="return isCampoNumerico(event);" >
									</logic:present> 
				...
				<tr> 
					...
					<td><br>
						<html:text property="dataParcelamento" size="10" maxlength="10" tabindex="2" 
						onkeyup="mascaraData(document.forms[0].dataParcelamento,this)"
						onkeypress="return isCampoNumerico(event);"/>
				...
				<tr> 
					...
					<td>
						<logic:present name="colecaoResolucaoDiretoria" scope="session">
						...
						<logic:notPresent name="colecaoResolucaoDiretoria" scope="session">
							<html:select property="resolucaoDiretoria">
								<html:option value="">&nbsp;</html:option>
							</html:select>
						</logic:notPresent>
				...
				<tr> 
					...
					<logic:notPresent name="bloqueiaIntervaloParcelamento" scope="session">
						<html:text property="inicioIntervaloParcelamento" 
						onkeyup="mascaraAnoMes(document.forms[0].inicioIntervaloParcelamento,this)" maxlength="7" size="7"
						onkeypress="return isCampoNumerico(event);"/>
							a 
						<logic:empty name="EfetuarParcelamentoDebitosActionForm" property="inicioIntervaloParcelamento">
						  <html:text property="fimIntervaloParcelamento" 
						  onkeyup="mascaraAnoMes(document.forms[0].fimIntervaloParcelamento,this)"
						  onkeypress="return isCampoNumerico(event);" maxlength="7" size="7" readonly="true"/>
						</logic:empty>
						<logic:notEmpty name="EfetuarParcelamentoDebitosActionForm" property="inicioIntervaloParcelamento">
						  <html:text property="fimIntervaloParcelamento"
						   onkeyup="mascaraAnoMes(document.forms[0].fimIntervaloParcelamento,this)"
						   onkeypress="return isCampoNumerico(event);" maxlength="7" size="7"/>
						</logic:notEmpty>
					</logic:notPresent>
					...
					<logic:present name="bloqueiaIntervaloParcelamento" scope="session">
						<logic:equal name="bloqueiaIntervaloParcelamento" scope="session" value="nao">
							<html:text property="inicioIntervaloParcelamento" 
							onkeyup="mascaraAnoMes(document.forms[0].inicioIntervaloParcelamento,this)" 
							onkeypress="return isCampoNumerico(event);" maxlength="7" size="7"/>
							a 
							<logic:empty name="EfetuarParcelamentoDebitosActionForm" property="inicioIntervaloParcelamento">
							  <html:text property="fimIntervaloParcelamento" 

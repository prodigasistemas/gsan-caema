	...
	<table width="770" border="0" cellspacing="5" cellpadding="0">
		<tr>
			...
			<table width="100%" border="0">
				...
				<tr>
					<td><strong>Faturar "Tarifa Social"?</strong></td>
					<td>
						<html:radio property="indicadorCobrarConsumoMinimo" tabindex="5" value="1" /><strong>Sim</strong> 
						<html:radio property="indicadorCobrarConsumoMinimo" tabindex="7" value="2" /><strong>Não</strong>
						<html:radio property="indicadorCobrarConsumoMinimo" tabindex="8" value="" /><strong>Todos</strong></td>
					</td>
				</tr>

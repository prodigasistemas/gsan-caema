...
<%@page import="gcom.faturamento.contratodemanda.ContratoDemandaComercialIndustrial"%>
		...
		<tr>
						...
						<pg:pager isOffset="true" index="half-full" maxIndexPages="10"
							...
							<logic:present name="colecaoContratoDemanda">
								...
								<logic:iterate name="colecaoContratoDemanda"
									id="contratoDemanda" type="ContratoDemandaComercialIndustrial">
									<pg:item>
										<%cont = cont + 1;
			if (cont % 2 == 0) {%>
										<tr bgcolor="#cbe5fe">
			...
			%>
										<tr bgcolor="#FFFFFF">
											...
											<logic:empty name="contratoDemanda" property="dataContratoEncerrado">
											...
											<logic:notEmpty name="contratoDemanda" property="dataContratoEncerrado">
											...
											<td width="25%" align="center"><logic:notEmpty
												name="contratoDemanda" property="dataContratoEncerrado">
												<bean:write name="contratoDemanda"
													property="dataContratoEncerrado" formatKey="date.format" />
											</logic:notEmpty>&nbsp;</td>
										</tr>
									</pg:item>
								</logic:iterate>

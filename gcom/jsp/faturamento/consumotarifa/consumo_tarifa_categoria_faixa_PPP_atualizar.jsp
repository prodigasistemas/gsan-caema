...
<link rel="stylesheet"
	...
	type="text/css">
<script language="JavaScript" src="<bean:message key="caminho.js"/>validacao/regras_validator.js"></script><html:javascript staticJavascript="false"  formName="AtualizarCategoriaFaixaConsumoTarifaPPPActionForm" />
...
<script language="JavaScript">
	function ValidarForm(){
		var formRed = "/gsan/atualizarCategoriaFaixaConsumoTarifaPPPAction.do";
...
<html:form action="/atualizarCategoriaFaixaConsumoTarifaPPPAction"
	name="AtualizarCategoriaFaixaConsumoTarifaPPPActionForm"
	onsubmit="return validateAtualizarCategoriaFaixaConsumoTarifaPPPActionForm(this);"
		...
		<tr>
			...
			<table width="100%" border="0" align="center" cellpadding="0"
				...
				<tr>
					...
					<td class="parabg">Informar Faixa de Consumo PPP</td>
					<td width="11"><img border="0"
			...
			<table width="100%" border="0">
				...
				<tr>
					...
					<div align="right"><input name="Button" type="button"
						class="bottonRightCol" value="Inserir" onClick="javascript:if(validateAtualizarCategoriaFaixaConsumoTarifaPPPActionForm(document.forms[0])){document.forms[0].submit();}""> <input
						name="Button2" type="button" class="bottonRightCol" value="Fechar"
						onClick="javascript:window.location.href='/gsan/exibirAtualizarCategoriaConsumoTarifaPPPAction.do';"></div>
					</td>
				</tr>
			</table>
			<p>&nbsp;</p>

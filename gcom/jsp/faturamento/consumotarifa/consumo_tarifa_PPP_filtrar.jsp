...
<script language="JavaScript" src="<bean:message key="caminho.js"/>validacao/regras_validator.js"></script><html:javascript staticJavascript="false"  formName="FiltrarConsumoTarifaPPPActionForm" />
<link rel="stylesheet"
...
<script>
 ...
 function chamarFiltrar(){
  	var form = document.FiltrarConsumoTarifaPPPActionForm;
  	
  	if(validateFiltrarConsumoTarifaPPPActionForm(form)){
	    form.action = 'filtrarConsumoTarifaPPPAction.do'
	   	form.submit();  	
	}
 }
...
<html:form action="/filtrarConsumoTarifaPPPAction"
	name="FiltrarConsumoTarifaPPPActionForm"
		...
		<tr>
			...
			<table width="100%" border="0" align="center" cellpadding="0"
				...
				<tr>
					...
					<td class="parabg">Filtrar Tarifa de Consumo PPP</td>
					<td width="11"><img border="0"
			...
			<table width="100%">
				<tr>
					<td>Para manter a(s) tarifa(s) de consumo PPP, informe os
					dados abaixo:</td>
				</tr>
			</table>	
			<table  width="100%">
				...
				<tr>
					...
					<a
						href="javascript:abrirCalendario('FiltrarConsumoTarifaPPPActionForm', 'dataVigencia')">
					<img border="0"
					...
					<a
						href="javascript:abrirCalendario('FiltrarConsumoTarifaPPPActionForm', 'dataVigenciaFim')">
					<img border="0"
						src="<bean:message key="caminho.imagens"/>calendario.gif"

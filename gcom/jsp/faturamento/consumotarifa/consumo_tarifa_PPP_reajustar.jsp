...
<link rel="stylesheet"
	...
	type="text/css">
<script language="JavaScript" src="<bean:message key="caminho.js"/>validacao/regras_validator.js"></script><html:javascript staticJavascript="false"  formName="InserirReajusteConsumoTarifaPPPActionForm" />
...
<script>
	...
	function validarForm(){
	    var form = document.InserirReajusteConsumoTarifaPPPActionForm;
...
<body>
<html:form action="/inserirReajusteConsumoTarifaPPPAction"
	name="InserirReajusteConsumoTarifaPPPActionForm"
	onsubmit="return validateInserirReajusteConsumoTarifaPPPActionForm(this);"
		...
		<tr>
			...
			<table width="100%" border="0" align="center" cellpadding="0"
				...
				<tr>
					...
					<td class="parabg">Reajustar Tarifa de Consumo PPP</td>
					<td width="11"><img border="0"
			...
			<table border="0" width="100%">
				<tr>
					...
					<td colspan="3"><html:text maxlength="10" property="dataVigencia"
						...
						href="javascript:abrirCalendario('InserirReajusteConsumoTarifaPPPActionForm', 'dataVigencia')">
					<img border="0"

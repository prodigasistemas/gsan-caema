...
function facilitador(objeto){
 ...
 function novoFiltro(){
	var formRed = "/gsan/exibirFiltrarConsumoTarifaPPPAction.do";
 	...
 	function validarForm(objeto){ 
	   ...
	   var acumulador = 0;
    	...
    	for(indice = 0; indice < formulario.elements.length; indice++){
  		...
  		abrirPopup('/gsan/exibirInserirReajusteConsumoTarifaPPPAction.do?id_r=' + ids, 500, 610);
	...
	function  remover(){
		if(CheckboxNaoVazio(document.ManutencaoRegistroActionForm.idRegistrosRemocao) && confirm('Confirma remoção?')){
    		...
    		form.action = "removerConsumoTarifaPPPAction.do";
	    	form.submit()	
	    }
	}  	
...
<html:form action="/removerConsumoTarifaPPPAction"
		...
		<tr>
			...
			<table width="100%" border="0" align="center" cellpadding="0"
				...
				<tr>
					...
					<td class="parabg">Manter Tarifa de Consumo PPP</td>
					<td width="11"><img border="0"
			...
			<table width="100%">
				<tr>
					...
					de consumo PPP encontradas:</strong></font></td>
					</tr>
					</table>
				...
				cor = "#cbe5fe";%>
										<tr bgcolor="#cbe5fe">
											...
											<td align="left">
											<a
												href="/gsan/exibirAtualizarConsumoTarifaPPPAction.do?idVigencia=<bean:write name="vigenciaF" property="id"/>"><bean:write
												name="vigenciaF" property="consumoTarifaPpp.descricao" /></a></td>
				...
				<td>
					<gsan:controleAcessoBotao name="Button2" value="Reajustar"
							  onclick="javascript:validarForm(idRegistrosRemocao);" url="inserirReajusteConsumoTarifaPPPAction.do"/>
					...
					<gsan:controleAcessoBotao name="Button" value="Remover"
							  onclick="javascript:remover();" url="removerConsumoTarifaPPPAction.do"/>
					<!--<html:button

...
</script><html:javascript staticJavascript="false"  formName="AtualizarCategoriaConsumoTarifaPPPActionForm" />
...
<script>
	...
	function redirecionaForm(){
		var formRed = "/gsan/atualizarConsumoTarifaPPPAction.do";
			redirecionarSubmit(formRed);
	}
	
	function validaForm(){
		var form = document.AtualizarCategoriaConsumoTarifaPPPActionForm;
		if(validateCaracterEspecial(form) && 
			validateRequired(form) && 
			validateInteger(form) && 
			validateDecimal(form)){
			
			referencia = '/gsan/exibirAtualizarCategoriaFaixaConsumoTarifaPPPAction.do?limpaFaixa=1&parametro1='
...
<logic:equal name="testeInserir" value="true" scope="request">
	<body leftmargin="0" topmargin="0"
		onload="chamarReload('exibirAtualizarConsumoTarifaPPPAction.do');window.close();">
</logic:equal>
<body leftmargin="0" topmargin="0"
	onload="resizePageSemLink(640,400); setarFoco('${requestScope.slcCategoria}');">

<html:form action="/atualizarCategoriaConsumoTarifaPPPAction"
	name="AtualizarCategoriaConsumoTarifaPPPActionForm"
	onsubmit="return validateAtualizarCategoriaConsumoTarifaPPPActionForm(this);"
		...
		<tr>
			...
			<table width="100%" border="0" align="center" cellpadding="0"
				...
				<tr>
					...
					<td class="parabg">Informar Categoria PPP</td>
					<td width="11"><img border="0"
			...
			<table width="100%" border="0">
				...
				<tr>
					...
					<td colspan="3"><c:if
						test="${empty AtualizarCategoriaConsumoTarifaPPPActionForm.slcCategoria}"
						var="formVazio">
				...
				<tr>
					...
					<td align="right" width="13%" height="25"><input type="button"
						name="adicionar2" class="bottonRightCol" value="Adicionar" disabled="true"
				...
				<tr>
					...
					<div align="right"><input type="hidden" name="testeInserir"> <input
						name="Button" type="button" class="bottonRightCol" value="Inserir" disabled="true"

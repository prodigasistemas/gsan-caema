...
<script language="JavaScript">
	function ValidarForm(){
		...
		if(validateInserirCategoriaFaixaConsumoTarifaActionForm(form)){
...
<logic:equal name="testeInserir" value="false" scope="request">
	<body leftmargin="0" topmargin="0"
		onload="resizePageSemLink(620,305); setarFoco('${requestScope.limiteSuperiorFaixa}');">
</logic:equal>
	...
	<table width="600" border="0" cellpadding="0" cellspacing="5">
		<tr>
			...
			<table width="100%" border="0">
				...
				<tr>
					<td>
					<div align="left"><input name="Button2" type="button" class="bottonRightCol"
						value="Voltar"
						onClick="javascript:window.location.href='/gsan/exibirInserirCategoriaConsumoTarifaAction.do';"></div></td> 
					<td width="40%">&nbsp;</td>

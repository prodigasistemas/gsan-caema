...
function validarForm(form){
	if (validateSituacaoEspecialFaturamentoActionForm(form) && validarConsumoVolume(form)){
	    ...
	    if(confirm("Confirma a possivel inserção da situação especial de faturamento para " + form.quantidadeImoveisSEMSituacaoEspecialFaturamento.value + " imóvel(eis) ?")){

		...
		<tr>
			...
			<table width="100%" border="0">
				...
				<tr>
					...
					<html:radio property="indicadorCobrarConsumoMinimo" tabindex="3" value="2" /><strong>Não</strong>
					</td>
					<td>&nbsp;</td>
				</tr>
				...
				<tr>
					...
					<html:radio property="indicadorDesconsiderarEstouroAltoConsumo" tabindex="3" value="2" /><strong>Não</strong>
					</td>
					<td>&nbsp;</td>
				</tr>
				<!-- Fim RM 5981 -->

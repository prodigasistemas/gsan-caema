...
<logic:present name="reloadPage">
	...
	<logic:equal name="reloadPageURL" value="INFDADOSVALORPAGINDEV">
		<body leftmargin="0" topmargin="0" onload="window.focus(); resizePageSemLink(550, 270); chamarSubmitComUrl('exibirInformarDadosDevValorFatPagoIndevAction.do?idImovel=${requestScope.idImovel}&idPagamento=${requestScope.idPagamento}&idDocumento=${requestScope.idDocumento}&reloadPage=ok'); window.close();">
	</logic:equal>

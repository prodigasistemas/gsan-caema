...
function validarForm(form){
	...
	var msg = "";
 	...
 	if(form.banco.value != '' && form.banco.value != '-1'){
 		botaoAvancarTelaEspera('/gsan/filtrarImovelInserirManterContaAction.do');
 		//form.submit(); 	
 	}else{
...
function bloquearLSQLS(){
	...
	if(form.codigoCliente.value != "" ){
		...
		form.perfilImovel.disabled = false;  
	}
}
			...
			<table width="100%" border="0">
				<tr>
					...
					<html:text property="codigoClienteSuperior"
						...
						onkeyup="bloquearLSQLS();verificarBotao();" /> 
				...
				<tr>
					<td height="22" colspan="4">Informe os dados do imóvel:</td>
				</tr>
				<tr>
					<td width="125"><strong>Imóvel: </strong></td>
					<td colspan="3">
						<html:text  property="idImovel" 
									maxlength="9"
									size="9"
									onkeypress="validaEnterComMensagem(event, 'exibirFiltrarImovelInserirManterContaAction.do','idImovel','Imóvel');return isCampoNumerico(event);" /> 
										<a href="javascript:abrirPopup('exibirPesquisarImovelAction.do', 400, 800);"> 
										   <img width="23" height="21" 
										   		src="<bean:message key='caminho.imagens'/>pesquisa.gif" 
										   		border="0" title="Pesquisar Imóvel"/>
										</a>
						...
						<logic:notPresent name="corImovel">
							<logic:empty name="FiltrarImovelContaActionForm"
								property="idImovel">
								<html:text property="inscricaoImovel" size="38" value=""
									readonly="true"
									style="background-color:#EFEFEF; border:0; color: #ff0000" />
							</logic:empty>
							<logic:notEmpty name="FiltrarImovelContaActionForm"
				...
				<tr> 
	                ...
	                <td colspan="6"><span class="style2"><strong>
						<html:select property="categoria" style="width: 350px; height:100px;" multiple="true">
							<html:option value="<%=""+ConstantesSistema.NUMERO_NAO_INFORMADO%>">&nbsp;</html:option>
				...
				<tr>
					...
					<td colspan="2">
						<html:text maxlength="4" 
								   ...
								   size="4" 
								   tabindex="3" 
								   onkeypress="limpar(12);return isCampoNumerico(event);"
			...
			&nbsp; </td>
				...
				<tr>
					...
					<html:text  maxlength="3"
								...
								size="3" 
								tabindex="6"
								onkeypress="validaEnterComMensagem(event, 'exibirFiltrarImovelInserirManterContaAction.do?objetoConsulta=1&inscricaoTipo=destino','localidadeDestinoID','Código da localidade de destino');return isCampoNumerico(event);limpar(13);" /> 
								<a href="javascript:chamarPopup('exibirPesquisarLocalidadeAction.do?indicadorUsoTodos=1', 'destino', null, null, 275, 480, '');"><img src="<bean:message key="caminho.imagens"/>pesquisa.gif" 
									    border="0"
										width="23" 
										height="21" 
					...
					<a href="javascript:limparLocalidade(2);"><img src="<bean:message key="caminho.imagens"/>limparcampo.gif"
							 border="0" 
							 title="Apagar" /> 
					</a>
					</td>
							...
							<table width="100%" border="0">
								<tr>
									...
									<td><html:text  maxlength="4" 
													...
													size="5" tabindex="12"
													onkeyup="replicaDados(document.forms[0].codigoRotaOrigem, document.forms[0].codigoRotaDestino);bloquearLSQLS();verificarBotao();"
								...
								<tr>
									...
									<td><html:text  maxlength="6" 
													...
													size="7" 
													tabindex="13"
													onkeyup="replicaDados(document.forms[0].sequencialRotaOrigem, document.forms[0].sequencialRotaDestino);bloquearLSQLS();verificarBotao();" 
													onkeypress="return isCampoNumerico(event);"/>
									</td>
								</tr>

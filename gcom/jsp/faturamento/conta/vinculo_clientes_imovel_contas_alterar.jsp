	...
	<table width="770" border="0" cellspacing="5" cellpadding="0">
		<tr>
			...
			<table border="0" width="100%" cellpadding="0" cellspacing="0" >
				<tr>
					...
					<td width="75%"><html:text maxlength="9"
						...
						onkeyup="javascript:return validaEnterComMensagem(event, 'exibirAlterarVinculoClientesImovelContasAction.do?pesquisar=1', 'idImovel', 'Imóvel');" />
					<a
			...
			<table border="0" width="100%" cellpadding="0" cellspacing="0" >
				...
				<tr>
					...
					<td><html:text
						name="ExibirAlterarVinculoClientesImovelContasActionForm"
							...
							onkeypress="return isCampoNumerico(event);"
							onkeyup="mascaraData(this, event);duplicaDataInicioRelacao(document.forms[0]);" />&nbsp;dd/mm/aaaa
					</td>
				</tr>
				<tr>
				...
				<tr>
					<td><strong>Nome da Conta<font color="#FF0000">*</font></strong></td>
					<td>
				                        ...
				                        <%}%>
				                            ...
				                            <td width="10%" align="center"> 
				                            	<input name="dataInicioRelacao_<%= cont %>" onkeyup="mascaraData(this, event);" style="text-align:right;"
													onkeypress="javascript:return isCampoNumerico(event);" size="10" maxlength="10" type="text"

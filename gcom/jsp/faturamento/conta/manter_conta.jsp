...
function recuperarDadosPopup(codigoRegistro, descricaoRegistro, tipoConsulta) {
 ...
 function limparForm(){
	...
	redirecionarSubmit("exibirManterContaAction.do?menu=sim");
 }
										...
										<logic:iterate name="colecaoContaImovel" id="conta" type="Conta">
												...
												%>
													...
													<td width="10%" align="center">
														...
														<logic:equal name="imovelContratoDemanda" value="false" >
														...
														<logic:equal name="imovelContratoDemanda" value="true">
															...
															<logic:equal name="usuarioPodeAtualizarRetificarContasPagas" value="true" >
																...
																%>
																	<logic:equal name="usuarioPodeRetificarContaContratoDemanda" value="true" >
																		<a href="javascript:retificar('<%="" + conta.getId().intValue()%>')">
																		<%=""+ Util.formatarMesAnoReferencia(conta.getReferencia())%> </a>
																	</logic:equal>
																	
																	<logic:equal name="usuarioPodeRetificarContaContratoDemanda" value="false" >
																		<%= ""+ Util.formatarMesAnoReferencia(conta.getReferencia()) %>
																	</logic:equal>

...
<!--
  ...
  function validarForm(form){
	...
	urlRedirect = "/gsan/pesquisarContaRetificacaoAction.do"
	  ...
	  <table width="100%" border="0">
        ...
        <tr> 
		  ...
		  <logic:present name="situacaoConta"> 
		  	<logic:notPresent name="tipoSituacao">
			  	<html:select property="idSituacaoConta" multiple="true">
	              <html:option value="-1">&nbsp;</html:option> 
	              <html:option value="2">INCLUIDA</html:option> 
	              <html:option value="0">NORMAL</html:option> 
	              <html:option value="1">RETIFICADA</html:option> 
	            </html:select>
	      	</logic:notPresent>
	      	
	      	<logic:present name="tipoSituacao">
	      		<html:select property="idSituacaoConta" multiple="true">	
	      			<html:option value="-1">&nbsp;</html:option>
	      			<html:option value="5">PARCELADA</html:option>	
	      			<html:option value="7">ENTRADA DE PARCELAMENTO</html:option>
	      		</html:select>
	      	</logic:present>

...
<script>
	...
	function InteiroZeroPositivoValidations () {
		...
		this.at = new Array("quantidadeColiformesTermotolerantesExigidas", "Quantidade Coliformes E. COLI Exigidas deve somente conter números positivos.", new Function ("varName", " return this[varName];"));
		this.au = new Array("quantidadeColiformesTermotolerantesAnalisadas", "Quantidade Coliformes E. COLI Analisadas deve somente conter números positivos.", new Function ("varName", " return this[varName];"));
		this.av = new Array("quantidadeColiformesTermotolerantesConforme", "Quantidade Coliformes E. COLI Conforme deve somente conter números positivos.", new Function ("varName", " return this[varName];"));
	...
	function caracteresespeciais () {
		...
		this.at = new Array("quantidadeColiformesTermotolerantesExigidas", "Quantidade Coliformes E. COLI Exigidas possui caracteres especiais.", new Function ("varName", " return this[varName];"));
		this.au = new Array("quantidadeColiformesTermotolerantesAnalisadas", "Quantidade Coliformes E. COLI Analisadas possui caracteres especiais.", new Function ("varName", " return this[varName];"));
		this.av = new Array("quantidadeColiformesTermotolerantesConforme", "Quantidade Coliformes E. COLI Conforme possui caracteres especiais.", new Function ("varName", " return this[varName];"));
				...
				<logic:present name="desabilitaCampos">
					...
					<tr>
						...
						<table width="100%" align="center" bgcolor="#99CCFF">
							...
							<tr bgcolor="#cbe5fe">
								<td width="25%"><strong>Quantidade Coliformes E. COLI :</strong></td>
								<td width="25%" align="center"><html:text

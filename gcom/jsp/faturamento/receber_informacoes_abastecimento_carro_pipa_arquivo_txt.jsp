...
<form action="/gsan/receberInformacoesAbastecimentoCarroPipaArquivoTxtAction.do"
...
<table width="770" border="0" cellspacing="5" cellpadding="0">
	<tr>
		...
		<table width="100%" border="0" align="center" cellpadding="0"
			...
			<tr>
				<td width="11"><img border="0" src="imagens/parahead_left.gif" /></td>
					<td class="parabg">Receber Informações Abastecimento Carro-Pipa Arquivo Txt</td>
		...
		<table width="100%" border="0">
			<tr>
				<td colspan="2">Para receber Informações Abastecimento Carro-Pipa Arquivo Txt, informe
					os dados abaixo:</td>
			</tr>

		...
		<script type="text/javascript">
			$(document).ready(function(){
				...
				$('#emailConfirmado').click(function(){
					window.location = '/gsan/exibirServicosPortalCompesaAction.do?menu=sim';
				});
			...
			function enviarConfirmacao(){
				...
				if (enviarEmailConfirmacao == "OK"){
					...
					if (confirm("Confirma alteração do cadastro de email do cliente? ")) {
						...
						form.action = "/gsan/inserirCadastroEmailClientePortalAction.do?lojaVirtual=S&ok=sim&enviarEmail=sim";
		...
		<div id="container">
			...
			<div id="content">
				...
				<div id="fatura-email" class="serv-int">
	            	...
	            	<html:form action="/inserirCadastroEmailClientePortalAction.do?lojaVirtual=Sok=sim&enviarEmail=sim"
						...
						<html:hidden property="cpfCnpjCliente"/>

	        ...
	        <div id="content">
				...
				<div id="fatura-email" class="serv-int">
                	...
                	<logic:present name="cpfCnpj" scope="session">
                		<bean:write name="cpfCnpj" scope="session" />
                	</logic:present>
                	</em></p>
	            	<html:form action="/inserirCadastroContaBrailePortalAction.do?lojaVirtual=S"
								...
								<tr>
									<td style="text-align: left">
										...
										<span class="cmp-text-2">
			                            	...
			                            	<logic:present name="cpfCnpj" scope="session">
												<html:text property="cpfSolicitante" size="15" tabindex="4" value='<bean:write name="cpfCnpj" scope="session" />' onkeypress="return isCampoNumerico(event);"/>
											</logic:present>
											<logic:notPresent name="cpfCnpj" scope="session">
												<html:text property="cpfSolicitante" size="15" tabindex="4" onkeypress="return isCampoNumerico(event);"/>
											</logic:notPresent>
										</span>
									</td>
								</tr>

	...
	<head>
		...
		<script type="text/javascript">
			...
			function gerarDocumentoExtrato(){
				window.location.href='<html:rewrite page="/gerarRelatorioExtratoDebitoAction.do?lojaVirtual=S&parcelamentoPortal=SIM&parcelamento=1&indicadorContasRevisao=1&RD="/><bean:write name="EfetuarParcelamentoDebitosPortalActionForm" property="resolucaoDiretoria"/>'
			}
			
			function gerarDocumentosParcelamento(){
				window.location.href='gerarRelatorioDocumentosParcelamentoPortalAction.do?lojaVirtual=S'
			}
		...
		<div id="container">
			...
			<div id="content">
				...
				<div id="parc-debito" class="serv-int">
	            	...
	            	<html:form action="/efetuarParcelamentoDebitosPortalAction.do?lojaVirtual=S"
							...
							<logic:present name="exibirDetalhesDebito" scope="request">
								...
								<div id="pagto">
									...
									<ul class="lista-resumo">
										...
										<li>
					                		<h6>Valor das doações:</h6>
											R$<bean:write name="EfetuarParcelamentoDebitosPortalActionForm" property="valorTotalDoacoes" 
												formatKey="money.format"/>
										</li>
										<li>

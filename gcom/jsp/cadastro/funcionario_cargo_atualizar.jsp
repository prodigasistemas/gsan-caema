			...
			<table width="100%" border="0">
				...
				<tr>
					...
					<td colspan="2"><span class="style2"> <html:text
						property="codigo" size="5" maxlength="5" onkeypress="return isCampoNumerico(event);" /> </span></td>
				</tr>
				...
				<tr>
					...
					<td colspan="2"><span class="style2"> <html:text
						property="descricao" size="70" maxlength="70" onblur="validaTexto(this);" /> </span></td>
				</tr>

				<tr>
					<td><strong>Descrição Abreviada: </strong></td>
					<td colspan="2"><span class="style2"> <html:text
						property="descricaoAbreviada" size="15" maxlength="15" onblur="validaTexto(this);" /> </span></td>
				</tr>

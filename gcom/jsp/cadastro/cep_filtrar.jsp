...
<script language="JavaScript">
	...
	function validarCodCEP() {
		var form = document.forms[0];
		if (form.codigo.value.length == 10) {
			validarForm(document.forms[0])
		} else {
			alert("Informe CEP válido!");
		}
...
<body leftmargin="5" topmargin="5">
	<html:form action="/filtrarCepAction" name="FiltrarCepActionForm"
		type="gcom.gui.atendimentopublico.FiltrarCepActionForm" method="post"
			...
			<tr>
				...
				<td width="615" valign="top" class="centercoltext">
					...
					<table width="100%" border="0">
						<tr>
							<td colspan="2">Para filtrar o CEP a ser atualizado, informe
								o código abaixo:</td>
						</tr>

						<tr>
							<td><strong>CEP:<font color="#FF0000">*</font></strong></td>
							<td colspan="2"><span class="style2"> <input
						...
						<tr>
							<td colspan="2"><input name="Button" type="button"
								...
								tabindex="8"> <input name="Button" type="button"
							...
							<td width="53" height="24" align="right"><input
								...
								value="Filtrar" onClick="javascript:validarCodCEP();" /></td>
							<td width="12">&nbsp;</td>
						</tr>

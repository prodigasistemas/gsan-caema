		...
		<tr>
			...
			<table width="100%" border="0">
				...
				<tr>
					...
					<td width="85%" colspan="2"><html:text maxlength="30" property="loteamento" size="40"
						tabindex="4" /></td>
				</tr>
				...
				<tr>
					...
					<logic:present
						...
						<td align="right">
							...
							<input type="button" class="bottonRightCol" value="Adicionar" tabindex="9" style="width: 80px; align: right;" onclick="adicionarObjetoEnter('1');" name="botaoAdicionarBairro">
				...
				<tr>
					...
					<td>
						<logic:present name="cepUnico" scope="request">
							<html:text maxlength="8" property="codigoCEP" size="10" tabindex="10" disabled="true" 
							onkeypress="return isCampoNumerico(event);"/>
						</logic:present>
						
						<logic:notPresent name="cepUnico" scope="request">
							<html:text maxlength="8" property="codigoCEP" size="10" tabindex="10"
								onkeypress="javascript:return validaEnterDependencia(event, 'exibirAtualizarLogradouroAction.do', this,document.forms[0].idMunicipio.value,'Município');return isCampoNumerico(event);" />
						</logic:notPresent>
						...
						<td align="right">
							...
							<logic:present name="cepUnico" scope="request">
								<input type="button" class="bottonRightCol" value="Adicionar" tabindex="11" style="width: 80px; align: right;" disabled="true">
							</logic:present>
							
							<logic:notPresent name="cepUnico" scope="request">
								<input type="button" class="bottonRightCol" value="Adicionar" tabindex="11" style="width: 80px; align: right;" onclick="adicionarObjetoEnter('2');" name="botaoAdicionarCep">
							</logic:notPresent>

				   ...
				   <tr>
					...
					<td>
						...
						<logic:notEqual name="origem" value="acquaGIS" scope="request">
							...
							<logic:present name="logradouroBloqueado" >
							...
							<logic:notPresent name="logradouroBloqueado" >
									...
									<logic:notEqual name="origem" value="acquaGIS" scope="request"> 
										...
										<logic:present name="logradouroMunicipioCepUnico" scope="request">
											...
											<logic:notEqual name="logradouroMunicipioCepUnico" value="OK">
												<logic:present name="bairroCEPBloqueado" >
													<html:text maxlength="8" property="cep" tabindex="2" disabled="true"
												...
												<logic:notPresent name="bairroCEPBloqueado" >

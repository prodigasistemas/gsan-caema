...
<!-- Begin
 ...
 var bCancel = false;
    ...
    function caracteresespeciais  () {
     ...
     this.ae = new Array("loteamentoLogradouro", "Nome Popular possui caracteres especiais.", new Function ("varName", " return this[varName];"));
	...
	<table width="770" border="0" cellspacing="5" cellpadding="0">
		<tr>
			...
			<table width="100%" border="0">
				...
				<tr>
					<td width="20%"><strong>Loteamento:</strong></td>
					<td width="80%">
						<html:text  maxlength="30"
									property="loteamentoLogradouro" 
									size="40" 
									tabindex="8" />
					</td>
				</tr>
					...
					<td>
						<html:text  maxlength="8" 
									...
									onkeyup="javascript:limpaNomeCEP();"
								 	...
								 	<a href="javascript:abrirPopup('exibirPesquisarCepAction.do?idMunicipioDefinido='+document.forms[0].idMunicipioFiltro.value);"> 
								 	<img
										width="23" 
										height="21" 
										border="0"
				...
				<tr>
					...
					<strong>Inativo</strong> <html:radio property="indicadorUso"
						tabindex="10" value="" /> <strong>Todos</strong></div>
					</td>
				</tr>
				<tr>
					<td>&nbsp;</td>

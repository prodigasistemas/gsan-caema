    ...
    <td width="630" valign="top" class="centercoltext">
	  ...
	  <table width="100%" border="0" >
              ...
              <tr>
                ...
                <td width="70%" colspan="2"> <html:text maxlength="5" property="quantidadeEconomia" size="5"
              ...
              <tr>
                ...
                <td width="70%" colspan="2"> 
                	<html:text maxlength="5" property="qtdUnidadePrivativa" size="5"
                	onkeypress="return isCampoNumerico(event);"/>
				</td>
              </tr>
              ...
              <tr>
                ...
                <td width="70%" colspan="2"> 
                	<html:text maxlength="5" property="qtdUnidadeColetiva" size="5"
                	onkeypress="return isCampoNumerico(event);"/>
				</td>
              </tr>
             ...
             <tr><td colspan="3">&nbsp;</td></tr>
              ...
              <tr>
                ...
                <table width="100%" cellpadding="0" cellspacing="0" border="0">
					...
					<td  width="10%">
					  <div align="center">
                                            <img border="0" src="/gsan/imagens/Error.gif" title="Remover" 
                                                style="cursor:pointer; cursor:hand;"
                                            	onclick="javascript:removerSubcategoria('removerAtualizarImovelSubCategoriaAction.do?removerImovelSubCategoria=<%=""+ExibirAtualizarImovelSubCategoriaAction.obterTimestampIdImovelSubcategoria(imovelSubCategoria)%>');"/>
                                          </div>
					</td>
                                        <td width="15%">
					  <div>
                            ...
                            <logic:iterate name="colecaoImovelRamosAtividade" id="idRamoAtividade" type="ImovelRamoAtividade">
								...
								<td  width="10%">
					  				<div align="center">
                                            <img border="0" src="/gsan/imagens/Error.gif" title="Remover" 
                                                style="cursor:pointer; cursor:hand;"
                                            	onclick="javascript:removerRamoAtividade('removerAtualizarImovelRamoAtividadeAction.do?removerImovelRamoAtividade=<%=""+ExibirAtualizarImovelSubCategoriaAction.obterTimestampIdImovelRamoAtividade(idRamoAtividade)%>');"/>
                                          </div>
								</td>
                                <td>
					  					<div>

...
function pesquisarSetorComercialOrigem() {
	...
	abrirPopupDependencia('exibirPesquisarSetorComercialAction.do?idLocalidade='+form.localidadeOrigemID.value, form.localidadeOrigemID.value, 'Localidade Origem', 275, 480);
}
...
function pesquisarSetorComercialDestino() {
	...
	abrirPopupDependencia('exibirPesquisarSetorComercialAction.do?idLocalidade='+form.localidadeDestinoID.value, form.localidadeDestinoID.value, 'Localidade Destino', 275, 480);
}

...
<!-- ============================================================================================================================== -->
					...
					<td width="100%" align="center" colspan="2">
						...
						<table width="100%" border="0">
							...
							<tr> 
								...
								<logic:present  name="documentoCorte" scope="session">
								<td>
									<img border="0" width="25" height="25" src="<bean:message key="caminho.imagens"/>informacao.gif" onmouseover="this.T_BGCOLOR='whitesmoke';this.T_LEFT=true;return escape( '${DocumentoCobrancaItemActionForm.hintCorte}');" />
								</td>
								</logic:present>
							</tr>
							<tr> 
      ...
      <tr>
      	<td colspan="5">
			...
			<tr>
				<td height="10"><strong>Vl. Acréscimos:</strong></td>
				<td>
					<html:text property="valorAcrescimo" size="10" readonly="true" style="background-color:#EFEFEF; border:0; text-align: right;"/>
				</td>
				<td height="10"><strong>Vl. Desconto Efetivo:</strong></td>
				<td>
					<html:text property="valorDescontoEfetivo" size="10" readonly="true" style="background-color:#EFEFEF; border:0; text-align: right;"/>
				</td>
			</tr>
			<tr> 
					...
					<tr> 
                		<td> 
                    		...
                    		<tr bgcolor="#99CCFF"> 
								...
								<td width="10%"><div align="center"><font color="#000000" style="font-size:9px" face="Verdana, Arial, Helvetica, sans-serif"><strong>Parcela</strong></font></div></td>
								<td width="20%"><div align="center"><font color="#000000" style="font-size:9px" face="Verdana, Arial, Helvetica, sans-serif"><strong>Vl. Parcela</strong></font></div></td>
								<td width="20%"><div align="center"><font color="#000000" style="font-size:9px" face="Verdana, Arial, Helvetica, sans-serif"><strong>Vl. Item Creditado</strong></font></div></td>
							</tr>
                    		</table>
												...
												<bean:define name="cobrancaDocumentoItemCreditoARealizar" property="creditoARealizarGeral" id="creditoARealizarGeral"/>
													<logic:present name="creditoARealizarGeral" property="creditoARealizar">
														<bean:define name="creditoARealizarGeral" property="creditoARealizar" id="creditoARealizar"/>
															...
															<logic:present name="creditoARealizar" property="creditoARealizar.numeroPrestacaoCreditoMenosBonus">
													...
													<logic:present name="creditoARealizarGeral" property="creditoARealizarHistorico">
														<bean:define name="creditoARealizarGeral" property="creditoARealizarHistorico" id="creditoARealizarHistorico"/>
															...
															<logic:present name="creditoARealizarHistorico" property="prestacaoRealizadas">
																<font color="#000000" style="font-size:9px" face="Verdana, Arial, Helvetica, sans-serif"><bean:write name="creditoARealizarHistorico" property="prestacaoRealizadas"/></font>
															</logic:present>
															
															/
															
															<logic:present name="creditoARealizarHistorico" property="creditoARealizarHistorico.numeroPrestacaoCreditoMenosBonus">
											...
											<logic:present name="cobrancaDocumentoItemCreditoARealizar" property="creditoARealizarGeral">	
												<bean:define name="cobrancaDocumentoItemCreditoARealizar" property="creditoARealizarGeral" id="creditoARealizarGeral"/>
													<logic:present name="creditoARealizarGeral" property="creditoARealizar">
														<bean:define name="creditoARealizarGeral" property="creditoARealizar" id="creditoARealizar"/>
															...
															<logic:notPresent name="creditoARealizar" property="valorTotalComBonus">
																&nbsp;
															</logic:notPresent>
													</logic:present>		
												...
												<logic:present name="creditoARealizarGeral" property="creditoARealizarHistorico">
														<bean:define name="creditoARealizarGeral" property="creditoARealizarHistorico" id="creditoARealizarHistorico"/>
															...
															<logic:notPresent name="creditoARealizarHistorico" property="valorTotalComBonus">
																&nbsp;
															</logic:notPresent>

...
function controlaTextEsgoto(tipoRelatorio){
	...
	var campoSituacaoLigacaoEsgoto = form.situacaoLigacaoEsgoto;
	
	if('${sessionScope.habilitarCamposComMultiplaSelecao}' == '<%=ConstantesSistema.SIM+""%>'){
		campoSituacaoLigacaoEsgoto = form.colecaoSituacaoLigacaoEsgoto;
	}
	
	if(campoSituacaoLigacaoEsgoto.value != "3"
		&& campoSituacaoLigacaoEsgoto.value != "5" ){
...
function controlaTextAgua(tipoRelatorio){
	var form = document.ImovelOutrosCriteriosActionForm;
	var campoSituacaoAgua = form.situacaoAgua;
	
	if('${sessionScope.habilitarCamposComMultiplaSelecao}' == '<%=ConstantesSistema.SIM+""%>'){
		campoSituacaoAgua = form.colecaoSituacaoLigacaoAgua;
	}
	
	if(campoSituacaoAgua.value != "3"
		&& campoSituacaoAgua.value != "5" ){
...
function validarIndicadorMedicao(tipoRelatorio){
   ...
   for(indice = 0; indice < form.elements.length; indice++){
	...
	function habilitaOuDesabilitaTipoPoco(campo) {
		...
		var campoSituacaoLigacaoEsgoto = form.situacaoLigacaoEsgoto;
		var campoSituacaoLigacaoAgua = form.situacaoAgua;
		
		if('${sessionScope.habilitarCamposComMultiplaSelecao}' == '<%=ConstantesSistema.SIM+""%>'){
			campoSituacaoLigacaoEsgoto = form.colecaoSituacaoLigacaoEsgoto;
			campoSituacaoLigacaoAgua = form.colecaoSituacaoLigacaoAgua;
		}

		if (parseInt(campoSituacaoLigacaoEsgoto.value) == parseInt(3)
				 || parseInt(campoSituacaoLigacaoAgua.value) == parseInt(3)) {
				...
				<tr>
					...
					<div align="left">
						<strong> 
							...
							<logic:notEqual name="habilitarCamposComMultiplaSelecao" value="<%=ConstantesSistema.SIM+""%>">
								<html:select  property="situacaoAgua"
									...
									<logic:notEmpty name="collectionsLigacaoAguaSituacao">
										<html:options name="request" collection="collectionsLigacaoAguaSituacao"
											labelProperty="descricao" property="id" />
									</logic:notEmpty>
								</html:select>
							</logic:notEqual>
							
							<logic:equal name="habilitarCamposComMultiplaSelecao" value="<%=ConstantesSistema.SIM+""%>">
								<html:select multiple="true" size="3" property="colecaoSituacaoLigacaoAgua"
										onchange="controlaTextAgua('${sessionScope.parametroGerarRelatorio}');habilitaOuDesabilitaTipoPoco(this);">
									<option value="-1">&nbsp;</option>
									<logic:notEmpty name="collectionsLigacaoAguaSituacao">
										<html:options name="request" collection="collectionsLigacaoAguaSituacao"
							...
							<strong> 
									<logic:notEqual name="habilitarCamposComMultiplaSelecao" value="<%=ConstantesSistema.SIM+""%>">
										<html:select  property="situacaoLigacaoEsgoto"
											...
											<option value="-1">&nbsp;</option>
											<logic:notEmpty name="collectionLigacaoEsgotoSituacao">
												<html:options name="request" collection="collectionLigacaoEsgotoSituacao"
													labelProperty="descricao" property="id" />
											</logic:notEmpty>
										</html:select>
									</logic:notEqual>
									...
									<logic:equal name="habilitarCamposComMultiplaSelecao" value="<%=ConstantesSistema.SIM+""%>">
										<html:select multiple="true" size="3" property="colecaoSituacaoLigacaoEsgoto"
											onchange="controlaTextEsgoto('${sessionScope.parametroGerarRelatorio}');habilitaOuDesabilitaTipoPoco(this);">
											<option value="-1">&nbsp;</option>
											<logic:notEmpty name="collectionLigacaoEsgotoSituacao">
												<html:options name="request" collection="collectionLigacaoEsgotoSituacao"

...
<%@ page import="gcom.arrecadacao.bean.ContratoDemandaHelper"%>
...
<head>
		...
		$(document).ready(function() {
			...
			$('a[name=modal]').click(function(e) {
				if(janelaAberta == false){
					...
					var id = "#dialog_"+$(this).attr('href');
					var id1 = "#dialog1_"+$(this).attr('href');
					...
					$(id1).css('top',  winH/2-$(id).height()/2);
					$(id1).css('left', '700px');
					//efeito de transição
					$(id).fadeIn(2000);
					$(id1).fadeIn(2000);
	...
	<script language="JavaScript">
		...
		function pesquisarImoveisContratoDemanda(id){
			abrirPopup('exibirConsultarImoveisContratoDemandaPopupAction.do?idContratoDemanda='+id, 300, 800);	
		}
		...
		<tr>
			...
			<td class="centercoltext" valign="top">
				...
				<table border="0" width="100%">
								    ...
								    <td>
									    <table width="100%" align="center" bgcolor="#99CCFF" border="0">
										    <tr>
												...
												<td align="right" width="53%"><strong>Dados do Imóvel<logic:present name="imovelExcluido" scope="request"><font color="#ff0000"> (Excluído)</font></logic:present></strong></td>
												<td width="3%">&nbsp;</td>
												<td width="40%"><div align="center"><font color="#FF0000"><strong><bean:write name="ConsultarImovelActionForm" 
												property="msgImovelAptoSorteioComplementares"/></strong></font></div></td>
											</tr>
										</table>
									</td>
								</tr>
										...
										<table border="0" width="100%">
											<tr>
												...
												<td width="75%" colspan="3">
													<html:text property="idImovelDadosComplementares" 
														maxlength="9" 
														size="9"
	             ...
	             <!-- Inicio da tabela de Hitorico Clientes do Imovel - Vivianne Sousa -->
            <tr>
             <td colspan="6" >	
	             	...
	             	<table width="100%" align="center" bgcolor="#90c7fc" border="0">
						...
						<tr bordercolor="#000000">
							...
							<td width="13%" bgcolor="#90c7fc" align="center">
							 <div align="center"><strong>Data Início Rela&ccedil;&atilde;o</strong></div>
							</td>
							<td width="13%" bgcolor="#90c7fc" align="center">
							 <div align="center"><strong>Data Fim Rela&ccedil;&atilde;o</strong></div>
							</td>
							<td width="15%" bgcolor="#90c7fc" align="center">
				...
				<tr>
					<td width="100%" colspan="6" >
           		  ...
           		  <!-- Inicio da tabela de Situação de Cobranca  -->
				  <tr>
					<td colspan="7">
					<table width="100%" align="center" bgcolor="#90c7fc" border="0">
						...
						<logic:present name="colecaoDadosImovelCobrancaSituacao">
							...
							<logic:iterate name="colecaoDadosImovelCobrancaSituacao" id="imovelCobrancaSituacaoHelper" indexId="ind">
									...
									<td width="10%">
										...
										<font color="#000000" style="font-size:9px" face="Verdana, Arial, Helvetica, sans-serif"> 											
											...
											<logic:notEmpty name="imovelCobrancaSituacaoHelper" property="contasEnviadasCobrancaHelper" >
												<a href="javascript:abrirPopup('exibirContasEnviadasPagasParceladasEmCobrancaAction.do?ind=<c:out value="${ind}'" />, 500, 800);">
												<bean:write name="imovelCobrancaSituacaoHelper" property="dataImplantacaoCobranca" formatKey="date.format"/></a>
											</logic:notEmpty>
				...
				<!-- Fim da tabela de Situação de Cobranca - Vivianne Sousa -->
				  ...
				  <tr>
					...
					<table width="100%" align="center" bgcolor="#90c7fc" border="0">
						...
						<tr bordercolor="#79bbfd">
							<td colspan="5" bgcolor="#79bbfd" align="center"><strong>Negativações</strong></td>
						</tr>
							...
							<logic:iterate name="colecaoDadosNegativadorMovimentoReg" id="negaticacaoAceitaHelper">
								...
								<tr bgcolor="#cbe5fe">
									...
									<td width="10%">
										<div align="center" class="style9">
										<font color="#000000" style="font-size:9px" face="Verdana, Arial, Helvetica, sans-serif"> 
											<a href="javascript:abrirPopup('exibirConsultarClienteAction.do?desabilitarPesquisaCliente=SIM&codigoCliente='+<bean:write name="negaticacaoAceitaHelper" property="idClienteNegativado" />, 500, 800);">
											 	<bean:write name="negaticacaoAceitaHelper" property="idClienteNegativado" />
											</a>
										</font></div>
									</td>
									<td width="20%">
				...
				if (cont % 2 == 0) {%>
					...
					cor2 = "#FFFFFF";%>
						...
						<table bgcolor="#90c7fc" width="100%" border="0">
							<tr bordercolor="#79bbfd">
								<td colspan="3" align="center" bgcolor="#79bbfd"><strong>Fotos Cadastradas no Imóvel: </strong></td>
							</tr>
							
							<tr bordercolor="#000000">
								<td width="65%" bgcolor="#90c7fc" align="center">
								<div class="style9"><font color="#000000" style="font-size:9px"
									face="Verdana, Arial, Helvetica, sans-serif"> <strong>Tipo de Foto</strong></font></div>
								</td>
							...
							<%String cor3 = "#FFFFFF";%>
							<logic:present name="colecaoFotosImovel" scope="session">
								<logic:iterate name="colecaoFotosImovel" id="imovelFoto">
									<%if (cor3.equalsIgnoreCase("#FFFFFF")) {
										cor3 = "#cbe5fe";%>
											<tr bgcolor="#FFFFFF">
									<%} else {
										cor3 = "#FFFFFF";%>
									...
									<%}%>
										<td align="left"><font style="font-size: 9px;"
														color="#000000" face="Verdana, Arial, Helvetica, sans-serif"><bean:write name="imovelFoto" property="fotoSituacao.descricao"/></font></td>
										<td align="center"><font style="font-size: 9px;"
														color="#000000" face="Verdana, Arial, Helvetica, sans-serif"><bean:write name="imovelFoto" property="ultimaAlteracao" formatKey="date.format"/></font>
										</td>
										<td align="center">
											<logic:notEmpty name="imovelFoto" property="fotoImovel">
												<a href="javascript:abrirPopup('exibirFotoImovelAction.do?id=<bean:write name="imovelFoto" property="id"/>', 600, 800);">
													<img width="18" height="18"
														src="<bean:message key="caminho.imagens"/>imgfolder.gif" border="0" />
												</a>
											</logic:notEmpty>
			...
			<table bgcolor="#90c7fc" width="100%"
						border="0">
			  <tr>
					<td colspan="8" align="center" bgcolor="#79bbfd">
			  ...
			  <tr bordercolor="#000000" bgcolor="#90c7fc">
							...
							<td align="center" bgcolor="#90c7fc" width="10%">
								<font style="font-size: 9px;" color="#000000" face="Verdana, Arial, 
												Helvetica, sans-serif">
												<strong>Valor Tarifa ou Percentual</strong>
								</font>
							</td>
							<td align="center" bgcolor="#90c7fc" width="10%">
								<font style="font-size: 9px;" color="#000000" face="Verdana, Arial, 
												Helvetica, sans-serif">
												<strong>Consumo Mínimo Tarifa</strong>
								</font>
							</td>
							<td align="center" bgcolor="#90c7fc" width="10%">
								<font style="font-size: 9px;" color="#000000" face="Verdana, Arial, 
												Helvetica, sans-serif">
												<strong>Percentual Coleta de Esgoto</strong>
								</font>
							</td>
							<td align="center" bgcolor="#90c7fc" width="10%">
								<font style="font-size: 9px;" color="#000000" face="Verdana, Arial, 
												Helvetica, sans-serif">
												<strong>Volume Mínimo de Esgoto</strong>
								</font>
							</td>
							<td align="center" bgcolor="#90c7fc" width="10%">
								<font style="font-size: 9px;" color="#000000" face="Verdana, Arial, 
												Helvetica, sans-serif">
												<strong>Percentual Tarifa de Água</strong>
								</font>
							</td>
				</tr>
				<tr>
					...
					<table width="100%" align="left" bgcolor="#99CCFF">
					<%	int contContrato = 0;	%>
						<logic:notEmpty name="colecaoContratoDemanda" scope="session">
							<logic:iterate name="colecaoContratoDemanda"
								id="helper"
								type="ContratoDemandaHelper">
							...
							<%	}	%>								
									...
									<td align="center" width="20%">
										<div class="style9">
											<font style="font-size: 9px;"
												...
												<logic:present name="helper" property="contratoDemandaComercialIndustrial">
													<a href="javascript:pesquisarImoveisContratoDemanda(<bean:write name="helper" property="contratoDemandaComercialIndustrial.id" />);">
														<bean:write name="helper" property="contratoDemandaComercialIndustrial.numeroContrato" />
													</a>
												</logic:present>
												
												<logic:present name="helper" property="contratoDemandaImovel">
													<bean:write name="helper" property="contratoDemandaImovel.numeroContrato" />
												</logic:present>
									...
									<td align="center" width="15%">
										<font style="font-size: 9px;"
											color="#000000" face="Verdana, Arial, Helvetica, sans-serif">
												...
												<logic:present name="helper" property="contratoDemandaComercialIndustrial">
													<bean:write name="helper" property="contratoDemandaComercialIndustrial.dataContratoInicio" formatKey="date.format"/>
												</logic:present>
												
												<logic:present name="helper" property="contratoDemandaImovel">
													<bean:write name="helper" property="contratoDemandaImovel.dataInicioContrato" formatKey="date.format"/>
												</logic:present>											
										</font>
									</td>
									<td align="center" width="15%">
										<font style="font-size: 9px;"
											color="#000000" face="Verdana, Arial, Helvetica, sans-serif">
												...
												<logic:present name="helper" property="contratoDemandaComercialIndustrial">
													<bean:write name="helper" property="contratoDemandaComercialIndustrial.dataContratoFim" formatKey="date.format"/>
												</logic:present>
												
												<logic:present name="helper" property="contratoDemandaImovel">
													<bean:write name="helper" property="contratoDemandaImovel.dataFimContrato" formatKey="date.format"/>
												</logic:present>											
										</font>
									</td>
									<td align="center" width="10%">
										<font style="font-size: 9px;"
											...
											<bean:write name="helper" property="valorTarifa" />													
										</font>
									</td>
									<td align="center" width="10%">
										<font style="font-size: 9px;"
											color="#000000" face="Verdana, Arial, Helvetica, sans-serif">
											<bean:write name="helper" property="consumoContratado" />													
										</font>
									</td>
									<td align="center" width="10%">
										<font style="font-size: 9px;"
											color="#000000" face="Verdana, Arial, Helvetica, sans-serif">
											<logic:present name="helper" property="contratoDemandaComercialIndustrial">
												<bean:write name="helper" property="contratoDemandaComercialIndustrial.percentualColetaEsgoto" formatKey="money.format" />
											</logic:present>
										</font>
									</td>
									<td align="center" width="10%">
										<font style="font-size: 9px;"
											color="#000000" face="Verdana, Arial, Helvetica, sans-serif">
											<logic:present name="helper" property="contratoDemandaComercialIndustrial">
												<bean:write name="helper" property="contratoDemandaComercialIndustrial.numeroVolumeInformadoFixadoEsgoto" />
											</logic:present>													
										</font>
									</td>
									<td align="center" width="10%">
										<font style="font-size: 9px;"
											color="#000000" face="Verdana, Arial, Helvetica, sans-serif">
											<logic:present name="helper" property="contratoDemandaComercialIndustrial">
												<bean:write name="helper" property="contratoDemandaComercialIndustrial.percentualValorTarifaAgua" formatKey="money.format" />
											</logic:present>													
										</font>
									</td>
								</tr>
			...
			<p>&nbsp;</p>
			<!-- Inicio da Tabela  Historico de alteracao dados do Imovel -->
            ...
            <table bgcolor="#90c7fc" width="100%"
             ...
             <tr>
             	...
             	<table width="100%" align="left" bgcolor="#90c7fc" border="0">
             		<tr bordercolor="#79bbfd">
						<td colspan="6" bgcolor="#79bbfd" align="center"><strong>Histórico de Altera&ccedil;&atilde;o do Imóvel</strong>
						</td>
						<td align="center" bgcolor="#79bbfd"><input type="button" name="button" class="bottonRightCol"
						value="Pesquisar Histórico"
						onClick="javascript:pesquisarHistoricoImovel()"></td>
					</tr>
					 </table>
					...
					<tr bordercolor="#000000">
						<td width="20%" bgcolor="#90c7fc" align="left">
							<div align="left"><strong>Data da Realiza&ccedil;&atilde;o</strong></div>
						</td>
						<td width="20%" bgcolor="#90c7fc" align="left">
							 <div align="left"><strong>Nome da Opera&ccedil;&atilde;o</strong></div>
						</td>
						<td width="20%" bgcolor="#90c7fc" align="left">
							 <div align="left"><strong>Usuario que Realizou a Opera&ccedil;&atilde;o</strong></div>
						</td>
					</tr>
				 </table>
             	</td>
					...
					<div style="width: 100%; height: 102; overflow: auto;">
						<table width="100%" align="left" bgcolor="#99CCFF" border="0">
							...
							<logic:notEmpty name="colecaoAlteracaoImovel" scope="request">
								<logic:iterate name="colecaoAlteracaoImovel" id="alteracaoImovel"
												type="OperacaoEfetuada">
									<%countt = countt + 1;
									if (countt % 2 == 0) {%>
									<tr bgcolor="#cbe5fe">
										<%} else {%>

...
<body leftmargin="5" topmargin="5" onload="javascript:habilitaMatricula();setarFoco('idImovelDebitos');mostrarPopUp(document.forms[0].idImovelDebitos.value);consultarImovelAjax();">
						...
						<tr>
						    <td>
							    <table width="100%" align="center" bgcolor="#99CCFF" border="0">
									...
									property="msgImovelAptoSorteio"/></strong></font></div></td>
						...
						<table width="100%">
							<tr>  
								<logic:empty name="colecaoContaValores">
									...
									<td align="right">
										<input type="button" name="" value="Emitir Extrato de Débito do Imóvel" class="bottonRightCol" disabled="disabled"/>
									</td>
								</logic:empty>
								<logic:notEmpty name="colecaoContaValores">
									<logic:equal name="ConsultarImovelActionForm" property="indicadorEmissaoExtratoNaConsulta" value="<%=ConstantesSistema.SIM.toString()%>" >
										...
										<td align="right">
											<input type="button" name="" value="Emitir Extrato de Débito do Imóvel" class="bottonRightCol" onclick="gerarExtratoDebito()" >
										</td>
									</logic:equal>

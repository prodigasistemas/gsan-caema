	...
	<table width="770" border="0" cellspacing="5" cellpadding="0">
		<tr>
						...
						<tr>
						    <td>
							    <table width="100%" align="center" bgcolor="#99CCFF" border="0">
									...
									property="msgImovelAptoSorteioDadosCadastrais"/></strong></font></div></td>
									</tr>
								</table>
							</td>
						</tr>
			...
			%>
						...
						<logic:present name="exibirVisualizarCoordenadas" scope="request">
							<tr>
						...
						<tr>
							...
							<td height="10" align="left">
								<div class="style9">
									<strong>Rateio Negativo:</strong>	
								</div>
							</td>
							<td align="left">
								<html:text
									property="indicadorImovelRateioNegativo"
									readonly="true"
									style="background-color:#EFEFEF; border:0; color: #000000"
									size="20" maxlength="20" />
							</td>
						...
						<tr>
							...
							<td height="10" align="left">
							<div class="style9"><strong>Subsistema de Esgoto:</strong></div>
							</td>
							<td align="left">
							<div class="style9"><html:text
								property="subsistemaEsgotoDadosCadastrais" readonly="true"
								style="background-color:#EFEFEF; border:0; color: #000000"
								size="20" maxlength="20" /></div>
							</td>
						</tr>
						<tr>
							...
							<td align="left" colspan="3">
								<div class="style9"><html:text
									property="dataCadastramento" readonly="true"
									style="background-color:#EFEFEF; border:0; color: #000000"
									size="20" maxlength="20" />
								</div>
							</td>

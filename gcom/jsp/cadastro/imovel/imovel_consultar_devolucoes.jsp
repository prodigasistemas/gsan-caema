						    ...
						    <td>
							    <table width="100%" align="center" bgcolor="#99CCFF" border="0">
								    <tr>
									    ...
									    property="msgImovelAptoSorteioDevolucoesImovel"/></strong></font></div></td>												
									</tr>
								</table>
							</td>
						</tr>
		   ...
		   <tr>
			<td colspan="7">
			  <table width="100%" align="center" bgcolor="#90c7fc" border="0">
				 <tr bgcolor="#79bbfd">
				 	<td align="center" bgcolor="#79bbfd" height="20" colspan="7">
						<strong>Devolução de Documentos Pagos em Duplicidade, a Maior ou Não Conforme</strong>
					</td>
				</tr>
				<tr bgcolor="#99CCFF">
					<td width="11%" bgcolor="#90c7fc" align="center"><strong>RA</strong></td>
					<td width="29%" bgcolor="#90c7fc" align="center"><strong>Espec. da Solicitação</strong></td>
					<td width="16%" bgcolor="#90c7fc" align="center"><strong>Tipo de Documento.</strong></td>
					<td width="11%" bgcolor="#90c7fc" align="center"><strong>Ref.</strong></td>
					<td width="11%" bgcolor="#90c7fc" align="center"><strong>Valor do Pagam.</strong></td>
					<td width="11%" bgcolor="#90c7fc" align="center"><strong>Valor da Devol.</strong></td>
					<td width="11%" bgcolor="#90c7fc" align="center"><strong>Data da Devol.</strong></td>
				</tr>

				<%int cntd = 1;%>
				<%if ( (session.getAttribute("qtdeDevDoc") == null) ) {%>
										<!-- Para carregar a tabela vazia -->

				<%}else if ( (session.getAttribute("qtdeDevDoc") != null) && ((Integer) session.getAttribute("qtdeDevDoc")
									<= ConstantesSistema.NUMERO_MAXIMO_REGISTROS_CONSULTA_DEVOLUCAO)) {%>
				<tr>
					<td>
						<logic:present name="colecaoRADevolucaoValoresHelper" scope="session">
															
							<logic:iterate name="colecaoRADevolucaoValoresHelper"
								id="rADevolucaoValoresHelper" type="RADevolucaoValoresHelper">
								<%cntd = cntd + 1;
									if (cntd % 2 == 0) {%>
								<tr bgcolor="#FFFFFF">
									<%} else {
								...
								<tr bgcolor="#cbe5fe">
									...
									<%}%>
									<td width="11%" align="center">${rADevolucaoValoresHelper.numeroRA}&nbsp;</td>
									<td width="29%">${rADevolucaoValoresHelper.especificacaoSolicitacao}&nbsp;</td>
									<td width="16%" align="center">${rADevolucaoValoresHelper.documentoTipo}&nbsp;</td>
									<td width="11%" align="center">${rADevolucaoValoresHelper.referencia}&nbsp;</td>
									<td width="11%" align="right"><%=Util.formatarMoedaReal(rADevolucaoValoresHelper.getValorPagamento())%></td>
									<td width="11%" align="right"><%=Util.formatarMoedaReal(rADevolucaoValoresHelper.getValorDevolucao())%></td>
									<td width="11%" align="center"><bean:write name="rADevolucaoValoresHelper" property="dataDevolucao" formatKey="date.format" />&nbsp;</td>
								</tr>
							</logic:iterate>
						</logic:present>
					</td>
				...
				<tr>
					<td height="190" colspan="7">
						<logic:present name="colecaoRADevolucaoValoresHelper"
							scope="session">
							...
							<logic:iterate name="colecaoRADevolucaoValoresHelper"
								...
								<tr bgcolor="#cbe5fe">
									...
									<td width="11%" align="center">${rADevolucaoValoresHelper.numeroRA}&nbsp;</td>
									<td width="29%">${rADevolucaoValoresHelper.especificacaoSolicitacao}&nbsp;</td>
									<td width="16%">${rADevolucaoValoresHelper.documentoTipo}&nbsp;</td>
									<td width="11%" align="center">${rADevolucaoValoresHelper.referencia}&nbsp;</td>
									<td width="11%" align="right"><%=Util.formatarMoedaReal(rADevolucaoValoresHelper.getValorPagamento())%></td>
									<td width="11%" align="right"><%=Util.formatarMoedaReal(rADevolucaoValoresHelper.getValorDevolucao())%></td>
									<td width="11%" align="center"><bean:write name="rADevolucaoValoresHelper" property="dataDevolucao" formatKey="date.format" />&nbsp;</td>														

		...
		<p>&nbsp;</p>
			...
			<table width="100%" border="0">
				...
				<tr>
					...
					<table width="100%" align="center" bgcolor="#79bbfd" border="0">
						<tr bordercolor="#79bbfd">
							<td bgcolor="#79bbfd"><strong>Valor dos Débitos do Imóvel:</strong></td>
						</tr>
					</table>
					<table width="100%" align="center" bgcolor="#99CCFF" border="0">
						<tr bordercolor="#90c7fc">
				...
				<tr>
					...
					<table width="100%" align="center" bgcolor="#79bbfd" border="0">
						<tr bordercolor="#79bbfd">
							<td bgcolor="#79bbfd"><strong>Percentual e Valor dos Descontos Concedidos:</strong></td>
						</tr>
					</table>
					<table width="100%" align="center" bgcolor="#99CCFF" border="0">
						<tr bordercolor="#90c7fc">
				...
				<tr>
					...
					<table width="100%" align="center" bgcolor="#79bbfd" border="0">
						<tr bordercolor="#79bbfd">
							<td bgcolor="#79bbfd"><strong>Condições da Negociação:</strong></td>
						</tr>
					</table>
					<table width="100%" align="center" bgcolor="#99CCFF" border="0">
						<tr bordercolor="#90c7fc">

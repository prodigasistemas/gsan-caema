						    ...
						    <td>
							    <table width="100%" align="center" bgcolor="#99CCFF" border="0">
								    <tr>
									    ...
									    <td align="left" width="4%">
									    <logic:present name="imovelOsComFoto">
									    	<logic:notEmpty name="imovelOsComFoto">
									    	<img border="0" width="25" height="25"
												src="<bean:message key="caminho.imagens"/>fotos.gif"
												onmouseover="this.T_BGCOLOR='whitesmoke';this.T_LEFT=true;return escape( 'Existe OS seletiva com fotos' ); "/>
									    	</logic:notEmpty>
									    </logic:present>
									    </td>						    						
										<td align="right" width="49%"><strong>Dados do Imóvel<logic:present name="imovelExcluido" scope="request"><font color="#ff0000"> (Excluído)</font></logic:present></strong></td>
										<td width="3%">&nbsp;</td>
										<td width="40%"><div align="center"><font color="#FF0000"><strong><bean:write name="ConsultarImovelActionForm" 
									property="msgImovelAptoSorteioAnaliseMedicaoConsumo"/></strong></font></div></td>
									</tr>
								</table>
							</td>
						</tr>						
						<tr bgcolor="#cbe5fe">
							...
							<table border="0" width="100%">
								<tr>
									...
									<td width="75%" colspan="4"><html:text
					...
					<table width="100%" bgcolor="#99CCFF">
						<tr>
							<td colspan="6" bgcolor="#79bbfd" align="center">
								<strong>Dados da Ligação de Água<strong>
							</td>
						...
						<!--header da tabela interna -->
						<tr bgcolor="#99CCFF" class="styleFontePeqNegrito">
							<td width="10%" align="center">Data da Ligação</td>
							<td width="10%" align="center">Data de Corte</td>
							<td width="20%" align="center">Motivo do Corte</td>
						...
						<tr bgcolor="#FFFFFF" class="styleFontePequena">
							<td align="center">${sessionScope.consultarImovelActionForm.dataLigacaoAgua}&nbsp;</td>
							<td align="center">${sessionScope.consultarImovelActionForm.dataCorteAgua}&nbsp;</td>
							<td align="center">${sessionScope.consultarImovelActionForm.motivoCorteAgua}&nbsp;</td>
							<td align="center">${sessionScope.consultarImovelActionForm.dataReligacaoAgua}&nbsp;</td>
							<td align="center">${sessionScope.consultarImovelActionForm.dataSupressaoAgua}&nbsp;</td>
							<td align="center">${sessionScope.consultarImovelActionForm.dataRestabelecimentoAgua}&nbsp;</td>
						</tr>
				...
				<tr>
					...
					<table width="100%" bgcolor="#99CCFF">
						...
						<tr bgcolor="#99CCFF" class="styleFontePeqNegrito">
							...
							<td align="center" width="5px">Telemedido</td>
						...
						<tr bgcolor="#FFFFFF" class="styleFontePequena">
							...
							&nbsp;</td>
							<td align="center">${sessionScope.consultarImovelActionForm.indicadorTelemedidoLigacaoAgua}
							&nbsp;</td>
						...
						<tr bgcolor="#99CCFF" class="styleFontePeqNegrito">
							...
							<td colspan="2" align="center">Modelo do Sensor</td>
						</tr>
						...
						<tr bgcolor="#FFFFFF" class="styleFontePequena">
							...
							&nbsp;</td>
							<td align="center" colspan="2">${sessionScope.consultarImovelActionForm.hidrometroModeloSensor}
							&nbsp;</td>
						</tr>
				...
				<tr>
					...
					<table width="100%" bgcolor="#99CCFF">
						...
						<tr bgcolor="#99CCFF" class="styleFontePeqNegrito">
							...
							<td width="27%" align="center" colspan="2">Capacidade</td>
						</tr>
						...
						<tr bgcolor="#FFFFFF" class="styleFontePequena">
							...
							&nbsp;</td>
							<td align="center" colspan="2">${sessionScope.consultarImovelActionForm.capacidadeHidrometroPoco}
							&nbsp;</td>
						</tr>
						<tr bgcolor="#99CCFF" class="styleFontePeqNegrito">
							<td align="center">Tipo de Hidr&ocirc;metro</td>
						...
						<tr bgcolor="#FFFFFF" class="styleFontePequena">
							...
							<td align="center" colspan="2">${sessionScope.consultarImovelActionForm.diametroHidrometroPoco}
							&nbsp;</td>
						</tr>
						...
						<tr bgcolor="#FFFFFF" class="styleFontePequena">
							...
							&nbsp;</td>
							<td align="center">${sessionScope.consultarImovelActionForm.indicadorTelemedidoPoco}
							&nbsp;</td>
						...
						<tr bgcolor="#FFFFFF" class="styleFontePequena">
							...
							&nbsp;</td>
							<td align="center" colspan="2">${sessionScope.consultarImovelActionForm.numeroLacreInstalacaoPoco}
							&nbsp;</td>
						</tr>
					</table>
					</td>

...
function validarSubSistemaEsgoto() {
	
	var form = document.forms[0];
	
	form.action='atualizarImovelWizardAction.do?action=exibirAtualizarImovelCaracteristicasAction';
	form.submit();
				...
				<tr>
					...
					<tr>
						...
						<td>
							...
							onchange="validarSubSistemaEsgoto();">
								...
								<tr>
									<td><strong>Subsistema:</strong></td>
									<td>

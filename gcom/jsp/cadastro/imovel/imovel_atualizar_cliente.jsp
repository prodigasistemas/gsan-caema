...
<!-- Begin
    ...
    function validateManterImovelActionForm(form) {
      ...
      return true;
       ...
       return testarCampoValorZero(document.ManterImovelActionForm.idCliente, 'Código') && validateCaracterEspecial(form) && validateLong(form);
   }
			...
			<table width="100%" border="0">
				...
				<tr>
					...
					<td width="450" align="right"><input type="button"
						...
						onclick="javascript:verificarAdicionar();" id="botaoAdicionar" /></td>
				</tr>
				<tr>
					<td colspan="2">

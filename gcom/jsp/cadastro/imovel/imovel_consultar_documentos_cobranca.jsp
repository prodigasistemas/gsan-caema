						    ...
						    <td>
							    <table width="100%" align="center" bgcolor="#99CCFF" border="0">
								    <tr>
									    ...
									    property="msgImovelAptoSorteioDocumentosCobranca"/></strong></font></div></td>
									</tr>
								</table>
							</td>
						</tr>
						...
						<logic:present name="colecaoDocumentoCobranca">
							...
							%>
								<tr bgcolor="#cbe5fe">
									...
									<td width="50" align="center"><font style="font-size:9px">${cobrancaDocumentoHelper.cobrancaDocumento.documentoEmissaoForma.descricaoDocumentoEmissaoForma}</font></td>
									<td width="65" align="center"><font style="font-size:9px">${cobrancaDocumentoHelper.cobrancaDocumento.documentoTipo.descricaoDocumentoTipo}</font></td>
									...
									<td width="30" align="center"><font style="font-size:9px">${cobrancaDocumentoHelper.quantidadeItensCobrancaDocumento}</font></td>
									...
									<logic:present name="colecaoContaEmissao2Via" >
										<logic:iterate name="colecaoContaEmissao2Via" id="contaEmissao2Via"
											...
											<tr bgcolor="#FFFFFF">
												...
												<td width="12%" align="left">
													<div align="right">
														...
														<logic:present	name="contaEmissao2Via" property="contaGeral">
																...
																<logic:present name="contaEmissao2Via" property="contaGeral.contaHistorico">
																	<%="" +contaEmissao2Via.getContaGeral().getContaHistorico().getValorTotalConta() %>
																</logic:present>														
														</logic:present>
												...
												<td width="12%" align="left">
													<div align="center">
														<logic:present	name="contaEmissao2Via" property="conta">
															<logic:present	name="contaEmissao2Via" property="conta.debitoCreditoSituacaoAtual">
															<bean:write name="contaEmissao2Via"

			...
			<table width="100%" border="0">
						...
						<div align="left">
							<strong>
								...
								<logic:equal name="habilitarCamposComMultiplaSelecao" value="<%=ConstantesSistema.SIM+""%>">
									<html:select property="colecaoPerfilImovel" multiple="true" size="3">
										<html:option value="-1">&nbsp;</html:option>
										<html:options collection="collectionImovelPerfil"
											labelProperty="descricao" property="id" />
									</html:select>
				...
				<tr>
					...
					<div align="left">
						<strong> 
							<logic:notEqual name="habilitarCamposComMultiplaSelecao" value="<%=ConstantesSistema.SIM+""%>">
								<html:select property="categoriaImovel"
							...
							<logic:equal name="habilitarCamposComMultiplaSelecao" value="<%=ConstantesSistema.SIM+""%>">
								<html:select property="colecaoCategoriaImovel" multiple="true" size="3"
									onchange="javascript:document.ImovelOutrosCriteriosActionForm.subcategoria.value='-1';pesquisaColecaoReload('filtrarImovelOutrosCriteriosWizardAction.do?action=exibirCaracteristicasImovel','colecaoCategoriaImovel');">
									<html:option value="-1">&nbsp;</html:option>
									<html:options collection="collectionImovelCategoria"
										labelProperty="descricao" property="id" />
								</html:select>

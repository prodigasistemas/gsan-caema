...
function bloqueiaDadosEmpresaCobranca(){
		...
		if(form.indicadorEmpresaCobranca[0].checked){
            ...
            form.indicadorUso[0].disabled = true;
            form.indicadorUso[1].disabled = true;	 	 
			...
			var calendarioIni = document.getElementById('calendarioIni');
	 		...
	 		calendarioFinal.style.display = "none";
...
<body leftmargin="5" topmargin="5" onload="javascript:setarFoco('descricao');bloqueiaDadosEmpresaCobranca();">
		...
		<tr>
			...
			<table width="100%" border="0">
				...
				<tr>
					...
					<td colspan="2"><strong> <html:text
						...
						tabindex="10" onkeyup="mascaraData(this, event)" onchange="bloqueiaCampos('sim');"
				...
				<tr>
					...
					<td colspan="2"><strong> <html:text
						...
						tabindex="12" onkeyup="mascaraData(this, event)"  onchange="bloqueiaCampos('sim');"
						onkeypress="return isCampoNumerico(event);"/> <a
						id="calendarioFinal"
				...
				<tr>
							...
							<td colspan="2"><strong> <html:text
										...
										tabindex="14" onkeyup="mascaraData(this, event);" onblur="bloqueiaCampos();" 
									...
									<a id="calendarioFim">	
										...
										onclick="javascript:abrirCalendarioComFuncaoRetorno('AtualizarEmpresaActionForm', 'dataEncerramentoContratoCobranca', 'bloqueiaCampos()');"
										width="16" height="15" border="0" alt="Exibir Calendário"
										tabindex="15" /></a> (dd/mm/aaaa) </strong></td>
				</tr>
				...
				<logic:present name="colecaoEmpresaCobrancaFaixa">
					<tr>
						...
						<td colspan="2"><span class="style2"> <html:text 
							...
							onkeyup="formataValorMonetario(this, 5);"  onblur="bloqueiaCampos('sim');"
							onkeypress="return isCampoNumerico(event);"
							tabindex="16" readonly="true" style="background-color:#EFEFEF;" /> </span></td>
					...
					<tr>
						...
						<tr>
							...
							<td colspan="2"><span class="style2"> <html:text
										...
										onkeypress="return isCampoNumerico(event);" tabindex="18" /> </span>
							</td>
							<td>&nbsp;</td>
						</tr>
						...
						<tr>
					       ...
					       <td><html:radio property="indicadorUso" tabindex="19" value="1"><strong>Ativo</strong></html:radio>
					           <html:radio property="indicadorUso" tabindex="20" value="2" ><strong>Inativo</strong></html:radio>
					       </td>
					       <td>&nbsp;</td>
				        </tr>
				...
				<tr>
					...
					<td colspan="2"><span class="style2"> <html:text
						...
						onkeypress="return isCampoNumerico(event);" tabindex="21"/> </span></td>
					<td>&nbsp;</td>
				</tr>
				...
				<tr>
					...
					<td colspan="2"><span class="style2"> <html:text
						...
						onkeypress="return isCampoNumerico(event);" onblur="bloqueiaCampos('sim');"
						onkeyup="formataValorMonetario(this, 5);" tabindex="22"/> </span></td>
					<td>&nbsp;</td>
				</tr>
				
				<tr>
					<td><strong>Percentual de Imóveis:</strong></td>
					<td colspan="2"><span class="style2"> <html:text
						property="percentualImovelFaixa" size="7" maxlength="7"
						onkeypress="return isCampoNumerico(event);" onblur="bloqueiaCampos('sim');"
						onkeyup="formataValorMonetario(this, 5);" tabindex="23"/> </span></td>
				</tr>
				<tr>
				<td>
				</td>
			...
			<table width="100%" cellpadding="0" cellspacing="0">
							...
							<tr bordercolor="#000000">
								...
								<td bgcolor="#90c7fc" width="35%"><strong>Quantidade mínima de contas</strong></td>
								<td bgcolor="#90c7fc" width="30%"><strong>Percentual da Faixa</strong></td>
			     				<td bgcolor="#90c7fc" width="40%"><strong>Percentual de Imóveis</strong></td>
							</tr>
							<logic:present name="colecaoEmpresaCobrancaFaixa">
								<tr>
									<td colspan="4">
									...
									<table width="100%" bgcolor="#99CCFF">
										...
										<logic:iterate name="colecaoEmpresaCobrancaFaixa"
											...
											<td width="25%">
												<bean:write name="empresaCobrancaFaixa"
													property="percentualImovelFaixa" formatKey="money.format"/>
											</td>
										</logic:iterate>
										</tr>
			...
			<table width="100%" border="0">
				...
				<tr>
					...
					<input type="button"
						name="ButtonVolta" class="bottonRightCol" value="Voltar"
					...
					<td align="right"><input type="button"
						...
						name="botaoAtualizar" class="bottonRightCol" value="Atualizar">
				    </td>
				</tr>
				<tr>
				<td>

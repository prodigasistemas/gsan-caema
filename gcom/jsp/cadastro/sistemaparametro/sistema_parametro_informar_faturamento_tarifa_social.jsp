...
<script>
	...
	function IntegerValidations () {
		...
		this.aq = new Array("qtdEconomiaContratoDemanda", "Qtde mínima de economia deve somente conter números positivos.", new Function ("varName", "return this[varName];"));
		this.an = new Array("numeroVezesAlterarVinculo", "Quantidade máxima de alterações no vinculo da conta deve apenas conter números positivos.", new Function ("varName", "return this[varName];"));
		this.am = new Array("quantidadeMaximaContasItensEspecialFaturamento", "Quantidade máxima de contas para retirar imóvel da situação especial de faturamento por inadimplência deve apenas conter números positivos.", new Function ("varName", "return this[varName];"));
	}
	...
	function required () {
    	...
    	//this.ao = new Array("qtdEconomiaContratoDemanda", "Informe Qtde Mínima de Economia.", new Function ("varName", " return this[varName];"));
	}
			...
			<table width="100%" border="0">
				...
				<tr>
					<td width="40%" align="left"><strong>Quantidade de Dias de Débitos Vencidos para
					 Suspensão da Geração das Doações:</strong> <font color="#FF0000"></font></td>
					<td><html:text maxlength="3" property="qtdDiasDebitoVencidoParaSuspensaoGeracaoDeDoacoes" size="3"
						onkeyup="javascript:verificaNumeroInteiro(this,3);" /></td>
				</tr>
				...
				<tr>
					...
					<td><html:text property="diasVencimentoAlternativo" size="50"
						...
						title="Informe os dias separados por ponto e vírgula (;) e sem espaço em branco." />
					</td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td><strong> <html:radio
						property="indicadorCalculaVencimento" value="1" /> Sim <html:radio
						property="indicadorCalculaVencimento" value="2" />
					N&atilde;o </strong></td>
				</tr>
				...
				<tr>
					...
					recalculo e reemissão de conta na impressão simultânea:</strong> <font
				...
				<tr>
					...
					<td><strong> <html:radio property="indicadorPercentualColetaEsgoto"
						value="1" /> Sim <html:radio property="indicadorPercentualColetaEsgoto"
						value="2" /> N&atilde;o </strong></td>
				</tr>
				<tr>
					<td width="40%">
				...
				<tr>
					<td width="40%" align="left">
						<strong>Quantidade máxima de alterações no vinculo da conta:</strong>
					</td>
					
					<td><html:text property="numeroVezesAlterarVinculo" maxlength="2"
						size="2" onkeyup="javascript:verificaNumeroInteiro(this);" />
					</td>
				</tr>
				...
				<tr>
					<td width="40%" align="left">
						<strong>Quantidade máxima de contas para retirar imóvel da situação especial de faturamento por inadimplência:</strong>
					</td>
			
					<td><html:text property="quantidadeMaximaContasItensEspecialFaturamento" maxlength="2"
						size="2" onkeyup="javascript:verificaNumeroInteiro(this);"
				...
				<tr>
					...
					<td>
						<html:select property="motivoRetificacaoContaPagtoAntecipado">
						<html:option value="<%=""+ConstantesSistema.NUMERO_NAO_INFORMADO%>">&nbsp;</html:option>
						<html:options collection="colecaoContaMotivoRetificacao"
				...
				<tr>
					<td width="40%" align="left">
						<strong>Quantidade Mínima de Economias:<br>
						(Contrato de Demanda Residencial)</strong>
					</td>
					
					<td><html:text property="qtdEconomiaContratoDemanda"
						maxlength="3" size="3"
						onkeyup="javascript:verificaNumeroInteiro(this);" /></td>
				</tr>				

	...
	<table width="770" border="0" cellspacing="5" cellpadding="0">
		...
		<table width="100%" border="0">
			<tr>
				...
				<tr>
					...
					<td width="70%" colspan="2">
						...
						<html:text property="idMunicipio" size="4" maxlength="4" tabindex="3"
							onkeypress="validaEnterComMensagem(event,'exibirInserirFeriadoAction.do','idMunicipio','Município');return isCampoNumerico(event);" />
			 	...
			 	<tr> 
					...
					<td width="70%" colspan="2">
						<html:text property="dataFeriado" size="10" maxlength="10" tabindex="4" onkeyup="mascaraData(this,event)" onkeypress="return isCampoNumerico(event);" />
            	...
            	<tr>
            		<td><strong><span class="style2">Data Perene:<font color="#FF0000">*</font></span></strong></td>
					<td align="left" colspan="2">
						<html:radio property="indicadorPerene" value="1" /> <strong>Sim</strong>
						<html:radio property="indicadorPerene" value="2" /> <strong>Não</strong>
					</td>
            	</tr>
				...
				<table width="100%">
						...
						<tr>
							  <td width="40%" align="left">				
								...
								value="Limpar" onClick="window.location.href='/gsan/exibirInserirFeriadoAction.do?menu=sim'"> 

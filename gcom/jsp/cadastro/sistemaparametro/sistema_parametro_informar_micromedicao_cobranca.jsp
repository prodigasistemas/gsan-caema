...
/*function caracteresespeciais () {
	...
	function required () {
		...
		this.ag = new Array("valorSegundaVia", "Informe o valor da Segunda Via.", new Function ("varName", " return this[varName];"));
	...
	<table width="770" border="0" cellspacing="5" cellpadding="0">
		<tr>
				...
				<tr>
					...
					<td>
						<html:text maxlength="2" 
							...
							size="2" 
							onchange="validarCampoNumericoComMensagemLimpandoCampo(document.forms[0].numeroDiasVencimentoEntradaParcelamento, 'Número Dias Vencimento Entrada Parcelamento');" />
					</td>
				</tr>
			...
			<td colspan="3"><hr></td>
				...
				<tr>
					<td width="40%" align="left">
						<strong>Número de dias que permite inserir processo comando de cobrança:</strong>
					</td>
					<td>
						<html:text maxlength="3" 
							property="numeroDiasInserirProcessoCobranca"
							size="3" onkeypress="javascript:return isCampoNumerico(event);" 
							onchange="validarCampoNumericoComMensagemLimpandoCampo(document.forms[0].numeroDiasInserirProcessoCobranca, 'Número de dias que permite inserir processo comando de cobrança');" />
					</td>
				</tr>
				...
				<tr>
					...
					<td>
						<strong>
							<html:radio property="indicadorControleDividaAtiva" value="1" /> Sim
							<html:radio property="indicadorControleDividaAtiva" value="2" /> N&atilde;o
						</strong>
					</td>
				</tr>
				...
				<tr>
					...
					<td>
						<strong>
							<html:radio property="indicadorEmissaoExtratoDebitoNaConsulta" value="1" /> Sim
							<html:radio property="indicadorEmissaoExtratoDebitoNaConsulta" value="2" /> N&atilde;o
						</strong>
					</td>
				</tr>
				...
				<tr>
					...
					<td>
						<strong>
							<html:radio property="indicadorInclusaoContasCanceladasBoletim" value="1" /> Sim
							<html:radio property="indicadorInclusaoContasCanceladasBoletim" value="2" /> N&atilde;o
						</strong>
					</td>
				</tr>
				...
				<tr>
					...
					<td>
						<strong>
							<html:radio property="indicadorIncluirContaEmCobranca" value="1" /> Sim
							<html:radio property="indicadorIncluirContaEmCobranca" value="2" /> N&atilde;o
						</strong>
					</td>
				</tr>

			...
			<table width="100%" border="0">
				...
				<tr>
					...
					<td width="70%" colspan="2">
						...
						<html:text property="idMunicipio" size="4" maxlength="4" tabindex="4"
							onkeypress="validaEnterComMensagem(event,'exibirFiltrarFeriadoAction.do','idMunicipio','Município');return isCampoNumerico(event);" />
					
						<a href="javascript:chamarPopup('exibirPesquisarMunicipioAction.do', 'municipio', null, null, 485, 370, '',document.forms[0].idMunicipio);">
							<img src="/gsan/imagens/pesquisa.gif" title="Pesquisar Municipio" border="0" height="21" width="23"></a> 
						
						
						<logic:present name="municipioEncontrado">
						
							<logic:equal name="municipioEncontrado" value="exception">
								<html:text property="descricaoMunicipio" size="35" maxlength="40" readonly="true"
						...
						<logic:notPresent name="municipioEncontrado">
							...
							<logic:notEmpty name="FiltrarFeriadoActionForm" property="idMunicipio">
								<html:text property="descricaoMunicipio" size="25" maxlength="40" readonly="true"
									style="background-color:#EFEFEF; border:0; color: #000000" />
							</logic:notEmpty>
						</logic:notPresent> 
				...
				<tr> 
					...
					<td width="70%" colspan="2">
						...
						a
						<html:text property="dataFeriadoFim" size="10" maxlength="10" tabindex="6" onkeyup="mascaraData(this, event);" onkeypress="return isCampoNumerico(event);" /> 
				...
				<tr>
					<td width="30%" class="style3"><strong>Data Perene:</strong></td>
					<td width="70%" colspan="3" >  
						<html:radio property="indicadorPerene" value="1" tabindex="1" /><strong>Sim</strong>
						<html:radio property="indicadorPerene" value="2" tabindex="2" /><strong>Não</strong>
						<html:radio property="indicadorPerene" value="3" tabindex="3" /><strong>Todos</strong>
					</td>
				</tr>

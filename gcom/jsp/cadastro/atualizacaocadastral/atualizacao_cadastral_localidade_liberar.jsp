...
<html:javascript staticJavascript="false"
	formName="LiberarLocalidadeAtualizacaoCadastralActionForm" />
<script language="JavaScript"
...
<div id="formDiv">
	<html:form action="/liberarLocalidadeAtualizacaoCadastralAction" 
		...
		type="gcom.gui.cadastro.atualizacaocadastral.LiberarLocalidadeAtualizacaoCadastralActionForm"
		method="post"
						...
						<table width="100%" border="0">
							...
							<tr>
								...
								<td>
									...
									<a href="javascript:abrirPopupDependencia('exibirPesquisarSetorComercialAction.do?idLocalidade='+document.forms[0].localidade.value+'&tipo=SetorComercial',document.forms[0].localidade.value,'Localidade', 400, 800);">

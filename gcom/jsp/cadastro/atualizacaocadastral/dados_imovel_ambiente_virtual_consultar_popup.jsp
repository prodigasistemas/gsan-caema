	      										...
	      										<logic:present name="colecaoCliente" scope="request">
	      											<logic:iterate name="colecaoCliente" id="cliente" scope="request" type="ClienteAtualizacaoCadastral">
														<tr bgcolor="#FFFFFF">
			      										...
			      										<tr bgcolor="#FFFFFF">
			      											<td width="50%">
			                                					<strong>Data Relação fim</strong>
			                                				</td>
			                                				<td width="50%" align="center">  
	      							...
	      							<tr bgcolor="#cbe5fe">
										<td>
											<table width="100%" bgcolor="#90c7fc" border="0" class="fontePequena">
	      										...
	      										<tr bgcolor="#FFFFFF">
	      											<td width="50%">
	                                					<strong>Indetificação de Poço</strong>
	                                				</td>
	      											<td width="50%" align="center">  
	      						...
	      						<tr>
									...
									<td>
										<input name="ButtonAdicionariD" type="button" class="bottonRightCol" id="ButtonAdicionariD"
	      									value="Adicionar Imóvel Duplicado" onclick="enviarDadosParametrosFecharPopupAmbienteVirtual();" style="width: 170px;">
									</td>
								</tr>
	      					</table>
	      				</td>

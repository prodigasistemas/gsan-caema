...
<%@page import="gcom.cadastro.AreaAtualizacaoCadastral"  isELIgnored="false"%>
...
<html:javascript staticJavascript="false"
	formName="SuspenderLocalidadeAtualizacaoCadastralActionForm" />
<script language="JavaScript"
									...
									<td height="120">
										<div style="width: 100%; height: 100%; overflow: auto;">
											<table width="100%" bgcolor="#99CCFF">
												...
												<%int cont = 0;%>
                      							<logic:iterate name="colecaoAreaAtualizacaoCadastral" id="areaAtualizacao" scope="request" type="AreaAtualizacaoCadastral">

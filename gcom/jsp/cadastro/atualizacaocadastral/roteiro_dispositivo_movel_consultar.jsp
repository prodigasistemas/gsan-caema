...
<link rel="stylesheet"
	...
	<%@ page import="gcom.cadastro.atualizacaocadastral.bean.AtualizacaoCadastralArquivoTextoHelper "%>
		...
		<tr>
			...
			<table width="100%" border="0">
				...
				<tr>
					...
					<td colspan="2" align="left"><html:select property="cadastrador"
						tabindex="4">
						<html:option value="-1">&nbsp;</html:option>
						<html:options collection="colecaoLeiturista"
							labelProperty="usuario.nomeUsuario" property="id" />
					</html:select></td>

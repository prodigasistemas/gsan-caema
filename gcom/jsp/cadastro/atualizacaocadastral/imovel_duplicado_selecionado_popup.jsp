...
<%@ page import="gcom.cadastro.atualizacaocadastral.bean.DadosImovelDuplicadoPreGsanHelper"%>
...
function enviarImovelSelecionado() {
	...
	opener.window.location.href = '/gsan/exibirConsultarImoveisPreGsanAction.do?idAtualizacaoCadastralPopup='+ form.matricula.value + '&idImovelSelecionado=' +form.valorSelecionado.value;
	self.close();
...
<body onload="resizePageSemLink(410, 430);">
<form >
			...
			<table width="100%" border="0" bordercolor="#79bbfd">
				...
				<tr>
						...
						<td  align="left">
							...
							onClick="javascript:enviarImovelSelecionado();"/>
						</td>

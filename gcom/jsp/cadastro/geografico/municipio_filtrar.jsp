				...
				<td width="625" valign="top" class="centercoltext">
					...
					<table width="100%" border="0">
						<tr>
					  		...
					  		<td  width="60%" colspan="2"><strong><b><span class="style2" style="FONT-FAMILY: 'Bitstream Charter';"> 
						...
						<tr>
							<td><strong>Indicador de Logradouro Bloqueado Durante Atualização Cadastral:</strong></td>
							<td><html:radio property="indicadorLogradouroBloqueado" value="1" tabindex="12"/><strong>Sim 
								<html:radio	property="indicadorLogradouroBloqueado" value="2" tabindex="13"/>Não 
								<html:radio	property="indicadorLogradouroBloqueado" value="3" tabindex="14"/>Todos</strong></td>
						</tr>
						
						<tr>
							<td><strong>Ordernar Resultado Por:</strong></td>
							<td><html:radio property="ordernarPor" value="<%=ConstantesSistema.ORDENAR_POR_DESCRICAO.toString()%>" /><strong>Nome 
							<html:radio
								property="ordernarPor" value="<%=ConstantesSistema.ORDENAR_POR_CODIGO.toString()%>" />C&oacute;digo</strong></td>
						</tr>

...
<script language="JavaScript">
	...
	function validaForm(){
		...
		var form = document.forms[0];
	  	...
	  	if(form.codigoUnidade.value == null || form.codigoUnidade.value == '' ){
	  		erros += "Informe Código da Unidade Organizacional. \n";
	  	}
	  	
	  	if(form.unidadeTipo.value == null || form.unidadeTipo.value == '' || form.unidadeTipo.value == '-1' ){
	  		erros += "Informe Tipo da Unidade. \n";
	  	}
	  	
	  	if(form.idEmpresa.value == null || form.idEmpresa.value == '' || form.idEmpresa.value == '-1' ){
	  		erros += "Informe Empresa. \n";
	  	}
	  	
	  	
	  	if (validaDescricao()!= '') {
	  		erros += validaDescricao();
	  	}
	  	
	  	if(validaTodosRadioButton() != ''){
	  		erros += validaTodosRadioButton();
	  	}
    ...
    function validaDescricao() {
    	...
    	if (form.codigoUnidadeTipo.value == 'G' && form.descricao.readOnly == true && form.gerenciaRegional.value == '-1') {
    		...
    		//return false;
    		erros += "Informe Unidade de Negocio. \n";
    	} else {
    		if (form.descricao.value == '') {
    			//alert('Informe Descrição');	
    			//return false;
    			erros += "Informe Descrição. \n";
    		}
    	}
    ...
    function validaTodosRadioButton() {
		...
		if (!form.unidadeEsgoto[0].checked && !form.unidadeEsgoto[1].checked) {
			...
			//return false;
			erros+= "Informe Indicador de Unidade Esgoto. \n";
		}		
		...
		if (!form.unidadeCentralAtendimento[0].checked && !form.unidadeCentralAtendimento[1].checked) {
			...
			//return false;
			erros += "Informe Indicador de Central Atendimento. \n";
		}

		if (!form.unidadeTarifaSocial[0].checked && !form.unidadeTarifaSocial[1].checked) {
			//alert("Informe Indicador de Tarifa Social.");
			//return false;
			erros += "Informe Indicador de Tarifa Social. \n";
		}

		if(form.unidadeAbreRegistro[0].checked &&  ( form.meioSolicitacao.value == '' || form.meioSolicitacao.value == '-1') ){
			//alert("Informe Meio de Solicitação.");		
			//return false;
			erros += "Informe Meio de Solicitação. \n";
		}
    ...
    function limparUnidadeTramitacao() {
        var form = document.forms[0];
    ...
    function verificaIndicadorAbreRegistro(){
		...
		if(form.unidadeAbreRegistro[0].checked){
			
			form.meioSolicitacao.disabled=false;
   			document.getElementById('obrigarMeio').innerHTML = "<font color='#FF0000'>*";
			
		}else{
			
			form.meioSolicitacao.selectedIndex = -1;
    		form.meioSolicitacao.disabled = true;
    		document.getElementById('obrigarMeio').innerHTML = "";
							...
							<table width="100%" border="0" bgcolor="#99CCFF">
								...
								<tr bgcolor="#cbe5fe">
									...
									<table border="0" width="100%">
										...
										<tr>
											<td><strong>Código da Unidade Organizacional:<font color="#FF0000">*</font></strong></td>
											<td><html:text maxlength="6" property="codigoUnidade" tabindex="1"
												size="6" onkeypress="return isCampoNumerico(event);"/></td>
										</tr>
										...
										<tr>
											<td><strong>Unidade de Tramitação das RA de Esgoto:</strong></td>
											<td width="63%"><html:text property="idUnidadeTramitacao"
												tabindex="11" size="4" maxlength="9"
												onkeypress="validaEnterComMensagem(event, 'exibirInserirUnidadeOrganizacionalAction.do?objetoConsulta=undTramit', 'idUnidadeTramitacao', 'Unidade Tramitacao');return isCampoNumerico(event);" />
											<a
												href="javascript:chamarPopup('exibirPesquisarUnidadeOrganizacionalAction.do?tipoUnidade=unidadaTramitacao', 'unidadeTramitacao', null, null, 275, 480, '', document.forms[0].idUnidadeTramitacao);">
											<img src="<bean:message key="caminho.imagens"/>pesquisa.gif"
												border="0" width="23" height="21" title="Pesquisar Unidade Tramitacao"></a> <logic:present
												name="corUnidadeTramitacao">
												<logic:equal name="corUnidadeTramitacao" value="exception">
													<html:text property="descricaoUnidadeTramitacao" size="35"
														readonly="true"
														style="background-color:#EFEFEF; border:0; color: #ff0000" />
												</logic:equal>
												<logic:notEqual name="corUnidadeTramitacao" value="exception">
													<html:text property="descricaoUnidadeTramitacao" size="35"
														readonly="true"
														style="background-color:#EFEFEF; border:0; color: #000000" />
												</logic:notEqual>
											</logic:present> <logic:notPresent name="corUnidadeTramitacao">
												<logic:empty name="InserirUnidadeOrganizacionalActionForm"
												...
												href="javascript:limparUnidadeTramitacao();"> <img
												src="<bean:message key="caminho.imagens"/>limparcampo.gif"
												border="0" title="Apagar" /></a></td>
										</tr>
										...
										<tr>
											...
											<span class="style2"> <strong> <label id="obrigarMeio"> </label> </strong>
											</span> </strong></td>

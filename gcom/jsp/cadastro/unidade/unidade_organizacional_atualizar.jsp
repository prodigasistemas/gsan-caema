						...
						<tr bgcolor="#cbe5fe">
							...
							<table border="0" width="100%">
								...
								<tr>
									...
									<a
										href="javascript:abrirPopup('exibirPesquisarUnidadeSuperiorAction.do', 250, 495);">
								...
								<tr>
									...
									<td width="63%"><html:text property="idUnidadeTramitacao"
										...
										onkeypress="validaEnterComMensagem(event, 'exibirAtualizarUnidadeOrganizacionalAction.do?consultaUnidadeTramitacao=1', 'idUnidadeTramitacao', 'Unidade Tramitacao');return isCampoNumerico(event);" />
									<a
									...
									<img src="<bean:message key="caminho.imagens"/>pesquisa.gif"
										border="0" width="23" height="21" title="Pesquisar Unidade Tramitação"></a> <logic:present
									...
									<logic:notPresent name="corUnidadeTramitacao">
										<logic:empty name="AtualizarUnidadeOrganizacionalActionForm"
								...
								<tr>
									<td><strong> Meio de Solicita&ccedil;&atilde;o &nbsp; Padr&atilde;o: <span
										class="style2"> <strong> <label id="obrigarMeio"> </label> </strong>
									</span> </strong></td>

	...
	<table width="770" border="0" cellspacing="5" cellpadding="0">
		<tr>
    		...
    		<table width="100%" border="0">
				...
				<tr>
					<td height="28"><strong>Nome Receita Federal:</strong></td>
					<td>
						<html:text maxlength="100" property="nomeClienteReceitaFederal" size="60" tabindex="2" />
					</td>
				</tr>
				<tr>
					<td>&nbsp;</td>
					<td align="top">
						<html:radio property="tipoPesquisaNomeCliente"
					...
					<td width="18%">
						...
						codigoMunicipio='+document.forms[0].idMunicipioCliente.value+'&codigoBairro='+document.forms[0].codigoBairroCliente.value+'&indicadorUsoTodos=1&primeriaVez=1', 465, 380);"> 
							<img src="<bean:message key='caminho.imagens'/>pesquisa.gif" width="23" height="21" 
								border="0" style="cursor:hand;" title="Pesquisar Logradouro"></a>

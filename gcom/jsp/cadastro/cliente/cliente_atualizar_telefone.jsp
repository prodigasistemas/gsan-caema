				...
				<tr>
					...
					<td width="76%">
						<html:text maxlength="4" property="idMunicipio" tabindex="2" size="4"
							onkeypress="javascript: validaEnter(event,'atualizarClienteWizardAction.do?action=exibirAtualizarClienteTelefoneAction','idMunicipio');return isCampoNumerico(event);" />

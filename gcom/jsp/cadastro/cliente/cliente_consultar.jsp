			            ...
			            <table bgcolor="#90c7fc" width="100%"
				             ...
				             <tr>
			             		...
			             		<tr bordercolor="#79bbfd">
									<td colspan="6" bgcolor="#79bbfd" align="center"><strong>Histórico de Altera&ccedil;&atilde;o do Cliente</strong>
									</td>
									<td align="center" bgcolor="#79bbfd"><input type="button" name="button" class="bottonRightCol"
									value="Pesquisar Histórico"
									onClick="javascript:pesquisarHistoricoCliente()"></td>
								</tr>
								 </table>
								...
								<div style="width: 100%; height: 102; overflow: auto;">
									<table width="100%" align="left" bgcolor="#99CCFF" border="0">
										...
										<logic:notEmpty name="colecaoAlteracaoCliente" scope="request">
											<logic:iterate name="colecaoAlteracaoCliente" id="alteracaoCliente"
												...
												<tr bgcolor="#FFFFFF">
													...
													<td width="20%" align="left">
														...
														<a	href="javascript:abrirPopup('consultarOperacaoEfetuadaAction.do?idOperacaoEfetuada=<bean:write name="alteracaoCliente" property="id" />&tipoPesquisa=cliente', 500, 800);">
															<bean:write name="alteracaoCliente" property="operacao.descricao" />
														</a>
														</div>
													</td>

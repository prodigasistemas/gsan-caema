...
<!--
   ...
   function habilitacaoSistemaEsgotoSubsistema(indicadorRedeEsgoto){
	var form = document.forms[0];
		//sem rede
		if (indicadorRedeEsgoto == 1 || form.indicadorRedeEsgotoAux[0].checked){
			...
			form.subsistemaID.disabled = true;
			form.subsistemaID.value = "-1"; 
		}else{
			form.sistemaEsgotoID.disabled = false;
			form.subsistemaID.disabled = false;
		}
   }
...
function validarForm(formulario){
	...
	if (validateAtualizarQuadraActionForm(formulario)){
		...
		var objSubsistemaID = returnObject(formulario, "subsistemaID");
		...
		if(objSistemaEsgotoID.options[objSistemaEsgotoID.options.selectedIndex].value == "-1"){
			...
			else if (objSubsistemaID.length == "1"){
				alert("Sistema de Esgoto selecionado não contém Subsistema.");
				objSistemaEsgotoID.focus();
			}
			else if (objSubsistemaID.options[objSubsistemaID.options.selectedIndex].value == "-1") {
				alert("Informe Subsistema.");
				objSistemaEsgotoID.focus();
			}
...
<body leftmargin="5" topmargin="5" onload="atualizarDadosIndicador(document.forms[0]);
	...
	habilitacaoSistemaEsgotoSubsistema('${requestScope.indicadorPossuiRedeEsgoto}');">
	<!-- FIM- CASO A EMPRESA NÃO TRABALHE COM FACE DE QUADRA -->
				...
				<td width="100%" align="center">
				    ...
				    <tr>
						...
						<td>
							...
							onkeyup="limpar(12);" readonly="true"/> 
				...
				<td width="100%" align="center">
				    ...
				    <!-- CASO A EMPRESA NÃO TRABALHE COM FACE DE QUADRA -->
					    ...
					    <tr>
						  ...
						  <td>
						  		<html:radio property="indicadorRedeEsgotoAux" value="1" tabindex="8" onclick="verificarMarcacao(1, 'Esgoto');habilitacaoSistemaEsgotoSubsistema(document.forms[0].indicadorRedeEsgotoAux.value);"/><strong>Sem Rede de Esgoto
								<html:radio property="indicadorRedeEsgotoAux" value="2" tabindex="9" onclick="verificarMarcacao(2, 'Esgoto');habilitacaoSistemaEsgotoSubsistema(document.forms[0].indicadorRedeEsgotoAux.value);"/>Com Rede de Esgoto
								<html:radio property="indicadorRedeEsgotoAux" value="3" tabindex="10" onclick="verificarMarcacao(3, 'Esgoto');habilitacaoSistemaEsgotoSubsistema(document.forms[0].indicadorRedeEsgotoAux.value);"/>Rede de Esgoto Parcial</strong>
						  </td>
					    </tr>
					    ...
					    <tr>
							<td><strong>Subsistema:<font color="#FF0000">*</font></strong></TD>
							<td>
								<html:select property="subsistemaID" style="width: 200px;" tabindex="14">
									<html:option value="<%=""+ConstantesSistema.NUMERO_NAO_INFORMADO%>">&nbsp;</html:option>
									<logic:present name="colecaoSubsistema">
										<html:options collection="colecaoSubsistema" labelProperty="descricao" property="id"/>
									</logic:present>
								</html:select>
							</td>
						</tr>
					...
					<tr>
						<td width="21%"><strong>Quadra Criada para Atualização Cadastral? <font color="#FF0000">*</font></strong></td>
						<td>
							<html:radio property="indicadorAtualizacaoCadastral" value="1" tabindex="8" /><strong>Sim</strong>
							<html:radio property="indicadorAtualizacaoCadastral" value="2" tabindex="9" /><strong>N&atilde;o</strong>
						</td>
					</tr>						

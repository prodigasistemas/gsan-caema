...
function habilitacaoSistemaEsgotoSubsistema(indicadorRedeEsgotoAux){
							...
							<table width="100%" border="0">
								...
								<tr>
									...
									<td><html:text property="quadraNM" size="5" tabindex="3"
										...
										onkeypress="validaEnterComMensagem(event, 'exibirInserirQuadraAction.do?objetoConsulta=10', 'quadraNM', 'Quadra');" 
										onkeyup="somente_numero_zero_a_nove(this);"/>										
										&nbsp;<a
								...
								<tr>
									...
									<html:text property="codigoRota" size="5" maxlength="4"
										...
										onkeyup="limpar(12);somente_numero_zero_a_nove(this);" readonly="true" /> <!-- <a
								...
								<!-- CASO A EMPRESA NÃO TRABALHE COM FACE DE QUADRA -->
									...
									<tr>
										...
										<td>
											...
											onclick="verificarMarcacao(1, 'Esgoto');habilitacaoSistemaEsgotoSubsistema(document.forms[0].indicadorRedeEsgotoAux);" /><strong>
											Sem Rede de Esgoto 
											
											<html:radio property="indicadorRedeEsgotoAux" value="2" tabindex="9"
											onclick="verificarMarcacao(2, 'Esgoto');habilitacaoSistemaEsgotoSubsistema(document.forms[0].indicadorRedeEsgotoAux);" />
											Com Rede de Esgoto 
											
											<html:radio property="indicadorRedeEsgotoAux" value="3" tabindex="10"
											onclick="verificarMarcacao(3, 'Esgoto');habilitacaoSistemaEsgotoSubsistema(document.forms[0].indicadorRedeEsgotoAux);" />
							...
							<tr>
								<td>
									...
									<tr bgcolor="#99CCFF">
										...
										<td width="30%">
											<div align="center"><strong>Subsistema</strong></div>
										</td>
...
<!-- CASO A EMPRESA NÃO TRABALHE COM FACE DE QUADRA -->
	...
	<script language="JavaScript">
		...
		habilitacaoSistemaEsgotoSubsistema(document.forms[0].indicadorRedeEsgotoAux);
		//-->

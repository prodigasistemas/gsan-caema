  		...
  		<tr>
    		...
    		<logic:equal name="pemissaoIndicadorBloqueio" value="2">
      		...
      		<tr>
        		...
        		<td>
					<html:radio property="indicadorAtualizacaoCadastral" value="1"/><strong>Sim</strong>
					<html:radio property="indicadorAtualizacaoCadastral" value="2"/><strong>Não</strong>
				</td>
      		</tr>

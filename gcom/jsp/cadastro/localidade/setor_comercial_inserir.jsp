	...
	<table width="770" border="0" cellspacing="5" cellpadding="0">
		<tr>
    		...
    		<table width="100%" border="0">
				...
				<tr>
					<td><strong>Setor Criado para Atualização Cadastral? <font color="FF0000">*</font></strong></td>
					<td>
						<html:radio property="indicadorAtualizacaoCadastral" value="1" tabindex="4" /><strong>Sim</strong> 
						<html:radio property="indicadorAtualizacaoCadastral" value="2" tabindex="5" /><strong>Não</strong>
					</td>
					<td>&nbsp;</td>
				</tr>

...
$(document).ready(function(){
	   ...
	   $('[@name=idSistemaAbastecimento]').change(function() {
		   ...
		   var theForm = $("form[name=InserirLocalidadeActionForm]");
		   var params = theForm.serialize();
		   var actionURL = 'exibirInserirLocalidadeAction.do?action=atualizarListaAbastecimentoSecundario'
		   $.ajax({
			    type:"POST",
			    url:actionURL,
			    data:params,
...
<table width="770" border="0" cellspacing="5" cellpadding="0">
  <tr>
	...
	<td width="625" valign="top" class="centercoltext">
	  ...
	  <tr> 
          ...
          <td colspan="2"><html:text property="localidadeID" size="5" tabindex="1"
						maxlength="3" 
						onkeyup="somente_numero_zero_a_nove(this);" />&nbsp;<a tabindex="2"
	  ...
	  <tr> 
          ...
          <td colspan="2"><html:text property="localidadeNome" size="45" maxlength="30" tabindex="3"/></td>
      </tr>
      <tr>
		 ...
		 <logic:present name="colecaoEnderecos">
			<logic:empty name="colecaoEnderecos">
				<input type="button" class="bottonRightCol" value="Adicionar" tabindex="4" id="botaoEndereco" onclick="javascript:abrirPopup('exibirInserirEnderecoAction.do?tipoPesquisaEndereco=localidade&operacao=1', 570, 700);">
			</logic:empty>
			<logic:notEmpty name="colecaoEnderecos">
				<input type="button" class="bottonRightCol" value="Adicionar" tabindex="4" id="botaoEndereco" onclick="javascript:abrirPopup('exibirInserirEnderecoAction.do?tipoPesquisaEndereco=localidade&operacao=1', 570, 700);" disabled>
			</logic:notEmpty>
		 </logic:present>
   ...
   <tr>
	  ...
	  <td><html:text property="email" size="55" maxlength="40" tabindex="8"/></td>
   </tr>
   <tr>
	  <td><strong>Menor Consumo:</strong></td>
	  <td><html:text property="menorConsumo" size="10" maxlength="6" tabindex="9"
	  		onkeyup="somente_numero_zero_a_nove(this);"/></td>
   </tr>
    <tr>
	   <td><strong>Unidade Negócio:<font color="#FF0000">*</font></strong></td>
	   <td>
			<html:select property="idUnidadeNegocio" style="width: 200px;" tabindex="10" onchange="carregarElos();">
   ...
   <tr>
	   ...
	   <td><html:text property="icms" size="10" maxlength="10" tabindex="15"
	   		onkeyup="somente_numero_zero_a_nove(this);" /></td>
   </tr>   
   <tr>
	   <td><strong>Centro de Custo:</strong></td>
	   <td><html:text property="centroCusto" size="10" maxlength="10" tabindex="16" onkeyup="somente_numero_zero_a_nove(this);"/></td>   
   </tr>
   <tr>
	   <td><strong>Centro de Custo de Esgoto:</strong></td>
	   <td><html:text property="centroCustoEsgoto" size="10" maxlength="10" tabindex="17" onkeyup="somente_numero_zero_a_nove(this);"/></td>   
   </tr>
   ...
   <tr>
	...
	<tr>
		...
		<td>
			<html:radio property="sede" onclick="javascript:verificarLocalidadeSede();" tabindex="24"
				value="<%=""+ConstantesSistema.SIM%>" /> <strong>Sim</strong>
			<html:radio property="sede" tabindex="25"
				value="<%=""+ConstantesSistema.NAO%>" /> <strong>N&atilde;o</strong>
		</td>
	</tr>
    ...
    <tr>
        ...
        <td>
			<html:radio tabindex="30" property="indicadorCoordenadaProgisRA" value="1"/><strong>Sim</strong>
			<html:radio tabindex="30" property="indicadorCoordenadaProgisRA" value="2"/><strong>Não</strong>
		</td>
    </tr>
       ...
       <td><font color="#FF0000">*</font>&nbsp;Campos obrigat&oacute;rios</td>
				...
				<tr>
					<td colspan="2"><input type="button" name="Button"
						...
						onClick="javascript:window.location.href='/gsan/exibirInserirLocalidadeAction.do?menu=sim'"

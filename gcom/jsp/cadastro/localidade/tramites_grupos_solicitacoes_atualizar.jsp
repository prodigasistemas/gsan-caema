...
<!--
    ...
    function recuperarDadosPopup(codigoRegistro, descricaoRegistro,
        ...
        form.action = "exibirAtualizarTramitesGruposSolicitacoesAction.do?consultaUnidade=1&posicaoUnidade="+linhaPesquisa
	...
	function limparUnidade(i){
  		document.forms[0].action = "exibirAtualizarTramitesGruposSolicitacoesAction.do?apagarUnidade=1&posicaoUnidade="+i;
...
<html:form action="/atualizarTramitesGruposSolicitacoesAction"
	name="AtualizarTramitesGruposSolicitacoesActionForm" method="post"
					...
					<%}%>
						...
						<td>
							<html:text property="idsUnidadeOrganizacional" size="4" maxlength="4" 
									   ...
									   onkeyup="validaEnter(event, 'exibirAtualizarTramitesGruposSolicitacoesAction.do?consultaUnidade=1&posicaoUnidade=${i}', 'idsUnidadeOrganizacional[${i}]');return isCampoNumerico(event);" />

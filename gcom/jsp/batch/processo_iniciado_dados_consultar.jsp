		...
		<tr>
			...
			<table width="100%" border="0">
				<tr>
					...
					${requestScope.processoIniciado.processo.descricaoProcesso}
					<c:if test="${not empty processoIniciado.complementoProcesso}" >
					 	- ${requestScope.processoIniciado.complementoProcesso}
					 </c:if></strong>
					</div>
					</div>
					</td>

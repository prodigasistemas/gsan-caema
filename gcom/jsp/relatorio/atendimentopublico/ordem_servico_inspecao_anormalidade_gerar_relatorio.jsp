...
<script type="text/javascript">
	$(document).ready(function(){
		$('#botaoAvancar').click(function(){
			var form = document.forms[0];
			var n = $("input[@name=idsComandos]:checked").length;
			if(n == 0){
				...
				<tr>
					...
					<td width="75%">
						...
						<logic:present name="empresaInexistente" scope="request">
							<html:text property="nomeEmpresa" size="40" maxlength="50"
								readonly="true"
						...
						<a href="javascript:limparEmpresa();"><img border="0" src="imagens/limparcampo.gif" height="21" width="23" title="limpar"></a>
					</td>
				</tr>
				...
				<tr>
					...
					<td>
						<strong> 
							...
							<a href="javascript:abrirCalendarioReplicando('GerarRelatorioBoletimMedicaoOrdemServicoInspecaoAnormalidadeActionForm', 'periodoExecucaoInicial', 'periodoExecucaoFinal');"><img border="0" 
									width="20" 
									border="0" 
									align="absmiddle" 
									title="Exibir Calendário" 
									src="<bean:message key="caminho.imagens"/>calendario.gif"/></a>
						</strong> 
						<strong> a </strong>
						<html:text maxlength="10" 
							...
							onkeypress="return isCampoNumerico(event);"/> 
						<a href="javascript:abrirCalendario('GerarRelatorioBoletimMedicaoOrdemServicoInspecaoAnormalidadeActionForm', 'periodoExecucaoFinal')"><img border="0" 
										...
										<div align="left" style="max-height: 200px; overflow-y: scroll; ">
											<table width="100%" bgcolor="#99CCFF">
												...
												<tr bordercolor="#000000">
													...
													<td width="15%" bgcolor="#90c7fc" align="center"><strong>Data de Execução</strong></td>
												</tr>
											...
											<%	}	%>
														...
														<td width="10%">
															<div align="center">
																<input type="checkbox" name="idsComandos" value="${helper.idComando}">
															</div>
														</td>
														
														<td align="left" width="50%">
															<a	href="javascript:abrirPopup('exibirConsultarComandosOSSeletivaInspecaoAnormalidadePopupAction.do?pesquisa=nao&idComando=<%= helper.getIdComando()%>', 600, 700);">
																<%=helper.getDescComando()%> 
															</a>
														</td>

				...
				<tr>
			        ...
			        <td>
			        	<html:text property="municipio" size="4" maxlength="4" 
			        		onblur="validaNumero(this);"
			        		onkeypress="pesquisarMunicipio(event)" 
			        		onkeyup="somente_numero_zero_a_nove(this);" />
						
						<a href="javascript:chamarPopup('exibirPesquisarMunicipioAction.do', 'municipio', null, null, 570, 700, '', document.forms[0].municipio);">

...
<html:javascript staticJavascript="false"  formName="GerarRelatorioImoveisRateioNegativoActionForm"/>
...
<script language="JavaScript">
	...
	function validarForm(){
		...
		if(validateGerarRelatorioImoveisRateioNegativoActionForm(form) && 
			validarCampos()){
	...
	function chamarPopup(url, tipo, objeto, codigoObjeto, altura, largura, msg,campo){
  	...
  	function reloadForm(){
  		...
  		form.action='exibirGerarRelatorioImoveisRateioNegativoAction.do';
	    form.submit();
  	}
  	...
  	function limpar(){
		...
		form.sequencialRotaFinal.value = "";
  		...
  		form.action='exibirGerarRelatorioImoveisRateioNegativoAction.do?menu=sim';
	    form.submit();
  	}
	...
	function limparOrigem(tipo){
		...
		case 2: //De setor para baixo
			...
			if (!form.setorComercialInicial.disabled){
			   form.nomeSetorComercialInicial.value = "";
			   form.setorComercialFinal.value = "";
			   form.nomeSetorComercialFinal.value = "";
			   form.rotaFinal.value = "";
	...
	function limparBorrachaDestino(tipo){
		...
		switch(tipo){
			...
			case 2: //De setor para baixo
				if (!form.setorComercialFinal.disabled){	   
			   		form.setorComercialFinal.value = ""; 
			   		form.nomeSetorComercialFinal.value = "";
	...
	function recuperarDadosPopup(codigoRegistro, descricaoRegistro, tipoConsulta) {
		...
		if (tipoConsulta == 'localidadeOrigem') {
	  		...
	  		form.action='exibirGerarRelatorioImoveisRateioNegativoAction.do?campoDesabilita=1';
	   		form.submit();
	...
	function recuperarDadosQuatroParametros(idRegistro, descricaoRegistro, codigoRegistro, tipoConsulta) {
		...
		if (tipoConsulta == 'setorComercialOrigem') {
		  	...
		  	form.action='exibirGerarRelatorioImoveisRateioNegativoAction.do?campoDesabilita=2';
	   		form.submit();
		}
	...
	var form = document.GerarRelatorioImoveisRateioNegativoActionForm;	
	...
	function limparDestino(tipo){
		...
		if (!form.localidadeFinal.disabled || !form.setorComercialFinal.disabled){
			switch(tipo){
				case 1: //De localidade pra baixo
					 if(form.localidadeInicial.value != form.localidadeFinal.value){
	...
	function desabilitaTipoSelecao(){
		var form = document.GerarRelatorioImoveisRateioNegativoActionForm;

		if (form.tipoSelecao[0].checked){
...
<html:form action="/gerarRelatorioImoveisRateioNegativoAction"
	name="GerarRelatorioImoveisRateioNegativoActionForm"
	type="gcom.gui.relatorio.faturamento.GerarRelatorioImoveisRateioNegativoActionForm"
	method="post">
	      ...
	      <div align="center">
			...
			<table width="100%" border="0" align="center" cellpadding="0"
				...
				<tr>
					...
					<td class="parabg">Gerar Relat&oacute;rio de Im&oacute;veis com Rateio Negativo</td>
					<td width="11"><img border="0"
			...
			<table width="100%" border="0">
				...
				<tr>
					<td colspan="2">Para filtrar o(s) im&oacute;vel(eis), informe os dados abaixo:</td>
				</tr>
				<tr>
					<td>&nbsp;</td>
				</tr>
				<tr>
					<td>
						<strong>Tipo de sele&ccedil;&atilde;o:<font color="#FF0000">*</font></strong>
					</td>
					<td colspan="2">
						<html:radio property="tipoSelecao" value="todosImoveis" tabindex="3" onchange="javascript:desabilitaTipoSelecao();"/> 
							<strong>Todos os im&oacute;veis</strong>&nbsp; 
						<html:radio property="tipoSelecao" value="porLocalizacao" tabindex="3" onchange="javascript:desabilitaTipoSelecao();"/> 
							<strong>Por localiza&ccedil;&atilde;o</strong>
					</td>
				</tr>
				<tr>
					<td colspan="5"><hr></td>
				...
				<tr>
					...
					<td>
						...
						<html:text maxlength="3" 
							...
							onkeypress="javascript:limparOrigem(1);validaEnterComMensagem(event, 'exibirGerarRelatorioImoveisRateioNegativoAction.do?objetoConsulta=1&campoDesabilita=1','localidadeInicial','Localidade Inicial'); return isCampoNumerico(event);"/>
				...
				<tr>
					...
					<td>
						...
						<html:text maxlength="3" 
							...
							onkeypress="limparOrigem(2);validaEnterComMensagem(event, 'exibirGerarRelatorioImoveisRateioNegativoAction.do?objetoConsulta=2&campoDesabilita=2','setorComercialInicial','Setor Comercial Inicial');return isCampoNumerico(event);"/>
				...
				<tr>
					...
					<td>
						...
						<html:text maxlength="5" 
							...
							onblur="javascript:replicarRota();desabilitaIntervaloDiferente(3);"
							size="5"
				...
				<tr>
					...
					<td>
						...
						<html:text maxlength="3" 
							...
							size="3"
							onkeypress="validaEnterComMensagem(event, 'exibirGerarRelatorioImoveisRateioNegativoAction.do?objetoConsulta=3&campoDesabilita=1','localidadeFinal','Localidade Final');return isCampoNumerico(event);"
				...
				<tr>
					...
					<td>
						...
						<html:text maxlength="3" property="setorComercialFinal"
							size="3"
							onkeypress="validaEnterComMensagem(event, 'exibirGerarRelatorioImoveisRateioNegativoAction.do?objetoConsulta=4&campoDesabilita=2', 'setorComercialFinal', 'Localidade Final');return isCampoNumerico(event);"
...
<%@ include file="/jsp/util/rodape.jsp"%>	
	...
	<jsp:include
		page="/jsp/relatorio/escolher_tipo_relatorio.jsp?relatorio=gerarRelatorioImoveisRateioNegativoAction.do" />

...
<script language="JavaScript">
	...
	function validarForm(){
		...
		if (temLetra(form.idLocalidade.value) == 1){
		      alert('Valor informado da localidade está inválido.');
		} else
	...
	function chamarPopup(url, tipo, objeto, codigoObjeto, altura, largura, msg,campo){
  	...
  	function limpar1(){
  		...
  		form.tipoEspecificacao.value = "-1";
  		form.motivoDevolucao.value = "-1";
  		form.tipoDocumento[3].checked = true;
...
<html:form action="/gerarRelatorioDevolucaoPagamentosDuplicidadeAction.do"
...
<table width="770" border="0" cellspacing="5" cellpadding="0">
	      ...
	      <div align="center">
			...
			<table width="100%" border="0" align="center" cellpadding="0"
				...
				<tr>
					...
					<td class="parabg">Relatório Devolução de Valores </td>
					<td width="11"><img border="0"
			...
			<table width="100%" border="0" style=" width : 600px;">
				...
				<tr>
					<td colspan="2">Para gerar o relat&oacute;rio de devolução de valores, informe os dados abaixo:</td>
				</tr>
				<tr>
					<td>
						<br />
				...
				<tr>
					<td>
						<strong>Tipo de Especificação:<font color="#FF0000">*</font></strong>
					</td>

					<td>
						<strong> 
						<html:select property="tipoEspecificacao" 
									 style="width: 320px;" 
									 tabindex="1">
							<html:option
				...
				<tr>
					<td>
						<strong>Motivo de Devolução:<font color="#FF0000"></font></strong>
					</td>

					<td>
						<strong> 
						<html:select property="motivoDevolucao" 
									 style="width: 320px;" 
									 tabindex="2">
							<html:option
								value="<%=""+ConstantesSistema.NUMERO_NAO_INFORMADO%>">&nbsp;
							...
							<logic:present name="colecaoCobrancaIndevidaMotivo" 
										   scope="request">
							   <html:options collection="colecaoCobrancaIndevidaMotivo"
											 labelProperty="descricao" 
											 property="id" />
							</logic:present>
						</html:select> 														
				...
				<tr>
							<td>
							<strong>Tipo de Documento:<font color="#FF0000"></font></strong>
							</td>

							<td>
							    <html:radio property="tipoDocumento" value="1" tabindex="3" /> 
									<strong>Conta</strong>
								<html:radio property="tipoDocumento" value="2" tabindex="4" /> 
									<strong>Guia de Pagamento</strong> 
								<html:radio property="tipoDocumento" value="3" tabindex="5" />
								    <strong>Débito a Cobrar</strong>
								<html:radio property="tipoDocumento" value="4" tabindex="6" />
								    <strong>Todos</strong>    
						   </td>
				...
				<tr>
					...
					<td>
						...
						<html:select property="idGerencia" 
									 style="width: 230px;" 
									 tabindex="9" onchange="javascript:reload(1);">
							<html:option
								value="<%=""+ConstantesSistema.NUMERO_NAO_INFORMADO%>">&nbsp;
							</html:option>
				...
				<tr>
                   ...
                   <td colspan="2">
                   		...
                   		/>
                      	<a tabindex="12" href="javascript:abrirPopup('exibirPesquisarLocalidadeAction.do', 275, 480);">
							...
							<input type="text" 
								   ...
								   size="35" 
								   readonly="true" 
								   style="background-color:#EFEFEF; border:0; color: #ff0000" tabindex="13"
						...
						<a tabindex="14" href="javascript:limparPesquisaLocalidade();document.forms[0].idLocalidade.focus();"> <img
				...
				<tr>
					<td height="24" colspan="2">
			          	...
			          	<input type="button" 
			          		   ...
			          		   value="Cancelar" tabindex="18" class="bottonRightCol" name="ButtonCancelar">
					</td>
	...
	<jsp:include
			page="/jsp/relatorio/escolher_tipo_relatorio_tela_espera.jsp?relatorio=/gsan/gerarRelatorioDevolucaoPagamentosDuplicidadeAction.do" 
	/>	

...
function validarForm(form){
	if(validateGerarRelatorioAnaliseImovelCorporativoGrandeActionForm(form)){	    
		if(form.idLocalidadeInicial.value.length > 0 && form.idLocalidadeFinal.value.length == 0) {
			...
			javascript:botaoAvancarTelaEspera('/gsan/gerarRelatorioAnaliseImovelCorporativoGrandeAction.do');
	...
	<table width="770" border="0" cellspacing="5" cellpadding="0">
		...
		<tr>
			...
			<table width="100%" border="0">
				...
				<tr>
					<td width="200"><strong>Opção de Totalização:<font color="#FF0000">*</font></strong></td>
					<td colspan="2" align="left">
						<html:radio	property="opcaoTotalizacao" value="1" /> 
				...
				<tr>
					...
					<td colspan="2" align="left"> 
						<html:radio	property="opcaoTotalizacao" value="2" /> 
				...
				<tr>
					<td><strong> <font color="#FF0000"></font></strong></td>
					<td colspan="2" align="left">
						<html:radio property="opcaoTotalizacao" value="3" />
				...
				<tr>
					<td><strong> <font color="#FF0000"></font></strong></td>
					<td colspan="2" align="left"> 
						<html:radio	property="opcaoTotalizacao" value="4" /> 
						<strong>Estado por Perfil</strong>
					</td>
				</tr>
				<tr>
					<td><strong> <font color="#FF0000"></font></strong></td>
					<td width="36%" align="left">
						<html:radio property="opcaoTotalizacao" value="5" /> 
				...
				<tr>
					<td><strong> <font color="#FF0000"></font></strong></td>
					<td align="left">
						<html:radio property="opcaoTotalizacao"	value="6" /> 
						<strong>Unidade de Negocio</strong>
					</td>
				</tr>
				<tr>
					<td><strong> <font color="#FF0000"></font></strong></td>
					<td align="left"> 
						<html:radio property="opcaoTotalizacao"	value="7" /> 
				...
				<tr>
					...
					<td colspan="3">
						<html:select property="regional" tabindex="1" style="width:200px;  height:50px;" multiple="true">
				...
				<tr>
					...
					<td colspan="3">
						<html:select property="unidadeNegocio" tabindex="2" style="width:200px; height:50px;" multiple="true">
							<html:option value="-1"> &nbsp; </html:option>
				...
				<tr>
					...
					<td colspan="3">
						...
						onkeypress="validaEnterComMensagem(event, 'exibirGerarRelatorioAnaliseImovelCorporativoGrandeAction.do', 'idLocalidadeInicial', 'Localidade Inicial');return isCampoNumerico(event);" 
						/>
				...
				<tr>
					...
					<td colspan="3">
						...
						onkeypress= "validaEnterComMensagem(event, 'exibirGerarRelatorioAnaliseImovelCorporativoGrandeAction.do', 'idLocalidadeFinal', 'Localidade Final');return isCampoNumerico(event);"/>
						 
						<a href="javascript:chamarPesquisaLocalidadeFinal();">
							<img border="0" src="imagens/pesquisa.gif" height="21" width="23" title="Pesquisar" ></a>
				...
				<tr>
					...
					<td colspan="3">
						...
						onkeypress="validaEnterDependencia(event, 'exibirGerarRelatorioAnaliseImovelCorporativoGrandeAction.do', this, document.forms[0].idLocalidadeInicial.value, 'Localidade Inicial');return isCampoNumerico(event);" />
                ...
                <tr>
					...
					<td colspan="3">
						...
						onkeypress="validaEnterDependencia(event, 'exibirGerarRelatorioAnaliseImovelCorporativoGrandeAction.do', this, document.forms[0].idLocalidadeFinal.value, 'Localidade Final');return isCampoNumerico(event);" />
				...
				<tr>
					...
					<td >
						<html:select property="idImovelPerfil" tabindex="9" style="width: 175px; height:50px;" multiple="true">
							<html:option value="-1">&nbsp;</html:option>
				...
				<tr>
					...
					<td >
						<html:select property="idCategoria" tabindex="9" style="width: 175px; height:50px;" multiple="true">
							<html:option value="-1">&nbsp;</html:option>
				...
				<tr>
					<td width="200">
						<strong>Ligação de Água Situação:</strong>
					</td>
					<td >
						<html:select property="idLigacaoAguaSituacao" tabindex="9" style="width: 175px; height:50px;" multiple="true">
							<html:option value="-1">&nbsp;</html:option>
				...
				<tr>
					<td width="200">
						<strong>Ligação Esgoto Situação:</strong>
					</td>
					<td >
						<html:select property="idLigacaoEsgotoSituacao" tabindex="9" style="width: 175px; height:50px;" multiple="true">
							<html:option value="-1">&nbsp;</html:option>
							<logic:present name="colecaoLigacaoEsgotoSituacao" scope="session">

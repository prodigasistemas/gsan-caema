	      ...
	      <div align="center">
			...
			<table width="100%" border="0">
	        	...
	        	<tr>
					...
					<td><html:radio property="indicadorInscricaoAtualAnterior"  value="1" /><strong>Inscrição Atual</strong>
					<html:radio property="indicadorInscricaoAtualAnterior"  value="2" /><strong>Inscrição Anterior</strong>
					</td>
				</tr>
				...
				<tr>
					<td>
						<strong>Tipo Geração:<font color="#FF0000">*</font></strong>
					</td>
					<td><html:radio property="tipoGeracao"  value="1" /><strong>Relatório</strong>
					<html:radio property="tipoGeracao"  value="2" /><strong>Resumo</strong>
					</td>
				</tr>
				
				<tr>
					<td>
						<strong>Origem da Atualização:<font color="#FF0000">*</font></strong>
					</td>
					<td><html:radio property="origemAtualizacao"  value="1" /><strong>GSAN</strong>
					<html:radio property="origemAtualizacao"  value="2" /><strong>Ressetorização</strong>
					<html:radio property="origemAtualizacao"  value="3" /><strong>Todos</strong>
					</td>
				</tr>
				<tr>
					<td colspan="2">&nbsp;</td>

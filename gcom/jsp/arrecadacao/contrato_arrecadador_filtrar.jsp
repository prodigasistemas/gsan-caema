			...
			<table width="100%" border="0">
				...
				<tr>
					...
					<td width="68%">
						...
						<html:text  maxlength="20" 
									...
									readonly="true"
									style="background-color:#EFEFEF; border:0; font-color: #000000" />
					<a href="javascript:pesquisaTipoConta('arrecadacao');"><img width="23" height="21" src="<bean:message key='caminho.imagens'/>pesquisa.gif" border="0" title="Pesquisar Conta Depósito Arrecadação"/></a>
					<a href="javascript:limparContaBancaria(document.forms[0],'arrecadacao');"> <img src="<bean:message key="caminho.imagens"/>limparcampo.gif"	border="0" title="Limpar Conta Depósito Arrecadação"/></a>
				  </td>
				</tr>
				...
				<tr>
					...
					<a href="javascript:pesquisaTipoConta('tarifa');">
						<img  width="23" 
							  ...
							  border="0" 
							  title="Pesquisar Conta Depósito Tarifa"/></a>
				...
				<tr>
					...
					<td><html:text  property="dtInicioContrato" 
									...
									onkeypress="return isCampoNumerico(event);"/>
							<a href="javascript:abrirCalendarioReplicando('FiltrarContratoArrecadadorActionForm', 'dtInicioContrato', 'dtFimContrato');"> <img border="0" src="<bean:message key="caminho.imagens"/>calendario.gif" width="20" border="0" align="absmiddle" alt="Exibir Calendário" title="Exibir Calendário"/></a>
						dd/mm/aaaa
					</td>
				</tr>
				...
				<tr>
					...
					<td><html:text  property="dtFimContrato" 
									...
									onkeypress="return isCampoNumerico(event);"/> 
							<a href="javascript:abrirCalendario('InserirContratoArrecadadorActionForm', 'dtFimContrato')"> <img border="0" src="<bean:message key="caminho.imagens"/>calendario.gif" width="20" border="0" align="absmiddle" alt="Exibir Calendário" title="Exibir Calendário"/></a>
						dd/mm/aaaa
					</td>
				</tr>
				<tr>

...
function validarForm(form){
	...
	if(validateFiltrarMovimentoArrecadadoresActionForm(form)){
		...
		else if($("input[@name='tipoSaida']:checked").val() == '1' 
		...
		if (realizarSubmit){
			...
			form.action='filtrarMovimentoArrecadadoresAction.do';
			

			if(form.indicadorRelatorio.value == '1' && $("input[@name='tipoSaida']:checked").val() == '2' ){
				toggleBox('demodiv',1);				
			}else{
				botaoAvancarTelaEspera('/gsan/filtrarMovimentoArrecadadoresAction.do');
			}
...
function limparFormulario(){
	var form = document.forms[0];
	if(form.indicadorRelatorio.value == '1'){
		//form.action='exibirFiltrarAcompanhamentoMovimentoArrecadadoresPorNSAAction.do?menu=sim&relatorio=sim';
		window.location.href='/gsan/exibirFiltrarAcompanhamentoMovimentoArrecadadoresPorNSAAction.do?menu=sim&relatorio=sim';
	}else{
		//form.action='exibirFiltrarMovimentoArrecadadoresAction.do?menu=sim';
		window.location.href='/gsan/exibirFiltrarMovimentoArrecadadoresAction.do?menu=sim';
	}
	//form.submit();
}
...
function habilitarDesabilitarEmail(){
	var form = document.forms[0];
	if($("input[@name='tipoSaida']:checked").val() == '1'){
...
<div id="formDiv"><html:form action="/filtrarMovimentoArrecadadoresAction" method="post">
	<%@ include file="/jsp/util/cabecalho.jsp"%>
	<%@ include file="/jsp/util/menu.jsp"%>
	
	<html:hidden property="indicadorRelatorio"/>
				...
				<table width="100%" border="0">
					...
					<tr>
						...
						<td width="432">
							...
							<a href="javascript:abrirPopup('exibirPesquisarArrecadadorAction.do');"><img width="23" height="21" border="0" src="<bean:message key="caminho.imagens"/>pesquisa.gif" title="Pesquisar Arrecadador" /></a>
										...
										<table width="100%" border="0">
											<tr>
												...
												<td>
													...
													<a href="javascript:abrirCalendario('FiltrarMovimentoArrecadadoresActionForm', 'dataGeracaoMovimentoInicio');"><img align="absmiddle" src="<bean:message key='caminho.imagens'/>calendario.gif" width="20" border="0" alt="Exibir Calendário" tabindex="7" /></a><strong>a</strong> 
													<html:text property="dataGeracaoMovimentoFim" size="11" maxlength="10" tabindex="8" 
													onkeyup="mascaraData(this, event);" 
													onkeypress="return isCampoNumerico(event);"/> 
													<a href="javascript:abrirCalendario('FiltrarMovimentoArrecadadoresActionForm', 'dataGeracaoMovimentoFim')" onkeypress="return isCampoNumerico(event);"><img align="absmiddle" src="<bean:message key='caminho.imagens'/>calendario.gif" width="20" border="0" alt="Exibir Calendário" tabindex="9" /></a>dd/mm/aaaa
												</td>
											</tr>
											...
											<tr>
												...
												<td>
													...
													onkeypress="return isCampoNumerico(event);"/>
													<a href="javascript:abrirCalendario('FiltrarMovimentoArrecadadoresActionForm', 'dataProcessamentoMovimentoInicio');"><img align="absmiddle" src="<bean:message key='caminho.imagens'/>calendario.gif" width="20" border="0" alt="Exibir Calendário" tabindex="11" /></a><strong>a</strong>
													<html:text property="dataProcessamentoMovimentoFim" size="11" maxlength="10" tabindex="12" onkeyup="mascaraData(this, event);" 
													onkeypress="return isCampoNumerico(event);"/> 
													<a href="javascript:abrirCalendario('FiltrarMovimentoArrecadadoresActionForm', 'dataProcessamentoMovimentoFim')"><img align="absmiddle" src="<bean:message key='caminho.imagens'/>calendario.gif" width="20" border="0" alt="Exibir Calendário" tabindex="13" /></a>dd/mm/aaaa
												</td>
											</tr>
										</table>
									</td>
					...
					<tr>
						<td HEIGHT="30"><strong>Tipo de Saída:</strong></td>
						<td><strong>
							<html:radio property="tipoSaida" value="1" onchange="habilitarDesabilitarEmail()">Gerar Arquivo</html:radio>
							<html:radio property="tipoSaida" value="2" onchange="habilitarDesabilitarEmail()">Emitir Relatório</html:radio>							
						</strong></td>
					</tr>
	...
	<div style="position:absolute; left:11px; top:50px;">
		<jsp:include page="/jsp/relatorio/escolher_tipo_relatorio_tela_espera.jsp?relatorio=filtrarMovimentoArrecadadoresAction.do" />
	</div>

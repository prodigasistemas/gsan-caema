...
<script type="text/javascript" language="Javascript1.1">
	...
	var todosDocumentosMarcados = false;
	...
	function selecionarTodosDocumentos(){
		var form = document.forms[0];
		var checkBoxs = form.documentosCobrancaSelecao;
		
		if (checkBoxs != null && checkBoxs.length == null){
			checkBoxs.checked = !todosDocumentosMarcados;
		}else{
			for (var i = 0; i < checkBoxs.length; i++) {
				checkBoxs[i].checked = !todosDocumentosMarcados;
			}
		}
		
		todosDocumentosMarcados = !todosDocumentosMarcados;
	}
	...
	function desabilitarBotaoSelecionar() {
		...
		form.selecionarDebitos.disabled = true;
	}
	...
	function verificaSelecaoImovel() {
		...
		if(form.idImovel.value == null
			...
			form.selecionarDebitos.disabled = false;
...
<table width="770" border="0" cellspacing="5" cellpadding="0">
  <tr>
    <td width="145" valign="top" class="leftcoltext">
		...
		<input type="hidden" name="checkDocumentoCobranca" value="0">
      ...
      <table width="100%" border="0" dwcopytype="CopyTableRow">
        ...
        <tr>
		  ...
		  <td width="82%" >
		    ...
		    <html:text maxlength="9" tabindex="1" property="idImovel" size="9" 
			    ...
			    onkeypress="validaEnter(event, '/gsan/informarAcertoDocumentosNaoAceitosWizardAction.do?destino=2&action=exibirInformarAcertoDocumentosNaoAceitosDebitosAction','idImovel');return isCampoNumerico(event);"/> 
        ...
        <tr>
		  <td align="right" colspan="2">
		  	<input type="button"
				name="selecionarDebitos" class="bottonRightCol"
				disabled="disabled"
				value="Selecionar Débitos Pagos/Parcelados"
		...
		<tr>
			<td colspan="2">
				<table width="100%" align="center" bgcolor="#90c7fc" border="0">
					<tr bordercolor="#79bbfd">
						<td colspan="9" bgcolor="#79bbfd" align="center"><strong>Documentos Cobrança</strong></td>
					</tr>
					<tr bordercolor="#000000">
						<td width="10%" bgcolor="#90c7fc">
							<div align="center">
								<strong><a href="javascript:facilitador(document.forms[0].checkDocumentoCobranca,'documentosCobrancaSelecao');"id="0">Selecionar</a></strong>
							</div>
						</td>
						<td width="10%" bgcolor="#90c7fc">
							<div align="center" class="style9">
						...
						<td width="15%" bgcolor="#90c7fc">
							<div align="center" class="style9">
								<font color="#000000" style="font-size:9px" face="Verdana, Arial, Helvetica, sans-serif"> 
									<strong>Forma de Emiss&atilde;o</strong> 
								</font>
							</div>
						</td>
						<td width="15%" bgcolor="#90c7fc">
					...
					<%cor = "#cbe5fe";%>	
					<logic:present name="colecaoDocumentoCobranca" scope="session">
					<tr>
						<td colspan="9">
							<div style="height: 100%; max-height: 200px; overflow: auto;">
								<table width="100%" align="center" bgcolor="#90c7fc" border="0">
									<logic:iterate name="colecaoDocumentoCobranca"
										...
										<tr bgcolor="#cbe5fe">
											...
											<td width="10%" >
										 		<div align="center">
											 		<input name="documentosCobrancaSelecao" 
											 			value="<c:out value="${cobrancaDocumentoHelper.cobrancaDocumento.id}" ></c:out>" 
											 			type="checkbox"
											 			alt="<%="" + Util.formatarMoedaReal(((CobrancaDocumentoHelper)cobrancaDocumentoHelper).getCobrancaDocumento().getValorDocumento()).trim()%>"
														onclick="totalizarDebito(this);" >
											 	</div>
		                                    </td>
					...
					<tr bgcolor="#cbe5fe">
						<%}%>
						<td bgcolor="#90c7fc" colspan="5">
							<div align="center" class="style9"><font color="#000000"
								style="font-size:9px"
								face="Verdana, Arial, Helvetica, sans-serif"> <strong>Total</strong>
							</font></div>
						</td>
						<td><%=((Collection) session.getAttribute("colecaoDocumentoCobranca")).size()%>
						&nbsp;
						doc(s)</td>
						<td>&nbsp;</td>
						<td>&nbsp;</td>
						...
						<div align="right" class="style9"><font color="#000000"
							style="font-size:9px"
							face="Verdana, Arial, Helvetica, sans-serif"> <%=session.getAttribute("valorDocumentoCobranca")%>
						</font></div>
						</td>
					</tr>
					</logic:present>

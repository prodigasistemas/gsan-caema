...
<script language="JavaScript">
	...
	function validarForm(form){
		...
		if(validateInserirContratoArrecadadorActionForm(form)){
			if(form.bcoArrecadadorConta.value == ""){
				alert("Informe Conta Depósito Arrecadação");
			}else if(form.bcoTarifaConta.value == ""){
				alert("Informe Conta Depósito Tarifa");
	...
	function email () {
	 ...
	 function required () {
		this.aa = new Array("idClienteCombo", "Informe Arrecadador.", new Function ("varName", " return this[varName];"));
		this.ab = new Array("numeroContrato", "Informe Número Contrato.", new Function ("varName", " return this[varName];"));
		this.ac = new Array("idContaBancariaArrecadador", "Informe Conta Depósito Arrecadação.", new Function ("varName", " return this[varName];"));
		this.ad = new Array("idContaBancariaTarifa", "Informe Conta Depósito Tarifa.", new Function ("varName", " return this[varName];"));
		this.ae = new Array("idCliente", "Informe Cliente.", new Function ("varName", " return this[varName];"));
		this.af = new Array("idConvenio", "Informe Código do Convênio.", new Function ("varName", " return this[varName];"));
		this.ag = new Array("tamanhoMaximoIdentificacaoImovel", "Informe Tamanho Máximo para Identificação do Imóvel.", new Function ("varName", " return this[varName];"));
	} 
	
	function IntegerValidations() {
		var form = document.forms[0];
	
 		this.aa = new Array("numeroContrato", "Número Contrato deve somente conter números positivos.", new Function ("varName", " return this[varName];"));
		this.ab = new Array("idCliente", "Cliente deve somente conter números positivos.", new Function ("varName", " return this[varName];"));
		this.ac = new Array("tamanhoMaximoIdentificacaoImovel", "Tamanho Máximo para Identificação do Imóvel deve somente conter números positivos.", new Function ("varName", " return this[varName];")); 
		
//		if(form.valorTarifa.disabled == false){
//			this.ad = new Array("valorTarifa", "Valor da tarifa deve conter apenas números.", new Function ("varName", " return this[varName];"));
//		}
		
		if(form.numeroDiaFloat.disabled == false){
			this.ae = new Array("numeroDiaFloat", "Quantidade de dias FLOAT deve conter apenas números.", new Function ("varName", " return this[varName];"));
		}
		
//		if(form.valorTarifaPercentual.disabled == false){
//			this.af = new Array("valorTarifaPercentual", "Percentual da tarifa deve conter apenas números.", new Function ("varName", " return this[varName];"));
//		}
	}

    function DateValidations () {
	    this.aa = new Array("dtInicioVigencia", "Data inicio da  Vigência inválida.", new Function ("varName", "this.datePattern='dd/MM/yyyy';  return this[varName];"));
    }
	
	function caracteresespeciais () {
		var form = document.forms[0];
		
		this.aa = new Array("numeroContrato", "Número Contrato possui caracteres especiais.", new Function ("varName", " return this[varName];"));
		this.ab = new Array("idCliente", "Cliente possui caracteres especiais.", new Function ("varName", " return this[varName];"));
		this.ac = new Array("tamanhoMaximoIdentificacaoImovel", "Tamanho Máximo para Identificação do Imóvel possui caracteres especiais.", new Function ("varName", " return this[varName];"));
		this.ad = new Array("dtInicioContrato", "Data Início do contrato possui caracteres especiais.", new Function ("varName", "this.datePattern='dd/MM/yyyy'; return this[varName];"));
		this.ae = new Array("dtFimContrato", "Data Fim do Contrato possui caracteres especiais.", new Function ("varName", "this.datePattern='dd/MM/yyyy'; return this[varName];")); 
	
    	if(form.valorTarifa.disabled == false){
    		this.af = new Array("valorTarifa", "Valor da Tarifa possui caracteres especiais.", new Function ("varName", " return this[varName];"));
    	}
    	
    	if(form.numeroDiaFloat.disabled == false){
    		this.ag = new Array("numeroDiaFloat", "Quantidade de dias FLOAT possui caracteres especiais.", new Function ("varName", " return this[varName];"));
    	}
    	
    	if(form.valorTarifaPercentual.disabled == false){
    		this.ah = new Array("valorTarifaPercentual", "Percentual da tarifa possui caracteres especiais.", new Function ("varName", " return this[varName];"));
    	}    	
    }
	...
	function adicionarObjeto(){
		...
		if(validateInteger(form) && validateDate(form)){
			...
			var objDataInicioVigencia = form.dtInicioVigencia;
			
			if( objFormaArrecadacao.value != '-1' ) {
	
				if( (objValorTarifa.value != "" || objValorTarifaPercentual.value != "")  && objNmDiasFloat.value != "" && objDataInicioVigencia.value != "") {
					...
					form.submit();
						...
						alert("Informar valor monetário da tarifa ou percentual para tarifa"); 
				} else if (objNmDiasFloat.value == "" ) {
						alert("Informe Quantidade de dias FLOAT"); 
				} else if(objDataInicioVigencia.value == ""){
					alert("Informe Data inicio da  Vigência");
				}
			} else {
	...
	<table width="770" border="0" cellspacing="5" cellpadding="0">
		<tr>
			...
			<table width="100%" border="0">
				...
				<tr>
					...
					<td width="68%" colspan="2"><strong><b><span class="style2"> 
					  <html:text property="numeroDiaFloat" 
					  			 ...
					  			 tabindex="12"
					  			 style="text-align: right;" 
					  			 onkeypress="javascript:verificaNumeroInteiro(this);"
				...
				<tr>
					<td><strong>Data inicio da  Vigência:<font color="#FF0000">*</font></strong></td>
					<td><html:text property="dtInicioVigencia" size="10" maxlength="10"
						tabindex="8" onkeyup="mascaraData(this, event);"
						onkeypress="return isCampoNumerico(event);" /> <a
						href="javascript:abrirCalendario('InserirContratoArrecadadorActionForm', 'dtInicioVigencia')">
					<img border="0"
						src="<bean:message key="caminho.imagens"/>calendario.gif"
						width="20" border="0" align="absmiddle" title="Exibir Calendário" /></a>
					dd/mm/aaaa</td>
						...
						<tr>
							...
							<table width="100%" bgcolor="#99CCFF">
								<tr bgcolor="#99CCFF">
									...
									<td width="15%">
										<div align="left"><strong>Dt. Inicio Vigência</strong></div>
									</td>
								</tr>
							</table>
							</td>
										...
										<table width="100%" align="center" bgcolor="#99CCFF">
											...
											<logic:iterate name="colecaoArrecadadorContratoTarifaSelecionados" 
												...
												<c:choose>
													...
													<td width="15%">
														<div align="left">
															<logic:present name="arrecadadorContratoTarifa" property="dtTarifaInicio">
																<%= Util.formatarData(arrecadadorContratoTarifa.getDtTarifaInicio())%>
															</logic:present> 
															
															<logic:notPresent name="arrecadadorContratoTarifa" property="dtTarifaInicio">&nbsp;</logic:notPresent>
														</div>
													</td>

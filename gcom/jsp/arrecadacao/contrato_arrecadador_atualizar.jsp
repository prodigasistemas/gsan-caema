...
function validarForm(formulario){
		if(validateAtualizarContratoArrecadadorActionForm(formulario)){
			...
			if(formulario.bcoArrecadadorConta.value == ""){
				alert("Informe Conta Depósito Arrecadação");
			}else if(formulario.bcoTarifaConta.value == ""){
				alert("Informe Conta Depósito Tarifa");
			}else if (validarMotivoCancelamento(formulario)){
...
//		}
	...
	function desabilitaCampo(){
	    ...
	    if( objFormaArrecadacao.value == '-1' ){	        	        
		 ...
		 if(document.getElementById("permissaoAlterarTamanhoMaximo").value == "true"){
		 	form.tamanhoMaximoIdentificacaoImovel.disabled = false;
		 }else{
		 	form.tamanhoMaximoIdentificacaoImovel.disabled = true;
		 }
	}
...
<html:form action="/atualizarContratoArrecadadorAction.do"
	...
	<input type="hidden" id="permissaoAlterarTamanhoMaximo" value="${sessionScope.permissaoAlterarTamanhoMaximo}"/>
	...
	<table width="770" border="0" cellspacing="5" cellpadding="0">
		<tr>
			...
			<table width="100%" border="0">
						...
						<logic:notPresent name="existeCliente">
							...
							<a  href="javascript:limparForm('cliente');"> 
								<img border="0"
									 ...
									 style="cursor: hand;" title="Limpar Cliente" /> 
							</a>
					</td>
				</tr>
				...
				<tr>
					<td width="32%" class="style3"><strong>Código do Convênio:<font color="#FF0000">*</font></strong></td>
					<td width="68%" colspan="2"><strong><b><span class="style2"> <html:text
						property="idConvenio" size="28" maxlength="20" tabindex="5" /> </span></b></strong></td>
				</tr>
				...
				<tr>
					...
					<td><html:text property="dtInicioVigencia" size="10" maxlength="10"
						tabindex="8" onkeyup="mascaraData(this, event);"
						onkeypress="return isCampoNumerico(event);" /> <a
						href="javascript:abrirCalendario('AtualizarContratoArrecadadorActionForm', 'dtInicioVigencia')">
					<img border="0"
						src="<bean:message key="caminho.imagens"/>calendario.gif"

			...
			<table width="100%" border="0">
				<tr>
					...
					<table width="100%" bgcolor="#99CCFF" dwcopytype="CopyTableRow">
						...
						String cor = "#cbe5fe";
						%>
						<logic:present name="colecaoDadosDiariosValores" scope="session">
						<logic:iterate name="colecaoDadosDiariosValores" id="itemHelper" type="FiltrarDadosDiariosArrecadacaoHelper">

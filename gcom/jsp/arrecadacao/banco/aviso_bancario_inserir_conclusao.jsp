...
function recuperarDadosDeducao(tipoDeducao,valorDeducao) {
    ...
    function validateInserirAvisoBancarioActionForm(form) {
      ...
      if (bCancel) {
      	return true; 
      } else if(form.tipoAviso[0].checked == false && form.tipoAviso[1].checked == false){
			alert('Informe Tipo do Aviso.'); 
		} else if ((form.numeroDocumento.value == null) || (form.numeroDocumento.value == '')){
		    alert('Informe Número do Documento.');
		} else if ((form.idFormaArrecadacao.value == null) || (form.idFormaArrecadacao.value == '')
		|| (form.idFormaArrecadacao.value == '-1')){
		    alert('Informe Forma de Arrecadação.');
		} else if ((form.numeroBanco.value == null) || (form.numeroBanco.value == '') ||
		(form.numeroAgencia.value == null) || (form.numeroAgencia.value == '') ||
		(form.numeroConta.value == null) || (form.numeroConta.value == '')){
		    alert('Informe Conta Bancária.');
		} else if ((form.dataRealizacao.value == null) || (form.dataRealizacao.value == '')){
		    alert('Informe Data da Realização do Aviso.');
...
function bloquearObservacoes(){

	var form = document.forms[0];
	
	if(form.idFormaArrecadacao.value == "14"){
		form.observacoes.disabled = false;
	} else {
	    form.observacoes.value = ""; 
		form.observacoes.disabled = true;
	}
}
-->
</script>
...
<body leftmargin="5" topmargin="5" onload="javascript:setarFoco('${requestScope.nomeCampo}'); bloquearObservacoes();">
					...
					<table width="100%" border="0">
						...
						<tr>
							...
							<strong> <html:text property="nomeArrecadador" size="50"
								maxlength="50" readonly="true" tabindex="2"
								style="background-color:#EFEFEF; border:0; font-color: #000000" />
						...
						<tr>
							...
							<td colspan="3"><logic:present name="avisoSelecionado">
								<html:radio property="tipoAviso" value="1" disabled="true" tabindex="5" />
								<strong>Crédito</strong>
								<html:radio property="tipoAviso" value="2" disabled="true" tabindex="6" />
								<strong>Débito</strong>
							</logic:present> <logic:notPresent name="avisoSelecionado">
								<html:radio property="tipoAviso" value="credito" tabindex="7" />
								<strong>Crédito</strong>
								<html:radio property="tipoAviso" value="debito" tabindex="8"/>
								<strong>Débito</strong>
							</logic:notPresent>
							</td>
						</tr>
						<tr>
							...
							<td colspan="3" class="style1"><html:text tabindex="9"
						...
						<tr>
							...
							<td colspan="3" class="style1">
								<html:select onchange="bloquearObservacoes();" property="idFormaArrecadacao" tabindex="10" style="width:200px;">
						...
						<tr>
							<td class="style1"><strong>Observações:</strong></td>
							<td colspan="3" class="style1">
								<html:textarea tabindex="11" property="observacoes" cols="40" rows="4" onkeyup="limitTextArea(document.forms[0].observacoes, 400, document.getElementById('utilizado'), document.getElementById('limite'));"/><br>
						...
						<tr>
							...
							<td colspan="3" class="style1"><html:text property="numeroBanco"
								size="3" maxlength="3" readonly="true" tabindex="12"
								style="background-color:#EFEFEF; border:0; font-color: #000000" />
							<html:text property="numeroAgencia" size="7" maxlength="7" tabindex="13"
								readonly="true"
								style="background-color:#EFEFEF; border:0; font-color: #000000" />
							<html:text property="numeroConta" size="10" maxlength="10" tabindex="14"
								readonly="true"
								style="background-color:#EFEFEF; border:0; font-color: #000000" />
						...
						<tr>
							...
							<td colspan="3" class="style1"><html:text tabindex="15"
						...
						<tr>
							...
							<td colspan="3" class="style1"><html:text tabindex="16"
								property="valorArrecadacao" size="16" maxlength="14"
						...
						<tr>
							...
							<td colspan="3" class="style1"><html:text
								property="valorDevolucao" size="16" maxlength="14" tabindex="17"
								onkeyup="formataValorMonetario(this, 13)"
								onkeypress="return isCampoNumerico(event);"
								style="text-align:right;" /></td>
						</tr>
						<tr>
							<td class="style1"><strong>Valor das Dedu&ccedil;&otilde;es:</strong></td>
							<td colspan="3" class="style1"><html:text
								property="valorDeducoes" size="16" maxlength="14" tabindex="18"
								style="text-align:right;" readonly="true" /></td>
						</tr>
						<tr>
							<td class="style1"><strong>Valor do Aviso:</strong></td>
							<td colspan="3" class="style1"><html:text
								property="valorAviso" size="16" maxlength="14" tabindex="19"
								style="text-align:right;" readonly="true" /></td>
						</tr>
						<tr>
							<td class="style1">&nbsp;</td>
						...
						<tr>
							<td colspan="4">
								<div align="right">
									<input type="button" class="bottonRightCol" value="Calcular" tabindex="20"

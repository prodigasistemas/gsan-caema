...
var bCancel = false; 
   ...
   var bancoTexto = document.forms[0].nomeBanco.value;
   var codigoAgenciaTexto = document.forms[0].nomeAgencia.value;
   var numeroContaTexto = document.forms[0].numeroConta.value;	
		
     if (bCancel) {
     	return true; 
     } else 
        if ((form.idFormaArrecadacao.value == null) || 
            (form.idFormaArrecadacao.value == '') ||
		...
		} else if ((bancoTexto == null) || (bancoTexto == '') ||
		(codigoAgenciaTexto == null) || (codigoAgenciaTexto == '') ||
		(numeroContaTexto == null) || (numeroContaTexto == '')){
...
<body leftmargin="5" topmargin="5" onload="javascript:bloquearObservacoes();">
			...
			<table border="0" width="100%">
				...
				<tbody>
					...
					<tr>
						...
						value="${requestScope.dataAtual}" /><html:text disabled="true"
					...
					<tr>
						<td class="style1" width="156"><strong>Forma de Arrecadação:<font color="#ff0000">*</font></strong></td>
					...
					<tr>
							...
							<td colspan="3" class="style1">
								<html:textarea property="observacoes" cols="40" rows="4" onkeyup="limitTextArea(document.forms[0].observacoes, 400, document.getElementById('utilizado'), document.getElementById('limite'));"/><br>
					...
					<tr>
						...
						<input type="hidden" name="idContaRequest"
							value="<bean:write name="avisoBancario"  property="contaBancaria.id" />">
						<input id="nomeBanco" type="text" size="3" maxlength="3" name="nomeBanco"
							value="<bean:write name="avisoBancario"  property="contaBancaria.agencia.banco.id" />"
							disabled="true"
							style="border: 0pt none ; background-color: rgb(239, 239, 239);" />
						<input id="nomeAgencia" type="text" size="9" maxlength="9" name="nomeAgencia"
							value="<bean:write name="avisoBancario"  property="contaBancaria.agencia.codigoAgencia" />"
							disabled="true"
							style="border: 0pt none ; background-color: rgb(239, 239, 239);" />
						<input id="numeroConta" type="text" size="20" maxlength="20" name="numeroConta"
						...
						<a
							...
							border="0" src="imagens/pesquisa.gif" width="23" height="21" title="Pesquisar Conta Bancária"></a>
					</tr>
					<tr>

...
<!-- Begin
  function recuperarDadosPopup(codigoRegistro, descricaoRegistro, tipoConsulta) {
    ...
    function validateInserirAvisoBancarioActionForm(form) {                                                                   
		...
		if (((form.codigoArrecadador.value == null) || (form.codigoArrecadador.value == '')) && 
		((form.dataLancamento.valeu == null) || (form.dataLancamento.valeu == '')) &&
		((form.codigoConvenio.valeu == null) || (form.codigoConvenio.valeu == ''))){

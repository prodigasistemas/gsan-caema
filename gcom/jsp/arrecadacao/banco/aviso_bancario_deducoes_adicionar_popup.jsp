				...
				<tr>
					...
					<table width="100%" border="0">
						...
						<tr>
							...
							<td width="72%" colspan="3"><html:select tabindex="1"
						...
						<tr>
							<td class="style1"><strong>Valor da
							Dedu&ccedil;&atilde;o:<font color="#FF0000">*</font></strong></td>
							<td colspan="3" class="style1"><html:text
								property="valorDeducaoInclusao" size="16" maxlength="14" tabindex="2"
						...
						<tr>
							...
							<div align="right"><input name="Button" type="button" tabindex="3"

			...
			<table width="100%" border="0">
				<tr>
					...
					<table width="100%" bgcolor="#99CCFF" dwcopytype="CopyTableRow">
						...
						<%String cor = "#cbe5fe"; %>
						<logic:present name="colecaoDadosDiariosElo" scope="session">
						<logic:iterate name="colecaoDadosDiariosElo" id="itemHelper" type="FiltrarDadosDiariosArrecadacaoHelper">
						<% 

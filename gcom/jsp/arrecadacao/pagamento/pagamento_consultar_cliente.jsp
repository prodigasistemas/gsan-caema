			...
			<table width="100%" border="0" style="fonteReduzida">
				...
				if (contad % 2 == 0) {%>
										...
										<tr bgcolor="#cbe5fe">
											...
											<td width="15%" align="center"><logic:notEmpty
												name="pagamentoHistorico" property="guiaPagamentoGeral.guiaPagamentoHistorico">
												<a
													href="javascript:abrirPopup('exibirConsultarGuiaPagamentoAction.do?guiaPagamentoHistoricoId=<%="" + pagamentoHistorico.getGuiaPagamentoGeral().getGuiaPagamentoHistorico().getId() %>')">${pagamentoHistorico.guiaPagamentoGeral.guiaPagamentoHistorico.debitoTipo.descricao}</a>&nbsp;
														</logic:notEmpty><logic:empty name="pagamentoHistorico"
												property="guiaPagamentoGeral.guiaPagamentoHistorico">${pagamentoHistorico.debitoTipo.descricao} </logic:empty>
											</td>
				...
				if (contad % 2 == 0) {%>
												...
												<tr bgcolor="#cbe5fe">
													...
													<td width="15%" align="center"><logic:notEmpty
														name="pagamentoHistorico" property="guiaPagamentoGeral.guiaPagamentoHistorico">
														<logic:notEmpty name="pagamentoHistorico"
															property="guiaPagamentoGeral.guiaPagamentoHistorico.debitoTipo">
															<a
																href="javascript:abrirPopup('exibirConsultarGuiaPagamentoAction.do?guiaPagamentoHistoricoId=<%="" + pagamentoHistorico.getGuiaPagamentoGeral().getGuiaPagamentoHistorico().getId() %>')"><font
																color="#ff0000">${pagamentoHistorico.guiaPagamentoGeral.guiaPagamentoHistorico.debitoTipo.descricao}</font></a>&nbsp;
																	</logic:notEmpty>
													</logic:notEmpty><logic:empty name="pagamentoHistorico"
														property="guiaPagamentoGeral.guiaPagamentoHistorico">${pagamentoHistorico.debitoTipo.descricao}</logic:empty></td>

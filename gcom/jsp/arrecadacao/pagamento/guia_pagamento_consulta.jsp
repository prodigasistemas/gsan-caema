			...
			<logic:present name="guiaPagamento" scope="request">
				...
				<tr>
					...
					<td class="style1"><span class="style1"> <input name="ramoAtividade" type="text" readonly="readonly" 
						style="background-color:#EFEFEF; border:0" value="${requestScope.guiaPagamento.cliente.ramoAtividade.descricao}" size="50" maxlength="45"></span>
					</td>
				</tr>
...
<!-- Parte nova de debito tipo -->
			<tr>
				...
				<table width="100%" align="center" bgcolor="#79bbfd">
					<tr>
						<td colspan="3"><strong>Débito / Crédito Tipo:</strong></td>
					</tr>
					<tr bgcolor="#99CCFF">
									  ...
									  <pg:item>
										...
										<%}%>
										 <td width="10%" align="center">
										   <div>
										   		<logic:notEmpty name="guiaPagamentoItem" property="debitoTipo">
										      		${guiaPagamentoItem.debitoTipo.id}
										      	</logic:notEmpty>
										   		<logic:empty name="guiaPagamentoItem" property="debitoTipo">

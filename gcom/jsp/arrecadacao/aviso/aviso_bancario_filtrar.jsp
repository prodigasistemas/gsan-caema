	...
	<tr>
		...
		<td valign="top" class="centercoltext">
			...
			<table width="100%" border="0">
				<tr>
					...
					<logic:present name="idArrecadadorNaoEncontrado">
						<logic:equal name="idArrecadadorNaoEncontrado" value="exception">
							<html:text property="arrecadadorNomeCliente" size="40" maxlength="40" readonly="true" style="background-color:#EFEFEF; border:0; color: #ff0000" />
						</logic:equal>
						<logic:notEqual name="idArrecadadorNaoEncontrado" value="exception">
							<html:text  property="arrecadadorNomeCliente" size="40" maxlength="40" readonly="true" style="background-color:#EFEFEF; border:0; color: #000000" />
						</logic:notEqual>
					</logic:present> 
					<logic:notPresent name="idArrecadadorNaoEncontrado">
						<logic:empty name="FiltrarAvisoBancarioActionForm" property="arrecadadorCodAgente">
							<html:text  property="arrecadadorNomeCliente" value="" size="40" maxlength="40" readonly="true" style="background-color:#EFEFEF; border:0; color: #ff0000" />
						</logic:empty>
						...
						<a href="javascript:limparArrecadador(document.FiltrarAvisoBancarioActionForm);">
							<img src="<bean:message key="caminho.imagens"/>limparcampo.gif" border="0" title="Apagar Arrecadador" />
						</a>
					</td>
				</tr>
				...
				<tr>
							<td class="style1"><strong>Forma de Arrecadação:</strong></td>
										...
										<html:text  property="dataPrevisaoCreditoDebitoInicio" 
											...
											<a href="javascript:abrirCalendarioReplicando('FiltrarAvisoBancarioActionForm', 'dataPrevisaoCreditoDebitoInicio', 'dataPrevisaoCreditoDebitoFim');">
												<img border="0"
													 ...
													 border="0" 
													 align="absmiddle"
													 alt="Exibir Calendário" /></a> a</strong> 

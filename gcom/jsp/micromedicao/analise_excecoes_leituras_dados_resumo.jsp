													...
													.formatarData(((gcom.cadastro.imovel.bean.ImovelMicromedicao) imovelMicromedicaoIterator)
															...
															<td width="10%" align="center"><font color="#000000"
																...
																title="${imovelMicromedicaoIterator.consumoHistorico.consumoAnormalidade.descricao}">
																	...
																	<logic:present name="imovelMicromedicaoIterator" property="consumoHistorico.consumoAnormalidade">
																		<logic:equal name="imovelMicromedicaoIterator" property="indicadorRisco" value="1">
							 												<a href="javascript:alertaImovelRisco();">
								 												${imovelMicromedicaoIterator.consumoHistorico.consumoAnormalidade.descricaoAbreviada} 
								  											</a> 
							 											 </logic:equal>
							 											<logic:notEqual name="imovelMicromedicaoIterator" property="indicadorRisco" value="1">
						 												 	<a href="javascript:abrirPopupNovo('exibirConsultarFotoConsumoAnormalidadePopupAction.do?id=${idImovel}&anoMes=${imovelMicromedicaoIterator.medicaoHistorico.anoMesReferencia}&medt=${tipoMedicao}&csan=${imovelMicromedicaoIterator.consumoHistorico.consumoAnormalidade.id}', 550, 450);">
						 														${imovelMicromedicaoIterator.consumoHistorico.consumoAnormalidade.descricaoAbreviada}
						 													</a>  
							 											 </logic:notEqual>							 											
							 										</logic:present>	
															...
															<td width="10%" align="center"><font color="#000000"
																...
																<c:choose>
																	<c:when test="${imovelMicromedicaoIterator.indicadorRisco eq '1' }">
																		<a href="javascript:alertaImovelRisco();">
							 												${imovelMicromedicaoIterator.medicaoHistorico.leituraAnormalidadeFaturamento.id} 
							  											</a>
																	</c:when>
																	<c:otherwise>
							 											<a href="javascript:abrirPopupNovo('exibirConsultarFotoMicroMedicaoPopupAction.do?id=${idImovel}&anoMes=${imovelMicromedicaoIterator.medicaoHistorico.anoMesReferencia}&metp=${tipoMedicao}&ltan=${imovelMicromedicaoIterator.medicaoHistorico.leituraAnormalidadeFaturamento.id}', 550, 450);">
							 												${imovelMicromedicaoIterator.medicaoHistorico.leituraAnormalidadeFaturamento.id}
							  											</a>
						  											</c:otherwise>			 
																</c:choose>

	...
	<table width="770" border="0" cellspacing="5" cellpadding="0">
		<tr>
			...
			<table width="100%" border="0">
				...
				<tr>
					<td><strong>Indicador de Foto Obrigatória: </strong></td>
					<td>
						<strong> 
						<html:radio property="indicadorFotoObrigatoria" value="1" /> Sim 
						<html:radio property="indicadorFotoObrigatoria" value="2" /> N&atilde;o 
						</strong>
					</td>
				</tr>

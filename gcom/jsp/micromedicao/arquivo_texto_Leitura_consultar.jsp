...
function servicoTipoCelularChange(form){
		...
		<tr>
			...
			<table width="100%" border="0">
				...
				<tr>
		            ...
		            <td height="24" colspan="2">
                   		<html:text maxlength="3" 
                   				   ...
                   				   size="3"  
                   				   tabindex="7"
                   				   onkeypress="javascript:validaEnterComMensagem(event, 'exibirConsultarArquivoTextoLeituraAction.do', 'idLocalidade', 'Localidade'); return isCampoNumerico(event);"
                   		/>
				...
				<tr>
					...
					<html:select property="servicoTipoCelular" onchange="servicoTipoCelularChange(document.forms[0])" tabindex="4">
						<html:option value="-1">&nbsp;</html:option>
		  ...
		  --%> <gsan:controleAcessoBotao name="Botao" value="Selecionar"
				...
				<tr>
					<td colspan="7" height="23"> 
					 ...
					 <logic:equal name="impressaoSimultania" value="SIM">
						 <input name="compactarButton" type="button" value="Compactar" onclick="javascript:gerarZip();" 
							 	url="retornarArquivoZipLeituraAction.do" class="bottonRightCol" tabindex="13" />
					</logic:equal>
					<logic:equal name="impressaoSimultania" value="NAO">
						 <input name="compactarButton" type="button" value="Compactar" onclick="javascript:gerarZip();" 
							 	url="retornarArquivoZipLeituraAction.do" class="bottonRightCol" disabled="true" tabindex="13" />
					</logic:equal>												
						...
						<td width="100%" align="center">
						 <table width="100%" bgcolor="#99CCFF" border="0">
							<tr bordercolor="#000000" bgcolor="#90c7fc" class="styleFontePeqNegrito">
								...
								<td width="10%" bgcolor="#90c7fc">
								<div align="center"><strong>Sequência Liberação</strong></div>
								</td>
								<td width="10%" bgcolor="#90c7fc">
								...
								<logic:present name="colecaoArquivoTextoRoteiroEmpresa">
									...
									<logic:iterate name="colecaoArquivoTextoRoteiroEmpresa"
										...
										<tr bgcolor="#FFFFFF" class="styleFontePequena">
											...
											<td width="10%" align="center">${arquivoTextoRoteiroEmpresa.numeroSequenciaLeitura}</td>
											
											<td width="10%">
											
											<logic:present name="arquivoTextoRoteiroEmpresa" property="rota">
												<c:choose>
													<c:when test='${arquivoTextoRoteiroEmpresa.colecaoArquivoTextoRoteiroEmpresaFotoHelper != null }'>
...
<!-- 															<td width="100%" > -->
<!-- 																<table width="100%" bgcolor="#99CCFF"> -->
<%-- 																	<logic:present name="arquivoTextoRoteiroEmpresa" property="colecaoArquivoTextoRoteiroEmpresaFotoHelper"> --%>
<%-- 																		<logic:iterate name="arquivoTextoRoteiroEmpresa" property="colecaoArquivoTextoRoteiroEmpresaFotoHelper" id="arquivoTextoRoteiroEmpresaFotoHelper"> --%>
<%-- 																			<%count = count + 1; --%>
<%-- 																			if (count % 2 == 0) {%> --%>
<!-- 																				<tr bgcolor="#cbe5fe" class="styleFontePequena"> -->
<%-- 																			<%} else {%> --%>

...
<!-- Begin
      ...
      return true;
            ...
            if (mensagem != null && mensagem != '') {
       		...
       		return validateRequired(form) 
       			...
       			&& naoTemZeroComMsg(form.vazaoTransicao, 'Vazão Transição')     			
       			&& (form.vazaoTransicao == null 
       					|| form.vazaoTransicao.value == ''           				
       	       			|| testarCampoValorZeroDecimal(form.vazaoTransicao, 'Vazão Transição'))
       	       	&& naoTemZeroComMsg(form.vazaoNominal, 'Vazão Nominal')
           		&& (form.vazaoNominal == null 
                   		|| form.vazaoNominal.value == ''
       				 	|| testarCampoValorZeroDecimal(form.vazaoNominal, 'Vazão Nominal'))
       			&& naoTemZeroComMsg(form.vazaoMinima, 'Vazão Minima')		
           		&& (form.vazaoMinima == null 
                   		|| form.vazaoMinima.value == ''
                       	|| testarCampoValorZeroDecimal(form.vazaoMinima, ' Vazão Mínima'))
                && naoTemZeroComMsg(form.hidrometroFatorCorrecao, 'Erro Macromedidor')		
           		&& ( form.hidrometroFatorCorrecao == null 
                   		|| form.hidrometroFatorCorrecao.value == ''
                   		||	testarCampoValorZeroDecimal(form.hidrometroFatorCorrecao, 'Erro Macromedidor'))
    ...
    function required () {
     ...
     this.ac = new Array("idHidrometroMarca", "Informe Marca.", new Function ("varName", " return this[varName];"));
     this.ad = new Array("idHidrometroDiametro", "Informe Diâmetro.", new Function ("varName", " return this[varName];"));
     this.ae = new Array("idHidrometroCapacidade", "Informe Capacidade.", new Function ("varName", " return this[varName];"));
     this.af = new Array("idNumeroDigitosLeitura", "Informe Número de Digitos.", new Function ("varName", " return this[varName];"));
     this.ag = new Array("idLocalArmazenagem", "Informe Local de Armazenagem.", new Function ("varName", " return this[varName];"));
     this.ah = new Array("indicadorOperacional", "Informe o Indicador Operacional.", new Function ("varName", " return this[varName];"));
	...
	function validarCamposMacroMicro(form){
		...
		if(form.indicadorMacromedidor[0].checked == true){
			...
			if (form.hidrometroClassePressao.value == null 
				...
				mensagem = mensagem + "Informe  Classe pressão.\n";
			}		
			...
			if (form.idHidrometroClasseMetrologica.value == null 
				...
				mensagem = mensagem + "Informe Classe Metrológica.\n";
			}
    ...
    function caracteresespeciais () {
     ...
     this.ae = new Array("tempoGarantiaAnos", "Tempo de Garantia em Anos possui caracteres especiais.", new Function ("varName", " return this[varName];"));
     this.af = new Array("notaFiscal", "Nota Fiscal possui caracteres especiais.", new Function ("varName", " return this[varName];"));
     this.aj = new Array("hidrometroClassePressao", "Classe Pressão possui caracteres especiais.", new Function ("varName", " return this[varName];"));
    }
    ...
    function IntegerValidations () {
     ...
     this.ac = new Array("tempoGarantiaAnos", "Tempo de Garantia em Anos deve somente conter números positivos.", new Function ("varName", " return this[varName];"));
   
     this.ae = new Array("hidrometroClassePressao", "Classe Pressão deve somente conter números inteiros positivos.", new Function ("varName", " return this[varName];"));
     this.af = new Array("tempoGarantiaAnos", "Tempo Garantia Anos deve somente conter números inteiros positivos.", new Function ("varName", " return this[varName];"));
     this.ag = new Array("notaFiscal", "Nota Fiscal deve somente conter números inteiros positivos.", new Function ("varName", " return this[varName];"));
...
function validarForm(form){
	...
	function bloqueiaDados(){
		...
		if(form.indicadorMacromedidor[0].checked == true){
			...
			form.hidrometroClassePressao.style.color = "#000000";
			form.hidrometroClassePressao.readOnly = false;
			form.hidrometroClassePressao.style.backgroundColor = '';

			form.hidrometroFatorCorrecao.style.color = "#000000";
			form.hidrometroFatorCorrecao.readOnly = false;
			form.hidrometroFatorCorrecao.style.backgroundColor = '';

            form.idHidrometroModeloSensor.value = "";
		...
		form.indicadorMacromedidor[1].checked = true;
			...
			form.hidrometroFatorCorrecao.value = "";
			form.hidrometroFatorCorrecao.style.color = "#000000";
			form.hidrometroFatorCorrecao.readOnly = true;
			form.hidrometroFatorCorrecao.style.backgroundColor = '#EFEFEF';

			form.hidrometroClassePressao.value = "";
			form.hidrometroClassePressao.style.color = "#000000";
			form.hidrometroClassePressao.readOnly = true;
			form.hidrometroClassePressao.style.backgroundColor = '#EFEFEF';
  
			form.idHidrometroClasseMetrologica.value = "-1";
            form.idHidrometroClasseMetrologica.style.color = "#000000";
            form.idHidrometroModeloSensor.disabled = true;
            form.idHidrometroModeloSensor.readOnly = true;
    		form.idHidrometroModeloSensor.style.backgroundColor = '#EFEFEF'; 
	...
	<table width="770" border="0" cellpadding="0" cellspacing="5">
		<tr>
			...
			<table width="100%" border="0">
				...
				<tr>
					<td width="40%" align="left"><strong>Vazão Transição:</strong> </td>
					<td><html:text maxlength="6" property="vazaoTransicao" size="6"
				...
				<tr>
					<td width="40%" align="left"><strong>Vazão Nominal:</strong> </td>
					<td><html:text maxlength="6" property="vazaoNominal" size="6"
				...
				<tr>
					<td width="40%" align="left"><strong>Vazão Mínima:</strong> </td>
				...
				<tr>
					<td width="40%" align="left"><strong>Erro do Macromedidor:</strong> </td>
					<td><html:text maxlength="6" property="hidrometroFatorCorrecao" size="6"
						onkeyup="javascript:formataValorMonetario(this,13);" /></td>
				</tr>
				...
				<tr>
					<td><strong>Classe Pressão:</strong></td>
					<td><html:text maxlength="2" property="hidrometroClassePressao" size="4"
						onkeypress="return isCampoNumerico(event);" 
						onkeyup="return isCampoNumerico(event);" 
						onchange="validarCampoNumericoComMensagemLimpandoCampo(document.forms[0].hidrometroClassePressao, 'hidrometro Classe Pressão');" 
						onblur="return isCampoNumerico(event);" 
						tabindex="2" /> </td>
				</tr>

				<tr>
					<td><strong>Modelo do Sensor :</strong></td>
					<td><html:select property="idHidrometroModeloSensor" tabindex="12">
						<html:option
							value="<%=""+ConstantesSistema.NUMERO_NAO_INFORMADO%>">&nbsp;</html:option>

...
<!-- Begin
    ...
    function IntegerValidations () {
     ...
     this.ah = new Array("hidrometroClassePressao", "Classe Pressão deve somente conter números positivos.", new Function ("varName", " return this[varName];"));
   	 this.ai = new Array("tempoGarantiaAnos", "Tempo de Garantia em Anos deve somente conter números positivos.", new Function ("varName", " return this[varName];"));
    }
...
function limparForm(){
	...
	form.idHidrometroModeloSensor.value = "-1";
	limparLocalidade();
	...
	<table width="770" border="0" cellpadding="0" cellspacing="5">
		<tr>
			...
			<table width="100%" border="0">
				...
				<tr>
					<td><strong>Erro do Macromedidor:</strong></td>
					<td><html:text maxlength="6"
								 property="hidrometroFatorCorrecao" 
								 size="6"
								 tabindex="2" 
								 onkeypress="formataValorMonetario( this, 6 ); return isCampoNumerico(event);" 
								 onkeyup="formataValorMonetario( this, 6 );" 
				...
				<tr>
					...
					<td><html:text maxlength="2" property="hidrometroClassePressao" size="9"
						tabindex="2" onkeypress="return isCampoNumerico(event);"
						onkeyup="return isCampoNumerico(event);" 
				...
				<tr>
					<td colspan="2"><strong><font color="#ff0000"> <input name="Submit22"
						...
						onclick="window.location.href='/gsan/exibirFiltrarHidrometroActionMovimentarHidrometro.do?tela=movimentarHidrometro&menu=sim'">&nbsp; <input type="button" name="Button"

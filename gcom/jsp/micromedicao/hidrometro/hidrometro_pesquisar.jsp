	...
	function validarForm(form){
		...
		testarCampoValorZero(form.idLocalArmazenamento, 'Local de Armazenamento')) {
			if( ((form.numeroHidrometro != null && form.numeroHidrometro.value =="") || 
					(form.numeroTombamento != null && form.numeroTombamento.value =="")) && 
					...
					<td colspan="2">
						<table width="100%">
							...
							<logic:notEmpty name="tipoMacromedidor" scope="session">
								<tr>
									<td width="30%"><strong>Tombamento:</strong></td>
									<td><input name="numeroTombamento" type="text" size="10"
										maxlength="10"></td>
								</tr>
							</logic:notEmpty>
							...
							<logic:notEmpty name="tipoMacromedidor" scope="session">
								<tr>
									...
									<td><html:select property="idHidrometroTipo" disabled="true">
										<html:option
											value="<%=""+ConstantesSistema.NUMERO_NAO_INFORMADO%>">&nbsp;</html:option>

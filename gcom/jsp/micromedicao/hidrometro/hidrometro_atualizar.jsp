   ...
   function naoTemZeroComMsg(campo, nomeCampo){
           ...
           return validateRequired(form) 
            ...
            && naoTemZeroComMsg(form.vazaoTransicao, 'Vazão Transição')     			
       		...
       		&& (form.vazaoMinima == null 
                   	...
                   	|| testarCampoValorZeroDecimal(form.vazaoMinima, 'Vazão Minima'))
      }           
   }
    ...
    function caracteresespeciais () {
    	...
    	this.ad = new Array("vazaoTransicao", "Vazão de Transição possui caracteres especiais.", new Function ("varName", " return this[varName];"));
     	...
     	this.af = new Array("vazaoNominal", "Vazão Nominal possui caracteres especiais.", new Function ("varName", " return this[varName];"));
     	this.ag = new Array("vazaoMinima", "Vazão Mínima possui caracteres especiais.", new Function ("varName", " return this[varName];"));
    ...
    function IntegerValidations () {
     this.aj = new Array("anoFabricacao", "Ano de Fabricação deve somente conter números positivos.", new Function ("varName", " return this[varName];"));
     this.al = new Array("tempoGarantiaAnos", "Tempo de Garantia em Anos deve somente conter números positivos.", new Function ("varName", " return this[varName];"));
     this.am = new Array("notaFiscal", "Nota Fiscal deve somente conter números positivos.", new Function ("varName", " return this[varName];"));
...
function validarForm(){
        ...
        if (validateAtualizarHidrometroActionForm(form)&& testarCampoValorZero(form.numeroHidrometro, 'Número Hidrômetro') && testarCampoValorZero(form.anoFabricacao, 'Data Fabricação')&& testarCampoValorZero(form.hidrometroClassePressao, 'Classe Pressão')){
			...
			<tr>
				...
				<td valign="top" class="centercoltext">
					...
					<table width="100%" border="0">
						...
						<tr>
							<td width="218"><strong>Matrícula do Imóvel:</strong>
							</td>
					  ...
					  <html:option
						...
						<tr>
							<td><strong>Classe Metrológica:</strong>
							</td>
						...
						<tr>
							<td><strong>Diâmetro:<font color="#FF0000">*</font>
							</strong>
							</td>
						...
						<tr>
							<td><strong>Número de Digitos:<font color="#FF0000">*</font>
							</strong>
							</td>
						...
						<tr>
							<td width="40%" align="left"><strong>Vazão
									Transição:</strong>
							</td>
						...
						<tr>
							<td width="40%" align="left"><strong>Vazão Nominal:</strong>
							</td>
						...
						<tr>
							<td width="40%" align="left"><strong>Vazão Mínima:</strong>
							</td>
						...
						<logic:equal name="indicadorMacromedidor" value="1">
							...
							<tr>
								<td><strong>Classe Pressão:</strong>
								</td>

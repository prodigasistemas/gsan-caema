...
<%@ page import="gcom.micromedicao.consumo.ConsumoAnormalidadeAtividadeAcao"%>
							...
							<table width="100%" bgcolor="#90c7fc">
								...
								<pg:pager isOffset="true" index="half-full" maxIndexPages="10"
									...
									<logic:iterate name="colecaoConsumoAnormalidadeAcao" id="consumoAnormalidadeAcao"
										type="ConsumoAnormalidadeAtividadeAcao">
									...
									<pg:item>
										...
										<%}%>
											...
											<html:link
												href="/gsan/exibirAtualizarConsumoAnormalidadeAcaoAction.do?menu=s"

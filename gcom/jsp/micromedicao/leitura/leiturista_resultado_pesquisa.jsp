				...
				<logic:iterate name="leituristas" id="leiturista">
					...
					cor = "#cbe5fe";%>
							...
							<logic:empty name="caminhoRetornoTelaPesquisaLeiturista">
								...
								<logic:notEmpty name="retornarCPF">
								    <logic:notEmpty	name="leiturista" property="funcionario">
									  <a href="javascript:enviarDadosQuatroParametros(
									    '<bean:write name="leiturista" property="id"/>', 
									    '<bean:write name="leiturista" property="funcionario.nome"/>', 
									    '<bean:write name="leiturista" property="funcionario.numeroCpf"/>', 'leiturista');">
									    <bean:write name="leiturista" property="funcionario.nome" /> 
									  </a>
									</logic:notEmpty>	    					
									<logic:empty name="leiturista" property="funcionario">								
									    <logic:notEmpty	name="leiturista" property="cliente">
										  <a href="javascript:enviarDadosQuatroParametros(
										    '<bean:write name="leiturista" property="id"/>', 
										    '<bean:write name="leiturista" property="cliente.nome"/>', 
										    '<bean:write name="leiturista" property="cliente.cpf"/>', 'leiturista');">
										    <bean:write name="leiturista" property="cliente.nome" /> 
										  </a>
										</logic:notEmpty>
										<logic:empty name="leiturista" property="cliente">
										    <logic:notEmpty	name="leiturista" property="usuario">
											  <a href="javascript:enviarDadosQuatroParametros(
											    '<bean:write name="leiturista" property="id"/>', 
											    '<bean:write name="leiturista" property="usuario.nomeUsuario"/>', 
											    '<bean:write name="leiturista" property="usuario.cpf"/>', 'leiturista');">
											    <bean:write name="leiturista" property="usuario.nomeUsuario" /> 
											  </a>
											</logic:notEmpty>
										</logic:empty>

...
<SCRIPT LANGUAGE="JavaScript">
	...
	function validarForm(){
		var form = document.forms[0];
		if(validateAtualizarLeituristaActionForm(form) && validarIndicadorAtualizacaoCadastral()){
			if(form.indicadorAtualizacaoCadastral[0].checked || 
				((form.idFuncionario.value != null && form.idFuncionario.value != "") ||(form.idCliente.value != null && form.idCliente.value != ""))){
	       		submeterFormPadrao(form);
	       	}else{
	...
	function validarIndicadorAtualizacaoCadastral(){
		var form = document.forms[0];
		
		if(form.indicadorAtualizacaoCadastral[0].checked 
			&& form.loginUsuario.value == ""){
			alert ('Login do Usuário deve ser informado');
			return false;
		}else if(form.indicadorAtualizacaoCadastral[1].checked && form.numeroImei.value == ""){
			alert('Informe Imei');
			return false;
		}
		...
		<tr>
			...
			<table width="100%" border="0">
				...
				<tr>
					...
					<td>
						<html:text property="numeroEnderecoMac" size="17" maxlength="17" tabindex="4" style="text-transform: uppercase;" onkeyup="javascript:mascaraEnderecoMac(this, event);" />
					</td>	
				</tr>
	            	...
	            	<td><strong>Login do usuário:</strong></td>
	              	<td colspan="6">
	              		<span class="style2"><strong>
							...
							<a href="javascript:chamarPopup('exibirUsuarioPesquisar.do?limpaForm=S&mostrarLogin=S', 'usuario', null, null, 370, 600, '',document.forms[0].loginUsuario);">

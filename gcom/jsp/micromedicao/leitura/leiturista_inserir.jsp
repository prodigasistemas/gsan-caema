...
<SCRIPT LANGUAGE="JavaScript">
	...
	function validarForm(){
		...
		if(validateInserirLeituristaActionForm(form) && validarIndicadorAtualizacaoCadastral()){
			form.empresaID.disabled = false
	...
	function validarIndicadorAtualizacaoCadastral(){
		...
		if(form.indicadorAtualizacaoCadastral[0].checked && form.loginUsuario.value == ""){
			alert('Informe Login do Usuário');
			return false;

...
<script language="JavaScript">
   ...
   function validarIndicadorGerarFiscalizacao(){
	...
	function validarLimiteImoveisRota(){
		...
		if(form.numeroLimiteImoveis.value != "" && (form.leituraTipo.value != '3' && form.leituraTipo.value != '5')){
...
-->
				...
				<tr>
					...
					<img width="23" height="21" border="0" src="<bean:message key="caminho.imagens"/>pesquisa.gif" title="Pesquisar Leiturista" /></a> 

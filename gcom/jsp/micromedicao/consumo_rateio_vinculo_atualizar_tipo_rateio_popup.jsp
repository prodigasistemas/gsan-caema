...
<html:html>
	...
	<body onload="bloquearConsumoRateio();">
									...
									<logic:present scope="session" name="colecaoRateioTipo">
										<table width="100%" border="0">
											<logic:present name="AtualizarTipoRateioPopupActionForm" property="rateioTipoAgua">
												<tr>
													...
													<td width="60%">
														<div align="left">
															<strong> 
																<html:select name="AtualizarTipoRateioPopupActionForm" property="rateioTipoAgua" onchange="bloquearConsumoRateio();">
											...
											<logic:present name="AtualizarTipoRateioPopupActionForm" property="rateioTipoPoco">
												<tr>
													...
													<td width="60%">
														<div align="left">
															<strong> 
																<html:select name="AtualizarTipoRateioPopupActionForm" property="rateioTipoPoco" onchange="bloquearConsumoRateio();">
																	<html:options name="request" collection="colecaoRateioTipo" labelProperty="descricao" property="id" />
																</html:select>
															</strong>
														</div>
											...
											<tr>
											 ...
											 <tr>
											    <td class="style1"><strong>Aceita Rateio negativo:</strong></td>
								              	<td>								              	
								              	Sim 
								              	<logic:equal name="AtualizarTipoRateioPopupActionForm" property="rateioNegativo" value="1">
								              		<input type="radio" name="rateioNegativo" value="1" checked="checked"/>
								              	</logic:equal>
								              	<logic:notEqual name="AtualizarTipoRateioPopupActionForm" property="rateioNegativo"  value="1">
								              		<input type="radio" name="rateioNegativo" value="1" />
								              	</logic:notEqual>
								              	 Não 
								              	<logic:equal name="AtualizarTipoRateioPopupActionForm" property="rateioNegativo"  value="2">
								              		<input type="radio" name="rateioNegativo" value="2" checked="checked" />
								              	</logic:equal>
								              	<logic:notEqual name="AtualizarTipoRateioPopupActionForm" property="rateioNegativo"  value="2">
								              		<input type="radio" name="rateioNegativo" value="2" />
								              	</logic:notEqual>								              	
											</tr>
											<tr>
											    <td class="style1"><strong>Considerar Franquia de consumo para Rateio:</strong></td>
								              	<td>								              	
								              	Sim 
								              	<logic:equal name="AtualizarTipoRateioPopupActionForm" property="rateioConsumoFranquia" value="1">
								              		<input type="radio" name="rateioConsumoFranquia" value="1" checked="checked"/>
								              	</logic:equal>
								              	<logic:notEqual name="AtualizarTipoRateioPopupActionForm" property="rateioConsumoFranquia"  value="1">
								              		<input type="radio" name="rateioConsumoFranquia" value="1" />
								              	</logic:notEqual>
								              	 Não
								              	<logic:equal name="AtualizarTipoRateioPopupActionForm" property="rateioConsumoFranquia"  value="2">
								              		<input type="radio" name="rateioConsumoFranquia" value="2" checked="checked" />
								              	</logic:equal>
								              	<logic:notEqual name="AtualizarTipoRateioPopupActionForm" property="rateioConsumoFranquia"  value="2">

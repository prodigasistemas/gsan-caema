...
<script language="JavaScript">
	...
	function validaForm(form) {
		...
		botaoAvancarTelaEspera('/gsan/inserirConsumoAnormalidadeAcaoAction.do');
	} 
	
	function validateInserirConsumoAnormalidadeAcaoActionForm(form) { return true;}
	...
	function validaAdicionarAcaoMensal(form) {
		...
		if (msg!=""){
			...
			form.action = 'exibirInserirConsumoAnormalidadeAcaoAction.do?objetoConsulta=4';
			form.submit();
		}
	} 
				...
				<tr>
					...
					<td>	
						<html:text maxlength="4" 
							...
							size="5"
							onkeypress="javascript:validaEnterComMensagem(event, 'exibirInserirConsumoAnormalidadeAcaoAction.do?objetoConsulta=1','idServicoTipo','Tipo de Serviço');return isCampoNumerico(event);"/>
											...
											<td width="10%">
									            <div align="center"><font color="#333333"> <img width="14"
									             ...
									             src="<bean:message key="caminho.imagens"/>Error.gif"
										             onclick="javascript:document.forms[0].target='';if(confirm('Confirma remoção?')){redirecionarSubmit('exibirInserirConsumoAnormalidadeAcaoAction.do?objetoConsulta=5&idAcaoMensal=<bean:write name="acao" property="id2"/>');}"
										              />
									            </font></div>
									       </td>	
									       <td align="center">

...
<script language="JavaScript">
	...
	function bloquearRota(indicador){
	...
	function bloquearSetorComercial(indicador){
		var form = document.forms[0];
		if(indicador == 1){
...
<html:form action="/gerarRelatorioRegistrarLeiturasAnormalidadesAction"
	...
	<table width="770" border="0" cellspacing="5" cellpadding="0">
		<tr>
			...
			<table width="100%" border="0">
				...
				<tr>
					<td><strong>Selecionar apenas as anormalidades que impactam no faturamento:</strong></td>
					<td>						
	...
	<logic:present name="bloquearRota" scope="session">
		<script>
			bloquearRota(1);	
		</script>
	</logic:present>
	
	<logic:present name="bloquearSetorComercial" scope="session">
		<script>
			bloquearSetorComercial(1);	
		</script>
	</logic:present>

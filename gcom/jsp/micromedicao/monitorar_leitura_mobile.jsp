...
function alertaImovelRisco(){
	alert('O imóvel não possui foto de anormalidade de leitura por ser um imóvel de RISCO.');
}
					...
					<tr bgcolor="#cbe5fe" >
						...
						<table width="100%" bgcolor="#99CCFF">
							<tr bordercolor="#000000" bgcolor="#90c7fc">
								...
								<div align="center"><strong>Leit. Anterior</strong></div>
								</td>
								<td width="11%" bgcolor="#90c7fc">
								<div align="center"><strong>Leit. Atual</strong></div>
								</td>
								<td width="7%" bgcolor="#90c7fc">
								<div align="center"><strong>Leit. Anormal.</strong></div>
								</td>
								<td width="7%" bgcolor="#90c7fc">
								<div align="center"><strong>Cons. Anormal.</strong></div>
								</td>
							...
							if (cont % 2 == 0) {%>
									...
									<tr bgcolor="#FFFFFF">
										...
										<td width="15%" align="center">
										<c:choose>
										 <c:when test='${movimento.leituraAnormalidade != null && movimento.leituraAnormalidade.id != null && movimento.leituraAnormalidade.id != 0 }'>
											
											<c:set var="indicadorRisco" value="${movimento.inscricao}" />
											<c:choose>
												<c:when test="${empty sessionScope[indicadorRisco]}">
		 											<a href="javascript:abrirPopup('exibirConsultarFotoMicroMedicaoPopupAction.do?id=${movimento.imovel.id}&anoMes=${movimento.anoMesMovimento}&metp=${movimento.medicaoTipo.id}&ltan=${movimento.leituraAnormalidade.id}', 450, 550);">
										...
										<td width="15%" align="center">
										<c:choose>
											<c:when test='${movimento.codigoAnormalidadeAnterior != null && movimento.codigoAnormalidadeAnterior != 0 && movimento.descricaoAnormalidadeAnterior != null }'>
	 											<a href="javascript:abrirPopup('exibirConsultarFotoConsumoAnormalidadePopupAction.do?id=${movimento.imovel.id}&anoMes=${movimento.anoMesMovimento}&medt=${movimento.medicaoTipo.id}&csan=${movimento.codigoAnormalidadeAnterior}', 450, 550);">
	 												${movimento.descricaoAnormalidadeAnterior}
	 											</a>  											
											</c:when>
										 	<c:otherwise>

...
function validarForm(form){
	if (validateInformarDadosGeracaoRelatorioConsultaPeriodoActionForm(form)){
		...
		if(validarPeriodoInicial(form) && validarPeriodoFinal(form)){
		    if (form.tipoAnaliseFaturamento == undefined){
...
function validarCampos(){
	...
	if (opcaoSelected == "6" || opcaoSelected == "20"){
       ...
       if ( form.grupoCobranca == null ) {
           if ( form.grupoFaturamento.value == null || form.grupoFaturamento.value == "" ) {
	   			alert("Grupo de Faturamento é obrigatorio.");
	   			validacao = false;
	   		}
	   } else {
		   alert("Grupo de Cobrança é obrigatorio.");
		   validacao = false;
	   }
		...
		if ( form.gerencialRegional.value == null || form.gerencialRegional.value == "" ) {
			alert("Gerência Regional é obrigatorio.");
			validacao = false;
		}
       ...
       if ( form.unidadeNegocio.value == null || form.unidadeNegocio.value == "" ) { 
			alert("Unidade de Negócio é obrigatorio.");
	   		validacao = false;
       }
	   ...
	   if ( form.localidade.value == null || form.localidade.value == "" ) { 
			alert("Localidade é obrigatorio.");
			validacao = false;
       }
		...
		if ( form.setorComercial.value == null || form.setorComercial.value == "" ) { 

			alert("Setor Comercial é obrigatorio.");
			validacao = false;
       }
    }
	else if (opcaoSelected == "18"){

		if ( form.quadra.value == null || form.quadra.value == "" ) { 

			alert("Quadra é obrigatorio.");
			validacao = false;
       }
       ...
       if ( form.municipio.value == null || form.municipio.value == "" ) { 
			alert("Município é obrigatorio.");
			validacao = false;
       }
...
<body leftmargin="5" topmargin="5" onload="setarFoco('${requestScope.nomeCampo}'); habilitaDesabilitaCampos();">
  ...
  <tr>
	...
	<td width="625" valign="top" class="centercoltext">
	  ...
	  <tr>
        ...
        <td>
			<html:select property="opcaoTotalizacao" style="width: 350px;" tabindex="2" >
      ...
      <tr>
        ...
        <td width="432">
        	...
        	<html:text property="localidade" 
        				size="4" 
        				maxlength="3" 
        				tabindex="6" 
        				onblur="validaNumero(this);"
        				onkeyup="somente_numero(this);limparSetor();"
        				onkeypress="validaEnterComMensagem(event, 'exibirInformarDadosGeracaoRelatorioConsultaPeriodoAction.do?pesquisarLocalidade=OK', 'localidade', 'Localidade');return isCampoNumerico(event);"/>
      ...
      <tr>
        ...
        <td width="432">
        	...
        	<html:text property="municipio" size="4" maxlength="4" tabindex="6" 
        	onkeyup="somente_numero(this);"
        	onblur="validaNumero(this);"
        	onkeypress="validaEnterComMensagem(event, 'exibirInformarDadosGeracaoRelatorioConsultaPeriodoAction.do?pesquisarMunicipio=OK', 'municipio', 'Município');return isCampoNumerico(event);"/>
      ...
      <tr>
        ...
        <td width="432">
        	...
        	<html:text property="setorComercial" size="4" maxlength="3" tabindex="7" 
        	onkeyup="somente_numero(this);"
        	onblur="validaNumero(this);"
        	onkeypress="validaEnterDependenciaComMensagem(event, 'exibirInformarDadosGeracaoRelatorioConsultaPeriodoAction.do?pesquisarSetorComercial=OK', this, document.forms[0].localidade.value, 'Localidade', 'Setor Comercial');return isCampoNumerico(event);"/>
        	...
        	<a href="javascript:limparSetorComercial();" title="Apagar"><img src="<bean:message key='caminho.imagens'/>limparcampo.gif" border="0"></a>
		</td>
      </tr>
      <tr>
        ...
        <td width="432">
        	...
        	<html:text property="quadra" size="4" maxlength="4" tabindex="8" 
        	onkeyup="somente_numero(this);"
        	onblur="validaNumero(this);"
        	onkeypress="validaEnterDependenciaComMensagem(event, 'exibirInformarDadosGeracaoRelatorioConsultaPeriodoAction.do?pesquisarQuadra=OK', this, document.forms[0].setorComercial.value, 'Setor Comercial', 'Quadra');return isCampoNumerico(event);"/>
      ...
      <tr>
		...
		<td><html:hidden property="idRota" /> <html:text maxlength="4"
			...
			onkeypress="habilitaDesabilitaCampos();return isCampoNumerico(event);"
			style="background-color:#EFEFEF; border:0; color: #000000" /> <a
			href="javascript:pesquisarRota(); " title="Pesquisar">
      ...
      <logic:present name="analiseFaturamento" scope="session">
	  	<tr>
	      	<td HEIGHT="30"><strong>Tipo de Análise:</strong><font color="#FF0000">*</font></td>
	        <td>

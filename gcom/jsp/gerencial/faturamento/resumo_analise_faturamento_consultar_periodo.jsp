				                    	...
				                    	<table width="100%" border="0">
				                        	...
				                        	<tr>
							                    ...
							                    <td height="10">Valor Faturado</td>
				                          		<td>
				                          			<strong>
				                          				<input name="valorEsgoto" type="text"  disabled style="background-color:#EFEFEF; border:0; text-align:right; color: #000000;" value="<bean:write name="ResumoAnaliseFaturamentoActionForm" property="valorEsgoto"   />" size="15" maxlength="15">
				                          			</strong>
				                          		</td>
					                        </tr>
					                        <tr>

...
<html:form action="/exibirGerarRelatorioRetornoOSFiscalizacaoAction.do"
	...
	<table width="570" border="0" cellpadding="0" cellspacing="5">
		<tr>
			...
			<input type="hidden" name="cobrancaAcaoId" value="${sessionScope.cobrancaAcaoId}"/>
			<input type="hidden" name="idCobrancaAcaoSituacao" value="${sessionScope.idCobrancaAcaoSituacao}"/>

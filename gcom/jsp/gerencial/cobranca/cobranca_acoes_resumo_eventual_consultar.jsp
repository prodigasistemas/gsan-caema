						  ...
						  <tr>
						    <td rowspan="2" bgcolor="#cbe5fe" width="32%">
							  ...
							  if (((CobrancaAcaoSituacaoHelper) cobrancaAcaoSituacao).getId().intValue() != CobrancaAcaoSituacao.PENDENTE.intValue()){
								  if (ehFiscalizacao){
									  if (((CobrancaAcaoSituacaoHelper) cobrancaAcaoSituacao).getId().intValue() == CobrancaAcaoSituacao.FISCALIZADA.intValue()){
										  %>							  
										  &nbsp;&nbsp;
										  <a href="javascript:abrirPopup('exibirConsultarResumoAcaoCobrancaSituacaoAcaoAnoMesDetalhesPopupAction.do?tipoDetalhe=eRF&idCobrancaAcao=<bean:write name="resumoAcaoCobranca" property="id"/>&idCobrancaAcaoSituacao=<bean:write name="cobrancaAcaoSituacao" property="id"/>
											  							&cobrancaAcaoSituacao=<bean:write name="cobrancaAcaoSituacao" property="descricao"/>
											  							&quantidadeTotal=<bean:write name="cobrancaAcaoSituacao" property="quantidadeDocumento"/>&valorTotal=<bean:write name="cobrancaAcaoSituacao" property="valorDoumento"/>', 500, 650);"><img border="0" src="imagens/calendar.gif" width="20" height="22" title="Resumo Mensal" /></a>							  
										 <%
									  }
							  %>							  
							  &nbsp;&nbsp;
							  <a href="javascript:abrirPopup('exibirConsultarResumoAcaoCobrancaSituacaoAcaoDetalhesPopupAction.do?tipoDetalhe=eF&idCobrancaAcao=<bean:write name="resumoAcaoCobranca" property="id"/>&idCobrancaAcaoSituacao=<bean:write name="cobrancaAcaoSituacao" property="id"/>
								  							&cobrancaAcaoSituacao=<bean:write name="cobrancaAcaoSituacao" property="descricao"/>
								  							&quantidadeTotal=<bean:write name="cobrancaAcaoSituacao" property="quantidadeDocumento"/>&valorTotal=<bean:write name="cobrancaAcaoSituacao" property="valorDoumento"/>', 400, 600);"><img border="0" src="imagens/fiscalizada.jpg" width="20" height="22" title="Situação Encontrada" /></a>							  
							 <%
								  }
							 %>
							  &nbsp;&nbsp;
							  <a href="javascript:abrirPopup('exibirConsultarResumoAcaoCobrancaSituacaoAcaoDetalhesPopupAction.do?tipoDetalhe=eE&idCobrancaAcao=<bean:write name="resumoAcaoCobranca" property="id"/>&idCobrancaAcaoSituacao=<bean:write name="cobrancaAcaoSituacao" property="id"/>
								  							&cobrancaAcaoSituacao=<bean:write name="cobrancaAcaoSituacao" property="descricao"/>
								  							&quantidadeTotal=<bean:write name="cobrancaAcaoSituacao" property="quantidadeDocumento"/>&valorTotal=<bean:write name="cobrancaAcaoSituacao" property="valorDoumento"/>', 400, 600);"><img border="0" src="imagens/pastaAzul.jpg" width="25" height="23" title="Motivo da Baixa da Ordem"/></a>							  
							 <%
							  }
							 %>									  							
						    </td>

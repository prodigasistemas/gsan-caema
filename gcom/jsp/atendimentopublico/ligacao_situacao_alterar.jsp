...
<script language="JavaScript">
	...
	function desabilitaCombos(){
		...
		}		if ( form.indicadorVeioEncerrarOS != null && form.indicadorVeioEncerrarOS.value != null 				&& form.indicadorVeioEncerrarOS.value == '1' ) {			form.indicadorTipoLigacao[0].disabled = true;			form.indicadorTipoLigacao[1].disabled = true;			form.indicadorTipoLigacao[2].disabled = true;			form.idOrdemServico.disabled = true;					}
	...
	function limparForm() {
		...
		if ( form.indicadorVeioEncerrarOS.value == null || form.indicadorVeioEncerrarOS.value != '1' ) {
...
<html:form action="/exibirAlterarSituacaoLigacaoAction.do"
	...
	<table width="770" border="0" cellspacing="5" cellpadding="0">
		<tr>
			...
			<td width="615" valign="top" class="centercoltext">						<html:hidden property="indicadorVeioEncerrarOS" />				
			<table height="200%">
				<tr>
					<td></td>
				</tr>

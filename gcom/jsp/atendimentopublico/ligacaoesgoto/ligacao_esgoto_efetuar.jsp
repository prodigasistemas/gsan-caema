...
<script language="JavaScript">
	...
	function validaForm() {
		...
		if ((form.motivoNaoCobranca != undefined && form.motivoNaoCobranca.value == '-1') 
				&& (form.quantidadeParcelas != undefined && form.quantidadeParcelas.value == '')){
		     alert("É necessário informar a quatidade de parcelas.");
		} else
		if ((form.motivoNaoCobranca != undefined && form.motivoNaoCobranca.value == '-1') 
				&& (form.quantidadeParcelas != undefined && form.quantidadeParcelas.value == 0)){
	...
	function limparForm() {
		...
		form.condicaoEsgotamento.selectedIndex = 0;
		...
		form.situacaoCaixaInspecao.selectedIndex = 0;
		form.destinoDejetos.selectedIndex = 0;
		form.destinoAguasPluviais.selectedIndex = 0;
						...
						<tr>
							...
							<table width="100%" border="0" align="center" cellpadding="0"
								...
								<tr>
									...
									<logic:present name="factivelFaturavel">
										<td class="parabg">Efetuar Ligação de Esgoto Factível Faturável</td>
									</logic:present>
									<logic:notPresent name="factivelFaturavel">
									...
									<table width="100%" border="0" align="center">
										...
										<logic:present name="factivelFaturavel">
											<td height="10" colspan="2">Para efetuar a
												liga&ccedil;&atilde;o de esgoto factível faturável, informe os dados abaixo:.</td>
										</logic:present>
										<logic:notPresent name="factivelFaturavel">
											<td height="10" colspan="2">Para efetuar a
													...
													<table border="0" width="100%">
														...
														<tr>
															...
															<td colspan="2"><strong> <html:select
																...
																onchange="redirecionarSubmit('exibirEfetuarLigacaoEsgotoAction.do?refresh=true');"
																style="width: 230px;">
																...
																<table border="0" width="100%">
																	...
																	<logic:present name="permissaoMotivoNaoCobranca">
																		...
																		<tr>
																			...
																			<td colspan="4" align="right"><input type="button"
																				...
																				onclick="calcularValores();" style="width: 80px" readonly="false" ></td>
																		</tr>
																	...
																	<logic:notPresent name="permissaoMotivoNaoCobranca">
																		...
																		<tr>
																			...
																			<td colspan="2"><strong> <html:text property="quantidadeParcelas" size="5" maxlength="5" readonly="false" disabled="false" /></strong></td>
										...
										<tr>
											<td width="40%" align="left"><logic:present
												...
												<INPUT TYPE="button" class="bottonRightCol" value="Voltar"
													onclick="ativarVoltar('${caminhoRetornoIntegracaoComercial}')" />

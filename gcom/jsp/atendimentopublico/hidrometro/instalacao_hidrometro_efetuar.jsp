									...
									<table width="100%" border="0" align="center">
										...
										<tr>											<html:hidden property="idLocalArmazenagem" />
											...
											<td><!-- Campo Ordem de Serviço --> <html:text
												property="idOrdemServico" size="12" maxlength="9"
												...
												onkeyup="javascript:limparDecricaoEfetuar()" /> <a title="Pesquisar"
											...
											<img src="/gsan/imagens/pesquisa.gif" alt="Pesquisar"
												...
												<logic:equal name="ordemServicoEncontrado" value="exception">
													<html:text property="nomeOrdemServico" size="45"
											...
											<table width="100%" border="0" bgcolor="#99CCFF">
												...
												<tr bgcolor="#cbe5fe">
													...
													<table border="0" width="100%">																											<tr>																											<td><strong>Tipo Hidrômetro:</strong></td>															<td><strong> 																<html:radio property="indicadorTipoHidrometro" value="1" onchange="reload(1)"/><strong>Micromedidor 																<html:radio	property="indicadorTipoHidrometro" value="2" onchange="reload(2)"/>Macromedidor</strong>															</strong></td>														</tr>																												<c:choose>
															<c:when test="${EfetuarInstalacaoHidrometroActionForm.indicadorTipoHidrometro == '1'}">																<tr>																	
																	...
																	<td width="58%"><html:text property="numeroHidrometro"		
																		...
																		onkeypress="validaEnterString(event, 'exibirEfetuarInstalacaoHidrometroAction.do?veioEncerrarOS=${EfetuarInstalacaoHidrometroActionForm.veioEncerrarOS}', 'numeroHidrometro','Número do Hidrômetro');" />		
																	<a title="Pesquisar"		
																		href="javascript:pesquisarHidrometro()">		
																	<img src="/gsan/imagens/pesquisa.gif" alt="Pesquisar"		
																		border="0" height="21" width="23"></a><a		
																		href="javascript:limparNumeroHidrometro()" title="Apagar"><img		
																		border="0" title="Apagar"		
																		src="<bean:message key='caminho.imagens'/>limparcampo.gif" /></a>		
																	</td>		
																</tr>															</c:when>																														<c:otherwise>																															<tr>																																		<td width="37%" class="style3"><strong>Tombamento:																					<font color="#FF0000">*</font></strong></td>																					<td width="58%"><html:text property="numeroTombamento"																				size="13" maxlength="10"																				onkeypress="validaEnterString(event, 'exibirEfetuarInstalacaoHidrometroAction.do?tombamento=ok', 'numeroTombamento','Tombamento');" />																			<a																				href="javascript:pesquisarHidrometroTombamento()">																			<img src="/gsan/imagens/pesquisa.gif" alt="Pesquisar"																				border="0" height="21" width="23"></a><a																				href="javascript:limparNumeroTombamento()"><img																				border="0" title="Apagar"																				src="<bean:message key='caminho.imagens'/>limparcampo.gif" /></a>																			</td>																		</tr>																														</c:otherwise>														</c:choose>																												
														<tr>
														...
														</tr>																												<tr>															<td><strong>Telemedido:<font color="#FF0000">*</font></strong></td>															<td><strong> <html:radio property="indicadorMedicaoTelemedido"																value="1" /> <strong>SIM <html:radio																property="indicadorMedicaoTelemedido" value="2"/> NÃO</strong> </strong></td>														</tr>		
									...
									<table width="100%">
										...
										<tr>
											<td width="40%" align="left">												<logic:present
												...
												</logic:present> 																							<input name="Button" type="button"												class="bottonRightCol" value="Limpar" align="left"												onclick="window.location.href='<html:rewrite page="/exibirEfetuarInstalacaoHidrometroAction.do?limparForm=sim"/>'">																																				<input type="button"

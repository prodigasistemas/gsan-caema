...
<script language="JavaScript"><!--
	...
	function limparHidrometroSemMedicao(){
		...
		if(form.indicadorTipoHidrometro[0].checked){
			...
			form.indicadorTipoHidrometro[0].checked = false;
			
		}
		else if(form.indicadorTipoHidrometro[1].checked){
						...
						<!-- Ordem de Serviço -->
							<tr>
								...
								<td><span class="style2"> <html:text property="idOrdemServico"
									...
									onkeyup="limparOS();bloqueiaImovel();" /> <a
								...
								<tr bgcolor="#cbe5fe">
									...
									<table border="0" width="100%">
										...
										<tr>
											...
											<td><strong> 
												<html:radio property="indicadorTipoHidrometro" value="1" disabled="true"/><strong>Micromedidor 
												<html:radio	property="indicadorTipoHidrometro" value="2" disabled="true"/>Macromedidor</strong>
											</strong></td>
										</tr>
										
										<c:choose>
											<c:when test="${AtualizarInstalacaoHidrometroActionForm.indicadorMacromedidor == '2'}">
												<tr>
										...
										<tr>
											<td width="25%"><strong>Telemedido:</strong></td>

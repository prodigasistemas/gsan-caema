...
<script language="JavaScript">
	...
	function limparForm(){
		...
		form.action = 'exibirConsultarArquivoTextoOSVisitaAction.do?menu=sim';
		form.submit();
	}
	...
	<table width="780" border="0" cellspacing="5" cellpadding="0">
		<tr>
			...
			<table width="100%" border="0">
				...
				<tr>
	                <td style="width: 100px;"><strong>Localidade<font color="#FF0000">*</font>:</strong></td>
	                <td colspan="2"><strong>
							...
							<tr>
								...
								<td align="right">
									<gsan:controleAcessoBotao name="Botao" value="Selecionar"
										onclick="validaForm();"
										url="consultarArquivoTextoOSVisitaAction.do" tabindex="13" />
								</td>
							</tr>
						</table>
					</td>

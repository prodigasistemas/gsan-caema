...
--%>
				...
				<tr>
					<td><strong><span class="style2">Indicador de Geração de Resumo:<font
						color="#FF0000">*</font></span></strong></td>
					<td align="left" width="20%"><label> <html:radio
				...
				<tr>
					<td><strong><span class="style2">Indicador Programação Automática:</span></strong></td>
					<td align="left" width="20%"><label> 
				...
				<tr>
					<td><strong><span class="style2">Indicador de criação de novas etapas no celular:<font color="#FF0000">*</font></span></strong></td>
					<td align="left" width="20%"><label> <html:radio
				...
				<tr>
					<td><strong><span class="style2">Indicador de Serviço de Cobrança:<font color="#FF0000">*</font></span></strong></td>
					<td align="left" width="20%"><label> <html:radio
				...
				<tr>
					<td><strong><span class="style2">Indicador de Serviço de Micromedição:<font color="#FF0000">*</font></span></strong></td>
					<td align="left" width="20%"><label> <html:radio

...
<script language="JavaScript">
	...
	function limparForm() {
	    ...
	    form.metragemPavimentoRua.value = "";
	    form.idPavimentoRua.selectedIndex = 0;
	    form.idUnidadeRepavimentadora.selectedIndex = 0;
              		...
              		<tr bgcolor="#cbe5fe"> 
                		<td> 
                			<table border="0" width="100%">
                    			...
                    			<logic:notEmpty name="GerarOrdemServicoActionForm" property="indicadorPavimentoRua">
									<logic:equal name="GerarOrdemServicoActionForm" property="indicadorPavimentoRua" 
												value="<%=""+ConstantesSistema.SIM %>">

										<tr>
											<td class="style3"><STRONG>Pavimento de Rua:<FONT color=#ff0000>*</FONT></STRONG></td>
											<td colspan="3"><html:select property="idPavimentoRua"
													tabindex="2">
													<html:option value="-1"> &nbsp; </html:option>
										...
										<tr> 
											<td class="style3"><STRONG>Metragem:<FONT color=#ff0000>*</FONT></STRONG> </td>
											<td colspan="3">
												<html:text property="metragemPavimentoRua" size="6" maxlength="5"
														onkeyup="javascript:formataValorMonetario(this, 5)"
														onkeydown="javascript:formataValorMonetario(this, 5)" />&nbsp;<STRONG>m²</STRONG>
											</td>
										</tr>
										
										<tr>
											<td class="style3"><strong>Unidade
													Repavimentadora:<FONT color=#ff0000>*</FONT></strong></td>
											<td colspan="3"><html:select
													property="idUnidadeRepavimentadora" tabindex="2">
													<html:option value="-1"> &nbsp; </html:option>

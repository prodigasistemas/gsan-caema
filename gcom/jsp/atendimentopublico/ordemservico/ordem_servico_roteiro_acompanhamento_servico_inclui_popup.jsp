...
<script language="JavaScript">
   	...
   	function limpar() {
		var form = document.forms[0];
   		var actionRetorno = 'exibirAcompanhamentoArquivosRoteiroIncluirOrdemServicoAction.do?veioAcompanhamentoRoteiro=true&limpar=sim&chave='+form.idAcompanhamentoArquivosRoteiro.value;

		form.action = actionRetorno;
		form.submit();
   		/*var form = document.forms[0];
...
*/   	
	...
	function habilitaGerarOs(){
    	var form = document.forms[0];
		if(form.numeroRA.value != '' && form.habilitarGerar.value != ''){
   	...
   	function concluir(actionTipo) {
    	var form = document.forms[0];
		var bt = document.getElementById('concluirBt');
		bt.disabled = true;
		if(validaForm()){
   	...
   	function validaForm(){
   		...
   		if(form.sequencialProgramacaoPrevisto.value == ""){
   			...
   			return false;
   		} else if(parseInt(form.sequencialProgramacaoPrevisto.value) > parseInt(form.sequencialProgramacao.value)){
...
<html:form action="/exibirAcompanharRoteiroProgramacaoOrdemServicoAction.do"
	...
	<html:hidden property="idAcompanhamentoArquivosRoteiro"/>
	<html:hidden property="idEmpresa"/>
	<html:hidden property="idSituacao"/>
	<html:hidden property="habilitarGerar"/>
									...
									<td>
										<%if(request.getParameter("veioAcompanhamentoRoteiro") != null && request.getParameter("veioAcompanhamentoRoteiro").equals("true")){%>
											<html:text maxlength="9" 
												...
												property="numeroRA" 
												size="9"
												onkeypress="javascript:habilitaGerarOs();validaAcao(event,'registroAtendimento','true'); return isCampoNumerico(event);"/>
										<%}else{%>
											<html:text maxlength="9" 
												tabindex="1"
												property="numeroRA" 
												size="9"
												onkeypress="javascript:habilitaGerarOs();validaAcao(event,'registroAtendimento','false'); return isCampoNumerico(event);"/>
										<%}%>
                    ...
                    <tr> 
                      	<td height="10">
                        	...
                        	<%if(request.getParameter("veioAcompanhamentoRoteiro") != null && request.getParameter("veioAcompanhamentoRoteiro").equals("true")){%>
									...
									<input name="ButtonGerar" id="gerar"

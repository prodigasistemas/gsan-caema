    ...
    function validateImovelEmissaoOrdensSeletivasActionForm(form) {                                                                   
		if ( (validateMesAno(form)) ) {
			...
			if (parseInt(form.numeroOcorrenciasConsecutivas.value) > 10 || 
					parseInt(form.numeroOcorrenciasConsecutivas.value) < 0) {
			...
			if (form.anormalidadeHidrometro.selectedIndex != 0 && form.anormalidadeHidrometro.selectedIndex != -1) {
				if (form.numeroOcorrenciasConsecutivas.value == ''){
					form.numeroOcorrenciasConsecutivas.value = 0;
				}
			}
...
<html:form action="/filtrarImovelEmissaoOrdensSeletivasWizardAction"
	...
	<jsp:include page="/jsp/util/wizard/navegacao_abas_wizard_tela_espera.jsp?numeroPagina=2" />
		...
		<tr>
			...
			<table width="100%" border="0">
						...
						<table width="100%" border="0">
							<tr>
								<td><html:text property="numeroOcorrenciasConsecutivas" size="3" maxlength="2" disabled="true"
									styleClass="tipoInteiro"></html:text></td>
							</tr>
						</table>
					</td>
				</tr>
				...
				<tr>
					<td colspan="2">
						<div align="right">
							<jsp:include page="/jsp/util/wizard/navegacao_botoes_wizard_valida_avancar_valida_voltar_tela_espera.jsp?numeroPagina=2" />
						</div>
					</td>
				</tr>
			</table>

				...
				<td width="625" valign="top" class="centercoltext">
					...
					<table width="100%" border="0" align="center" cellpadding="0"
						...
						<tr>
							...
							<td class="parabg">Atualizar Motivo de Não Aceite</td>
							<td width="11"><img border="0"
					...
					<table width="100%" border="0">
						<tr>
							<td colspan="3">Para atualizar o motivo de não aceite, informe os dados abaixo:</td>
						...
						<tr>
							...
							<td><html:radio property="indicadorObservacaoObrigatoriedade" value="1"
									tabindex="11" /><strong>Sim <html:radio
										property="indicadorObservacaoObrigatoriedade" value="2" tabindex="12" />Não 
									</strong></td>
						</tr>

...
//		toggleBox('demodiv',1);
	...
	function abrirPopupFoto(){
		...
		if(chave != false){
			...
			window.open('exibirFotosOSOriginalRepavimentacaoPopupAction.do?idOs='+chave+'','PesquisaNova','top=' + top + ',left='+ left +',location=no,screenY=0,screenX=0,menubar=no,status=yes,toolbar=no,scrollbars=yes,resizable=no,width=650,height=480');
	...
	function selecionouArquivo(){
		...
		if(jaSelecionado == false){
			alert('É necessário marcar alguma OS');
			return false;
		}
...
<html:form action="/exibirManterOrdemProcessoRepavimentacaoAction" method="post"
	...
	<html:hidden property="idUnidadeResponsavel" />
					...
					<tbody>
					  <tr bordercolor="#90c7fc" bgcolor="#cbe5fe"> 
		                ...
		                <td bgcolor="#90c7fc" width="9%"><div align="center"><strong>Pvt.Rua Ret.<p> T / (m2) </strong></div></td>
	                  	<td bgcolor="#90c7fc" width="9%"><div align="center"><strong> Dt.<p> Geração </strong></div></td>
									...
									<pg:item>
										...
										<tr bgcolor="#cbe5fe">
											<%}%>
												...
												<td bordercolor="#90c7fc" onmouseover="this.T_BGCOLOR='whitesmoke';return escape('${oSPavimentoRetornoHelper.hint}'); ">
													<div align="center">
												...
												<td bordercolor="#90c7fc">
													<div align="center">
														<logic:present  name="oSPavimentoRetornoHelper" property="ordemServico.dataGeracao">						
															<%=""+ Util.formatarData(((OSPavimentoRetornoHelper) oSPavimentoRetornoHelper).getOrdemServico().getDataGeracao())%>
														</logic:present>
														
														<logic:notPresent  name="oSPavimentoRetornoHelper" property="ordemServico.dataGeracao">												
														&nbsp;
														</logic:notPresent>
					...
					<td align="left" height="24%">			
			  		...
			  		<td align="left" height="24%">			
						<input name="button" 
							type="button" 	
							class="bottonRightCol" 
							value="Exibir Fotos OS Original" 
							onclick="abrirPopupFoto();"
							align="left" 
							style="width: 150px;">
			  		</td>

...
<html:javascript staticJavascript="false"
	formName="FiltrarValorCobrancaServicoActionForm" />
...
<script language="JavaScript">
		...
		if (validateFiltrarValorCobrancaServicoActionForm(form)) {
			if (validaIndicadorMedido()) {
				if (validaQuantidadeEconomias()) {
					if (validaDataVigencia()) {

						if (comparaData(form.dataVigenciaInicial.value, "<=",
	...
	function validaDataVigencia() {
		...
		if ((form.dataVigenciaInicial.value == '' && form.dataVigenciaFinal.value != '')
				|| (form.dataVigenciaInicial.value != '' && form.dataVigenciaFinal.value == '')) {
			if (form.dataVigenciaInicial.value == '') {
				alert('Informe Data Vigência Inicial.');
			} else if (form.dataVigenciaFinal.value == '') {
				alert('Informe Data Vigência Final.');
			}
			return false;
		}
		return true;
		...
		<table width="770" border="0" cellspacing="5" cellpadding="0">
			<tr>
				...
				<td width="615" valign="top" class="centercoltext">
					...
					<p>&nbsp;</p> <!--Inicio da Tabela Ligação de Esgoto -->
					<table width="100%" border="0">
						<tr>
							<td height="31">
								<table width="100%" border="0" align="center">
									<tr>
										<td height="10" colspan="2">Para manter o(s) valor(res),
									...
									<tr>
										<td height="10"><strong> Tipo do Serviço:<font
												color="#FF0000"></font></strong></td>
										<td colspan="2" width="330"><span class="style2">
											...
											</a> <logic:present name="servicoTipoEncontrada" scope="session">
									...
									<tr>
										<td><strong>Categoria:<font color="#FF0000"></font></strong>
										</td>

										<td><strong> <html:select property="idCategoria"
									...
									<tr>
										<td><strong>Subcategoria:<font color="#FF0000"></font></strong>
										</td>

										<td><strong> <html:select
													property="idSubCategoria" style="width: 230px;"
													tabindex="2">
													<html:option
														value="<%=""+ConstantesSistema.NUMERO_NAO_INFORMADO%>">&nbsp;
									</html:option>
									...
									<tr>
										...
										<td colspan="2" width="330" align="right">
											<div align="left">
												<label> <html:radio property="indicadorMedido"
														value="1"
														onclick="javascript: habilitarCapacidadeHidrometro();" />
													<strong>Sim</strong>
												</label> <label> <html:radio property="indicadorMedido"
														value="2"
														onclick="javascript: habilitarCapacidadeHidrometro();" />
													<strong>Não</strong></label><label> <html:radio
														property="indicadorMedido" value="3"
														onclick="javascript: habilitarCapacidadeHidrometro();" />
													<strong>Todos</strong></label>
											</div>
										</td>
									</tr>
									<tr>
										...
										<td colspan="2" width="330" align="right">
											<div align="left">
												<html:select property="capacidadeHidrometro"
													style="width: 230px;">
													<html:option
														value="<%=""+ConstantesSistema.NUMERO_NAO_INFORMADO%>">&nbsp;</html:option>
									...
									<tr>
										<td><strong><span class="style2">Indicador
													de Geração de Débito:<font color="#FF0000">*</font>
											</span></strong></td>
										<td align="left" colspan="2"><label> <html:radio
													property="indicadorGeracaoDebito" value="1"
													onchange="javascript:validarExibicaoValorServico(this);" /><strong>Sim</strong>
										</label> <label> <html:radio property="indicadorGeracaoDebito"
													value="2"
													onchange="javascript:validarExibicaoValorServico(this);" />
												<strong>Não</strong>
										</label> <label> <html:radio property="indicadorGeracaoDebito"
													value="3"
													onchange="javascript:validarExibicaoValorServico(this);" />
									...
									<tr>
										...
										<td colspan="2" width="330" align="right">
											<div align="left">
												<html:text property="valorServicoInicial" size="12"
													maxlength="9"
													onkeyup="javascript:formataValorMonetario(this, 11)"
													style="text-align:right;" />
												<strong> até</strong>
												<html:text property="valorServicoFinal" size="12"
													maxlength="9"
													onkeyup="javascript:formataValorMonetario(this, 11)"
													style="text-align:right;" />
											</div>
									...
									<tr>
										<td><strong><span class="style2">Indicador
													de Quantidade de Economias:<font color="#FF0000">*</font>
											</span></strong></td>
										<td align="left" colspan="2"><label> <html:radio
													property="indicativoTipoSevicoEconomias" value="1"
													onchange="javascript:habilitaEconomia();" /><strong>Sim</strong>
										</label> <label> <html:radio
													property="indicativoTipoSevicoEconomias" value="2"
													onchange="javascript:desabilitaEconomia();" /> <strong>Não</strong>
										</label> <label> <html:radio
													property="indicativoTipoSevicoEconomias" value="3"
													onchange="javascript:desabilitaEconomia();" /> <strong>Todos</strong>
										</label></td>
									</tr>

									<!-- Quantidade de Economias -->
									<tr>
										<td><strong> Quantidade de Economias de <font
												color="#FF0000"></font>
										</strong></td>
										<td colspan="3" align="left"><html:text
												property="quantidadeEconomiasInicial" size="4" maxlength="3"
												disabled="true" onkeypress="return isCampoNumerico(event);"
												style="text-align:right;" /> <strong> até </strong> <html:text
												property="quantidadeEconomiasFinal" size="4" maxlength="3"
												disabled="true" onkeypress="return isCampoNumerico(event);"
									...
									<tr>
										<td><strong>Vigência do valor do Serviço:<font
												color="#FF0000"></font>
										</strong></td>
										<td valign="middle"><html:text maxlength="10"
												property="dataVigenciaInicial" size="10"
												onkeypress="return isCampoNumerico(event);"
												onkeyup="javascript:mascaraData(this,event);replicaDataVigencia();" />
											<img border="0"
											...
											<strong> a </strong> <html:text maxlength="10"
												property="dataVigenciaFinal" size="10"
												onkeypress="return isCampoNumerico(event);"
												onkeyup="javascript:mascaraData(this,event);" /> <img
											border="0"
											src="<bean:message key='caminho.imagens'/>calendario.gif"
									...
									<tr>
										<td><strong> <font color="#FF0000"> <input
													...
													value="Limpar"
													onClick="javascript:window.location.href='/gsan/exibirFiltrarValorCobrancaServicoAction.do?menu=sim'">
													<!-- <input type="button"
								...
								onClick="javascript:window.location.href='/gsan/telaPrincipal.do'"> -->
										...
										<td colspan="2" align="right"><input type="button"
											name="Submit2" class="bottonRightCol" value="Filtrar"

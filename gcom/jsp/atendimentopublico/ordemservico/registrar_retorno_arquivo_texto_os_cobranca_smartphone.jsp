...
<form action="/gsan/registrarArquivoTextoOSCobrancaSmartphoneAction.do"
...
<table width="770" border="0" cellspacing="5" cellpadding="0">
	<tr>
		...
		<table width="100%" border="0">
			<tr>
				<td colspan="2">Para registrar o retorno arquivo texto das OS de Cobran&ccedil;a do Smartphone, informe
					os dados abaixo:</td>
			</tr>

...
function IntegerValidations () {
	 this.aa = new Array("idUnidadeOrganizacional", "Unidade de Encerramento Inválida.", new Function ("varName", "return this[varName];"));
}
				...
				<table>
					<tr bgcolor="#cbe5fe">
					  	<td width="94%" colspan="2">
							  ...
							  <input type="button" align="left" name="Button" class="bottonRightCol" value="Limpar" tabindex="8" onClick="javascript:window.location.href='/gsan/exibirFiltrarOrdemRepavimentacaoProcessoAceiteAction.do?menu=sim'" />			 
						</td>
						<td>

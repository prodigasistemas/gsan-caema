  ...
  <tr>
    ...
    <td width="625" valign="top" class="centercoltext">
      ...
      <table width="100%" border="0" dwcopytype="CopyTableRow">
        <tr>
          <td colspan="4">
            Dados das Ordens de Servi&ccedil;o para Smartphone do Arquivo Texto:
          </td>
        </tr>
		...
		<tr>
			...
			<td>
				...
				<html:text property="descricaoTipoOrdemServico" size="28"
						maxlength="30" readonly="true" style="background-color:#EFEFEF; border:0; color: #000000" />
    	...
    	<logic:present name="execucaoOSSupressao" >
			...
			<tr>
    	   	...
    	   	<tr>
	    		<td><strong>Motivo do Supress&atilde;o:</strong></td>        
	            <td>
	               	<strong>
		     			<html:text
	     					   maxlength="40"
	     					   size="40"
	     					   property="descricaoMotivoSupressao"
	     					   readonly="true"
	 		     			   style="background-color:#EFEFEF; border:0; color: #000000"/>
	    			</strong>
	    		</td>    		
    	   	...
    	   	<tr>
	    		<td><strong>Tipo do Supress&atilde;o:</strong></td>        
	            <td>
	               	<strong>
		     			<html:text
	     					   maxlength="40"
	     					   size="40"
	     					   property="descricaoTipoSupressao"
	     					   readonly="true"
	 		     			   style="background-color:#EFEFEF; border:0; color: #000000"/>
	    			</strong>
	    		</td>    		
    	   	...
    	   	<tr>
	    		<td><strong>Leitura da Supress&atilde;o:</strong></td>        
	            <td>
	               	<strong>
		     			<html:text
	     					   maxlength="40"
	     					   size="40"
	     					   property="leituraSupressao"
	     					   readonly="true"
	 		     			   style="background-color:#EFEFEF; border:0; color: #000000"/>
	    			</strong>
	    		</td>    		
	            ...
	            <td>
	               	<strong>
		     			<html:text
	     					   maxlength="40"
	     					   size="40"
	     					   property="descricaoDocumentoEntregue"
	     					   readonly="true"
	 		     			   style="background-color:#EFEFEF; border:0; color: #000000"/>
	    			</strong>
	    		</td>    		
					 ...
					 <table width="100%" bgcolor="#99CCFF" border="0">
						<tr bordercolor="#000000" bgcolor="#90c7fc" class="styleFontePeqNegrito">
								<td width="100%" bgcolor="#90c7fc">
									<div align="center" style="height:20px;"><strong>Situações Encontradas</strong></div>
								</td>
						</tr>
					</table>
				</td>
							...
							<tr bordercolor="#000000" bgcolor="#90c7fc">								
								<logic:present name="colecaoSituacoesEncontradas">
									...
									<logic:iterate name="colecaoSituacoesEncontradas"
										...
										type="gcom.mobile.ExecucaoOSSituacoesEncontradas">
										...
										<tr bgcolor="#FFFFFF" class="styleFontePequena">
											...
											<td width="100%" align="center">
												${situacaoEncontrada.comp_id.fiscalizacaoSituacao.descricaoFiscalizacaoSituacao}
											</td>
										</tr>
									</logic:iterate>
								</logic:present>
	            ...
	            <td>
	               	<strong>
		     			<html:text
	     					   maxlength="40"
	     					   size="40"
	     					   property="numeroLeituraInstalacao"
	     					   readonly="true"
	 		     			   style="background-color:#EFEFEF; border:0; color: #000000"/>
	    			</strong>
	    		</td>    		
	            ...
	            <td>
	               	<strong>
		     			<html:text
	     					   maxlength="40"
	     					   size="40"
	     					   property="localInstalacaoHidrometro"
	     					   readonly="true"
	 		     			   style="background-color:#EFEFEF; border:0; color: #000000"/>
	    			</strong>
	    		</td>    		
            ...
            <td>
               	<strong>
	     			...
	     			<html:text
     					   maxlength="40"
     					   size="40"
     					   property="descricaoMotivoEncerramento"
     					   readonly="true"
 		     			   style="background-color:#EFEFEF; border:0; color: #000000"/>
    			</strong>
    		</td>    		
    	...
    	<tr>
    		<td><strong>Data da Execu&ccedil;&atilde;o:</strong></td>        
            <td>
               	<strong>
	     			<html:text
     					   maxlength="40"
    	...
    	<tr>
    		<td><strong>Hora da Execu&ccedil;&atilde;o:</strong></td>        
            <td>
               	<strong>
	     			<html:text
     					   maxlength="40"
     					   size="40"
     					   property="horaExecucao"
     					   readonly="true"
 		     			   style="background-color:#EFEFEF; border:0; color: #000000"/>
    			</strong>
    		</td>    		

...
<script language="JavaScript">
	...
	function validaTipoPerfilServico(form)
	{
		...
		if( trim(form.idServicoPerfilTipo.value) == '' && rad_val=="1"){
	...
	function validarForm() {
		...
		if (validateAtualizarEquipeActionForm(form)) {
			...
			if (validaQtdeEquipeComponentes() && validaTipoPerfilServico(form)) {
			...
			<table width="100%" border="0">
				<tr>
					...
					<table width="100%" border="0" align="center">
						...
						<tr>
							<td><strong> Numero IMEI do Aparelho : <font color="#FF0000">*</font>
							</strong></td>
							<td colspan="2" align="right">

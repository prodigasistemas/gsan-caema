...
<script language="JavaScript">
	...
	function limpar(){
		...
		form.periodoEnvioOsInicial.value = "";		
		form.periodoEnvioOsFinal.value = "";		
	...
	function DateValidations () { 
	     this.aa = new Array("periodoEnvioOsInicial", "Data do Envio da OS Inicial não é uma data válida.", new Function ("varName", "this.datePattern='dd/MM/yyyy';  return this[varName];"));
	     this.ab = new Array("periodoEnvioOsFinal", "Data do Envio da OS Final não é uma data válida.", new Function ("varName", "this.datePattern='dd/MM/yyyy';  return this[varName];"));
	...
	function IntegerValidations(){
		this.aa = new Array("numeroOS", "Número da OS deve somente conter números positivos.", new Function ("varName", " return this[varName];"));
		this.ab = new Array("idBairro", "Nome do Bairro inválido.", new Function ("varName", " return this[varName];"));
		this.ac = new Array("codigoBairro", "Bairro deve somente conter números positivos.", new Function ("varName", " return this[varName];"));
		this.ad = new Array("idLogradouro", "Logradouro deve somente conter números positivos.", new Function ("varName", " return this[varName];"));
	}


	function limparEnvioOs(){
	...
	function verificarDatas(){
	  	...
	  	if ( form.periodoEnvioOsInicial.value == '' && form.periodoEnvioOsFinal.value != '' ){
			alert('Data inicial de envio da OS deve ser informada');
	     	return false;
	
	  	} else if ( form.periodoEnvioOsFinal.value == '' && form.periodoEnvioOsInicial.value != '' ){
			alert('Data final de envio da OS deve ser informada');
	     	return false;
	...
	function validateFiltrarOrdemProcessoRepavimentacaoActionForm() { 
    	...
    	if( verificarDatas() && validateRequired(form) &&  validateDate(form) && validateLong(form)){
		 ...
		 <tr  bgcolor="#cbe5fe" >
		  ...
		  <tr>		  
		  	...
		  	<td width="24%" align="left">		
		   	...
		   	<td width="15%">
		    	 <strong>Envio <br> da OS:</strong> 
		  	</td>
		  	<td width="45%" align="left">
		    	<html:text  property="periodoEnvioOsInicial" 
		    				size="10" 
		    				maxlength="10" 
		    				tabindex="2"   
		    				onkeypress="return isCampoNumerico(event);"
		    				onkeyup="mascaraData(this, event),limparRetornoServico();" />
			     		<a	href="javascript:abrirCalendarioReplicando('FiltrarOrdemProcessoRepavimentacaoActionForm', 'periodoEnvioOsInicial', 'periodoEnvioOsFinal'),limparRetornoServico();" >
							<img border="0" 
								 ...
								 title="Calendário"/></a>   
                 <strong>  a  </strong>
				<html:text  property="periodoEnvioOsFinal" 
							size="10" 
							maxlength="10" 
							tabindex="3"  
							onkeypress="return isCampoNumerico(event);"
							onkeyup="mascaraData(this, event),limparRetornoServico();" /> 
					  <a href="javascript:abrirCalendario('FiltrarOrdemProcessoRepavimentacaoActionForm', 'periodoEnvioOsFinal'),limparRetornoServico()">
						<img border="0" 
							 src="<bean:message key="caminho.imagens"/>calendario.gif" 
							 width="20" 
							 align="absmiddle" 
		  ...
		  <tr>		  
		  	...
		  	<td width="45%" align="left">
		    	<html:text  property="periodoRetornoServicoInicial" 
		    				...
		    				maxlength="10" 
		    				tabindex="5" 
		    				onkeyup="mascaraData(this, event),limparEnvioOs();" 
		    				onkeypress="return isCampoNumerico(event);"/>
				     <a	href="javascript:abrirCalendarioReplicando('FiltrarOrdemProcessoRepavimentacaoActionForm', 'periodoRetornoServicoInicial', 'periodoRetornoServicoFinal'),limparEnvioOs();" >
						<img border="0" 
							 src="<bean:message key="caminho.imagens"/>calendario.gif" 
							 width="20" 
							 align="absmiddle" 
				...
				<html:text property="periodoRetornoServicoFinal" 
						   ...
						   onkeypress="return isCampoNumerico(event);"
						   onkeyup="mascaraData(this, event),limparEnvioOs();"  /> 
					  <a href="javascript:abrirCalendario('FiltrarOrdemProcessoRepavimentacaoActionForm', 'periodoRetornoServicoFinal'),limparEnvioOs();">
						<img border="0" 
							 src="<bean:message key="caminho.imagens"/>calendario.gif" 
							 width="20" 
							 align="absmiddle" 
       	...
       	<tr> 
            ...
            <td>
                <html:text property="numeroOS" 
                	size="9" 
                	maxlength="9"
                	onkeypress="validaEnterComMensagem(event, 'filtrarOrdemProcessoRepavimentacao.do', 'numeroOS', 'Número da OS');

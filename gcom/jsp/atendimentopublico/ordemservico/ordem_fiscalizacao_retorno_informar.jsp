...
function validarAutoInfracao(form){
	...
	function desabilitaCampos(desabilita, veioEncerrarSmartphone){
		var form = document.forms[0];

		if (veioEncerrarSmartphone == false) {
	...
	function voltarSmartphone(idArquivo) {
		var form = document.forms[0];
		form.action = 'exibirConsultarDadosOrdemServicoCobrancaSmartphoneAction.do?ordemServico=' + form.idOrdemServico.value + '&matricula=' + form.matriculaImovel.value + '&idArquivo=' + idArquivo
		form.submit();
	}
</script>
...
onload="setarFoco('${requestScope.nomeCampo}');desabilitaCampos('${requestScope.desabilita}', ${sessionScope.veioEncerrarSmartphone});exibirGeracaoDebito();">
				...
				<tr>
					...
					<table width="100%" border="0" align="center">
						...
						<tr>
							...
							<td>
							<logic:present name="veioEncerrarSmartphone" scope="session">
								<html:text
							...
							<logic:notPresent name="veioEncerrarSmartphone" scope="session">
								<html:text
									property="idOrdemServico" 
									size="10" 
									maxlength="9"
								...
								<tr bgcolor="#cbe5fe">
										...
										<tr>
											...
											<table width="100%" border="0" bgcolor="90c7fc">
												<logic:empty name="colecaoFiscalizacaoSituacaoSelecionada" scope="session">
													<tr bgcolor="#90c7fc">
														<logic:notPresent name="veioEncerrarSmartphone" scope="session"><td width="10%" align="center"><strong>Remover</strong></td></logic:notPresent>
									...
									<table border="0" width="100%">
										<tr>
											...
											<td>
											<c:choose>
												<c:when test="${InformarRetornoOSFiscalizacaoActionForm.indicadorDocumentoEntregue == 1}">
													<html:radio property="indicadorDocumentoEntregue" value="1" /> <strong> Sol. Comparecimento </strong>
												</c:when>
												<c:otherwise>
													<html:radio property="indicadorDocumentoEntregue" value="1" disabled="true"/> <strong> Sol. Comparecimento </strong>
												</c:otherwise>
											</c:choose>
											<c:choose>
												<c:when test="${InformarRetornoOSFiscalizacaoActionForm.indicadorDocumentoEntregue == 2}">
													<html:radio property="indicadorDocumentoEntregue" value="2" /> <strong> Auto de Infração </strong>
												</c:when>
												<c:otherwise>
													<html:radio property="indicadorDocumentoEntregue" value="2" disabled="true"/> <strong> Auto de Infração </strong>
												</c:otherwise>
											</c:choose>
											<c:choose>
												<c:when test="${InformarRetornoOSFiscalizacaoActionForm.indicadorDocumentoEntregue == 4}">
													<html:radio property="indicadorDocumentoEntregue" value="4" /> <strong> Nenhum </strong>
												</c:when>
												<c:otherwise>
													<html:radio property="indicadorDocumentoEntregue" value="4" disabled="true"/> <strong> Nenhum </strong>
												</c:otherwise>
											</c:choose>
											<c:choose>
												<c:when test="${InformarRetornoOSFiscalizacaoActionForm.indicadorDocumentoEntregue == 3}">
													<html:radio property="indicadorDocumentoEntregue" value="3" /> <strong> Notificação de Esgoto </strong>
												</c:when>
												<c:otherwise>
													<html:radio property="indicadorDocumentoEntregue" value="3" disabled="true" /> <strong> Notificação de Esgoto </strong>
												</c:otherwise>
											</c:choose>
											</td>
								...
								<tr bgcolor="#cbe5fe">
									...
									<table border="0" width="100%">
											...
											<td>
												<logic:present name="veioEncerrarSmartphone" scope="session">
													<html:radio property="indicadorEncerramentoOS" 
														value="1" /> <strong>Sim</strong>
													<html:radio property="indicadorEncerramentoOS" 
														value="2" disabled="true" /> <strong>Não</strong>
												</logic:present>
												<logic:notPresent name="veioEncerrarSmartphone" scope="session">
													<html:radio property="indicadorEncerramentoOS" 
										...
										<tr>
											...
											<logic:present name="veioEncerrarSmartphone" scope="session">
												<html:text property="descricaoMotivoEncerramento" size="45" maxlength="40"
												readonly="true"
												style="background-color:#EFEFEF; border:0; color: #000000" />
												<html:hidden property="atendimentoMotivoEncerramento" />
											</logic:present>
											<logic:notPresent name="veioEncerrarSmartphone" scope="session">
												<html:select property="atendimentoMotivoEncerramento">
													<html:option value="-1">&nbsp;</html:option>
													<html:options
					...
					<table width="100%">
						...
						<tr>
							...
							<input name="Button" type="button"
								class="bottonRightCol" value="Voltar" onclick="voltarSmartphone(${sessionScope.idArquivo});">
							</logic:present>
							<input name="Button" type="button"

	...
	<tr>
		...
		<table width="100%" border="0" align="center" cellpadding="0"
			...
			<tr>
				...
				<logic:notPresent name="osCorrecaoAnormalidade" scope="request">
					<td class="parabg">Registrar Retorno Arquivo Texto da Visita de Campo</td>
				</logic:notPresent>
				<logic:present name="osCorrecaoAnormalidade" scope="request">
					<td class="parabg">Registrar Retorno Arquivo Texto de Ordens de Serviço para Smartphone</td>
				</logic:present>
		...
		<table width="100%" border="0">
			<tr>
				...
				<logic:present name="osCorrecaoAnormalidade" scope="request">
					<td colspan="2">Para registrar o retorno arquivo texto de ordens de serviço para smartphone, 
					informe os dados abaixo:</td>
				</logic:present>
			</tr>
			
			<tr>
				<td class="style1"><strong>Tipo da Ordem de Serviço:</strong></td>
				<logic:notPresent name="osCorrecaoAnormalidade" scope="request">
					<td class="style1"><input type="text" size="35" maxlength="35" value="OS Inspeção Anormalidade" disabled="disabled" >
				</logic:notPresent>
				<logic:present name="osCorrecaoAnormalidade" scope="request">
					<td class="style1"><input type="text" size="35" maxlength="35" value="OS Correção Anormalidade" disabled="disabled" >
				</logic:present>
			</tr>

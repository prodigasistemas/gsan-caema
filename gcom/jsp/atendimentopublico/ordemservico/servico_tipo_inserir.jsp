...
<script language="JavaScript">
  	...
  	function validaTodosRadioButton() {
		...
		if (!form.indicadorInformacoesBoletimMedicao[0].checked &&	!form.indicadorInformacoesBoletimMedicao[1].checked){
   		...
   		if (!form.indicadorNovaEtapa[0].checked && !form.indicadorNovaEtapa[1].checked){
   		   	alert("Informe indicador de criação de novas etapas no celular");	
   			return false;
   		}

   		if (!form.indicadorServicoCobranca[0].checked && !form.indicadorServicoCobranca[1].checked){
   		   	alert("Informe indicador de serviço de cobrança");	
   			return false;
   		}
	...
	function  habilitaIndicativos() {
	 ...
	 function adicionarObjetoEnter(){
			...
			var form = document.forms[0];
			var objPerfilServico = form.idPerfilServico;
			...
			if (objPerfilServico.value.length < 1){
				...
				alert("Perfil deve somente conter números positivos.");
				objPerfilServico.focus();
			}
			else if (!testarCampoValorZero(document.forms[0].idPerfilServico, "Perfil")){
		    	document.forms[0].idPerfilServico.focus();
		    }
			else{

				form.action = "exibirInserirServicoTipoAction.do?adicionarPerfilColecao=OK";
				submeterFormPadrao(form);
			}
		}
	 ...
	 function remover(idObj){
			...
			if (confirm('Confirma Remoção?')) {
				form.action = "exibirInserirServicoTipoAction.do?idServicoPerfilTipo=" + idObj;
			}
	...
	<table width="770" border="0" cellspacing="5" cellpadding="0">
		<tr>
			...
			<table width="100%" height="311" border="0">
				...
				<tr>
					<td>
						<strong><span class="style2">Indicador de Geração de Resumo:<font
				...
				<tr>
					<td><strong><span class="style2">Indicativo de Pavimento:
					<font color="#FF0000">*</font></span></strong></td>
					<td align="left" width="20%"><label> 
				...
				<tr>
					<td><strong><span class="style2">Indicativo de Reposição de Asfalto:<font color="#FF0000">*</font>
					</span></strong></td>
					<td align="left" width="20%"><label> 
				...
				<tr>
					<td><strong><span class="style2">Indicativo de Reposição de Paralelo:<font color="#FF0000">*</font>
					</span></strong></td>
					<td align="left" width="20%"><label> 
				...
				<tr>
					<td><strong><span class="style2">Indicativo de Reposição de Calçada:<font color="#FF0000">*</font></span>
					</strong></td>
					<td align="left" width="20%"><label> 
				...
				<tr>
					<td><strong><span class="style2">Indicador de Programação Automática:</span></strong></td>
					<td align="left" width="20%"><label>
				...
				<!-- Indicador de criação de novas etapas no celular -->
				
				 <tr>
					<td><strong><span class="style2">Indicador de criação de novas etapas no celular:<font
						color="#FF0000">*</font></span></strong></td>
					<td align="left" width="20%"><label> <html:radio
				...
				<tr>
					<td><strong><span class="style2">Indicador de Serviço de Cobrança:<font
						color="#FF0000">*</font></span></strong></td>
					<td align="left" width="20%"><label> <html:radio
				...
				<tr>
					<td><strong><span class="style2">Indicador de Serviço de Micromedição:<font
						color="#FF0000">*</font></span></strong></td>
					<td align="left" width="20%"><label> <html:radio

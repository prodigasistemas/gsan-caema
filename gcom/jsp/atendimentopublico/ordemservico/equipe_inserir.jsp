...
<%-- Novos Javascripts --%>
<script language="JavaScript">
	function validaUsuarioResponsavel(form)
	{
		for (var i=0; i < form.indicadorProgramacaoAutomatica.length; i++)
		   {
		   if (form.indicadorProgramacaoAutomatica[i].checked)
		      {
		      var rad_val = form.indicadorProgramacaoAutomatica[i].value;
		      
		      }
		   }
		  
		if( trim(form.cdUsuarioRespExecServico.value) == '' && rad_val=="1"){
			alert("Informe Usuário Responsável");
			return false;
	    }
	    return true;
	...
	function validaTipoPerfilServico(form)
	{
		for (var i=0; i < form.indicadorProgramacaoAutomatica.length; i++)
		   {
		   if (form.indicadorProgramacaoAutomatica[i].checked)
		...
		if( trim(form.tipoPerfilServicoId.value) == '' && rad_val=="1"){
			alert("Informe Tipo Perfil Serviço");
			return false;
	    }
	    return true;
    ...
    function validaForm() {
        ...
        if (validateInserirEquipeActionForm(form)) {
            ...
            //if (validaQtdeComponentes('inserir')) {
                if (validaQtdeEquipeComponentes() && validaTipoPerfilServico(form) && validarEquipeNatureza(form)) {
	...
	function validarEquipeNatureza(form){
 			if(form.naturezaEquipe.value == '-1'){
					alert("Informe Natureza da Equipe");
					return false;
 	 			}
	 			return true;
		}
    ...
    */
    ...
    function limparUnidadeOrganizacional() {
        ...
        form.agrupamentoBairroRepavimentadora.value = "-1";
            ...
            <table width="100%" border="0">
                <tr>
                    ...
                    <table width="100%" border="0" align="center">
                        ...
                        <tr>
                            ...
                            <img src="<bean:message key='caminho.imagens'/>pesquisa.gif"
                                ...
                                src="<bean:message key='caminho.imagens'/>limparcampo.gif" /></a></div>
									...
									<tr>
										<logic:present name="agrupamentoBairroRep">
											<td><strong>Agrupamento Bairro Repavimentadora:</strong></td>
											<td><html:select
													property="agrupamentoBairroRepavimentadora" tabindex="4">

													<html:option value="-1">&nbsp;</html:option>

													<html:options collection="colecaoEquipesGruposDeBairros"
														labelProperty="descricaoAgrupamento" property="id" />

												</html:select> <font size="1">&nbsp; </font></td>
										</logic:present>

										<logic:notPresent name="agrupamentoBairroRep">
											<td><strong>Agrupamento Bairro Repavimentadora:</strong></td>
									...
									<tr>
										<td><strong>Natureza da Equipe:<font color="#FF0000">*</font>
										</strong></td>
										<td><html:select property="naturezaEquipe" tabindex="5">
												<html:option
													value="<%=""+ConstantesSistema.NUMERO_NAO_INFORMADO%>">&nbsp;</html:option>
												<logic:present name="colecaoNaturezaEquipe">	
													<html:options collection="colecaoNaturezaEquipe"
                        ...
                        <tr>
							<td><strong>Usuário Responsável Pela Execução do Serviço:</strong></td>
						...
						<tr>
							<td><strong>Indicador de Manter Programação com OS do Dia Anterior:</strong></td>
					
							<td colspan="4">						
								<html:radio property="indicadorManterProgramacaoOSdiaAnterior"
									value="<%=ConstantesSistema.SIM.toString()%>" tabindex="1" />
								<strong>Sim</strong>
								<html:radio property="indicadorManterProgramacaoOSdiaAnterior"
									value="<%=ConstantesSistema.NAO.toString()%>" tabindex="2" />

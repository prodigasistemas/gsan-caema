...
function limparPesquisaImovel() {
    ...
    if(!form.matriculaImovel.disabled){
        ...
        form.action='exibirEmitirOrdemFiscalizacaoAction.do?limpar=imovel';
        form.submit();
    }
}
...
function verificaOrdemServico(){
	 var form = document.forms[0];

	 if ( form.tipoServico.value == "-1" && form.matriculaImovel.value != null && form.matriculaImovel.value != "" ) {
		 limparPesquisaImovel();
	 } else if ( form.tipoServico.value == "-1" ) {
...
<body leftmargin="5" topmargin="5"
	onload="javascript:setarFoco('${requestScope.nomeCampo}');bloqueiaImovel();">
										...
										<table border="0" width="100%">
													<tr>	
														<td>
															<table border="0" width="100%">
																<tr>
																	<td><strong>Tipo do Serviço de Fiscalização:<font color="#FF0000">*</font></strong></td>
																	<td colspan="2" align="left">
																		<html:select property="tipoServico" onchange="verificaOrdemServico();">
																			<html:option value="-1">&nbsp;</html:option>
																			<html:options collection="colecaoTipoServico"
																				labelProperty="descricao" property="constanteFuncionalidadeTipoServico" />
																		</html:select>
																	</td>
																</tr>
																<tr>
																	...
																	<td width="80%" colspan="2">
																		...
																		<a href="javascript:chamarPopup('exibirPesquisarImovelAction.do', 'imovel', null, null, 400, 800, '',document.forms[0].matriculaImovel);" id="pesIm">

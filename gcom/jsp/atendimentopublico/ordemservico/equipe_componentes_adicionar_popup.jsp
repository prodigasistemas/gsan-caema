...
<script language="JavaScript">
	...
	/* Valida Radio */
  	function validaRadioButton() {
   	...
   	function enviarParametroIndicadorResponsavel(){
   		var form = document.forms[0];

   		if(form.responsavelId[0].checked || form.responsavelId[1].checked){
   			var indicador = '';
   			if ( form.responsavelId[0].checked ) {
   				indicador = '1';
   			} else {
   			...
   			$.ajax({
   					   type: "POST",
   					   url: "exibirInserirEquipeAction.do?indicadorResponsavel="+indicador,
   					   data: "",
	    		...
	    		<table height="100%">
	      		...
	      		<table width="100%" border="0">
	        		...
	        		<tr> 
	          			...
	          			<td width="9%">
          					<html:radio property="responsavelId" value="1" onclick="enviarParametroIndicadorResponsavel();"/>
            				<strong>Sim</strong>
		            	</td>
		            	<td width="74%" colspan="3">			
                			<html:radio property="responsavelId" value="2" onclick="enviarParametroIndicadorResponsavel();"/>

...
function DateValidations () { 
 ...
 function validateConfirmarOrdemProcessoRepavimentacaoPopUpActionForm() { 
     var form = document.forms[0];       
     if(!isEspecial(form.observacao,"Observação")){
 		return false;
 	}
...
function isEspecial(nomeCampo,nomeCampoMSG){
	var teste = true;
	var indesejaveis = "~{}^%$[]@|`\\<?\#?!;*>\"\'";
...
function anexarFotos(){
	var form = document.forms[0];       
	window.location.href = '/gsan/exibirAssociarFotosOSRepavimentacaoPopUpAction.do?desfazer=sim&idRA='+form.idRA.value
}

function outrosServicos(){
	var form = document.forms[0];
	window.location.href = '/gsan/exibirInformarServicosRepavimentadoraAction.do?idOrdemServico='+form.idOrdemServico.value+
	'&idUnidadeRepavimentadora='+form.idUnidadeRepavimentadora.value;
}
		...
		<tr>
			...
			<table width="100%" border="0">
				<tr>
                    ...
                    <logic:equal name="desabilitaOutrosServicos" scope="request" value="false" >
	                    <td>
	                    	<input name="Button" type="button" 
	                    			class="bottonRightCol" value="Outros Serviços"
	                    			onclick="javascript:outrosServicos();" >
	                    </td>
	                </logic:equal>
	                <logic:equal name="desabilitaOutrosServicos" scope="request" value="true" >
	                	<td>
					...
					<td width="90%" align="right">						
						<input  type="button" 
							    ...
							    value="Anexar Fotos" 
							    onClick="javascript:anexarFotos();">
					</td>
				...
				<tr><td colspan="6" align="right"><input name="Button" type="button"
						class="bottonRightCol" value="Fechar"
						onClick="javascript:fechar();"></td></tr>
			</table>
			<p>&nbsp;</p>
			</td>
		</tr>

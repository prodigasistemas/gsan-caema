...
<script language="JavaScript">
    ...
    function validarForm() {
    	var form = document.forms[0];
	  	if(validateAtualizarServicoRepavimentadoraActionForm(form)) {	     
...
<html:javascript staticJavascript="false"
	formName="AtualizarServicoRepavimentadoraActionForm" />

<body leftmargin="5" topmargin="5"
	onload="setarFoco('${requestScope.nomeCampo}');">

	<html:form action="/atualizarServicoRepavimentadoraAction.do"
		name="AtualizarServicoRepavimentadoraActionForm"
		type="gcom.gui.atendimentopublico.ordemservico.AtualizarServicoRepavimentadoraActionForm"
		method="post"
		onsubmit="return validateAtualizarServicoRepavimentadoraActionForm(this);">
				...
				<td valign="top" class="centercoltext">
					...
					<table width="100%" border="0" align="center" cellpadding="0"
						...
						<tr>
							...
							<td class="parabg">Atualizar Serviço Repavimentadora</td>
					...
					<table width="100%" border="0">
						<tr>
							<td colspan="2">Para atualizar um serviço da repavimentadora, informe os dados abaixo:</td>
						</tr>
						...
						<tr>
							<td><strong>Unidade do Serviço:<font color="#FF0000">*</font></strong>
							</td>
							<td>
								<html:select property="unidadeMaterial" tabindex="5" style="width:200px;">
						...
						<tr>
							<td height="24"><strong>Valor do Serviço:<font color="#FF0000">*</font></strong></td>
							<td>
								<html:text style="text-align:right;" maxlength="12" property="valorServico" size="12"
					...
					<table width="100%">
						<tr>
							<td width="40%" align="left"><input type="button"
								...
								value="Desfazer"
								onclick="window.location.href='/gsan/exibirAtualizarServicoRepavimentadoraAction.do?desfazer=S&reloadPage=1&idServico=<bean:write name="AtualizarServicoRepavimentadoraActionForm" property="id" />';">

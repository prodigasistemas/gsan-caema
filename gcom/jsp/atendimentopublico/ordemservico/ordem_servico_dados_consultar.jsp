...
<script language="JavaScript">
	...
	/*function abreFotos(idOs){ 
 		var form = document.forms[0];
 		var numeroOS=0;;
 		if(form.numeroOSPesquisada.value != form.numeroOS.value){
 			numeroOS = form.numeroOSPesquisada.value;
 	 	}else{
 	 		numeroOS = form.numeroOS.value;
 	 	 }
    	var action = 'exibirConsultarDadosOrdemServicoAction.do?metodo=visualizarFotos&numeroOS='+numeroOS+'&idOs=' + idOs;
    	
		$('#result').load(action, function(response, status, xhr) {alert('wee2');
			if (status == "error") {
	...
	<table width="770" border="0" cellspacing="5" cellpadding="0">
		<tr>
			...
			<table width="100%" border="0">
				...
				<!-- Histórivo Motivos OS -->
				<logic:present name="colOsProgramacaoAcompServico">
					<%int cont = 0;%>
					<tr bgcolor="#cbe5fe">
						<td align="center">
						<div id="layerHideMotivos" style="display:block">
	
						<table width="100%" border="0" bgcolor="#99CCFF">
							<tr bgcolor="#99CCFF">
								<td align="center"><span class="style2"> <a
									href="javascript:extendeTabela('Motivos',true);" /> <b>Histórico Motivos OS
								Não Encerradas</b> </a> </span></td>
							</tr>
						</table>
						</div>
	
						<div id="layerShowMotivos" style="display:none">
	
						<table width="100%" border="0" bgcolor="#99CCFF">
							<tr bgcolor="#99CCFF">
								<td align="center"><span class="style2"> <a
									href="javascript:extendeTabela('Motivos',false);" /> <b>Histórico Motivos OS
								Não Encerradas</b> </a> </span></td>
							</tr>
								...
								<table border="0" width="100%">
									<tr bgcolor="#cbe5fe" >
				              			<td width="100%" align="center">
											<div style="height:auto;max-height:170px; overflow: auto;">
												<table width="100%" bgcolor="#99CCFF"  bordercolor="#000000">
													<tr bordercolor="#000000" bgcolor="#90c7fc" class="styleFontePeqNegrito">
														<td width="28%"><strong>Data da Programação</strong></td>
														<td><strong>Motivo do Não Encerramento</strong> </td>
													</tr>
														<logic:iterate id="osProgramacaoAcompanhamentoServico" name="colOsProgramacaoAcompServico" type="OSProgramacaoAcompanhamentoServico">
														<%cont = cont + 1;
														if (cont % 2 == 0) {%>
															<tr bgcolor="#cbe5fe" class="styleFontePequena" height="20" >
																<%} else {%>
															<tr bgcolor="#FFFFFF" class="styleFontePequena" height="20">
																<%}%>				
																<td><bean:write
																		name="osProgramacaoAcompanhamentoServico" property="dataProgramacao"
																		formatKey="date.format" />																			
																</td>	
																<td>									
																	${osProgramacaoAcompanhamentoServico.osProgramacaoNaoEncerramentoMotivo.descricao }																	
																</td>
				...
				<!-- RM7889 - Historico Tipo de Servico Alterado -->
				
				<tr bgcolor="#cbe5fe">
					<td align="center">
					<div id="layerHideHistorico" style="display:block">

					<table width="100%" border="0" bgcolor="#99CCFF">
						<tr bgcolor="#99CCFF">
							<td align="center"><span class="style2"> <a
								href="javascript:extendeTabela('Historico',true);" /> <b>Historico Tipo de Servico Alterado</b> </a> </span></td>
						</tr>
					</table>
					</div>

					<div id="layerShowHistorico" style="display:none">

					<table width="100%" border="0" bgcolor="#99CCFF">
						<tr bgcolor="#99CCFF">
							<td align="center"><span class="style2"> <a
								href="javascript:extendeTabela('Historico',false);" /> <b>Historico Tipo de Servico Alterado</b> </a> </span></td>
						</tr>
								...
								<tr bgcolor="#cbe5fe" >
			              			<td width="100%" align="center">
										<div style="height:auto;max-height:170px; overflow: auto;">
											<table width="100%" bgcolor="#99CCFF"  bordercolor="#000000">
												<tr bordercolor="#000000" bgcolor="#90c7fc" class="styleFontePeqNegrito">
													<td width="20%"><strong>Data Inclusão</strong></td>
													<td width="20%"><strong>Código do Serviço em Campo</strong> </td>
													<td width="20%"><strong>Código do Serviço Alterado </strong> </td>
													<td width="20%"><strong>Matrícula</strong> </td>
													<td width="20%"><strong>Nome do Usuário</strong> </td>
												</tr>
												<tr bordercolor="#000000">
													<td><html:text property="dataAlteracao" size="8" maxlength="10" readonly="true"/></td>
													<td><html:text property="codigo" size="8" maxlength="8" readonly="true"/></td>
													<td><html:text property="codigoAlterado" size="8" maxlength="8" readonly="true"/></td>
													<td><html:text property="login" size="10" maxlength="8" readonly="true"/></td>
													<td><html:text property="nomeUsuario" size="15" maxlength="8" readonly="true"/></td>
												</tr>
												<!-- 
												<tr bordercolor="#000000">
													<td width="20%"><html:text property="dataAlteracao" readonly="true"
														style="background-color:#EFEFEF; border:0;" 
														maxlength="10" /></td>
													<td width="20%"><html:text property="codigo" readonly="true"
														style="background-color:#EFEFEF; border:0;" 
														maxlength="5" /></td>
													<td width="20%"><html:text property="codigoAlterado" readonly="true"
														style="background-color:#EFEFEF; border:0;" 
														maxlength="5" /></td>
													<td width="20%"><html:text property="login" readonly="true"
														style="background-color:#EFEFEF; border:0;" 
														maxlength="10" /></td>
													<td width="20%"><html:text property="nomeUsuario" readonly="true"
														style="background-color:#EFEFEF; border:0;" 
														maxlength="10" /></td>														
												</tr>	-->	
												</tr> 

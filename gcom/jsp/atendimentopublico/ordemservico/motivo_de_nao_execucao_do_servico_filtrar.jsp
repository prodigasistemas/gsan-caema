...
<!--
	...
	function validarForm(){
		var form = document.FiltrarMotivoDeNaoExecucaoDoServicoActionForm;
		form.action = 'filtrarMotivoDeNaoExecucaoDoServicoAction.do?indicadorAtualizar=' + form.indicadorAtualizar.value;		
	...
	function limparForm() {
		...
		form.unidadeRepavimentacao.value = "-1";
...
<script language="JavaScript" src="<bean:message key="caminho.js"/>validacao/regras_validator.js"></script><html:javascript staticJavascript="false"  formName="FiltrarMotivoDeNaoExecucaoDoServicoActionForm" />

<body leftmargin="5" topmargin="5"
	onload="setarFoco('${requestScope.nomeCampo}');verificarChecado('${indicadorAtualizar}');">

<html:form action="/filtrarMotivoDeNaoExecucaoDoServicoAction"
	name="FiltrarMotivoDeNaoExecucaoDoServicoActionForm"
	type="gcom.gui.atendimentopublico.ordemservico.FiltrarMotivoDeNaoExecucaoDoServicoActionForm"
	method="post"
	onsubmit="return validateFiltrarMotivoDeNaoExecucaoDoServicoActionForm(this);">
		...
		<tr>
			...
			<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
				<tr>
					...
					<td class="parabg">Filtrar Motivo de Não Execução do Serviço de Repavimentação</td>
					<td width="11"><img border="0"
			...
			<table width="100%" border="0">
				<tr>
					...
					<table width="100%">
						<tr>
							<td width="80%">Para filtrar o(s) Motivo(s) de não execução do serviço, informe os dados abaixo
							</td>
							<td align="right"><input type="checkbox"
								name="indicadorAtualizar" value="1" 
								onclick="javascript:verificarValorAtualizar();" />
			...
			<table width="100%" border="0">
				<tr>
					...
					<td colspan="2"><html:text property="descricao" size="45"
						maxlength="80" tabindex="1" /></td>
				</tr>
				<tr>
					<td>&nbsp;</td>
					<td><input type="radio"
						onclick="javascript:document.forms[0].acertar.value = 1;" checked="checked"
						name="tipoPesquisa" property="tipoPesquisa" value="1">Iniciando pelo texto 
					<input type="radio" onclick="javascript:document.forms[0].acertar.value = 2;"
						name="tipoPesquisa" property="tipoPesquisa" value="2">  Contendo o texto</td>
					<td>&nbsp;</td>						
				</tr>
				<tr>
					<td>
				...
				<tr>
					...
					<td><html:select property="unidadeRepavimentacao" tabindex="3" style="width:200px;">
						<html:option
				...
				<tr>
					<td colspan="2"><input name="Button" type="button" class="bottonRightCol"
						...
						onclick="javascript:limparForm();" tabindex="7">

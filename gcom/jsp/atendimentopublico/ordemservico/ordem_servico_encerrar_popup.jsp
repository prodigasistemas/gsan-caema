		...
		<tr>
			...
			<table width="100%" border="0">
				...
				<tr>
					...
					<logic:notEmpty name="isNew">
						<input type="hidden" name="isNew" value="false" />
					</logic:notEmpty> 
					<logic:empty name="isNew">
							...
							<table width="100%" border="0" bgcolor="#99CCFF">
								...
								<logic:notEmpty name="EncerrarOrdemServicoActionForm" property="exibeQtdeReposicaoAsfalto">
									<logic:equal name="EncerrarOrdemServicoActionForm" 
										...
										<tr>
											<td><strong>Quantidade de reposição de asfalto:</strong></td>

											<td><html:text property="qtdeReposicaoAsfalto" size="6" maxlength="6" onkeyup="formataValorMonetario(this, 6)"/></td>
										</tr>		 
								 	</logic:equal>
								</logic:notEmpty>	
								...
								<logic:notEmpty name="EncerrarOrdemServicoActionForm" property="exibeQtdeReposicaoParalelo">
									<logic:equal name="EncerrarOrdemServicoActionForm" 
										...
										<tr>
											...
											<td><html:text property="qtdeReposicaoParalelo" size="6" maxlength="6" onkeyup="formataValorMonetario(this, 6)"/></td>
										</tr>															 
								 	</logic:equal>
								</logic:notEmpty>	
								...
								<logic:notEmpty name="EncerrarOrdemServicoActionForm" property="exibeQtdeReposicaoCalcada">
									<logic:equal name="EncerrarOrdemServicoActionForm" 
										...
										<tr>
											...
											<td><html:text property="qtdeReposicaoCalcada" size="6" maxlength="6" onkeyup="formataValorMonetario(this, 6)"/></td>
										</tr>					 
								 	</logic:equal>
								</logic:notEmpty>									 								 

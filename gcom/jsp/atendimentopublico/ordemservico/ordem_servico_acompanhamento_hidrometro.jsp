...
<script language="JavaScript">
	...
	function validaTodosPeriodos() {
		...
		if (validaPeriodoEncerramento(form)
			...
			alert('Data Final do Período de Execução é anterior à Data Inicial');
			return false;
		}
				...
				<td valign="top" class="centercoltext">
					...
					<table width="100%" border="0" align="center" cellpadding="0"
						...
						<tr>
							...
							<td class="parabg">Filtrar Relatório de Acompanhamento Ordem
								de Serviço de Hidr&ocirc;metro</td>
							<td width="11"><img border="0"
					...
					<table width="100%" border="0">
						...
						<tr>
							<td colspan="2">Para selecionar ordens de serviço para
								geração do relatório de acompanhamento, informe os dados abaixo:</td>
						</tr>
						<tr>
									...
									<tr>
										<logic:present name="tipoOrdem">
											...
											<td align="left" nowrap><html:radio value="REMOCAO"
													property="tipoOrdem" tabindex="3"></html:radio>Remoção
												Hidr&ocirc;metro</td>
										</logic:present>
										<logic:notPresent name="tipoOrdem">
											...
											<td align="left" nowrap><input type="radio"
												...
												Hidr&ocirc;metro</td>
											<td align="left" nowrap><input type="radio"
												name="tipoOrdem" value="REMOCAO" tabindex="3">Remoção
												Hidr&ocirc;metro</td>
										</logic:notPresent>
									</tr>
									<tr>
										<logic:present name="tipoOrdem">
											<td align="left" nowrap><html:radio
													...
													tabindex="4"></html:radio>Inspeção de Anormalidade</td>
											<td align="left" nowrap><html:radio
													value="SUBSTITUICAO COM REMOCAO" property="tipoOrdem"
													tabindex="5"></html:radio>Substituição com Remoção</td>
										</logic:present>
										<logic:notPresent name="tipoOrdem">
											<td align="left" nowrap><input type="radio"
												name="tipoOrdem" value="INSPECAO DE ANORMALIDADE"
												tabindex="4">Inspeção de Anormalidade</td>
											<td align="left" nowrap><input type="radio"
												name="tipoOrdem" value="SUBSTITUICAO COM REMOCAO"
												tabindex="5">Substituição com Remoção</td>
										</logic:notPresent>
									</tr>
									<tr>
										<logic:present name="tipoOrdem">
											<td colspan="2" align="left" nowrap><html:radio
													...
													property="tipoOrdem" tabindex="6"></html:radio>Instalação
												da Caixa de Proteção</td>
										</logic:present>
										<logic:notPresent name="tipoOrdem">
											<td colspan="2" align="left" nowrap><input type="radio"
												name="tipoOrdem" value="INSTALACAO DA CAIXA DE PROTECAO"
												tabindex="6">Instalação da Caixa de Proteção</td>
										</logic:notPresent>
									</tr>
								</table>
							</td>
						...
						<tr>
							<td><strong>Gerência Reginal:&nbsp;</strong></td>
							<td align="right">
								<div align="left">

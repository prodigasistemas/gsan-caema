...
<!--
	function verificarChecado(valor){
		var form = document.FiltrarNaturezaEquipeActionForm;
	...
	function validarForm(){
		...
		if(validateFiltrarNaturezaEquipeActionForm(form)){
			botaoAvancarTelaEspera('/gsan/filtrarNaturezaEquipeAction.do?indicadorAtualizar=' + form.indicadorAtualizar.value);
		}
	}
...
<script language="JavaScript" src="<bean:message key="caminho.js"/>validacao/regras_validator.js"></script>
	<html:javascript staticJavascript="false"  formName="FiltrarNaturezaEquipeActionForm" />
...
<html:form action="/filtrarNaturezaEquipeAction"
	name="FiltrarNaturezaEquipeActionForm"
	type="gcom.gui.atendimentopublico.ordemservico.FiltrarNaturezaEquipeActionForm"
	method="post"
	onsubmit="return validateFiltrarNaturezaEquipeActionForm(this);">
		...
		<tr>
			...
			<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
				<tr>
					...
					<td class="parabg">Filtrar Natureza de Equipe</td>
					<td width="11"><img border="0"
			...
			<table width="100%" border="0">
				<tr>
					...
					<table width="100%">
						<tr>
							<td width="80%">Para filtrar a(s) Natureza(s) de equipe, informe os dados abaixo:
							</td>

	...
	<table width="770" border="0" cellspacing="5" cellpadding="0">
		<tr>
			...
			<table width="100%" border="0">
				...
				<tr>
					<td><strong><span class="style2">Indicador de Geração de Resumo:
					<font color="#FF0000">*</font></span></strong></td>
					<td align="left" width="20%"><label> <html:radio
						property="indicadorGerarResumo" value="1" /> <strong>Sim</strong></label>
					<label> <html:radio property="indicadorGerarResumo"
						value="2" /> <strong>Não</strong></label>
					<label> <html:radio property="indicadorGerarResumo"
						value="" /> <strong>Todos</strong></label> 
					</td>
				</tr>
				...
				<tr>
					...
					<label><html:radio 
						property="indicadorEmpresaCobranca" value=""/> <strong>Todos</strong></label>	
					</td>
				</tr>
				...
				<tr>
					...
					<label> <html:radio property="indicadorInspecaoAnormalidade" value="" /> <strong>Todos</strong></label>	
					</td>
				</tr>
				...
				<tr>
					...
					<label><html:radio 
						property="indicadorProgramacaoAutomatica" value="" /> <strong>Todos</strong></label>	
					</td>
				</tr>

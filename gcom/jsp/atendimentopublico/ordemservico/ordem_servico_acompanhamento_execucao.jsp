...
<script language="JavaScript">
    ...
    function validaTodosPeriodos() {
		...
		if (validaPeriodoAtendimento(form) && validaPeriodoEncerramento(form) && validaPeriodoExecucao(form)) {
    ...
    function validaPeriodoExecucao(form) {
    	...
    	var periodoExecucaoInicial = trim(form.periodoExecucaoInicial.value);
 	   	var periodoExecucaoFinal = trim(form.periodoExecucaoFinal.value);
	...
	//Replica Data de Execução
	function replicaPeriodoExecucao() {
		var form = document.forms[0];
	...
	<table width="770" border="0" cellspacing="5" cellpadding="0">
		<tr>
			...
			<table width="100%" border="0">
				...
				<tr>
					<td><strong>Per&iacute;odo de Execu&ccedil;&atilde;o:</strong></td>

					<td colspan="6"><span class="style2"> <strong> <html:text
						property="periodoExecucaoInicial" size="11" maxlength="10"
						tabindex="3"
						onkeyup="mascaraData(this, event);replicaPeriodoExecucao();" />
					<a
						href="javascript:chamarCalendario('periodoExecucaoInicial',document.forms[0].periodoExecucaoInicial,'periodoExecucaoFinal');">
					<img border="0"
						src="<bean:message key='caminho.imagens'/>calendario.gif"
						width="16" height="15" border="0" alt="Exibir Calendário"
						tabindex="4" /></a> a <html:text
						property="periodoExecucaoFinal" size="11" maxlength="10"
						tabindex="3" onkeyup="mascaraData(this, event)" /> <a
						href="javascript:chamarCalendario('periodoExecucaoFinal',document.forms[0].periodoExecucaoFinal,'');">
					<img border="0"
						src="<bean:message key='caminho.imagens'/>calendario.gif"
						width="16" height="15" border="0" alt="Exibir Calendário"
						tabindex="4" /></a> </strong>(dd/mm/aaaa)<strong> </strong> </span>

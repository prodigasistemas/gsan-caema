		...
		<tr>
			...
			<table width="100%" border="0">
				...
				<tr>
					...
					<td align="right" colspan="2">
					<div align="left"><html:radio property="indicadorManterProgramacaoOSdiaAnterior" tabindex="4"
						value="<%=ConstantesSistema.INDICADOR_USO_ATIVO.toString()%>" />
					<strong>Sim</strong> <html:radio property="indicadorManterProgramacaoOSdiaAnterior"
						tabindex="5"
						value="<%=ConstantesSistema.INDICADOR_USO_DESATIVO.toString()%>" />
					<strong>Não</strong> <html:radio property="indicadorManterProgramacaoOSdiaAnterior"
						tabindex="5" value="" /> <strong>Todos</strong></div>
					</td>
				</tr>
				<tr>

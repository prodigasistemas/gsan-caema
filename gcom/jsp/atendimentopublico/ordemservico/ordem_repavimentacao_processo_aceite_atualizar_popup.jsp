	...
	<table width="600" border="0" cellpadding="0" cellspacing="5">
		<tr>
			...
			<table width="100%" border="0">
				...
				<tr>
					<td><strong>Pvto.Rua T / (m2):</strong></td>
					<td width="66%">
						<html:text property="pavimentoRua" 	
					 			tabindex="3"
					 			disabled="disabled" 
					 			readonly="true" />
					</td>
				...
				<tr>
					<td><strong>Pvto.Rua-Ret T / (m2):</strong></td>
					<td width="66%">
						<html:text property="pavimentoRuaRetorno" 	
					 			tabindex="3"
					 			disabled="disabled" 
					 			readonly="true" />
					</td>
					...
					<td colspan="2">
						 <table width="100%" bgcolor="#99CCFF">	
						 	<tr bordercolor="#FFFFFF" bgcolor="#99CCFF">
								<td width="70%">
									<div align="center" class="style9"><strong>Outros Serviços</strong></div>
								<td width="30%">
									<div align="center" class="style9"><strong>Quantidade</strong></div>
								</td>
							</tr>
							
							<%String cor = "#FFFFFF";%>
							<logic:present name="colecaoServicoRepavimentadoraHelper" scope="session">
								<logic:iterate indexId="posicao"
									name="colecaoServicoRepavimentadoraHelper" id="helper" >
				...
				<logic:present name="colecaoFotoOS" scope="session" >
					<tr>
						<td >
							<div id="gallery">
							    <ul>

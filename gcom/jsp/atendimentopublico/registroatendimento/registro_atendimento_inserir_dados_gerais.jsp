...
<SCRIPT LANGUAGE="JavaScript">
   ...
   function caracteresespeciais () { 
	...
	function mudarTipoSolicitacao(){
		...
		redirecionarSubmit('inserirRegistroAtendimentoWizardAction.do?action=exibirInserirRegistroAtendimentoDadosGeraisAction&pesquisarTipoSolicitacao=OK');
	}
...
<html:form action="/inserirRegistroAtendimentoWizardAction" 
 name="InserirRegistroAtendimentoActionForm"
...
<%@ include file="/jsp/util/informacoes_usuario.jsp"%> 
	...
	<td width="625" valign="top" class="centercoltext">
      ...
      <tr>
        ...
        <td>
			<logic:equal name="InserirRegistroAtendimentoActionForm" property="tipo" value="1">
				...
				<img border="0" src="<bean:message key='caminho.imagens'/>calendario.gif" width="20" border="0" title="Exibir Calendário" tabindex="4"/>
			</logic:equal>
      ...
      <tr>
      	<td HEIGHT="30"><strong>Unidade Atendimento:<font color="#FF0000">*</font></strong></td>
        <td colspan="2">
			...
			<logic:notPresent name="desabilitaUnidade">
				...
				<html:text property="unidade" size="4" maxlength="4" tabindex="8" onkeypress="validaEnterComMensagem(event, 'inserirRegistroAtendimentoWizardAction.do?action=exibirInserirRegistroAtendimentoDadosGeraisAction&pesquisarUnidade=OK', 'unidade', 'Unidade');return isCampoNumerico(event);"/>
      ...
      <tr>
		...
		<c:if test="${not empty InserirRegistroAtendimentoActionForm.prazoPrevistoArpe }">
			<tr id="divArpe">

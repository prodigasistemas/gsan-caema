	...
	<table width="770" border="0" cellspacing="5" cellpadding="0">
		<tr>
			...
			<table width="100%" border="0">
				...
				<tr>
					<td width="40%"><strong>Situação Esgoto Factível Faturável:</strong></td>
					<td colspan="2"><html:radio property="indicadorFactivelFaturavel" value="1"
						tabindex="3" /> <strong>Sim</strong>&nbsp; <html:radio
						property="indicadorFactivelFaturavel" value="2" tabindex="4" /> <strong>N&atilde;o</strong>&nbsp;
					<html:radio property="indicadorFactivelFaturavel" value="3" tabindex="4" />
					<strong>Todos</strong>
				</tr>
			...
			<table width="100%" border="0">
				<tr>
					<td valign="top"><input name="button" type="button"
						...
						onclick="window.location.href='/gsan/exibirFiltrarTipoSolicitacaoEspecificacaoAction.do?menu=sim'">&nbsp;

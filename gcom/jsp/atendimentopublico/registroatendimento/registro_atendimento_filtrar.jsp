...
<SCRIPT LANGUAGE="JavaScript">
	function reload() {
		...
		if(form.grupoAtendimento.selectedIndex == 0){
			limparEspecificacao();
			limparTipoSolicitacao();
		}
	...
	function habilitaTipoSolicitacao() {
		var form = document.forms[0];
		if(form.selectedGrupoAtendimentoSize.value = '1') {
			form.tipoSolicitacao.disabled = false;
		}else{
			form.tipoSolicitacao.disabled = true;
		}
	}
	...
	function mudarGrupo() {
		var form = document.FiltrarRegistroAtendimentoActionForm;
		form.mudouGrupo.value = "true";
	}
	...
	/* Clear Tipo Solicitacao */
	function limparTipoSolicitacao() {
		var form = document.forms[0];
		
		for(i=form.tipoSolicitacao.length-1; i>0; i--) {
			form.tipoSolicitacao.options[i] = null;
		}
	}
...
<html:hidden property="selectedGrupoAtendimentoSize" />
<html:hidden property="situacaoId"/>
<html:hidden property="mudouGrupo"/>
	...
	<td width="625" valign="top" class="centercoltext">
      ...
      <table width="100%" border="0">
			<tr> 
              ...
              <tr>
              	<td><strong>Grupo de Atendimento:</strong></td>
              	<td colspan="1"><span class="style2"><strong>
					<html:select property="grupoAtendimento" style="width: 427px; height:100px;" multiple="true" onchange="javascript:mudarGrupo();reload();habilitaTipoSolicitacao();">
						<html:option value="<%=""+ConstantesSistema.NUMERO_NAO_INFORMADO%>">&nbsp;</html:option>
						<logic:present name="colecaoGrupoAtendimento" scope="session">
              ...
              <tr> 
                ...
                <td colspan="1"><span class="style2"><strong>
					<html:select property="tipoSolicitacao" style="width: 427px; height:100px;" multiple="true" onchange="javascript:reload();habilitaEspecificacao();">
						<html:option value="<%=""+ConstantesSistema.NUMERO_NAO_INFORMADO%>">&nbsp;</html:option>
              ...
              <tr> 
                ...
                <td colspan="1"><span class="style2"><strong> 
					<html:select property="especificacao" style="width: 427px;" multiple="true">
						<html:option value="<%=""+ConstantesSistema.NUMERO_NAO_INFORMADO%>">&nbsp;</html:option>
              ...
              <tr> 
                ...
                <td colspan="1"><span class="style2"><strong>
					<html:select property="colecaoPerfilImovel" style="width: 427px; height:100px;" multiple="true">
						<html:option value="<%=""+ConstantesSistema.NUMERO_NAO_INFORMADO%>">&nbsp;</html:option>
              ...
              <tr> 
                ...
                <td colspan="1"><span class="style2"><strong> 
					...
					<html:select property="colecaoAtendimentoMotivoEncerramento" style="width: 427px; height:100px;" disabled="true" multiple="true">
						<html:option value="<%=""+ConstantesSistema.NUMERO_NAO_INFORMADO%>">&nbsp;</html:option>
					...
					<html:select property="colecaoAtendimentoMotivoEncerramento" style="width: 427px; height:100px;" multiple="true">
						<html:option value="<%=""+ConstantesSistema.NUMERO_NAO_INFORMADO%>">&nbsp;</html:option>
						<logic:present name="colecaoAtendimentoMotivoEncerramento" scope="session">
							<html:options collection="colecaoAtendimentoMotivoEncerramento" labelProperty="descricao" property="id" />
						</logic:present>
             ...
             <tr> 
              ...
              <tr> 
                ...
                <td colspan="3"> 
	                <div align="right" style="width: 355px;"> 

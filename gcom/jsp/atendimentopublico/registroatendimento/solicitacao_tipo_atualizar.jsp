...
<script language="JavaScript">
	...
	function remover(id) {
		...
		if (where_to == true) {
			form.action = 'exibirAtualizarTipoSolicitacaoEspecificacaoAction.do?deleteComponente='
					+ id;
			form.submit();
		}
	}
...
<div id="formDiv">
	...
	<html:form action="/atualizarTipoSolicitacaoEspecificacaoAction"
		...
		<html:hidden property="indicadorPermiteClienteDesconhecido" />
				...
				<td width="600" valign="top" bgcolor="#003399" class="centercoltext">
					...
					<table width="100%" border="0" align="center" cellpadding="0"
						...
						<tr>
							...
							<td class="parabg">Atualizar Tipo de Solicitação com
								Especificações</td>
					...
					<table width="100%" border="0">
						<tr>
							<td colspan="2">
								<p>Para atualizar um tipo de solicitação, informe os dados
									abaixo:</p>
								<p>&nbsp;</p></td>
							<logic:present scope="application" name="urlHelp">
								<td align="right"><a
									href="javascript:abrirPopupHelp('${applicationScope.urlHelp}atendimentoRegistroTipoSolicitacaoEspecificacoesAtualizar', 500, 700);"><span
						...
						<tr>
							<td><strong>Código do Tipo de Solicitação:</strong>
							</td>
							<td><html:hidden property="idTipoSolicitacao" /> <bean:write
									name="AtualizarTipoSolicitacaoEspecificacaoActionForm"
									property="idTipoSolicitacao" />
							</td>
						</tr>
						...
						<tr>
							...
							<td><html:text property="descricao" size="50" maxlength="60"
									tabindex="1" />
							</td>
						</tr>
						<tr>
						...
						<tr>
							<td width="40%"><strong>Situação Esgoto Factível Faturável:<font
									color="#FF0000">*</font>
							</strong>
							</td>
							<td><html:radio property="indicadorFactivelFaturavel" value="1"
									tabindex="5" /> <strong>Sim</strong>&nbsp; <html:radio
									property="indicadorFactivelFaturavel" value="2" tabindex="6" /> <strong>N&atilde;o</strong>
						</tr>
						
						<tr>
							<td width="40%"><strong>Indicador de uso:<font
									color="#FF0000">*</font>
							</strong>
							</td>
							<td><html:radio property="indicadorUso" value="1"
									tabindex="7" /> <strong>Ativo</strong>&nbsp; <html:radio
									property="indicadorUso" value="2" tabindex="8" /> <strong>Inativo</strong>
						</tr>
						<tr>
							...
							<td><logic:present
									...
									<html:radio property="indicadorUsoSistema" value="1"
										tabindex="9" />
									<strong>Sim</strong>&nbsp; 
							<html:radio property="indicadorUsoSistema" value="2" tabindex="10" />
						...
						<tr>
							<td colspan="2"><strong>Especificação do Tipo da
							...
							<td colspan="3">
								<table width="100%" bgcolor="#99CCFF cellpadding="
									...
									<tr bordercolor="#000000">
										...
										<td bgcolor="#90c7fc" width="65%"><strong>Descrição
												da Especificação</strong>
										</td>
										<td bgcolor="#90c7fc" width="20%"><strong>Indicador
												de Uso</strong>
										</td>
									</tr>
									...
									<tr>
										<logic:present name="colecaoSolicitacaoTipoEspecificacao">
											<logic:iterate name="colecaoSolicitacaoTipoEspecificacao"
												...
												type="SolicitacaoTipoEspecificacao">
												...
												<td bordercolor="#90c7fc">
													<div align="center">
														<img src="<bean:message key='caminho.imagens'/>Error.gif"
															...
															name="imagem" onclick="remover('${count}');"
															alt="Remover">
													</div></td>
										...
										<div align="center">
											<bean:write name="solicitacaoTipoEspecificacao" property="id" />
												...
												<td bordercolor="#90c7fc">
													<div align="center">
														<%
															if (solicitacaoTipoEspecificacao.getIndicadorUso() == 1) {
														%>
														Ativo
														<%
															} else {
					...
					<table width="100%" border="0">
						<tr>
							<td colspan="2"><font color="#FF0000"><logic:present
									...
									</logic:notPresent> <input type="button" name="ButtonReset" class="bottonRightCol"

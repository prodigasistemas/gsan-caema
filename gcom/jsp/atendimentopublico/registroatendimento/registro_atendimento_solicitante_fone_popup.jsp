...
var bCancel = false; 
   ...
   if ((temLetra(form.numeroTelefone.value) == 1)){
         alert('Campo referente ao telefone deve conter apenas números.');
   } 
   
   else
   
   if (form.numeroTelefone.size != 8){
         alert('Campo referente ao telefone deve conter 8 dígitos.');
   }
		...
		<tr>
			...
			<table width="100%" border="0">
				...
				<tr>
					...
					<td>
						<input type="text" name="numeroTelefone" maxlength="8" size="8" tabindex="4" onkeypress="return isCampoNumerico(event);">
					</td>
				</tr>

				...
				<tr> 
					...
					<td width="70%" colspan="2">
						...
						<html:text	property="periodoReclamacaoInicio" size="10" maxlength="10" tabindex="11" 
							onkeyup="mascaraData(this, event);somente_numero(this);replicarCampo(document.forms[0].periodoReclamacaoFim,this);" 
				...
				<tr> 
					...
					<td width="70%" colspan="2">
						...
						<html:text	property="periodoRetornoInicio" size="10" maxlength="10" tabindex="13" 
							onkeyup="mascaraData(this, event);somente_numero(this);replicarCampo(document.forms[0].periodoRetornoFim,this);" 

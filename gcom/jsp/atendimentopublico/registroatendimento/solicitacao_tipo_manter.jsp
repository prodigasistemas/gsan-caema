...
<script>
	function transferir(){
		if(selecionou()){
			var chave = selecionou();
			var form = document.forms[0];
	  		form.action='exibirTransferirSolicitacaoEspecificacaoAction.do?chave='+chave;
	  		form.submit();
  		}
	}
	...
	function selecionou(){
		var form = document.forms[0];
		var selecionados = form.elements['idRegistrosRemocao'];
			...
			for (i=0; i < selecionados.length; i++) {
				if(selecionados[i].checked){
					...
					if(jaSelecionado == false){
						...
						alert('Marque apenas um Tipo de Solicitação');
						return false;
					}
				}
			}
		...
		if(jaSelecionado == false){
			alert('É necessário marcar algum Tipo de Solicitação');
			return false;
		}
		...
		<tr>
			...
			<table width="100%" border="0" align="center" cellpadding="0"
				...
				<tr>
					...
					<td class="parabg">Consultar Procedimento Operacional Padrão</td>
							...
							<table width="100%" border="0">
								...
								<tr>
									<td><font color="#FF0000"> <html:submit
										...
										value="Transferir Especificações" 
										onclick="return transferir()"
										/> 
									</td>
								</tr>
							</table>

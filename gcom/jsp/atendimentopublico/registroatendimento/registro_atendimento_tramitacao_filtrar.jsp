			...
			<table width="100%" border="0">
				...
				<tr>
					...
					<td colspan="6"><span class="style2"><strong> <html:select
						property="tipoSolicitacao" style="width: 395px; height:100px;"
						multiple="true"
				...
				<tr>
					...
					<td colspan="6"><span class="style2"><strong> <html:select
						property="especificacao" style="width: 395px;" multiple="true">
						<html:option
							value="<%=""+ConstantesSistema.NUMERO_NAO_INFORMADO%>">&nbsp;</html:option>
                ...
                <td><strong>Perfil do Imóvel:</strong></td>
                  <td colspan="1"><span class="style2"><strong>
					<html:select property="colecaoPerfilImovel" style="width: 395px; height:100px;" multiple="true">
				...
				<tr>
					<td><input type="button" class="bottonRightCol"
						value="Limpar"
						onClick="javascript:window.location.href='/gsan/exibirFiltrarRegistroAtendimentoTramitacaoAction.do?menu=sim'">

...
<%@ page import="gcom.atendimentopublico.registroatendimento.bean.SituacaoDevolucaoValoresRAHelper"%>
<%@ page import="gcom.atendimentopublico.registroatendimento.bean.RADevolucaoValoresHelper"%>
			...
			<td width="600" valign="top" class="centercoltext">
								...
								<tr bgcolor="#cbe5fe">
									...
									<table border="0" width="100%">
										...
										<tr> 
		                            	 ...
		                            	 <tr>
			                              	<td class="style3"><strong>Grupo de Atendimento:</strong></td>
			                              	<td colspan="3">
												<html:text property="idGrupoTipoSolicitacao" readonly="true"
													style="background-color:#EFEFEF; border:0;" size="4"
													maxlength="4" />

												<html:text property="grupoTipoSolicitacao" readonly="true"
													style="background-color:#EFEFEF; border:0;" size="57"
													maxlength="50" />
											</td>
			                            </tr> 
		                               	...
		                               	<tr>
		                                 	...
		                                 	<td>
												<html:text property="numeroCoordenadaNorte" readonly="true"
													style="background-color:#EFEFEF; border:0; text-align: right" size="27"
													maxlength="25" />
		                                 	</td>
		                               	</tr>
									...
									<table border="0" width="100%">
										...
										<tr>
                                  		...
                                  		<tr>
                                    		...
                                    		<td colspan="3">
												<html:text property="cpfSolicitante" readonly="true"
													style="background-color:#EFEFEF; border:0;" size="40"
													maxlength="14" />
											</td>
                                  		</tr>                  		
				...
				<!-- Dados da Ultima Tramitação -->
							...
							<tr>
			      			...
			      			<!--Dados de Devolução de Pagamentos - Erivan Sousa-->
							<logic:present name="situacaoDevolucaoValoresRAHelper">
							<tr>
								<td>
                   				        
			                   	  <div id="layerHideDevolucaoPagamentos" style="display:block">
			           					<table width="100%" border="0" bgcolor="#99CCFF">
				    						<tr bgcolor="#99CCFF">
			                     				<td align="center">     
      											 <span class="style2">
			                     					<a href="javascript:extendeTabela('DevolucaoPagamentos',true);"/>
			                     						<strong><bean:write name="situacaoDevolucaoValoresRAHelper"
														property="especificacaoSolicitacao" /></strong>
			                     					</a>
			                     					</span>
			                     				</td>
			                    			</tr>
			                        ...
			                        <div id="layerShowDevolucaoPagamentos" style="display:none">
				                    	...
				                    	<table width="100%" border="0" bgcolor="#99CCFF">
											...
											<tr bgcolor="#99CCFF">
					                    		<td align="center">
			                       					<span class="style2">
			                         					<a href="javascript:extendeTabela('DevolucaoPagamentos',false);"/>
			                         						<strong><bean:write name="situacaoDevolucaoValoresRAHelper"
																property="especificacaoSolicitacao" /></strong>
			                         					</a>
			                       					</span>
													...
													<tr>
			                                    		...
			                                    		<td bgcolor="#90c7fc" align="center">
			                                    			<strong>Valor Pagamento</strong>
			                                  				...
			                                  				<td bgcolor="#90c7fc" align="center">
			                                    			<strong>Valor Devolução</strong>
			                                    		</td>
			                                    		<td bgcolor="#90c7fc" align="center">
			                                    			<strong>Devolvido?</strong>
			                                    		</td>			                                    					                                    		
			                                  		</tr>
													<%	BigDecimal valorTotalPagamentoDevolucao = null;	%>
			                                  		<logic:notEmpty name="situacaoDevolucaoValoresRAHelper"
															property="colecaoRADevolucaoValoresHelper">
														<%!	int cont2 = 1;	%>														
														<logic:iterate name="situacaoDevolucaoValoresRAHelper"
																property="colecaoRADevolucaoValoresHelper" id="rADevolucaoValoresHelper"
																type="RADevolucaoValoresHelper">																
															<%	cont2 = cont2 + 1;
																if (cont2 % 2 == 0) {	%>
																	<tr bgcolor="#FFFFFF">
															<%	} else {	%>																			
															...
															<%	}	%>
								                       		...
								                       		<%	if(valorTotalPagamentoDevolucao == null){
								                       			valorTotalPagamentoDevolucao = new BigDecimal(0.0);                       			
								                       			}
																if(rADevolucaoValoresHelper.getValorPagamento() != null){
																	valorTotalPagamentoDevolucao = 
																			valorTotalPagamentoDevolucao.add(rADevolucaoValoresHelper.getValorDevolucao()); 
																}	%>
																		<td align="center"><%=rADevolucaoValoresHelper.getDocumentoTipo()%></td>
																		<td align="center"><%=rADevolucaoValoresHelper.getReferencia()%></td>
																		<td align="center"><%=Util.formatarData(rADevolucaoValoresHelper.getDataPagamento())%></td>
																		<td align="right"><%=Util.formatarMoedaReal(rADevolucaoValoresHelper.getValorPagamento())%></td>
																		<td align="right"><%=Util.formatarMoedaReal(rADevolucaoValoresHelper.getValorDevolucao())%></td>
																		<td align="center"><%=rADevolucaoValoresHelper.getIndicadorPagamentoDevolvido() == 1?"SIM":"NÃO"%></td>
																	</tr>
														</logic:iterate>
														...
														<% if (valorTotalPagamentoDevolucao != null) {	%>
								                			<tr>
								        		        		...
								        		        		<td>
												                    <div align="right">
										   		              		<strong><%= Util.formatarMoedaReal(valorTotalPagamentoDevolucao) %></strong>
												                    </div>
								                  				</td>
								                			</tr>
														<%	}	%>														
			      			...
			      			<!-- Final da Devolução de Pagamentos-->
							<tr>
								<td>

		...
		<tr>
			...
			<table width="100%" border="0">
				...
				<tr>
					...
					<td><html:select property="idTipoSolicitacao" size="1" style="width:450px" onchange="javascript:statusEspecificacao();">
			...
			<table width="100%" border="0">
				<tr>
					<td valign="top"><input name="button" type="button"
						...
						onclick="window.location.href='/gsan/exibirFiltrarProcedimentoOperacionalPadraoAction.do?menu=sim'">&nbsp;

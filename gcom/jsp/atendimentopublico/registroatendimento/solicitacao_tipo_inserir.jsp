		...
		<table width="770" border="0" cellspacing="5" cellpadding="0">
			<tr>
				...
				<td width="600" valign="top" bgcolor="#003399" class="centercoltext">
						...
						<tr>
							...
							<td><logic:present
									...
									<html:radio property="indicadorUsoSistema" value="1"
										tabindex="7" />
									<strong>Sim</strong>&nbsp; 
							<html:radio property="indicadorUsoSistema" value="2" tabindex="8" />
									<strong>N&atilde;o</strong>
								</logic:present> <logic:notPresent
									name="temPermissaoAlterarIndicadorUsoSistemaTipoSolicitacao">
									<html:radio property="indicadorUsoSistema" value="1" tabindex="7"
										disabled="true" />
									<strong>Sim</strong>&nbsp; 
							<html:radio property="indicadorUsoSistema" value="2" tabindex="8"
										disabled="true" />
													...
													<table width="100%" bgcolor="#99CCFF">
														...
														<logic:iterate name="colecaoSolicitacaoTipoEspecificacao"
															...
															<tr bgcolor="#FFFFFF">
																...
																<td width="80%"><a
																	href="javascript:document.forms[0].target='';abrirPopup('exibirAdicionarSolicitacaoEspecificacaoAction.do?editar=<bean:write name="solicitacaoTipoEspecificacao" property="idHelper"/>&ultimaAlteracao=<bean:write name="solicitacaoTipoEspecificacao" property="ultimaAlteracao.time"/>',650,1100);">
					...
					<table width="100%" border="0">
						<tr>
							<td valign="top"><input name="button" type="button" tabindex="12"

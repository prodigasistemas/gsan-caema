...
<html:form action="/filtrarNormasProcedimentosAction"
		...
		<td valign="top" class="centercoltext">
            ...
            <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
              <tr>
                ...
                <td class="parabg">Filtrar Normas e Procedimentos</td>
			...
			<table width="100%" border="0">
				 ...
				 <tr>
			          <td width="100%" colspan=2>
				          <table width="100%" border="0">
				          	<tr>
				          		<td>Para filtrar normas e procedimentos no sistema, informe os dados abaixo:</td>
				          		<td align="right"><input type="checkbox" name="indicadorAtualizar" value="1" /><strong>Atualizar</strong></td>
							</tr>
				          </table>
			          </td>
			     </tr>
				...
				<tr> 
             	...
             	<tr> 
              	...
              	<tr>
					<td>&nbsp;</td>
					<td>
						<html:radio property="tipoPesquisaTitulo" value="<%=ConstantesSistema.TIPO_PESQUISA_INICIAL.toString()%>" />Iniciando pelo texto
						<html:radio property="tipoPesquisaTitulo"	value="<%=ConstantesSistema.TIPO_PESQUISA_COMPLETA.toString()%>" /> Contendo o texto
					</td>
				</tr>
         	    ...
         	    <tr> 
              	...
              	<tr>
					<td>&nbsp;</td>
					<td>
						<html:radio property="tipoPesquisaAssunto" value="<%=ConstantesSistema.TIPO_PESQUISA_INICIAL.toString()%>" />Iniciando pelo texto
						<html:radio property="tipoPesquisaAssunto"	value="<%=ConstantesSistema.TIPO_PESQUISA_COMPLETA.toString()%>" /> Contendo o texto
					</td>
				</tr>

				<tr>
					<td>
						<input name="Button" type="button" class="bottonRightCol" value="Limpar" align="left" onclick="window.location.href='<html:rewrite page="/exibirFiltrarNormasProcedimentosAction.do?desfazer=S"/>'" >
                   	</td>
                   	<td  align="right">
						<gsan:controleAcessoBotao name="Button" value="Filtrar"
							  onclick="javascript:validarForm(document.NormaProcedimentosActionForm);" url="filtrarNormasProcedimentosAction.do"/>
					</td>
				</tr>

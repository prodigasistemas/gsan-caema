...
<script language="JavaScript">
	...
	function validaForm() {
		...
		if ((form.motivoNaoCobranca.value == '-1') && (form.quantidadeParcelas.value == 0)){
	...
	function limparOrdemServico(){
		var form = document.forms[0];
		form.action = 'exibirEfetuarCorteLigacaoAguaAction.do?limparOS=OK';
		form.submit();
	}
									...
									<table border="0" width="100%">
										...
										<tr>
											...
											<td colspan="2"><strong> <!--Campo Seleção Motivo do Corte -->
												<logic:notPresent name="bloquearMotivoCorte" scope="session">
													<html:select property="motivoCorte" style="width: 230px;">
														<logic:present name="colecaoMotivoCorteLigacaoAgua" scope="session">
															<html:option
												...
												<logic:present name="bloquearMotivoCorte" scope="session">

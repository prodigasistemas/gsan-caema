...
<script language="JavaScript">
	...
	function limparForm() {
        ...
        if ((form.idOrdemServico.readOnly == false) && (form.idOrdemServico.disable == false)){
		...
		form.indicadorPermanenciaHidrometro[0].checked = false;
		form.indicadorPermanenciaHidrometro[1].checked = true;
	...
	function desfazer(){
		...
		form.action = 'encerrarOrdemServicoAction.do?desfazer=ok';
		form.submit();
	}
    ...
    function verificaForm() {
		...
		if(form.veioEncerrarOS.value == 'true'){
			...
			form.indicadorTipoSupressao[0].checked = true;
			form.indicadorTipoSupressao[0].disabled = true;
			form.indicadorTipoSupressao[1].disabled = true;
			form.indicadorTipoSupressao[0].checked = true;
		}else{
											...
											<table width="100%" border="0" bgcolor="#99CCFF">
												...
												<tr bgcolor="#cbe5fe">
													...
													<table border="0" width="100%">
														...
														<tr>
															<td><strong>Indicador de Permanência Hidrômetro:<font color="#FF0000">*</font></strong></td>
															<td><strong> 
																<html:radio property="indicadorPermanenciaHidrometro" value="1" /> Sim
																<html:radio property="indicadorPermanenciaHidrometro" value="2" /> Não
															</strong></td>
														</tr>
															...
															<logic:notPresent name="permissaoMotivoNaoCobranca">
																...
																<tr>
																	...
																	<td colspan="2"><strong> <html:text
																		...
																		onkeypress="return isCampoNumerico(event);" readonly="false" disabled="false" /> </strong></td>
								...
								<tr>
									...
									<table width="100%">
										...
										<tr>
											...
											<input name="Button" type="button"
												class="bottonRightCol" value="Efetuar"
												onClick="javascript:validarForm2(document.forms[0]);">
											</logic:notPresent>
											</td>
										</tr>
									</table>

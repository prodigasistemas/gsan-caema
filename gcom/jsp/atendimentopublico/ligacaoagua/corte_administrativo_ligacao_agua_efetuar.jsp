...
function redirecionaSubmit(caminhoAction) {
 ...
 function validarForm(form){
  ...
  if ((form.tipoCorte.value == '-1')){
	 alert("É necessário informar o tipo de corte.");
  }else 
 ...
 function limparForm() {
  ...
  function desfazer(){
	        ...
	        if (form.valorParcelas != undefined) {
				form.valorParcelas.value = "";
	        }
					...
					<table width="100%" border="0" align="center">
						...
						<tr>
							...
							<td><span class="style2"> 
								...
								onkeypress="javascript:validaEnterComMensagem(event, 'exibirEfetuarCorteAdministrativoLigacaoAguaAction.do', 'idOrdemServico','Ordem de Serviço');"
								onkeyup="limparOS();" />
							<a
							...
							<img width="23" height="21" border="0"
							    ...
							    <a href="javascript:desfazerSemPermissao();"> <img border="0" title="Apagar"
								src="<bean:message key='caminho.imagens'/>limparcampo.gif" /> </a>
							    </logic:notPresent>
											...
											<logic:notPresent name="permissaoMotivoNaoCobranca">
												...
												<tr>
													...
													<td colspan="2"><strong> <html:text
														...
														property="quantidadeParcelas" size="5" maxlength="5" readonly="false" disabled="false" /> </strong></td>
				...
				<tr>
					...
					<table width="100%">
						...
						<tr>
							...
							<logic:notPresent name="permissaoMotivoNaoCobranca">
							<input type="button" name="ButtonReset"
								class="bottonRightCol" value="Desfazer" onClick="desfazerSemPermissao();">
							</logic:notPresent>

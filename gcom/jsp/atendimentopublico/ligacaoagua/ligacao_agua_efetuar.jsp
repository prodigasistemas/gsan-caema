														...
														<table border="0" width="100%">
															...
															<logic:present name="permissaoMotivoNaoCobranca">
																...
																<tr>
																	...
																	<td colspan="4" align="right"><input type="button"
																		...
																		onclick="calcularValores();" style="width: 80px" 
																		readonly="false" ></td>
															...
															<logic:notPresent name="permissaoMotivoNaoCobranca">
																...
																<tr>
																	...
																	<td colspan="2"><strong> <html:text property="quantidadeParcelas" size="5" 
																	maxlength="5" readonly="false" disabled="false" /> </strong></td>

...
<script language="JavaScript">
	...
	function validaForm() {
		...
		if(form.indicadorTipoHidrometro[0].checked == false && form.indicadorTipoHidrometro[1].checked == false)
			alert("Informe Tipo do Hidrômetro");
		else{
			if(form.permissaoEfetuarLigacaoAguaComInstalacaoHidrometrosemRA.value == "true"){
				...
				&& validaDebito()&& validaOSeImovel() && validaMicroMacromedidores()){
				...
				if (validateEfetuarLigacaoAguaComInstalacaoHidrometroActionForm(form) && validaDebito() && validaMicroMacromedidores()){
	...
	function limparForm() {
		...
		form.indicadorTipoHidrometro[0].checked = true;
		form.indicadorTipoHidrometro[1].checked = false;
	...
	if(varTipoConsulta == 'tombamento'){		
    		form.numeroTombamento.value = codigoRegistro;
	      	form.action='exibirEfetuarLigacaoAguaComInstalacaoHidrometroAction.do?tombamento=ok';
	      	form.submit();
    	}
	...
	function calcularValores(){
		...
		var form = document.EfetuarLigacaoAguaComInstalacaoHidrometroActionForm;
	   	if (validateEfetuarLigacaoAguaComInstalacaoHidrometroActionForm(form) && validaDebito()){
	   		if ((form.motivoNaoCobranca == undefined || form.motivoNaoCobranca.value == '-1') && (form.quantidadeParcelas.value == 0)){
												...
												<tr bgcolor="#cbe5fe">
													...
													<table border="0" width="100%">
														...
														<tr>
															...
															<td><strong>Tipo Hidrômetro:<font color="#FF0000">*</font></strong></td>
															<td><strong> 
														...
														<c:choose>
															<c:when test="${EfetuarLigacaoAguaComInstalacaoHidrometroActionForm.indicadorTipoHidrometro == '1'}">
																<tr>
																	...
																	<a href="javascript:pesquisarHidrometro()"><img
																		src="/gsan/imagens/pesquisa.gif" alt="Pesquisar" title="Pesquisar"
															...
															<c:otherwise>															
																<tr>																
																	...
																	<td width="58%"><html:text property="numeroTombamento"		
																		size="13" maxlength="10"
																		onkeypress="validaEnterString(event, 'exibirEfetuarLigacaoAguaComInstalacaoHidrometroAction.do?tombamento=ok', 'numeroTombamento','Tombamento');" />		
																	<a
		
																		href="javascript:pesquisarHidrometroTombamento()"><img src="/gsan/imagens/pesquisa.gif" alt="Pesquisar"
																		title="Pesquisar"
																		border="0" height="21" width="23"></a><a
									...
									<table width="100%">
										...
										<tr>
											<td width="40%" align="left"><logic:present
												...
												onClick="limparForm();"
												<%--onclick="window.location.href='/gsan/exibirEfetuarLigacaoAguaComInstalacaoHidrometroAction.do?menu=sim'"--%>
												 > <input type="button"

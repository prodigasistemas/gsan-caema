...
function naoAutorizar(){
	if (CheckboxAutorizarNaoVazio()){
		abrirPopup('exibirSolicitacaoNaoAutorizada.do', 275, 480);		
	}
}

function recuperarDadosPopup(codigoRegistro, descricaoRegistro, tipoConsulta) {
	var form = document.forms[0];
	if (tipoConsulta == 'motivo') {
		form.action = 'autorizarSolicitacaoAcessoAction.do?naoautorizar='+codigoRegistro;
		form.submit();
	}	
}
</script>
...
<html:form action="/autorizarSolicitacaoAcessoAction"
	...
	onsubmit="return CheckboxAutorizarNaoVazio() && confirm('Confirmar Autorização?')">
			...
			<table width="100%" cellpadding="0" cellspacing="0">
				<tr>
					<td colspan="7" height="23"><font style="font-size: 10px;"
						...
						<strong>Solicitações de Acesso Cadastradas:</strong> </font>
					</td>
				</tr>
				<tr>
								...
								<tr>
									<td>
										<font color="#FF0000"> 
											...
											<input type="button" class="bottonRightCol" value="Não Autorizar"
											onClick="naoAutorizar()" />

...
<%@ page import="gcom.seguranca.acesso.usuario.bean.EfetuarLoginHelper"%>
    ...
    <table width="770" border="0" cellspacing="5" cellpadding="0">
        <tr>
            ...
            <td width="625" valign="top" class="centercoltext">
                  ...
                  <logic:present name="usuariosFilhosAExpirar">  
	                                
	                  	<img id="btMaisAExpirar" alt="Mostrar mais" src="./imagens/nolines_plus.gif"  class="btusuariosFilhos" onclick="abre(this,'tb1')">
	                  	<label style="color:red">Caro usuário, voc&ecirc; tem os seguintes usuários a expirar:</label>
	                 <br>
                 	<div id='tb1'  class="usuariosFilhos">       
                 	<logic:iterate name="usuariosFilhosAExpirar" id="usuario" type="EfetuarLoginHelper">
                 		<span style="font:18px;padding:7px;"  >
                 			O usuário <bean:write name="usuario" property="usuario.login" /> / <bean:write name="usuario" property="usuario.nomeUsuario" /> 
                 			precisa ser	validado até o dia 	<%="" + Util.formatarData(usuario.getUsuario().getDataExpiracaoAcesso())%> 	
						</span><br>
					</logic:iterate>
					</div>
				</logic:present>	
				
				 <logic:present name="usuariosFilhosExpirados">    
				
                  		<img src="./imagens/nolines_plus.gif" alt="Mostrar mais" id="btMaisExpirado" class="btusuariosFilhos" onclick="abre(this,'tb2')">
                  		<label style="color:red">Caro usuário, voc&ecirc; tem os seguintes usuários expirados:</label>
                  	<br>
                 	 <div id='tb2' class="usuariosFilhos">       
                 	<logic:iterate name="usuariosFilhosExpirados" id="usuario" type="EfetuarLoginHelper">
                 		<span style="font:18px;padding:7px;"  >
                 			O usuário <bean:write name="usuario" property="usuario.login" /> / <bean:write name="usuario" property="usuario.nomeUsuario" /> 
                 			está expirado. 	
						</span><br>
                      ...
                      <table width="95%">
                         ...
                         <tr>
                            <td width="50%">
                                  ...
                                  <strong>
                                      <span style="font-size: 11px; font-family: verdana">Parcelamento / Devolução:</span>
                                  </strong>
                                  <br>
                            ...
                            <td>
									...
									<strong>
                                       <span style="font-size: 11px; font-family: verdana">Cobrança:</span>
                                   </strong>
                                  <br>
                                  <span style="font-size: 11px; font-family: verdana">
                                  &nbsp;&nbsp;Gerência de Cobrança - GCB:(81)34129696<br>
                                  </span>
                                  <strong>
                                       <span style="font-size: 11px; font-family: verdana">Arrecadação:</span>
                                   </strong>
                                  <br>
                                  <span style="font-size: 11px; font-family: verdana">
                                  &nbsp;&nbsp;Gerência de Comercialização e Arrecadação -
								GCA:(81)34129856<br>
                                  </span>
                                   <strong>
                      ...
                      <table width="95%">
                          <tr>
                              <td width="50%">
                                   ...
                                   <strong>
                                       <span style="font-size: 11px; font-family: verdana">Ger&ecirc;ncia Comercial: Emídio</span>
                                   </strong>
                                  <br>
                                  <span style="font-size: 11px; font-family: verdana">
                                  ...
                                  <br>
                                  <strong>
                                      <span style="font-size: 11px; font-family: verdana">Divis&atilde;o de Cadastro: Rafael</span>
                                  </strong>
                                  <br>
                                  <span style="font-size: 11px; font-family: verdana">
                                  ...
                                  <br>
                                  <strong>
                                  <span style="font-size: 11px; font-family: verdana">Divis&atilde;o de Leitura e Corte: Leocádio</span>
                                  </strong>
                                  <br>
                                  <span style="font-size: 11px; font-family: verdana">
                                  ...
                                  <br>
                                  <strong>
                                  <span style="font-size: 11px; font-family: verdana">Divis&atilde;o de Atendimento ao P&uacute;blico: Elcina</span>
                                  </strong>
                                  <br>
                                  <span style="font-size: 11px; font-family: verdana">
                              ...
                              <td width="50%" valign="top">
                                  ...
                                  <br>
                                  <strong>
                                  <span style="font-size: 11px; font-family: verdana">Ger&ecirc;ncia de Servi&ccedil;os: Dioclecio</span>
                                  </strong>
                                  <br>
                                  <span style="font-size: 11px; font-family: verdana">
                                  ...
                                  <br>
                                  <strong>
                                  <span style="font-size: 11px; font-family: verdana">Divis&atilde;o de Faturamento e Cobran&ccedil;a: Genival</span>
                                  </strong>
                                  <br>
                                  <span style="font-size: 11px; font-family: verdana">
                                ...
                                <br>
                                  <strong>
                                  <span style="font-size: 11px; font-family: verdana">Divis&atilde;o de Arrecada&ccedil;&atilde;o: Synara</span>
                                  </strong>
                                <br>
                                  <span style="font-size: 11px; font-family: verdana">

			...
			<logic:equal name="statusWizard" property="botaoConcluirDesabilitado" value="sim">
				<logic:present name="statusWizard" property="nomeBotaoConcluir">
					<input name="concluir" 
						...
						value="<bean:write name="statusWizard" property="nomeBotaoConcluir"/>"
						disabled="disabled" />
				</logic:present>
				...
				<logic:notPresent name="statusWizard" property="nomeBotaoConcluir">
					<input name="concluir" 
						...
						style="width: 80px" value="Concluir"
						disabled="disabled" />
				</logic:notPresent>
			</logic:equal>
			...
			<logic:notEqual name="statusWizard" property="botaoConcluirDesabilitado" value="sim">
				...
				<logic:present name="statusWizard" property="nomeBotaoConcluir">
						<input name="concluir" 
							id="botaoConcluir" 
							type="button" 
							class="bottonRightCol" style="width: 150px" 
							value="<bean:write name="statusWizard" property="nomeBotaoConcluir"/>"
				...
				<logic:equal name="statusWizard" property="botaoConcluirSemAlteracao" value="true">
					<input name="concluirSemAlteracao" 
						id="botaoConcluirSemAlteracao" 
						type="button" 
						class="bottonRightCol" 
						style="width: 150px" 
						value="Concluir Sem Alteração"
						onClick="javascript:botaoAvancar('/gsan/exibirInserirMotivoRejeicaoClienteVirtualAction.do');"/>	
				</logic:equal>

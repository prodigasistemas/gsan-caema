    		...
    		<td width="770" valign="top" class="centercoltext">
		      	...
		      	<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
			   	...
			   	<table width="100%" border="0">
			        ...
			        <tr>
			        	<logic:present name="usuarioLogado" scope="session"> 
				          	<td width="60" align="left">
								<input name="Button" 
									...
									align="left"
									onclick="window.location.href='/gsan/telaPrincipal.do?acao=log'">
				          	</td>
			          </logic:present>
			          <logic:notPresent name="usuarioLogado" scope="session">
				          <td width="60" align="left">
								<input name="Button" 
									type="button" 
									class="bottonRightCol"
									value="Tela Login" 
									align="left"
									onclick="window.location.href='/gsan'">
				          	</td>
			          </logic:notPresent>
			          	<td align="right">
	  		      			<input name="Button" 
